...
public class PGPFileProcessor {
    ...
    public boolean encrypt() throws Exception {
        ...
        PGPUtilV2.encryptFile(out, inputFile, PGPExampleUtil.readPublicKey(keyIn),
...
//         FileInputStream keyIn = new FileInputStream(keyFile);
//         FileOutputStream out = new FileOutputStream(outputFile);
//         //PGPUtilV2.decryptFile(in, out, keyIn, passphrase.toCharArray());
//         PGPUtilV2.decryptAndVerify(in, out, keyIn, passphrase.toCharArray());
         PGPUtilV2.gpgDecrypt(inputFile, passphrase, outputFile, keyFile);
//         in.close();
//         out.close();
//         keyIn.close();
         return true;
