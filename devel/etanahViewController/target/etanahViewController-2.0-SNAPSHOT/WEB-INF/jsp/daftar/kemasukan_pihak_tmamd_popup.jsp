...
<div class="subtitle">
  <s:form beanclass="etanah.view.daftar.PihakKepentinganAction" name="form1">
    ...
    <fieldset class="aras1">
      ...
      <p>
        <label><font color="red" class="noPengenalan">*</font>No Pengenalan :</label> 
      ...
      <p>
        <label for="alamat">
          <font color="red">*</font>Alamat Berdaftar :
        </label>
            <s:text name="pihak.alamat1" id="alamat1" disabled="${disabled}" 
                    size="40" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
      </p>
      <p>
        <label> &nbsp;</label>
        <s:text name="pihak.alamat2" id="alamat2" disabled="${disabled}" 
                size="40" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
      </p>
      <p>
        <label> &nbsp;</label>
        <s:text name="pihak.alamat3" id="alamat3" disabled="${disabled}" 
                size="40" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
      </p>
      <p>
        <label>Bandar :</label>
        <s:text name="pihak.alamat4" id="alamat4" disabled="${disabled}" 
                size="40" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
      </p>
      <p>
        <label>Poskod :</label>
        <s:text name="pihak.poskod" id="poskod" disabled="${disabled}" 
                size="40" maxlength="5" onkeyup="validateNumber(this,this.value);"/>
      </p>
      <p>
      ...
      <div id="pgAmanahDialog" style="display: none" align="left" title="Tambah Waris">
        <table border="0">
          ...
          <tr>
            ...
            <td id="tdDisplay">
              <s:text name="permohonanPihakHubungan.alamat1" size="40" id="alamatAmanah1" 
          ...
          <tr>
            <td id="tdLabel"> &nbsp;</td>
            <td id="tdDisplay">
              <s:text name="permohonanPihakHubungan.alamat2" size="40" id="alamatAmanah2" 
                      maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
            </td>
          </tr>
          <tr>
            <td id="tdLabel">&nbsp;</td>
            <td id="tdDisplay">
              <s:text name="permohonanPihakHubungan.alamat3" size="40" id="alamatAmanah3" 
                      maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
            </td>
          </tr>          
          <tr>
      ...
      <div id="cawDialog" style="display: none" align="left" title="Tambah Cawangan">
        <table border ="0" >
          ...
          <tr>
            ...
            <td id="tdDisplay">
              <s:text name="pihakCawangan.alamat1" id="alamatCaw1" size="40" maxlength="40" 
                      onkeyup="this.value=this.value.toUpperCase();"/>
            </td>
          </tr>
          <tr>
            <td id="tdLabel">&nbsp;</td>
            <td id="tdDisplay">
              <s:text name="pihakCawangan.alamat2" id="alamatCaw2" 
                      size="40" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
            </td>
          </tr>
          <tr>
            <td id="tdLabel">&nbsp;</td>
            <td id="tdDisplay">
              <s:text name="pihakCawangan.alamat3" id="alamatCaw3" 
                      size="40" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
            </td>
          </tr>
          <tr>
            <td id="tdLabel">Bandar :</td>
            <td id="tdDisplay">
              <s:text name="pihakCawangan.alamat4" id="alamatCaw4" 
                      size="40" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
            </td>
          </tr> 
          <tr>
            <td id="tdLabel">Poskod :</td>
            <td id="tdDisplay">
              <s:text name="pihakCawangan.poskod" size="40" id="poskodCaw" 
      ...
      <p>
        <label>
          <s:submit name="showSearchForm" class="btn" value="Carian Semula"/>&nbsp;
        </label>
