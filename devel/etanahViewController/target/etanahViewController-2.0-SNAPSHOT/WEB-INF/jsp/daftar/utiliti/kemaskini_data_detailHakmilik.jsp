...
//    });
  ...
  function popupFormSyaratNyata() {
    ...
    var url = "${pageContext.request.contextPath}/daftar/utiliti/kemaskiniData?paparPopupSyaratNyata&idHakmilik=" + $("#idHakmilik").val();
  ...
  function popupFormKodSekatan() {
    // GET SEKATAN POPUP
    var url = "${pageContext.request.contextPath}/daftar/utiliti/kemaskiniData?paparPopupSekatan&idHakmilik=" + $("#idHakmilik").val();
    window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=600");
  }

  function popupPihak(id) {
    // GET PIHAK POP
    var url = "${pageContext.request.contextPath}/daftar/utiliti/kemaskiniData?paparPopupPihak&idHakmilik=" + id;
...
//      alert("kodBPM " + kodBPM);
    ...
    $.post('${pageContext.request.contextPath}/pendaftaran/kemasukan_perincian_hakmilik?checkPelan&noLot='
            + noLot + '&kodDaerah=' + kodDaerah + '&kodNegeri=' + kodNegeri + '&kodBPM=' + kodBPM + '&kodSeksyen=' + kodSeksyen,
            function(data) {
