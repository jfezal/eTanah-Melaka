  ...
  <c:choose>
    ...
    <c:otherwise>
      ...
      $("#cariPihak").click(function() {
        ...
        doBlockUI();
        var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?cariPihak&pihakNama='
...
//      COPY FROM 'ALAMAT BERDAFTAR' TO 'ALAMAT SURAT'
    ...
    function pilihPihak(val) {
      doBlockUI();
      var idPihak = val;
      var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?cariPihak&idPihak=' + idPihak;
      frm = document.form1;
      frm.action = url;
      frm.submit();
    }
      ...
      <fieldset class="aras1">      
        ...
        <table align="center">
          ...
          <tr>
              ...
              <td id="tdDisplay">
                  <s:select name="pihak.penubuhanSyarikat.kod" id="penubuhanSyarikat">
                      <s:option value="">Sila Pilih</s:option>
