...
<script>
  function clearForm(f) {
    var frm = document.forms.form1;
        var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanDataHakmilik';
        frm.action = url;
        frm.submit();
      }
</script>
...
<div class="kutipdata">
  ...
  <s:form beanclass="etanah.view.daftar.utiliti.KutipanDataHakmilikActionBean" name="form1">    
