...
<html>
  <body>
    ...
    <s:messages />
    <s:errors />
    <s:useActionBean beanclass="etanah.view.daftar.utiliti.UtilitiUndoSerah" var="penggunaperanan"/>
    <img id="displayBox" src="${pageContext.request.contextPath}/pub/images/logo.gif" width="50" height="50" style="display: none" alt=""/>
    <s:form beanclass="etanah.view.daftar.utiliti.UtilitiUndoSerah" name="form1">
