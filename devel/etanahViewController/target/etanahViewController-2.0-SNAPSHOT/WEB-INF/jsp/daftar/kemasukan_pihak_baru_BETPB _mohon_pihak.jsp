    ...
    <s:form name="form1" beanclass="etanah.view.stripes.nota.TambahPihakBerkepentinganActionBean">
        ...
        <fieldset class="aras1">
            ...
            <c:if test="${moreThanOneHakmilik}">
                ...
                <p>
                    <br>
                <label>Perserahan terlibat :</label> <em>${actionBean.urusan.idPerserahan} ( ${actionBean.urusan.kodUrusan.nama} )</em>
                </br>
            </p>
            <p>
            ...
            <center>
                <s:button name="savePihakPopupMohonPihak" class="btn" value="Simpan" onclick="save(this.name, this.form);"/>&nbsp;
