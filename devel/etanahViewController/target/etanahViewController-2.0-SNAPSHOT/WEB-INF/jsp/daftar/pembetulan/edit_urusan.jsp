                ...
                <div align="center">
                    <table class="tablecloth">
                        ...
                        <tr><th>Perkara</th><th>Maklumat Lama</th><th>Maklumat Baru</th></tr>
                            ...
                            <tr><td colspan="3">
                                    <div align="center">
                                        <s:button name="saveUrusanSC" value="Simpan" class="btn" onmouseover="this.style.cursor='pointer';" onclick="save(this.name, this.form, '${actionBean.idUrusan}')"/>
...
<!-- yus edit 14022017 -->
                                    ...
                                    <tr><td>Cukai Lama:</td>
                                        <td class="s">${actionBean.hakmilikUrusan.cukaiLama}</td>
                                        <td class="s">
                                            <s:text name="betulUrusan.cukaiLama" value ="${actionBean.betulUrusan.cukaiLama}" onkeyup="this.value=this.value.toUpperCase();"/>
                                        </td></tr>
...
<!--end yus edit -->
                            ...
                            <tr><td colspan="3">
                                    <div align="center">
                                        <s:button name="saveUrusanN" value="Simpan" class="btn" onmouseover="this.style.cursor='pointer';" onclick="save(this.name, this.form, '${actionBean.idUrusan}')"/>
                                        <s:button name="tutup" value="Tutup" class="btn" onclick="javascript:self.close()"/>
                                    </div>
                                </td></tr>
                            </c:if>
                            ...
                            <tr><td>No Mahkamah :</td>
                                ...
                                <tr><td colspan="3">
                                        <div align="center">
                                            <s:button name="saveUrusanB" value="Simpan" class="btn" onmouseover="this.style.cursor='pointer';" onclick="save(this.name, this.form, '${actionBean.idUrusan}')"/>
                                            <s:button name="tutup" value="Tutup" class="btn" onclick="javascript:self.close()"/>
                                        </div>
                                    </td></tr>
                                </c:if>
