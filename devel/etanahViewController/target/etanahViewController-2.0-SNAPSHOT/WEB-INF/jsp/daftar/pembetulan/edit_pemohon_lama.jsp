            ...
            <fieldset class="aras1">
                ...
                <div align="center">
                    ...
                    <table class="tablecloth" width="70%">
                        ...
                        <tr><td>Nama :</td><td class="s">${actionBean.pemhn.nama}</td>
                                <td class="s">
                                <s:text name="nama" onkeyup="this.value=this.value.toUpperCase();"/>
                            </td></tr>

                        <tr><td>Jenis Pengenalan :</td><td class="s">${actionBean.pemhn.jenisPengenalan.nama}</td>
                                <td class="s">
                        ...
                        <tr><td>No. Pengenalan :</td><td class="s">${actionBean.pemhn.noPengenalan}</td>
                                <td class="s">
                                <s:text name="noPengenalan" maxlength="25" onkeyup="this.value=this.value.toUpperCase();"/>
                            </td></tr>
                        <tr><td>Warganegara :</td><td class="s">${actionBean.pemhn.wargaNegara.nama}</td>
                            <td class="s">
                        ...
                        <tr><td>Jenis Pihak Berkepentingan :</td><td class="s">${actionBean.pemhn.jenis.nama}</td>
                            <td class="s">
                        ...
                        <tr><td>Pembilang / Penyebut :</td><td class="s">${actionBean.pemhn.syerPembilang}/${actionBean.pemhn.syerPenyebut}</td>
                            <td class="s">

                                <s:text name="pembilang" class="pembilang" 
                                        onblur="updateSyer('${actionBean.pemhn.idPemohon}')" onchange="updateSyer('${actionBean.pemhn.idPemohon}'" style="width:46% !important;"/> / <s:text name="penyebut" class="penyebut" onblur="updateSyer('${pemhn.idPemohon}')" onchange="updateSyer('${pemhn.idPemohon}'" style="width:46% !important;"/>
                            </td></tr>
                        ...
                        <tr><td>Alamat :</td><td class="s">${actionBean.pemhn.pihak.alamat1}</td>
                                <td class="s">
                                <s:text name="alamat1" id="alamat1"/>
                            </td></tr>

                        <tr><td>&nbsp;</td><td class="s">${actionBean.pemhn.pihak.alamat2}</td>
                                <td class="s">
                                <s:text name="alamat2" id="alamat2"/>
                            </td></tr>

                        <tr><td>&nbsp;</td><td class="s">${actionBean.pemhn.pihak.alamat3}</td>
                                <td class="s">
                                <s:text name="alamat3" id="alamat3"/>
                            </td></tr>

                        <tr><td>&nbsp;</td><td class="s">${pemhn.pihak.alamat4}</td>
                                <td class="s">
                                <s:text name="alamat4" id="alamat4"/>
                            </td></tr>

                        <tr><td>Poskod :</td><td class="s">${actionBean.pemhn.pihak.poskod}</td>
                                <td class="s">
                        ...
                        <tr><td>Negeri :</td><td class="s">${actionBean.pemhn.pihak.negeri.nama}</td>
                                <td class="s">
                        ...
                        <tr><td colspan="3">
                                <div align="center">
                                    <s:button name="saveBetulPemohon" value="Simpan" class="btn" onmouseover="this.style.cursor='pointer';" onclick="save(this.name, this.form, '${actionBean.pemhn.idPemohon}', '${actionBean.pemhn.idPemohon}')"/>
