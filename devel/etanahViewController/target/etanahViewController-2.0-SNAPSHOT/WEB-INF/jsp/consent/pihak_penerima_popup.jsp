...
<script type="text/javascript">
                ...
                dodacheck($("#kp").val());
                    ...
                    $("#pgAmanahDialog").dialog({
                        ...
                        close: function() {
                            ...
                            $('#negeriAmanah').val('');
                            $('#negaraAmanah').val('');
                            $('#syerPenyebutAmanah').val('');
                            $('#syerPembilangAmanah').val('');
                        }
                    });
    ...
    <%--var idMohonPihak = $('#idMohonPihak').val();--%>
                            ...
                            doBlockUI();
                            var rowNoEdit = $('#rowAmanahEdit').val();
                            var idDelete = "x"+rowNoEdit;
                            $('#'+idDelete).remove();

    <%--var size = $('table#pgAmanahTable tr').length;--%>
                            var rowNo = $('table#pgAmanahTable tr').length;

                            $('table#pgAmanahTable tbody').append("<tr id='x"+rowNo+"' class='x'>" +
                                "<td><input type=hidden name='namaPA' value='"+nama+"'/>" + nama + '</td>' +
                                "<td><input type=hidden name='kpPA' value='"+jenisKp+"'/>" + $('#kpAmanahEdit option:selected').text() + '</td>' +
                                "<td><input type=hidden name='noKpPA' value='"+noKp+"'/>" + noKp + '</td>' +
                                "<td><input type=hidden name='wargaPA' value='"+warga+"'/>" + $('#warganegaraAmanahEdit option:selected').text() + '</td>' +
                                "<td><input type=hidden name='add1PA' value='"+add1+"'/>" + add1 + '</td>' +
                                "<td><input type=hidden name='add2PA' value='"+add2+"'/>" + add2 + '</td>' +
                                "<td><input type=hidden name='add3PA' value='"+add3+"'/>" + add3 + '</td>' +
                                "<td><input type=hidden name='add4PA' value='"+add4+"'/>" + add4 + '</td>' +
    ...
    <%--                            for(var rowNo=0; rowNo<size; rowNo++){
                                    $('table#pgAmanahTable tbody').append("<tr id='x"+rowNo+"' class='x'>" +
                                        "<td><input type=hidden name='namaPA' value='"+nama+"'/>" + nama + '</td>' +
                                        "<td><input type=hidden name='kpPA' value='"+jenisKp+"'/>" + $('#kpAmanah option:selected').text() + '</td>' +
                                        "<td><input type=hidden name='noKpPA' value='"+noKp+"'/>" + noKp + '</td>' +
                                        "<td><input type=hidden name='wargaPA' value='"+warga+"'/>" + $('#warganegaraAmanah option:selected').text() + '</td>' +
                                        "<td><input type=hidden name='add1PA' value='"+add1+"'/>" + add1 + '</td>' +
                                        "<td><input type=hidden name='add2PA' value='"+add2+"'/>" + add2 + '</td>' +
                                        "<td><input type=hidden name='add3PA' value='"+add3+"'/>" + add3 + '</td>' +
                                        "<td><input type=hidden name='add4PA' value='"+add4+"'/>" + add4 + '</td>' +
    ...
    <%--                                    var url = '${pageContext.request.contextPath}/consent/pihak_penerima?savePgAmanahEdit&idHubungan='+idHubungan  + '&idMohonPihak=' + idMohonPihak  + '&nama=' + nama + '&jenisKp=' + jenisKp + '&noKp=' + noKp + '&alamat1=' + add1 + '&alamat2=' + add2 + '&alamat3=' + add3  + '&alamat4=' + add4 +'&poskod=' + poskod+ '&negeri=' + negeri+ '&warga=' + warga+ '&syerPenyebut=' + syerPenyebut+ '&syerPembilang=' + syerPembilang;
                                        frm = document.form1;
                                        frm.action = url;
                                        frm.submit();--%>
                                                                $.unblockUI();
                    ...
                    'Simpan': function() {
                        ...
                        if (bValid) {
                            ...
                            if(idPengarah == ''){
                                ...
                                $('table#pengarahTable tbody').append("<tr id='x"+rowNoEdit+"' class='x'>" +
                                    "<td><input type=hidden name='namaPgrh' id='namaPgrh' value='"+nama+"'/>" + nama + '</td>' +
                                    "<td><input type=hidden name='kpPgrh' value='"+kp+"'/>" + $('#kpPengarahEdit option:selected').text() + '</td>' +
                                    "<td><input type=hidden name='noKpPgrh' value='"+noKp+"'/>" + noKp + '</td>' +
                                    "<td><input type=hidden name='wargaPgrh' value='"+warga+"'/>" + $('#wargaPengarahEdit option:selected').text() + '</td>' +
                                    "<td><div align=center><img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/images/edit.gif' \n\
                                onmouseover='this.style.cursor=\"pointer\";' onclick='editPengarah(\""+rowNoEdit+"\");'></div></td>" +
                                    "<td><div align=center><img alt='Klik Untuk Hapus' border='0' src='${pageContext.request.contextPath}/images/not_ok.gif' \n\
                                onmouseover='this.style.cursor=\"pointer\";' onclick='deleteWaris2(\"x"+rowNoEdit+"\");'></div></td>" +
                                    '</tr>');

                                var url = '${pageContext.request.contextPath}/consent/pihak_penerima?savePihak';
                            }

                            else{

                                var url = '${pageContext.request.contextPath}/consent/pihak_penerima?savePengarahEdit&idPengarah='+idPengarah  + '&idMohonPihak=' + idMohonPihak + '&idPemohon=' + idPemohon + '&namaPengarah=' + nama + '&kpPengarah=' + kp + '&noKpPengarah=' + noKp + '&wargaPengarah=' + warga + '&idPihak=' + $('#idPihak').val()+ '&idHakmilik=' + $('#idHakmilik').val();;
    ...
    <%--var telefon = $('#telCawEdit').val();--%>

                            var idCawangan = $('#idCawEdit').val();
                            var idMohonPihak = $('#idMohonPihak').val();
                            var idPemohon = $('#idPemohon').val();
                            var rowNoEdit = $('#rowCawangan').val();

                            doBlockUI();

                            if(idCawangan == ''){
                                var idDelete = "caw"+rowNoEdit;
                                $('#'+idDelete).remove();
                                ...
                                $('table#cawTable tbody').append("<tr id='caw"+rowNo+"' class='x'>" +
                                    "<td><input type=hidden class=nw_pc name=nw_pc/><input type=radio name=pilih value='pc_"+no+"'/></td>" +
    <%--                        "<td><input type=hidden name='namaCaw' value='"+namaCawangan+"'/>\n\
            <input type=hidden name='telCaw' value='"+telefon+"'/>\n\
            " + namaCawangan + '</td>' +--%>
                                        "<td><input type=hidden name='namaCaw' value='"+namaCawangan+"'/>" + namaCawangan + '</td>' +
                                            "<td><input type=hidden name='add1Caw' value='"+alamat1+"'/>" + alamat1 + '</td>' +
                                            "<td><input type=hidden name='add2Caw' value='"+alamat2+"'/>" + alamat2 + '</td>' +
                                            "<td><input type=hidden name='add3Caw' value='"+alamat3+"'/>" + alamat3 + '</td>' +
                                            "<td><input type=hidden name='add4Caw' value='"+alamat4+"'/>" + alamat4 + '</td>' +
                                            "<td><input type=hidden name='poskodCaw' value='"+poskod+"'/>" + poskod + '</td>' +
                                            "<td><input type=hidden name='negeriCaw' value='"+negeri+"'/>" + $('#negeriCaw option:selected').text() + '</td>' +
                                            "<td><div align=center><img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/images/edit.gif' \n\
                                onmouseover='this.style.cursor=\"pointer\";' onclick='editCawangan(\""+rowNo+"\");'></div></td>" +
                                ...
                                onmouseover='this.style.cursor=\"pointer\";' onclick='deleteWaris2(\"caw"+rowNo+"\");'></div></td>" +
                                        ...
                                        var url = '${pageContext.request.contextPath}/consent/pihak_penerima?saveCawanganEdit&idCawangan='+idCawangan  + '&idMohonPihak=' + idMohonPihak  + '&idPemohon=' + idPemohon + '&namaCawangan=' + namaCawangan + '&alamat1=' + alamat1 + '&alamat2=' + alamat2 + '&alamat3=' + alamat3 + '&alamat4=' + alamat4 + '&poskod=' + poskod+ '&negeri=' + negeri+ '&idPihak=' + $('#idPihak').val()+ '&idHakmilik=' + $('#idHakmilik').val();
    ...
    <%--$('#telCawEdit').val('');--%>
        ...
        function editPemegangAmanah(row) {
    ...
    <%--$('#telCawEdit').val($('table#cawTable tr:eq('+row+') td:eq('+8+')').text());--%>
        ...
        function doValidation(){
            ...
            if(val3 == ''){
                ...
                alert('Sila Masukkan Jenis Pihak Berkepentingan.');
                return false;
            } else if (suratAlamat == ''){
        ...
        function removePengarah(val, id){
            if(confirm('Adakah anda pasti?')) {
                doBlockUI();
                var url = '${pageContext.request.contextPath}/consent/pihak_penerima?deletePengarah&idPengarah='+val + '&idPihak=' + $('#idPihak').val()+ '&idHakmilik=' + $('#idHakmilik').val();
                frm = document.form1;
                frm.action = url;
                frm.submit();
            }
        ...
        function removeCawanganPemohon(val, id){
            if(confirm('Adakah anda pasti?')) {
                doBlockUI();
                var url = '${pageContext.request.contextPath}/consent/pihak_penerima?deletePihakCaw&idPihakCaw='+val + '&idPihak=' + $('#idPihak').val() + '&idHakmilik=' + $('#idHakmilik').val();
                frm = document.form1;
                frm.action = url;
                frm.submit();
            }
    ...
    <s:form beanclass="etanah.view.stripes.consent.PihakPenerimaActionBean" name="form1">
            ...
            <fieldset class="aras1">
                ...
                <c:if test="${moreThanOneHakmilik}">
                    <p>
                        ...
                        <font color="red" size="2">
                            <input type="checkbox" name="copyToAll" value="1" checked/>
                ...
                <%-- <c:if test="${actionBean.kodNegeri eq '05'}">
                     <p>
                         ...
                         <s:select name="pihak.jenisPengenalan.kod" id="jenisKP" onchange="javaScript:changeHideSuku(this.options[selectedIndex].value)">
                ...
                <p>
                    ...
                    <s:text name="pihak.noPengenalan" id="kp" size="40" onkeyup="dodacheck(this.value);this.value=this.value.toUpperCase();" onchange="changeIcNumber(this.value);"/>&nbsp;<em style="font-style:normal">(cth : 800620125177)</em>
                </p>
                <p>
                    ...
                    <s:select name="jenisPihak" style="width:400px" id="jenis_pihak" onchange="javaScript:changePgAmanah(this.options[selectedIndex].value);">
                        ...
                        <c:choose>
                            <c:when test="${actionBean.kodNegeri eq '05'}">
                                <c:choose>
                                    <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PMADT' || actionBean.permohonan.kodUrusan.kod eq 'PMWNA' || actionBean.permohonan.kodUrusan.kod eq 'PCPTD' || actionBean.permohonan.kodUrusan.kod eq 'PGDMB' || actionBean.permohonan.kodUrusan.kod eq 'PCMMK' || actionBean.permohonan.kodUrusan.kod eq 'GSMMK' || actionBean.permohonan.kodUrusan.kod eq 'PMMAT' || actionBean.permohonan.kodUrusan.kod eq 'PMPTD' || actionBean.permohonan.kodUrusan.kod eq 'PJKTL' || actionBean.permohonan.kodUrusan.kod eq 'PMJTL' || fn:startsWith(actionBean.permohonan.kodUrusan.kod, 'PPTD') || fn:startsWith(actionBean.permohonan.kodUrusan.kod, 'PMMK')}">
                                        <s:option value="PA">PEMEGANG AMANAH</s:option>
                                        <s:option value="PPM">PENERIMA PINDAH MILIK</s:option>
                                    </c:when>
                                    <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PJADT' || actionBean.permohonan.kodUrusan.kod eq 'PJPTD' || actionBean.permohonan.kodUrusan.kod eq 'PJMMK'}">
                                        <s:option value="PA">PEMEGANG AMANAH</s:option>
                                        <s:option value="PPA">PENERIMA PAJAKAN</s:option>
                                    </c:when>
                                    <c:when  test="${actionBean.permohonan.kodUrusan.kod eq 'CGADT' || actionBean.permohonan.kodUrusan.kod eq 'MCPTD' || actionBean.permohonan.kodUrusan.kod eq 'MCGMB' || actionBean.permohonan.kodUrusan.kod eq 'MCMMK'}">
                                        <s:option value="PA">PEMEGANG AMANAH</s:option>
                ...
                <c:if test="${actionBean.kodNegeri eq '05'}">
                    ...
                    <p id="luak">
                        ...
                        <s:select name="pihak.tempatSuku" style="width:250px">
                            <s:option value="">Sila Pilih</s:option>
                ...
                <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L'
                      ...
                      <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PMADT' && actionBean.permohonan.kodUrusan.kod ne 'CGADT' && actionBean.permohonan.kodUrusan.kod ne 'PAADT' && actionBean.permohonan.kodUrusan.kod ne 'TMADT' && actionBean.permohonan.kodUrusan.kod ne 'BTADT' && actionBean.permohonan.kodUrusan.kod ne 'TMWNA'}">
                          ...
                          <p>
                              ...
                              <s:text name="permohonanPihak.pendapatan" id="pendapatan" size="40" maxlength="12" formatPattern="#,###.00"  onchange="convert(this.value, this.id);" onkeyup="validateNumber(this,this.value);"/>
                          </p>
                          <p>
                ...
                <c:if test="${actionBean.pihak.jenisPengenalan.kod ne 'B' && actionBean.pihak.jenisPengenalan.kod ne 'L'
                      ...
                      <div class="content" align="center" id="cawangan">
                          ...
                          <display:table class="tablecloth" name="${actionBean.cawanganList}" cellpadding="0" cellspacing="0"
                                         ...
                                         requestURI="${pageContext.request.contextPath}/consent/pihak_penerima" style="width:90%">
                              ...
                              <display:column title="Kemaskini">
                                  <div align="center">
                                      ...
                                      <%--onclick="editCawangan(${cawTable_rowNum})" onmouseover="this.style.cursor='pointer';">--%>
                                  </div>
                              </display:column>
                ...
                <div id="pgAmanah" style="display: none" align="center">
                    <span class=instr><em>Sila klik pada imej <img alt="" src='${pageContext.request.contextPath}/images/tambah.png'/> untuk menambah penerima amanah.</em></span><br/>
                    <div align="center">
                        <display:table class="tablecloth" name="${actionBean.senaraiPihakHubungan}" cellpadding="0" cellspacing="0"
                            ...
                            <display:column title="Warganegara"></display:column>
                            ...
                            <display:column title="Syer"></display:column>
                            ...
                            <%-- <display:column title="Kemaskini">
                                 <div align="center">
                                     <img alt='Klik Untuk Kemaskini' id='editPA' border='0' src='${pageContext.request.contextPath}/images/edit.gif' class='rem'
                                          onmouseover="this.style.cursor='pointer';" onclick="editPemegangAmanah(${pgAmanahTable_rowNum})">
                                 </div>
                             </display:column>--%>
                            <display:column title="<img alt='Tambah Penerima Amanah' id='addPA'
                                            src='${pageContext.request.contextPath}/images/tambah.png' onmouseover=\"this.style.cursor='pointer';\"/>"/>
                        </display:table>
                    </div>
                    <br/>
                ...
                <div id="pgAmanahDialog" style="display: none" align="left" title="Tambah Penerima Amanah">
                    <p align="left">
                        <label for="nama"><font color="red">*</font>Nama :</label>
                    ...
                    <p>
                        ...
                        <s:select name="permohonanPihakHubungan.negeri.kod" id="negeriAmanah" onchange="javaScript:changeNegeriAmanah(this.options[selectedIndex].text);">
                            <s:option value="">Sila Pilih</s:option>
                            <s:options-collection collection="${list.senaraiKodNegeri}" label="nama" value="nama"/>
                            <s:option>LAIN-LAIN</s:option>
                        </s:select>
                ...
                <div id="pgAmanahDialogEdit" style="display: none" align="left" title="Kemaskini Penerima Amanah">
                    <s:hidden name="permohonanPihakHubungan.idPihakHubungan" id="rowAmanahEdit"/>
                    <p align="left">
                        <label for="nama"><font color="red">*</font>Nama :</label>
                ...
                <p align="center">
                    <s:submit name="showSearchFormPenerima" class="btn" value="Carian Semula"/>
        ...
        <c:if test="${pemohon}">
            <fieldset class="aras1">
                ...
                <%--            <c:if test="${actionBean.kodNegeri eq '04' && actionBean.permohonan.kodUrusan.kod eq 'PMMMK'}">
                                <c:if test="${actionBean.pihak.jenisPengenalan.kod ne 'B' && actionBean.pihak.jenisPengenalan.kod ne 'L'
                                              && actionBean.pihak.jenisPengenalan.kod ne 'P' && actionBean.pihak.jenisPengenalan.kod ne 'T'
                                              && actionBean.pihak.jenisPengenalan.kod ne 'I' && actionBean.pihak.jenisPengenalan.kod ne 'K'}">
                                      <p>
                ...
                <c:if test="${actionBean.kodNegeri eq '04' && actionBean.permohonan.kodUrusan.kod eq 'PMMMK'}">
                    <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L'
                          ...
                          <p>
                              ...
                              <s:text name="pemohon.tempohMastautin" id="mastautin" size="10" maxlength="3" onkeyup="validateNumber(this,this.value);"/>
                          </p>
                    </c:if>
                ...
                <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L'
                      ...
                      <p>
                          <c:choose>
                              <c:when test="${actionBean.kodNegeri eq '04' && actionBean.permohonan.kodUrusan.kod eq 'PMMMK'}">
                      ...
                      <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PMADT' && actionBean.permohonan.kodUrusan.kod ne 'CGADT' && actionBean.permohonan.kodUrusan.kod ne 'PAADT' && actionBean.permohonan.kodUrusan.kod ne 'TMADT' && actionBean.permohonan.kodUrusan.kod ne 'BTADT'}">
                          ...
                          <p>
                              ...
                              <s:text name="pemohon.pendapatan" id="pendapatan" size="40" maxlength="12" formatPattern="#,###.00"  onchange="convert(this.value, this.id);" onkeyup="validateNumber(this,this.value);"/>
                          </p>
                          <p>
                              <label>Tanggungan :</label>
                ...
                <p align="center">
                    <s:submit name="showSearchFormPemohon" class="btn" value="Carian Semula"/>
                    <s:button name="savePemohonPopup" class="btn" value="Simpan" onclick="save(this.name, this.form);"/>
                    <s:button name="close" id="tutup" value="Tutup" class="btn" onclick="self.close()"/>
                </p>
                <br/>
            </fieldset>
