    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <table border="0">
                ...
                <c:if test="${actionBean.hakmilik.noBangunan ne null}">
                    <tr><td id="tdLabel">No Bangunan :&nbsp;</td>
                        <td id="tdDisplay">
                            ${actionBean.hakmilik.noBangunan}
                        </td>
                    </tr>
                </c:if>
                <c:if test="${actionBean.hakmilik.noTingkat ne null}">
                    <tr><td id="tdLabel">No Tingkat :&nbsp;</td>
                        <td id="tdDisplay">
                            ${actionBean.hakmilik.noTingkat}
                        </td>
                    </tr>
                </c:if>
                <c:if test="${actionBean.hakmilik.noPetak ne null}">
                    <tr><td id="tdLabel">No Petak :&nbsp;</td>
                        <td id="tdDisplay">
                ...
                <c:if test="${fn:length(actionBean.senaraiPemegangGadai) > 0}">
                    <tr><td id="tdLabel">Maklumat Gadaian :&nbsp;</td>
                        <td>
                            <display:table style="width:100%;" class="tablecloth" name="${actionBean.senaraiPemegangGadai}" cellpadding="0" cellspacing="0" id="lineGadaian">
                                <display:column title="Bil" style="width:10;">${lineGadaian_rowNum}</display:column>
                                <display:column title="ID Permohonan" property="permohonan.idPermohonan" style="width:80;"/>
                                <display:column title="Nama Pemegang Gadaian" property="nama"/>
                            </display:table>
                        </td>
                    </tr>
                </c:if>
