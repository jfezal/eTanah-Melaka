...
<s:form beanclass="etanah.view.stripes.consent.UlasanTanahLadangMelakaActionBean">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <table width="100%">
                ...
                <c:if test="${tajuk}"><tr><td>&nbsp;</td><td id="uLabel">Nombor Kertas : <s:text name="permohonanKertasTemp.nomborRujukan" maxlength="50" size="50" id="noRujukan"/><s:hidden name="permohonanRujukanLuar.idRujukan"/></td></tr></c:if>
                <tr><td></td><td>
                        <c:if test="${viewTajuk}">
