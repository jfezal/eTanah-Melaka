<%-- 
    Document   : dokumen_tambahan2
    Created on : Jul 15, 2013, 1:56:13 PM
    Author     : nur.aqilah
--%>
...
<s:useActionBean beanclass="etanah.view.lelong.dokumen.FolderAction2" var="list"/>
<img id="displayBox" src="${pageContext.request.contextPath}/pub/images/logo.gif" width="50" height="50" style="display: none"/>
<s:form beanclass="etanah.view.lelong.dokumen.FolderAction2" >
