...
<script type="text/javascript">
    ...
    function successRedirection() {
        var url = '${pageContext.request.contextPath}/lelong/dokumen/folder?reload&permohonan.idPermohonan=${idPermohonan}';
        $.ajax({
            type:"GET",
            url : url,
...
<s:form beanclass="etanah.view.lelong.dokumen.ViewDocumentAction">
