<%-- 
    Document   : tangguhAwal
    Created on : May 27, 2011, 12:36:46 PM
...
<script type="text/javascript">
    function show_calendar(){
        window.open("${pageContext.request.contextPath}/lelong/keputusan_tangguh_awal?showFormC", "eTanah",
...
<s:form beanclass="etanah.view.stripes.lelong.KeputusanTangguhAwalActionBean">
    <s:messages/>
    <s:errors/>
        ...
        <div class="subtitle" id="lain2">
            <fieldset class="aras1">
                ...
                <div class="content" align="center">
                    <p>
                        <s:button name="simpanEnkuiriSemakRekodPenghantaran" id="save" value="Simpan" class="longbtn" onclick="if(validation())doSubmit(this.form, this.name, 'page_div')"/>
                    </p>
                </div>
        </fieldset>
    </div>
