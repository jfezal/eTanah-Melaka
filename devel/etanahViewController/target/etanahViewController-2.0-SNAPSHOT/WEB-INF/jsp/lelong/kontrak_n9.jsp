<%-- 
    Document   : kontrak_n9
    Created on : Jun 7, 2010, 1:17:57 PM
    ...
    <p>
        ...
        <fieldset class="aras1">
            ...
            <p style="font-size: 11pt">
                ...
                telah membayar bayaran kepada<b><c:forEach var="i" items="${actionBean.listPermohonanPihak}" ><c:if test='${i.jenis.kod == "PG"}'>${i.pihak.nama}&nbsp;(${i.jenis.nama})</c:if>&nbsp;</c:forEach></b>sebanyak <b>RM <fmt:formatNumber pattern="#,##0.00" value="${actionBean.lelongan.deposit}"/></b>
