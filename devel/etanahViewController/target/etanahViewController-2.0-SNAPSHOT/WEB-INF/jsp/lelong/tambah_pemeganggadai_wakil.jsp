<%-- 
    Document   : tambah_pemeganggadai_wakil
    Created on : Apr 21, 2010, 3:51:48 PM
...
<s:form beanclass="etanah.view.stripes.lelong.MaklumatKehadiranNEWActionBean" id="maklumat_kehadiran">
    ...
    <fieldset class="aras1">
        ...
        <div class="subtitle displaytag" >
            ...
            <p>
                ...
                <s:text id="nokp1" name="kkk.wakilNoPengenalan" maxlength="12" onkeyup="validateNumber(this,this.value);" onchange="validateNewICLength(this.value);" style="width:139px;"/>
            ...
            <p align="center"><label></label>
                ...
                <%--<s:reset name="reset" value="Isi Semula" class="btn" onclick="clearText('maklumat_kehadiran');"/>--%>
