<%-- 
    Document   : maklumat_kehadiran_adat
    Created on : May 11, 2011, 5:27:31 PM
...
<script type="text/javascript">
    function tambahBaru(val,id){
        window.open("${pageContext.request.contextPath}/lelong/maklumat_kehadiran_adat?tambahBarule&idPihak="+val +"&id="+id, "eTanah",
    ...
    function refreshPage(){
        var url = '${pageContext.request.contextPath}/lelong/maklumat_kehadiran_adat?refreshpage';
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function removeWakil(val,id){
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/lelong/maklumat_kehadiran_adat?deleteWakil&idKehadiran='+val+'&id='+id;
            $.get(url,
            function(data){
...
<s:form beanclass="etanah.view.stripes.lelong.MaklumatKehadiranTanahAdatActionBean" id="kehadiran">
    <s:messages/>
    <s:errors/>&nbsp;
        ...
        <fieldset class="aras1">
            ...
            <display:table class="tablecloth" name="${actionBean.listKehadiran}"  cellpadding="0" cellspacing="0" requestURI="/lelong/maklumat_kehadiran_NEW" id="line">
                ...
                <display:column title="Nama" class="nama" style="text-transform:uppercase;">
                    ...
                    <c:if test="${line.senaraiRujukan.kod ne null}">
                        ${line.senaraiRujukan.nama}
                    </c:if>
                </display:column>
                ...
                <display:column title="Catatan" class="${line_rowNum}" style="text-transform:uppercase;">
                    ...
                    <ul>
                        <li><a id="kete${line_rowNum - 1}" title="Sila Klik Untuk Masukkan Keterangan" onclick="javascript:cacat2('${line_rowNum - 1}');return false;" onmouseover="this.style.cursor='pointer';">
            ...
            <p id="kosKehadiran" align="left">
                <label><font color="red">*</font> Kos Kehadiran : </label>
