...
<script>
    ...
    function save(event, f, idPembida) {
                ...
                <table class="tablecloth" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <tr class="odd">
                            ...
                            <s:hidden name="namaLama" value="${actionBean.pembida.pihak.nama}"/>
                            <s:hidden name="idPihak" value="${actionBean.pihak.idPihak}"/></td>
                            <td>
                                <s:textarea name="nama" onkeyup="this.value=this.value.toUpperCase()" rows="5" cols="50" value="${actionBean.pembida.pihak.nama}"/>
                            </td>
                        </tr>
                        <tr class="even">
                            <td>2.</td>
                            <td>Jenis Pengenalan</td>
                            <s:hidden name="jeniskpLama" value="${actionBean.pembida.pihak.jenisPengenalan.kod}"/>
                            <td>
                        ...
                        <tr class="odd">
                            <td>3.</td>
                            <td>No Pengenalan</td>
                            <s:hidden name="nokpLama" value="${actionBean.pembida.pihak.noPengenalan}"/>
                            <td><s:text name="nokp" onkeyup="this.value=this.value.toUpperCase();" value="${actionBean.pembida.pihak.noPengenalan}"/></td>
                        </tr>  
                        <tr class="odd">
                            <td>4.</td>
                            <td>No Telefon Bimbit</td>
                            <s:hidden name="noHPLama" value="${actionBean.pembida.pihak.noTelefonBimbit}"/>
                            <td><s:text name="noHP" onkeyup="this.value=this.value.toUpperCase();" value="${actionBean.pembida.pihak.noTelefonBimbit}"/></td>
                        </tr>  
                        <tr class="odd">
                            <td>4.</td>
                            <td>No. Bank Draf</td>
                        ...
                        <s:hidden name="idPermohonan" id = "idPermohonan" value="${actionBean.pembida.hakmilikPermohonan.permohonan.idPermohonan}"/>
                    </tbody>
                </table>
            </div>
            <center>
                <s:button name="saveTukar" id="simpan" value="Simpan" class="btn" onclick="save(this.name, this.form, '${actionBean.pembida.idPembida}');"/>
