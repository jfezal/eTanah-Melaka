...
<script type="text/javascript">
    function show_calendar2(idPermohonan){
        alert(idPermohonan);
        window.open("${pageContext.request.contextPath}/lelong/utilitiSemakanPembida?showFormB&idPermohonan= " + idPermohonan, "eTanah",
    ...
    function refreshPage(){
        var url = '${pageContext.request.contextPath}/lelong/UtilitiKeputusanLelongAction?refreshpage';
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function edit1(f, id1){
        ...
        window.open("${pageContext.request.contextPath}/lelong/UtilitiKeputusanLelongAction?cetak&"+queryString+"&notis.idNotis="+id1, "eTanah",
    ...
    <s:hidden id="idPermohonan" name="idPermohonan" value="${actionBean.idPermohonan}"/>
            <fieldset class="aras1">
                ...
                <p>
                    ...
                    <s:text name="tarikhLelong" id="datepicker" onclick="show_calendar2('${actionBean.idPermohonan}');" formatPattern="dd/MM/yyyy"/>&nbsp;
...
<!--                            <img src="${pageContext.request.contextPath}/images/not_ok.gif" height="15" width="15" alt="Klik Untuk Hapus"
                ...
                <c:if test="${same eq false}">
                    <p align="right">
                        <%--<<s:button name="simpanLelong" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>--%>
                            <s:submit name="simpanLelong" id="save" value="Simpan" class="btn" />
                ...
                <c:if test="${same eq true}">
                    <p align="right">
                        <%--<s:button name="saveBersama" id="save" value="Simpan2" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>--%>
                           <s:submit name="saveBersama" id="save" value="Simpan" class="btn" />
