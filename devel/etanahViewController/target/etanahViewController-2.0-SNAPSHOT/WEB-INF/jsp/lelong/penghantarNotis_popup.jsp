...
<script type="text/javascript">
    ...
    function edit(idPenghantarNotis){

        window.open("${pageContext.request.contextPath}/lelong/penghantarnotis?showEdit&idPenghantarNotis="+idPenghantarNotis, "eTanah",
    ...
    function hapus(idPenghantarNotis){
        if(confirm('Adakah pasti untuk hapus?')){
            ...
            $.get("${pageContext.request.contextPath}/lelong/penghantarnotis?delete&idPenghantarNotis=" + idPenghantarNotis,
            function(data){
                if(data=='1'){
                    ...
                    <display:table class="tablecloth" name="${actionBean.listPenghantar}"  cellpadding="0" cellspacing="0" id="line">
                        ...
                        <p align="center">
                            <img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                 onclick="edit('${line.idPenghantarNotis}');return false;" onmouseover="this.style.cursor='pointer';">
                        </p>
                    </display:column>
