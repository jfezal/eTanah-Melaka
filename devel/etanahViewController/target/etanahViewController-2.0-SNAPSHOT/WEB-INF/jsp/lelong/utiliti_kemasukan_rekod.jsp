<%-- 
    Document   : utiliti_kemasukan_rekod
    Created on : Nov 25, 2010, 7:50:02 PM
...
<script type="text/javascript">
    ...
    function muatNaikForm(notis) {
        ...
        var url = '${pageContext.request.contextPath}/lelong/kemasukkan_rekod?popupUpload&idNotis='+notis;
...
<s:form beanclass="etanah.view.stripes.lelong.UtilitiKemasukkanRekod">
            ...
            <fieldset class="aras1">
                ...
                <div class="content" align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.listNotis}"
                                   cellpadding="0" cellspacing="0" requestURI="/lelong/kemasukkan_rekod" id="line">
                        ...
                        <display:column title="Nama Penghantar Notis" >
                            <s:text name="namaPenghantar${line_rowNum-1}" id="namela${line_rowNum - 1}" >${line.penghantarNotis.nama}</s:text>
                        </display:column>

                        <display:column title="Status Penyampaian" class="${line_rowNum}">

                            <c:if test="${line.kodStatusTerima.nama ne null}" >
                                <s:select name="kodPenyampaian${line_rowNum-1}" id="kodPenyampaian${line_rowNum-1}">
