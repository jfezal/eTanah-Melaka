...
<div class="subtitle">
    <fieldset class="aras1">
        <legend>
            Maklumat Tambahan Kos Remedi
        </legend>
            <div class="content" align="center">
                <table>
                    <tr>
                        <td class="rowlabel1"> Tarikh Penyediaan :</td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="rowlabel1"> Tempoh Bayaran (Hari) :</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="rowlabel1"> Tarikh Tamat Tempoh Bayaran :</td>
                        <td></td>
                    </tr>
                </table>
            </div>
