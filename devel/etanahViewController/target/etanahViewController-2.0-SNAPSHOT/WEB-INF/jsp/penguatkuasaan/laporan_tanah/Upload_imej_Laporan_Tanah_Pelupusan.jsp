...
<script type="text/javascript">
    ...
    function refreshlptn(){
        var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?refreshpage';
        $.get(url,
        function(data){
            $('#page_div').html(data);
    ...
    function openFrame(type){        
        ...
        NoPrompt();
        //    alert(idHakmilik);
        window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?openFrame&idHakmilik="+idHakmilik+"&type="+type, "eTanah",
    ...
    <c:choose>
        ...
        function refreshpage2(type,pandanganImej,idLapor){
            ...
            //        alert(type);
            //        alert(idLapor);
            var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?refreshpage&type='+type+'&pandanganImej='+pandanganImej+'&idLapor='+idLapor;
        ...
        function deleteImage(idImej, idDokumen, type,f) {
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                //'${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?deleteImage&idImej='+idImej+'&idDokumen='+idDokumen+'&type='+type+'&imageType='+imageType+'&idLapor='+idLapor
                $.post('${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?deleteImage',{idImej:idImej,idDokumen:idDokumen,type:type,imageType:imageType,idLapor:idLapor,idlaporTnhSmpdn:idlaporTnhSmpdn},
                function(data){
                    $('#page_div').html(data);
