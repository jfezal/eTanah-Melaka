...
<script type="text/javascript">
    ...
    function tambahKawasan(){
        ...
        window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?kawasanPopup&idHakmilik="+idHakmilik, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
    }
    function editLaporKawasan(idMohonlaporKws){
        NoPrompt();
        window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?kawasanPopupUpdate&idMohonKw="+idMohonlaporKws, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
    }
    function removeLaporKawasan(idMohonlaporKws,f,tName)
    {   NoPrompt();
        if(confirm('Adakah anda pasti untuk menghapus data ini2?')) {
            var q = $(f).formSerialize();
            //alert(idMohonlaporKws);
            $.post('${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?deleteRow',{idKandungan:idMohonlaporKws,tName:tName},
            function(data){
                $('#page_div').html(data);
                ...
                <div id="perihaltanah">
                    ...
                    <div class="content" align="center">
                        <table class="tablecloth" border="0">
                            <tr>
                                Tanah Terlibat Berada Dalam Kawasan :
                                <td>
