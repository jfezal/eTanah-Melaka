...
<div class="subtitle">
    <s:form beanclass="etanah.view.penguatkuasaan.MaklumatPihakBerkepentinganActionBean" name="form1">
        ...
        <s:hidden name="valUrusanPilihan"/>
        <fieldset class="aras1">
            ...
            <p id="syerTerlibat" style="display:none">
                ...
                <s:text name="syerPembilang" id="syerPembilang" onchange="validateSyer(this.id);"/> /
                <s:text name="syerPenyebut" id="syerPenyebut" onchange="validateSyer(this.id);"/>
            </p>
            ...
            <p>
                ...
                <s:text name="pihak.noPengenalan" id="noPengenalan" size="30"
                        onkeyup="dodacheck(this.value,'jenisPengenalan', this.id);this.value=this.value.toUpperCase();"
            ...
            <c:if test="${newPihak || actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L'
                  ...
                  <p class="individu">
                      ...
                      <s:select name="pihak.tempatLahir" style="width:200px">
                          <s:option value="">Sila Pilih</s:option>
