<%-- 
    Document   : popup_keputusan_mesyuarat
...
<script type="text/javascript">
    ...
    function save(event, f){
        ...
        function(data){
            ...
            self.opener.refreshPageMesyuarat();
            self.close();
        },'html');
            ...
            try {
                ...
                for(var i=0; i<rowCount; i++) {
                    ...
                    if(null != chkbox && true == chkbox.checked) {
                        idKehadiran = $("#idKehadiran"+(i+j-1)).val();

                        if(document.getElementById("idKehadiran"+(i+j-1)) != null){

                            var url = '${pageContext.request.contextPath}/penguatkuasaan/maklumat_keputusan_mesyuarat?deleteKehadiran&idKehadiran='
                                +idKehadiran;
...
<s:form beanclass="etanah.view.penguatkuasaan.MaklumatKeputusanMesyuaratActionBean">
    <s:messages />
    <div class="subtitle">
            ...
            <c:if test="${!viewMaklumatAgensi}">
                ...
                <div class="content">
                    ...
                    <p>
                        ...
                        <s:textarea name="keputusan" rows="5" cols="50" id="tempat"/>&nbsp;
                    </p>
                        ...
                        <div align="center" >
                            ...
                            <table  width="100%" id="tbl" class="tablecloth" align="center">
                                <tr>
                                    ...
                                    <th  width="3%" align="center"><b>Jawatan</b></th>
                                    <th  width="3%" align="center"><b>Email</b></th>
                                </tr>
                                <c:set value="0" var="i"/>
                                <c:forEach items="${actionBean.senaraiKehadiranMesyuaratPenguatkuasaan}" var="line">
                                    <tr style="font-weight:bold">
                                        <td><s:checkbox name="pilih${i}" id="pilih${i}" /> </td>
                                        <td><c:out value="${i+1}"/></td>
                                        <td><em>*</em>
                                            <s:select name="kodAgensi${i}" id="kodAgensi${i}" value="${line.kodAgensi.kod}">
                                        ...
                                        <td>
                                            <input type="text" size="30" name="nama${i}" id="nama${i}" value="${line.nama}" class="normal_text">
                                        </td>
                                        <td>
                                            <input type="text" size="15" name="jawatan${i}" id="jawatan${i}" value="${line.jawatan}" class="normal_text">
                                        </td>
                                        <td>
                                            <input type="text" size="20" name="email${i}" id="email${i}" value="${line.email}" onblur="return ValidateEmail('${i}')">
                                            <input type="hidden" name="idKehadiran${i}" id="idKehadiran${i}" value="${line.idKehadiran}">
                                        </td>
                                        </td>
                                    </tr>
