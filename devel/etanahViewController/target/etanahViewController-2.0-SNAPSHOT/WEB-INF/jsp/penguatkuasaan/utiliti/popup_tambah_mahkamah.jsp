        ...
        <fieldset class="aras1">
            ...
            <div class="content">
                ...
                <fieldset class="aras2">
                    ...
                    <div align="center" >
                        ...
                        <table  width="60%" id="tbl" class="tablecloth" align="center">
                            ...
                            <c:set value="0" var="i"/>
                            <c:forEach items="" var="line">
                                <tr style="font-weight:bold">
                                    <td><s:checkbox name="pilih${i}" id="pilih${i}" /> </td>
                                    <td><c:out value="${i+1}"/></td>
                                    <td><s:text name="nama${i}" id="nama${i}" size="30" onchange="this.value=this.value.toUpperCase();"/></td>
                                    <td><s:select name="jawatan${i}" id="jawatan${i}">
                                            <s:option value="">Sila Pilih</s:option>
                ...
                <p align="right">
                    ...
                    <s:button class="btn" value="Simpan" name="simpanRecord"  onclick="if(validateForm())save(this.name,this.form);" />
