...
<s:form beanclass="etanah.view.penguatkuasaan.GisIntegrationActionBean" name="form">
    ...
    <html>
        ...
        <body>
            <s:button name="semakPUGIS" id="semakPUGIS" value="Semak PU" class="btn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
        </body>
    </html>
</s:form>