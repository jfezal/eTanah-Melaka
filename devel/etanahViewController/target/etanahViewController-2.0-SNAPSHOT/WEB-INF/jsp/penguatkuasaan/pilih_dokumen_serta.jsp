...
//            alert(radio) ;
            ...
            var idRujukan = $('#idRujukan').val() ;
               var url = '${pageContext.request.contextPath}/penguatkuasaan/sedia_jabatan?simpanKodSalinan&kod=' + kod + '&radio=' + radio + '&idRujukan=' + idRujukan ;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
...
//                    alert($('#kodAsal').val());
    ...
    <s:errors/>
        <s:messages/>
        <div class="subtitle">
            <s:form beanclass="etanah.view.penguatkuasaan.JabatanTeknikalActionBean" name="salinan">
            ...
            <s:hidden name="data" id="data"/>
                <fieldset class="aras1">
                    ...
                    <p>
                        <display:table style="width:100%" class="tablecloth" name="${actionBean.listKandunganFolder}" pagesize="100" cellpadding="0" cellspacing="0" requestURI="/penguatkuasaan/sedia_jabatan" id="line">
