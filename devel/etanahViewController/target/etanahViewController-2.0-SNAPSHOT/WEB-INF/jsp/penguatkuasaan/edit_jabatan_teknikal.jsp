...
//                alert(document.getElementById('mandatori2').value);
       ...
       function search(index, kodAsal, idRujukan){
          <%--  alert(kodAsal) ;--%>
                // alert("search:"+index);
                var url = '${pageContext.request.contextPath}/penguatkuasaan/sedia_jabatan?kodAgensiPopup2&index='+index+'&kodAsal='+kodAsal + '&idRujukan=' + idRujukan;
       ...
       function searchDokumen(index, kodAsal, idRujukan){
          <%--  alert(kodAsal) ;--%>
                // alert("search:"+index);
                var url = '${pageContext.request.contextPath}/penguatkuasaan/sedia_jabatan?kodAgensiPopup3&index='+index+'&kodAsal='+kodAsal + '&idRujukan=' + idRujukan;
                window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=910,height=800,scrollbars=yes");
        }
...
//                alert(idRujukan + " and row = " + idSalinan) ;
                    ...
                    var url = '${pageContext.request.contextPath}/penguatkuasaan/sedia_jabatan?deleteRujukanSalinan&idRujukan='+idRujukan+'&idSalinan='+idSalinan;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
...
//                alert(idRujukan + " and row = " + idSalinan) ;
                        if(confirm('Adakah anda pasti?')) {
                    var url = '${pageContext.request.contextPath}/penguatkuasaan/sedia_jabatan?deleteRujukanDokumen&idRujukan='+idRujukan+'&idDokumen='+idDokumen;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
                        alert("Rekod dihapuskan") ;
...
//                alert("Hi");
    ...
    <s:errors/>
    <s:messages/>
    <s:form beanclass="etanah.view.penguatkuasaan.JabatanTeknikalActionBean" name="edit">
         ...
         <fieldset class="aras1">
             ...
             <div class="content" align="center">
                 ...
                 <display:table class="tablecloth" name="${actionBean.prs}" cellpadding="0" cellspacing="0" id="line"
                            requestURI="${pageContext.request.contextPath}/penguatkuasaan/sedia_jabatan">
