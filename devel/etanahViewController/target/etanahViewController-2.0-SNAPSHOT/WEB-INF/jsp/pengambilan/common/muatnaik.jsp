<%-- 
    Document   : muatnaik
    Created on : May 28, 2012, 4:39:50 PM
    Author     : User
--%>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = '${pageContext.request.contextPath}/pengambilan/muat_naik_imej?showRefresh';
        $.ajax({
            type:"GET",
            url : url,
            success : function(data) {
...
<s:form beanclass="etanah.view.stripes.pengambilan.MuatNaikImejActionBean">
