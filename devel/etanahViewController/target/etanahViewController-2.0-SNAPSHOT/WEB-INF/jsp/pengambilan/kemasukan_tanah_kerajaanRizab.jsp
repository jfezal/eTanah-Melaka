<%-- 
    Document   : kemasukan_tanah_kerajaanRizab
    Created on : 06-Dec-2010, 18:09:27
    Author     : nordiyana
--%>
...
function save(){
     ...
     function tambahPengawalBaru(){
            window.open("${pageContext.request.contextPath}/pengambilan/maklumat_hakmilikpengambilan?PengawalPopup", "eTanah",
...
function validation() {
    ...
    function filterDaerah(kodDaerah,f){
        ...
        var url = '${pageContext.request.contextPath}/pengambilan/maklumat_hakmilikpengambilan?penyukatanBPM&kodDaerah='+kodDaerah;

        f.action = url;
        <%--var kd = document.getElementById("kodBandarPekanMukim");
        var kd2 = kd.options[kd.selectedIndex].value;
        f.action = kd2;--%>
...
<div class="subtitle">
         ...
         <s:form beanclass="etanah.view.stripes.pengambilan.MaklumatHakmilikActionBean" >
            ...
            <s:hidden name="idTanahRizabPermohonan" id="idTanahRizabPermohonan" value="#{actionBean.rizab.idTanahRizabPermohonan}"/>
            <p>
            ...
            <p>
                ...
                <s:select name="rizab.daerah.kod" id="kodDaerah" onchange="filterDaerah(this.value,this.form);" >
           ...
           <p>
            ...
            <p>
                ...
                <s:select name="rizab.rizab.kod" id="rizab" >
                    <s:option value="">--Sila Pilih--</s:option>
