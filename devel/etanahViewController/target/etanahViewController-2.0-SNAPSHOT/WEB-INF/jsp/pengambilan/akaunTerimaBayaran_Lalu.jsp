...
function validateNumber(elmnt,content) {
    ...
    function popupList(idPihak,idHakmilik){
        var url = '${pageContext.request.contextPath}/pengambilan/akaunTerimaBayaran_Lalu?showAkuanBayaranList&idPihak='+idPihak+'&idHakmilik='+idHakmilik;
...
<s:form beanclass="etanah.view.stripes.pengambilan.AkaunTerimaBayaran_LaluActionBean">
<div  id="hakmilik_details">
    <div align="center">
        <table style="width:99.2%" bgcolor="purple">
            <tr><td width="100%" height="20" ><div style="background-color: purple;" align="center">
                        <font style="font-family: Tahoma; font-size: 16px; font-weight: bold;"><font color="white">AKUAN TERIMA BAYARAN</font></font>
            </div></td></tr>
        </table>
    </div><br /><br />
    ...
    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
        ...
        <display:column title="Tuan Tanah" >
            <c:forEach items="${line.hakmilik.senaraiPihakBerkepentingan}" var="senarai">
                <s:link beanclass="etanah.view.stripes.pengambilan.AkaunTerimaBayaran_LaluActionBean"
