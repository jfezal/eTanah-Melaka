...
<script type = "text/javascript">
    ...
    <%--alert("search:"+index);--%>
            var url = '${pageContext.request.contextPath}/pengambilan/melaka/sedia_jabatan?kodAgensiPopup&index='+index;
        ...
        function removePermohonanRujukanLuar(idRujukan,row){
            if(confirm('Adakah anda pasti?')) {
                var url = '${pageContext.request.contextPath}/pengambilan/melaka/sedia_jabatan?deleteRujukan&idRujukan='
                    +idRujukan;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
    ...
    <%--   $(document).ready( function() {
            ...
            function refreshAgensi(){
                var url = '${pageContext.request.contextPath}/pengambilan/melaka/sedia_jabatan?refreshPage';
                $.get(url,
                function(data){
                    $('#page_div').html(data);
                },'html');
...
<s:form beanclass="etanah.view.stripes.pengambilan.JabatanTeknikalActionBean" name="form">
    <s:messages/>
