...
<script language="javascript" type="text/javascript">
    ...
    return true;
                ...
                <s:form beanclass="etanah.view.stripes.pengambilan.MMKNSEK4AduanActionBean"  id="form2">
                    <%--SekAduanMMK4ActionBean--%>
    <s:messages/>
    <s:errors/>
                ...
                <div class="content" align="center">
                    <table border="0" width="80%">
                       ...
                       <tr><td><br/><b>1. <%--<font style="text-transform: uppercase">PERMOHONAN PENGAMBILAN TANAH DI ATAS LOT
                                    ...
                                    <table  width="90%" id="table5${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPentadbir[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount5 eq 1}">
                                                <tr> <td><b>5.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" cols="130" name="syorPentadbir${i}${recordCount5}" id="syorPentadbir${i}${recordCount5}" class="normal_text" value="${senarai.kandungan}" /></td>
                                            ...
                                            <tr>  <td></td>
                                                ...
                                                <td><s:textarea rows="5" cols="130" name="syorPentadbir${i}${recordCount5}" id="syorPentadbir${i}${recordCount5}" class="normal_text" value="${senarai.kandungan}" /></td>
                                            </c:if>
                                    ...
                                    <c:set var="k" value="1" />
                                      <c:forEach items="${actionBean.senaraiKertasKandungan6}" var="line">
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan6${k}" id="kandungan6${k}" class="normal_text" rows="5" cols="150">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                        ...
                        <tr><td><b> &nbsp;</b><font><s:textarea name="ulasan1.kandungan" rows="5" readonly="false" cols="150" id="ulasan1" class="normal_text"/>
                                </font></td></tr><br>
                                    ...
                                    <table  width="90%" id="table8${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPengarah[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount8 eq 1}">
                                                <tr> <td><b>8.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" cols="130" readonly="true" name="syorPengarah${i}${recordCount8}" id="syorPengarah${i}${recordCount8}" class="normal_text" value="${senarai.kandungan}" /></td>
                                                    <td><s:hidden name="count8${i}" id="count8${i}" value="${(fn:length(actionBean.senaraiSyorPengarah[i]))}" /> </td>
                                                    <td><s:button class="btn" value="Tambah 8.${i}" name="add" id="tambah8${i}" onclick="addDynamicRow8('table8${i}','count8${i}')" disabled="true"/></td>
                                                    <td><s:button class="btn" value="Hapus 8.${i}" name="hapus" id="hapus8${i}" onclick="deleteDynamicRow8('table8${i}','count8${i}')" disabled="true"/></td>
                                            </c:if>
                                            <c:if test="${recordCount8 ne 1}">
                                            <tr>  <td></td>
                                                  <td><b><c:out value="${actionBean.str[recordCount8-1]}"/>.</b></td>
                                                  <td><s:textarea rows="5" cols="130" readonly="true" class="normal_text" name="syorPengarah${i}${recordCount8}" id="syorPengarah${i}${recordCount8}" value="${senarai.kandungan}"/></td>
                                            </c:if>
                        ...
                        <s:button class="btn"  value="Tambah" name="add" disabled="true" onclick="addTable8('Tables8')"/>
                        <s:button class="btn" value="Hapus" name="add" disabled="true" onclick="deleteTable8()"/>
                ...
                <div class="content" align="center">
                    <table border="0" width="80%">
                       ...
                       <tr><td><br/><b>1. <%--<font style="text-transform: uppercase">PERMOHONAN PENGAMBILAN TANAH DI ATAS LOT
                                ...
                                <table id ="dataTable3">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan3${i}" id="kandungan3${i}" rows="5" cols="150" readonly="true">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                        <s:hidden name="idKandungan3${i}" id="idKandungan3${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                        ...
                        <tr><td align="right"><s:button name="perihalPermohonan" value="Tambah" class="btn" disabled="true" onclick="addRow3('dataTable3')" />
                                <s:button name="perihalPermohonan" value="Hapus" disabled="true" class="btn" onclick="deleteRow3()" />
                            </td>
                        </tr>
                        ...
                        <tr><td>
                                <table id ="dataTable4">
                                    <c:set var="i" value="1" /><c:forEach items="${actionBean.senaraiKertasKandungan4}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan4${i}" readonly="true" id="kandungan4${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                        <s:hidden name="idKandungan4${i}" id="idKandungan4${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                        ...
                        <tr><td align="right"><s:button name="nilaianTanah" value="Tambah" disabled="true" class="btn" onclick="addRow4('dataTable4')" />
                                <s:button name="nilaianTanah" value="Hapus" class="btn" disabled="true" onclick="deleteRow4()" />
                            </td>
                        </tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b><font style="text-transform:uppercase">5. SYOR PENTADBIR TANAH DAERAH ${actionBean.hakmilik.daerah.nama}</font></b></td></tr>
                        ...
                        <c:forEach var="i" begin="1" end="${actionBean.count5}">
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPentadbir[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount5 eq 1}">
                                                <tr> <td><b>5.${i}</b></td>
                                                    ...
                                                    <td><s:button class="btn" value="Hapus 5.${i}" disabled="true" name="hapus" id="hapus5${i}" onclick="deleteDynamicRow5('table5${i}','count5${i}')"/></td>
                                            </c:if>
                                            <c:if test="${recordCount5 ne 1}">
                                            <tr>  <td></td>
                                                <td><b><c:out value="${actionBean.str[recordCount5-1]}"/>.</b></td>
                            ...
                            <tr><td align="right">
                                    ...
                                    <s:button class="btn" value="Tambah" name="add" disabled="true" onclick="addTable5('Tables5')"/>
                                    <s:button class="btn" value="Hapus" name="add" disabled="true" onclick="deleteTable5()"/>
                        ...
                        <tr><td>
                                <table id ="dataTable6">
                                    <c:set var="k" value="1" />
                                      <c:forEach items="${actionBean.senaraiKertasKandungan6}" var="line">
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea readonly="true" name="kandungan6${k}" id="kandungan6${k}" rows="5" cols="150">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                                        <s:hidden name="idKandungan6${k}" id="idKandungan6${k}" value="${line.idKandungan}" />
                                            <c:set var="k" value="${k+1}" />
                                        </c:forEach>
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>7. KEPUTUSAN JAWATANKUASA KHAS PENGAMBILAN TANAH NEGERI MELAKA</b></td></tr>
                        <tr><td><b> &nbsp;</b><font><s:textarea name="ulasan1.kandungan" rows="5" readonly="true" cols="150" id="ulasan1"/>
                                </font></td></tr><br>
                            ...
                            <tr><td>
                                    <table  width="90%" id="table8${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPengarah[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount8 eq 1}">
                                                <tr> <td><b>8.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" cols="130" name="syorPengarah${i}${recordCount8}" id="syorPengarah${i}${recordCount8}" value="${senarai.kandungan}" class="normal_text"/></td>
                                                    <td><s:hidden name="count8${i}" id="count8${i}" value="${(fn:length(actionBean.senaraiSyorPengarah[i]))}" /> </td>
                                            ...
                                            <tr>  <td></td>
                                                  <td><b><c:out value="${actionBean.str[recordCount8-1]}"/>.</b></td>
                                                  <td><s:textarea rows="5" cols="130" name="syorPengarah${i}${recordCount8}" id="syorPengarah${i}${recordCount8}" value="${senarai.kandungan}" class="normal_text"/></td>
                                            </c:if>
                                            <s:hidden name="kand8${i}${recordCount8}" id="kand8${i}${recordCount8}" value="${senarai.idKandungan}" />
                                        </c:forEach>
                                    </table>
