...
<script type="text/javascript">
    ...
    <%--alert(id);--%>
            ...
            //            alert(idHakmilik);
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?showFormPopUp&idHakmilik="+idHakmilik, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        {   
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName,q,
                function(data){
                    //                    $('#page_div').html(data);
        ...
        {
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?showFormPopUp&idKandungan="+idKandungan, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
...
//                opener.refreshV2('main');
        ...
        function uploadForm(pandanganImej,idlaporTnhSmpdn,idHakmilik) {
            NoPrompt();
            //            alert(idlaporTnhSmpdn);
            var idLapor = $('#idLapor').val();
            var idHakmilik = $('#idHakmilik').val();
            //            alert(idLapor);
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?uploadDoc&pandanganImej="+pandanganImej+"&idLapor="+idLapor+'&idlaporTnhSmpdn='+idlaporTnhSmpdn+"&idHakmilik="+idHakmilik, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
</script>
<body>
                ...
                <div id="perihaltanah">
                    ...
                    <div class="content" align="center">
                        <table class="tablecloth" border="0">
                            <tr>
                                <th>&nbsp;</th><th>ID. Hakmilik</th><th>No. Lot</th><th>Kegunaan Tanah</th><th>Keadaan Tanah</th><th>Jarak Dari Tanah Diambil</th><th>Catatan</th><th>Milik Kerajaan</th><th>Tindakan</th>
                            </tr>
                            <%--UTARA--%>
