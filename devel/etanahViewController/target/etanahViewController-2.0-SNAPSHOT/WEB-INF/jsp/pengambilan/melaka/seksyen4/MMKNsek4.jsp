...
<script language="javascript" type="text/javascript">
    ...
    <%--document.form2.rowCount2.value=rowCount2 +1;--%>
        ...
        function deleteRow2()
        {
            ...
            if (document.getElementById('idKandungan2'+(i)) != null) {
                var url = '${pageContext.request.contextPath}/pengambilan/borang_mmkn_sek4?deleteSingle&idKandungan='
                    +idKandungan;
    ...
    <%--document.form2.rowCount4.value=rowCount4 +1;--%>
        ...
        function deleteRow4()
        {
            ...
            if (document.getElementById('idKandungan4'+(i)) != null) {
                var url = '${pageContext.request.contextPath}/pengambilan/borang_mmkn_sek4?deleteSingle&idKandungan='
                    +idKandungan;
...
<s:form beanclass="etanah.view.stripes.pengambilan.PengambilanMMKNSek4ActionBean"  id="form2">
    <s:messages/>
    <s:errors/>
    <c:if test="${empty actionBean.permohonan.senaraiPemohon}"><font color="red" size="3"><b>Sila masukkan pemohon di tab pemohon terlebih dahulu.</b></font></c:if>
    <c:if test="${!empty actionBean.permohonan.senaraiPemohon}">
                ...
                <fieldset class="aras1" id="locate">
                    <div class="content" align="center">
                        <table border="0" width="80%">
                                    ...
                                    <table id ="dataTable1">
                                        ...
                                        <c:forEach items="${actionBean.senaraiKertasKandungan21}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font><s:textarea name="kandungan1${i}" class="normal_text" id="kandungan1${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                            ...
                            <tr><td>
                                    <table id ="dataTable3">
                                        ...
                                        <c:forEach items="${actionBean.senaraiKertasKandungan23}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font><s:textarea name="kandungan3${i}" class="normal_text" id="kandungan3${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                            ...
                            <tr><td>
                                    <table id ="dataTable4">
                                        ...
                                        <c:forEach items="${actionBean.senaraiKertasKandungan24}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font><s:textarea name="kandungan4${i}" class="normal_text" id="kandungan4${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                            ...
                            <tr><td> &nbsp;</td></tr>
                            <tr><td><b>3. ULASAN YB ADUN KAWASAN DAN JABATAN - JABATAN TEKNIKAL </b></td></tr>
                            <tr><td>
                                    <table id ="dataTable5">
                                        <c:set var="i" value="1" />
                                        <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font><s:textarea name="kandungan5${i}" class="normal_text" id="kandungan5${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                            ...
                            <tr><td align="right"><s:button name="ulasanAdun" value="Tambah" class="btn" onclick="addRow5('dataTable5')" />
                                    <s:button name="ulasanAdun" value="Hapus" class="btn" onclick="deleteRow5()" />
                            <tr><td> &nbsp;</td></tr>
                            <tr><td> &nbsp;</td></tr>
                            ...
                            <tr><td>
                                    <table id ="dataTable6">
                                        ...
                                        <c:forEach items="${actionBean.senaraiKertasKandungan4}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font><s:textarea name="kandungan6${i}" class="normal_text" id="kandungan6${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                        ...
                                        <table  width="90%" id="table4${i}" >
                                            ...
                                            <c:forEach items="${actionBean.senaraiPerakuanPengarah[i]}" var="senarai">
                                                ...
                                                <c:if test="${recordCount4 eq 1}">
                                                    <tr> <td><b>5.${i}</b></td>
                                                        <td colspan="2"><s:textarea rows="5" cols="130" class="normal_text" disabled="false" name="perakuanPengarah${i}${recordCount4}" id="perakuanPengarah${i}${recordCount4}" value="${senarai.kandungan}" /></td>
                                                        <td><s:hidden name="count4${i}" id="count4${i}" value="${(fn:length(actionBean.senaraiPerakuanPengarah[i]))}" /> </td>
                                                        <td><s:button class="btn" value="Tambah 5.${i}" disabled="false" name="add" id="tambah4${i}" onclick="addDynamicRow4('table4${i}','count4${i}')"/></td>
                                                        <td><s:button class="btn" value="Hapus 5.${i}" disabled="false" name="hapus" id="hapus4${i}" onclick="deleteDynamicRow4('table4${i}','count4${i}','${formPtg}','${form1}')"/></td>
                                                    </c:if>
                                                    <c:if test="${recordCount4 ne 1}">
                                                    <tr>  <td></td>
                                                        <td><b><c:out value="${actionBean.str[recordCount4-1]}"/>.</b></td>
                                                        <td><s:textarea rows="5" cols="130" name="perakuanPengarah${i}${recordCount4}" class="normal_text" disabled="false" id="perakuanPengarah${i}${recordCount4}" value="${senarai.kandungan}" /></td>
                                                    </c:if>
                            ...
                            <tr><td align="right">
                                    ...
                                    <s:button class="btn" value="Tambah" disabled="false" name="add" onclick="addTable4('Tables4')"/>
                                    <s:button class="btn" value="Hapus" disabled="false" name="add" onclick="deleteTable4('${formPtg}','${form1}')" style="font-size:12px"/>
                        ...
                        <table border="0" width="80%">
                            ...
                            <tr><td>
                                    <table id ="dataTable1">
                                        ...
                                        <c:forEach items="${actionBean.senaraiKertasKandungan21}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font><s:textarea name="kandungan1${i}" class="normal_text" id="kandungan1${i}" rows="5" cols="150" disabled="false">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                            <s:hidden name="idKandungan1${i}" id="idKandungan1${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                            ...
                            <tr><td align="right"><s:button name="perihalPermohonan" value="Tambah" disabled="false" class="btn" onclick="addRow1('dataTable1')" />
                                    <s:button name="perihalPermohonan" value="Hapus" disabled="false" class="btn" onclick="deleteRow1()" />
                            ...
                            <tr><td>
                                    <table id ="dataTable2">
                                        ...
                                        <c:forEach items="${actionBean.senaraiKertasKandungan22}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font <%--style="text-transform: uppercase"--%>><s:textarea name="kandungan2${i}" class="normal_text" id="kandungan2${i}" rows="5" disabled="false" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                            <s:hidden name="idKandungan2${i}" id="idKandungan2${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                            ...
                            <tr><td align="right"><s:button name="perihalTanah" value="Tambah" disabled="false" class="btn" onclick="addRow2('dataTable2')" />
                                    <s:button name="perihalTanah" value="Hapus" class="btn" disabled="false" onclick="deleteRow2()" />
                            ...
                            <tr><td>
                                    <table id ="dataTable3">
                                        ...
                                        <c:forEach items="${actionBean.senaraiKertasKandungan23}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font <%--style="text-transform: uppercase"--%>><s:textarea name="kandungan3${i}" class="normal_text" id="kandungan3${i}" disabled="false" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                            <s:hidden name="idKandungan3${i}" id="idKandungan3${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                            ...
                            <tr><td align="right"><s:button name="anggaranNilaianPampasan" disabled="false" value="Tambah" class="btn" onclick="addRow3('dataTable3')" />
                                    <s:button name="anggaranNilaianPampasan" value="Hapus" disabled="false" class="btn" onclick="deleteRow3()" />
                            ...
                            <tr><td>
                                    <table id ="dataTable4">
                                        ...
                                        <c:forEach items="${actionBean.senaraiKertasKandungan24}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font <%--style="text-transform: uppercase"--%>><s:textarea name="kandungan4${i}" class="normal_text" id="kandungan4${i}" disabled="false" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                            <s:hidden name="idKandungan4${i}" id="idKandungan4${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                            ...
                            <tr><td align="right"><s:button name="perihalPemohon" value="Tambah" disabled="false" class="btn" onclick="addRow4('dataTable4')" />
                                    <s:button name="perihalPemohon" value="Hapus" class="btn" disabled="false" onclick="deleteRow4()" />
                            ...
                            <tr><td align="right"><s:button name="ulasanAduan" disabled="false" value="Tambah" class="btn" onclick="addRow5('dataTable5')" />
                                    <s:button name="ulasanAdun" disabled="false" value="Hapus" class="btn" onclick="deleteRow5()" />
                            <tr><td> &nbsp;</td></tr>
                            <tr><td> &nbsp;</td></tr>
                            <tr><td><b>4. PERAKUAN PENTADBIR TANAH ${actionBean.hakmilik.daerah.nama} </b></td></tr>
                            <tr><td>
                                    <table id ="dataTable6">
                                        <c:set var="i" value="1" />
                                        <c:forEach items="${actionBean.senaraiKertasKandungan4}" var="line">
                                            <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                                <td><font><s:textarea name="kandungan6${i}" class="normal_text" id="kandungan6${i}" rows="5" disabled="false" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                            <s:hidden name="idKandungan6${i}" id="idKandungan6${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                            ...
                            <tr><td align="right">
                                    <s:button name="perakuanPentadbir" disabled="false" value="Tambah" class="btn" onclick="addRow6('dataTable6')" />
                                    <s:button name="perakuanPentadbir" disabled="false" value="Hapus" class="btn" onclick="deleteRow6()" />
                            <tr><td> &nbsp;</td></tr>
