<%-- 
    Document   : permohonanTerdahulu_ppelan
    Created on : 11-Jun-2010, 11:16:23
    Author     : nordiyana
--%>
    ...
    <fieldset class="aras1">
        ...
        <div class="content" align="center">
                     <div class="content" align="center">
                        ...
                        <display:column title="ID Permohonan/No. Fail">
             ...
             <table>
                    <tr>
                        <td class="rowlabel1">Lain - lain hal :</td>
                        <td><s:textarea name="lainlainhal" rows="5" cols="150"/></td>
                        <td>&nbsp;</td>
                    </tr>
                        </table>
