<%--
    Document   : maklumat_hakmilik_pengambilanPtsp
            ...
            <c:if test="${!edit}">
                ...
                <p align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="20" cellpadding="0" cellspacing="0"
                        ...
                        <display:column  title="Pertikaian<br> <input type='checkbox'  id='semua' name='semua' onclick='javascript:selectAll(this);' />" >
                        <div align="center">
                ...
                <s:button name="simpanPertikaian" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div');"/>
