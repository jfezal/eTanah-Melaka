...
<s:form beanclass="etanah.view.stripes.pengambilan.PerintahActionBean">
                        ...
                        <c:forEach items="${line.hakmilik.senaraiPihakBerkepentingan}" var="senarai">
                             <table border="0">
                              <tr>
                                 ...
                                 <td>
                                    <s:link beanclass="etanah.view.stripes.pengambilan.PerintahActionBean"
                                            event="pihakDetails" onclick="return ajaxLink(this, '#hakmilik_details');" >
                                        <s:param name="show" value="${actionBean.show}"/>
                                        <s:param name="hide" value="${actionBean.hide}"/>
          ...
          <fieldset class="aras1">
              <div class="content" align="left">
                  <table align="center"  width="70%" border="0">
                      ...
                      <c:if test="${actionBean.hide eq 'FALSE'}">
                      <tr>
                      ...
                      <tr>
                          ...
                          <td >
                              <c:if test="${showEdit}"> 
                                  <%--b4 this comment edit on 5/10/2011--%>
                                  <s:text name="tarikhTerimaPerintah" class="datepicker" id="tarikhTerimaPerintah" formatPattern="dd/MM/yyyy" disabled="true"/>
                              </c:if>
                              <c:if test="${showDetails}">
                                  <%--<s:text name="tarikhTerimaPerintah" class="datepicker" id="tarikhTerimaPerintah" size="12" formatPattern="dd/MM/yyyy"/>--%>
                                  <fmt:formatDate pattern="dd/MM/yyyy" value="${actionBean.tarikhTerimaPerintah}" />
                                  <s:hidden name="tarikhTerimaPerintah" class="datepicker" id="tarikhTerimaPerintah" formatPattern="dd/MM/yyyy"/>
                              </c:if>
                          </td>
                      </tr>
                      </c:if>
