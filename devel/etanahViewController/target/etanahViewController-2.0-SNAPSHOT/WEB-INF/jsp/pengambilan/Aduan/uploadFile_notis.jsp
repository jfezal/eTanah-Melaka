...
<s:form beanclass="etanah.view.stripes.pengambilan.PenerimaanNotisBorangAduanActionBean">
    ...
    <fieldset class="aras1">
        ...
        <p>
            ...
            <c:if test="${actionBean.isJPPH eq 'true'}">
                <s:submit name="processUploadDocJPPH" value="Simpan" class="btn" />
            </c:if>
            <%--<c:if test="${actionBean.isPihak eq 'true'}">
                <s:submit name="processUploadDoc" value="Simpan" class="btn" />
            </c:if>--%>
             <%--<s:submit name="processUploadDoc" value="Simpan" class="btn" />--%>
             <s:button name="processUploadDoc" id="simpan" value="Simpan" class="btn" onclick="saveAduan(this.name, this.form);"/>
