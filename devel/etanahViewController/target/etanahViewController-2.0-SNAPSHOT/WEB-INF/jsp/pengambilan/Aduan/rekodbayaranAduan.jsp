...
<script type="text/javascript">
    ...
    function popupList(idPihak,idHakmilik){
        var url = '${pageContext.request.contextPath}/pengambilan/rekodBayaranAduan?showAmbilPampasanList&idPihak='+idPihak+'&idHakmilik='+idHakmilik;
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <%--<c:forEach items="${actionBean.ambilPampasanList}" var="list">
                                 ...
                                 <c:set value="${count + 1}" var="count"/>
                                <a href="javascript:popupList('${actionBean.permohonanPihak.pihak.idPihak}','${actionBean.hakmilik.idHakmilik}');">
                                    <%--<c:out value="${count}" />--%>
                                    <img src="${pageContext.request.contextPath}/pub/images/icons/_active__document.png"
                                     onclick="javascript:popupList('${actionBean.permohonanPihak.pihak.idPihak}','${actionBean.hakmilik.idHakmilik}');" height="30" width="30" alt="papar"
