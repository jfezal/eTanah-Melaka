...
<script type="text/javascript">
    ...
    function p(v){
        ...
        $.get("${pageContext.request.contextPath}/pengambilan/depositMahkamahedit?pihakDetails&idPihak="+v,
        function(data){
            //alert(data);
                    ...
                    <p>
                        <display:table style="width:75%" class="tablecloth" name="${actionBean.permohonanPihakPendepositList}"
                            ...
                            <display:column title="Nama">
                                ...
                                <s:link beanclass="etanah.view.stripes.pengambilan.depositMahkamahActionBean"
                            ...
                            <display:column title="Bangsa" property="pihak.bangsa.nama" style="text-transform:uppercase;vertical-align:top;" />
            ...
            <c:if test="${actionBean.pihak ne null}">
                <div class="subtitle" id="main">
                    ...
                    <div class="content" align="center">
                        ...
                        <table class="tablecloth" border="0" width="75%">
                            <tr>
                                <td><font color="red" size="4">*</font>Kod Deposit :</td>
                                <td>
                                    <s:select name="kodDepositSpeks" id="kodDepositSpeks">
                                        <s:option value="0">Sila Pilih</s:option>
                                        <s:option value="231">231 - Pulangan Deposit</s:option>
                                        <s:option value="211">211 - Bil Pelbagai</s:option>
                                    </s:select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <s:select name="caraBayaran" id="caraBayar">
                                        <s:option value="0">Sila Pilih</s:option>
                                        <s:option value="CT" onclick="Show();">CT - Cek Tempatan</s:option>
                                        <s:option value="EF" onclick="Show();">EFT - Wang Dalam Pindahan</s:option>
