...
<html>
    <head>
        ...
        <title>NOTIFIKASI ARAHAN PENYEDIAAN BAYARAN PAMPASAN DAN LAIN-LAIN BAYARAN</title>
    </head>
    <body>
        <s:form beanclass="etanah.view.stripes.pengambilan.ArahanPtdActionBean">
           <s:messages/>
           <s:errors/>
           <div class="subtitle">
                <fieldset class="aras1">
                    ...
                    <div class="content" align="">
                        <table border="0">
                           ...
                           Arahan penyediaan bayaran pampasan dan lain-lain bayaran.
                            </font>
                        </table>
                    </div>
                </fieldset>
