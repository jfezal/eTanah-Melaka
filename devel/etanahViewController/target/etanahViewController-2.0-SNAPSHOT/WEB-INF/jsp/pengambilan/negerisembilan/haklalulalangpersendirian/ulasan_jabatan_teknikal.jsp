<%-- 
    ...
    Created on : Okt 22, 2010, 2:28:55 PM
    Author     : massita
--%>
...
<script type="text/javascript">
    ...
    function addNewUlasan(){
            window.open("${pageContext.request.contextPath}/pengambilan/ulasan_jabatan_teknikalPHLL?ulasanPopup", "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
    }
    function refreshUlasanJabatanTeknikalPage(){
    var url = '${pageContext.request.contextPath}/pengambilan/ulasan_jabatan_teknikalPHLL?refreshpage';
    $.get(url,
    function(data){
    $('#page_div').html(data);
    },'html');
    ...
    function removeSingle(val)
    {
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/pengambilan/ulasan_jabatan_teknikalPHLL?deleteSingle&idKertas='+val;
            $.get(url,
            function(data){
            $('#page_div').html(data);
            ...
            <legend>Ulasan Jabatan Teknikal</legend>
                <div class="content" align="center">
                    <display:table name="${actionBean.senaraiKertas}" id="line1" class="tablecloth"
                                   pagesize="12" cellpadding="0" cellspacing="0" requestURI="/pengambilan/ulasan_jabatan_teknikalPHLL">
                        ...
                        <display:column title="Tarikh Ulasan">
                            <c:forEach items="${line1.senaraiKandungan}" var="senarai">
