        ...
        <s:form beanclass="etanah.view.stripes.pengambilan.PembatalahHakLaluLalangActionBean">
           ...
           <div class="subtitle">
                <fieldset class="aras1">
                    <legend>
                        notifikasi Pembatalan Hak Lalu Lalang
                    </legend>
                    <div class="content" align="">
                        <table border="0">
                            <font color="black" style=" font-size: x-small">
                            Sila klik butang charting untuk pembatalan Hak Lalu Lalang
                            </font>
                        </table>
                    </div>
                </fieldset>
           ...
           <div align="right">
            <table>
                <tr align="right"><td>
                <font style="font-family: Arial; font-size: x-small; font-weight: bold;"><s:button name="janaSurat" value="Charting" class="longbtn"/></font>
            </td></tr>
            </table>
      </div>
            <%--<p align="right">
