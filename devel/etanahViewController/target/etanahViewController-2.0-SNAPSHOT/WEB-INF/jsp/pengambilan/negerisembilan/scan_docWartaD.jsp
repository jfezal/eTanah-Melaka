<%-- 
    Document   : scan_docWartaD
    Created on : Jul 29, 2013, 2:40:00 PM
    Author     : Admin
--%>
...
<script type="text/javascript">
    ...
    function successRedirection() {
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_n9?reload';
        $.ajax({
            type:"GET",
            url : url,
...
<applet code="etanah.dokumen.scan.DocumentScanner"
        ...
        width="800" height="600">
            <param name="idDokumen" value="${actionBean.permohonanRujukanLuar.dokumen.idDokumen}" />
