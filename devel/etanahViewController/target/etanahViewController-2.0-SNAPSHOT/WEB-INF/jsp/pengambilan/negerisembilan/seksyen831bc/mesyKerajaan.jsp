<%-- 
    Document   : mesyuarat kerajaan_N9
...
<s:form beanclass="etanah.view.stripes.pengambilan.MMKN831AActionBean" name="form1">
    <s:messages/>
    <s:errors/>
            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                     <div class="content" align="left">
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td align="left"><b><label><font color="black">KERTAS MESYUARAT NO :</font></label><s:text name="kertasBil"  size="10" style="text-align:left" id="kertasBil" class="normal_text"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b></td></tr>
                       <%-- <tr>
                    ...
                    <tr><td> &nbsp;</td></tr>
                    <tr><%--<font style="text-transform:uppercase">--%><%--</font>--%></tr>
                    ...
                    <tr><td> &nbsp;</td></tr>
                     ...
                     <tr><td><b>3. PENILAIAN DAN PERAKUAN </b></td></tr>
                        <tr><td>
                                <table id ="dataTable3">
                                    <c:set var="i" value="1" />
                        ...
                        <tr><td> &nbsp;</td></tr>
                     <tr><td><b><%--<font style="text-transform:uppercase">--%>4. PERAKUAN JAWATANKUASA KHAS ${actionBean.hakmilik.daerah.nama}<%--</font>--%></b></td></tr>
