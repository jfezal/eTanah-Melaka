<%-- 
    Document   : mmkn_sek4_nsAduan
    Created on : 11-Sep-2011, 17:20:09
    Author     : nordiyana
--%>
...
<script language="javascript" type="text/javascript">
    ...
    function deleteRow5()
    {
        ...
        if(confirm('Adakah anda pasti?')) {
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/mmkns4Aduan?deleteSinglePTG&idKandungan='
            +idKandungan;
            $.get(url,
            function(data){
            $('#page_div').html(data);
...
<s:form beanclass="etanah.view.stripes.pengambilan.MMKNAduanNSActionBean" name="form2">
    <s:messages/>
    <s:errors/>
            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                     <div class="content" align="left">
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td align="left"><b><label><font color="black">KERTAS BIL :</font></label><s:text name="kertasBil" disabled="true" size="10" style="text-align:left" id="kertasBil" class="normal_text"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b></td></tr>
                        <%--<tr>
                    ...
                    <tr><td> &nbsp;</td></tr>
                     ...
                     <tr><td><b>3. NILAIAN TANAH DAN PERUNTUKAN</b></td></tr>
                        ...
                        <tr><td> &nbsp;</td></tr>
                     <tr><td><b><font>4. SYOR PENTADBIR TANAH DAERAH ${actionBean.hakmilik.daerah.nama}</font></b></td></tr>
                        ...
                        <tr><td> &nbsp;</td></tr>
                    <tr><td><b><font>5. ULASAN PENGARAH TANAH DAN GALIAN, NEGERI SEMBILAN</font></b></td></tr>
        ...
        <fieldset class="aras1" id="locate">
            <div class="content" align="center">
                <table border="0" width="80%">
                    ...
                    <tr><td><b>1. TUJUAN</b></td></tr>
                    <tr><tr><tr><td colspan="2"><b> &nbsp;</b><s:textarea rows="5" cols="140" name="tujuan" class="normal_text" disabled="true"/><td>
                                ...
                                <table id ="dataTable2">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan2}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan2${i}" class="normal_text" id="kandungan2${i}" disabled="true" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                                        <s:hidden name="rowCount2" value="${i-1}" id="rowCount2"/>
                                </table>
                        <tr><td align="right"><s:button name="perihal2" disabled="true" value="Tambah" class="btn" onclick="addRow2('dataTable2')" />
                    ...
                    <tr><td> &nbsp;</td></tr>
                     ...
                     <tr><td><b>3. NILAIAN TANAH DAN PERUNTUKAN</b></td></tr>
                                ...
                                <table id ="dataTable3">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                        <tr style="font-weight:bold">
                                            ...
                                            <td><font><s:textarea name="kandungan3${i}" class="normal_text" disabled="true" id="kandungan3${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                        ...
                        <tr><td> &nbsp;</td></tr>
                     <tr><td><b><%--<font style="text-transform:uppercase">--%>4. SYOR PENTADBIR TANAH DAERAH ${actionBean.hakmilik.daerah.nama}<%--</font>--%></b></td></tr>
                            ...
                            <tr><td>
                                    <table  width="90%" id="table5${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiPentadbir[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount5 eq 1}">
                                                <tr> <td><b>4.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" class="normal_text" cols="130" disabled="true" name="senaraiPentadbir${i}${recordCount5}" id="senaraiPentadbir${i}${recordCount5}" value="${senarai.kandungan}" /></td>
                                                    <td><s:hidden name="count5${i}" id="count5${i}" value="${(fn:length(actionBean.senaraiPentadbir[i]))}" /> </td>
                                                    <td><s:button class="btn" disabled="true" value="Tambah 4.${i}" name="add" id="tambah5${i}" onclick="addDynamicRow5('table5${i}','count5${i}')"/></td>
                                                    <td><s:button class="btn" disabled="true" value="Hapus 4.${i}" name="hapus" id="hapus5${i}" onclick="deleteDynamicRow5('table5${i}','count5${i}')"/></td>
                                            </c:if>
                                            <c:if test="${recordCount5 ne 1}">
                                            <tr>  <td></td>
                                                <td><b><c:out value="${actionBean.str[recordCount5-1]}"/>.</b></td>
                                                <td><s:textarea rows="5" cols="130"  disabled="true" class="normal_text" name="senaraiPentadbir${i}${recordCount5}" id="senaraiPentadbir${i}${recordCount5}" value="${senarai.kandungan}" /></td>
                                            </c:if>
                                            <s:hidden name="kand5${i}${recordCount5}" id="kand5${i}${recordCount5}" value="${senarai.idKandungan}" />
                                        </c:forEach>
                                    </table>
                    ...
                    <tr><td> &nbsp;</td></tr>
                    <tr><td><b><%--<font style="text-transform:uppercase">--%>6. SYOR PENGARAH TANAH DAN GALIAN, NEGERI SEMBILAN<%--</font>--%></b></td></tr>
