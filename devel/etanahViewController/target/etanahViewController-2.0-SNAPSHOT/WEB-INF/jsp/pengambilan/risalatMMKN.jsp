<%-- 
    ...
    Author     : Rohan
    Modified   : khairul.hazwan @modified hazirah
--%>
...
<s:form beanclass="etanah.view.stripes.pengambilan.RisalatMMKNActionBean">
    <s:messages/>
    <s:errors/>
        ...
        <fieldset class="aras1">
            ...
            <div class="content">
                <table width="90%" border="0">
                    ...
                    <tr><td><b>TAJUK : </b>&nbsp; ${actionBean.pkk.kandungan}</td></tr><br>

                    <c:if test="${edit}">
                        <tr><td><b><font style="text-transform:uppercase">RISALAT MMKN  : </font></b>&nbsp; <s:text name="norisalat" size="30" class="normal_text"/></td></tr><br>
                                </c:if>
                                <c:if test="${!edit}">
                        <tr><td><b><font style="text-transform:capitalize">RISALAT MMKN  : </font></b>&nbsp; ${actionBean.norisalat} </td></tr><br>
                                </c:if>

                    <tr><td><b><font style="text-transform:capitalize">NO. RUJUKAN PTG  : </font></b> &nbsp; ${actionBean.permohonan.idPermohonan} &nbsp;</td></tr><br>
                ...
                <div align="center">
                    <table class="tablecloth" border="0" width="90%">
                        ...
                        <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PBMT' and actionBean.permohonan.kodUrusan.kod ne 'PPTR' and actionBean.permohonan.kodUrusan.kod ne 'LPSP' and actionBean.permohonan.kodUrusan.kod ne 'PLPS'}">
                        ...
                        <c:if test = "${actionBean.permohonan.kodUrusan.kod ne 'PBSK' and actionBean.permohonan.kodUrusan.kod and 'LMCRG' and actionBean.permohonan.kodUrusan.kod ne 'MLCRG' and actionBean.permohonan.kodUrusan.kod ne 'PBMT'}">
                        ...
                        <tr><td><b>Ulasan YB Adun Kawasan</b></td>
                            <c:if test="${edit}">
                                <td><s:textarea name="ulasanYB" rows="5" cols="130" class="normal_text" readonly="true"/></td>
                            </c:if>
                            <c:if test="${!edit}">
                                <td>${actionBean.ulasanYB} &nbsp;</td>
                            </c:if>
                        </tr>   

                        <tr><td><b>Ulasan PTD</b></td>
                            <c:if test="${edit}">
                                <td><s:textarea name="ulasanPtd" rows="5" cols="130" class="normal_text" readonly="true"/></td>
                            </c:if>
                            <c:if test="${!edit}">
