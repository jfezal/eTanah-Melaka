<%-- 
    Document   : perakuan_kertas_pertimbangan
    Created on : Jan 14, 2010, 5:41:26 PM
...
<s:form beanclass="etanah.view.pelupusan.PelupusanActionBean">
    <p>PERAKUAN KERTAS PERTIMBANGAN PENTADBIR TANAH DAERAH</p>
    <div class="subtitle">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                Keputusan Pentadbir Tanah Daerah
            </legend>
            <p>
    ...
    <p>
        <label>&nbsp;</label>
        <s:submit name="" value="Papar Kertas Pertimbangan" class="btn"/>
