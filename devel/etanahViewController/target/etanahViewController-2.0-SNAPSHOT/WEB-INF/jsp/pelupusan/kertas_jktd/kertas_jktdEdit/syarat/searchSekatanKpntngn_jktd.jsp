...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasJKTDV2ActionBean">
        ...
        <fieldset class="aras1">
            <legend></legend>
            <p>
                <display:table style="width:100%" class="tablecloth" name="${actionBean.disSyaratSekatan.listKodSekatan}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pelupusan/kertas_JKTDV2" id="line">
