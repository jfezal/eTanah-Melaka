    ...
    <div class="subtitle">
        ...
        <div class="subtitle">
            ...
            <fieldset class="aras1">
                <legend></legend>
                <p>
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.disSyaratSekatan.listKodSyaratNyata}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pelupusan/kertas_JKTDV2" id="line">
