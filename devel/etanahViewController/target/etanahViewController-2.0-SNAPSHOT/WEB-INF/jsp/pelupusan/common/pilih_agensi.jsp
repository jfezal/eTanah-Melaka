...
//                    alert(data) ;
                    ...
                    var url = '${pageContext.request.contextPath}/pelupusan/sedia_jabatan?simpanAgensi&item='+data ;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
...
//                     alert("test1
    ...
    //                     alert(data[cnt])
                    ...
                    if(confirm("Adakah anda pasti?")) {
                    var url = '${pageContext.request.contextPath}/pelupusan/sedia_jabatan?simpanAdun&item='+data ;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
                        alert("Rekod telah berjaya di masukkan") ;
    ...
    <s:errors/>
        <s:messages/>
        <div class="subtitle">
            <s:form beanclass="etanah.view.stripes.pelupusan.JabatanTeknikalActionBean" name="frm">
