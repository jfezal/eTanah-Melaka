...
<script type="text/javascript">
    $(document).ready( function() {   
        ...
        if('${actionBean.permohonan.kodUrusan.kod}' == "MPJLT"){
    ...
    function validateForm(){
        ...
        if(${actionBean.permohonan.kodUrusan.kod eq 'MPJLT'})
        {
            if(document.form2.tempat.value=="")
            {
                alert("Sila masukkan Nama Tempat");
...
<s:form name="form2" id="form2" beanclass="etanah.view.stripes.pelupusan.MaklumatTanahMPJLTActionBean">
    <s:messages/>
    <s:errors/>
    <s:hidden name="urusan" id="urusan" value="MPJLT"/>
