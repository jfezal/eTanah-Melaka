                ...
                <fieldset class="aras1">
                    ...
                    <div class="content" align="center">
                        ...
                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PPTR'}">
                            <c:import url="syaratEdit/syaratPPTR.jsp"></c:import>
                        </c:when>
                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PPRU'}">
                            <c:import url="syaratEdit/syaratPPRU.jsp"></c:import>
                        </c:when>
                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PPRU'}">
                            <c:import url="syaratEdit/syaratPLPS.jsp"></c:import>
                        </c:when>
                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PLPT'}">
                            <c:import url="syaratEdit/syaratPPTR.jsp"></c:import>
                        </c:when>
                        </c:choose>
                    </div>
