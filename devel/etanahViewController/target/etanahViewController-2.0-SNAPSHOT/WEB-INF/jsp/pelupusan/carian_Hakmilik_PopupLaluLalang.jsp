...
<script type="text/javascript">
    ...
    function simpan(){
          ...
          var url = '${pageContext.request.contextPath}/pelupusan/pihak_kepentingan_lalulalang?simpan&idHakmilik='+idHakmilik+'&statusPage='+statusPage;
           $.get(url,
            function(data){
                $('#page_div').html(data);
...
//            alert('aa');
          ...
          var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/pihak_kepentingan_lalulalang?cariHakmilik&statusPage='+statusPage,q,
            function(data){
                $('#page_div').html(data);
//                self.opener.refreshlptn();
            }, 'html');         
...
//                     alert(data[cnt])
            ...
            var url = '${pageContext.request.contextPath}/pelupusan/pihak_kepentingan_lalulalang?simpan&idHakmilik='+data ;
            $.get(url,
            function(data){
                $('#page_div').html(data);
...
<s:form beanclass="etanah.view.stripes.pelupusan.PihakKepentinganLalulalangActionBean" name="frm">
