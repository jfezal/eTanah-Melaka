...
<s:form beanclass="etanah.view.stripes.pelupusan.LesenTerdahuluMLCRGActionBean">
    <s:messages/>
    <s:hidden name="idMohonDulu" value="${actionBean.idMohonDulu}"/>
    <fieldset class="aras1">
<!--        Add by Aizuddin Orogenic Group-->
        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PJLB' or actionBean.permohonan.kodUrusan.kod eq 'MPJLB'}">
        <legend>Maklumat Lesen Pajakan Lombong</legend>
        </c:if>
        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'LMCRG' or actionBean.permohonan.kodUrusan.kod eq 'MLCRG'}">
        <legend>Maklumat Lesen Mencarigali Dan Penjelajahan</legend>
        </c:if>
<!--        End of addition-->
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <display:table class="tablecloth" name="${actionBean.listLesen}" pagesize="5" cellpadding="0" cellspacing="0"
                                ...
                                <display:column title="No.Lot/PT">${actionBean.hakmilikPermohonan.noLot}</display:column>
                                ...
                                <display:column title="Tempoh Pajakan" sortable="true" value="${actionBean.hakmilikPermohonan.tempohPajakan} Tahun"/>
                                <display:column title="Jenis Hakmilik" sortable="true" value=""/>
                                <display:column title="Sewa Tanah Tahunan" sortable="true" value="RM ${actionBean.mohonTuntutKos.amaunTuntutan}"/>
                            </display:table>
                        </td>
                    </tr>
                </table>
