...
<div class="subtitle" id="caw">
    <s:form beanclass="etanah.view.stripes.pelupusan.DrafMMKN_LPSPActionBean">
        <s:hidden name="edit" id="edit"/>
        <fieldset class="aras1">
            <legend><b><font style="text-transform: capitalize">Perakuan Pentadbir Tanah Daerah ${actionBean.drafDaerah}</font></b></legend>
            <table border="0" width="100%" id="tblhuraian" cellspacing="0" align="center">
                <table>
                    ...
                    <tr><td></td>
                        <td><center>
                            <s:submit name="simpanPerakuanPTDPopUp" id="simpan" value="Simpan" class="btn" />
