<%-- 
    Document   : laporan_tanah_ns1
    Created on : Jul 22, 2011, 4:08:58 PM
...
<%--if(document.getElementById('kpsn').value == null){
    $('#tidak').hide();
    $('#hideshow').hide();

}
else if(document.getElementById('kpsn').value == 'DI'){
     showTable();
 }
 ...
 else if(document.getElementById('kpsn2').value == 'DX'){
       ...
       <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'U' || actionBean.pihak.jenisPengenalan.kod eq 'D' || actionBean.pihak.jenisPengenalan.kod eq 'S'}">
        ...
        <fieldset class="aras1">
            ...
            <p><label>Keputusan :</label>
                ...
                <s:radio name="kpsn" value="DI" id="kpsn" onclick="showTable()" checked="showTable()"/> Sokong
                <s:radio name="kpsn" value="DX" id="kpsn" onclick="hideTable()" checked="hideTable()"/> Tidak Sokong
                <%--</c:if>--%>
                <%--<c:if test="${actionBean.display eq 'true'}">
                    <s:radio name="kpsn" value="DI" id="kpsn" onclick="showTable()" checked="showTable()"/> Sokong
            <s:radio name="kpsn" value="TI" id="kpsn" onclick="hideTable()" checked="hideTable()"/> Tidak Sokong
                </c:if>--%>

               <%-- <c:if test="${actionBean.kpsn ne 'null'}">
                    showTable()
                </c:if>--%>
            </p><br/>
            <div class="subtitle" align="center">
            ...
            <table id="tidak">
                ...
                <br>
                    <p><label>Tarikh :</label><s:text name="tarikhKeputusan"  id= "datepicker" class="datepicker" formatType="date" formatPattern="dd/MM/yyyy"/></p></br>
                  </fieldset>
            <p align="center">
