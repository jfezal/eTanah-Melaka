...
<s:form beanclass="etanah.view.stripes.pelupusan.JabatanTeknikal2ActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PLPS' and actionBean.permohonan.kodUrusan.kod ne 'PBMT' and actionBean.permohonan.kodUrusan.kod ne 'PLPTD'}">
                <p>
                ...
                <p>
                    ...
                    <s:button  name="reset" id="padam" value="Padam" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
            ...
            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PLPS' or actionBean.permohonan.kodUrusan.kod eq 'PBMT' or actionBean.permohonan.kodUrusan.kod eq 'PLPTD'}">
                <c:if test="${!actionBean.viewOnly}">
                    <p>
                   
                        <c:if test="${actionBean.kNegeri eq '04'}">
                            <c:if test = "${!(actionBean.kpsnSoKanan eq null)}">
                                <label>Keputusan Daripada Penolong Pegawai Tanah Kanan : </label>
