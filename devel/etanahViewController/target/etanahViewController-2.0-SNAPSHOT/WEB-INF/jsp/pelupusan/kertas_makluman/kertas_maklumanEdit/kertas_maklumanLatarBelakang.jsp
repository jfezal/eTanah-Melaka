<%-- 
    Document   : kertas_maklumanLatarBelakang
    Created on : Apr 23, 2013, 4:33:20 PM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_makluman_mmkV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kLatarBelakang',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kLatarBelakang') ;
        }
    }
            ...
            <fieldset class="aras1">
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganLatarBelakang}" var="line">
                        <tr>
                            <td style="text-align: right"><c:out value="2.${num}"/></td>
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiKandunganLatarBelakang[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
