...
<div class="subtitle">
        ...
        <fieldset class="aras1">
            ...
            <p>
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'BMBT' || actionBean.permohonan.kodUrusan.kod eq 'PTBTS' || actionBean.permohonan.kodUrusan.kod eq 'PTBTC'}">
                    <s:submit name="cariKodSyaratNyataPTG" value="Cari" class="btn"/>
                    <s:button name="tutup" value="Tutup" class="btn" onclick="javascript:window.close();"/>
                </c:if>
                <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'BMBT' && actionBean.permohonan.kodUrusan.kod ne 'PTBTS' && actionBean.permohonan.kodUrusan.kod ne 'PTBTC'}">
    ...
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            <legend></legend>
            <p>
                <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSyaratNyata}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pelupusan/draf_mmkn" id="line">
