...
<script type="text/javascript">
    ...
    function menyimpan(index,i)
    {
        ...
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?simpan&index='+index+'&kandungan='+kand;
            +index;
    ...
    function deleteRow(idKandungan)
    {
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?deleteRow&idKandungan='+idKandungan;
    ...
    {
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?tambahRow&index='+index;
    ...
    function kemaskiniRow(idKandungan,index,i){
        ...
        if(confirm('Adakah anda pasti untuk kemaskini data ini?')) {
            var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?kemaskini&index='+index+'&kandungan='+kand+'&idKandungan='+idKandungan;
    ...
    function simpanPerakuanPTG(index,i)
    {
        ...
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?simpanPerakuanPTG&index='+index+'&kandungan='+kand;
            +index;
    ...
    {
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?deleteRowPerakuanPTG&idKandungan='+idKandungan;
    ...
    function kemaskiniRowPerakuanPTG(idKandungan,index,i){
        ...
        if(confirm('Adakah anda pasti untuk kemaskini data ini?')) {
            var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?kemaskiniPerakuanPTG&index='+index+'&kandungan='+kand+'&idKandungan='+idKandungan;
    ...
    {
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?tambahPerakuanRowPTG&index='+index;
    ...
    function simpanPerakuanPTD(index,i)
    {
        ...
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?simpanPerakuanPTD&index='+index+'&kandungan='+kand;
            +index;
    ...
    {
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?deleteRowPerakuanPTD&idKandungan='+idKandungan;
    ...
    function kemaskiniRowPerakuanPTD(idKandungan,index,i){
        ...
        if(confirm('Adakah anda pasti untuk kemaskini data ini?')) {
            var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?kemaskiniPerakuanPTD&index='+index+'&kandungan='+kand+'&idKandungan='+idKandungan;
    ...
    {
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkas_rayt?tambahPerakuanRowPTD&index='+index;
...
<s:form beanclass="etanah.view.stripes.pelupusan.KertasRingkasRAYTActionBean">
    <s:messages/>
    <s:errors/>
    <div class="subtitle" align="center">
        <fieldset class="aras1"> 
            <table align="center" width="80%">
                <tr>
                    <td>
                        <c:if test="${edit}"><font size="3"><b><s:textarea name="tajuk" id="tajuk" value="Test" cols="150"  rows="3"/></b></font>
                                                ...
                                                <!--table border="0"-->         
                                                    ...
                                                    <c:forEach items="${actionBean.listKertasPerakuanPTG}" var="line">
                                                        <tr>
                                                            ...
                                                            <td><s:textarea  id="kandungan5${i}"  name="listKertasPerakuanPTG[${i-2}].kandungan" cols="150"  rows="5" class="normal_text"/></td>
