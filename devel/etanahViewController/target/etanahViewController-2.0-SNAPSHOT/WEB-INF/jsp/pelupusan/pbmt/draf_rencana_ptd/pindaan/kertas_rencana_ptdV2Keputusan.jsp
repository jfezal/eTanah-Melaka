<%-- 
    Document   : kertas_rencana_ptdV2Keputusan
    Created on : Jul 3, 2013, 11:44:29 AM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_pindaanPTDV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kKeputusan',q,
            function(data){
                $('#page_div').html(data);
