<%-- 
    Document   : kertas_rencana_ptdV2HuraianPPTD
    Created on : Jul 3, 2013, 11:43:57 AM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        NoPrompt();
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_pindaanPTDV2?tambahRow&index='+index;
        window.open(url, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_pindaanPTDV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kHuraianPPtd',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kHuraianPPtd') ;
        }
    }
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasRencanaPindaanPTDV2ActionBean" name="form">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Huraian Penolong Pentadbir Tanah</legend>
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganHuraianPPtd}" var="line">
                        <tr>
                            ...
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiKandunganHuraianPPtd[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
