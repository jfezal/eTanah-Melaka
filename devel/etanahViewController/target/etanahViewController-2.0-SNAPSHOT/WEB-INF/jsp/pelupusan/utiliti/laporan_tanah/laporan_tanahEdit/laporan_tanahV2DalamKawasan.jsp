...
<script type="text/javascript">
    ...
    function tambahKawasan(){
        ...
        window.open("${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?kawasanPopup&idHakmilik="+idHakmilik+"&noPtSementara="+noPtSementara+"&idPermohonan="+idPermohonan, "eTanah",
    ...
    function editLaporKawasan(idMohonlaporKws){
        ...
        var noPtSementara = $('#noPtSementara').val();
        var idPermohonan = $('#idPermohonan').val() ;
        window.open("${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?kawasanPopupUpdate&idMohonKw="+idMohonlaporKws+"&idHakmilik="+idHakmilik+"&noPtSementara="+noPtSementara+"&idPermohonan="+idPermohonan, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
    }
    ...
    {   NoPrompt();
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?deleteRow&idKandungan='+idMohonlaporKws+'&tName='+tName,q,
            function(data){
                alert(data);
                $('#page_div').html(data);
                alert(data);
