    ...
    <div class ="subtitle">
        <div class="content">
            <fieldset class ="aras1">
                ...
                <p><label><font color="red">*</font>ID Permohonan / ID Kelompok :</label>
                        <s:text id="idPermohonan" name="idPermohonan"   value="${actionBean.idPermohonan}"></s:text>
                </p>
                <p align="center"><s:submit name="carianKelompok" value="Cari" class="btn"/>&nbsp;
                    ...
                    <table class="tablecloth" style="font-size: small">
                        ...
                        <c:if test="${actionBean.simpan}"> 
                            <tr>
                                ...
                                <td>
                                    <s:radio name="jenisKelompok" id="jenisKelompok" value="T"/> Bertindih
                                    <s:radio name="jenisKelompok" id="jenisKelompok" value="R"/> Beramai - ramai
                                </td>
                            </tr>
                            <tr align="center">
                                <td colspan="2">
