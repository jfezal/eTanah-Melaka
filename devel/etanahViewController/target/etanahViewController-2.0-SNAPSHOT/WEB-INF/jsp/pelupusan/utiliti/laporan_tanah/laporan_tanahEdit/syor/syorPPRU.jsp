<%--
    Document   :  syorPPRU(Editable).jsp
...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.ksn ne null}">
        ...
        function showpprutidaksokong(val) {
            $('#pprutidaksokong').show();
            $('#pprusokong').hide();
            if(val == 'SL'){
                val = 'ST';
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showpprusokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showpprutidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                        ...
                        <div id="pprusokong">
                            <table class="tablecloth" align="center">
                                ...
                                <tr>
                                    <td><font color="red" size="4">*</font>Keluasan Diluluskan (Isipadu) :</td>
                                    <td>
                                        <s:text name="hakmilikPermohonan.luasDiluluskan" formatPattern="#,###,##0.0000" size="20" onkeyup="validateNumber(this,this.value);"/>
                    ...
                    <c:when test="${actionBean.kodNegeri eq '05'}">
                        ...
                        <div id="pprusokong">
                            <table class="tablecloth" align="center">
                                ...
                                <tr>
                                    <td><font color="red" size="4">*</font>Keluasan Diluluskan :</td>
                                    <td>
                                        <s:text name="hakmilikPermohonan.luasDiluluskan" formatPattern="#,###,##0.0000" size="20" onkeyup="validateNumber(this,this.value);"/>
                                        <s:select name="kodU" id="koduom" style="width:100px">
                                            <s:option value="">Sila Pilih</s:option>
