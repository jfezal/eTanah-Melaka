...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        {   
            ...
            var url = '${pageContext.request.contextPath}/pelupusan/kertas_MMKPBGSA?tambahRow&index='+index+'&kodksn='+kpsn+'&ksn='+kpsn;
            window.open(url, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        {   
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}/pelupusan/kertas_MMKPBGSA?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kPerakuanPtd',q,
                function(data){
                    $('#page_div').html(data);
        ...
        function cariPopup(val){
            ...
            //            alert(idMh);
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pelupusan/kertas_MMKPBGSA?searchSyarat&jenisSyarat="+val+"&idMh="+idMh, "eTanah",
        ...
        function kiraCukai(f) {
            ...
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_MMKPBGSA?kiraCukai&kodTanah=' + kodTanah , q,
            function(data) {
                if (data == '-1') {
                } else {
