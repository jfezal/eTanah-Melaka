<%--
    Document   : Edit_imej_Laporan_Tanah_Pelupusan
    Created on : Feb 5, 2015, 4:25:08 PM
    Author     : Erra Zyra
--%>
...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        function editImage(idImej) {
            ...
            //alert(idlaporTnhSmpdn);
            //alert(imageType);
            window.open("${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?showFormPopUpImej&idImej="+idImej+"&idLapor="+idLapor+"&idlaporTnhSmpdn="+idlaporTnhSmpdn+'&imageType='+imageType, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.LaporanTanahV2PelupusanActionBean">
        <s:hidden name="idDok" id="idDok" value="${actionBean.imejL.dokumen.idDokumen}"/>
                ...
                <div class="content" align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikImejLaporanListEdit}" pagesize="5" cellpadding="0" cellspacing="0" id="line"
                        ...
                        <display:column title="Kemaskini">
                            <div align="center">
                                <a onclick="editImage(${line.idImej},${line.laporanTanahSempadan.idLaporTanahSpdn})" onmouseover="this.style.cursor='pointer';" ><img alt="Kemaskini"  height="20px" width="20px" src='${pageContext.request.contextPath}/pub/images/icons/edit_pelupusan_small.png'/></a>
        ...
        <fieldset class="aras1">
            ...
            <p>
                <label>&nbsp;</label>&nbsp;
                <s:submit name="updateImejLaporan" value="Kemaskini" class="btn" onclick="NoPrompt();"/>
                <c:choose>
