...
<script type="text/javascript">
    ...
    function cariPopup(val, idMohonHakmilik, idLaporan) {
        NoPrompt();
        window.open("${pageContext.request.contextPath}/common/laporan/tanah/laporantanahNewActionBean?searchSyarat&jenisSyarat=" + val + "&idMohonHakmilik=" + idMohonHakmilik + "&idLaporan=" + idLaporan, "eTanah",
            ...
            <fieldset class="aras1">
                ...
                <table class="tablecloth" align="center">
                    <tr>
                        ...
                        <td>
                            <s:radio name="ksn" id="ksn" value="SL" onclick="showjikasokong(this.value);" />&nbsp;Sokong
                ...
                <div id="jikasokong">
                    <table class="tablecloth" align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="hakmilikPermohonan.luasDiluluskan" size="20" value="${actionBean.hakmilikPermohonan.luasDiluluskan}" formatPattern="#,###,##0.0000" onkeyup="validateNumber(this,this.value);"/>&nbsp;

                                <s:select name="kodU" style="width:150px" value="${actionBean.hakmilikPermohonan.luasLulusUom.kod}" id="kodU">
                        ...
                        <tr>
                            ...
                            <td> 
                                <s:select name="katTanahPilihan" id="katTanahPilihan" value="${actionBean.hakmilikPermohonan.kategoriTanahBaru.kod}" onchange="filterKodGunaTanah();"> 
                        ...
                        <tr id="jikaPajakan">
                            ...
                            <td>
                                <s:select name="tempohPajakan" id="Premium" value="${actionBean.hakmilikPermohonan.tempohPajakan}">
                                    <s:option value="0">--Sila Pilih--</s:option>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:select name="keteranganKadarPremium" id="nama" value="${actionBean.hakmilikPermohonan.keteranganKadarPremium}" onchange="javaScript:showPremimTxt(this.value)">
                                    <s:option value="">--Sila Pilih--</s:option>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="hakmilikPermohonan.cukaiPerMeterPersegi" value="${actionBean.hakmilikPermohonan.cukaiPerMeterPersegi}"  size="10"/>
                                <s:select name="hakmilikPermohonan.keteranganCukaiBaru" id="jenishasil" value="${actionBean.hakmilikPermohonan.keteranganCukaiBaru}">
                                    <s:option value="0">--Sila Pilih--</s:option>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${actionBean.hakmilikPermohonan.agensiUpahUkur eq null}">
                                    <s:radio name="agensiUpahUkur" id="agensiUpahUkur" value="JUP" />&nbsp;Mengikut PU(A)438
                                    <s:radio name="agensiUpahUkur" id="agensiUpahUkur" value="JUB" />&nbsp;Juru Ukur Berlesen   
                                </c:if>
                                <c:if test="${actionBean.hakmilikPermohonan.agensiUpahUkur eq 'JUB'}">
                                    <s:radio name="agensiUpahUkur" id="agensiUpahUkur" value="JUP" />&nbsp;Mengikut PU(A)438
                                    <input type="radio" name="agensiUpahUkur" value="${actionBean.hakmilikPermohonan.agensiUpahUkur}" class="checkbox" checked/>&nbsp;Juru Ukur Berlesen 
                                </c:if>
                                <c:if test="${actionBean.hakmilikPermohonan.agensiUpahUkur eq 'JUP'}">
                                    <input type="radio" name="agensiUpahUkur" value="${actionBean.hakmilikPermohonan.agensiUpahUkur}" class="checkbox" checked/>&nbsp;Mengikut PU(A)438
                                    <s:radio name="agensiUpahUkur" id="agensiUpahUkur" value="JUB" />&nbsp;Juru Ukur Berlesen  
                                </c:if>
                            </td>
                    ...
                    <table class="tablecloth" align="center">
                        <tr>
                            ...
                            <td>
                                <s:textarea name="syaratNyata" id="syaratNyata" value="${actionBean.hakmilikPermohonan.syaratNyataBaru.syarat}" rows="5" cols="80" readonly="yes" class="tooltips"></s:textarea>
                                <s:hidden name="disSyaratSekatan.kod" id="kod"/>                                    
                            </td>
                            <td style="vertical-align: middle;">
                                <s:button name="cari" value="Cari" id="cari" class="btn" onclick="cariPopup('nyata','${actionBean.hakmilikPermohonan.id}','${actionBean.laporanTanah.idLaporan}')"/>  
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <s:textarea name="syaratNyata1" id="syaratNyata1" value="${actionBean.hakmilikPermohonan.sekatanKepentinganBaru.sekatan}" rows="5" cols="80" readonly="yes" class="tooltips"></s:textarea>
                                <s:hidden name="disSyaratSekatan.kodSktn" id="kodSktn"/>

                            </td>
                            <td style="vertical-align: middle;">
                                <s:button name="cari" value="Cari" id="cari" class="btn" onclick="cariPopup('sekatan','${actionBean.hakmilikPermohonan.id}','${actionBean.laporanTanah.idLaporan}')"/>  
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <tr>
                        <s:hidden name="idLaporTanah" value ="${actionBean.laporanTanah.idLaporan}" id="idLaporTanah"/>
                        <s:hidden name="idMohonHakmilik" value ="${actionBean.hakmilikPermohonan.id}"  id="idMohonHakmilik"/>
                        <td style="text-align:center;" colspan="3">      
                            <s:submit name="simpanKandungan" value="Simpan" class="btn" onclick="setKpsn();"/>
                        </td>
                    </tr> 
