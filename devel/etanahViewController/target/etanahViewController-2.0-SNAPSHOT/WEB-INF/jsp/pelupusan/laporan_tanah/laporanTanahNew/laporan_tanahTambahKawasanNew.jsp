...
//                var idHakmilik = $('#idHakmilik').val();
                //    alert(idHakmilik);
                window.open("${pageContext.request.contextPath}/common/laporan/tanah/laporantanahNewActionBean?kawasanPopupKembali&idMohonHakmilik=" + idMohonHakmilik + '&idLaporTanah=' + idLaporTanah, "eTanah",
                        "status=0,toolbar=0,location=0,menubar=0,width=1000,height=500,scrollbars=yes");
                //        "status=0,toolbar=0,location=0,menubar=0,width=2000,height=900,scrollbars=yes,fullscreen=yes");
            }
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.common.laporan.tanah.laporantanahNewActionBean" name="form">
        ...
        <c:if test="${actionBean.permohonanLaporanKawasan eq null}">
            <div class="subtitle">
                <fieldset class="aras1">
                    <div id="perihaltanah">
                        <legend>Tanah Dipohon Berada Dalam Kawasan 2:</legend>
                        ...
                        <table class="tablecloth" border="0" align="center">
                            <tr>
                                ...
                                <td align="left" style="color:black">
                                    <s:select name="rizabKwsn" id="rizabKwsn" onchange="openLain_lain(this.value)">
                            ...
                            <tr id="catatanKwsn">
                                ...
                                <td style="color:black">:</td>
                                <td align="left" style="color:black">
                                    <s:textarea name="catatanKwsn"  rows="5" cols="50" />
                                </td>
                            </tr>
                            <tr id="pbtKawasan">
                                ...
                                <td style="color:black">:</td>
                                <td align="left" style="color:black">
                                    <s:textarea name="pbtKawasan"  rows="5" cols="50" />
                                </td>
                            </tr>
                            <tr id="noWartaKwsn">
                                ...
                                <td style="color:black">:</td>
                                <td align="left" style="color:black">
                                    <s:text name="noWartaKwsn"  size="30" />
                                </td>
                            </tr>
                             <tr id="trhWartaKwsn">
                                ...
                                <td style="color:black">:</td>
                                <td align="left" style="color:black">
                                    <s:text name="trhWartaKwsn"  size="12" id="datepicker" class="datepicker" formatPattern="dd/MM/yyyy"/> <em>[hh/bb/tttt]</em>
                                </td>
                            </tr>
                            <tr id="noPelankawasan">
                                <td align="left">No Pelan Warta</td>
                                <td style="color:black">:</td>
                                <td align="left" style="color:black">
                                    <s:text name="noPelankawasan" size="30" />
                                </td>
                            </tr>
                           <tr>
        ...
        <c:if test="${actionBean.permohonanLaporanKawasan ne null}">
            <div class="subtitle">
                <fieldset class="aras1">
                    <div id="perihaltanah">
                        <legend>Tanah Dipohon Berada Dalam Kawasan 2:</legend>
                        ...
                        <table class="tablecloth" border="0" align="center">
                            ...
                            <tr>
                                <td align="left" colspan="3">
                                    <s:hidden name="idLaporTanah" id="idLaporTanah" value="${actionBean.laporanTanah.idLaporan}"/>
                                    <s:hidden name="idMohonHakmilik" id="idMohonHakmilik" value="${actionBean.hakmilikPermohonan.id}"/>
                                     <s:hidden name="idMohonlaporKws" id="idMohonlaporKws" value="${actionBean.permohonanLaporanKawasan.idMohonlaporKws}"/>
