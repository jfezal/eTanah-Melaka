                ...
                <c:choose>
                    <c:when test="${actionBean.fasaPermohonan.keputusan.kod eq 'SL' }">
                        ...
                        <tr>
                            ...
                            <td>
                                <s:format formatPattern="#,###.00" value="${actionBean.disPermohonanBahanBatu.kuponAmaun}"/> * ${actionBean.disPermohonanBahanBatu.kuponQty} = RM <s:format formatPattern="#,###.00" value="${actionBean.disPermohonanBahanBatu.kupon}"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
