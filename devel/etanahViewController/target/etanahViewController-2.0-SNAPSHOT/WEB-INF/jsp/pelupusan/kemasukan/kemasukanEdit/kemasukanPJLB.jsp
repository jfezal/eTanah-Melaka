...
<script type="text/javascript">
    ...
    function filterKodDaerah() {
        var kodCaw = $("#kodCaw").val();
        <%--alert("hi " + kodCaw);--%>
        NoPrompt();

        $.post('${pageContext.request.contextPath}/pelupusan/maklumat_tanahV3?senaraiKodDaerahByKodCaw&kodCaw=' + kodCaw,
                function(data) {
                  if (data != '') {
                        ...
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <%--senaraiKodCawangan--%>
                                    <s:select name="hakmilikPermohonan.cawangan.kod" style="width:150px" value="actionBean.disHakmilikPermohonan.hakmilikPermohonan.cawangan.kod" id="kodCaw" onchange="filterKodDaerah()">
