<%-- 
    Document   : kemasukanPRIZ
    Created on : Sep 25, 2013, 11:50:20 AM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   if($('#mpb').val() == "")
        ...
        if($('#kULuas').val() == "")
        {   alert("Sila pilih Unit Luas Dipohon.");
            return false;
        }
//        if($('#hakmilikPermohonan.jarak').val() == "")
//        {   alert("Sila masukkan Jarak.");
//            return false;
//        }
//        if($('#unitJarak.kod').val() == "")
//        {   alert("Sila pilih Kod Jarak.");
//            return false;
//        }
//        if($('#hakmilikPermohonan.jarakDari').val() == "")
//        {   alert("Sila masukkan Jarak Dari.");
//            return false;
//        }
//        if($('#hakmilikPermohonan.jarakDariNama').val() == "")
//        {   alert("Sila pilih Jarak Dari Nama.");
//            return false;
//        }
//        if($('#hakmilikPermohonan.jarakDariKediaman').val() == "")
//        {   alert("Sila masukkan Jarak Dari Kediaman.");
//            return false;
//        }
//        if($('#jarakDariKediamanUom.kod').val() == "")
//        {   alert("Sila pilih Unit Jarak Dari Kediaman.");
//            return false;
//        }
        return true;        
    }
                ...
                <c:choose>
                        ...
                        <table class="tablecloth" align="center">
                            ...
                            <tr>
                                <td style="text-align:center;" colspan="3">      
                                    <s:submit name="simpan" value="Simpan" class="btn" id="simpan" onclick="NoPrompt();"/>
                    ...
                    <c:when test="${actionBean.negeri eq '05'}">                        
                        <table class="tablecloth" align="center">
                            ...
                            <c:if test="${actionBean.forSeksyen}">
                                <tr>
                                    <td><font color="red" size="4">*</font>Seksyen :</td>
                                    <td>
                                        <s:select name="kodSeksyen.kod" value="${actionBean.disHakmilikPermohonan.hakmilikPermohonan.kodSeksyen.kod}"style="width:300px;" id="_kodSeksyen" onchange="putValueSeksyen(this.value);">
                                            <s:option value="">-- Sila Pilih --</s:option>
                                            <s:options-collection collection="${actionBean.senaraiKodSeksyen}" value="kod" label="nama" />
...
<%--                            <tr>
                            ...
                            <tr>
                                <td><font color="red" size="4">*</font>Luas Terlibat :</td>
                                <td>
                                    <s:text name="hakmilikPermohonan.luasTerlibat" value="${actionBean.disHakmilikPermohonan.hakmilikPermohonan.luasTerlibat}" formatPattern="#,###,##0.0000" maxlength="15" onkeyup="validateNumber(this,this.value);" id="Luas"/>
                                    <s:select name="disHakmilikPermohonan.keluasanUOM" id="kULuas">
                                        <s:option value="">Sila Pilih</s:option>
