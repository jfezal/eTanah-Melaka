...
<s:form beanclass="etanah.view.stripes.pelupusan.DrafMMKNActionBean">
        ...
        <div class="subtitle">
            ...
            <p>
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'BMBT' || actionBean.permohonan.kodUrusan.kod eq 'PTBTS' || actionBean.permohonan.kodUrusan.kod eq 'PTBTC'}">
                    <s:submit name="cariKodSekatanPTG" value="Cari" class="btn"/>
    ...
    <fieldset class="aras1">
        <legend></legend>
        <p>
            <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSekatan}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pelupusan/draf_mmkn" id="line">
