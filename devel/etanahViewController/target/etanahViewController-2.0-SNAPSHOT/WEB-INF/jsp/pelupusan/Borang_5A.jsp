<%--
    Document   : Borang_5A
    Created on : Sep 1, 2010, 12:30:50 PM
   ...
   <s:form beanclass="etanah.view.stripes.pelupusan.Borang5AActionBean">
                    ...
                    <div class="content"><br/>
                            ...
                            <c:if test="${edit}">
                             ...
                             <c:if test="${edit}">
                               ...
                               <s:text id="pendaftaranTetap" name="amaunTuntutan9" onchange="calc(this.value);" value=""
                                       onkeyup="validateNumber(this,this.value);" formatPattern="#,##0.00" style="width:150px;"/></p><br>
                             </c:if>
        ...
        <br>
                <p>
                    ...
                    <s:button name="simpan2" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div');"/>&nbsp;
                    <%--<s:submit name="simpan2" id="save" value="Simpan" class="btn" />&nbsp;--%>
                    <s:button name="reset" value="Isi Semula" onclick="return test();" class="btn"/>
                   <%-- <s:submit name="SimpanEdit" value="Simpan" class="btn"/>--%>
                </p>
