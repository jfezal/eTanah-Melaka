        ...
        <fieldset class="aras1">
             ...
             <c:if test="${actionBean.edit}">
                 <div id="keputusanEdit">
                    <table>
                        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBPTD' or actionBean.permohonan.kodUrusan.kod eq 'PBPTG' or actionBean.permohonan.kodUrusan.kod eq 'PBMMK' or actionBean.permohonan.kodUrusan.kod eq 'LPSP'}">
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <s:text name="hakmilikPermohonan.luasDiluluskan" id="hakmilikPermohonan.luasDiluluskan"/> 
                                                <s:select name="kodLuaslulusUOM" id="kodLuaslulusUOM" value="${actionBean.kodLuaslulusUOM}">
            ...
            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PPBB' or actionBean.permohonan.kodUrusan.kod eq 'LPSP' or actionBean.permohonan.kodUrusan.kod eq 'PBMMK'}">
                <c:if test="${actionBean.keputusan eq 'T'}">
                     <p align="center">
