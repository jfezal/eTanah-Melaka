<%-- 
    ...
    Created on : Nov 9, 2010, 12:16:47 PM
    Author     : nursyazwani
--%>
...
<div class="subtitle">
    ...
    <s:form beanclass="etanah.view.stripes.pembangunan.LaporanPelukisPelanActionBean" name="form">
        <s:hidden name="idMohonlaporKws" id="idMohonlaporKws" value="${permohonanLaporanKawasan.idMohonlaporKws}"/>
        ...
        <fieldset class="aras1">
            ...
            <p>
                ...
                <s:select name="permohonanLaporanKawasan.rizab.kod" id="rizab">
            ...
            <p>
                ...
                <s:text name="permohonanLaporanKawasan.pelanWarta" size="20" id="pelanWarta"/>
            </p>
            <p>
                <label for="nowarta">No. Warta :</label>
                <s:text name="permohonanLaporanKawasan.noWarta" size="20" id="nowarta" />
            </p>
            <p>
                <label for="tarikhwarta">Tarikh Warta :</label>
                <s:text name="permohonanLaporanKawasan.tarikhWarta" id="datepicker" class="datepicker" size="12" />
            </p>
            <p>
                <label for="catatan">Catatan :</label>
                <s:text name="actionBean.permohonanLaporanKawasan.catatan" size="50" id="catatan"/>
            </p>
            <p>
                <label>&nbsp;</label>
                <s:button name="simpanTanahRizab" value="Kemaskini" class="btn" onclick="save1(this.name, this.form,'${permohonanLaporanKawasan.idMohonlaporKws}');" />
