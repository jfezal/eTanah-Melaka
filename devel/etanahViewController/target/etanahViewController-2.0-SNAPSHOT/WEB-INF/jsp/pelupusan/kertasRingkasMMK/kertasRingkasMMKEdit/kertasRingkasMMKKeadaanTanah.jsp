...
<script type="text/javascript">
    ...
    {   
        NoPrompt();
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkasMMKV2?tambahRow&index='+index;
        window.open(url, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_ringkasMMKV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kPermohonan',q,
            function(data){
                $('#page_div').html(data);
    ...
    function refreshpage(){
        //        alert('aa');
        NoPrompt();
        opener.refreshV2KertasRingkasMMK('main');
        self.close();
    }
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasRingkasanMMKV2ActionBean" name="form">
        <s:errors/>
        <s:messages/>    
        <div class="subtitle">
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganKeadaanTanah}" var="line">
                        <tr>
                            ...
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiKandunganKeadaanTanah[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
