...
<script type="text/javascript">
    ...
    {
        NoPrompt();
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_ringkasMMKV2?tambahRow&index=' + index; //+ '&kodksn=' + kpsn + '&ksn=' + kpsn;
        window.open(url, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
    function deleteRow(idKandungan, f, tName)
    {
        ...
        if (confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_ringkasMMKV2?deleteRow&idKandungan=' + idKandungan + '&tName=' + tName + '&typeName=kPerakuanPtd', q,
                    function(data) {
                        $('#page_div').html(data);
