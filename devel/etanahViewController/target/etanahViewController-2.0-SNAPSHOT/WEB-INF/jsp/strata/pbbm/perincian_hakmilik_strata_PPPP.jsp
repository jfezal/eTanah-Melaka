...
<s:form beanclass="etanah.view.strata.MaklumatTanahPHPPActionBean" id="kemasukanPerincianHakmilik">
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                <label>No PA(B) :</label>
                <s:text name="noPelan1" id="noPelan1" readonly="true" onkeyup="validateNumber2(this,this.value);"/>
            </p>
