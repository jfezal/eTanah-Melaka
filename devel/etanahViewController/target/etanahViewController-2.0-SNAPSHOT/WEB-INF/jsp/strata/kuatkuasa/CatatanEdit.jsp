...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = '${pageContext.request.contextPath}/strata/SemakKertasSiasatan?showRefresh';
        $.ajax({
            type:"GET",
            url : url,
            success : function(data) {
...
<s:form beanclass="etanah.view.strata.SenaraiKertasSiasatanActionBean">
    ...
    <fieldset class="aras1">
        ...
        <p>
            <label> Catatan :</label>
            <s:textarea id="catatan" name="catatan" cols="40" rows="5" />
        </p>
        <br/>
        <p>
            <label>&nbsp;</label>&nbsp;
            <s:button name="upDateCatatan" value="Simpan" class="btn" onclick="simpan(this.name,this.form)"/>
