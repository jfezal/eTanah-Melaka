<%-- 
    Document   : muatnaik_popup
    Created on : Jul 11, 2011, 1:04:04 PM
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = '${pageContext.request.contextPath}/strata/penguatkuasaan_strata?showRefresh';
        $.ajax({
            type:"GET",
            url : url,
            success : function(data) {
...
<s:form beanclass="etanah.view.strata.LaporanSiasatKuatkuasaStrataActionBean">
