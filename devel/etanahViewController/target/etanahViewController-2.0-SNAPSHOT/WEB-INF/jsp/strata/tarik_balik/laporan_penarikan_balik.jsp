...
<script type="text/javascript">
    ...
    function deleteRow(idKandungan)
    {
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var url = '${pageContext.request.contextPath}/strata/semak_penarikan_balik?deleteRow&idKandungan='+idKandungan;
    ...
    function addRow(index)
    {
        if(confirm('Adakah anda pasti untuk menambah data ini?')) {
            var url = '${pageContext.request.contextPath}/strata/semak_penarikan_balik?tambahRow&index='+index;
        ...
        <fieldset class="aras1"> <legend>Kertas Pertimbangan PTG</legend>
            ...
            <table align="left" width="713" border="0">
                        ...
                        <td><table width="650" border="0">
                            ...
                            <c:forEach items="${actionBean.listMohonKertas2}" var="line">
                                ...
                                <tr>
                                    ...
                                    <td><s:hidden name="listMohonKertas2[${i-1}].bil"/><s:hidden name="listMohonKertas2[${i-1}].subtajuk"/> <s:textarea  id="kandungan2${i}"name="listMohonKertas2[${i-1}].kandungan" readonly="${readOnly}" cols="90"  rows="5" class="normal_text"/></td>
                                    <td><c:if test="${edit}"><s:button value="Hapus" class="btn" name="tambah" onclick="deleteRow(${line.idKandungan})"></s:button></c:if> </td>
                ...
                <c:if test="${actionBean.stage2}">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td><center><s:radio name="syorRadio" disabled="${readOnly}" value="DI" id="12" ></s:radio> Disokong <s:radio name="syorRadio" value="DT" id="12" disabled="${readOnly}" ></s:radio> Ditolak </center>&nbsp; </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        ...
                        <td><table width="650" border="0">
                                ...
                                <c:forEach items="${actionBean.listMohonKertas3}" var="line">
                                    <tr>
                                        ...
                                        <td><s:hidden name="listMohonKertas3[${j-1}].bil"/><s:hidden name="listMohonKertas3[${j-1}].subtajuk"/> <s:textarea id="kandungan3${j}" name="listMohonKertas3[${j-1}].kandungan" readonly="${readOnly}" cols="90" rows="5" class="normal_text"/></td>
                                        <td><c:if test="${edit}"><s:button value="Hapus" class="btn" name="tambah" onclick="deleteRow(${line.idKandungan})"></s:button> </c:if></td>
                                ...
                                <tr>
                                    ...
                                    <td  align="left">
                                        <%--<s:button class="btn" value="Tambah" name="add" onclick="addRowViaJS('dataTable1')"/>--%>
                                        <c:if test="${edit}"> <s:button value="Tambah" class="btn" name="tambah"  onclick="addRow('3')"></s:button><s:button name="simpan3" id="save1" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"></s:button> </c:if><%--<td  align="left">
