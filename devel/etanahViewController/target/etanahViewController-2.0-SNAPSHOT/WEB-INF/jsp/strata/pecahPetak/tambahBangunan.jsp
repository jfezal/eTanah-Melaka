...
<script type="text/javascript">
    ...
    function save(event, f){
        ...
        var bil_tgkt = document.getElementById("bil_tgkt").value;
...
<!--                    <s:submit name="test" value="Tambah" class="longbtn" />-->
   ...
   <%-- <div class="subtitle">
        ...
        <fieldset class="aras1">
            ...
            <p>
                <label><em>*</em>Bangunan (B)M:</label><s:text name="bangunan.nama" id="nama" onkeyup="validateNumber(this,this.value);" />
            </p>
            <p>
                <label>Nama Lain :</label><s:text name="bangunan.namaLain" />
            </p>
            <p>
                <label><em>*</em>Jumlah Tingkat :</label><s:text name="bangunan.bilanganTingkat" id="bil_tgkt" onkeyup="validateNumber(this,this.value);"/>
            </p>
            <p>
            ...
            <p>
                <label>&nbsp;</label>
                <s:checkbox name="bangunan.untukLainlain" value="Y" /> Lain-lain (sila nyatakan)
                <s:text name="bangunan.untukKegunaanLain"  size="30"/>
            </p>
            <p>
                <label>Jenis Bangunan :</label>
                <s:radio name="bangunan.kekal" value="Y"/> Kekal
                <s:radio  name="bangunan.kekal" value="N"/> Sementara
            </p>
            <p>
                <label><em>*</em>Menara :</label>

                <input type="radio" name="menara" value="Y" onclick ="javaScript:changebgnn(this.value)"/>Ya
                <input type="radio" name="menara" value="N" onclick ="javaScript:changebgnn(this.value)"  checked="checked"/>Tidak
            ...
            <div id="menara_bgnn" class="subtitle">
                <fieldset class="aras1">
                    ...
                    <p>
                        <label><em>*</em>Bilangan Menara Bagi Bangunan:</label><input type="text" id="bilmenara" name="bangunan.bilanganMenara" value="1"/>
                    </p>
                </fieldset>
            </div>
            <br>
