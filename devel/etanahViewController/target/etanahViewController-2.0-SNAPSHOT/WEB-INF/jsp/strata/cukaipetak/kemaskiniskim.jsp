...
<s:form id="senarai_tugasan" beanclass="etanah.view.strata.cukaipetak.KemaskiniSkimStrataActionBean" name="form2">
    <s:hidden name="btn"/>
    <s:errors/>
    <s:messages/>  
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center"><img src="${pageContext.request.contextPath}/pub/images/loading_img.gif" id="loading-img"/>&nbsp;
                <display:table class="tablecloth" name="${actionBean.senaraiSkim}"
                               ...
                               requestURI="${pageContext.request.contextPath}/strata/kemaskiniskim"
                    ...
                    <display:column title="Jenis Bangunan"><s:select  name="syaratNyata" value="${line.katgBangunan}">
                            <s:option value="">Sila Pilih</s:option>
                    ...
                    <display:column title="Pengkelasan Tanah">                        
                        ${line.kelasTanah}
                        <s:select id="kelasBangun" name="kelasBangun" value="${line.kelasTanah}">
                            <s:option value="" >Sila Pilih</s:option>
                            <s:options-collection collection="${listUtil.senaraiKodKelasTanah}" value="kod" label="nama"/>
                        </s:select>
                    </display:column>
                    <display:column title="Kos Rendah"><s:select  name="kosRendah" value="${line.katgBangunan}">
                            <s:option value="">Sila Pilih</s:option>
