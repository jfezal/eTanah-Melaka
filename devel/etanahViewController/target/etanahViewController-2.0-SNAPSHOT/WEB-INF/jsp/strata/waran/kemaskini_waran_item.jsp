<%--
    Document   : kemaskini_waran_item
    Created on : Sep 27, 2011, 1:20:16 PM
...
<script type="text/javascript">
    ...
    function simpan(event, f){
        var idMh = $("#idMh").val();
        var idMohonWaranItem = $("#idMohonWaranItem").val();

        var q = $(f).formSerialize();

        var url = f.action + '?' + event+'&idMohonWaranItem='+idMohonWaranItem+'&idMh='+idMh;
...
<s:form beanclass="etanah.view.strata.WaranPenahananActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <s:hidden name="idMohonWaranItem" id="idMohonWaranItem" />
            ...
            <p> <c:if test="${!actionBean.display}">
                    <label>&nbsp;</label><s:button class="btn" name="kemaskiniWaranItem" value="Kemaskini" onclick="simpan(this.name,this.form);"/>
