                            ...
                            <table id ="dataTable1">
                                ...
                                <c:forEach items="${actionBean.senaraiLaporanKandungan1}" var="line">
                                    <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="1.${k}"/></td>
                                        <td><font style="text-transform: uppercase"><s:textarea name="kandungan1${i}" id="kandungan1${i}"  rows="5" cols="100" onkeyup="this.value=this.value.toUpperCase();">${line.kandungan}</s:textarea> <s:button class="btn" value="Hapus" name="delete" id="${i}" onclick="deleteRow('dataTable1',this.id)"/></font>
                                        </td></tr>
                  ...
                  <tr><td><b>4. ULASAN PENGARAH TANAH DAN GALIAN, NEGERI SEMBILAN DARUL KHUSUS</b></td></tr>
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr><td valign="top"><b>4.1</b></td>
                                        <td><font style="text-transform:uppercase">
                                                ${actionBean.ulasapengarah}</font></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                             ...
                             <table id ="dataTable4" border="0">
                                ...
                                <c:forEach items="${actionBean.senaraiLaporanKandungan4}" var="line">
                                    <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="4.${k}"/></td>
                                        <td><font style="text-transform: uppercase"><s:textarea name="kandungan4${i}" id="kandungan4${i}"  rows="5" cols="100" onkeyup="this.value=this.value.toUpperCase();">${line.kandungan}</s:textarea> <s:button class="btn" value="Hapus" name="delete" id="${i}" onclick="deleteRow('dataTable4',this.id)"/></font>
                                        </td></tr>
                                        <c:set var="i" value="${i+1}" />
                                        <c:set var="k" value="${k+1}" />
                                    </c:forEach>
                     ...
                     <tr>
                       ...
                       <tr><td><b>5. SYOR PENGARAH TANAH DAN GALIAN NEGARI SEMBILAN</b></td></tr>
