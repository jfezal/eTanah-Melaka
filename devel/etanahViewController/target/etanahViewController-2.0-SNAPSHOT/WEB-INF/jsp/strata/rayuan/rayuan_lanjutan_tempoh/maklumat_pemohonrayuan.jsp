...
<s:form beanclass="etanah.view.strata.rayuan">
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                <label>Nama/Nama Syarikat :</label> <s:text name="nama_pemohon" ></s:text>

            </p>
           <p>
                <label>Nombor Kad Pengenalan/Nombor Pendaftaran Syarikat :</label> <s:text name="no_pengenalan" ></s:text>
...
<p>
     ...
     <p>
             ...
             <label>Email :</label> <s:text name="email" ></s:text>
                 ...
                 <p>
                <label>&nbsp;</label>
                <a href="rayuan?showForm69" <s:submit name="Terus" value="Terus" class="btn"/></a>
                <a href="rayuan?showForm2" <s:submit name="isisemula" value="Isi Semula" class="btn" /></a>
