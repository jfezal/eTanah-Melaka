    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <div class="bckrnd" align ="center">
                <c:if test = "${actionBean.foredit eq 'NE'}">
                    ...
                    <tr>
                        ...
                        <td><b>: </b> </td>
                        <td>
                            <s:textarea rows="3" readonly="readOnly" cols="80" name="premiumDesc" class="jqte-test"/>
                            <s:text name="premium" class="normal_text" size="20" onkeyup="validateNumber(this,this.value);"/>                     
                        </td>
                        <td>
                            <em>* Sila Inputkan Data 0 Jika Jumlah Premium Adalah 0 </em>
                    ...
                    <tr>
                        ...
                        <td><b>:  </b></td>
                        <td>
                            <s:textarea rows="3" readonly="readOnly" cols="80" name="hasilDesc" class="jqte-test"/>
                            <s:text name="hasil" class="normal_text" size="20" onkeyup="validateNumber(this,this.value);"/> 
                        </td>
                        <td>
                            <em>* Sila Inputkan Data 0 Jika Jumlah Hasil Adalah 0 </em>                 
                 ...
                 <%--   <tr>
                        <td> &nbsp; Premium    </td>
                        <td><b>: </b> </td>
                        <td><s:textarea rows="3" readonly="readOnly" cols="80" name="premiumDesc" class="jqte-test"/></td>
                    ...
                    <tr>
                        <td> &nbsp; Hasil    </td>
                        <td><b>:  </b></td>
                        <td><s:textarea rows="3" readonly="readOnly" cols="80" name="hasilDesc" class="jqte-test"/></td>
            ...
            <c:if test ="${actionBean.foredit eq 'NE'}">
                ...
                <div align="center">      
                    <td><s:submit name="simpanPopup" id="save" value="Simpan" class="btn1"/> </td>
                    <td><s:button name="" id="tutup" value="Tutup" class="btn1" onclick="self.close()"/></td>                   
                </div>
                </tr>
            </c:if>
                <!------------------------------------------------------------ Toggle jQTE Button ------------------------------------------------------------>
