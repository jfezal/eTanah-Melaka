<%--
    Document   : muat_naik
    Created on : Oct 10, 2011, 8:19:28 AM
    Author     : Syaiful
--%>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = '${pageContext.request.contextPath}/pembangunan/muat_naik_imej?showRefresh';
        $.ajax({
            type:"GET",
            url : url,
            success : function(data) {
...
<s:form beanclass="etanah.view.stripes.pembangunan.MuatNaikImejActionBean">
    ...
    <fieldset class="aras1">
        ...
        <p> <p>
            <label><font color="red"><b>*</b></font> Catatan :</label><s:textarea name="catatan" cols="50" rows="5"/>
