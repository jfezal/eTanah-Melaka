...
<s:form beanclass="etanah.view.stripes.pembangunan.PihakBerkepentinganActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                <label>Nama :</label>
                <s:text name="nama" id="nama" size="40"/><s:hidden name="pihak.idPihak"/>
                <%-- ${actionBean.pihak.nama}&nbsp;<s:hidden name="pihak.idPihak"/> 26/05/2016--%>
            </p>
            <p>
            ...
            <p>
                ...
                <s:text name="noTel1" id="noTel1" maxlength="11" onkeyup="validateNumber2(this,this.value);"/>
            </p>
            <p>
                <label>No. Telefon 2 :</label>
                <s:text name="noTel2" id="noTel2" maxlength="11" onkeyup="validateNumber2(this,this.value);"/>
            </p>
            ...
            <p>
                <label>&nbsp;</label>
                <s:button name="simpanPihakPindaan" id="simpan" value="Simpan" class="btn" onclick="save(this.name, this.form);"/>
                <label>&nbsp;</label>
