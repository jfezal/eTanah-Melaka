<%-- 
    Document   : charting_kelulusan_penolakan
    Created on : Dec 30, 2009, 1:51:19 PM
    Author     : nursyazwani
--%>
...
<html>
    <head>
        ...
        <title>Charting Kelulusan Penolakan</title>
    </head>
    <body>
        <stripes:form beanclass="etanah.view.stripes.pembangunan.SerahBalikTanahActionBean">
           <div class="subtitle">
           ...
           <%--end--%>
           <p align="center">
                        <s:button name="charting" value="Charting Kelulusan" class="longbtn"/>&nbsp;
