...
<script type="text/javascript">
    ...
    function selectCheckBox()
    {
        ...
        if(confirm("Adakah anda pasti?")) {
            var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?simpanAgensi&item='+data ;
            $.get(url,
            function(data){
        ...
        <s:form beanclass="etanah.view.stripes.pembangunan.LaporanTanahV2ActionBean" name="frm">
            <fieldset class="aras1">
                ...
                <p>
                    ...
                    <s:button name="tutup" value="Tutup" class="btn" onclick="openFrame('jTeknikal')"/>
                </p>
            </fieldset>
        </div>
        <br>
