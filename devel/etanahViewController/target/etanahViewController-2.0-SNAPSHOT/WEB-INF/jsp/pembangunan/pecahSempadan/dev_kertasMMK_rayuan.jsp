...
<script type="text/javascript">
    ...
    function deleteRow2(idKandungan, index)
    {
        ...
        if (idKandungan == '') {
            ...
            var url = '${pageContext.request.contextPath}/pembangunan/kertas_mmk_rayuan?deleteSingle&idKandungan='
                    + idKandungan;
            $.get(url,
                    function(data) {
                        $('#page_div').html(data);
        ...
        try {
            ...
            if (rowCount > 1) {
                for (var i = 0; i < rowCount; i++) {
                    ...
                    if (i > 0) {
                        table.rows[i].cells[1].childNodes[0].name = 'asas' + (i + 1);
                        table.rows[i].cells[2].childNodes[0].id = i;
                    }
                }
            }
...
<s:form beanclass="etanah.view.stripes.pembangunan.KertasMMKRayuanActionBean">
    <s:messages/>
    <s:errors/>
                    ...
                    <div class="content" align="center">
                        <table border="0" width="80%">
                            ...
                            <td>
                                <table width="100%">
                                    <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${actionBean.noIdPermohonanBaru}</td>
                                    </tr>
                                    <c:if test="${edit2}">
                                        <tr>
                                        <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${actionBean.noRujukan}</td>
                                        <td align="right">KM No: <s:text name="kmno" id="kmno" size="35"/></td>
                                        </tr>
                                    </c:if>
                                    <c:if test="${!edit2}">
                                        <tr>
                                        <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${actionBean.noRujukan}</td>
                                        <td align="right">KM No: ${actionBean.kmno}</td>
                                        </tr>
                                    </c:if>
                                </table>
                            </td>
                            </tr
                            <c:if test="${edit2}"><tr><td align="center"><b>(MAJLIS MESYUARAT KERAJAAN PADA <s:text name="tarikhMesyuarat" id="datepicker1" class="datepicker" formatPattern="dd/MM/yyyy"/>)</b></td></tr><br></c:if>
                            <c:if test="${!edit2}"><tr><td align="center"><b>(MAJLIS MESYUARAT KERAJAAN PADA ${actionBean.tarikhMesyuarat})</b></td></tr><br></c:if>
                            <c:if test="${edit}">
                                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textarea name="tajuk" rows="5" cols="150"/></td></tr><br>
                            </c:if>
                            <c:if test="${!edit}">
                                <tr><td><b><font style="text-transform:uppercase">${actionBean.tajuk} &nbsp;</font></b></td></tr><br>
                                        </c:if>
                            ...
                            <c:if test="${edit}">
                                ...
                                <tr><td>
                                    <table cellspacing="10">
                                        <tr>
                                        <td><b>1.1 </b></td>
                                        <td><font style="text-transform:none">${actionBean.tujuan}</font></td>
                                        </tr>
                                    </table>
                                </td></tr>
                            </c:if>
                            ...
                            <c:if test="${edit}">
                                <tr><td>
                                    <table id ="dataTable3">
                                        <tr>
                                        <td><b>3.1 </b></td>
                                        <td><s:textarea name="asas1" id="asas1"  rows="5" cols="150" class="normal_text"></s:textarea></td>
                                            </tr>
                                        <c:set var="i" value="2" />
                                        <c:forEach items="${actionBean.senaraiKandungan3}" var="line" begin="1">
                                            <tr><td style="display:none">${line.idKandungan}</td>
                                            <td><b>3.${i}</b></td>
                                            <td><s:textarea name="asas1{i}" id="asas1{i}"  rows="5" cols="150" class="normal_text">${line.kandungan}</s:textarea></td>
                            ...
                            <tr><td><b>6. PENUTUP</b></td></tr>
                            <c:if test="${edit}">
                                <tr><td>
                                    <table>
                                        <tr>
                                        <td><b>6.1 </b></td>
                                        <td><s:textarea rows="5" cols="150" name="penutup" class="normal_text"/></td>
                                        </tr>
                                    </table>
                                </td></tr>
                            </c:if>
