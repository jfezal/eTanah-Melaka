<%-- 
    Document   : 16H_scan_doc
    Created on : Aug 5, 2010, 10:11:16 AM
...
<script type="text/javascript">
    ...
    function successRedirection() {
        var url = '${pageContext.request.contextPath}/lelong/kemasukkan_rekod?reload';
        $.ajax({
            type:"GET",
            url : url,
...
<s:form beanclass="etanah.view.stripes.pembangunan.PenghantaranNotis7GActionBean">
