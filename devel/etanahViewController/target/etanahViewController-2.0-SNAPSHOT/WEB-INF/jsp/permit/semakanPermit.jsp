<%-- 
    Document   : semakanPermit
    Created on : Oct 22, 2015, 10:27:14 AM
    Author     : Hazwan
--%>
...
<stripes:form beanclass="etanah.view.stripes.permit.PermitActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <legend>
                <td align="center"><font color="#001848"><b> Sila Masukkan No. Fail Rujukan Dan No. Lesen/Permit Untuk Tujuan Semakan</b></font></td>
            </legend>
            <br/>
