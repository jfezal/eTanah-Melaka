<%-- 
    Document   : bil_cukai
    Created on : Apr 14, 2011, 1:55:27 PM
    Author     : abdul.hakim
--%>
...
//        $.unblockUI();
    ...
    function popupKumpulan(){
        var url = '${pageContext.request.contextPath}/hasil/bil_cukai?popupCarianKumpulan';
        ...
        <tr>
            <td width="100%" height="20" >
                <div style="background-color: green;" align="center">
                    <font style="font-family: Tahoma; font-size: 16px; font-weight: bold;">HASIL: Set-up Bil Cukai</font>
                </div>
            </td>
        </tr>
    </table></div>
...
<stripes:form beanclass="etanah.view.stripes.hasil.BilCukaiNSActionBean" id="bil_tahunan" >
