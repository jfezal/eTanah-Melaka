<%-- 
    Document   : kertasRisalatKeputusan
    Created on : Jun 4, 2013, 9:35:37 AM
    Author     : khadijah
--%>
...
<script type="text/javascript">
    ...
    function deleteRow(idKandungan,f,tName)
    {
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/hasil/kertas_risalat?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kKeputusan',q,
            function(data){
                $('#page_div').html(data);
            ...
            <fieldset class="aras1">
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganKeputusan}" var="line">
                        <tr>
                            <td style="text-align: right"><c:out value="8.${num}"/></td>
                            <td>
