<%-- 
    Document   : papar_keputusan_other
    Created on : Dec 3, 2009, 9:24:18 AM
    Author     : abu.mansur
--%>
...
<s:form beanclass="etanah.view.stripes.hasil.KeputusanPaparRemOthersActionBean">
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            <legend>
                ...
                <p>
                    ...
                    ${actionBean.permohonanAktiviti.luasTerlibat}&nbsp;
                </p>
                <P>
                    <label><font color="red">*</font>Tarikh mula ditanam semula :</label>
                    <fmt:formatDate pattern="dd/MM/yyyy" value="${actionBean.permohonanAktiviti.tarikhMula}"/>&nbsp;
                </P>
                <p style="height:50px">
                    <label><font color="red">*</font>Pengurangan Semula Tahun Sebelum Kerana Ditanam Semula :</label>
                    ${actionBean.permohonanAktiviti.tahunSebelum}&nbsp;
                </p>
                <p>
                    <label>Tanah-tanah yang dimiliki selain tanah dipohon :</label>
                    &nbsp;
                    <h4><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <p>
                    ...
                    ${actionBean.permohonanAktiviti.hakmilikLain}&nbsp;
                </p>
                <p>
                    <label>ii) Nombor Lot / PT :</label>
                    ${actionBean.permohonanAktiviti.lotLain}&nbsp;
                </p>
        </fieldset>--%>
            <br>
        <fieldset class="aras1">
