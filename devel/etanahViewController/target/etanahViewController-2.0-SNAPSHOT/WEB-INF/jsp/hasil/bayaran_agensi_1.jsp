<%-- 
    Document   : bayaran_agensi_1
    Created on : Feb 22, 2011, 4:57:28 PM
    Author     : abdul.hakim
--%>
...
<stripes:form beanclass="etanah.view.stripes.hasil.BayaranAgensiActionBean" id="bayar_agensi">
                        ...
                        <td>
                            <display:table name="${actionBean.senaraiCaraBayaran}" id="row" class="tablecloths">
                                ...
                                <display:column title="Tarikh">
                                    <em id="tcek${row_rowNum - 1}">*</em><stripes:text name="tarikhCek[${row_rowNum-1}]" id="trkh${row_rowNum - 1}" size="20" readonly="true" maxlength="10" class="datepicker"/>
                                </display:column>
    ...
    <div align="center"><table border="0" bgcolor="green" style="width:99.2%">
            <tr>
                <td align="right">
                    <stripes:submit name="Step4" value="Bayar" onclick="return checkAmount()" class="btn" id="pay"/>
...
<script language="javascript" >
    $(document).ready(function() {
        ...
        $("#a0").hide();
        $("#tcek0").hide();
        $('#amaun0').val((${actionBean.jumlahBayar}).toFixed(2));
        $('#jumCaraBayar').val((${actionBean.jumlahBayar}).toFixed(2));
...
<script type="text/javascript">
    function checkAmount(){
        var asal = ${actionBean.jumlahBayar};
    ...
    <%--}--%>
            ...
            if(yy>=0){
                var t = document.getElementById('jumCaraBayar');
                var bal = (parseInt(${actionBean.jumlahBayar}) - parseInt(t.value)).toFixed(2);
                if(bal > 0)
                    $('#amaun' + (row+1)).val(bal);
            }else{
                var t = document.getElementById('jumCaraBayar');
