...
<div class="subtitle displaytag">
    <s:form beanclass="etanah.view.stripes.hasil.PenyediaanEndorsanActionBean">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <p>
                    <label>&nbsp;</label>
                    <s:textarea name="hakmilik.syaratNyata.syarat" rows="5" cols="60" id="syarat" readonly="true">${actionBean.hakmilik.syaratNyata.syarat}</s:textarea>
                </p>
                <p>
