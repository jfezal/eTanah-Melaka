<%-- 
    Document   : kemaskini_maklumat_pembayar
    Created on : Apr 12, 2011, 11:08:52 AM
    Author     : abdul.hakim
--%>
...
<script type="text/javascript">
    function save1(f){
        if(validationAddress()){
            ...
            self.opener.refreshPagesAddress(f);
            self.close();
        }
    }
...
--%>
          ...
          <%--  <p>
            ...
            <div align="center">
                <s:submit name="save" value="Simpan" class="btn" onclick="return save1(this.form);" />
