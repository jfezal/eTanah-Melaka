...
<div class= "all">
     ...
     maximizeWindow();
        ...
        function removeNonNumeric( strString )
        {
         ...
         function goTo(frm, value,value2) {
           ...
           var url = '${pageContext.request.contextPath}/utility_kod/kemasukanAdun?updateData&table_name='+value+'&kod='+value2;
            frm.action = url;
            frm.submit();
            }
        }
         function goTo2(frm, value) {
            var url = '${pageContext.request.contextPath}/utility_kod/kemasukanAdun?KodList&table_name='+value;
            frm.action = url;
            frm.submit();
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KemasukanAdunActionBean" name ="kemaskiniKodAgensi" id ="kemaskiniKodAgensi">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Kemaskini Kod Agensi </legend>
                 ...
                 <p><label><font color="red">*</font>Nama :</label>
                  ...
                  <p><label><font color="red">*</font>Alamat 1 :</label>
                            <s:text id="alamat1" name="details.alamat1" value ="${actionBean.details.alamat1}"></s:text>
                </p>
                <p><label><font color="red">*</font>Alamat 2 :</label>
                            <s:text id="alamat2" name="details.alamat2" value ="${actionBean.details.alamat2}"></s:text>
                </p>
                <p><label><font color="red">*</font>Alamat 3 :</label>
                            <s:text id="alamat3" name="details.alamat3" value ="${actionBean.details.alamat3}"></s:text>
                </p>
                <p><label><font color="red">*</font>Alamat 4 :</label>
                            <s:text id="alamat4" name="details.alamat4" value ="${actionBean.details.alamat4}"></s:text>
                </p>
