...
<div class= "all">
    <script type="text/javascript">
        ...
        function kemaskini(frm, value,value2) {
            var url = '${pageContext.request.contextPath}/utility_kod/kemasukanAdun?viewKodAgensi&kod='+value+'&table_name='+value2;
            frm.action = url;
            frm.submit();
        }
        function goBack(frm) {
        ...
        function addDokumen(frm, value) {
            var url = '${pageContext.request.contextPath}/utility_kod/kemasukanAdun?viewAddForm&table_name='+value;
            frm.action = url;
            frm.submit();
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KemasukanAdunActionBean" name ="kodAgensi" id ="kodAgensi">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Kemasukan ADUN</legend>
                ...
                <p align="center"><s:submit name="KodList2" value="Cari" class="btn"/>&nbsp;<s:button name = "reset" class="btn" value ="Isi Semula" onclick= "clearText('kodAgensi')" />&nbsp;<s:button name = "tambah" class="btn" value ="Tambah" onclick= "addDokumen(document.forms.kodAgensi,'${actionBean.nameTable}')" />&nbsp;<s:button name="kembali" value="Kembali" class="btn" onclick="goBack(document.forms.kodAgensi)" /></p>
