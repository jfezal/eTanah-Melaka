...
<div class= "all">
     ...
     maximizeWindow();
        ...
        function removeNonNumeric( strString )
        {
         ...
         function goTo(frm, value) {
            ...
            var url = '${pageContext.request.contextPath}/utility_kod/kemasukanAdun?simpanData&table_name='+value;
            frm.action = url;
            frm.submit();
            }
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KemasukanAdunActionBean" name ="tambahKodAgensi" id ="tambahKodAgensi">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Tambah Kod Agensi </legend>
                <s:hidden value = "${actionBean.id_rekod_agensi}" name = "id_rekod_agensi"/>
                 <p><label><font color="red">*</font>Nama :</label>
                  ...
                  <p><label><font color="red">*</font>Alamat 1 :</label>
                            <s:text id="alamat1" name="alamat1" value ="${actionBean.alamat1}"></s:text>
                </p>
                <p><label><font color="red">*</font>Alamat 2 :</label>
                            <s:text id="alamat2" name="alamat2" value ="${actionBean.alamat2}"></s:text>
                </p>
                <p><label><font color="red">*</font>Alamat 3 :</label>
                            <s:text id="alamat3" name="alamat3" value ="${actionBean.alamat3}"></s:text>
                </p>
                <p><label><font color="red">*</font>Alamat 4 :</label>
                            <s:text id="alamat4" name="alamat4" value ="${actionBean.alamat4}"></s:text>
                </p>
