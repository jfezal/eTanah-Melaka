...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.jomPay.TestPayActionBean" name="form">
        <s:errors/>
        <s:messages/>
        <fieldset class="aras1">
            ...
            <p>
                <label>&nbsp;</label>&nbsp;
              noAkaun  <s:text name="noAkaun"/>
               amaun <s:text name="amaun"/>
            <p>
                &nbsp;<p></p>
            <p>
            </p>
            ...
            <p>
                <label>&nbsp;</label>&nbsp;
                <s:submit name="bayar" value="Bayar" class="btn"/>
