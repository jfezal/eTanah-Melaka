        ...
        <fieldset class="aras1">
            ...
            <c:if test="${fn:length(actionBean.permohonanList) == 0}">
                ...
                <p>
                    ...
                    <s:text name="hakmilik.idHakmilik" size="50" maxlength="35" id="idHakmilik" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>
                <p>
                    <label>&nbsp;</label>
                    atau
                ...
                <p>
                    ...
                    <s:select name="pihakPemohon.jenisPengenalan.kod" id="jenisKp">
                ...
                <p>
                    ...
                    <s:text name="pihakPemohon.noPengenalan" id="noKp" size="50" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>
                <p>
                    <label>&nbsp;</label>
                    atau
                ...
                <p>
                    <label><em>*</em>Nama Pemohon :</label>
                    <s:text name="namaPemohon" size="50" maxlength="" id="idHakmilik" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>
                <p>
                    <label>&nbsp;</label>
                    atau
                ...
                <p>
                    ...
                    <s:text name="pihakPenerima.noPengenalan" id="noKp2" size="50" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>
                <p>
                    <label>&nbsp;</label>
                    atau
                ...
                <p>
                    <label><em>*</em>Tarikh Permohonan :</label>
                    <s:text name="tarikhMula" size="10" class="datepicker" id="tarikhMula" onchange="dateValidation(this.id, this.value)"/> Hingga <s:text name="tarikhTamat" size="10" class="datepicker" id="tarikhTamat" onchange="dateValidation(this.id, this.value)"/>
                </p>
            </c:if>
            <c:if test="${fn:length(actionBean.permohonanList) == 0}">
                <p align="center">
                ...
                <div align="center">
                    <display:table name="${actionBean.permohonanList}" class="tablecloth" id="line" style="width:90%" pagesize="20" requestURI="${pageContext.request.contextPath}/consent/semak_status">
                        ...
                        <display:column title="ID Permohonan" sortable="true">
                            <a href="#" title="klik untuk paparan" onclick="viewStatus('${line.idPermohonan}');
                                    return false;">${line.idPermohonan}</a>
                        </display:column>
