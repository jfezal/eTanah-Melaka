...
<script type="text/javascript">
    ...
    $('#kodBangsa').hide();
            ...
            $('#perut').show();
            $('#luak').show();
            $('#warganegaraAsal').show();
            $('#warganegaraIndividu').hide();
            $('#warganegaraSyarikat').hide();
            $('#tarikhLahirText').show();
            $('#umurText').show();
            $('#tempatLahirText').show();
            $('#statusKahwinText').show();
            $('#pekerjaanText').show();
            $('#pendapatanText').show();
            $('#tanggunganText').show();
    ...
    $('#kodBangsa').hide();
            ...
            $('#warganegaraIndividu').hide();
            $('#warganegaraSyarikat').hide();
            $('#tarikhLahirText').hide();
            $('#umurText').hide();
            $('#tempatLahirText').hide();
            $('#statusKahwinText').hide();
            $('#pekerjaanText').hide();
            $('#pendapatanText').hide();
            $('#tanggunganText').hide();
            if ((kodNegeri == '04' && kodUrusan == 'PMMK1') || (kodNegeri == '04' && kodUrusan == 'PMMK2')){
    ...
    autoOpen: false,
            ...
            $(this).dialog('close');
                    ...
                    var idDelete = "x" + rowNoEdit;
                            ...
                            '</tr>');
                            var url = '${pageContext.request.contextPath}/consent/pihak_kepentingan?savePihak';
                    }

                    else{

                    var url = '${pageContext.request.contextPath}/consent/pihak_kepentingan?savePengarahEdit&idPengarah=' + idPengarah + '&idMohonPihak=' + idMohonPihak + '&idPemohon=' + idPemohon + '&namaPengarah=' + nama + '&kpPengarah=' + kp + '&noKpPengarah=' + noKp + '&wargaPengarah=' + warga + '&idPihak=' + $('#idPihak').val() + '&idHakmilik=' + $('#idHakmilik').val(); ;
                    }
    ...
    $('#kodBangsa').hide();
            ...
            $('#cawangan').hide();
            $('#pengarah').hide();
            $('#warganegaraAsal').hide();
            $('#warganegaraIndividu').show();
            $('#warganegaraSyarikat').hide();
            $('#tarikhLahirText').show();
            $('#umurText').show();
            $('#tempatLahirText').show();
    ...
    var val = $('#kod_warganegara').val();
            ...
            var val5 = $('#KatgPenerima').val();
            var val6 = $('#KatgPemohon').val();
    ...
    var kodNegeri = '${actionBean.kodNegeri}';
            var kodUrusan = '${actionBean.permohonan.kodUrusan.kod}';
            if (val4 == "PA" || val4 == "PP" || val4 == "WS"){
    if ($('table#pgAmanahTable tr').length == 1){
    if (val4 == "PA"){
    alert('Sila Masukkan Penerima Amanah.');
    }
    else if (val4 == "PP"){
    alert('Sila Masukkan Penerima Tadbir.');
    }
     else{
    alert('Sila Masukkan Penerima Wasi.');
    }
    return false;
    }
    }
    ...
    if ((kodNegeri == '04' && kodUrusan == 'PMMK1') || (kodNegeri == '04' && kodUrusan == 'PMMK2')){
    var jantina = $('#jantinaData').val();
    <%--var mastautin =  $('#mastautin').val();--%>
    <%--var pendapatan =  $('#pendapatan').val();--%>
    var tarikhTubuh = $('#datepicker2').val();
            var tempatLahir = $('#tempatLahir').val();
    ...
    doBlockUI();
            var url = '${pageContext.request.contextPath}/consent/pihak_kepentingan?deletePengarah&idPengarah=' + val + '&idPihak=' + $('#idPihak').val() + '&idHakmilik=' + $('#idHakmilik').val();
            frm = document.form1;
            frm.action = url;
            frm.submit();
    }
    ...
    if (confirm('Adakah anda pasti?')) {
    doBlockUI();
            var url = '${pageContext.request.contextPath}/consent/pihak_kepentingan?deletePihakCaw&idPihakCaw=' + val + '&idPihak=' + $('#idPihak').val() + '&idHakmilik=' + $('#idHakmilik').val();
            frm = document.form1;
            frm.action = url;
            frm.submit();
    }
    ...
    <s:form beanclass="etanah.view.stripes.consent.PihakKepentinganActionBean" name="form1">
        ...
        <c:if test="${penerima || penerimaGadaian}">
            <fieldset class="aras1">
                    ...
                    <c:if test="${penerima}">
                        ...
                        <c:choose>
                            <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PCPTD' || actionBean.permohonan.kodUrusan.kod eq 'PGDMB' 
                                            ...
                                            || actionBean.permohonan.kodUrusan.kod eq 'PMMMK' || actionBean.permohonan.kodUrusan.kod eq 'PPTGM'
                                            || actionBean.permohonan.kodUrusan.kod eq 'PMKMM' || actionBean.permohonan.kodUrusan.kod eq 'PMPTD'
                ...
                <p id="warganegaraIndividu">  <label><font color="red">*</font>Kewarganegaraan :</label></p>
                <p id="warganegaraSyarikat">  <label><font color="red">*</font>Negara Syarikat :</label></p>
                <p id="warganegaraAsal">
                    <c:choose>
                        <c:when test="${actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L'
                                ...
                                <label><font color="red">*</font>Kewarganegaraan :</label>
                                    ...
                                    <c:otherwise>
                                <label>Kewarganegaraan/Negara Syarikat :</label>
                        </c:otherwise>
                    </c:choose>
                </p>
                <s:select name="pihak.wargaNegara.kod" style="width:200px" id="kod_warganegara">
                            ...
                            <c:choose>
                                <c:when test="${actionBean.kodNegeri eq '05'}">
                                    <c:choose>
                                        ...
                                        <c:when  test="${actionBean.permohonan.kodUrusan.kod eq 'CGADT' || actionBean.permohonan.kodUrusan.kod eq 'MCGMB' 
                                                         || actionBean.permohonan.kodUrusan.kod eq 'MCMMK' || actionBean.permohonan.kodUrusan.kod eq 'MCPTD'
                                                         || fn:startsWith(actionBean.permohonan.kodUrusan.kod, 'GPTD') }">                                            
                                            <s:option value="PGA">PENERIMA GADAIAN</s:option>
                                            <s:option value="PA">PEMEGANG AMANAH</s:option>
                                        </c:when>
                                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'TMADT' || actionBean.permohonan.kodUrusan.kod eq 'TMWNA' 
                ...
                <p id="kodBangsaOrang">
                    <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PMADT' && actionBean.permohonan.kodUrusan.kod ne 'CGADT' && actionBean.permohonan.kodUrusan.kod ne 'PAADT' && actionBean.permohonan.kodUrusan.kod ne 'TMADT' && actionBean.permohonan.kodUrusan.kod ne 'BTADT'}">
                        ...
                        <%--<label>Bangsa :</label>--%>
                        <s:select name="pihak.bangsa.kod" id="kodBangsaOrangData" style="width:400px" >
                            <s:option value="">Sila Pilih</s:option>
                ...
                <c:if test="${(actionBean.kodNegeri eq '04' && actionBean.permohonan.kodUrusan.kod eq 'PMMK1') || (actionBean.kodNegeri eq '04' && actionBean.permohonan.kodUrusan.kod eq 'PMMK2')}">
                    ...
                    <p id="jantina">
                        <label><font color="red">*</font>Jantina :</label>
                                <s:select name="pihak.kodJantina" id="jantinaData" style="width:200px">
                                    <s:option value="">Sila Pilih</s:option>
                    ...
                    <%--    <c:if test="${actionBean.pihak.jenisPengenalan.kod ne null && actionBean.pihak.jenisPengenalan.kod ne 'B' && actionBean.pihak.jenisPengenalan.kod ne 'L'
                    ...
                    <p id="ditubuh">
                        ...
                        <s:text name="tarikhLahir" size="40" id="datepicker2" class="datepicker" />&nbsp;<em style="font-style:normal">(cth : hh / bb / tttt)</em>
                    </p> 
                    <%--   
                    </c:if>
                    --%>
                ...
                <p align="center">
                    ...
                    <c:if test="${penerimaGadaian}">
                        <s:submit name="showSearchFormGadaian" class="btn" value="Carian Semula"/>
                    </c:if>
        ...
        <c:if test="${pemohon}">
            <fieldset class="aras1">
                ...
                <p>
                    <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'MCKMM' || actionBean.permohonan.kodUrusan.kod eq 'MCPTG' 
                                  || actionBean.permohonan.kodUrusan.kod eq 'PJKMM' || actionBean.permohonan.kodUrusan.kod eq 'PMKMM' 
                                  || actionBean.permohonan.kodUrusan.kod eq 'PPTGM' || actionBean.permohonan.kodUrusan.kod eq 'SWKMM'
                                  || actionBean.permohonan.kodUrusan.kod eq 'PMPTD' || actionBean.permohonan.kodUrusan.kod eq 'MCPTD' 
                                  || actionBean.permohonan.kodUrusan.kod eq 'PJPTD' || actionBean.permohonan.kodUrusan.kod eq 'SWPTD'}">
              ...
              <p>
                ...
                <%-- 
                 <label>Tempoh Mastautin (Tahun) :</label>
                 <s:text name="pemohon.tempohMastautin" id="mastautinData" size="10" maxlength="3" onkeyup="validateNumber(this,this.value);"/>
             </p>--%>
                <%--  </c:if>
                ...
                <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L'
                      ...
                      <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PMADT' && actionBean.permohonan.kodUrusan.kod ne 'CGADT' && actionBean.permohonan.kodUrusan.kod ne 'PAADT' && actionBean.permohonan.kodUrusan.kod ne 'TMADT' && actionBean.permohonan.kodUrusan.kod ne 'BTADT'}">
                          ...
                          <p>
                              ...
                              <s:text name="pemohon.pendapatan" id="pendapatanPemohon" size="14" maxlength="12" formatPattern="#,###.00"  onchange="convert(this.value, this.id);" onkeyup="validateNumber(this,this.value);"/>
                          </p>
                          <p>
                              <label>Tanggungan :</label>
