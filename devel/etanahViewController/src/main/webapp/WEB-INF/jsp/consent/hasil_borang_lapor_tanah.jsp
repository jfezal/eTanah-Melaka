<%-- 
    Document   : hasil_borang_lapor_tanah
    Created on : Jun 15, 2010, 10:34:17 PM
    Author     : nurfaizati
--%>
...
<%--    function save1(f){
            ...
            self.opener.simpan(f);
            self.close();

    }--%>
 function save1(f, id1, id2){
     alert("asfsdfsd");
     ...
     alert(x.value);
        ...
        window.open("${pageContext.request.contextPath}/hasil/laporan_tanah_hasil?simpan&"+queryString+"&idHakmilik="+id1+"&id="+id2+"&idPermohonan="+x.value, "eTanah",
...
<s:form beanclass="etanah.view.stripes.hasil.LaporanTanahActionBean">
    <s:messages/>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <s:hidden name="laporanTanah.hakmilikPermohonan.id"/>
    ...
    <s:text name="idHakmilik" style="display:none;"/>
    <s:text name="idPermohonan" style="display:none;"/>
    <s:text name="id" style="display:none;"/>
        ...
        <fieldset class="aras1">
         ...
         <%--   <legend>Ulasan Pegawai</legend>
            <c:if test="${edit}">
                <p>
                    <label>Ulasan :</label>
                    <s:textarea name="fasaPermohonan.ulasan" cols="50" rows="4"/>
                ...
                <p>
                    ...
                    <%--<s:submit name="" value="Simpan" class="btn"  onclick="save1(this.form,'${line.hakmilik.idHakmilik}', '${line.id}');" />--%>
                      <c:if test="${actionBean.flag1}">
                    <s:submit name="simpan" value="Simpan" class="btn" disabled="${actionBean.btn}" />
            ...
            <%--</c:if>--%>
            <s:text name="" id="xx" style="display:none" value="${actionBean.permohonan.idPermohonan}"/>
         <%--   <c:if test="${!edit}">
                <p>
                    <label>Ulasan :</label>
