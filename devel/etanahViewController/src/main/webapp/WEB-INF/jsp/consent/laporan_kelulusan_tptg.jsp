...
<s:form beanclass="etanah.view.stripes.consent.LaporanKelulusanTPTGActionBean">
    ...
    <div id="display" class="subtitle">
        <fieldset class="aras1">
            ...
            <br/>
            <font color="black">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ringkasan Permohonan Kebenaran Pindahmilik Bagi Kelulusan YAB Ketua Menteri Melaka (Perakuan TPTG) 
            </font>
            <br/> <br/>
            <p>
                <label>&nbsp;</label>
