<%--
    ...
    Created on :  June 10, 2011, 4:44:13 PM
             ...
             self.close();
                ...
                function selectCheckBox()
                {
                    ...
                    if(confirm("Adakah anda pasti?")) {
                        var url = '${pageContext.request.contextPath}/consent/jabatan_teknikal?simpanAgensi&item='+data ;
                        $.get(url,
                        function(data){
                            $('#page_div').html(data);
                ...
                function selectRadioBox()
                {
                    ...
                    if(confirm("Adakah anda pasti?")) {
                        var url = '${pageContext.request.contextPath}/consent/jabatan_teknikal?simpanAdun&item='+data ;
                        $.get(url,
                        function(data){
                            $('#page_div').html(data);
...
<s:messages/>
<div class="subtitle">
    <s:form beanclass="etanah.view.stripes.consent.JabatanTeknikalActionBean" name="frm">
        <fieldset class="aras1">
            ...
            <p>
                ...
                <s:select name="pilihAgensi" id="pilihAgensi" disabled="true">
        ...
        <fieldset class="aras1">
            <div id="jtk1">
                ...
                <c:if test="${fn:length(actionBean.listKodAgensi) > 0}" >
                    <p>
                        <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodAgensi}" pagesize="100" cellpadding="0" cellspacing="0" requestURI="/consent/jabatan_teknikal" id="line">
