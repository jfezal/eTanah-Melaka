...
<div class="subtitle">
    <s:form beanclass="etanah.view.stripes.consent.PihakKepentinganActionBean" name="form1">
                ...
                <legend>
                    ...
                    <c:if test="${penerima}">
                        ...
                        <c:choose>
                            ...
                            <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'SWKMM'}">
                                Penerima Sewaan
                            </c:when>
                        ...
                        <c:if test="${penerima}">
                            <c:choose>
                                ...
                                <c:when test="${actionBean.kodNegeri eq '04'}">
                                    <c:choose>
                                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PMKMM' || actionBean.permohonan.kodUrusan.kod eq 'PPTGM' || actionBean.permohonan.kodUrusan.kod eq 'PMJTL' || actionBean.permohonan.kodUrusan.kod eq 'PMMK1' || actionBean.permohonan.kodUrusan.kod eq 'PMMK2'}">
                                            <s:option value="PA">PEMEGANG AMANAH</s:option>
                                            <s:option value="PPM">PENERIMA PINDAH MILIK</s:option>
                                            <s:option value="PP">PENTADBIR</s:option>   
                                            <s:option value="WS">WASI</s:option>  
                                        </c:when>
                                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PJKMM'}">
                                            <s:option value="PA">PEMEGANG AMANAH</s:option>
                                            <s:option value="PPA">PENERIMA PAJAKAN</s:option>
                                        </c:when>
                                        <c:when  test="${actionBean.permohonan.kodUrusan.kod eq 'SWKMM'}">
        ...
        <%--================================================PEMOHON===============================================--%>
        <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PMKMM'}">
            <c:if test="${pemohon}">
                <fieldset class="aras1">
                    <legend>
        ...
        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PMKMM'}">
        ...
        <c:if test="${pemohon}">
            <fieldset class="aras1">
                ...
                <p>
                    <label for="nama"><font color="red">*</font>Nama :</label>
                            <s:text name="pemohon.nama" id="nama_pemohon" size="62" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>

                <p>
                    <label for="Jenis Pengenalan"> <font color="red">*</font>Jenis Pengenalan :</label>
                            <s:select name="pemohon.jenisPengenalan.kod" id="jenisKP" onchange="javaScript:changeJenisKP(this.options[selectedIndex].value)">
                                <s:option value="">Sila Pilih</s:option>
                        <s:options-collection collection="${list.senaraiKodJenisPengenalan}" label="nama" value="kod"/>
                    </s:select>
                </p>
                ...
                <p>
                    <label for="No Pengenalan"><font color="red">*</font>Nombor Pengenalan :</label>
                    <s:text name="pemohon.noPengenalan" id="kp" size="40" onkeyup="this.value=this.value.toUpperCase();dodacheck(this.value);" onchange="changeIcNumber(this.value);"/>&nbsp;<em style="font-style:normal">(cth : 800620125177)</em>
                </p>
                <p>
                    <label>Nombor Pengenalan Lain :</label>
                    <s:text name="pemohon.noPengenalanLain" id="kpl" size="40" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>
                <%--                <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L'
                                              || actionBean.pihak.jenisPengenalan.kod eq 'P' || actionBean.pihak.jenisPengenalan.kod eq 'T'
                                              || actionBean.pihak.jenisPengenalan.kod eq 'I' || actionBean.pihak.jenisPengenalan.kod eq 'K'}">
                ...
                <p>
                    <c:choose>
                        <c:when test="${actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'B' || actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'L'
                                        ...
                                        || actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'I' || actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'K'}">
                                <label><font color="red">*</font>Kewarganegaraan :</label>
                                    </c:when>
                                    <c:otherwise>
                                <label>Negara Syarikat :</label>
                ...
                <p>
                    <label for="alamat"><font color="red">*</font>Alamat Berdaftar :</label>
                            <s:text name="pemohon.alamat.alamat1" size="40" id="alamat1" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>

                <p>
                    <label> &nbsp;</label>
                    <s:text name="pemohon.alamat.alamat2" size="40" id="alamat2" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>

                <p>
                    <label> &nbsp;</label>
                    <s:text name="pemohon.alamat.alamat3" size="40" id="alamat3" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>
                <p>
                    <label> Bandar :</label>
                    <s:text name="pemohon.alamat.alamat4" size="40" id="alamat4" maxlength="40" onkeyup="this.value=this.value.toUpperCase();"/>
                </p>
                <p>
                    <label>Poskod :</label>
                    <s:text name="pemohon.poskod" size="40" maxlength="5" id="poskod" onkeyup="validateNumber(this,this.value);"/>
                </p>

                <p>
                    <label for="Negeri">Negeri :</label>
                    <s:select name="pemohon.alamat.negeri.kod" id="negeri">
                        <s:option value="">Sila Pilih</s:option>
                        <s:options-collection collection="${list.senaraiKodNegeri}" label="nama" value="kod"/>
                    </s:select>
                </p>
                <p id="kodBangsaOrang">
                    <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PMADT' && actionBean.permohonan.kodUrusan.kod ne 'CGADT' && actionBean.permohonan.kodUrusan.kod ne 'PAADT' && actionBean.permohonan.kodUrusan.kod ne 'TMADT' && actionBean.permohonan.kodUrusan.kod ne 'BTADT'}">
                        <label>Bangsa :</label>
                        <s:select name="pemohon.bangsa.kod" style="width:400px" >
                            <s:option value="">Sila Pilih</s:option>
                            <s:options-collection collection="${list.senaraiKodBangsaPerseorangan}" label="nama" value="kod"/>
                        </s:select>
                    </c:if>
                ...
                <p id="kodBangsaAdat">
                    <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PMADT' || actionBean.permohonan.kodUrusan.kod eq 'CGADT' || actionBean.permohonan.kodUrusan.kod eq 'PAADT' || actionBean.permohonan.kodUrusan.kod eq 'TMADT' || actionBean.permohonan.kodUrusan.kod eq 'BTADT'}">
                        <label>Bangsa :</label>
                        <s:select name="hakmilikPihakB.bangsa.kod" style="width:200px" >
                            <s:option value="MEL">MELAYU</s:option>
                        </s:select>
                    </c:if>
                </p>
                ...
                <c:if test="${actionBean.kodNegeri eq '05'}">
                    <p id="suku">
                        ...
                        <s:select name="hakmilikPihakB.suku.kod" style="width:200px" id="sukuData">
                            <s:option value="">Sila Pilih</s:option>
                            <s:options-collection collection="${list.senaraiKodSuku}" label="nama" value="kod"/>
                        </s:select>
                    </p>
                    <p id="subSuku">
                        <label for="subSuku">Pecahan Suku/Lengkongan :</label>
                        <s:text name="hakmilikPihakB.subSuku" size="40" onkeyup="this.value=this.value.toUpperCase();"/>
                    </p>
                    <p id="perut">
                        <label for="perut">Perut :</label>
                        <s:text name="hakmilikPihakB.keturunan" size="40" onkeyup="this.value=this.value.toUpperCase();"/>
                    </p>
                    <p id="luak">
                        <c:choose>
                            <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'TMADT' || actionBean.permohonan.kodUrusan.kod eq 'TMWNA' ||
                        ...
                        <s:select name="hakmilikPihakB.tempatSuku" style="width:250px" id="luakData">
                            <s:option value="">Sila Pilih</s:option>
                            <s:options-collection collection="${list.senaraiKodLuak}" label="nama" value="nama"/>
                        </s:select>
                    </p>
                ...
                <c:if test="${(actionBean.kodNegeri eq '04' && actionBean.permohonan.kodUrusan.kod eq 'PMMK1') || (actionBean.kodNegeri eq '04' && actionBean.permohonan.kodUrusan.kod eq 'PMMK2')}">
                    <c:if test="${actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'B' || actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'L'
                                  || actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'P' || actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'T'
                                  || actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'I' || actionBean.hakmilikPihakB.jenisPengenalan.kod eq 'K'}">
                          <p>
                              <label><font color="red">*</font>Jantina :</label>
                                      <s:select name="hakmilikPihakB.kodJantina" style="width:200px">
                                          <s:option value="">Sila Pilih</s:option>
                                  <s:options-collection collection="${list.senaraiKodJantina}" label="nama" value="kod"/>
                              </s:select>
                          </p>
                    ...
                    <c:if test="${actionBean.hakmilikPihakB.jenisPengenalan.kod ne 'B' && actionBean.hakmilikPihakB.jenisPengenalan.kod ne 'L'
                                  && actionBean.hakmilikPihakB.jenisPengenalan.kod ne 'P' && actionBean.hakmilikPihakB.jenisPengenalan.kod ne 'T'
                                  && actionBean.hakmilikPihakB.jenisPengenalan.kod ne 'I' && actionBean.hakmilikPihakB.jenisPengenalan.kod ne 'K'}">
                          <p>
                              <label><font color="red">*</font>Tarikh Ditubuhkan :</label>
                              <s:text name="tarikhLahir" size="40" id="datepicker" class="datepicker" />&nbsp;<em style="font-style:normal">(cth : hh / bb / tttt)</em>
                          </p>
                ...
                <p align="center">
                    <s:button name="simpanKemaskiniPemohon" class="btn" value="Simpan1" onclick="save(this.name, this.form);"/>
                    <s:button name="close" id="tutup" value="Tutup" class="btn" onclick="self.close()"/>
                </p>
                <br/>
            </fieldset>
