...
//                          var url = "reportName=" + report + "%26report_p_id_hakmilik=" + param.value;
    ...
    <stripes:messages />
    <stripes:errors />
    <stripes:form beanclass="etanah.view.stripes.ispeks.SediaPenyataPemungutActionBean" id="formSPEKS" name="formSPEKS">
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Fail SPEKS (Penyedia)</legend>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="2"><b>Arahan : Sila 'Isi' maklumat yang diperlukan.</b></font>
                <br>
                <br>
                <br />
                <p>
                ...
                <p>
                    <label>&nbsp;</label>
                    <stripes:submit name="simpan" value="Simpan" class="btn" id="simpan"/>
                    <stripes:button name="simpan" value="Selesai" class="btn" onclick="selesaiConfirm();"/>
                    <stripes:submit name="selesai" value="Selesai" class="btn" id="selesai" style=""/>
                ...
                <p>
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.senaraiPenyata}"  cellpadding="0" cellspacing="0" id="line">
                        ...
                        <c:if test="${line.caraBayar ne 'T'}">
                            ...
                            <%--<c:if test="${line.caraBayar eq 'CT' || line.caraBayar eq 'C' || line.caraBayar eq 'CS' || line.caraBayar eq 'CL'}">
                                <display:column title="No Akaun Bank"> <stripes:text name="noAkaunBankPembayar" size="20;" /> </display:column>
                            </c:if>   --%>                     
                        </c:if>
                    </display:table>
                </p>
