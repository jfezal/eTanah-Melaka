...
//                          var url = "reportName=" + report + "%26report_p_id_hakmilik=" + param.value;
        ...
        var url = "reportName="+report+"%26report_p_id_pp="+idJournal;
    ...
    <stripes:messages />
    <stripes:errors />
    <stripes:form beanclass="etanah.view.stripes.ispeks.LulusJournalActionBean" id="formSPEKS" name="formSPEKS">
        <div class="subtitle">
