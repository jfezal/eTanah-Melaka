...
<script type="text/javascript">
    ...
    function cBayar(id,jb,nop){ 
        var url = '${pageContext.request.contextPath}/permitEntry?cariPemilikNoIc&noFail='+id+'&jenisBorang='+jb+'&noPermit='+nop;         
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function submitBayaran(id,jb,nop){
        var url = '${pageContext.request.contextPath}/permitEntry?simpanCarianBayaran&noFail='+id+'&jenisBorang='+jb+'&noPermit='+nop;
        $.get(url,
        function(data){
            $('#page_div').html(data);
