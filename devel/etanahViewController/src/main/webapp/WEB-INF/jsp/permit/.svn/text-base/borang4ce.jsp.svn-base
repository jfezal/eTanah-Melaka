<%-- 
    Document   : borang4ce
    Created on : Sep 19, 2015, 12:20:16 PM
    Author     : Hazwan
--%>
...
<script type="text/javascript">
    ...
    function validateForm() {
        if ($("#daerah").val() == "") {
            ...
            alert('Sila Masukkan Urusan Permit !!!');
            return false;
        }else if ($("#noResit").val() == "") {
    ...
    function validateJadual4ce() {
        if ($("#tarikhMula").val() == "") {
            ...
            return false;
        }else if ($("#itemPermit").val() == "") {
            alert('Sila Masukkan Item Permit !!!');      
            return false;
        }else if ($("#kntt").val() == "") {
            alert('Sila Masukkan Kuantiti !!!');      
            return false;
        }else if ($("#jenisUom").val() == "") {
            alert('Sila Masukkan Jenis Kuantiti !!!');      
            return false;
        }else{
            return true;           
        }
    ...
    function refreshImej(){
        ...
        var url = '${pageContext.request.contextPath}/permitEntry?check&noFail='+id ;
        $.get(url,
        function(data){
            ...
            <div class="content" align="center">
                <table border="0" width="50%">
                    ...
                    <tr>
                        ...
                        <td><font style="font-size:13px; color:#003194; font-family:Tahoma; font-weight:bold;">:</font> </td>
                        <td>
                            <s:select name="kPermit" id="kPermit" style="width:520px;">
                                <s:option value="">Pilih</s:option>
                                <s:options-collection collection="${list.senaraiKodUrusanPermit}" label="nama" value="kod" />
                            </s:select>
                        </td>
                    </tr>
                </table>
        ...
        <div class="content" align="left">
            <table border="0" width="85%">
                <tr>
                    <td width="100%">
                        <font style="font-size:13px; color:#001848; font-family:Tahoma; font-weight:bold;">
                            (1) Permit ini bermula pada <s:text name="tarikhMula" id="tarikhMula" class="datepicker" size="12" style="width:130px;" formatPattern="dd/MM/yyyy"/> 
                            dan tamat pada <s:text name="tarikhtamat" id="tarikhtamat" class="datepicker" size="12" style="width:130px;" formatPattern="dd/MM/yyyy"/>.
                        </font>
                    </td>
                </tr>
            </table>
            ...
            <table border="0" width="85%"> 
                <tr>
                    <td width="50%">
                        <font style="font-size:13px; color:#001848; font-family:Tahoma; font-weight:bold;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <s:select name="itemPermit" id="itemPermit" style="width:300px;" >
                                <s:option value="">Pilih</s:option>
                                <s:options-collection collection="${list.listItemPermit}" label="nama" value="kod" />
                            </s:select>
                        </font>                       
                    </td>        
                </tr>
            ...
            <table border="0" width="100%">           
                <tr>
                    <td width="50%">
                        <font style="font-size:13px; color:#001848; font-family:Tahoma; font-weight:bold;">
                            (3) Kuantiti maksimum bahan batuan yang boleh diekstrak adalah <s:text name="kntt" id="kntt" size="12" style="width:50px;" maxlength="10" onkeyup="validateNumber(this,this.value);"/>
                            <s:select name="jenisUom" id="jenisUom" style="width:200px;" >
                                <s:option value="">Pilih</s:option>
                                <%--<s:options-collection collection="${list.kodUOMByJenis}" label="nama" value="kod" />--%>
            ...
            <table border="0" width="100%">           
                <tr>
                    <td width="50%">
                        <font style="font-size:13px; color:#001848; font-family:Tahoma; font-weight:bold;">
                            (4) Fi hendaklah dibayar adalah pada kadar RM <s:text name="rm" id="rm" size="12" style="width:50px;" maxlength="7" onkeyup="validateNumber(this,this.value);"/> bagi 
            ...
            <table border="0" width="100%">           
                <tr>
                    <td width="50%">
                        <font style="font-size:13px; color:#001848; font-family:Tahoma; font-weight:bold;">
                            (5) Permit ini *tidak boleh/boleh diserahhak di bawah Kaedah <s:text name="kaedah" id="kaedah" size="17" style="width:200px;" maxlength="20" onblur="this.value=this.value.toUpperCase();"/>.
                        </font>
                    </td>                   
                </tr>
            </table> 
            ...
            <br/>
            <p align="center">
                <s:submit name="simpanJadual4ce" id="save" value="Simpan" class="btn" onclick="return validateJadual4ce();"/>&nbsp;                  
            </p>
