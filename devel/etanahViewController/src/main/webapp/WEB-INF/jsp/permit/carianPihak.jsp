...
<script type="text/javascript">
    ...
    function cPihak(id,jb,nop){             
        var url = '${pageContext.request.contextPath}/permitEntry?cariBayaran&noFail='+id+'&jenisBorang='+jb+'&noPermit='+nop;         
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function savingPihak(id,jb,nop){       
        var url = '${pageContext.request.contextPath}/permitEntry?simpanCarianPihak&noFail='+id+'&jenisBorang='+jb+'&noPermit='+nop;         
        $.get(url,
        function(data){
            $('#page_div').html(data);
