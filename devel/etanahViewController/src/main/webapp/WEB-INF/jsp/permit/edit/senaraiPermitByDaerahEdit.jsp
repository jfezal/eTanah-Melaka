...
<div class= "all">
    <script type="text/javascript">
        ...
        function papar(frm,noF,noP,jB) {         
            var url = '${pageContext.request.contextPath}/digiSignPermit?viewEdit&noFailRuj='+noF+'&noPermit='+noP+'&borang='+jB;
            frm.action = url;
            frm.submit();
        }
    ...
    <s:form beanclass="etanah.view.stripes.permit.DSPermitActionBean" name ="senaraiPermit" id ="senaraiPermit">
        ...
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Senarai Permit Untuk Dikemaskini</legend>
                ...
                <br/>
                <p align="center">
                    <s:submit name="cariEdit" value="Cari" class="btn"/>&nbsp;
                    <s:button name = "reset" class="btn" value ="Isi Semula" onclick= "clearText('senaraiPermit')" />
                    <s:submit name="permitBaru" value="Permit Baru" class="btn"/>&nbsp;
                </p>
            </fieldset>
        </div>
                ...
                <fieldset class="aras1">
                    ...
                    <display:table  name="${actionBean.listPermit}" id="line"  class="tablecloth" pagesize="10" requestURI="${pageContext.request.contextPath}/digiSignPermit">
                        ...
                        <display:column title="Kemaskini">
                            <div align ="center">                            
                                <img alt='Klik untuk kemaskini permit' border='0' src='${pageContext.request.contextPath}/images/view_icon.gif' class='rem'
