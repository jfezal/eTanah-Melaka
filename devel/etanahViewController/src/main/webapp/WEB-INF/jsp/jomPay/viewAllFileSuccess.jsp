        ...
        <fieldset class="aras1">
            ...
            <p>
                <display:table style="width:100%" class="tablecloth" name="${actionBean.listJompayDetails}"  cellpadding="0" cellspacing="0" id="line">
                    ...
                    <display:column title="Nama Fail"><a href="uploadCsvFail?paparAllSuccessFile&idUploadFile=${line.idJomPayUpload}">${line.namaFail}</a></display:column>

                    <c:if test="${line.status eq 'A'}">
                        <display:column title="Status">BERJAYA DI PROSES</display:column>
                    </c:if>                  
