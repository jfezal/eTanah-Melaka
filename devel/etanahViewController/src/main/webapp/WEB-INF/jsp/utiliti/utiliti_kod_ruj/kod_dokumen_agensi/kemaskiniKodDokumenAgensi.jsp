...
<div class= "all">
     ...
     maximizeWindow();
        ...
        function removeNonNumeric( strString )
        {
         ...
         function goTo(frm, value,value2) {
           ...
           var url = '${pageContext.request.contextPath}/utility_kod/kodDokumenAgensi?updateData&table_name='+value+'&kod='+value2;
            frm.action = url;
            frm.submit();
            }
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KodDokumenAgensiActionBean" name ="kemaskiniKodDokumenAgensi" id ="kemaskiniKodDokumenAgensi">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Kemaskini Kod Dokumen Agensi </legend>
                 <p><label><font color="red">*</font>Id Rekod    :</label>${actionBean.details.idKodDokAgensi}
                </p>
                <p><label><font color="red">*</font>Kod Urusan Agensi:</label>
                         <s:select name="details.kodUrusanAgensi.idKodUrusanAgensi" id="kodUrusanAgensi" >
               ...
               <p><label><font color="red">*</font>Dimasukkan Oleh    :</label>${actionBean.details.infoAudit.dimasukOleh.idPengguna}
                ...
                <p><label><font color="red">*</font>DiKemaskini Oleh    :</label>${actionBean.details.infoAudit.dikemaskiniOleh.idPengguna}
                 ...
                 <br/><br/><br/>
                 <p align="center"><s:submit name="updateData" onclick="goTo(document.forms.kemaskiniKodDokumenAgensi,'${actionBean.nameTable}','${actionBean.kod}')" value="Simpan" class="btn"/>&nbsp;<s:button name ="kembali" class="btn" value ="Kembali" onclick="goTo2(document.forms.kemaskiniKodDokumenAgensi,'${actionBean.nameTable}')"/></p>
