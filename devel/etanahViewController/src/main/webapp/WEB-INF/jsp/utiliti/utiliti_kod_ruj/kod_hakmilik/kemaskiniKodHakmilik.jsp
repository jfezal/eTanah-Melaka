...
<div class= "all">
     ...
     maximizeWindow();
        ...
        function removeNonNumeric( strString )
        {
         ...
         function goTo(frm, value,value2) {
           ...
           var url = '${pageContext.request.contextPath}/utility_kod/kodHakmilik?updateData&table_name='+value+'&kod='+value2;
            frm.action = url;
            frm.submit();
            }
        }
         function goTo2(frm, value) {
            var url = '${pageContext.request.contextPath}/utility_kod/kodHakmilik?KodList&table_name='+value;
            frm.action = url;
            frm.submit();
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KodHakmilikActionBean" name ="kemaskiniKodHakmilik" id ="kemaskiniKodHakmilik">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Kemaskini Kod Hakmilik </legend>
                 ...
                 <p><label><font color="red">*</font>Kod Dokumen:</label>
                         <s:select name="details.kodDokumen.kod" id="kodDokumen" >
                                <s:option value="00">Pilih</s:option>
                                <s:options-collection collection="${list.senaraiKodDokumen}" label="nama" value="kod" />
                    </s:select>
                </p>
                 <p><label><font color="red">*</font>Milik Daerah :</label>
                     <s:text id="nama" name="details.milikDaerah" value ="${actionBean.details.milikDaerah}" size="70"></s:text>
                </p>
               ...
               <p><label><font color="red">*</font>Dimasukkan Oleh    :</label>${actionBean.details.infoAudit.dimasukOleh.idPengguna}
                ...
                <p><label><font color="red">*</font>DiKemaskini Oleh    :</label>${actionBean.details.infoAudit.dikemaskiniOleh.idPengguna}
                 ...
                 <br/><br/><br/>
                 <p align="center"><s:submit name="updateData" onclick="goTo(document.forms.kemaskiniKodHakmilik,'${actionBean.nameTable}','${actionBean.kod}')" value="Simpan" class="btn"/>&nbsp;<s:button name ="kembali" class="btn" value ="Kembali" onclick="goTo2(document.forms.kemaskiniKodHakmilik,'${actionBean.nameTable}')"/></p>
