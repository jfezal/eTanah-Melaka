...
<div class= "all">
     ...
     maximizeWindow();
        ...
        function removeNonNumeric( strString )
        {
         ...
         function goTo(frm, value,value2) {
           ...
           var url = '${pageContext.request.contextPath}/utility_kod/kodBangsa?updateData&table_name='+value+'&kod='+value2;
            frm.action = url;
            frm.submit();
            }
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KodBangsaActionBean" name ="kemaskiniKodBangsa" id ="kemaskiniKodBangsa">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Kemaskini Kod Bangsa </legend>
                 ...
                 <p>
                        ...
                        <s:radio name="details.untukIndividu" value="Y"></s:radio>Ya
                        <s:radio name="details.untukIndividu" value="T" ></s:radio>Tidak
                    </p>
               <p>
                        <label>Bangsa  :</label>
                        <s:radio name="details.bangsa" value="Y"></s:radio>Ya
                        <s:radio name="details.bangsa" value="T" ></s:radio>Tidak
                    </p>
                <p><label><font color="red">*</font>Perihal :</label>
                            <s:text id="perihal" name="details.perihal" value ="${actionBean.details.perihal}"></s:text>
                </p>
               ...
               <p><label><font color="red">*</font>Dimasukkan Oleh    :</label>${actionBean.details.infoAudit.dimasukOleh.idPengguna}
                ...
                <p><label><font color="red">*</font>DiKemaskini Oleh    :</label>${actionBean.details.infoAudit.dikemaskiniOleh.idPengguna}
                 ...
                 <br/><br/><br/>
                 <p align="center"><s:submit name="updateData" onclick="goTo(document.forms.kemaskiniKodBangsa,'${actionBean.nameTable}','${actionBean.kod}')" value="Simpan" class="btn"/>&nbsp;<s:button name ="kembali" class="btn" value ="Kembali" onclick="goTo2(document.forms.kemaskiniKodBangsa,'${actionBean.nameTable}')"/></p>
