...
<div class= "all">
     ...
     maximizeWindow();
        ...
        function removeNonNumeric( strString )
        {
         ...
         function goTo(frm, value) {
            ...
            var url = '${pageContext.request.contextPath}/utility_kod/kodHakmilik?simpanData&table_name='+value;
            frm.action = url;
            frm.submit();
            }
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KodHakmilikActionBean" name ="tambahKodHakmilik" id ="tambahKodHakmilik">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Tambah Kod Hakmilik </legend>
                <s:hidden value = "${actionBean.id_rekod_hakmilik}" name = "id_rekod_hakmilik"/>
                 <p><label><font color="red">*</font>Kod Hakmilik :</label>
                     <s:text id="kod_Hakmilik" name="kod_Hakmilik" value ="${actionBean.kod_Hakmilik}" size="70"></s:text>
                </p>
                ...
                <s:hidden value = "${actionBean.kod}" name = "kod"/>
                 ...
                 <br/><br/><br/>
                <p align="center"><s:submit name="simpan" onclick="goTo(document.forms.tambahKodHakmilik,'${actionBean.nameTable}')" value="Simpan" class="btn"/>&nbsp;<s:submit name = "kembali" onclick="goTo2(document.forms.tambahKodHakmilik,'${actionBean.nameTable}')" class="btn" value ="Kembali"/></p>
