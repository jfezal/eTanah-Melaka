<%-- 
    Document   : tambahRekodJtek
    Created on : Jul 10, 2014, 1:50:50 PM
...
<div class= "all">
        ...
        function goTo(frm, value, f) {
            if(confirm("Adakah anda pasti untuk simpan data?")){
                if($("#nama").val() == "") {
                    ...
                    $("#poskod").focus();
                    return false;
                } else if ($("#daerah").val() == "0") {
                    alert('Sila pilih daerah.');
                    $("#daerah").focus();
                    return false;
                } else if ($("#negeri").val() == "0") {
                    ...
                    $("#email").focus();
                    return false;
                } else if (!f.elements['aktif'][0].checked && !f.elements['aktif'][1].checked) {
                    alert('Sila pilih status.');
                    return false;
                } else {
                    var url = '${pageContext.request.contextPath}/utility_kod/kodJtek?simpanData&table_name='+value;
                    frm.action = url;
                    frm.submit();
                }
            }
    ...
    <s:form beanclass="etanah.view.utility.kod.KodJtekActionBean" name ="tambahKodAgensi" id ="tambahKodAgensi">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Tambah Kod Jabatan Teknikal </legend>
                <%--
                ...
                <p><label><font color="red">*</font>Alamat :</label>
                        <s:text id="alamat1" name="alamat1" value ="${actionBean.alamat1}" size="70"></s:text>                        
                </p>
                <p><label><font color="red"> </font>: </label>
                ...
                <p>
                    <label><font color="red">*</font>Poskod :</label>
                        <s:text id="poskod" name="poskod" maxlength="5" value ="${actionBean.details.poskod}"></s:text>
                    </p>
                    <p>
                ...
                <p><label><font color="red">*</font>Negeri :</label>
                        <s:select name="negeri" id="negeri" >
                            <s:option value="0">Pilih</s:option>
                        <s:options-collection collection="${list.senaraiKodNegeri}" label="nama" value="kod" />
                    </s:select>
                </p>
                <p><label><font color="red">*</font>Email :</label>
                        <s:text id="email" name="email" value ="${actionBean.email}" size="70"></s:text>
                </p>
                ...
                <br/><br/><br/>
                <p align="center"><s:submit name="simpan" onclick="return goTo(document.forms.tambahKodAgensi,'${actionBean.nameTable}', this.form);" value="Simpan" class="btn"/>&nbsp;<s:submit name = "kembali" onclick="goTo2(document.forms.tambahKodAgensi,'${actionBean.nameTable}')" class="btn" value ="Kembali"/></p>
