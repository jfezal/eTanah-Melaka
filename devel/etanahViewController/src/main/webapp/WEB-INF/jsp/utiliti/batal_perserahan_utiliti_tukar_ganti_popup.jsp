    ...
    <div id="page_div">
        ...
        <div class="subtitle">
            <fieldset class="aras1">                
                <s:hidden name="idPerserahan"/>
                <div align="center">
                    <table class="tablecloth" width="70%">
                        <tr><label id="sbb">Sebab Batal :</label><br/><br/>
                        <s:textarea id="sebab" name="sebab" cols="80" rows="10" onkeyup="this.value = this.value.toUpperCase();validate(this.value);"/>
                        <br/><br/>
                        <div align="center">                                    
                            <s:submit id="simpan" name="simpan" value="Simpan" class="btn" onclick=""/>
