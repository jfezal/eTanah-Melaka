...
<div class= "all">
     ...
     maximizeWindow();
        ...
        function removeNonNumeric( strString )
        {
         ...
         function goTo(frm, value,value2) {
           ...
           var url = '${pageContext.request.contextPath}/utility_kod/kodBPM?updateData&table_kod='+value+'&kod='+value2;
            frm.action = url;
            frm.submit();
            }
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KodBPMActionBean" name ="kemaskiniKodBPM" id ="kemaskiniKodBPM">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                ...
                <p><label><font color="red">*</font>Daerah :</label>${actionBean.details.daerah.kod} - ${actionBean.details.daerah.nama}
                         
                </p>
                <s:hidden value = "${actionBean.nameTable}" name = "namatable"/>
                <s:hidden value = "${actionBean.kod}" name = "kod"/>
                 
                 <p><label><font color="red">*</font>Kod BPM :</label>${actionBean.details.bandarPekanMukim}
                </p>
                <p><label><font color="red">*</font>Nama :</label>
                            <s:text id="nama" name="details.nama"></s:text>
                </p>
                <p><label><font color="red">*</font>Kod Tanah:</label>
                         <s:select name="details.kodTanah.kod" id="tanah" >
               ...
               <p><label><font color="red">*</font>Dimasukkan Oleh    :</label>${actionBean.details.infoAudit.dimasukOleh.idPengguna}
                ...
                <p><label><font color="red">*</font>DiKemaskini Oleh    :</label>${actionBean.details.infoAudit.dikemaskiniOleh.idPengguna}
                 ...
                 <br/><br/><br/>
                 <p align="center"><s:submit name="updateData" onclick="goTo(document.forms.kemaskiniKodBPM,'${actionBean.nameTable}','${actionBean.kod}')" value="Simpan" class="btn"/>&nbsp;<s:button name ="kembali" class="btn" value ="Kembali" onclick="goTo2(document.forms.kemaskiniKodBPM,'${actionBean.nameTable}')"/></p>
