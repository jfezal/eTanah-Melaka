...
//    alert("refreshMaklumatDetail");
    ...
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?refreshPage&idHakmilik=' + $('#idHakmilik').val();
    frm.action = url;
    frm.submit();
  }
...
//      alert("refreshkutipanUrusan");
    ...
    var frm = document.forms.kutipanUrusan;
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?refreshPage&selectedTab=' + idTab;
    frm.action = url;
    frm.submit();
  }
...
//      alert("refreshkutipanUrusan");
    var idTab = "maklumat_urusan";
    var frm = document.forms.kutipanUrusan;
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?kemaskiniPemohon&selectedTab=' + idTab;
    frm.action = url;
    frm.submit();
  }
</script>
  ...
  <div class="subtitle">
    ...
    <s:form beanclass="etanah.view.daftar.utiliti.KutipanDataActionBean">
      <fieldset class="aras1">
        <legend>Utiliti Kutipan Data </legend><br>
    ...
    <div id="tab_dokumen" class="tab_dokumen">
      ...
      <div id="maklumat_hakmilik" >        
        <%@ include file="/WEB-INF/jsp/daftar/utiliti/kutipan_data_hakmilik_1.jsp" %>
      </div>  
