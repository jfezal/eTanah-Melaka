...
//    alert("refreshMaklumatDetail");
    ...
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kemaskiniData?refreshPage&idHakmilik=' + $('#idHakmilik').val();
    frm.action = url;
    frm.submit();
  }
...
//      alert("refreshkutipanUrusan");
    ...
    var frm = document.forms.kutipanUrusan;
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kemaskiniData?refreshPage&selectedTab=' + idTab;
    frm.action = url;
    frm.submit();
  }
...
//      alert("refreshkutipanUrusan");
    var idTab = "maklumat_urusan";
    var frm = document.forms.kutipanUrusan;
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kemaskiniData?kemaskiniPemohon&selectedTab=' + idTab;
    frm.action = url;
    frm.submit();
  }
</script>
  ...
  <div class="subtitle">
    ...
    <s:form beanclass="etanah.view.daftar.utiliti.KemaskiniDataActionBean">
      <fieldset class="aras1">
        <legend>Kemaskini Data </legend><br>
    ...
    <div id="tab_dokumen" class="tab_dokumen">
      <ul>
        ...
        <li><a href="#maklumat_pemilik" id="tab1" title="Maklumat Pemilik">Maklumat Pemilik</a></li>
      ...
      <div id="maklumat_hakmilik" >        
        <%@ include file="/WEB-INF/jsp/daftar/utiliti/kemaskini_data_hakmilik.jsp" %>
      </div>  
      <div id="maklumat_pemilik" >        
        <%@ include file="/WEB-INF/jsp/daftar/utiliti/kemaskini_data_pemilik.jsp" %>
      </div> 
      <div id="maklumat_urusan">
        <%@ include file="/WEB-INF/jsp/daftar/utiliti/kemaskini_data_urusan.jsp" %>
      </div>       
    </div>
  </div>  
</s:form>
