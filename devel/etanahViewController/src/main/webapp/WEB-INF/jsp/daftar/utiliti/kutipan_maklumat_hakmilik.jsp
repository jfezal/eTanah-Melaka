...
<script type="text/javascript">
  function filterKodBPM(f) {
    ...
    var kodDaerah = f;
    $.post('${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?cariBPM&kodDaerah=' + kodDaerah + '&popup=true',
            function(data) {
              if (data != '') {
  ...
  function filterKodGunaTanah(val, val2) {
    var url = '${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?senaraiKodGunaTanahByKatTanah&kt=' + val + '&hm=' + val2;
...
//    alert($('#pegangan').val());
  ...
  <c:if test="${actionBean.kodKatTanah ne null}">
    ...
    function showHm1(v) {
      ...
      doBlockUI();
      var url = '${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?maklumatDetail&idHakmilik=' + v;
      frm = document.kutipanUrusan;
      frm.action = url;
      frm.submit();
    }
    ...
    function removeMultipleMohonHakmilik() {
      ...
      if (confirm('Adakah anda pasti untuk hapus hakmilik ini')) {
        ...
        var url = '${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?hapusHakmilik' + param;
        frm = document.kutipanUrusan;
        frm.action = url;
        frm.submit();
      }
    ...
    function popupFormSyaratNyata() {
      ...
      var url = "${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?paparPopupSyaratNyata&idHakmilik=" + $("#idHakmilik").val() + "&kumpHm=" + $("#kumpHm").val();
    ...
    function popupFormKodSekatan() {
      // GET SEKATAN POPUP
      var url = "${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?paparPopupSekatan&idHakmilik=" + $("#idHakmilik").val() + "&kumpHm=" + $("#kumpHm").val();
      window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=600");
    }

    function popupHakmilikSblm(id) {
      // GET HAKMILIK SEBELUM POP-UP
      var url = "${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?paparPopupHakmilikSebelum&idHakmilik=" + id + "&kumpHm=" + $("#kumpHm").val();
    ...
    function popupHakmilikAsal(id) {
      ...
      var url = "${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?paparPopupHakmilikAsal&idHakmilik=" + id + "&kumpHm=" + $("#kumpHm").val();
      window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=500");
    }

    function popupPihak(id) {
      // GET PIHAK POP
      var url = "${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?paparPopupPihak&idHakmilik=" + id + "&kumpHm=" + $("#kumpHm").val();
    ...
    function popupKemaskiniPihak(val, val1, val2) {
      ...
      var url = "${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?kemaskiniPihak&phk=" + val + "&hm=" + val1 + "&hp=" + val2;
      window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=800");
    }
...
//          alert(param);
        ...
        var url = '${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?hapusPihak' + param;
    ...
    function samaRata(f) {       // MAKE ALL SHARE EQUAL FOR EACH PIHAK
      ...
      doBlockUI();
      var url = '${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?agihSamaRata';
      //      frm = document.maklumatDetail;
      frm = document.kutipanUrusan;
      frm.action = url;
      frm.submit();
    ...
    function checkPelan(f) {
      ...
      $.post('${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?checkPelan&noLot='
...
//      alert(luas);
      if (kodUOM === 'E' && luas !== "") {
        ...
        $.post('${pageContext.request.contextPath}/daftar/utiliti/KemaskiniPerserahanHakmilik?checkLuas&luas=' + luas + '&kodUOM=' + kodUOM,
                function(data) {
...
<div class="a">
  ...
  <s:form beanclass="etanah.view.daftar.utiliti.KemaskiniPerserahanHakmilikActionBean" name="maklumatHakmilik" id="maklumatHakmilik">
      ...
      <c:if test="${actionBean.idHakmilik ne null}">
        ...
        <fieldset class="aras1">
          ...
          <p>
            ...
            <s:select  disabled="${disabled}" name="hakmilik.bandarPekanMukim.kod" id="namaBPM" style="width:200pt">            
