                        ...
                        <div class="content" align="center">
                            <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}"  cellpadding="0" cellspacing="0"
                                ...
                                <display:column title="Baiki / Semak">
                                    <div align="center">
                                        <c:if test="${hmstr}">
                                            <img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/pub/images/edit.gif' class='rem' id='rem_${line_rowNum}' 
                                                 onmouseover="this.style.cursor = 'pointer';" onclick="popupSTR('${pageContext.request.contextPath}/daftar/pembetulan/betulSTR?popupAsasSTR&idH=${line.hakmilik.idHakmilik}');"/>
                                        </c:if>
                                        <c:if test="${!hmstr}">
                                            <img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/pub/images/edit.gif' class='rem' id='rem_${line_rowNum}'
                                                 onmouseover="this.style.cursor = 'pointer';" onclick="popup('${pageContext.request.contextPath}/daftar/pembetulan/betulSTR?popupAsas&idH=${line.hakmilik.idHakmilik}');"/>
                                        </c:if>
                                    </div>
                                </display:column>
                            </display:table>
