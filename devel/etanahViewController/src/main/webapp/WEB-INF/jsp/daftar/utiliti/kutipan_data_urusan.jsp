...
<script type="text/javascript">
  ...
  function popupUrusanSC() {
    // GET POPUP URUSAN
    var url = "${pageContext.request.contextPath}/daftar/utiliti/kutipanData?tambahUrusan&jenisUrusan=" + $("#jenisUrusanSC").val() + "&kumpHm=" + $("#kumpHm").val();
  ...
  function popupUrusanN() {
    // GET POPUP URUSAN    
    var url = "${pageContext.request.contextPath}/daftar/utiliti/kutipanData?tambahUrusan&jenisUrusan=" + $("#jenisUrusanN").val() + "&kumpHm=" + $("#kumpHm").val();
    window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=800");
  }

  function popupUrusanB() {
    // GET POPUP URUSAN
    var url = "${pageContext.request.contextPath}/daftar/utiliti/kutipanData?tambahUrusan&jenisUrusan=" + $("#jenisUrusanB").val() + "&kumpHm=" + $("#kumpHm").val();
    window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=800");
  }

//  function popupUrusanNB() {
//    // GET POPUP URUSAN
//    var url = "${pageContext.request.contextPath}/daftar/utiliti/kutipanData?tambahUrusan&jenisUrusan=" + $("#jenisUrusanNB").val() + "&kumpHm=" + $("#kumpHm").val();
//    window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=800");
//  }
  ...
  function hapusUrusan(val) {
    ...
    doBlockUI();
//    alert("id urusan : " + val);
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?hapusUrusan&id=' + val;
...
//    alert("jenis utusan : " + val1)
    var url = "${pageContext.request.contextPath}/daftar/utiliti/kutipanData?tambahUrusan&jenisUrusan=" + val1
            + "&kumpHm=" + $("#kumpHm").val() + "&id=" + val;
    window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=800");
  }
  
  function viewJilidFolio(idmhn,idHm,kodUrusan) {
    var url = "${pageContext.request.contextPath}/daftar/utiliti/kutipanData?kemaskiniJilidFolio&idPerserahan=" + idmhn + "&idHM="+idHm+ "&kodUrusan="+kodUrusan;
    window.open(url, "eTanah", "status=1,toolbar=0,location=1,menubar=0,scrollbars=yes,resizable=1,width=900,height=800");
  }
...
<div class="a">
  ...
  <s:form beanclass="etanah.view.daftar.utiliti.KutipanDataActionBean" name="kutipanUrusan" id="kutipanUrusan">
                  ...
                  <display:table class="tablecloth" style="width:98%;" cellpadding="0" cellspacing="0" id="line" 
                    ...
                    <display:column title="Pihak Berkepentingan" style="width:5%;">
                      <c:if test="${line.kodUrusan.kod eq 'PJT' 
                                    ...
                                    or line.kodUrusan.kod eq 'JMGD'
                                    or line.kodUrusan.kod eq 'JPGD'}">
                            <div align="center">
                              <p align="center">
    ...
    return false;" onmouseover="this.style.cursor = 'pointer';">
                    ...
                    <display:column title="Kemaskini" style="width:5%;">
                      <c:if test="${line.kodUrusan.kod ne 'GD'
                                    and line.kodUrusan.kod ne 'GDWM'
                                    and line.kodUrusan.kod ne 'GDCE'}">
                            <div align="center">
                              <p align="center">
                                <img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
    ...
    return false;" onmouseover="this.style.cursor = 'pointer';">
                    ...
                    <display:column title="Kemaskini Jilid dan Folio" style="width:5%;">
                            <div align="center">
                              <p align="center">
                                <img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                     onclick="viewJilidFolio('${line.idPerserahan}','${line.hakmilik.idHakmilik}','${line.kodUrusan.kod}');
    return false;" onmouseover="this.style.cursor = 'pointer';">
                              </p>
                            </div>
                    </display:column>
                  ...
                  <display:table class="tablecloth" style="width:98%;" cellpadding="0" cellspacing="0" id="line" 
                    ...
                    <display:column title="Pihak Berkepentingan" style="width:5%;">
                      <c:if test="${line.kodUrusan.kod eq 'KVST' 
                                    ...
                                    or line.kodUrusan.kod eq 'KVSPC'
                                    ...
                                    or line.kodUrusan.kod eq 'KVSPT'
                                    or line.kodUrusan.kod eq 'KVPT'
                                    or line.kodUrusan.kod eq 'KVPPT'
                                    or line.kodUrusan.kod eq 'TMAME'
                                    or line.kodUrusan.kod eq 'TMAMT'
                                    or line.kodUrusan.kod eq 'TMAMG'
                                    or line.kodUrusan.kod eq 'TMAML'
                                    or line.kodUrusan.kod eq 'TMAMW'
                                    or line.kodUrusan.kod eq 'TMAMD'
                                    or line.kodUrusan.kod eq 'TMAMF'
                                    or line.kodUrusan.kod eq 'TN'
                                    or line.kodUrusan.kod eq 'PHMM'
                                    or line.kodUrusan.kod eq 'PHMMS'
                                    or line.kodUrusan.kod eq 'PNPHB'
                                    or line.kodUrusan.kod eq 'PH30A'}">
                            <div align="center">
                              <p align="center">
                                <img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                     onclick="viewPihak('${line.idUrusan}', 'SC');
    return false;" onmouseover="this.style.cursor = 'pointer';">
                    ...
                    <display:column title="Kemaskini" style="width:5%;">
                      <c:if test="${line.kodUrusan.kod ne 'KVST'
                                    and line.kodUrusan.kod ne 'KVAT'
