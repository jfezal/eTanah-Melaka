        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center" id="tanahMilik">
                ...
                <table class="tablecloth" width="50%">
                    ...
                    <tr><th>Perkara</th><th>Maklumat Waris</th></tr>
                    <tr><td>Nama Waris :</td><td><s:text name="permohonanPembetulanHakmilik.idHakmilikAsal"/></td></tr>
                    ...
                    <tr><td>No Pengenalan :</td><td><s:text name="permohonanPembetulanHakmilik.idHakmilikAsal"/></td></tr>
                     <tr><td>Kumpulan PB :</td><td><s:text name="permohonanPembetulanHakmilik.idHakmilikAsal"/></td></tr>
                </table>
            </div>
