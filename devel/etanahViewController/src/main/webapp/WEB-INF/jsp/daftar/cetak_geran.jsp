...
<s:form action="/senaraiTugasan">
    <div class="content">
        ...
        return false;">Papar</a>
                    ...
                    <!--azmi-->
                    <!--Start: DHKK/DHDK-->
                    <c:if test="${(line.dokumen5 != null) && fn:contains(line.dokumen5.kodDokumen.kod, 'DHKK')}">
                        <display:column title="<input type='checkbox' id='semuaNotis19F' name='semua' onclick='javascript:selectAll(this);' />DHKK" style="width:10%">
                            <c:if test="${line.dokumen5.namaFizikal != null}">
                                <a href="#" id="p" onclick="doViewReport('${line.dokumen5.idDokumen}');
        return false;">Papar</a>
                                <c:if test="${line_rowNum eq 1}">
                    ...
                    <c:if test="${(line.dokumen6 != null) && fn:contains(line.dokumen6.kodDokumen.kod,'DHDK')}">
                        <display:column title="<input type='checkbox' id='semuaNotis19A' name='semua' onclick='javascript:selectAll(this);' />DHDK" style="width:10%">
                            <c:if test="${line.dokumen6.namaFizikal != null}">
                                <a href="#" id="p" onclick="doViewReport('${line.dokumen6.idDokumen}');
        return false;">Papar</a>
                                <c:if test="${line_rowNum eq 1}">
        ...
        return false;">Papar</a>
               ...
               <!--Senarai Hakmilik Yang Dibatalkan-->
               <c:if test="${fn:length(actionBean.senaraiHakmilikBatalUnique) > 0}" >
                   <br>
                   <legend>Senarai Hakmilik Yang Akan<em>DIBATALKAN</em></legend><br>
                   <p align="center"> <label>&nbsp;</label>
                       <display:table style="width:80%;" class="tablecloth" name="${actionBean.senaraiHakmilikBatalUnique}" cellpadding="0" cellspacing="0" id="line2">
                           <display:column title="No" >
                           ...
                           <display:column title="DHDe <br/><input type='checkbox' id='semuaHakmilikBatal' name='semua' onclick='javascript:selectAll(this);' />">
                               <c:if test="${line2.hakmilikSejarah.dhde != null}">
                                   <a href="#" id="p" onclick="doViewReport('${line2.hakmilikSejarah.dhde.idDokumen}');return false;">Papar</a>
               ...
               <!--End:Senarai Hakmilik Yang Dibatalkan-->
            <p>
                <label>&nbsp;</label>&nbsp;
            </p>
