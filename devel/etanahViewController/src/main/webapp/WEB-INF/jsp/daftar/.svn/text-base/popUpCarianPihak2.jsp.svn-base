<%--
    Document   : popUpCarianPihak2
    Created on : Nov 17, 2012, 9:24:45 AM
    Author     : Aizuddin
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            <%--set focus--%>
                ...
                function cariPenerima(noKP2,kodKP2,namaPenerima2,jPihak){
            <%--alert(namaPemberi);--%>
            <%--alert(kodKP);--%>
                    ...
                    params += ', status=no';
                    params += ', toolbar=no';
                    var url = '${pageContext.request.contextPath}/daftar/suratkuasawakil?cariPenerima&noKP2='+noKP2+'&kodKP2='+kodKP2+'&namaPenerima2='+namaPenerima2+'&jPihak='+jPihak;
            <%-- $.get(url,
             function(data){
                 $('#page_div').html(data);
             });--%>
            ...
            <%--alert(jVal);--%>
                ...
                function pickPut(s){
                    ...
                    opener.document.getElementById('namaPenerima2').value = s;
                ...
                <fieldset class="aras1">
                    ...
                    <div class="subtitle">
                        <div class="content" align="center">
                            <table class="tablecloth" width="30%">
                                ...
                                <tr><td class="T"><p class="L">Nama</p></td><td><s:text name="namaPenerima2" id="namaPenerima2" style="width:100%" onkeyup="this.value=this.value.toUpperCase();"/></td></tr>
                                <tr><td colspan="2"><p class="L" align="center">Atau</p></td></tr>
                                <tr><td><p class="L">Jenis Pengenalan:</p></td><td> <s:select name="kodKP2" id="kodKP2" value="kod" >
                                            <s:option value="null">Pilih ...</s:option>
                                            <s:options-collection collection="${list.senaraiKodJenisPengenalan}" label="nama" value="kod" />
                                        </s:select></td></tr>
                                <tr><td><p class="L"> No Pengenalan:</p></td><td> <s:text name="noKP2" id="noKP2" onkeyup="this.value=this.value.toUpperCase();"/></td></tr>
                            </table>
                        </div>
                        <br/>
                        <div align="center">
                            <s:button name="cari" value="Cari" class="btn" onclick="cariPenerima(noKP2.value,kodKP2.value, namaPenerima2.value, jPihak.value)"/>
                    ...
                    <div class="content" align="center">
                        <display:table class="tablecloth" name="${actionBean.pihakList}" pagesize="10" cellpadding="0" cellspacing="0"
                                       requestURI="${pageContext.request.contextPath}/daftar/suratkuasawakil?cariPenerima" id="line">
