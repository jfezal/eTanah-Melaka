...
<script type="text/javascript">
    ...
    function addPihak(v) {
        ...
        for (var i = 1; i <= len; i++) {
            ...
            if (ckd) {
                param = param + '&idPermohonanPihak=' + $('#chkbox_pemohon_' + i).val();
            }
        }
        if (param == '') {
            alert('Tiada pihak.');
        ...
        var url = '${pageContext.request.contextPath}/daftar/pembetulan/HapusPihakBerkepentinganActionBean?simpanPemohonPihak2' + param;
    ...
    function addPihakPemohon(k) {
        ...
        var url = '${pageContext.request.contextPath}/daftar/pembetulan/HapusPihakBerkepentinganActionBean?simpanPemohon' + param;
...
<s:form name="form1" beanclass="etanah.view.stripes.nota.HapusPihakBerkepentinganActionBean">

    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                <c:set var="title" value="Pihak Berkepentingan1"/>
                Senarai ${title}
            </legend>
            <div class="content" align="center">
                ...
                <display:table class="tablecloth" name="${actionBean.listMohonPihak}" cellpadding="0" cellspacing="0" id="line">
                    <display:column>
                        <s:checkbox name="checkbox" id="chkbox_pemohon_${line_rowNum}" value="${line.idPermohonanPihak}"/>
                    </display:column>
