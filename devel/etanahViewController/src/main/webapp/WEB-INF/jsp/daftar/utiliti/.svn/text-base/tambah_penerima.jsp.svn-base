                ...
                <table class="tablecloth" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        <tr class="odd">
                            ...
                            <td>
                                <s:textarea name="namaPenerima" id="namaPenerima" onkeyup="this.value=this.value.toUpperCase()" rows="5" cols="50" value="${nama}"/>
                            </td>
                        </tr>
                        <tr class="even">
                            <td>2.</td>
                            ...
                            <td>
                                <s:select name="jenisPengenalanPenerima" id="jenisPengenalanPenerima" value="${kod}">
                        ...
                        <tr class="odd">
                            <td>3.</td>
                            <td>No Pengenalan</td>
                            <td><s:text name="noPengenalanPenerima" id="noPengenalanPenerima" onkeyup="this.value=this.value.toUpperCase();" value="${noPengenalanPemberi}"/></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                           <s:hidden id="idPermohonan" name="idPermohonan" value="${actionBean.idPermohonan}" />
            <center><s:submit name="simpanPenerimaNew" id="simpanPenerimaNew" value="Simpan" class="btn"/></center>
            <br>
        </fieldset>
    </s:form>
</div>
