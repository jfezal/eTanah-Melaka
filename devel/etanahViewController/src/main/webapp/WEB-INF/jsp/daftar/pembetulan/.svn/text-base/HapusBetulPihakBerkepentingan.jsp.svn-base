...
<script type="text/javascript">
    ...
    function removePihak(val) {
        ...
        if (confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/daftar/pembetulan/HapusPihakBerkepentinganActionBean?deletePihak&idAtasPihak=' + val;
            $.get(url,
                    function (data) {
                        $('#page_div').html(data);
                    }, 'html');
    ...
    function addPemohon() {
        ...
        var url = '${pageContext.request.contextPath}/daftar/pembetulan/HapusPihakBerkepentinganActionBean?simpanPemohonPihak' + param;
    ...
    function addPihak2() {
        ...
        var idmhn = document.getElementById("idPermohonan").value;
        window.open("${pageContext.request.contextPath}/daftar/pembetulan/HapusPihakBerkepentinganActionBean?caripihak2" + param + "&idPermohonan=" + idmhn, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=1200,height=600,scrollbars=yes");
