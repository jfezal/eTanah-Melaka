        ...
        <fieldset class="aras1">
            ...
            <div align="center">
                <display:table class="tablecloth" name="${actionBean.senaraiDokumenCapai}" 
                    ...
                    <display:column property="alasan" title="Sebab Cetakan"/>
                    <display:column property="infoAudit.dimasukOleh.nama" title="Dicetak Oleh"/>
                    <display:column title="Tarikh Dicetak">
