...
<script type="text/javascript">
    ...
    function findNoKadPengenalan(idPenghantarNotis,index){
        if(idPenghantarNotis != ""){
            $.get('${pageContext.request.contextPath}/pembangunan/PhantarNotis7G?findNoPengenalan&idPenghantarNotis='+idPenghantarNotis+'&index='+index,
            function(data){
                $('#icLoad'+index).empty();
...
<s:form beanclass="etanah.view.stripes.pembangunan.PenghantaranNotis7GActionBean" id="folder_div">
    ...
    <c:if test="${actionBean.show ne true}">
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>
                    Maklumat Penghantaran Notis 7G
                </legend>
