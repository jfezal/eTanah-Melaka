...
<script type="text/javascript">
    ...
    return false;--%>
        ...
        function muatNaikimej(f) {          
            ...
            var url = '${pageContext.request.contextPath}/utiliti/laporanTanah?uploadDoc&idPermohonan='+id;
        ...
        function popImej(idDok){
            ...
            var url = '${pageContext.request.contextPath}/utiliti/laporanTanah?viewImejPopup&idPermohonan='+id+'&idDokumen='+idDok;
...
<s:form id="testForm" name="myform" beanclass="etanah.view.stripes.pembangunan.utiliti.UtilitiLtActionBean">
...
<div id="muatnaik" style="display: none">
    <s:form name="myform1" beanclass="etanah.view.stripes.pembangunan.utiliti.UtilitiLtActionBean">
        <fieldset class="aras1">
            <div id="error"/>
