...
<script type="text/javascript">
    ...
    function muatNaikForm(notis,id) {
        ...
        var url = '${pageContext.request.contextPath}/pembangunan/kemasukkan_rekod_16H_PPCB?popupUpload&idNotis='+notis+'&id='+id;
    ...
    function addPenghantarNotis(){
        window.open("${pageContext.request.contextPath}/pembangunan/kemasukkan_rekod_16H_PPCB?popupPenghantarNotis", "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=400");
    }

    function scan(notis) {
        var url = '${pageContext.request.contextPath}/pembangunan/kemasukkan_rekod_16H_PPCB?popupScan&idNotis='+notis;
    ...
    function findNoKadPengenalan(idPenghantarNotis,index){
        if(idPenghantarNotis != ""){
            $.get('${pageContext.request.contextPath}/pembangunan/kemasukkan_rekod_16H_PPCB?findNoPengenalan&idPenghantarNotis='+idPenghantarNotis+'&index='+index,
            function(data){
                $('#icLoad'+index).empty();
...
<s:form beanclass="etanah.view.stripes.pembangunan.MaklumatPenghantaran16HPPCBActionBean" id="folder_div">
            ...
            <fieldset class="aras1">
                ...
                <div class="content" align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.listNotis}"
                                   cellpadding="0" cellspacing="0" requestURI="/pembangunan/kemasukkan_rekod_16H_PPCB" id="line">
                        ...
                        <display:column title="Tarikh" class="${line_rowNum}">
                            ...
                            <p align="center">
                                ...
                                <img src="${pageContext.request.contextPath}/pub/images/icons/_active__document.png" height="30" width="30" alt="papar"
                                     onclick="doViewReport('${line.buktiPenerimaan.idDokumen}');" title="Papar Dokumen"/>
                            </c:if>
                            </p>
                        </display:column>
                    </display:table>
