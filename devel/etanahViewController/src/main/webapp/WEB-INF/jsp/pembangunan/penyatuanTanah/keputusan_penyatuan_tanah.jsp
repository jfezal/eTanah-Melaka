<%-- 
    Document   : keputusan_penyatuan_tanah
    Created on : Jan 5, 2010, 11:02:33 AM
    Author     : nursyazwani
--%>
...
<html>
    <head>
        ...
        <title>Keputusan Permohonan Penyatuan Tanah</title>
    </head>
    <body>
        <stripes:form beanclass="etanah.view.stripes.pembangunan.PenyatuanTanahActionBean">
           ...
           <div class="subtitle">
                <fieldset class="aras1">
                    <legend>
                       Keputusan Penyatuan Tanah
                    </legend>
                    <div class="content" align="center">
                        <table>
                            <tr>
                                <td>Keputusan :</td>
                                <td><s:textarea cols="87" rows="8" name="keputusanPenyatuan"/></td>
                            </tr>
                        </table>
                    </div>
                </fieldset>
            ...
            <div class="subtitle">
                <fieldset class="aras1">
                    <legend>
                        Endorsan Borang 9C, 12B, Pelan Tatatur dan Pelan Pra-Hitung
                    </legend>
                    <div class="content" align="center">
                       <table>
                            <tr>
                        ...
                        <br>
                        <display:table class="tablecloth" name="endorsan" pagesize="4" cellpadding="0" cellspacing="0" id="line" size="100">
