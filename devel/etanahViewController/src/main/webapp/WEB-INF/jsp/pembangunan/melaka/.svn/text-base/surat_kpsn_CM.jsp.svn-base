<%-- 
    Document   : surat_kpsn_CM
    Created on : Mar 11, 2014, 1:51:56 PM
...
<script type="text/javascript">
    ...
    alert("c1:"+c1);--%>
        if (rc1 == c1) {
            var url = '${pageContext.request.contextPath}/pembangunan/melaka/suratKeputusanCM?deleteSingle&idKandungan='
                    + idKandungan;
            $.get(url,
                    function (data) {
                        $('#page_div').html(data);
...
<s:form beanclass="etanah.view.stripes.pembangunan.SuratKeputusanCMActionBean">
        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                    <tr><td align="center"><b>SURAT KEPUTUSAN Y.A.B Menteri</b></td></tr>
                </table> 
                <table border="0" width="100%">
                    <tr><td align="left"> <p><span style="color: #003194;font-family: tahoma;font-weight: bold;">Tarikh Sidang :</span>
                                <s:text name="tarikhSidang" size="20" id="tarikhSidang" class="datepicker"/>
                            </p></td></tr>
                    <tr><td align="left"> <p><span style="color: #003194;font-family: tahoma;font-weight: bold;">Nama Ketua Menteri :</span>
                                <s:text name="namaPelulus" size="35" id="namaPelulus" />
                            </p>
                            <br>
                            <br>
                        </td></tr>
                    ...
                    <!--no.4-->    
                    <tr><td>4. Syarat-syarat am adalah seperti berikut :- </td></tr>
                    <c:if test="${edit}">                      
                        <tr><td>
                                <table id ="dataTable4">                                    
                                    <c:set var="i" value="1" />
