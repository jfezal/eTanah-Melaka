<%-- 
    Document   : Kertas_MMKN_PBSK
    Created on : Aug 6, 2012, 3:32:07 PM
    Author     : NageswaraRao
--%>
...
<s:form beanclass="etanah.view.stripes.pembangunan.KertasMMKNPbskActionBean">
            ...
            <div class="content" align="center">
                ...
                <table border="0" width="80%" cellspacing="10">
                   ...
                   <c:if test="${actionBean.pengguna.kodCawangan.kod eq '00'}">
                    ...
                    <tr><td><b><font style="text-transform:uppercase">3. PERAKUAN PENTADBIR TANAH ${actionBean.pejTanah} </font></b></td></tr>
                    <c:if test="${edit}">
                        <tr><td>
                                <table id ="dataTable4">
                                    <c:set var="i" value="1" />
                    ...
                    <c:if test="${actionBean.pengguna.kodCawangan.kod eq '00'}">                    
                            <tr><td><b>4. PERAKUAN PENGARAH TANAH DAN GALIAN MELAKA</b></td></tr>
                            <c:if test="${edit1}">
                                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textarea name="perakuanptg" rows="5" cols="150" id="perakuanptg" class="normal_text"/></td></tr>
                            </c:if>
                            <c:if test="${!edit1}">
                                <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>4.1</b> &nbsp;${actionBean.perakuanptg}</td></tr>                             
                            </c:if>
                        </c:if>                  
                </table>
