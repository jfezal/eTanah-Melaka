...
<script type="text/javascript">
    ...
    function searchKodSyaratNyata(idPlot,forEdit){
        var url = '${pageContext.request.contextPath}/pembangunan/melaka/laporanTanah?showFormCariKodSyaratNyataSBMSnTSPSS&idPlot='+idPlot+'&forEdit='+forEdit;
    ...
    function searchKodSekatan(idPlot,forEdit){
        var url = '${pageContext.request.contextPath}/pembangunan/melaka/laporanTanah?showFormCariKodSekatanSBMSnTSPSS&idPlot='+idPlot+'&forEdit='+forEdit;
