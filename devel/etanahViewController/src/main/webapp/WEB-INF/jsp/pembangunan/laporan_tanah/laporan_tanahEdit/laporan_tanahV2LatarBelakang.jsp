...
<script type="text/javascript">
    ...
    function addMohonLaporPohon(){
        ...
        window.open("${pageContext.request.contextPath}/pembangunan/laporanTanahv2?showFormPopUpLatarBelakangTanah&idHakmilik="+idHakmilik+"&idLaporTanah="+${actionBean.laporanTanah.idLaporan}, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
