<%-- 
    Document   : menentukan_hakmilik_keluasan_syarat
    Created on : Jan 5, 2010, 10:52:09 AM
    Author     : nursyazwani
--%>
...
<html>
    <head>
        ...
        <title>Menetukan Hakmilik Jenis Hakmilik, Keluasan dan Syarat</title>
    </head>
    <body>
        ...
        <div class="subtitle">
            <fieldset class ="aras1">
                ...
                <table>
                    ...
                    <tr>
                        <td>Keluasan(ha) :</td>
                        <td><s:text name="keluasan" size="20"/></td>
                    </tr>
                    <tr>
                        <td>Syarat :</td>
                        <td><s:textarea name="keluasan" cols="87" rows="8"/></td>
                    </tr>
                </table>
                </div>
            </fieldset>
