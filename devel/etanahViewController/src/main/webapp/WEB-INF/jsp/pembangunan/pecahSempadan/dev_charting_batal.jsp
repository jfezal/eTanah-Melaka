...
<stripes:form beanclass="etanah.view.stripes.pembangunan.ChartingKelulusanActionBean">
   ...
   <p>
        <label>&nbsp;</label>
        <s:button name="lakarPelan" id="lakarPelan" value="Charting Batal" class="btn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
   </p>
</stripes:form>
