<%--
    Document   :  syorPJBTR(Editable).jsp
    Created on :  Jan 05, 2012, 08:05:00 PM
    Author     :  Shazwan
--%>
...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        function showpjbtrtidaksokong(val) {
            $('#pjbtrtidaksokong').show();
            $('#pjbtrsokong').hide();
            if(val == 'SL'){
                val = 'ST';
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showpjbtrsokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showpjbtrtidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                        ...
                        <div id="pjbtrsokong">
                            <table class="tablecloth" align="center">
                                ...
                                <tr>
                                    <td><font color="red" size="4">*</font>Isipadu Disyorkan :</td>
                                    <td>
