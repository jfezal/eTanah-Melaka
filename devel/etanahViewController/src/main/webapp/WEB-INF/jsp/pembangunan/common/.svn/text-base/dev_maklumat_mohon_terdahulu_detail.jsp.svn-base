<%-- 
    ...
    Created on : OCT 09, 2010, 5:32:06 PM
    Author     : Syaiful
--%>
...
<s:form  beanclass="etanah.view.stripes.pembangunan.LaporanPelukisPelanActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1" style="width: auto">
            <legend>Maklumat Permohonan Terdahulu</legend>
            <p>
                <label for="Permohonan">Permohonan :</label>
                <font style="text-transform:uppercase;"> ${actionBean.permohonanTerdahulu.kodUrusan.nama}</font>&nbsp;
            </p>
            <p>
                <label for="ID Permohonan">ID Permohonan :</label>
                ${actionBean.permohonanTerdahulu.idPermohonan}&nbsp;
            </p>
            <p>
                <label for="Tarikh Daftar">Tarikh Daftar :</label>
                <fmt:formatDate pattern="dd/MM/yyyy" value="${actionBean.permohonanTerdahulu.infoAudit.tarikhMasuk}"/>            
            </p>
            <br>
        </fieldset>
    </div>
<br>
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                <label>Nama :</label>
                <font style="text-transform:uppercase;"> ${actionBean.permohonanTerdahulu.penyerahNama}</font>&nbsp;
            </p>
            <p>
                <label>Jenis Penyerah :</label>
                <font style="text-transform:uppercase;">
                    <c:if test="${actionBean.permohonanTerdahulu.kodPenyerah.nama ne null}"> ${actionBean.permohonanTerdahulu.kodPenyerah.nama}&nbsp; </c:if>
                    <c:if test="${actionBean.permohonanTerdahulu.kodPenyerah.nama eq null}"> Tiada Data </c:if>
                </font>
            </p>
            <c:if test="${actionBean.permohonanTerdahulu.penyerahAlamat1 ne null}">
                <p>
                    <label>Alamat :</label>
                    <font style="text-transform:uppercase;"> ${actionBean.permohonanTerdahulu.penyerahAlamat1}</font>&nbsp;
                </p>
            </c:if>
            <c:if test="${actionBean.permohonanTerdahulu.penyerahAlamat2 ne null}">
                <p>
                    <label> &nbsp;</label>
                    <font style="text-transform:uppercase;">${actionBean.permohonanTerdahulu.penyerahAlamat2}</font> &nbsp;
                </p>
            </c:if>
            <c:if test="${actionBean.permohonanTerdahulu.penyerahAlamat3 ne null}">
                <p>
                    <label> &nbsp;</label>
                    <font style="text-transform:uppercase;"> ${actionBean.permohonanTerdahulu.penyerahAlamat3} </font> &nbsp;
                </p>
            </c:if>
            <c:if test="${actionBean.permohonanTerdahulu.penyerahAlamat4 ne null}">
                <p>
                    <label> &nbsp;</label>
                    <font style="text-transform:uppercase;">${actionBean.permohonanTerdahulu.penyerahAlamat4}</font>&nbsp;
                </p>
            </c:if>
            <p>
                <label>Poskod :</label>
                ${actionBean.permohonanTerdahulu.penyerahPoskod}&nbsp;
            </p>
            <p>
                <label>Negeri :</label>
                <font style="text-transform:uppercase;">${actionBean.permohonanTerdahulu.penyerahNegeri.nama} </font>&nbsp;
            </p>
            <br>
        </fieldset>
    </div>
        ...
        <fieldset class="aras1">
            ...
            <table border="0">
                <tr><td id="tdLabel">ID Hakmilik :</td>
                    <td id="tdDisplay"><c:if test="${actionBean.permohonanTerdahulu.idPermohonan ne null}"> ${actionBean.permohonanTerdahulu.idPermohonan}&nbsp; </c:if>
                        <c:if test="${actionBean.permohonanTerdahulu.idPermohonan eq null}"> Tiada </c:if>
                    </td>
                </tr>
                ...
                <tr><td id="tdLabel">Taraf Pegangan :</td>
                    <td id="tdDisplay"> <c:if test="${actionBean.hakmilik.pegangan eq 'P'}"> Pajakan ${actionBean.hakmilik.tempohPegangan} tahun </c:if>
                ...
                <tr><td id="tdLabel">Tarikh Daftar :</td>
                    <td id="tdDisplay"> <c:if test="${actionBean.hakmilik.tarikhDaftar ne null}"> ${actionBean.hakmilik.tarikhDaftar}&nbsp; </c:if>
                ...
                <tr><td id="tdLabel">Tarikh Luput Pajakan :</td>
