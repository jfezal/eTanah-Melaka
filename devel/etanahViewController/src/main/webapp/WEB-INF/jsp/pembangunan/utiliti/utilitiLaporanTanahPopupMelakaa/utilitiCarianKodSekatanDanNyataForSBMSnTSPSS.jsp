...
<div class="subtitle">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test = "${actionBean.forEdit eq 'NY'}">           
                <p>
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSyaratNyata}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/utiliti/laporanTanah" id="line">
            ...
            <c:if test = "${actionBean.forEdit eq 'SK'}">   
                <p>
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSekatan}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/utiliti/laporanTanah" id="line">
