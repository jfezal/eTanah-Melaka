    ...
    <fieldset class="aras1">
        ...
        <div class="content" align="center">
            <table  border="1" class="tablecloth">
                   <tr><td>Premium </td>
                        <td>RM</td>
                        <td style="text-align:right"><fmt:formatNumber pattern="#,##0.00" value="${actionBean.premiumBaru}"/></td>
                    </tr>
                    ...
                    <tr><th>Jumlah</th>
                        <th>RM</th>
                        <th style="text-align:right"><fmt:formatNumber pattern="#,##0.00" value="${actionBean.jumlah2}"/></th>
                    </tr>
                </table>
