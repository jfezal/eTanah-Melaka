...
<script type="text/javascript">
    ...
    function simpan(){
        ...
        var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?simpan&perihalHakmilik='+perihalHakmilik;
        $.get(url,
        function(data){
            $('#page_div').html(data);
    ...
    function openFrame(type){        
        ...
        NoPrompt();
        //    alert(perihalHakmilik);
        window.open("${pageContext.request.contextPath}/pembangunan/laporanTanahv2?openFrame&perihalHakmilik="+perihalHakmilik+"&type="+type, "eTanah",
