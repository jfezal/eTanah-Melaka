<%-- 
    Document   : dev_laporan_param_salinanKepada
    Created on : Jan 16, 2014, 12:31:51 PM
...
<s:form beanclass="etanah.view.stripes.pembangunan.utiliti.UtilitiSalinanKepadaDevActionBean">
    <s:hidden name="reportName"/>
    <s:hidden name="idPermohonan" id="idPermohonan"/>
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>Sila Klik Butang 'Papar' Untuk Paparan Dokumen</legend>
            ...
            <c:if test="${reportname eq 'DEVSMUYB_MLK.rdf'
                          ...
                          or reportname eq 'DEVSRJKBBPTG_MLK.rdf'
                          ...
                          or reportname eq 'DEVSMD_V2_MLK.rdf'
