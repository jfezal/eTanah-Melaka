...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.hakmilikPermohonan ne null}">
        ...
        function reload (val) {
            doBlockUI();
            var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?reload&idHakmilik=' + val;
            $.ajax({
                type:"GET",
                url : url,
                dataType : 'html',
        ...
        function reloadPT (val) {
            doBlockUI();
            var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?reload&noPtSementara=' + val;
            $.ajax({
                type:"GET",
                url : url,
                dataType : 'html',
        ...
        function refreshV2ManyHakmilik(type,hakmilik){
            var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?refreshpage&type='+type+'&idHakmilik='+hakmilik;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
...
<s:form beanclass="etanah.view.stripes.pembangunan.LaporanTanahV2ActionBean" name="form">
            ...
            <div id="perihaltanah">
                <div class="content" align="center"> 
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="20" cellpadding="0" cellspacing="0" id="line"
                                   requestURI="/pembangunan/laporanTanahv2">
                        <c:if test="${line.hakmilikPermohonan.hakmilik ne null}">
                            ...
                            <display:column title="No.Lot/PT">
                                <c:if test="${line.hakmilikPermohonan.noLot eq null}">
                                    <%--${line.hakmilikPermohonan.hakmilik.noLot}--%>${actionBean.nolot}
                                </c:if>
                                <c:if test="${line.hakmilikPermohonan.noLot ne null}">
                                    <%--${line.hakmilikPermohonan.noLot}--%>${actionBean.nolot}
                                </c:if>
                            </display:column>
                            ...
                            <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'BMBT'}">
                                <display:column title="Luas"><s:format formatPattern="#,###,##0.0000" value="${line.hakmilikPermohonan.luasTerlibat}"/> ${line.hakmilikPermohonan.kodUnitLuas.nama} </display:column>
                            </c:if>
                        </c:if>
                        <c:if test="${line.hakmilikPermohonan.hakmilik eq null}">
                            <display:column title="No" sortable="true">${line_rowNum}
                                <s:hidden name="x" class="x${line_rowNum -1}" value="${line.hakmilikPermohonan.id}"/></display:column>
                            <display:column title="No.Lot/PT" ><%--${line.hakmilikPermohonan.noLot}--%> ${actionBean.nolot}</display:column>
                    ...
                    <table class="tablecloth" border="0">
                                    ...
                                    <td colspan="2">
                                        <display:table  name="${actionBean.senaraiHakmilikPerihalTanah}" id="line" class="tablecloth">
                                            ...
                                            <display:column title="No Lot" >
                                                <c:if test="${line.hakmilik.noLot ne null}"> <%--${line.hakmilik.noLot}--%> ${actionBean.nolot}&nbsp; </c:if>
                        ...
                        <tr>
                            ...
                            <td>
                                ${actionBean.permohonanLaporanPelan.kawasan.nama} 
                            </td>
                        </tr>
                        --%>
                        <c:if test="${actionBean.permohonanLaporanPelan.kodTanah ne null}">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <div id="keadaantanah" align="center">
                ...
                <table class="tablecloth" align="center">
                    <tr>
                        <th>Talian Elektrik / Talian Elektrik Bawah Tanah</th><th>Talian Telefon / Talian Telefon Bawah Tanah</th><th>Laluan Gas</th><th>Paip Air</th><th>Tali Air</th><th>Sungai</th><th>Parit</th>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <display:table class="tablecloth" name="${actionBean.listPermohonanLaporanUsaha}" cellpadding="0" cellspacing="0"
                                                   requestURI="/pembangunan/laporanTanahv2"  id="line">
                ...
                <c:if test="${actionBean.laporanTanah.adaBangunan eq 'Y'}">
                    ...
                    <display:table class="tablecloth" name="${actionBean.permohonanLaporanBangunanList}" pagesize="5" cellpadding="0" cellspacing="0"
                        ...
                        <display:column title="Ukuran Bangunan" >
                            ${line.ukuran}
                            <c:if test="${line.uomUkuran.kod eq 'K'}">Kaki Persegi</c:if>
                            <c:if test="${line.uomUkuran.kod eq 'M'}">Meter Persegi</c:if>
                        </display:column>
                        <display:column property="tahunDibina" title="Tahun Dibina" />
                        <display:column property="keadaanBangunan" title="Keadaan Bangunan" />
                        <display:column title="Nilai Bangunan" >RM ${line.nilai}</display:column>
            ...
            <fieldset class="aras1">
                ...
                <div id="jabatan_teknikal" align="center">
                    <display:table class="tablecloth" name="${actionBean.senaraiUlasanJabatanTeknikal}" cellpadding="0" cellspacing="0" id="line"
                                   requestURI="${pageContext.request.contextPath}/pembangunan/laporanTanahv2">                              
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                ...
                <br>
                <c:import url="laporan_tanahView/syor/syor.jsp"></c:import>
            </legend>
            <br/>
            ...
            <table class="tablecloth" align="center">
                <c:if test="${!empty actionBean.senaraiLaporanKandungan1}">
                    ...
                    <c:forEach items="${actionBean.senaraiLaporanKandungan1}" var="line">
                        <tr><td style="text-align: right">${i}</td>
                            <td><s:textarea value="${line.ulasan}" cols="80" readonly="true" name="syorUlasan" rows="5" disabled="false" style="border:none;overflow:auto;resize:none" /></td>
                        </tr>
                        <c:set var="i" value="${i+1}" />
                    </c:forEach> 
                </c:if>
                <c:if test="${empty actionBean.senaraiLaporanKandungan1}">
                    <tr>
                        <td><s:textarea value="TIADA ULASAN PENOLONG PEGAWAI TANAH TELAH DIBUAT." cols="80" readonly="true" name="syorUlasan" disabled="true" rows="5" style="border:none;overflow:auto;resize:none"/></td>
                    </tr>
                </c:if>
            </table>
        </fieldset>
    ...
    <c:if test = "${actionBean.permohonan.kodUrusan.kod eq 'SBMS' || actionBean.permohonan.kodUrusan.kod eq 'TSPSS'}">
        <script type="text/javascript">
            ...
            function saveSyor1(kpsn)
            {
                //                alert("Save Syor");
                //NoPrompt();
                $.post('${pageContext.request.contextPath}/pembangunan/laporanTanahv2?saveSyor1', {typeName: 'syorPPT', kpsn: kpsn},
                function(data) {
                    //                    alert("Save Syord");
                    $('#page_div').html(data);
                }, 'html');
            ...
            function dopopup(i){  
                var d=i;
                window.open("${pageContext.request.contextPath}/pembangunan/laporanTanahv2?editPopup&idPlot="+d, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=800,height=500");
            }
    
            function doNyata(i,k){  
                var d=i;
                window.open("${pageContext.request.contextPath}/pembangunan/laporanTanahv2?editNyata&idPlot="+d+"&forEdit="+k, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=1200,height=500");
            }
    
            function doSekatan(i,k){  
                var d=i;
                window.open("${pageContext.request.contextPath}/pembangunan/laporanTanahv2?editSekatan&idPlot="+d+"&forEdit="+k, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=1200,height=900");
            }
            
            function refreshPopup(){
                var id = '${actionBean.idPermohonan}';
                var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?rehydrate&idPermohonan='+id ;
                $.get(url,
                function(data){
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <c:if test = "${actionBean.stageId eq 'g_laporan_tanah'}">
                    <p>
                ...
                <c:if test = "${actionBean.stageId ne 'g_laporan_tanah'}">
                    <p>
                        <label>Jika diperakukan :</label>
                ...
                <c:if test="${actionBean.laporanTanah.syor eq 'Y'}">
                    <div class="content" id="perakuanSyor">
                        ...
                        <div align ="center">
                            <div id="popupDiv">
                                <display:table class="tablecloth" name="${actionBean.listHakmilik}" cellpadding="0" requestURI="/pembangunan/laporanTanahv2"
                                    ...
                                    <display:column title="Kategori Tanah" style="vertical-align:baseline">
                                    ...
                                    <display:column title="Butir Pembangunan" style="vertical-align:baseline">
                                        <c:if test = "${line.catatan eq null}"> - &nbsp; </c:if>
                                    ...
                                    <display:column title="Denda Premium" style="vertical-align:baseline">
                                        <c:if test = "${line.keteranganKadarDaftar eq null}"> - &nbsp;</c:if>
                                        <c:if test = "${line.keteranganKadarDaftar ne null}"> ${line.keteranganKadarDaftar} &nbsp;</c:if>    
                                    </display:column> 
                                    <display:column title="Sewa Tahunan Baru" style="vertical-align:baseline">
                        ...
                        <br/>
                        <div align="center">
                            <td>Semua bayaran dijelaskan dalam tempoh:</td>                  
                            <c:choose>
                                <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'SBMS'}">
                                    <td>3 bulan dari tarikh Borang 5A.</td>
                                </c:when>
                                <c:otherwise>
                                    <td>3 bulan.</td>
                                </c:otherwise>
                ...
                <c:choose>
                    <c:when test="${actionBean.kodNegeri eq '04'}">                    
                        <legend>
                            ...
                            <span style="float:right">
                                <c:if test="${actionBean.disLaporanTanahController.syorPPTKanan}">
                        ...
                        <table class="tablecloth" align="center">
                            ...
                            <c:if test="${empty actionBean.senaraiLaporanKandunganPPTKanan}">
                                <tr>
                                    <td><s:textarea value="TIADA ULASAN PENOLONG PEGAWAI TANAH TELAH DIBUAT." cols="80" readonly="true" name="syorUlasan" rows="5" disabled="true" style="border:none;overflow:auto;resize:none"/></td>
                                </tr>
                            </c:if>
                        </table>
                    </c:when>
                    <c:when test="${actionBean.kodNegeri eq '05'}">
                        <c:if test="${actionBean.disLaporanTanahController.syorPPTKanan}">
                            ...
                            <table class="tablecloth" align="center">
                                ...
                                <c:if test="${empty actionBean.senaraiLaporanKandunganPPTKanan}">
                                    <tr>
                                        <td><s:textarea value="TIADA ULASAN PENOLONG PEGAWAI TANAH KANAN TELAH DIBUAT." cols="80" readonly="true" name="syorUlasan" rows="5" disabled="true" style="border:none;overflow:auto;resize:none"/></td>
                                    </tr>
                                </c:if>
                            </table>
                        </c:if>
