<%-- 
    ...
    Created on : Sept 25, 2013, 3:51:59 PM
    Author     : murali
--%>
...
<script type="text/javascript">
    ...
    function viewStatus(id){
        window.open("${pageContext.request.contextPath}/pembangunan/semak_status?viewStatus&idPermohonan="+id, "eTanah",
    ...
    function moduledet(val){       
        $.get('${pageContext.request.contextPath}/pembangunan/semak_status?findKod&kod=' + val,
        function(data){
...
<s:form beanclass="etanah.view.stripes.pembangunan.utiliti.SemakStatusActionBean" id="cetak_semula">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            ...
            <c:if test="${fn:length(actionBean.permohonanList) == 0}">
                <div class="content" align="center">
                    <table>
                        ...
                        <tr>
                            <td class="rowlabel1"><em>*</em>Unit :</td>
                            <td class="input1">
                        ...
                        <tr>                           
                            ...
                            <td class="input1" id="kodu">
                                <s:select name="kodurus" id="kodurus" style="width:350px;">
                                    <s:option  value="">Sila Pilih</s:option>
            ...
            <c:if test="${fn:length(actionBean.permohonanList) > 0}">
                ...
                <div align="center">
                    <display:table name="${actionBean.permohonanList}" class="tablecloth" id="line" style="width:90%" pagesize="20" requestURI="${pageContext.request.contextPath}/pembangunan/semak_status">
