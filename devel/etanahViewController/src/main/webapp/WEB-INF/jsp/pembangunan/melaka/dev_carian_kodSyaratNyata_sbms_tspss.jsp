<%-- 
    Document   : dev_carian_kodSyaratNyata_sbms_tspss
    Created on : Feb 25, 2014, 10:10:16 PM
...
<div class="subtitle">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test = "${actionBean.foredit eq 'NY'}">           
                <p>
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSyaratNyata}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pembangunan/melaka/rencanaRingkasanLampiranAForTPSSSnSBMS" id="line">
            ...
            <c:if test = "${actionBean.foredit eq 'SK'}">   
                <p>
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSekatan}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pembangunan/melaka/rencanaRingkasanLampiranAForTPSSSnSBMS" id="line">
            ...
            <div align="center">
                <c:if test="${fn:length(actionBean.listKodSekatan) > 0 || fn:length(actionBean.listKodSyaratNyata) > 0}">
                    <s:submit name="simpanKodSyaratNyata" value="Simpan" id="simpanKodSyaratNyata" class="btn"/>
                </c:if>
                <s:button name="tutup" value="Tutup" class="btn" onclick="self.close()"/>
            </div>
        </fieldset>
