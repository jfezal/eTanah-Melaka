<%-- 
    Document   : semak_B1
    Created on : Mar 3, 2011, 8:32:09 PM
    Author     : NageswaraRao
--%>
...
<s:form beanclass="etanah.view.stripes.pembangunan.SemakB1ActionBean" name="form">
    ...
    <html>
        ...
        <body>
            ...
            <c:if test="${edit}">
            <p align="center">
            <s:button name="lakarPelan" id="lakarPelan" value="Kemaskini FT" class="btn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
            </p>
            </c:if>
            ...
            <c:if test="${edit2}">
            <p align="center">            
            <s:button name="lakarPelan" id="lakarPelan" value="Semak FT" class="btn"  onclick="RunProgram2('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
            </c:if>
            </p>   
