...
<script type="text/javascript">
    ...
    function searchKodSyaratNyata(idPlot,forEdit){
        var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?showFormCariKodSyaratNyataSBMSnTSPSS&idPlot='+idPlot+'&forEdit='+forEdit;
    ...
    function searchKodSekatan(idPlot,forEdit){
        var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?showFormCariKodSekatanSBMSnTSPSS&idPlot='+idPlot+'&forEdit='+forEdit;
