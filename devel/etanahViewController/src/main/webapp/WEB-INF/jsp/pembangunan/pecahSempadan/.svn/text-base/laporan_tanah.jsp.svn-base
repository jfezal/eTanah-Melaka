...
<script type="text/javascript">
    ...
    function popup(i){
        ...
        var d = $('.x'+i).val();
        window.open("${pageContext.request.contextPath}/pembangunan/laporanTanah?showeditTanahRizab&idTanahRizabPermohonan="+d, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=890,height=600");
    }


    function refreshRizab(){
        var url = '${pageContext.request.contextPath}/pembangunan/laporanTanah?refreshpage';
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function removeSingle(idTanahRizabPermohonan)
    {
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/pembangunan/laporanTanah?deleteSingle&idTanahRizabPermohonan='
    ...
    function tambahBaru(){
        window.open("${pageContext.request.contextPath}/pembangunan/laporanTanah?hakMilikPopup", "eTanah",
    ...
    <%--document.forms[0].amt.style.display = 'none';--%>
        ...
        function addImage(idHakmilik,rowNo) {
            ...
            $.post('${pageContext.request.contextPath}/pembangunan/laporanTanah?addHakmilikImage&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        ...
        function addImageUtara(idHakmilik){
            ...
            $.post('${pageContext.request.contextPath}/pembangunan/laporanTanah?addLaporanImage&pandanganImej=U&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
        ...
        function addImageSelatan(idHakmilik){
            ...
            $.post('${pageContext.request.contextPath}/pembangunan/laporanTanah?addLaporanImage&pandanganImej=S&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
        ...
        function addImageTimur(idHakmilik){
            ...
            $.post('${pageContext.request.contextPath}/pembangunan/laporanTanah?addLaporanImage&pandanganImej=T&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
        ...
        function addImageBarat(idHakmilik){
            ...
            $.post('${pageContext.request.contextPath}/pembangunan/laporanTanah?addLaporanImage&pandanganImej=B&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
...
<s:form beanclass="etanah.view.stripes.pembangunan.LaporanTanahActionBean">
    <s:messages/>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="${pageContext.request.contextPath}/pub/images/icons/_active__document.png"
                                     ...
                                     onmouseover="this.style.cursor='pointer';" title="Papar Dokumen"/>
                                <s:button class="btn" value="Tambah" name="addUtaraImej" id="addUtaraImej" onclick="addImageUtara('${actionBean.permohonan.senaraiHakmilik[0].hakmilik.idHakmilik}');"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                ...
                                <img src="${pageContext.request.contextPath}/pub/images/icons/_active__document.png"
                                     ...
                                     onmouseover="this.style.cursor='pointer';" title="Papar Dokumen"/>
                                <s:button class="btn" value="Tambah" name="addSelatanImej" id="addSelatanImej" onclick="addImageSelatan('${actionBean.permohonan.senaraiHakmilik[0].hakmilik.idHakmilik}');"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                ...
                                <img src="${pageContext.request.contextPath}/pub/images/icons/_active__document.png"
                                     ...
                                     onmouseover="this.style.cursor='pointer';" title="Papar Dokumen"/>
                                <s:button class="btn" value="Tambah" name="addTimurImej" id="addTimurImej" onclick="addImageTimur('${actionBean.permohonan.senaraiHakmilik[0].hakmilik.idHakmilik}');"/>
                            </td>
                        </tr><tr>
                            <th>
                                Barat
                            ...
                            <td>
                                ...
                                <img src="${pageContext.request.contextPath}/pub/images/icons/_active__document.png"
                                     ...
                                     onmouseover="this.style.cursor='pointer';" title="Papar Dokumen"/>
                                <s:button class="btn" value="Tambah" name="addBaratImej" id="addBaratImej" onclick="addImageBarat('${actionBean.permohonan.senaraiHakmilik[0].hakmilik.idHakmilik}');"/>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <c:if test="${edit}">
                <p>
                    ...
                    <c:if test="${actionBean.stageId eq 'semaklaporantanah'}">
                        <s:textarea name="fasaPermohonan.ulasan" cols="100" rows="5" disabled="disabled"/>
                    </c:if>
                    <c:if test="${actionBean.stageId eq 'laporantanah'}">
                        <s:textarea name="fasaPermohonan.ulasan" cols="100" rows="5"/>
                    </c:if>
                </p>
                <p>
                    <c:if test="${actionBean.stageId eq 'laporantanah'}">
            ...
            <c:if test="${actionBean.stageId eq 'semaklaporantanah'}">
                ...
                <c:if test="${edit}">
                    <p>
                        ...
                        <s:textarea name="fasaPermohonan2.ulasan" cols="100" rows="5"/>
