...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.permohonanLaporanKawasan.kodRizab.kod ne '99' or actionBean.permohonanLaporanKawasan.kodRizab.kod ne '1'}">
                $('#catatanKwsn').hide();
    </c:if>
    <c:if test="${actionBean.permohonanLaporanKawasan.kodRizab.kod eq '99' or actionBean.permohonanLaporanKawasan.kodRizab.kod eq '1'}">
                $('#catatanKwsn').show();
    </c:if>
            });
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pembangunan.LaporanTanahV2ActionBean" name="test">
        <s:errors/>
        <s:messages/>
        <s:hidden name="idHakmilik" id="idHakmilik"/>
        <s:hidden name="noRizab" id="noRizab" value="${actionBean.permohonanLaporanKawasan.kodRizab.kod}"/>
        <div class="subtitle">
            <fieldset class="aras1">
                <div id="perihaltanah">
                    <legend>Tanah Dipohon Berada Dalam Kawasan :</legend>
                    <s:hidden name="id2" value="id"/>
                    <s:hidden name="permohonanLaporanKawasan.idMohonlaporKws" />
                    <table class="tablecloth" border="0" align="center">
                        <tr>
                            <td align="left">Jenis Rizab : </td>
                            <td style="color:black">:</td>
                            <td align="left" style="color:black">${actionBean.permohonanLaporanKawasan.kodRizab.nama}
                        ...
                        <c:if test="${actionBean.permohonanLaporanKawasan.kodRizab.kod eq '1' or actionBean.permohonanLaporanKawasan.kodRizab.kod eq '99'}">
                            <tr id="catatanKwsn">
                        ...
                        <tr>
                            <td align="left" colspan="3">
                                <s:submit name="simpanKawasanEdit" value="Simpan" class="btn" onclick="NoPrompt();"/>
