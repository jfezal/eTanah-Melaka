<%-- 
    Document   : sahkan_PU
    Created on : Mar 17, 2011, 7:23:06 PM
    Author     : NageswaraRao
--%>
...
<s:form beanclass="etanah.view.stripes.pembangunan.SahkanPUActionBean" name="form">
    ...
    <html>
        ...
        <body>
            <br><br>
            <p align="center">
            <s:button name="sahkan" id="sahkan" value="Sahkan PU" class="btn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
            </p>
        </body>
    </html>
</s:form>
