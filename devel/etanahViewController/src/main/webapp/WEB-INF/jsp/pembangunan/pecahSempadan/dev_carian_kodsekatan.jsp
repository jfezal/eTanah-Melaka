<%--
    Document   : dev_carian_kodsekatan
    Created on : Apr 13, 2011, 6:09:25 PM
    Author     : NageswaraRao
--%>
...
<script type="text/javascript">
        function masuk(){
            var index=document.getElementById('index').value;
             ...
             opener.document.getElementById('sekatan'+index).value = $("#selectedKod").val() +" - "+$("#selectedNama").val();
             self.close();
        }
       <%-- function uppercase(){
             alert("test");
    ...
    <fieldset class="aras1">
        ...
        <div class="subtitle">
            ...
            <p>
                ...
                <s:text name="sekatKpntgn" id="sekatKpntgn2"/>
            </p>
            <p>
                <label>&nbsp;</label>
        ...
        <fieldset class="aras1">
                    <legend></legend>
                    <p>
                        <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSekatan}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pembangunan/carianSyaratSekatan" id="line">
