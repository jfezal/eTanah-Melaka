        ...
        <div class="subtitle">
            ...
            <div class="subtitle">
                ...
                <fieldset class="aras1">
                    <legend></legend>
                    <p>
                        <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSyaratNyata}" pagesize="15" cellpadding="0" cellspacing="0" requestURI="/pendaftaran/maklumat_asas" id="line">
                    ...
                    <c:if test="${fn:length(actionBean.listKodSyaratNyata) > 0}" >
                        <p><label>&nbsp;</label>
                            <s:button name="simpanKodSyaratNyata" value="Simpan" id="simpanKodSyaratNyata" class="btn"/>
                        </p>
                    </c:if>
                </fieldset>
