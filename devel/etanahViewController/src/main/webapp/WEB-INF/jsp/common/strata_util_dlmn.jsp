...
<script type="text/javascript">
    ...
    function filterDaerah(kodDaerah, frm) {
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?penyukatanBPM&daerah=' + kodDaerah;
        frm.action = url;
        frm.submit();
    ...
    function search(event, frm) {
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?search&daerah=' + daerah + '&bandarPekanMukim=' + bandarPekanMukim + '&kodHakmilik=' + kodHakmilik + '&noHakmilik=' + noHakmilik + '&selectedTabs=' + selectedTabs;
        frm.action = url;
        frm.submit();
    }

    function find(kodDaerah, frm) {
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?search';
        frm.action = url;
        frm.submit();
    ...
    <%--var selectedTab = ''--%>
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?simpan&daerah=' + daerah + '&kodLot=' + kodLot + '&noLot=' + noLot + '&bandarPekanMukim=' + bandarPekanMukim + '&kodHakmilik=' + kodHakmilik + '&noHakmilik=' + noHakmilik + '&noFailRujukan=' + noFailRujukan + '&noSijil'
    ...
    function filterPetak(kodDaerah, frm) {
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?petak&daerah=' + daerah + '&kodLot=' + kodLot + '&noLot=' + noLot + '&bandarPekanMukim=' + bandarPekanMukim + '&kodHakmilik=' + kodHakmilik + '&noHakmilik=' + noHakmilik
...
//                if (confirm('Adakah anda pasti untuk menghapus Id Hakmilik ini? ' + idhakmilik)) {
                var url = '${pageContext.request.contextPath}/strataUtilDalaman?hapusSingle&idHakmilikHapus=' + idhakmilik + '&daerah=' + daerah + '&bandarPekanMukim=' + bandarPekanMukim + '&kodHakmilik=' + kodHakmilik + '&noHakmilik=' + noHakmilik + '&selectedTabs=' + selectedTabs;
                frm.action = url;
                frm.submit();
//                }
                check++;
    ...
    function popup2(f)
    {
        ...
        window.open("${pageContext.request.contextPath}/strataUtilDalaman?petakAksesoriPopupView&idHakmilikInduk=" + idHakmilikInduk, "eTanah",
    ...
    function popupEdit(f)
    {
        ...
        window.open("${pageContext.request.contextPath}/strataUtilDalaman?editPetak&idHakmilik=" + idHakmilik, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,scrollbars=1,width=1300,height=700");
    }
    <%--function hapus(f)
    {
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?hapusSingle&idHakmilikHapus='+ idHakmilikHapus;
    ...
    function hapus1(x, f, frm)
    {
        ...
        if (confirm('Adakah anda pasti untuk menghapus Id Hakmilik ini? ' + x)) {
            var url = '${pageContext.request.contextPath}/strataUtilDalaman?hapusSingle&idHakmilikHapus=' + x + '&daerah=' + daerah + '&bandarPekanMukim=' + bandarPekanMukim + '&kodHakmilik=' + kodHakmilik + '&noHakmilik=' + noHakmilik + '&selectedTabs=' + selectedTabs;
            frm.action = url;
            frm.submit();
        }
    ...
    function simpanEdit(x, y, f, frm)
    {
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?simpanPetakEdit&idHakmilikEdit=' + x + '&noTingkatEdit=' + noTingkatEdit + '&noPelanEdit=' + noPelanEdit + '&unitSyerEdit=' + unitSyerEdit + '&luasEdit=' + luasEdit + '&selectedTabs=' + selectedTabs
    ...
    function edit(x, f, frm)
    {
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?editPetak&idHakmilik=' + x + '&daerah=' + daerah + '&bandarPekanMukim=' + bandarPekanMukim + '&kodHakmilik=' + kodHakmilik + '&noHakmilik=' + noHakmilik + '&selectedTabs=' + selectedTabs;
        frm.action = url;
        frm.submit();
    ...
    function daftarHakmilik(f, frm)
    {
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?daftarH&daerah=' + daerah + '&bandarPekanMukim=' + bandarPekanMukim + '&kodHakmilik=' + kodHakmilik + '&noHakmilik=' + noHakmilik + '&selectedTabs=' + selectedTabs;
        frm.action = url;
        frm.submit();
    ...
    function doPopup(nopelan) {
        ...
        var url = '${pageContext.request.contextPath}/strataUtilDalaman?viewPelan&nopelan=' + nopelan;
        window.open(url, "eTanah", "status=0,toolbar=0,location=0,menubar=0,width=890,height=600,scrollbars=yes");
    }

</script>
<s:useActionBean beanclass="etanah.view.ListUtil" id="listUtil"/>
<s:form beanclass="etanah.view.stripes.common.strataUtilDalaman" name="form">
    <s:messages />
    <s:errors />
    <div id="aa">
        <div id="tab_hakmilik">
            ...
            <div id="petak_aksesori">
                ...
                <fieldset><font color="blue"><b>Petak Strata dan Petak Aksesori</b></font>
                    ...
                    <display:table style="width:90%" class="tablecloth" name="${actionBean.senaraiHakmilikStrataTemp}" cellpadding="0" cellspacing="0" id="line">
            ...
            <div id="upload_pelan">
                ...
                <c:set value="0" var="count"/>
                <br><br>
                <display:table class="tablecloth" name="${actionBean.senaraiPelanString}" pagesize="30" cellpadding="0" requestURI="/strataUtilDalaman" cellspacing="0" id="line">
