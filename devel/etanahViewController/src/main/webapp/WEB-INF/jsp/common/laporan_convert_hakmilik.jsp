<%-- 
    Document   : laporan_convert_hakmilik
                            ...
                            <td><div align="center">
                                    <p align="center">
                                        <img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                             onclick="popup('${pageContext.request.contextPath}/laporanConvertHakmilik/requestParam?namaReport=${actionBean.senaraiConvertHakmilikRN[count-1]}&report=${report}');" onmouseover="this.style.cursor='pointer';">
                                    </p>
                                </div>
                            </td>
                        </tr>
