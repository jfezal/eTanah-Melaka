...
<s:useActionBean beanclass="etanah.view.stripes.pelupusan.AgihanTugasPLPTActionBean" var="penggunaperanan"/>
<s:form beanclass="etanah.view.stripes.common.b1.AgihanTugasSediaB1ActionBean">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
