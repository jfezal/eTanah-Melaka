...
<script type="text/javascript">    
    ...
    function muatNaikForm1(folderId, dokumenId, idPermohonan) {
        ...
        var url = '${pageContext.request.contextPath}/strata/SemakKertasSiasatan?muatNaikForm1&folderId=' + folderId + '&dokumenId='
    ...
    <%--alert(url);--%>
            ...
            function addNew(v){
                window.open("${pageContext.request.contextPath}/strata/SemakKertasSiasatan?addDocForm&permohonan.idPermohonan=" + v, "eTanah",
            ...
            function kemaskiniCatatan(folderId, dokumenId){        
                var url = '${pageContext.request.contextPath}/strata/SemakKertasSiasatan?showCatatanEdit&folderId=' + folderId + '&dokumenId='
                    + dokumenId;
                window.open(url, "etanah", "status=0,toolbar=0,location=0,menubar=0,width=900,height=350");
            }

</script>
<s:form  name="form1" id="form1" beanclass="etanah.view.strata.SenaraiKertasSiasatanActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <%--<label><font size="2" color="Red">Sila Klik Tab Dokumen Untuk Memuatnaik Fail Siasatan.</font></label>--%>
            ...
            <display:table name="${actionBean.senaraiKandungan1}" class="tablecloth" id="row" style="width:100%">
                ...
                <display:column title="Kod Dokumen" property="dokumen.kodDokumen.kod"></display:column>
                <display:column title="Nama Dokumen" property="dokumen.kodDokumen.nama"></display:column>
                ...
                <display:column title="Catatan">                    
                    ...
                    <display:column title="Tarikh" property="dokumen.infoAudit.tarikhMasuk" format="{0,date,dd/MM/yyyy hh:mm:ss}"></display:column>
