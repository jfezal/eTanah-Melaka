...
<script type="text/javascript">    
        ...
        var url = '${pageContext.request.contextPath}/strata/SemakKertasSiasatanFoliB?muatNaikForm1&folderId=' + folderId + '&dokumenId='
    ...
    function addNew(v){
        window.open("${pageContext.request.contextPath}/strata/SemakKertasSiasatanFoliB?addDocForm&permohonan.idPermohonan=" + v, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=1500,height=800");
    }
    
    function kemaskiniCatatan(folderId, dokumenId){        
                var url = '${pageContext.request.contextPath}/strata/SemakKertasSiasatanFoliB?showCatatanEdit&folderId=' + folderId + '&dokumenId='
                    + dokumenId;
                window.open(url, "etanah", "status=0,toolbar=0,location=0,menubar=0,width=900,height=350");
            }
   
</script>
<s:form beanclass="etanah.view.strata.SenaraiKertasSiasatanFoliBActionBean" name="form1" id="form1">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <display:table name="${actionBean.senaraiKandungan1}" class="tablecloth" id="row" style="width:100%">
               ...
               <display:column title="No.Folio"> Folio B${row_rowNum} </display:column>
