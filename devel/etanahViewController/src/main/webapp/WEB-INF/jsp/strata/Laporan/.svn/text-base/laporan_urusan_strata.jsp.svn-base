...
<script type="text/javascript">
    $(document).ready(function() {
        $('#laporan_prestasi').hide();
        $('#laporan_terperinci').hide();
        $('#laporan_permohonan').hide();
        $('#laporan_statistik').hide();
        $('#laporan_pindahmilik').hide();
        $('#laporan_bdnUrus').hide();
    ...
    <s:form beanclass="etanah.view.laporan.LaporanMaklumatUrusanMis">
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <p style="color:red">
                    *Sila Pilih Senarai Laporan Strata<br/>
                </p>
                <br>
                <p>
                    <label>Senarai Laporan Strata :</label>
                    ...
                    <c:if test="${actionBean.kodNegeri eq 'n9'}">
                        <s:select name="senaraiLaporan"  onchange="javaScript:changelaporan(this.value)">
                            <s:option value="0">--Sila Pilih--</s:option>
                            <s:option value="1">Laporan Prestasi</s:option>
                            <s:option value="2">Laporan Terperinci Prestasi</s:option>
                            <s:option value="3">Laporan Keseluruhan Permohonan</s:option>
                            <s:option value="4">Laporan Statistik</s:option>
                            <s:option value="5">Laporan Peratusan Pindah Milik</s:option>
                            <s:option value="6">Laporan Terperinci Peratusan Pindah Milik</s:option>
                            <s:option value="7">Laporan Perbadanan Pengurusan</s:option>
                        </s:select>
                    </c:if>
                </p>
                <br>
        ...
        <br>
        <div class="subtitle" id="laporan_prestasi">
            <fieldset class="aras1">
                <legend>
                    Laporan Prestasi 
                </legend>
                ...
                <table class="tablecloth">
                    <tr style="width: 100%">
                        ...
                        <c:forEach items="${actionBean.laporanPrestasi}" var="report">
                        <tr>
                            <td>${count}
                            </td>
                            <td>${report}
                            ...
                            <td><div align="center">
                                    <p align="center">
                                        <img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                             onclick="popup('${pageContext.request.contextPath}/strata/LaporanUrusanStrata/requestParam?namaReport=${actionBean.senaraiMaklumatHakmilikRN[count-1]}&report=${report}');" onmouseover="this.style.cursor='pointer';">
                                    </p>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="subtitle" id="laporan_terperinci">
            <fieldset class="aras1">

                <legend>
                    Laporan Terperinci Prestasi
                </legend>
                <p style="color:red">
                    *Sila klik pada (<img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/pub/images/edit.gif' class='rem' id='rem_${line_rowNum}' onmouseover="this.style.cursor='pointer';"/>) untuk memaparkan laporan<br/>
                </p>
                ...
                <table class="tablecloth">
                    <tr style="width: 100%">
                        ...
                        <c:set value="1" var="count"/>
                        <c:forEach items="${actionBean.laporanPermohonan}" var="report">
                        <tr>
                            <td>${count}
                            </td>
                            <td>${report}
                            ...
                            <td><div align="center">
                                    <p align="center">
                                        <img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                             onclick="popup('${pageContext.request.contextPath}/strata/LaporanUrusanStrata/requestParam?namaReport=${actionBean.senaraiKeluasanTanahRN[count-1]}&report=${report}');" onmouseover="this.style.cursor='pointer';">
                                    </p>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="subtitle" id="laporan_permohonan">
            <fieldset class="aras1">

                <legend>
                    Laporan Keseluruhan Permohonan 
                </legend>
                <p style="color:red">
                    *Sila klik pada (<img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/pub/images/edit.gif' class='rem' id='rem_${line_rowNum}' onmouseover="this.style.cursor='pointer';"/>) untuk memaparkan laporan<br/>
                </p>
        ...
        <div class="subtitle" id="laporan_statistik">
            <fieldset class="aras1">
        ...
        <div class="subtitle" id="laporan_pindahmilik">
            <fieldset class="aras1">

                <legend>
                    Laporan Peratusan Pindah Milik
                </legend>
                <p style="color:red">
                    *Sila klik pada (<img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/pub/images/edit.gif' class='rem' id='rem_${line_rowNum}' onmouseover="this.style.cursor='pointer';"/>) untuk memaparkan laporan<br/>
                </p>
        ...
        <div class="subtitle" id="laporan_bdnUrus">
            <fieldset class="aras1">

                <legend>
                    Laporan Perbadanan Pengurusan
                </legend>
                <p style="color:red">
                    *Sila klik pada (<img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/pub/images/edit.gif' class='rem' id='rem_${line_rowNum}' onmouseover="this.style.cursor='pointer';"/>) untuk memaparkan laporan<br/>
                </p>
