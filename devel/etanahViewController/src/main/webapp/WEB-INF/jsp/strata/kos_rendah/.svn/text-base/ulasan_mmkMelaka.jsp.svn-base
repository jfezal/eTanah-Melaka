        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                    ...
                    <tr><td width="100%" id="tdDisplay">Kertas ini bertujuan untuk pertimbangan oleh Majlis Mesyuarat Kerajaan, Negeri Melaka bagi permohonan daripada ${actionBean.pemohon.pihak.nama}, No. Kad Pengenalan ${actionBean.pemohon.pihak.noPengenalan} yang beralamat ${actionBean.pemohon.pihak.alamat1}
                    ...
                    <tr><td><b>6. SYOR PENGARAH TANAH DAN GALIAN NEGERI MELAKA</b></td></tr>
                    <c:if test="${edit}">
                    ...
                    <tr>
                        <%--<td width="100%" id="tdDisplay">7.1 Dibentangkan untuk pertimbangan dan keputusan Majlis Mesyuarat Kerajaan Negeri Sembilan Darul Khusus.</td>--%>
                    <td id="tdDisplay">7.1 Dibentangkan untuk pertimbangan dan keputusan Majlis Mesyuarat Kerajaan Negeri Melaka.</td>
