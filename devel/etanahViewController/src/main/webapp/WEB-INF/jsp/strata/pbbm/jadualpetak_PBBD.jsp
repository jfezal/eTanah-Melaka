<%--
    Document   : jadualpetak_PBBD
    Created on : July 03, 2013, 10:42:01 AM
    Author     : Murali
--%>
...
<script type="text/javascript">
    ...
    function popup(b,p,idT){
        ...
        window.open("${pageContext.request.contextPath}/strata/pbbd?showForm2&namaBangunan="+b+"&tingkat="+p+"&idTingkat="+idT, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=800,height=250");
    }

    function popupPetakAksesori(b,t,p){

        window.open("${pageContext.request.contextPath}/strata/pbbd?showForm3&idBangunan="+b+"&idTingkat="+t+"&idPetak="+p, "eTanah",
    ...
    function removePtkAksr(val){
        ...
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/strata/pbbd?deletePtkAksr&idAksesori='+val;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
    ...
    function selectedBangunan(idBangunanVal){
        ...
        var url = '${pageContext.request.contextPath}/strata/pbbd?selectedBangunan&idBangunan='+idBangunanVal;
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function selectedTingkat(idBangunanVal,idTingkatVal){
        ...
        var url = '${pageContext.request.contextPath}/strata/pbbd?selectedTingkat&idBangunan='+idBangunanVal+'&idTingkat='+idTingkatVal;
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function selectedPetak(idBangunanVal,idTingkatVal,idPetakVal){       
        ...
        var url = '${pageContext.request.contextPath}/strata/pbbd?selectedPitak&idBangunan='+idBangunanVal+'&idTingkat='+idTingkatVal+"&idPetak="+idPetakVal;
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
...
<table><tr><td>
            <s:form beanclass="etanah.view.strata.MBangunanActionBeanPBBD">
                <s:messages/>
                <s:errors/>
                <c:if test="${manual}">
