...
<s:form beanclass="etanah.view.strata.MaklumatTanahPHPPActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PHPP'}">
            ...
            <c:if test="${actionBean.permohonan.permohonanSebelum.kodUrusan.kod eq 'PHPC'}">
                <p>
                    ...
                    <c:if test="${actionBean.hakmilik.noLot ne null}"> ${actionBean.nLot}&nbsp; </c:if>
            ...
            <c:if test="${actionBean.permohonan.permohonanSebelum.kodUrusan.kod ne 'PHPC' && actionBean.permohonan.kodUrusan.kod ne 'PHPP'}">
