...
<script type="text/javascript">
    ...
    function popup(b,p,idT){
        ...
        window.open("${pageContext.request.contextPath}/strata/urusan_pbs?showForm2&namaBangunan="+b+"&tingkat="+p+"&idTingkat="+idT, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=800,height=250");
    }

    function popupPetakAksesori(b,t,p){

        window.open("${pageContext.request.contextPath}/strata/urusan_pbs?showForm3&idBangunan="+b+"&idTingkat="+t+"&idPetak="+p, "eTanah",
    ...
    function removePtkAksr(val){
        ...
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/strata/urusan_pbs?deletePtkAksr&idAksesori='+val;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
    ...
    function selectedBangunan(idBangunanVal){
        ...
        var url = '${pageContext.request.contextPath}/strata/urusan_pbs?selectedBangunan&idBangunan='+idBangunanVal;
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function selectedTingkat(idBangunanVal,idTingkatVal){
        ...
        var url = '${pageContext.request.contextPath}/strata/urusan_pbs?selectedTingkat&idBangunan='+idBangunanVal+'&idTingkat='+idTingkatVal;
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function selectedPetak(idBangunanVal,idTingkatVal,idPetakVal){
        ...
        var url = '${pageContext.request.contextPath}/strata/urusan_pbs?selectedPitak&idBangunan='+idBangunanVal+'&idTingkat='+idTingkatVal+"&idPetak="+idPetakVal;
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
...
<table><tr><td>
            <s:form beanclass="etanah.view.strata.MaintainBangunanActionBeanPBS">
                <s:messages/>
                <s:errors/>  
                        ...
                        <c:if test="${fn:length(actionBean.pBangunanProvisionalBlock) > 0}">
                            <div class="subtitle">
                                <fieldset class="aras1">
                                    ...
                                    <table class="tablecloth" width="100%">
                                        <tr>
                                            <th>Bangunan Semantara</th>
                                            <th>Jumlah Unit Syer Sementara</th>
                                            <th>Jenis Kegunaan</th>
                                        </tr>
                                        <c:set var="items" value="0"/>
                                        <c:set var="items2" value="0"/>
                                        ...
                                        <c:forEach items="${actionBean.pBangunanProvisionalBlock}" var="bgn" varStatus="statusB">
                                            <tr>
                                                <td>${bgn.nama}</td>
                                                <td><s:text name="petaksyer" size="12" readonly="readonly" value="${bgn.syerBlok}"/></td>
                                                <td>
                                                    <c:set var="rowNo" value="${items}" />
                                                    <c:set var="petakKegunaanVal" value="" />
                                                    <c:if test="${actionBean.petakKegunaan[rowNo] eq '01'}">
