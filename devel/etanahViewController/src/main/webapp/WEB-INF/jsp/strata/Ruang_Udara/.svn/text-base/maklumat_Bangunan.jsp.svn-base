...
<script type="text/javascript">
    ...
    function resetForm(){
        var url = "${pageContext.request.contextPath}/strata/maklumat_bangunan?refresh";
        $.post(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function refresh(){
        var url = '${pageContext.request.contextPath}/strata/maklumat_bangunan';
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="left">
                <table class="tablecloth">
                    <tr>
                        <th>&nbsp;</th><th>Nombor Lot/PT</th><th>Kegunaan</th>
                    </tr>
                    <tr>
                        <th>
                            Utara
                        ...
                        <td>
                            <s:textarea name="sempadanUtaraNoLot" id="sempadanUtaraNoLot" class="normal_text" cols="60" rows="3"/>
                        </td>
                        <td>
                            <s:textarea name="sempadanUtaraKegunaan" id="sempadanUtaraKegunaan" class="normal_text" cols="60" rows="3"/>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <s:textarea name="sempadanSelatanNoLot" id="sempadanSelatanNoLot" class="normal_text" cols="60" rows="3"/>
                        </td>
                        <td>
                            <s:textarea name="sempadanSelatanKegunaan" id="sempadanSelatanKegunaan" class="normal_text" cols="60" rows="3"/>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <s:textarea name="sempadanTimurNoLot" id="sempadanTimurNoLot" class="normal_text" cols="60" rows="3"/>
                        </td>
                        <td>
                            <s:textarea name="sempadanTimurKegunaan" id="sempadanTimurKegunaan" class="normal_text" cols="60" rows="3"/>
                        </td>
                    </tr><tr>
                        <th>
                            Barat
                        ...
                        <td>
                            <s:textarea name="sempadanBaratNoLot" id="sempadanBaratNoLot" class="normal_text" cols="60" rows="3"/>
                        </td>
                        <td>
                            <s:textarea name="sempadanBaratKegunaan" id="sempadanBaratKegunaan" class="normal_text" cols="60" rows="3"/>
                        </td>
                    </tr>
                </table>
            </div>
