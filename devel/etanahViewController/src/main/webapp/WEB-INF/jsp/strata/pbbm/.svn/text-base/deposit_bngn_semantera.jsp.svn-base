<%-- 
    Document   : deposit_bngn_semantera
    Created on : Nov 18, 2013, 2:11:49 PM
    Author     : Murali
--%>
...
<script type="text/javascript">
    ...
    function resetForm(){
        var url = "${pageContext.request.contextPath}/strata/mlk/depositBngnSemantera?resetForm";
        $.post(url,
        function(data){
            $('#page_div').html(data);
        },'html');
...
<s:useActionBean beanclass="etanah.view.ListUtil" id="listUtil" />
<s:form beanclass="etanah.view.strata.DepositBngnSemanteraActionBean" name="form" id="form">
    <s:errors/>
    <s:messages/>
