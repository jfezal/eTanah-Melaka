...
<s:form id="form1" beanclass="etanah.view.strata.KertasPertimbanganActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test="${actionBean.kodNegeri ne '05'}">
                ...
                <c:if test="${actionBean.mohonbngn.permohonan.kodUrusan.kod eq 'PBBS' || actionBean.mohonbngn.permohonan.kodUrusan.kod eq 'PHPP' || actionBean.mohonbngn.permohonan.kodUrusan.kod eq 'PHPC'}">
                    <p>
                    ...
                    <p>
                        ...
                        ${actionBean.mohonbngn.bilanganPetak} Petak &nbsp;
                    </p>
                </c:if>

                <c:if test="${actionBean.mohonbngn.permohonan.kodUrusan.kod eq 'PBS' || actionBean.mohonbngn.permohonan.kodUrusan.kod eq 'PBBSS'}">
                    <p>
                        <label>Nama Bangunan : </label>
                        ${actionBean.mohonbngn.nama} Blok Bangunan Sementara yang mengandungi ${actionBean.mohonbngn.bilanganPetak} Petak di ${actionBean.hp.hakmilik.bandarPekanMukim.nama}, ${actionBean.hp.hakmilik.daerah.nama} &nbsp;
                    </p>
                    <br>
                    <p>
                        <label>Bilangan Petak : </label>
                ...
                <c:if test="${actionBean.mohonbngn.permohonan.kodUrusan.kod eq 'PBBD' || actionBean.mohonbngn.permohonan.kodUrusan.kod eq 'PBTS'}">
                    <p>
                        <label>Nama Bangunan : </label>
                        ${actionBean.mohonbngn.nama} Blok Bangunan yang mengandungi ${actionBean.mohonbngn.bilanganPetak} Petak
                        dan ${actionBean.lpps} Petak Tanah di ${actionBean.hp.hakmilik.bandarPekanMukim.nama}, ${actionBean.hp.hakmilik.daerah.nama} &nbsp;
                    </p>
                    <br>
                    <p>
                        <label>Bilangan Petak : </label>
                        ${actionBean.mohonbngn.bilanganPetak} Petak dan ${actionBean.lpps} Petak Tanah &nbsp;
                    </p>             
                </c:if>

                <c:if test="${actionBean.mohonbngn eq null}">
                    <p>
                        <label>Nama Bangunan : </label>
                        0 Blok Bangunan yang mengandungi 8 Petak
                        dan ${actionBean.lpps} Petak Tanah di ${actionBean.hp.hakmilik.bandarPekanMukim.nama}, ${actionBean.hp.hakmilik.daerah.nama} &nbsp;
                    </p>
                    <br>
                    <p>
                        <label>Bilangan Petak : </label>
                        8 Petak dan ${actionBean.lpps} Petak Tanah &nbsp;
                    </p>
                </c:if>  

            </c:if>

            <!-- ida update on 13/09/2013 /-->
            <c:if test="${actionBean.kodNegeri eq '05'}">
            ...
            <table>
                ...
                <fmt:formatDate value="${actionBean.tarikhMasuk}" pattern="dd MMMM yyyy" />  &nbsp;               
            </p>
