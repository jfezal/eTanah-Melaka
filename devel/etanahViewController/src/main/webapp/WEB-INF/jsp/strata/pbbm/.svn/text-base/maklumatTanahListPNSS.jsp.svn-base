<%--
    Document   : maklumatTanahListPNSS
        ...
        <fieldset class="aras1">
            ...
            <div class="subtitle">
                <fieldset class="aras1">
                    ...
                    <c:if test="${actionBean.hakmilik.idHakmilikInduk eq null}">
                        <p>
                    ...
                    <c:if test="${actionBean.hakmilik.idHakmilikInduk ne null}">
                        <p>
                        ...
                        <p>
                            <label>Cukai Petak :</label>
                            RM <c:if test="${actionBean.hakmilik.cukai ne null}">${actionBean.hakmilik.cukai}</c:if>
            ...
            <br> <br />
            <div align="center">
                <display:table class="tablecloth" name="${actionBean.listHP}" cellpadding="0" cellspacing="0" id="line"
