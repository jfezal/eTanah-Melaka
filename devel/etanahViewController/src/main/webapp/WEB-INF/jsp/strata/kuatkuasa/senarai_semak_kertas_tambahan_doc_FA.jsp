...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = '${pageContext.request.contextPath}/strata/SemakKertasSiasatanFoliA?showRefresh';
        $.ajax({
            type:"GET",
            url : url,
...
<s:useActionBean beanclass="etanah.view.strata.SenaraiKertasSiasatanFoliAActionBean" var="list"/>
<img id="displayBox" src="${pageContext.request.contextPath}/pub/images/logo.gif" width="50" height="50" style="display: none"/>
<s:form beanclass="etanah.view.strata.SenaraiKertasSiasatanFoliAActionBean" >
            ...
            <display:table name="${actionBean.kandunganFolderTamb}" id="row1"  class="tablecloth"  >
                <display:column title="Pilih" >
                    <s:select name="kandunganFolderTamb[${row1_rowNum - 1}].dokumen.kodDokumen.kod"
                        ...
                        <s:options-collection collection="${list.kodDokumenRequiredFiloA}"
