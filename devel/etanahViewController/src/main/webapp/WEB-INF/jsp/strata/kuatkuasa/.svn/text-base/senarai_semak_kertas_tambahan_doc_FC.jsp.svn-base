...
<s:useActionBean beanclass="etanah.view.strata.SenaraiKertasSiasatanFoliCActionBean" var="list"/>
            ...
            <display:table name="${actionBean.kandunganFolderTamb}" id="row1"  class="tablecloth"  >
                <display:column title="Pilih" >
                    <s:select name="kandunganFolderTamb[${row1_rowNum - 1}].dokumen.kodDokumen.kod"
                        ...
                        <s:options-collection collection="${list.kodDokumenRequiredFiloC}"
