...
<script type="text/javascript">
    ...
    function save(event, f) {
        ...
        var bil_petak = document.getElementById("bilPtk").value;
        var bil_tingkat = document.getElementById("bilTingkat").value;

        if ((blok == ""))
        {
            alert('Sila masukkan blok');
            document.form1.blok.focus();
            return false;
        }
        if ((bil_petak == ""))
        {
            alert('Sila masukkan bilangan petak');
            document.form1.bilPtk.focus();
            return false;
        }
        if ((bil_tingkat == ""))
        {
            alert('Sila masukkan bilangan tingkat');
            document.form1.bilTingkat.focus();
            return false;
        } else {
    ...
    <s:form  name="form1" beanclass="etanah.view.strata.BangunanKosRendahActionBean">
        ...
        <fieldset class="aras1">
            ...
            <p>
                ...
                <s:text name="blok" size="30" id="blok" onkeyup="validateNumber(this,this.value);"/>
            </p>
            <p>
                <label><em>*</em>Bilangan Tingkat :</label>
                <s:text name="bilTingkat"  size="30" id="bilTingkat" onkeyup="validateNumber(this,this.value);"/>
            </p>
            <p>
                <label><em>*</em>Bilangan Petak :</label>
                <s:text name="bilPtk" size="30" id="bilPtk"  onkeyup="validateNumber(this,this.value);"/>
            </p>
            <p>
                <label>Bilangan Bilik (Setiap Petak) :</label>
                <s:text name="bilBilik" size="30" id="bilBilik" onkeyup="validateNumber(this,this.value);"/>
            </p>
            <p>
            ...
            <br>
            <label>&nbsp;</label>
            <s:button name="simpanBngnKosRendah" id="simpan" value="Simpan" class="btn" onclick="save(this.name,this.form)"/>
