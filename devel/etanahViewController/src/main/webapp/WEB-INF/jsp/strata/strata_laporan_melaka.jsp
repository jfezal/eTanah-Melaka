_<%-- 
    Document   : strata_laporan_melaka
    Created on : Aug 15, 2013, 12:20:32 PM
    Author     : norazila
--%>
                            ...
                            <td><div align="center">
                                    <p align="center">
                                        <img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                             onclick="popup('${pageContext.request.contextPath}/laporanStrata_MLK/requestParam?namaReport=${actionBean.senaraiReportName[count-1]}');" onmouseover="this.style.cursor='pointer';">
                                    </p>
                                </div>
                            </td>                             
                        </tr>
