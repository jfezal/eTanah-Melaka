<%--
    Document   : muat_naik
    Created on : May 10, 2011, 8:19:28 AM
    Author     : zadhirul
--%>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = '${pageContext.request.contextPath}/strata/maklumat_bangunan?showRefresh';
        $.ajax({
            type:"GET",
            url : url,
            success : function(data) {
...
<s:form beanclass="etanah.view.strata.MaklumatBangunanActionBean">
