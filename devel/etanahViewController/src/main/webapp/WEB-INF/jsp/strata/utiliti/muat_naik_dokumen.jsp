<%-- 
    Document   : muat_naik_strata
    Created on : Oct 02, 2013, 8:19:28 AM
    Author     : dy
--%>
...
<s:form beanclass="etanah.view.stripes.MuatnaikActionBean">
    ...
    <fieldset class="aras1">
        ...
        <p>
         ...
         <%--   <s:button name="close" value="Tutup" onclick="self.close();" class="btn"/>--%>
               <s:button name="close" value="Tutup" onclick="refreshpage('${idPermohonan}')" class="btn"/>
        </p>
    </fieldset>
</s:form>
