...
<script type="text/javascript">
    ...
    function janaGeran(f) {
        ...
        var url = '${pageContext.request.contextPath}/strata/janaGeran?janaGeran&param=' + param;
        $.get(url,
                function(data) {
                    $('#page_div').html(data);
                    doUnBlockUI();
...
<s:form beanclass="etanah.view.strata.JanaGeranBerperingkatActionBean">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <span style="font-weight:normal;color: black" class=instr>
                <p></p>
                Sila pilih hakmilik yang ingin dijana. Sila masukkan Jumlah Bil. Pilihan dan Pilihan No. dari dan klik 'Tanda Pilihan' untuk menanda secara auto.
                <p></p>
                Klik Butang 'Jana Geran' bagi jana geran secara berperingkat. 
                <em>Sila Pastikan pengguna telah menjana borang 2K 3K terlebih dahulu pada butang 'JANA DOKUMEN' di sebelah butang 'SELESAI'.</em>
            </span>
            <p></p>
            <br />
             <p align="left">   
            ...
            <div class="content" align="center">                
                <display:table class="tablecloth" name="${actionBean.senaraiHakmilikTerlibat}" requestURI="/strata/janaGeran" cellpadding="0" cellspacing="0" id="line">
