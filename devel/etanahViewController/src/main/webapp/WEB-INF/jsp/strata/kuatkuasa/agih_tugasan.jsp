<%-- 
    ...
    Created on : Jul 6, 2011, 3:24:02 PM
    Author     : Akmal
--%>
...
<s:useActionBean beanclass="etanah.view.strata.AgihTugasanKuatkuasaActionBean" var="penggunaperanan"/>
<s:form beanclass="etanah.view.strata.AgihTugasanKuatkuasaActionBean">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
