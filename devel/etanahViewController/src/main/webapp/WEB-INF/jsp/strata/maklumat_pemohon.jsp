    ...
    <c:if test="${!readOnly}">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <br>
                <%--<c:if test="${!actionBean.penyerahAdalahPemohon}">--%>
                <c:if test="${actionBean.kodNegeri eq '05' || actionBean.kodNegeri eq '04'}">
                ...
                <c:if test="${actionBean.kodNegeri eq '03'}">
                ...
                <p>
                    ...
                    <s:button class="btn" value="Hapus" name="new" id="new" onclick="resetForm()"/>&nbsp;
