   ...
   <s:messages/>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
         <legend><font size="2" color="Red">Sila masukan keputusan sebelum jana.</font></legend>
         <p align="left">
             <s:button name="janaRBHS" value="Jana" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')" /><br>
