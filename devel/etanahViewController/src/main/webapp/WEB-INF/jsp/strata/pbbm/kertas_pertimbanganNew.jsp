...
<script type="text/javascript">
    ...
    <%-- var j = document.getElementById('count1').value;
     if(j == 1 && idKandungan != ''){
        ...
        if (idKandungan == '') {
            ...
            var url = '${pageContext.request.contextPath}/strata/kertasNew?deleteSingleSemakKertasptg&idKandungan=' + idKandungan;
            $.get(url,
                    function (data) {
                        $('#page_div').html(data);
                    }, 'html');
    ...
    <%--alert("index:"+index);--%>
        ...
        if (idKandungan == '') {
            ...
            var url = '${pageContext.request.contextPath}/strata/kertasNew?deleteSingle&idKandungan=' + idKandungan;
            $.get(url,
                    function (data) {
                        $('#page_div').html(data);
                    }, 'html');
...
<s:form beanclass="etanah.view.strata.KertasPertimbanganActionBeanNew">
    <div id="abc">
        <s:messages/>
        <s:errors/>
                ...
                <table border="0" width="80%" id="sa">
                    ...
                    <tr><td>
                            ...
                            <table border="0" width="100%" id="sa">
                                ...
                                <tr><td id="tdLabel">Luas Tanah :</td>
                                    ...
                                    <tr><td id="tdLabel">Tempoh Pajakan :</td>
                                        <td id="tdDisplay">  <c:if test="${actionBean.hakmilik.tempohPegangan ne null}">  ${actionBean.hakmilik.tempohPegangan}&nbsp; Tahun</c:if>
                            ...
                            <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'SUBMC'}">
                                ...
                                <table>
                                    <tr>
                                        <td id="tdLabel">Tanggungan :</td>
                                        <td><s:textarea name="tanggung" id="tanggung"  rows="5" cols="50" class="normal_text" value="${actionBean.tanggung}"></s:textarea></td>
                                        </tr>
                                    </table>
                    ...
                    <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'SFUS' && actionBean.permohonan.kodUrusan.kod ne 'PFUS'}">
                        ...
                        <c:if test="${actionBean.stageId ne 'sediakertasptg'}">                      
                            <c:if test="${actionBean.stageId eq 'semak_kemasukan' || actionBean.stageId eq 'keputusan' || actionBean.stageId eq 'semak_kertas_pertimbangan'}">   
                                <tr><td>&nbsp;</td></tr>
                                ...
                                <tr><td>&nbsp;</td></tr>
                                <tr><td><b>5. SYOR DAN PERAKUAN TIMBALAN PENGARAH TANAH DAN GALIAN (PENDAFTARAN) </b></td></tr>
                                <c:if test="${edit5}">
                                    <tr><td>
