...
<script type="text/javascript">
    function janas(idSkimStrata) {
        ...
        var url = "${pageContext.request.contextPath}/strata/tunggakan_cukai_petak?janaCukai&idSkimStrata=" + idSkimStrata;
        $.post(url,
                function(data) {
                     if(data != ''){
...
<s:form id="senarai_tugasan" beanclass="etanah.view.strata.cukaipetak.KemaskiniTunggakanActionBean" name="form2">
    <s:hidden name="btn"/>
    <s:errors/>
    <s:messages/>  
        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center" id="listhakmilik">
                ...
                <display:table class="tablecloth" name="${actionBean.senaraiSkim}"
                               ...
                               requestURI="${pageContext.request.contextPath}/strata/tunggakan_cukai_petak"
...
<display:column title="Jumlah Unit Syer" >
                        ${line.jumlahUnitSyer}
                    </display:column>
