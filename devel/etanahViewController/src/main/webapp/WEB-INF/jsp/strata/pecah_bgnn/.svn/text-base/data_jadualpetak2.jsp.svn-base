...
<div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                ...
                <s:text name="" ></s:text>  </display:column>
                ...
                <display:column property="kegunaan_petak" title="Kegunaan Petak">
                    <s:select name="" ></s:select> </display:column>
...
<br>
        ...
        <fieldset class="aras1">
            <br>
              <p>
                  <label>Masukkan Jumlah Asal Syer Bangunan :</label><s:text name="jumlah_syer" ></s:text>
            ...
            <br>
            <label>&nbsp;</label>
              <a href="urusan?showForm16"<s:submit name="Terus" value="Terus" class="btn"/></a>
