<%--
    Document   : pecahPetakHakmilik
    Created on : Dec 23, 2010, 12:09:48 PM
    Author     : NageswaraRao
--%>
...
<script type="text/javascript">
    ...
    function addRow(){
       ...
       // alert(count);
        ...
        for(var i=1;i<=count;i++){        
            ...
            //e1.setAttribute("value",rowcount);
            ...
            e2.onkeyup = function (){javascript:validate("2");};
            ...
            e3.onkeyup = function (){javascript:validate("3");};
            ...
            e5.setAttribute("name","petakBaru"+i+"5");
            e5.setAttribute("id","petakBaru"+i+"5");
    ...
    function validate(j){
        ...
        var count=document.getElementById('bilanganPetakBaru').value;
        for(var i=1;i<=count;i++){
            var elmnt = document.getElementById("petakBaru"+i+""+j);
            if (isNaN(elmnt.value)) {
                elmnt.value = removeNonNumeric(elmnt.value);
                return;
            }
        }
    }
...
<s:form  name="form1" beanclass="etanah.view.strata.PecahPetakHakmilikActionBean">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                <label>No Hakmilik : </label><s:text size="35" name="noHakmilik" id="noHakmilik" readonly="readonly" onkeyup="validateNumber(this,this.value);" value="${actionBean.hp.hakmilik.idHakmilik}" />
            </p>
            <p>
                <label>Luas Petak(meter persegi) : </label><s:text name="luas" id="luas" readonly="readonly" onkeyup="validateNumber(this,this.value);" value="${actionBean.hp.hakmilik.luas}" />
            </p>
            <p>
                <label>Unit Syer : </label><s:text name="unitSyer" id="unitSyer"  readonly="readonly" onkeyup="validateNumber(this,this.value);"  value="${actionBean.hp.hakmilik.unitSyer}" />
            </p>
        </fieldset><br/>

        <fieldset class="aras1">
            <legend>Maklumat Pecah Bahagi Petak</legend>
            <p>
                <label>Bilangan Petak Baru : </label><s:text name="bilanganPetakBaru" id="bilanganPetakBaru" onkeyup="validateNumber1(this,this.value);"/>
            </p>
            
             <table  width="80%" id="tbl" class="tablecloth" border="1">
                 <tr>
                     <th  width="15%" align="center"><b>Petak Baru</b></th>
                     <th  width="15%" align="center"><b>Luas Petak(meter persegi)</b></th>
                     <th  width="15%" align="center"><b>Unit Syer</b></th>
                     <th  width="27%" align="center"><b>Petak Aksesori</b></th>
                     <th  width="28%" align="center"><b>Petak Aksesori Bersangkutan</b></th>
                 </tr>
