...
<script type="text/javascript">
    function addNew(v){
        ...
        window.open("${pageContext.request.contextPath}/utility/strata/dokumen?dokumenTambahanForm&permohonan.idPermohonan=" + v, "eTanah",
    ...
    function keputusanMahkamah(v){
        window.open("${pageContext.request.contextPath}/utility/strata/dokumen?showFormA&permohonan.idPermohonan=" + v, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
    }
    ...
    function muatNaikForm(folderId, dokumenId, idPermohonan) {
        ...
        var url = '${pageContext.request.contextPath}/utility/strata/dokumen?uploadForm&folderId=' + folderId + '&dokumenId='
