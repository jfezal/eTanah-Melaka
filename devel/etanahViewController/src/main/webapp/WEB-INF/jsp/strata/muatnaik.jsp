...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = '${pageContext.request.contextPath}/strata/permohonanStrata?reload2&idPermohonan=${idPermohonan}';
        $.ajax({
            type:"GET",
            url : url,
            success : function(data) {
...
<s:form beanclass="etanah.view.strata.PermohonanStrataActionBean">
    ...
    <fieldset class="aras1">
        ...
        <p>
            <label>&nbsp;</label>&nbsp;
            <s:submit name="muatNaik" value="Simpan" class="btn" onclick="test();"/>
