...
<script type="text/javascript">
    ...
    function editPemohon(val){
        window.open("${pageContext.request.contextPath}/strata/rtpsmaklumat_Pemohon?editpemohonPopup&idPihak="+val, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=800,height=300");
    }

</script>
<s:form beanclass="etanah.view.strata.RTPSMaklumatPemohonActionBean">
   <s:messages/>
    <s:errors/>
    ...
    <c:if test="${edit1}">
      <div class="subtitle">
        <fieldset class="aras1">
           <legend>Sila masukkan maklumat permohonan terdahulu </legend>&nbsp;
            <p>
            ...
            <label>atau</label><br>
            <p>
                <label>No Rujukan Fail/Id Hakmilik Strata :</label>
                <s:text name="idHakmilikStrata" id="idHakmilikStrata" size="40" />
            </p>
            <label>atau</label><br>
            <p>
                <label>No Buku/Daftar Strata :</label>
                <s:text name="a" id="a" size="40" />
            </p>
        </fieldset>&nbsp;
    </div>
            <p>
