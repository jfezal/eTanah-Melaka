<%--
    Document   :  syorPRIZ(Editable).jsp
...
<script type="text/javascript">
    ...
    function showpriztidaksokong(val) {
        $('#priztidaksokong').show();
        $('#prizsokong').hide();
        if (val == 'SL') {
            val = 'ST';
    ...
    {
        NoPrompt();
        var url = '${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?tambahRow&index=' + index;
        window.open(url, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="sokong" id="ksn" value="SL" onclick="showprizsokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="sokong" id="ksn" value="ST" onclick="showpriztidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                        ...
                        <br/>
                        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBPTD' || actionBean.permohonan.kodUrusan.kod eq 'MMMCL'}">
                            <div id="prizsokong">
                                <table class="tablecloth" align="center">
                                    <tr>
                                        <td><font color="red" size="4">*</font>Luas Disyorkan:</td>
                                        <td>
                                            <s:text name="hakmilikPermohonan.luasTerlibat" size="15"/>
                    ...
                    <%--      <c:when test="${actionBean.kodNegeri eq '05'}">
                              <table class="tablecloth" align="center">
                                  <tr>
                                      ...
                                      <td>
                                          <s:radio name="ksn" id="ksn" value="SL" onclick="showprizsokong(this.value);" />&nbsp;Sokong
                                          <s:radio name="ksn" id="ksn" value="ST" onclick="showpriztidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                                          <s:hidden name="syorKpsn" id="syorKpsn"/>
                                      </td>
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <tr>
                        <td style="text-align:center;" colspan="3">
                            <c:choose>
                                <c:when test="${actionBean.permohonan.kodUrusan.kod ne 'PRIZ' and actionBean.permohonan.kodUrusan.kod ne 'BMRE' and actionBean.permohonan.kodUrusan.kod ne 'WMRE' and actionBean.permohonan.kodUrusan.kod ne 'MMRE' and actionBean.permohonan.kodUrusan.kod ne 'LPJH'}">
                                    <s:hidden id="${actionBean.idMohonHakmilik}" name="idMohonHakmilik"/>
                                    <s:hidden id="${actionBean.idLaporTanah}" name="idLaporTanah"/>
                                ...
                                <c:otherwise>
                                    ...
                                    <s:submit name="simpanKandungan" value="Simpan2" class="btn" onclick="setKpsn();"/>
                                    <s:hidden name="index" id="index" value="5"/>
                                    <%--<s:button name="simpanSyor" value="Simpan" class="btn" onclick="menyimpan('5',${i-1},this.form)"/>--%>
                                    <s:button name="tutup" value="Tutup" class="btn" onclick="refreshpage()"/>
                                </c:otherwise>
