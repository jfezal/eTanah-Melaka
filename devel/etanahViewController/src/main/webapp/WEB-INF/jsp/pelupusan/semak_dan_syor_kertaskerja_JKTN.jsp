<%-- 
    Document   : semak_dan_syor_kertaskerja_JKTN
    Created on : Jan 13, 2010, 10:21:54 AM
...
<s:form beanclass="etanah.view.pelupusan.PelupusanActionBean">
    <p>SEMAK DAN SYOR KERTAS KERJA JKTN</p>
    <div class="subtitle">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                Tindakan Timbalan Pengarah Tanah Galian
            </legend>
            <p>
                <label for="ID Berkaitan"> Tindakan : </label>
                <s:radio name="option" value="KK"/>Kemaskini
                <s:radio name="option" value="SS"/>Semak Semula
                <s:radio name="option" value="TP"/>Tiada Pindaan
            </p>
            <p>&nbsp;</p>
        </fieldset>
    </div>
    <p>
        ...
        <s:reset name="" value="Papar Kertas Kerja" class="btn"/>
