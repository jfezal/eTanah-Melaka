<%--
    Document   :  syorPTBTC(Editable).jsp
...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        function showptbtctidaksokong(val) {
            $('#ptbtctidaksokong').show();
            $('#ptbtcsokong').hide();
            if(val == 'SL'){
                val = 'ST';
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showptbtcsokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showptbtctidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
