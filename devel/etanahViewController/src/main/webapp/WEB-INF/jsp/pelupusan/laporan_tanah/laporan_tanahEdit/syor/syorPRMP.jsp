...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.ksn ne null}">
        ...
        function changeKadar (value) {

            if(value != ""){
                $.get('${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?changeRoyalti&value='+value,
                function(data){
                    $('#result').empty();
                    $('#result').val(data);
                }, 'html');
                        ...
                        <div id="prmpsokong">
                            <table class="tablecloth" align="center">
                                <tr>
                                    ...
                                    <td>
                                        <s:select name="keg" style="width:300px" id="kadarBayarPRMP" value="${actionBean.pmi.kodItemPermit.kod}" onchange="javascript:changeKadar(this.value);">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%--<div id="royaltiTanahKerajaan"></div>--%>
                                        <s:text name="result" id="result" readonly="true" size="5"/>&nbsp; se ${actionBean.pmi.kodItemPermit.royaltiTanahKerajaanUom.nama}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%--onkeyup="calculateBayaranPRMP()"--%>
                                        <%--onchange="calculateBayaranPRMP()"--%>
                                        <s:text name="hakmilikPermohonan.luasDiluluskan" id="luasLulus" formatPattern="#,###,##0.0000" size="20" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <s:text name="amnt" size="20" formatPattern="###,###,###,##0.00" onkeyup="validateNumber(this,this.value);" id="amnt" readonly="true"/> Setahun
                                    </td>
                                </tr>
                                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PTPBP'}">
                                    <tr>
                                        ...
                                        <td>
                                            ${actionBean.pmi.kodItemPermit.nama}&nbsp
                                        </td>
                                    </tr>
                                    <tr>
