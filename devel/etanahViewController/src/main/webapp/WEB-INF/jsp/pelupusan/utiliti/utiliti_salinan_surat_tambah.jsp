<%-- 
    Document   : utiliti_salinan_surat_tambah
    Created on : Dec 12, 2013, 3:19:53 PM
    Author     : afham
--%>
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.utility.UtilitiSalinanActionBean" name="form">
        <s:errors/>
        <s:messages/>
                        ...
                        <table class="tablecloth" border="0">
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <s:submit name="simpanSalinan" value="Simpan" class="btn" onclick="NoPrompt();"/>
