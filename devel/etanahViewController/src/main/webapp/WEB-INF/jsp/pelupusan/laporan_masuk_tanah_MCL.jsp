<%-- 
    Document   : laporan_masuk_tanah_MCL
...
<script type="text/javascript">
     function getHakmilikDetails(val){
        ...
        doBlockUI();
        var edit = $('#edit').val() ;
        var url = '${pageContext.request.contextPath}/pelupusan/laporanMasuk_MCL?searchHakmilik&idHakmilik='+val+'&edit='+edit;
        $.ajax({
            type:"GET",
            url : url,
            dataType : 'html',
...
<s:form beanclass="etanah.view.stripes.pelupusan.LaporanMasukTanahMCL_ActionBean">
    <s:messages/>
    <div class="subtitle">
