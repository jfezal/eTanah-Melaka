<%--
    Document   :  syorPJLB(Editable).jsp
    Created on :  March 20, 2012, 10:50:13 AM
    Author     :  Shazwan
--%>
...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        {   
            ...
            var url = '${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?tambahRow&index='+index+'&kodSN='+kodSN+'&kodSK='+kodSK;
            window.open(url, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        function cariPopup(val){
            ...
            alert('kodNyata : ' + kodNyata);
            var syaratNyata = $('#syaratNyata').val();
            var kodSekat = $('#kodSktn').val();
            //            alert(kodSekat);
            var syaratSekat = $('#syaratNyata1').val();
            window.open("${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?searchSyarat&jenisSyarat="+val+"&kodNyata="+kodNyata+"&syaratNyata="+syaratNyata+"&kodSktn="+kodSekat+"&syaratSekat="+syaratSekat, "eTanah",
