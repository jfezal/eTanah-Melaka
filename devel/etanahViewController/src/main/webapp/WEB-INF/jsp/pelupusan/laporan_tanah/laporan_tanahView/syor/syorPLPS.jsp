                ...
                <c:choose>
                    <c:when test="${actionBean.fasaPermohonan.keputusan.kod eq 'SL' }">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${actionBean.hmList[0].statusLuasDiluluskan eq 'P'}">
                                    Keluasan Penuh
                                </c:if>
                                <c:if test="${actionBean.hmList[0].statusLuasDiluluskan eq 'S'}">
                                    Keluasan Sebahagian
                                </c:if>                               
                            </td>
                        </tr>
                        <c:if test="${actionBean.hmList[0].statusLuasDiluluskan eq 'S'}">
                            <tr>
                                ...
                                <td>
                                    ${actionBean.hmList[0].luasDiluluskan}&nbsp; ${actionBean.hmList[0].luasLulusUom.nama}&nbsp;
                                </td>
                            </tr>
                        </c:if>
                        <tr>
