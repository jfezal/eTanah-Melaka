        ...
        <fieldset class="aras1">
            ...
            <table align="center" border="0">
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'BMBT' || actionBean.permohonan.kodUrusan.kod eq 'PTBTC' || actionBean.permohonan.kodUrusan.kod eq 'PTBTS'}">
                    <tr>
                        <td id="tdLabel">Isipadu Diluluskan:</td>
                        <td> <s:text name="hakmilikPermohonan.luasDiluluskan" id="luas" size="10"/>
                            <s:select name="kodUnitLuas.kod" value="${actionBean.hakmilikPermohonan.luasLulusUom.kod}">
                                <s:option>Sila Pilih</s:option>
                                <s:options-collection collection="${listUtil.senaraiKodUOMByLuas}" label="nama" value="kod" />
                                <s:options-collection collection="${listUtil.senaraiKodUOMByIsipadu}" label="nama" value="kod" />
                            </s:select>
                        </td>
                    </tr>
                    <tr>
                        <td id="tdLabel">Kedalaman Diluluskan:</td>
                        <td> <s:text name="hakmilikPermohonan.kedalamanTanahDiluluskan" id="luas" size="10"/>
                            <s:select name="kodUnitLuas.kod" value="${actionBean.hakmilikPermohonan.kedalamanTanahUOMDiLuluskan.kod}">
                                <s:option>Sila Pilih</s:option>
                                <s:options-collection collection="${listUtil.senaraiKodUOMByLuas}" label="nama" value="kod" />
                                <s:options-collection collection="${listUtil.senaraiKodUOMByIsipadu}" label="nama" value="kod" />
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'BMBT' && actionBean.permohonan.kodUrusan.kod ne 'PTBTC' && actionBean.permohonan.kodUrusan.kod ne 'PTBTS'}">
                    <tr>
                        ...
                        <td> <s:text name="hakmilikPermohonan.luasTerlibat" id="luas" size="10"/>
