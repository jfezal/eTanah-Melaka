<%-- 
    Document   : kertasMMKTujuan
    Created on : Apr 16, 2013, 12:39:22 PM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_JKTDPBGSA?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kTujuan',q,
            function(data){
                $('#page_div').html(data);
