<%-- 
    Document   : kertas_rencana_ptdV2SyorPPTD
    Created on : Jul 3, 2013, 11:44:08 AM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_pindaanPTDV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kSyorPPtd',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kSyorPPtd') ;
        }
    }
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasRencanaPindaanPTDV2ActionBean" name="form">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Syor Penolong Pentadbir Tanah</legend>
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganSyorPPtd}" var="line">
                        <tr>
                            ...
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiKandunganSyorPPtd[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
