...
<script type="text/javascript">
    $(document).ready( function() {   
        ...
        if('${actionBean.permohonan.kodUrusan.kod}' == "PBRZ"){
    ...
    function validateForm(){
        ...
        {
            if(${actionBean.permohonan.kodUrusan.kod eq 'PBRZ' })
            {
...
<s:form name="form2" id="form2" beanclass="etanah.view.stripes.pelupusan.MaklumatTanahPbrzActionBean">
    <s:messages/>
    <s:errors/>
    ...
    <c:if test="${hakmilik eq false && edit eq true}">
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <c:if test="${actionBean.negeri eq '04'}">
                    <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBRZ'|| actionBean.permohonan.kodUrusan.kod eq 'PBRZ' || actionBean.permohonan.kodUrusan.kod eq 'RAYT'}">
                    ...
                    <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'LMCRG'}">
                        <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PPRU' and actionBean.permohonan.kodUrusan.kod ne 'PPTR' and actionBean.permohonan.kodUrusan.kod ne 'PBRZ' and actionBean.permohonan.kodUrusan.kod ne 'PBRZ' and actionBean.permohonan.kodUrusan.kod ne 'RAYT'}">
                        <p>
                            <label>Luas :</label>
                ...
                <c:if test="${actionBean.negeri eq '04'}">
                    <c:if test="${!(actionBean.permohonan.kodUrusan.kod eq 'LMCRG')}">
                        <c:if test="${!(actionBean.permohonan.kodUrusan.kod eq 'PPTR' || actionBean.permohonan.kodUrusan.kod eq 'PBRZ' || actionBean.permohonan.kodUrusan.kod eq 'PBRZ' || actionBean.permohonan.kodUrusan.kod eq 'RAYT')}">
                            <p>
                ...
                <c:if test="${actionBean.negeri eq '04'}">
                    <%--<c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PPTR' and actionBean.permohonan.kodUrusan.kod ne 'PBRZ'}">--%>
                    <c:if test="${!(actionBean.permohonan.kodUrusan.kod eq 'PPTR' || actionBean.permohonan.kodUrusan.kod eq 'PBRZ' || actionBean.permohonan.kodUrusan.kod eq 'PBRZ' || actionBean.permohonan.kodUrusan.kod eq 'RAYT')}">
                        <p>
                            <label>Jarak:</label>
    ...
    <c:if test="${hakmilik eq false && view eq true}">
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <%--view melaka when kodUrusan eq PBRZ--%>
                <c:if test="${actionBean.negeri eq '04'}">
                    <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBRZ'}">
                        <p>
                            <label>Luas Dipohon:</label>
        ...
        <div class="subtitle displaytag">
            ...
            <fieldset class="aras1">
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PRMP' and actionBean.permohonan.kodUrusan.kod ne 'MCMCL' and actionBean.permohonan.kodUrusan.kod ne 'MMMCL' and actionBean.permohonan.kodUrusan.kod}">
                    <c:if test="${actionBean.negeri eq '05' and actionBean.permohonan.kodUrusan.kod eq 'PBRZ'}">
                        <p align="center"><label></label>
                            <br>
