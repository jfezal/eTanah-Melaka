...
<s:form beanclass="etanah.view.stripes.pelupusan.MaklumatRayuanActionBean">
    <s:messages/>
    <s:errors/>
    <c:if test="${!status}"> 
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Cari Permohonan Dahulu</legend>
    ...
    <c:if test="${status}">
        <div class="subtitle">
            <fieldset class="aras1"> 
                ...
                <table>
                    <tr>                    
                        <td><label>Id Permohonan :</label></td>
                        <td>${actionBean.permohonanSebelum.idPermohonan}</td>               
                    </tr>                 
                    <tr>
                        <td><label>Urusan :</label></td> 
                        <td>${actionBean.permohonanSebelum.kodUrusan.nama}</td>
                    </tr>
                    <tr>
                        <td><label>Tujuan Permohonan :</label></td>
                        <td>${actionBean.permohonanSebelum.sebab}</td>
                    </tr>
                    <tr>
                        <td> <label>Tarikh Permohonan :</label></td>
                        <td><s:format value="${actionBean.permohonanSebelum.infoAudit.tarikhMasuk}" formatPattern="dd/MM/yyyy"/></td>
                    </tr>
                </table>
                ...
                <fieldset class="aras1">
                    ...
                    <div class="content" align="center">
                        <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" cellpadding="0" cellspacing="0"
                            ...
                            <display:column title="Nombor Lot/PT" style="vertical-align:baseline"><fmt:formatNumber  pattern="00" value="${line.noLot}"/></display:column>
