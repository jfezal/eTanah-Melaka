...
<s:form beanclass="etanah.view.stripes.pelupusan.UlasanMinitBebasActionBean">
    <s:messages/>
    <s:errors/>
        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                    <tr>
                        <td>
                            Adalah dimaklumkan, pentadbiran ini telah menerima permohonan daripada [] untuk memiliki tanah kerajaan [] untuk tujuan [] di bawah Seksyen 76 Kanun Tanah Negara.      
                        </td>
                    </tr>
                    <tr>
                        <td>
