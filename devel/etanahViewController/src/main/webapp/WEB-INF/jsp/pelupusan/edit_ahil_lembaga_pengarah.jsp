    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.MaklumatPemohon1ActionBean">
        ...
        <fieldset class="aras1">
            ...
            <p>
                ...
                <s:text name="pihakPengarah.alamat1" size="40" id="alamat1" onkeyup="this.value=this.value.toUpperCase();"/><s:hidden name="pihakPengarah.pihak.idPihak"/>
            </p>
            ...
            <p>
                ...
                <s:text name="pihakPengarah.jumlahSaham" size="10" onkeyup="validateNumber(this,this.value);"/>
                <b>Peratus (%)</b>
            </p>
