...
//                    alert($('#harga'+cnt).val());
        ...
        //                    alert(data) ;
                if(confirm("Adakah anda pasti?")) {
                    var url = '${pageContext.request.contextPath}/pelupusan/kertas_pindaanPTDV2?simpanKodTuntut&item='+item+'&harga='+harga ;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
    ...
    function openFrame(type){
        NoPrompt();
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_pindaanPTDV2?openFrame&type='+type;
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasRencanaPindaanPTDV2ActionBean" name="frm">
