...
<script type="text/javascript">
    function addSalinan(){
        ...
        window.open("${pageContext.request.contextPath}/utiliti/utilitiSalinan?showFormTambahSalinan&idPermohonan="+idPermohonan+"&kodDokumen="+kodDokumen, "eTanah",
    ...
    function editSalinan(idSalinan)
    {
        ...
        var idPermohonan = $('#idPermohonan').val() ;
        NoPrompt();
        window.open("${pageContext.request.contextPath}/utiliti/utilitiSalinan?showFormEditSalinan&idSalinan="+idSalinan+"&idPermohonan="+idPermohonan+"&kodDokumen="+kodDokumen, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            ...
            $.post('${pageContext.request.contextPath}/utiliti/utilitiSalinan?deleteRow&idKandungan='+idSalinan+'&tName='+tName,q,
            function(data){
                $('#page_div').html(data);
            }, 'html');
                
            self.refreshPageSalinan() ;
        }
    }
    ...
    function refreshPageSalinan(){
        ...
        //        doBlockUI();
        //        alert(kodDokumen);
        window.open("${pageContext.request.contextPath}/utiliti/utilitiSalinan?showFormSalinan&idPermohonan="+idPermohonan+"&kodDokumen="+kodDokumen, "eTanah",
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.utility.UtilitiSalinanActionBean" name ="senaraiSalinan" id ="senaraiSalinan">
        <s:messages/>
        <s:errors/>
        <div class="subtitle">
        ...
        <fieldset class="aras1">
            <table  width="100%" border="0">
                <tr>
                    <td align="center">
                        <s:submit name="janaDokumen" id="janaDokumen" class="btn" value="Jana Dokumen" onclick="NoPrompt();"/>
