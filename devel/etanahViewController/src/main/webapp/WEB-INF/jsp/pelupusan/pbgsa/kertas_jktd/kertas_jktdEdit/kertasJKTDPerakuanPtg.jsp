...
<title>Perakuan Pengarah Tanah dan Galian</title>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_JKTDPBGSA?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kPerakuanPtg',q,
            function(data){
                $('#page_div').html(data);
