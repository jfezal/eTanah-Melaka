<%-- 
    Document   : kertas_maklumanKeputusan
    Created on : Apr 23, 2013, 4:34:28 PM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_makluman_mmkV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kKeputusan',q,
            function(data){
                $('#page_div').html(data);
            ...
            <fieldset class="aras1">
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganKeputusan}" var="line">
                        <tr>
                            <td style="text-align: right"><c:out value="5.${num}"/></td>
                            <td>
