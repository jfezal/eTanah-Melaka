        ...
        <div align="left">
            ...
            <div class="content" align="center"> 
                ...
                <display:table class="tablecloth" name="${actionBean.senaraiRujukanLuar}" cellpadding="0" cellspacing="0" id="line"
                    ...
                    <c:choose>
                        <c:when test="${actionBean.stageId eq 'kenalpasti_jabatan_teknikal'}">
                            <display:column title="Status">
                                <c:if test="${line.infoAudit.tarikhKemaskini ne null}">
                                    Telah Dikemasikini
                                </c:if>
                                <c:if test="${line.infoAudit.tarikhKemaskini eq null}">
                                    Belum Dikemasikini
                                </c:if>
                            </display:column>
                        </c:when>
