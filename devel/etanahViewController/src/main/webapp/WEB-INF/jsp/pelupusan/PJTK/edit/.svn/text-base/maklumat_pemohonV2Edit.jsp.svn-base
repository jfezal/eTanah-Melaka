...
<script type="text/javascript">
    function addPemohon(){
        ...
        window.open("${pageContext.request.contextPath}/pelupusan/lelong_awam?showFormPopUp", "eTanah",
    ...
    {
        NoPrompt();
        window.open("${pageContext.request.contextPath}/pelupusan/lelong_awam?showFormKemaskiniPemohon&idPemohon="+idPemohon+"&idPihak="+idPihak, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
    ...
    function deletePemohon(idPemohon,f,tName)
        {   
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                ...
                $.post('${pageContext.request.contextPath}/pelupusan/lelong_awam?deleteRow&idPemohon='+idPemohon+'&tName='+tName,q,
                function(data){
                    $('#page_div').html(data);
    ...
    {
        NoPrompt();
        window.open("${pageContext.request.contextPath}/pelupusan/lelong_awam?showFormMaklumatKeluarga&idPemohon="+idPemohon, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }   
