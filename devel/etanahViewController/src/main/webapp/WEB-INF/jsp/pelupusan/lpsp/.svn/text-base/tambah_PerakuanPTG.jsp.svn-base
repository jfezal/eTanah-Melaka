...
<div class="subtitle" id="caw">
    <s:form beanclass="etanah.view.stripes.pelupusan.DrafMMKN_LPSPActionBean">
        ...
        <fieldset class="aras1">
            <legend><b><font style="text-transform: capitalize">PERAKUAN PENGARAH TANAH DAN GALIAN</font></b></legend>
            <table border="0" width="100%" id="tblhuraian" cellspacing="0" align="center">
                <table>
                    ...
                    <tr><td></td>
                        <td><center>
                            <s:submit name="simpanPerakuanPTGPopUp" id="simpan" value="Simpan" class="btn" />
