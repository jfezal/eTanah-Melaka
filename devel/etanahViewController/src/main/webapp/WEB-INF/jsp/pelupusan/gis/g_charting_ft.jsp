...
<s:form beanclass="etanah.view.stripes.pelupusan.GISIntegrationActionBean" name="form">
    ...
    <html>
        ...
        <body>
            ...
            <br>
            <p align="center">
                <s:button name="chartingFT" id="chartingFT" style="font-size: 12px" value="Charting FT" class="longbtn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
            </p>
        </body>
    </html>
</s:form>
