<%-- 
    Document   : tambah_saudara
    Created on : Jul 11, 2011, 11:58:29 AM
    Author     : afham
--%>
...
<div class="subtitle" id="caw">
    <s:form beanclass="etanah.view.stripes.pelupusan.MaklumatPemohon1ActionBean">
        ...
        <fieldset class="aras1">
            <legend>Kemasukan Maklumat Saudara Pemohon</legend>
            ...
            <p>
                ...
                <s:select name="pemohonHbgn.jenisPengenalan.kod"  id="kod"  onchange ="hideWarna(this.options[selectedIndex].text);"  style="width:244px">
            ...
            <p> <label><font color="red">*</font>Kaitan :</label>
                ...
                <s:select name="pemohonHbgn.kaitan" id="kaitan" style="width:244px" >
                    <s:option value="0">Sila Pilih</s:option>
                    <s:option value="SAUDARA LELAKI">SAUDARA LELAKI</s:option>
                    <s:option value="SAUDARA PEREMPUAN">SAUDARA PEREMPUAN</s:option>
                </s:select>
            </p>

            <p>
                <label><font color="red">*</font>Tarikh Lahir :</label>
                <s:text name="pemohonHbgn.tarikhLahir" size="40"  id="datepicker" class="datepicker" formatPattern="dd/MM/yyyy"/> <em>[hh/bb/tttt]</em>
            </p>
            <p>
...
          
            ...
            <p>
                ...
                <s:text name="pemohonHbgn.gaji" size="40" onkeyup="this.value=this.value.toUpperCase();"/>
            </p>
            <p>
            ...
            <p>
                <label>&nbsp;</label>
                <s:submit name="simpanPemohonSaudara" id="simpan" value="Simpan" class="btn"/>
