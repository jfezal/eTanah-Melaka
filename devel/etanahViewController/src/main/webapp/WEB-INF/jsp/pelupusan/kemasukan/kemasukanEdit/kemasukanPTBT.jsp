...
<script type="text/javascript">
    ...
    <c:if test="${edit}">
        ...
        function getSeksyen()
        {
            ...
            var kULuas2 = $('#kULuas2').val();
            var kCatatan = $('#kCatatan').val();
            ...
            self.refreshDataSeksyen(mpb,tempat,Luas,Luas,kd,kULuas,kULuas2,kCatatan,kodlot,noLot,Jarak,uJarak,jarakDari,katTanahPilihan,kodSeksyen,kodGunaTanah,idMH,type);
        }
    
        function refreshDataSeksyen(mpb,tempat,Luas,Luas2,kd,kULuas,kULuas2,kCatatan,kodlot,noLot,Jarak,uJarak,jarakDari,katTanahPilihan,kodSeksyen,kodGunaTanah,idMH,type){
            window.open("${pageContext.request.contextPath}/pelupusan/maklumat_tanahV3?carianIndependent&katTanahPilihan="
                +katTanahPilihan+"&mpb="+mpb+"&tempat="+tempat+"&Luas="+Luas+"&Luas2="+Luas2+"&kULuas="+kULuas+"&kULuas2="+kULuas2+"&kCatatan="+kCatatan+"&kodlot="+kodlot+"&noLot="+noLot+"&Jarak="+Jarak+'&uJarak='+uJarak+"&jarakDari="+jarakDari+"&kodSeksyen="+kodSeksyen+"&kodGunaTanah="
        ...
        function filterKodGunaTanah() {
            ...
            $.post('${pageContext.request.contextPath}/pelupusan/maklumat_tanahV3?senaraiKodGunaTanahByKatTanah&kodKatTanah=' + katTanah,
            function(data) {
                if (data != '') {
                    ...
                    <c:when test="${actionBean.negeri eq '04'}">                        
                        <table class="tablecloth" align="center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <s:select name="bandarPekanMukimBaru.kod" value="${actionBean.disHakmilikPermohonan.hakmilikPermohonan.bandarPekanMukimBaru.kod}" id="mpb" onchange="filterKodSeksyen();">
                    ...
                    <c:when test="${actionBean.negeri eq '05'}">                        
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>                                  
                                    <c:choose>
                                        <c:when test="${actionBean.permohonan.cawangan.kod eq '08'}">
                                            Tampin
                                        </c:when>
                                        <c:otherwise>
                                            ${actionBean.permohonan.cawangan.daerah.nama}
                            ...
                            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'BMBT'}">
                                <tr>
                                    ...
                                    <td>
                                        <s:select id = "kCatatan"  name="hakmilikPermohonan.catatan">
                                            <s:option value="">Sila Pilih</s:option>
                                            <s:option value="BL">Sebahagian Tanah</s:option>
                                            <s:option value="SL">Keseluruhan Tanah</s:option>
                                        </s:select>
                                    </td>
                                </tr>
                            </c:if>
                            ...
                            <tr>
                                ...
                                <td>
                                    <s:text name="hakmilikPermohonan.kedalamanTanah" value="${actionBean.disHakmilikPermohonan.hakmilikPermohonan.kedalamanTanah}" formatPattern="0.0000" maxlength="15" onkeyup="validateNumber(this,this.value);" id="Luas2"/>
                                    <s:select name="disHakmilikPermohonan.kedalamanTanahUOM" value="${actionBean.disHakmilikPermohonan.hakmilikPermohonan.kedalamanTanahUOM.kod}" id="kULuas2">
                                        <s:option value="">Sila Pilih</s:option>
                            ...
                            <tr>
                                <td style="text-align:center;" colspan="3">      
                                    <s:submit name="simpan" value="Simpan" id="simpan" class="btn" />
                                    <s:button name="tutup" value="Tutup" class="btn" onclick="refreshpage()"/>
                                </td>
                            </tr>  
                        </table>      
