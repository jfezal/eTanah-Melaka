<%-- 
    Document   : borangV2Edit
    Created on : Jun 17, 2013, 11:48:31 AM
    Author     : afham
--%>
...
<script type="text/javascript">       
    ...
    <%--alert(id);--%>
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pelupusan/borangV2?showFormPopUp", "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        {   
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                ...
                $.post('${pageContext.request.contextPath}/pelupusan/borangV2?deleteRow&idTuntutanKos='+idTuntutanKos+'&tName='+tName,q,
                function(data){
                    $('#page_div').html(data);
        ...
        {
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pelupusan/borangV2?showFormKemaskiniNilai&idTuntutanKos="+idTuntutanKos, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        
        function refreshpage(){
            NoPrompt();
        opener.refreshV2Borang('main');
        self.close();
        }
