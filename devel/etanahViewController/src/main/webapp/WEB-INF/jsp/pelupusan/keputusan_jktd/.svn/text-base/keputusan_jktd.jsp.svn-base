<%-- 
    Document   : keputusan_jktd
    Created on : May 27, 2013, 3:35:30 PM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    function refreshpage2(){
        //        alert('aa');
        NoPrompt();
        opener.refreshRekodKeputusanJKTDV2('beforeMesyuarat');
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.RekodKeputusanJKTDV2ActionBean" name="form">
        <s:errors/>
        <s:messages/>
