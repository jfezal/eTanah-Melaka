...
<script type="text/javascript">
    ...
    function RunProgramQT(strUserID, strNama, strJawatan, strIDPermohonan, strIDStage) {

        strNama = ReplaceAll(strNama," ","_");
        strJawatan = ReplaceAll(strJawatan," ","_");
        alert("nama:" + strNama);
        alert ("jawatan:" + strJawatan);
        strIDStage = "g_penyediaan_pu_pt";
    ...
    function RunProgramB2(strUserID, strNama, strJawatan, strIDPermohonan, strIDStage) {
    ...
    function RunProgramFT(strUserID, strNama, strJawatan, strIDPermohonan, strIDStage) {
    ...
    <div class="subtitle">
                        ...
                        <tr>
                            ...
                            <c:choose>
                                <c:when test="${actionBean.permohonanUkur.sebabUkur eq 'SBT'}">
                                    ...
                                    <td>:</td>
                                    <td>
                                        Pemberimilikan Tanah Bawah Tanah
                                    </td>
                                </c:when>
                            </c:choose>
                            <c:choose>
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <div align="center">
                    <s:hidden name="checkQT" id="checkQT" value="${actionBean.checkQT}"/>
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PWGSA' and actionBean.stageId eq '8aSedPU'}">
                            ...
                            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PWGSA' and actionBean.stageId eq '8bSemakdanHntrPU'}">
                            ...
                            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBMT' and actionBean.stageId eq 'g_penyediaan_pu_pt'}">
                                <s:button name="simpan" id="save" value="Terima Pelan B2" class="longbtn"  onclick="RunProgramB2('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>
                                <s:button name="simpan" id="save" value="Penyediaan PU PT" class="longbtn"  onclick="RunProgramQT('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>  
                            </c:if>
                            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBMT' or actionBean.permohonan.kodUrusan.kod eq 'PRIZ' or actionBean.permohonan.kodUrusan.kod eq 'BMRE' or actionBean.permohonan.kodUrusan.kod eq 'PJTK' or actionBean.permohonan.kodUrusan.kod eq 'PJLB' and actionBean.stageId eq 'g_penyediaan_pu'}">
                                <s:button name="simpan" id="save" value="Penyediaan PU GIS" class="longbtn"  onclick="RunProgramFT('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>  
                            </c:if> 
                            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PHLP' and actionBean.stageId eq 'g_semak_pu'}">
                                <s:button name="simpan" id="save" value="Sahkan PU GIS" class="longbtn"  onclick="SemakPU('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/> 
                            </c:if>     
                            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PHLP' and actionBean.stageId eq 'g_sahkan_pu'}">
                                <s:button name="simpan" id="save" value="Sahkan PU GIS" class="longbtn"  onclick="SahPU('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/> 
                            </c:if> 
                            <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PHLP' and actionBean.stageId eq 'g_hanter_pu'}">
                                <s:button name="simpan" id="save" value="Hantar PU GIS" class="longbtn"  onclick="RunProgram2('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/> 
                            </c:if>     
