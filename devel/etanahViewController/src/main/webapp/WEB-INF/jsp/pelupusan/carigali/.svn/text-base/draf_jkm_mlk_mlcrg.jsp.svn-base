...
<s:form beanclass="etanah.view.stripes.pelupusan.DrafJKMMLCRGActionBean" name="form" id="form">
    ...
    <s:hidden id="viewMMKN" name="viewMMKN" value="${actionBean.viewFormTujuanPerakuan}"/>
    <s:messages/>
    <s:errors/>
    <table width="80%" border="0">
        ...
        <tr>
            ...
            <td>2.5</td>
            <td></td>
            <td><div align="left"><b>Perihal Permohonan</b></div></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
        </tr>
        
        <c:if test="${actionBean.viewFormTujuanPerakuan}">
            <c:set var="i" value="1" />
            <c:set var="k" value="1" />
            <c:forEach items="${actionBean.senaraiLaporanKandunganPerihalPermohonan}" var="line">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td style="display:none" valign="top">${line.idKandungan}</td><td valign="top"><c:out value="2.5.${k}"/></td>
