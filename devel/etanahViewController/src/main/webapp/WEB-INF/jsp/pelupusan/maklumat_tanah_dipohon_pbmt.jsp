<%--
    Document   : maklumat_tanah_pbmt_dipohon
...
function doSomething() {
    ...
    <c:if test="${actionBean.negeri eq '05'}">
        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBMT'}">
            ...
            var url = '${pageContext.request.contextPath}/pelupusan/maklumat_tanah_pbmt?carianIndependent&katTanahPilihan='
    ...
    <%-- alert('katTanahPilihan='
         ...
         function changeMukim() {
             ...
             var kodSeksyen = $('#_kodSeksyen2').val();
        <c:if test="${actionBean.negeri eq '04'}">
        var url = '${pageContext.request.contextPath}/pelupusan/maklumat_tanah_pbmt?carianIndependentMukim&katTanahPilihan='
    ...
    function cariPopup(){
        // alert("search:"+index);
        var url = '${pageContext.request.contextPath}/pelupusan/maklumat_tanah_pbmt?search';
...
<s:form name="form2" id="form2" beanclass="etanah.view.stripes.pelupusan.MaklumatTanahPbmtActionBean">
    <s:messages/>
    <s:errors/>
    ...
    <c:if test="${hakmilik eq false && edit eq true}">
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PPBB' && actionBean.permohonan.kodUrusan.kod ne 'PBPTG' && actionBean.permohonan.kodUrusan.kod ne 'PBPTD' && actionBean.permohonan.kodUrusan.kod ne 'LMCRG' && actionBean.permohonan.kodUrusan.kod ne 'PLPTD'}">
                    <p>
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PPBB' || actionBean.permohonan.kodUrusan.kod eq 'PBPTG' || actionBean.permohonan.kodUrusan.kod eq 'PBPTD' || actionBean.permohonan.kodUrusan.kod eq 'LMCRG' || actionBean.permohonan.kodUrusan.kod eq 'PLPTD'}">
                    <p>
                ...
                <c:if test="${actionBean.negeri eq '04'}">
                    <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PRIZ'|| actionBean.permohonan.kodUrusan.kod eq 'PBRZ' || actionBean.permohonan.kodUrusan.kod eq 'RAYT'}">
                        ...
                        <p>
                            ...
                            <s:select name="kodLot.kod" value="${actionBean.hakmilikPermohonan.lot.kod}" id="kodlot">
                                <s:option value="">Sila Pilih</s:option>
                                <s:options-collection collection="${listUtil.senaraiLotPelupusanLotOnly}" label="nama" value="kod" />
                            </s:select>
                    ...
                    <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'LMCRG'}">
                        <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PPRU' and actionBean.permohonan.kodUrusan.kod ne 'PPTR' and actionBean.permohonan.kodUrusan.kod ne 'PRIZ' and actionBean.permohonan.kodUrusan.kod ne 'PBRZ' and actionBean.permohonan.kodUrusan.kod ne 'RAYT'}">
                        <p>
                            <label>Luas :</label>
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PLPS' || actionBean.permohonan.kodUrusan.kod eq 'PLPTD' || actionBean.permohonan.kodUrusan.kod eq 'RLPS' || actionBean.permohonan.kodUrusan.kod eq 'RLPSK' || actionBean.permohonan.kodUrusan.kod eq 'LPSP'}">
                    <p>
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBMT'}">
                    ...
                    <p>
                        <label>Kategori Tanah :</label>
                        <c:if test="${actionBean.hakmilikPermohonan.kategoriTanahBaru.nama eq null}">Tiada<br/></c:if>
                        <c:if test="${actionBean.hakmilikPermohonan.kategoriTanahBaru.nama ne null}">${actionBean.hakmilikPermohonan.kategoriTanahBaru.nama}<br/></c:if>
                    </p>
                    <p>
                        <label>Kegunaan Tanah :</label>
                ...
                <c:if test="${actionBean.negeri eq '04'}">
                    <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PPTR'}">
                        ...
                        <p> <label>Jarak Dari Kediaman :</label>
                         ...
                         <p> <label><font color="red">*</font>Tujuan :</label>
                           ${actionBean.permohonan.sebab}
                        </p>
                    </c:if>
            ...
            <fieldset class="aras1">
                ...
                <div class="content" align="center">
                    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" cellpadding="0" cellspacing="0"
                        ...
                        <display:column property="hakmilik.noLot" title="Nombor Lot" style="vertical-align:baseline"/>
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PRMP' and actionBean.permohonan.kodUrusan.kod ne 'MCMCL' and actionBean.permohonan.kodUrusan.kod ne 'MMMCL' and actionBean.permohonan.kodUrusan.kod}">
