...
<script type="text/javascript">
    ...
    function tambahKawasan(){
        NoPrompt();
        window.open("${pageContext.request.contextPath}/pelupusan/laporan_tanahGSA?kawasanPopup", "eTanah",
    ...
    {   NoPrompt();
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/laporan_tanahGSA?deleteRow&idKandungan='+idMohonlaporKws+'&tName='+tName,q,
            function(data){
                $('#page_div').html(data);
