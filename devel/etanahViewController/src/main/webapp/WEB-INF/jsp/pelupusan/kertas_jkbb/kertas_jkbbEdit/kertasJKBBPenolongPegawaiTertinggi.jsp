...
<script type="text/javascript">
    ...
    {   
        NoPrompt();
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_JKBBV2?tambahRow&index='+index;
        window.open(url, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_JKBBV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kPTertinggi',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kPTertinggi') ;
        }
    }
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasJKBBV2ActionBean" name="form">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Perakuan Penolong Pegawai Tanah Tertinggi</legend>
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiLaporanKandunganPerakuanPegawaiTertinggi}" var="line">
                        <tr>
                            ...
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiLaporanKandunganPerakuanPegawaiTertinggi[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
                    ...
                    <tr>
                        <td style="text-align:center;" colspan="3">      
                            <s:button value="Tambah" class="btn" name="simpan1"  onclick="addRow('8',this.form)"/>
                            <s:submit name="simpanKandungan" value="Simpan" class="btn" onclick="NoPrompt();"/>
                            <s:hidden name="indexKertas" id="indexKertas" value="8"/>
