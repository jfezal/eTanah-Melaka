    ...
    <div class="subtitle displaytag" align="center">
        <c:if test="${actionBean.edit}">
            <fieldset class="aras1" id="locate">
                ...
                <c:if test="${actionBean.stageId eq 'g_charting_permohonan' || actionBean.stageId eq 'g_charting_pemohonan'  || actionBean.stageId eq '04KmsknLapChrtg' || actionBean.stageId eq '03KmsknKptsChrtg'}">
                    <p>
