...
<body>
    <script>
        ...
        function del(idLaporBangunan){          
            window.open("${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?delete&idLaporBangunan="+idLaporBangunan, "eTanah",
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${edit}">
                                    ...
                                    <s:submit name="delete" value="Hapus" class="btn" onclick="del(${actionBean.permohonanLaporanBangunan.idLaporBangunan});"/> 
                                </c:if>                                
