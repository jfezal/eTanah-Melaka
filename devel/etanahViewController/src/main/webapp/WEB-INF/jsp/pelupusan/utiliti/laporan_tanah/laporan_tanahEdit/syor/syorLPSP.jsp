...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.permohonanPermitItem eq null}">
        ...
        {   
            ...
            var url = '${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?tambahRow&index='+index+'&kodksn='+kodksn+'&idHakmilik='+idHakmilik+'&noPtSementara='+noPtSementara+'&idPermohonan='+idPermohonan;
            window.open(url, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        {   
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=PPT',q,
                function(data){
                    $('#page_div').html(data);

                }, 'html');
                self.openFrame('syorPPT') ;
            }
        }
        ...
        function calculateSyarat(){
            ...
            var amaun = document.getElementById('amnt').value;
            var amaun1 = (amaun * 1)                       
            //alert(bayaranSyarat);
            ...
            var totalLPSdanPermit = (jumlah) + (cagaran) + (jumlahKpnQty) + (cagarJalan) + (amaun1);
            ...
            document.getElementById('totalLPSdanPermit').value = CurrencyFormatted(totalLPSdanPermit)  ;
        }
                    ...
                    <fieldset class="aras1">
                        <div id="batuansokong">
                            ...
                            <table class="tablecloth" align="center">
                                ...
                                <tr>
                                    <td>Jumlah Keseluruhan Bayaran Permit (RM) :</td>
                                    <td><s:text name="disPermohonanBahanBatu.totalAll" id="totalAll" readonly="true"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Jumlah Keseluruhan Bayaran LPS dan Permit (RM) :</td>
                    ...
                    <fieldset class="aras1">
                        <div id="batuansokong">
                            ...
                            <table class="tablecloth" align="center">
                                <tr id="catatanKegunaan">
                                    <td>Catatan :</td>
                                    <td><s:textarea name="catatan" rows="5" cols="80"/></td>
                                </tr>
                                <tr>
                                    <td><font color="red" size="4">*</font>Bayaran (RM) :</td>
                                    <td><s:text name="amnt" id="amnt" size="20" onkeyup="validateNumber(this,this.value);"/>  Setahun</td>
                                </tr>
                                <tr>
                                    <td><font color="red" size="4">*</font>Keluasan : </td>
                                    <td>
                                ...
                                <tr>
                                    <td>Syarat Tambahan :</td>
                                    <td><s:textarea name="ulsn" rows="5" cols="80" /></td>
                                </tr>
                            </table><br/>
                            <legend>Syarat-syarat Permit </legend>
                            <table class="tablecloth" align="center">
                                ...
                                <tr>
                                    ...
                                    <td><c:if test="${actionBean.hakmilikPermohonan.kodMilik.kod eq 'H'}">
                                        ...
                                        <c:if test="${actionBean.hakmilikPermohonan.kodMilik.kod eq 'K'}">
                                            <c:if test="${actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.kod eq 'TM' or actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.kod eq 'BG'
                                                          or actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.kod eq 'PS' or actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.kod eq 'TL' or actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.kod eq 'RP'
                                                          or actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.kod eq 'BT' or actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.kod eq 'TN'}">
                                                <s:format value="${actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.royaltiTanahKerajaan}" formatPattern="##0.00"/> <span style="text-transform:lowercase">se${actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.royaltiTanahKerajaanUom.nama}</span>
                                                <s:hidden name="bayaranSyarat" id="bayaranSyarat" value="${actionBean.disPermohonanBahanBatu.syaratBahanBatu.jenisBahanBatu.royaltiTanahKerajaan}"/>
                                            </c:if>
                                        </c:if>
