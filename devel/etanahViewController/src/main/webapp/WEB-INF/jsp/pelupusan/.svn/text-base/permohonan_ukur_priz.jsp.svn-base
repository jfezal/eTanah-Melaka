...
<s:form beanclass="etanah.view.stripes.pelupusan.PermohonanUkurPRIZActionBean" name="form" id="form">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                ...
                <%--to transfer to JUPEM--%>
<!--                <table border="0" width="55%" cellspacing="10">
                    <tr>
                        <td>
                            <s:button name="transferFile" id="btnClick" value="Penghantaran PU" class="longbtn" onclick="doSubmit(this.form, this.name, 'page_div')" />
                        </td>
                    </tr>
        ...
        <fieldset class="aras1">
            <c:if test="${actionBean.viewGISButton}">
                <s:button name="transferFile" id="btnClick" value="Penghantaran PU" class="longbtn" onclick="doSubmit(this.form, this.name, 'page_div')" />
            </c:if>
        </fieldset>
    </div>
