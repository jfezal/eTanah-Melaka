                ...
                <div class="content" align="center">
                    <table class="tablecloth">
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="laporanTanah.jarakSempadanJalanraya" id="jarakSempadanJalanraya" formatPattern="#,###,##0.0000" maxlength="3" onkeyup="validateNumber(this,this.value);"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <s:text name="laporanTanah.jarakSempadanKeretapi" id="jarakSempadanKeretapi" formatPattern="#,###,##0.0000" maxlength="3" onkeyup="validateNumber(this,this.value);"/>                            
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <s:text name="laporanTanah.jarakSempadanLaut" id="jarakSempadanLaut"  formatPattern="#,###,##0.0000" maxlength="3" onkeyup="validateNumber(this,this.value);"/>                            
                            </td>
                        </tr><tr>
                            <td>
                                Sungai
                            ...
                            <td>
                                <s:text name="laporanTanah.jarakSempadanSungai" id="jarakSempadanSungai" formatPattern="#,###,##0.0000" maxlength="3" onkeyup="validateNumber(this,this.value);"/>                            
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <s:text name="laporanTanah.jarakSempadanLain" id="jarakSempadanLain" formatPattern="#,###,##0.0000" maxlength="3" onkeyup="validateNumber(this,this.value);"/>                           
                            </td>
                        </tr>
                    </table>
                    <br>
