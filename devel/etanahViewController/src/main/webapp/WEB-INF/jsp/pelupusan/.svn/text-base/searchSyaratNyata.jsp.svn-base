<%-- 
    Document   : searchSyaratNyata.jsp
            ...
            <div class="subtitle">
               ...
               <%-- <c:if test="${actionBean.kodSyaratNyata != null}">--%>
                ...
                <fieldset class="aras1">
                    <legend></legend>
                    <p>
                        <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSyaratNyata}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pelupusan/surat_kelulusan" id="line">
