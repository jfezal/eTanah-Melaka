<%-- 
    Document   : kertas_maklumanSiasatan
    Created on : Jul 8, 2013, 10:59:43 AM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_makluman_mmkV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kSiasatan',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kSiasatan') ;
        }
    }
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasMaklumanMMKActionBean" name="form">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Makluman Pengarah Tanah dan Galian</legend>
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganSiasatan}" var="line">
                        <tr>
                            ...
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiKandunganSiasatan[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
