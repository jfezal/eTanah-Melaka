<%-- 
    Document   : kertasMMKHuraianPtd
    Created on : Apr 16, 2013, 12:40:57 PM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_JKTDPBGSA?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kHuraianPtd',q,
            function(data){
                $('#page_div').html(data);
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasJKTDPBGSAActionBean" name="form">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Huraian Pentadbir Tanah</legend>
                <table class="tablecloth" border="0" align="center">
                    ...
                    <tr>
                        <td style="text-align:center;" colspan="3">      
                            <s:button value="Tambah" class="btn" name="simpan1"  onclick="addRow('4',this.form)"/>
                            <s:submit name="simpanKandungan" value="Simpan" class="btn" onclick="NoPrompt();"/>
                            <s:hidden name="indexKertas" id="indexKertas" value="4"/>
