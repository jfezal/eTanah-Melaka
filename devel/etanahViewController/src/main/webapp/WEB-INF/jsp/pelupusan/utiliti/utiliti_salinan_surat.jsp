...
//        alert(kodDokumen);
    ...
    function janaPermohonan(){
        ...
        if(confirm("Adakah anda pasti untuk jana permohonan?")) {
            var url = '${pageContext.request.contextPath}/utiliti/utilitiSalinan?janaPermohonan&idKelompok='+idKelompok ;
            $.get(url,
            function(data){
                $('#page_div').html(data);
...
<s:form beanclass="etanah.view.stripes.pelupusan.utility.UtilitiSalinanActionBean" name ="utilitiSalinan" id ="utilitiSalinan">
    <s:messages/>
    <s:errors/>
    <div class ="subtitle">
        <div class="content">
            <fieldset class ="aras1">
                ...
                <p><label><font color="red">*</font>ID Permohonan :</label>
                    ...
                    <p align="center"><s:submit name="findKandungan" value="Cari" class="btn"/>&nbsp;<s:button name = "reset" class="btn" value ="Isi Semula" onclick= "clearText('utilitiSalinan')" /></p>
            </fieldset>
        </div>
