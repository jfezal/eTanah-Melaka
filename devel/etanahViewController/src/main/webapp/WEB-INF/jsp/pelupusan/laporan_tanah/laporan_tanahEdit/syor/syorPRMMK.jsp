<%--
    Document   :  syorPRMMK(Editable).jsp
...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.ksn ne null}">
        ...
        function showprmmktidaksokong(val) {
            $('#prmmktidaksokong').show();
            $('#prmmksokong').hide();
            if(val == 'SL'){
                val = 'ST';
                    ...
                    <c:when test="${actionBean.kodNegeri eq '05'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showprmmksokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showprmmktidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                        ...
                        <div id="prmmksokong">
                            <table class="tablecloth" align="center">
                                <tr>
                                    <td><font color="red" size="4">*</font>Keluasan : Sebelum perenggan</td>
                                    <td>
                                ...
                                <tr>
                                    <td><font color="red" size="4">*</font>Keluasan : Selepas perenggan</td>
                                    <td>
                                        <s:text name="hakmilikPermohonan.luasDiluluskan" size="15"/>
                                        <s:select name="kodUomLuasLulus" id="kodUomLuasLulus">
                                            <s:option value="">Sila Pilih</s:option>
                                            <s:option value="M">Meter Persegi</s:option>
                                            <s:option value="H">Hektar</s:option>
                                        </s:select>
