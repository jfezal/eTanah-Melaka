        ...
        <div class="subtitle">
            <fieldset class="aras1">
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showmcmclsokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showmcmcltidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:if test="${empty actionBean.senaraiLaporanKandungan1}">
                        <tr>
                            <td><s:textarea value="TIADA ULASAN PENOLONG PEGAWAI TANAH TELAH DIBUAT. Sila Klik pada butang Tambah Ulasan Untuk Menambah Ulasan" cols="80" readonly="true" name="syorUlasan" rows="5"/></td>
                        </tr>
                    </c:if>
                    <tr>
