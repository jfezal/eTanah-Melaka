...
<script type="text/javascript">
    ...
    function selectCheckBox(f,kpsn,size)
    {
        ...
        if(confirm("Adakah anda pasti?")) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/rekod_keputusanMMKV2?pilihTanah&item='+data+'&kpsn='+kpsn,q,
            function(data){
                $('#page_div').html(data);
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.RekodKeputusanMMKV2ActionBean" name="frm">
        <s:errors/>
        <s:messages/>
