...
<s:form beanclass="etanah.view.stripes.pelupusan.LaporanNilaianPBMTActionBean">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
        <fieldset class="aras1">
           <legend>Laporan Nilaian</legend>
            ...
            <p>
                ...
                <c:if test="${actionBean.hakmilikPermohonan.noLot eq null}">
                    -&nbsp;
                </c:if>
            ...
            <p>
                    ...
                    <s:format formatPattern="#,###,##0.0000" value="${actionBean.hakmilikPermohonan.luasTerlibat}"/>  ${actionBean.hakmilikPermohonan.kodUnitLuas.nama}
            </p>
           <%-- <p>
            ...
            <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PHLP' && actionBean.permohonan.kodUrusan.kod ne 'PHLA'}  ">
                ...
                <p>
                    ...
                    <s:format formatPattern="#,###,##0.0000" value="${actionBean.noPt.luasDilulus}"/> 
