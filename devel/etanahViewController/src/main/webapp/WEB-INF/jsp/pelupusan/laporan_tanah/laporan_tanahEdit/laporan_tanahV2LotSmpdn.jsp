...
<script type="text/javascript">
    ...
    <%--alert(id);--%>
            ...
            //            alert(idHakmilik);
            window.open("${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?showFormPopUp&idHakmilik="+idHakmilik, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        {   
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName,q,
                function(data){
                    $('#page_div').html(data);
        ...
        {
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?showFormPopUp&idKandungan="+idKandungan, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
    ...
    <c:choose>
        ...
        function uploadForm(pandanganImej,idlaporTnhSmpdn) {
            ...
            //            alert(idLapor);
            window.open("${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?uploadDoc&pandanganImej="+pandanganImej+"&idLapor="+idLapor+'&idlaporTnhSmpdn='+idlaporTnhSmpdn, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
</script>
<body>
