                ...
                <br/>
                    <p>
                        <label><font color="red">*</font>Nama Anak:</label>
                         <s:text name="pemohonHubungan.nama" size="40" id="nama" onkeyup="this.value=this.value.toUpperCase();"/>
                    </p>
                      <p>
                    ...
                    <p><br/>
                       ...
                       <%-- <s:button name="simpanAnak" id="simpan" value="Simpan" class="btn" onclick="savePemohonAnak(this.name, this.form);"/>--%>
                       <s:submit name="simpanAnak" id="simpan" value="Simpan" class="btn"/>
