        ...
        <c:choose>
            <c:when test="${actionBean.kodNegeri eq '04'}">
                ...
                <tr>
                    ...
                    <td>
                        <s:textarea name="nyata" value="${actionBean.hakmilikPermohonan.syaratNyataBaru.syarat}" class="normal_text" readonly="true" cols="80" rows="5"/>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <c:when test="${actionBean.kodNegeri eq '05'}">
                ...
                <tr>
                    ...
                    <td>
                        <s:textarea name="nyata" value="${actionBean.hakmilikPermohonan.sekatanKepentinganBaru.sekatan}" class="normal_text" readonly="true" cols="80" rows="5"/>&nbsp;
                    </td>
                </tr>
            </c:when>
            <c:otherwise>
