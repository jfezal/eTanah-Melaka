...
<script type="text/javascript">
    ...
    function refreshpage2(){
        //        alert('aa');
        NoPrompt();
        opener.refreshRekodKeputusanMMKV2('beforeMesyuarat');
                                    ...
                                    <c:when test="${actionBean.kodNegeri eq '05'}">
                                        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBMT'}">
                                            <tr>
                                                ...
                                                <td>
                                                    <s:radio name="kpsnMohonFasa" value="XN"/>Telah Mendapat Keputusan&nbsp;
                                                    <s:radio name="kpsnMohonFasa" value="1M"/>Ditangguh Mesyuarat MMKN&nbsp;
                                                </td>
                                            </tr>
                                        </c:if>
                                    </c:when>
