<%--
    Document   : kodAgensi_Page
    Created on : Jul 20, 2010, 3:50:55 PM
...
$(".datepicker").datepicker({dateFormat: 'dd/mm/yy'});
    ...
    function validation() {
        ...
        <%--if($("#alamat2").val() == ""){
            alert('Sila pilih " alamat2 " terlebih dahulu.');
            $("#alamat2").focus();
            return true;
        }
        if($("#alamat3").val() == ""){
            alert('Sila pilih " alamat3 " terlebih dahulu.');
            $("#alamat3").focus();
            return true;
        }
        if($("#alamat4").val() == ""){
            alert('Sila pilih " alamat4 " terlebih dahulu.');
            $("#alamat4").focus();
            return true;
        }--%>
        if($("#poskod").val() == ""){
