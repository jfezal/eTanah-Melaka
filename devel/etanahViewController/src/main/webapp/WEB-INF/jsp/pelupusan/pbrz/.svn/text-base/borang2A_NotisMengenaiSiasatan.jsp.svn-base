    ...
    <div  id="hakmilik_details">
        <fieldset class="aras1"><br/>
            <legend align="center">
                <b>Borang 2A</b><br />
                <b>(Seksyen 27)</b><br />
                <b>NOTIS MENGENAI SIASATANaaaa </b>
            </legend><br/>
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="6" cellpadding="0" cellspacing="0"
                               requestURI="/pelupusan/pbrz/borang2A_NotisMengenaiSiasatan" id="line">
                    <display:column title="No" sortable="true">${line_rowNum}</display:column>
                    <display:column title="No Lot/No PT" >${actionBean.hakmilikPermohonan.lot.nama}&nbsp;${actionBean.hakmilikPermohonan.noLot}</display:column>
                    <display:column title="Luas"><fmt:formatNumber pattern="#,##0.00" value="${actionBean.hakmilikPermohonan.luasTerlibat}"/>&nbsp;${actionBean.hakmilikPermohonan.kodUnitLuas.nama}</display:column>
                    <display:column title="Daerah" >${actionBean.daerah}</display:column>
                    <display:column title="Bandar/Pekan/Mukim" >${actionBean.bandar}</display:column>
                    ...
                    <display:column title="Lokasi Perbicaraan"><s:text name="lokasiBicara[${line_rowNum - 1}]" id="lokasiBicara${line_rowNum - 1}" value="lokasiBicara"/></display:column>
                </display:table>
            <br/><br/><br/>
