        ...
        <table width="90%" border="0" >
            ...
            <c:if test="${actionBean.urusanStatus eq 'PRMMK'}">
                <tr>
                    <td>&nbsp;</td>
                    <td>3.1</td>
                    <td colspan="2">Tiada ulasan daripada Jabatan Teknikal.</td>
                </tr>
            </c:if>
            ...
            <c:if test="${actionBean.openPTG}">
                <c:if test="${actionBean.viewOnlyPTG}">
                    ...
                    <tr>
                        ...
                        <c:if test="${actionBean.urusanStatus eq 'PRMMK'}"><td width="1%">5.</td></c:if>
                        ...
                        <c:forEach items="${actionBean.senaraiLaporanKandunganPerakuanPTG}" var="line">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <c:if test="${actionBean.urusanStatus eq 'PRMMK'}"><c:out value="5.${num}"/></c:if>
                                </td>
                                <td>
                                    ${line.kandungan}
                                </td>
    ...
    <c:if test="${!actionBean.edit}">
            ...
            --%>
                ...
                <c:if test="${actionBean.urusanStatus eq 'PRMMK'}">
                    <tr>
                        <td>&nbsp;</td>
                        <td width="1%"><b>3.1</b></td>
                        <td colspan="2"><div align="left">${actionBean.tajukUlasanJabatan}Tiada ulasan daripada Jabatan Teknikal.
                </c:if>
                <tr>
                    <td colspan="4">&nbsp;</td>
                </tr>
        ...
        <c:if test="${!actionBean.openPTG}">
            ...
            <c:if test="${actionBean.urusanStatus eq 'PRMMK'}">
                ...
                <tr>
                     <td>&nbsp;</td>
                     <td width="1%"><div align="right">5.1.</div></td>
