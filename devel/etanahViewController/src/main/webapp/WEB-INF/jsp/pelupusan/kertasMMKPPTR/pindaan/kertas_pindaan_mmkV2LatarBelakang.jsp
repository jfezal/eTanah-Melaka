<%-- 
    Document   : kertas_pindaan_mmkV2LatarBelakang
    Created on : Jul 4, 2013, 4:44:32 PM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_pindaan_MMKV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kTanah',q,
            function(data){
                $('#page_div').html(data);
