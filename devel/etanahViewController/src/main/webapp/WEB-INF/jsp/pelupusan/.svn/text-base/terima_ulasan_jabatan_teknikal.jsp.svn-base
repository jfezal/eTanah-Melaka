...
<script type="text/javascript">
    function editJabatanTeknikal(id, index, kod){
        window.open("${pageContext.request.contextPath}/pelupusan/jabatan_teknikal12?showEditJabatanTeknikal&idRujukan="+id + '&index=' +index+ '&kod='+kod, "eTanah",
...
<s:form beanclass="etanah.view.stripes.pelupusan.JabatanTeknikal2ActionBean">
    <div class="subtitle">
            ...
            <div class="content" align="center">
                <display:table class="tablecloth" name="${actionBean.senaraiRujukanLuar}" cellpadding="0" cellspacing="0" id="line"
                            ...
                            <c:if test="${line.agensi.kategoriAgensi.kod eq 'ADN'}">
                                <div align="center">
                                    <img alt='Adun' border='0' src='${pageContext.request.contextPath}/images/edit.gif' class='rem'
                                         id='edit_${line_rowNum}' onclick="editJabatanTeknikal('${line.idRujukan}','${line.agensi.kod}','${line.agensi.kategoriAgensi.kod}')">
                                </div>
                            </c:if>
                    ...
                    <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'LMCRG' || actionBean.permohonan.kodUrusan.kod eq 'PJLB' || actionBean.permohonan.kodUrusan.kod eq 'PPTR'}">
                        ...
                        --%>
                        <c:if test="${actionBean.stageId eq 'sedia_surat_ulasan_pengawal' or actionBean.stageId eq 'laporan_tanah' or actionBean.stageId eq '03laporan_tanah' or actionBean.stageId eq '08PenyelarasanUlsn' or actionBean.stageId eq '09TerimaJTEK_JKSMN'}">
                            <display:column title="Kemaskini">
                                <c:if test="${line.agensi.kategoriAgensi.kod eq 'ADN'}">
                                    <div align="center">
                                        <img alt='Adun' border='0' src='${pageContext.request.contextPath}/images/edit.gif' class='rem'
