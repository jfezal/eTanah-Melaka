...
<script type="text/javascript">
    ...
    function menyimpan(index,i,f){
        ...
        $.post('${pageContext.request.contextPath}/pelupusan/draf_jksmnns?simpanKandungan&index='+index+'&kandungan='+kand+'&viewMMKN='+viewMMKN,q,
        function(data){
            $('#page_div').html(data);
        }, 'html');
    }
    function deleteRow(idKandungan,f){
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var viewMMKN = $('#viewMMKN').val();
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/draf_jksmnns?deleteRow&idKandungan='+idKandungan+'&viewMMKN='+viewMMKN,q,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }}
    ...
    function addRow(index){
        var viewMMKN = $('#viewMMKN').val();
        var url = '${pageContext.request.contextPath}/pelupusan/draf_jksmnns?tambahRow&index='+index+'&viewMMKN='+viewMMKN;
...
<s:form beanclass="etanah.view.stripes.pelupusan.DrafJKSMNnsActionBean" name="form" id="form">
    ...
    <table width="80%" border="0">
        ...
        <c:if test="${!actionBean.viewForMMKN}">
            ...
            <c:forEach items="${actionBean.senaraiLaporanKandunganPerihalPermohonan}" var="line">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td style="display:none" valign="top">${line.idKandungan}</td><td valign="top"><c:out value="2.1.${k}"/></td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td><b>2.4</b></td>
            <td colspan="2"><div align="left"><b>KEADAAN TANAH</b></div></td>
        </tr>
        ...
        <tr>
            <td><b>3.</b></td>
            <td colspan="3"><div align="left"><b>ASAS PERTIMBANGAN</b></div></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><b>3.1</b></td>
            <td colspan="2"><div align="left"><b>Peruntukan Undang-Undang : </b></div></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>3.1.1 </td>
            <td>
                ${actionBean.asasPertimbangan}
                <!--
                <s:textarea name="asasPertimbangan" class="normal_text" rows="5" cols="150" readonly="true"/>
                -->
            </td>
        </tr>
        <tr>
        ...
        <%--|| actionBean.stageId eq '12MaklumJKSMN' || actionBean.stageId eq '13SediaMesyuaratJKSMN' || actionBean.stageId eq '14Semak' || actionBean.stageId eq '15SediaSuratMesyuarat' || actionBean.stageId eq '16TerimaMinitJKSMN' || actionBean.stageId eq '17Keputusan' || actionBean.stageId eq '18SediakanDrafMMK' || actionBean.stageId eq '19SemakDrafMMK' || actionBean.stageId eq '20SemakDrafMMKN' || actionBean.stageId eq '21SemakDrafMMKN' || actionBean.stageId eq '22PerakukanKrtsMMK' || actionBean.stageId eq '23CetakKrtsMMK' || actionBean.stageId eq '24TerimaKpsnMMK' || actionBean.stageId eq '25RekodKpsnMMK'--%>
        <%--actionBean.stageId eq '09_1SmkJKSM' and actionBean.stageId eq '10SmkJKSM' and--%>
        <!--UlasanJabatanTeknikal-->
        <%--<c:if test="${actionBean.stageId eq '11SahkanJKSMN'}">--%>
        <tr>
            <td><b>4.</b></td>
        ...
        <c:if test="${actionBean.viewMMKN}">
            <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'LMCRG' and actionBean.permohonan.kodUrusan.kod ne 'PJLB' and actionBean.permohonan.kodUrusan.kod ne 'MPJLB' and actionBean.permohonan.kodUrusan.kod ne 'PCRG'}">
                <tr>
                    <td><b>10.</b></td>
                    <td colspan="3"><div align="left"><b>HURAIAN PENTADBIR TANAH </b></div></td>
                </tr>
            </c:if>
        ...
        <c:if test="${!actionBean.viewMMKN}">
            <tr>
                <td><b>6.</b></td>
                <td colspan="3"><div align="left"><b>HURAIAN PENGARAH TANAH DAN GALIAN NEGERI SEMBILAN </b></div></td>
            </tr>
        </c:if>
        <c:if test="${actionBean.viewMMKN}">
        ...
        <c:forEach items="${actionBean.senaraiSyorPTG}" var="line">
            ...
            <tr>
                ...
                <td><s:textarea  id="kandungan11${i}"name="senaraiSyorPTG[${i-1}].kandungan" cols="80"  rows="5" class="normal_text"/>
                    <s:button value="Hapus" class="btn" name="tambah" onclick="deleteRow(${line.idKandungan})"></s:button>
                </td>
        ...
        <c:forEach items="${actionBean.penutup}" var="line">
            ...
            <tr>
                ...
                <td><s:textarea  id="kandungan12${i}"name="penutup[${i-1}].kandungan" cols="80"  rows="5" class="normal_text"/>
                    <s:button value="Hapus" class="btn" name="tambah" onclick="deleteRow(${line.idKandungan})"></s:button>
                </td>
