...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        {   
            ...
            var url = '${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?tambahRow&index='+index+'&kodSN='+kodSN+'&kodSK='+kodSK+'&idHakmilik='+idHakmilik+'&noPtSementara='+noPtSementara+'&idPermohonan='+idPermohonan;
            window.open(url, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
