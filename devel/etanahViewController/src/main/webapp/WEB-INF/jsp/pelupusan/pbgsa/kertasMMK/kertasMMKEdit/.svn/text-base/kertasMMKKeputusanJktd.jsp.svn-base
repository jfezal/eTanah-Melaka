<%-- 
    Document   : kertasMMKKeputusanJktd
    Created on : Jun 16, 2013, 10:55:53 PM
    Author     : afham
--%>
...
<title>Keputusan Mesyuarat Jawatankuasa Tanah Daerah</title>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_MMKPBGSA?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kKeputusanJktd',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kKeputusanJktd') ;
        }
    }
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasMMKPBGSAActionBean" name="form">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                    <legend>Keputusan Mesyuarat Jawatankuasa Tanah Daerah</legend>
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganKeputusanJktd}" var="line">
                        <tr>
                            ...
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiKandunganKeputusanJktd[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
