...
<script type="text/javascript">
    ...
    function refreshDrafJKBB(){
        var edit = $('#edit').val();    
        var url = '${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?refreshDrafJKBB&edit='+edit;
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function addPerihalTanah(){
        window.open("${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?showTambahPerihalTanah", "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=710,heighbayaranSyaratt=500,scrollbars=yes");
    }
    function addPerakuanPTD(){
        var edit = $('#edit').val();
        window.open("${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?showTambahPerakuanPTD&edit=" + edit, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=710,height=500,scrollbars=yes");
    }
    function addPerakuanPTG(){
        var edit = $('#edit').val();
        window.open("${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?showTambahPerakuanPTG&edit=" + edit, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=710,height=500,scrollbars=yes");
    }
    function addAsasTimbang(){
        window.open("${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?showTambahAsasPertimbangan", "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=710,height=500,scrollbars=yes");
    }
    ...
    function menyimpan(index,i,f)
    {
        ...
        var q = $(f).formSerialize();
        $.post('${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?simpanKandungan&index='+index+'&kandungan='+kand,q,
        function(data){
            $('#page_div').html(data);
        }, 'html');
    ...
    {
        var q = $(f).formSerialize();
        $.post('${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?tambahRow&index='+index,q,
        function(data){
            $('#page_div').html(data);
        }, 'html');
    }
    function deleteRow(idKandungan,f)
    {
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?deleteRow&idKandungan='+idKandungan,q,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
    ...
    function semakSyor(f,v){
        var q = $(f).formSerialize();
        $.post('${pageContext.request.contextPath}/pelupusan/draf_mmknLPSP?showsyortolaklulus&kpsn='+v,q,
        function(data){
            $('#page_div').html(data);
        }, 'html');
    }
...
<s:form beanclass="etanah.view.stripes.pelupusan.DrafMMKN_LPSPActionBean" name="form" id="form">
    <s:messages/>
    <s:errors/>
    ...
    <c:if test="${!actionBean.edit}"> 
        <table width="90%" border="0" >
            <c:if test="${actionBean.urusanStatus eq 'LPSP'}">
                <c:if test="${actionBean.stageId eq '19TrmDrafMMK'}">
                    <tr>
                        <td  colspan="4"><b>No. Rujukan: </b><s:text name="no_laporan" id="no_laporan" size="20"/></td>
                    </tr>
                </c:if>
                <c:if test="${actionBean.stageId eq '20SmkHuraian' || actionBean.stageId eq '21SmkHuraian' || actionBean.stageId eq '22SmkHuraian' || actionBean.stageId eq '23Perakuan' || actionBean.stageId eq '24CtkKrtsMMK' || actionBean.stageId eq '26SmkKptsn' || actionBean.stageId eq '27BuatSiasatan'}">
                    <tr>
                        <td colspan="4"><b>No. Rujukan: </b> ${actionBean.permohonankertas.noLaporan}</td>
                    </tr>
                </c:if>
            ...
            <tr>
                <td><b>3.</b></td>
                <td colspan="3"><b>ULASAN JABATAN-JABATAN TEKNIKAL 1</b></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <c:if test="${actionBean.kpsn eq 'SL'}">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td width="1%">&nbsp;</td>
                    <td colspan="2"><div align="left"><b><font style="text-transform: capitalize">SYARAT-SYARAT LPS</font></b></div></td>
                </tr>
                <tr id="catatanKegunaan">
                    <td>&nbsp;</td>
                    <td width="1%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <s:text name="amtLPS" size="20" onkeyup="validateNumber(this,this.value);"/>  Setahun
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td width="1%">iii.</td>
                    <td colspan="2">
                        <font color="red" size="4">*</font>Keluasan : 
                ...
                <tr id="luassbhgn">
                    ...
                    <td colspan="2">
                        <font color="red" size="4">*</font>Luas Diluluskan :
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td width="1%">&nbsp;</td>
                    <td colspan="2"><div align="left"><b><font style="text-transform: capitalize">SYARAT-SYARAT PERMIT</font></b></div></td>
                </tr> 
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="2"><div align="left">${actionBean.tempoh}${actionBean.noktahbertindih}<s:text name="syaratBahanBatu.tempohDisyor" id="syaratBahanBatu.tempohDisyor"/>
                            <c:if test="${actionBean.syaratBahanBatu.unitTempohKeluar.kod eq 'T'}"> 
                                Tahun
                            </c:if>
                            <c:if test="${actionBean.syaratBahanBatu.unitTempohKeluar.kod eq 'B'}"> 
                ...
                <tr>
                    ...
                    <td colspan="2"><div align="left">Jumlah Keseluruhan Bayaran Permit : RM <s:text name="totalAll" id="totalAll" readonly="true"/>                              
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td width="1%"><div align="right">&nbsp;</div></td>
                    <td colspan="2"><div align="left">Jumlah Keseluruhan Bayaran LPS dan Permit : RM <s:text name="totalLPSdanPermit" id="totalLPSdanPermit" readonly="true"/>                              
                </tr>
                <tr>
                    <td>&nbsp;</td>
