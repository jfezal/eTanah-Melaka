<%--
    Document   : edit_suami
    Created on : Aug 09, 2010, 12:04:35 PM
    Author     : Rohan
--%>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.MaklumatPemohonLPSActionBean">
        ...
        <fieldset class="aras1">
            ...
            <p>
                ...
                <s:text name="pemohonHbgn.tarikhLahir" size="40" id="tarikhLahir" class="datepicker" onchange="calculateUmar();" formatPattern="dd/MM/yy" />
            </p>
            <p>
                <label><font color="red">*</font>Umur :</label>
                <s:text name="pemohonHbgn.umur" size="10" maxlength="3"  id="umur" value="${actionBean.pemohonHbgn.umur}" onkeyup="validateNumber(this,this.value);"/>
            </p>
            ...
            <p>
                <label>&nbsp;</label>
                <s:submit name="simpanEditSuamiIsteri" id="simpan" value="Simpan" class="btn" />
