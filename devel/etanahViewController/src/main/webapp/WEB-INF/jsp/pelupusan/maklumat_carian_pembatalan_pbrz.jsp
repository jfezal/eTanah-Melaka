...
<script type="text/javascript">
    ...
    {
        var url = '${pageContext.request.contextPath}/pelupusan/maklumat_carian_pembatalan_pbrz?searchId&idPermohonanSebelum'+idPermohonanSebelum;
        $.get(url,
        function(data)
        {
            $('#page_div').html(data);
...
<s:form beanclass="etanah.view.stripes.pelupusan.MaklumatCarianPembatalanPBRZActionBean">
    <s:messages/>
    <s:errors/>
    <c:if test="${!status}"> 
        <div class="subtitle">
                ...
                <fieldset class="aras1">
                    ...
                    <div class="content" align="center">
                        <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" cellpadding="0" cellspacing="0"
                            ...
                            <display:column title="Luas" style="vertical-align:baseline"><fmt:formatNumber pattern="#,##0.0000" value="${line.luasTerlibat}"/>${actionBean.luasDrpTrizab}&nbsp;${line.kodUnitLuas.nama}</display:column>
