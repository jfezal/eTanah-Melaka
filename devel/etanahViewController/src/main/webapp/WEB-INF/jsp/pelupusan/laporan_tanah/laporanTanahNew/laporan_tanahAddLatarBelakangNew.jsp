...
//        var idHakmilik = $('#idHakmilik').val();
        window.open("${pageContext.request.contextPath}/common/laporan/tanah/laporantanahNewActionBean?latarBelakang&idMohonHakmilik="
            +idMohonHakmilik, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=1000,height=500,scrollbars=yes");
        //        "status=0,toolbar=0,location=0,menubar=0,width=2000,height=900,scrollbars=yes,fullscreen=yes");
    }
    ...
    function addMohonLaporPohon(){
        NoPrompt();
        var idHakmilik = $('#idHakmilik').val();
        window.open("${pageContext.request.contextPath}/pembangunan/laporanTanahv2?showFormPopUpLatarBelakangTanah&idHakmilik="+idHakmilik+"&idLaporTanah="+${actionBean.idLaporTanah}, "eTanah",
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <tr id="carian">
                        <td colspan="2">
                            ...
                            &nbsp;<s:button name="tutup" value="Kembali" class="btn" onclick="kembali('${actionBean.hakmilikPermohonan.id}')"/>
                ...
                <fieldset class="aras1">
                    ...
                    <table class="tablecloth" border="0" align="center">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <s:submit name="simpanLatarBelakangTanah" value="Simpan" class="btn"/>
