...
<script type="text/javascript">
    ...
    {   
        ...
        var idPermohonan = $('#idPermohonan').val() ;
            var url = '${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?tambahRow&index='+index+'&idHakmilik='+idHakmilik+'&noPtSementara='+noPtSementara+'&idPermohonan='+idPermohonan+'&jenisLaporan=${actionBean.jenisLaporan}';
            window.open(url, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=PPTKanan&idPermohonan=${actionBean.idPermohonan}&jenisLaporan=${actionBean.jenisLaporan}',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.openFrame('syorPPTKanan') ;
        }
    }
