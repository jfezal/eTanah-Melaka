...
<s:form beanclass="etanah.view.stripes.pelupusan.Pengesahan_PembaharuanLPS_pejabatTanah_ActionBean">
    <s:messages/>
    <div class="subtitle">
        <fieldset class="aras1">
            <legend align="center">Pengesahan Pembaharuan Lesen</legend>
        ...
        <center><s:button name="simpanSyarat" id="simpan" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/></center>
        </fieldset>
    </div>
