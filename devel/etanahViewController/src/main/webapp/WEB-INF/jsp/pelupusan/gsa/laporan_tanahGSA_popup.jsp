...
<div class="subtitle">
    <s:form beanclass="etanah.view.stripes.pelupusan.LaporanTanahGSAPelupusanActionBean" >
            ...
            <div class="content" align="center">
                <table class="tablecloth" border="0">
                    ...
                    <tr>
                            ...
                            <td>
                                 <c:if test="${!edit}">
                                    <s:submit name="simpanBangunan" value="Simpan" class="btn"/>
                                 </c:if>                                
                                 <c:if test="${edit}">
                                    <s:submit name="editBangunan" value="Kemaskini" class="btn"/>    
                                </c:if>                                
