                        ...
                        <table class="tablecloth" border="0" align="center">
                            ...
                            <c:forEach items="${actionBean.senaraiKandunganPenutup}" var="line">
                                <tr>
                                    ...
                                    <td>
                                        <s:textarea  id="kandungan5${i}" name="senaraiKandunganPenutup[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
                            ...
                            <tr>
                                <td style="text-align:center;" colspan="3">      
                                    <s:button value="Tambah" class="btn" name="simpan1"  onclick="addRow('13',this.form)"/>
                                    <s:submit name="simpanKandungan" value="Simpan 1" class="btn" onclick="NoPrompt();"/>
                                    <s:hidden name="indexKertas" id="indexKertas" value="13"/>
