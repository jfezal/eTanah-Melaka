...
<s:form beanclass="etanah.view.stripes.pelupusan.RisalatMMKNActionBean">
    <s:messages/>
    <s:errors/>
            ...
            <div class="content">
                ...
                <div align="center">
                    <table class="tablecloth" border="0" width="90%">
                        ...
                        <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'PBMT' and actionBean.permohonan.kodUrusan.kod ne 'PPTR' and actionBean.permohonan.kodUrusan.kod ne 'LPSP' and actionBean.permohonan.kodUrusan.kod ne 'PLPS' and actionBean.permohonan.kodUrusan.kod ne 'PBGSA'}">
                        ...
                        <tr><td><b>Ulasan ADUN</b></td>
                            <c:if test="${edit}">
                                <td>${actionBean.ulasanAdun} &nbsp;</td>
                            </c:if>
