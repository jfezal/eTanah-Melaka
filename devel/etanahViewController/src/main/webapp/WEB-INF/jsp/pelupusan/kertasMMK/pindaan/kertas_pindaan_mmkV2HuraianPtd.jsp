...
<title>Huraian Pentadbir Tanah</title>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_pindaan_MMKV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kHuraianPtd',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kHuraianPtd') ;
        }
    }
            ...
            <fieldset class="aras1">
                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganHuraianPtd}" var="line">
                        <tr>
                            <td style="text-align: right"><c:out value="3.${num}"/></td>
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiKandunganHuraianPtd[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
