                ...
                <table class="tablecloth" border="0" align="center">
                    ...
                    <tr>
                        <td style="text-align:center;" colspan="3">      
                            <s:hidden name="idMohonHakmilik" value ="${actionBean.idMohonHakmilik}"  id="idMohonHakmilik"/>
                            <s:hidden name="idLaporTanah" value ="${actionBean.idLaporTanah}" id="idLaporTanah"/>
