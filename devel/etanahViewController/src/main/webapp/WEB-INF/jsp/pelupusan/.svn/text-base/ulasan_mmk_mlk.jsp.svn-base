                   ...
                   <%-- <c:if test="${edit}">
                    ...
                    <c:if test="${!edit}">
                        ...
                        <tr><td><b><font style="text-transform: uppercase">PERMOHONAN DARIPADA  ${actionBean.pemohon.pihak.nama}  UNTUK  ${actionBean.permohonan.kodUrusan.nama} BAGI ${actionBean.lokasi}
                                        ...
                                        UNTUK TUJUAN ${actionBean.permohonan.sebab}<%--${actionBean.permohonan.kegunaanTanah.nama}
                    ...
                    <c:if test="${!edit}">
                        ...
                        <c:if test="${edit}">
                            <tr><td><s:textarea name="pembangunanDicadang" rows="5" cols="160"/></td></tr><br>
                        </c:if>
                        <c:if test="${!edit}">
                            <tr><td><font style="text-transform:capitalize">4.1 &nbsp; ${actionBean.pembangunanDicadang}</font></td></tr><br>
                        </c:if>
                       ...
                       <c:if test="${edit}">
                           <tr><td>
                                   <table border="0" width="96%" id="tblhuraian">
                                       <tr><td><b><font style="text-transform: uppercase">6. HURAIAN PENTADBIR TANAH  ${actionBean.peng.kodCawangan.daerah.nama}&nbsp;</font></b></td></tr>
                            ...
                            <tr><td><b><font style="text-transform: uppercase">7. SYOR PENTADBIR TANAH  ${actionBean.peng.kodCawangan.daerah.nama}&nbsp;</font></b></td></tr>
                        ...
                        <c:if test="${edit}">
                            <tr><td><b>8. HURAIAN PENGARAH TANAH DAN GALIAN NEGERI MELAKA</b></td></tr>
                            <tr><td><s:textarea name="huraianPtg" rows="5" cols="160"/></td></tr><br>
                            <tr><td><b>9. SYOR PENGARAH TANAH DAN GALIAN NEGERI MELAKA</b></td></tr>
                        ...
                        <c:if test="${!edit}">
                            ...
                            <tr><td width="100%">10.1 Dibentangkan untuk pertimbangan dan keputusan Majlis Mesyuarat Kerajaan Negeri Melaka.</td></tr><br>
                        </table>
                    <c:if test="${edit}">
                        <br>
                        <p align="center">
