...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        function refreshDrafJKBB(){
            var edit = $('#edit').val();
            var url = '${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?refreshDrafJKBB&edit='+edit;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
        ...
        function addPerihalTanah(){
            window.open("${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?showTambahPerihalTanah", "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=710,heighbayaranSyaratt=500,scrollbars=yes");
        }
        function addPerakuanPTD(){
            var edit = $('#edit').val();
            window.open("${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?showTambahPerakuanPTD&edit=" + edit, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=710,height=500,scrollbars=yes");
        }
        function addPerakuanPTG(){
            var edit = $('#edit').val();
            window.open("${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?showTambahPerakuanPTG&edit=" + edit, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=710,height=500,scrollbars=yes");
        }
        function addAsasTimbang(){
            window.open("${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?showTambahAsasPertimbangan", "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=710,height=500,scrollbars=yes");
        }
        ...
        function menyimpan(index,i,f)
        {
            ...
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?simpanKandungan&index='+index+'&kandungan='+kand,q,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        ...
        {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?tambahRow&index='+index,q,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
        function deleteRow(idKandungan,f)
        {
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?deleteRow&idKandungan='+idKandungan,q,
                function(data){
                    $('#page_div').html(data);
                }, 'html');
            }
        ...
        function semakSyor(f,v){
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/draf_mmk_bmbtns?showsyortolaklulus&kpsn='+v,q,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
...
<s:form beanclass="etanah.view.stripes.pelupusan.DrafMMK_BMBTActionBean" name="form" id="form">
    <s:messages/>
    <s:errors/>
        ...
        <table width="90%" border="0" >
                    ...
                    <div class="subtitle" style="text-transform: capitalize">
                        ...
                        <fieldset class="aras1">
                            ...
                            <%--<c:if test="${actionBean.urusanStatus eq 'BMBT'}">
                                <c:if test="${actionBean.stageId eq '24TrmDrfMMK'}">
                                    No. Rujukan : <s:text name="no_ruj" id="no_ruj" size="20"/><br><br>
                                </c:if>
                                <c:if test="${actionBean.stageId eq '25SmkDrfMMK' or actionBean.stageId eq '26SmkDrfMMK' or actionBean.stageId eq '27SmkDrfMMK'}">
                                    No. Rujukan : ${actionBean.permohonankertas.noLaporan}<br><br>
                                </c:if>
                            </c:if>
                            <c:if test="${actionBean.urusanStatus eq 'PTBTC'}">
                                <c:if test="${actionBean.stageId eq '24TrmDrfMMK'}">
                                    No. Rujukan : <s:text name="no_ruj" id="no_ruj" size="20"/><br><br>
                                </c:if>
                                <c:if test="${actionBean.stageId eq '25SmkDrfMMK' or actionBean.stageId eq '26SmkDrfMMK' or actionBean.stageId eq '27SmkDrfMMK'}">
                            ...
                            <c:if test="${actionBean.urusanStatus eq 'PTBTS'}">
                                <c:if test="${actionBean.stageId eq '24TrmDrfMMK'}">
                                    No. Rujukan : <s:text name="no_ruj" id="no_ruj" size="20"/><br><br>
                                </c:if>
                                <c:if test="${actionBean.stageId eq '25SmkDrfMMK' or actionBean.stageId eq '26SmkDrfMMK' or actionBean.stageId eq '27SmkDrfMMK'}">
                            ...
                            <legend>
                                <c:if test="${actionBean.urusanStatus eq 'BMBT' || actionBean.urusanStatus eq 'PTBTS' || actionBean.urusanStatus eq 'PTBTC'}">DRAF MMK</c:if>
                            </legend>
                            <p align="center">
                                <b> </b>
                            </p>
            ...
            <tr>
                ...
                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'BMBT' || actionBean.permohonan.kodUrusan.kod eq 'PTBTC' || actionBean.permohonan.kodUrusan.kod eq 'PTBTS'}">
                    <td colspan="3"><div align="left"><b>LATAR BELAKANG TANAH BAWAH TANAH</b></div></td>
                </c:if>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <c:if test="${actionBean.openPTD}">
                <c:if test="${actionBean.viewOnlyPTD}">
                    ...
                    <tr>
                        <c:if test="${actionBean.urusanStatus eq 'BMBT' ||actionBean.urusanStatus eq 'PBPTC' || actionBean.urusanStatus eq 'PBPTS'}"><td width="1%">3.</td></c:if>
    ...
    <c:if test="${!actionBean.edit}">
        <table width="90%" border="0" >
                ...
                <td colspan="4">
                    <div class="subtitle" style="text-transform: capitalize">
                        <fieldset class="aras1">
                            ...
                            <legend> </legend>
                            <c:if test="${actionBean.urusanStatus eq 'BMBT' || actionBean.urusanStatus eq 'PBPTC' || actionBean.urusanStatus eq 'PBPTS'}">
                                <center>DRAF KERTAS MAJLIS MESYUARAT KERAJAAN (MMK)</center>
                            </c:if>
                            <p align="center">
                                <b> </b>
                            </p>
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td colspan="4"><div align="left"><b>Keadaan sekeliling tanah adalah seperti berikut :-</b></div></td>
            </tr>

            <tr><td colspan="6">
                    <div class="content" align="center">
                        <display:table class="tablecloth" name="${actionBean.laporTanahSempadanList}" cellpadding="0" cellspacing="0"
                                       requestURI="/pelupusan/draf_mmk_bmbtns" id="line">
                            <display:column title="Kedudukan">
                                <c:if test="${line.jenisSempadan eq 'U'}">
                                    Utara
                                </c:if>
            ...
            <c:if test="${actionBean.editPTD eq true}">
                ...
                <c:forEach items="${actionBean.senaraiLaporanAsasPertimbangan}" var="line">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${actionBean.urusanStatus eq 'BMBT'}"><c:out value="3.${num}"/></c:if>
                        </td>
                        <td>
                            <c:if test="${!actionBean.edit}">
                ...
                <tr>
                    <td>
                        <c:if test="${actionBean.urusanStatus eq 'BMBT' or actionBean.urusanStatus eq 'PTBTC' or actionBean.urusanStatus eq 'PTBTS'}"><b>4.</b></c:if>
                    </td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td colspan="2">
                        <c:if test="${actionBean.urusanStatus eq 'BMBT' || actionBean.urusanStatus eq 'PTBTC' || actionBean.urusanStatus eq 'PTBTS'}">
                            <c:if test="${actionBean.kpsn eq 'SL'}">
                                <c:if test="${!viewOnlyPTD}">
                                    <br>
                                    Isipadu &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: ${actionBean.hakmilikPermohonan.luasTerlibat} ${actionBean.hakmilikPermohonan.kodUnitLuas.nama} <br>
                                    Jarak Kedalaman : ${actionBean.hakmilikPermohonan.kedalamanTanah} ${actionBean.hakmilikPermohonan.kedalamanTanahUOM.nama}
                                </c:if>
                                <c:if test="${viewOnlyPTD}">
                                    <br>
                                    Isipadu &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: ${actionBean.hakmilikPermohonan.luasTerlibat} ${actionBean.hakmilikPermohonan.kodUnitLuas.nama}<br>
                        ...
                        <c:if test="${actionBean.urusanStatus ne 'BMBT' && actionBean.urusanStatus ne 'PTBTC' && actionBean.urusanStatus ne 'PTBTS'}">
                            <c:if test="${actionBean.kpsn eq 'SL'}">
                                <c:if test="${!viewOnlyPTD}">
                                    Luas : ${actionBean.hakmilikPermohonan.luasTerlibat} ${actionBean.hakmilikPermohonan.kodUnitLuas.nama}
                                </c:if>
                ...
                <c:forEach items="${actionBean.senaraiLaporanKandunganPerakuanPTD}" var="line">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${actionBean.urusanStatus eq 'BMBT' or actionBean.urusanStatus eq 'PTBTC' or actionBean.urusanStatus eq 'PTBTS'}"><c:out value="4.${num}"/></c:if>
                        </td>
                        <td>
                            <c:if test="${!actionBean.edit}">
            ...
            <c:if test="${actionBean.editPTD eq false}">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <c:if test="${actionBean.urusanStatus eq 'BMBT' or actionBean.urusanStatus eq 'PTBTC' or actionBean.urusanStatus eq 'PTBTS'}">
                            <c:if test="${actionBean.kpsn eq 'SL'}">
                                <c:if test="${!viewOnlyPTD}">
                                    <br>
                                    Isipadu &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: ${actionBean.hakmilikPermohonan.luasTerlibat} ${actionBean.hakmilikPermohonan.kodUnitLuas.nama} <br>
    ...
    END OF PERAKUAN PTD
            ...
            <c:if test="${actionBean.editPTD eq true}">
                <c:if test="${actionBean.urusanStatus ne 'BMBT' and actionBean.urusanStatus ne 'PTBTC' and actionBean.urusanStatus ne 'PTBTS'}">
                    <tr>
                        <td colspan="4">
                            <center>
                                <s:button name="SimpandrafJKBB" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
            ...
            <c:if test="${actionBean.urusanStatus eq 'BMBT' or actionBean.urusanStatus eq 'PTBTC' or actionBean.urusanStatus eq 'PTBTS'}">
                <c:if test="${actionBean.stageId eq '20TrmImbsKptsnJKTD'}">
                    <tr>
                        <td colspan="4">
                            <center>
                                <s:button name="SimpandrafJKBB" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
