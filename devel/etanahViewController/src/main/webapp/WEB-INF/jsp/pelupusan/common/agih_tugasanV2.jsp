...
<s:useActionBean beanclass="etanah.view.stripes.pelupusan.AgihanTugasDisV2ActionBean" var="penggunaperanan"/>
<s:form beanclass="etanah.view.stripes.pelupusan.AgihanTugasDisV2ActionBean">
    <s:messages/>
    <s:errors/>
    <div class="subtitle">
