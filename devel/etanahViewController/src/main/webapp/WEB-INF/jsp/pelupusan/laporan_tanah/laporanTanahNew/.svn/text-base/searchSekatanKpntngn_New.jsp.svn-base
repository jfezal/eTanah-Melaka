...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.common.laporan.tanah.laporantanahNewActionBean" name="form">
        ...
        <fieldset class="aras1">
            <legend></legend>
            <p>
                <display:table style="width:100%" class="tablecloth" name="${actionBean.disSyaratSekatan.listKodSekatan}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/common/laporan/tanah/laporantanahNewActionBean" id="line">
