            ...
            <fieldset class="aras1">
                ...
                <c:choose>
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <c:if test="${actionBean.hakmilikPermohonan.permohonan.kodUrusan.kod ne 'NT6A'}">
                            <table class="tablecloth" align="center">
                                <tr>
                                    <td>
                                        <font color="red" size="4">*</font>Syor ${actionBean.hakmilikPermohonan.permohonan.kodUrusan.kod}: 
                                    </td>
                                    <td>
                        ...
                        <c:if test="${actionBean.hakmilikPermohonan.permohonan.kodUrusan.kod eq 'NT6A'}">
                            <table class="tablecloth" align="center">
                                <tr>
                                    <td>
                                        <font color="red" size="4">*</font>Syor ${actionBean.hakmilikPermohonan.permohonan.kodUrusan.kod}: 
                                    ...
                                    <td>
                                        <s:radio name="ksn" id="ksn" value="SL" onclick="" />&nbsp;Sokong
                                        <s:radio name="ksn" id="ksn" value="ST" onclick="showplpstidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                                        <s:hidden name="syorKpsn" id="syorKpsn"/>
                                    </td>
