<%-- 
    ...
    Created on : June 24, 2011, 12:07:56 PM
    Author     : Murali
--%>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.LaporanTanah4ActionBean" >
        ...
        <fieldset class="aras1">
            ...
            <%--<p>
                ...
                <s:text name="permohonanLaporanBangunan.ukuran" id="ukuran" size="12" onkeyup="validateNumber(this,this.value);"/>&nbsp;Tingkat
            </p>--%>
            <p>
                <label>Keluasan Bangunan :</label>
