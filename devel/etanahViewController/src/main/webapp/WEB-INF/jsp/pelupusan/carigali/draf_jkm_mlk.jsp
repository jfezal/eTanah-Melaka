<%-- 
    ...
    Created on : Aug 15, 2011, 2:03:09 PM
    Author     : shah
--%>
...
<script type="text/javascript">
    ...
    function menyimpan(index,i,f){
        ...
        $.post('${pageContext.request.contextPath}/pelupusan/draf_jkm?simpanKandungan&index='+index+'&kandungan='+kand+'&viewMMKN='+viewMMKN,q,
        function(data){
            $('#page_div').html(data);
        }, 'html');
    }
    function deleteRow(idKandungan,f){
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var viewMMKN = $('#viewMMKN').val();
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/draf_jkm?deleteRow&idKandungan='+idKandungan+'&viewMMKN='+viewMMKN,q,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }}
    ...
    function addRow(index){
        var viewMMKN = $('#viewMMKN').val();
        var url = '${pageContext.request.contextPath}/pelupusan/draf_jkm?tambahRow&index='+index+'&viewMMKN='+viewMMKN;
...
<s:form beanclass="etanah.view.stripes.pelupusan.DrafJKMActionBean" name="form" id="form">
