...
<script type="text/javascript">       
    ...
    <%--alert(id);--%>
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pelupusan/kertas_pindaan_MMKV2?showFormPopUp", "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        {   
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                ...
                $.post('${pageContext.request.contextPath}/pelupusan/kertas_pindaan_MMKV2?deleteRow&idKandungan='+idTuntutanKos+'&tName='+tName,q,
                function(data){
                    $('#page_div').html(data);
        ...
        {
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pelupusan/kertas_pindaan_MMKV2?showFormKemaskiniNilai&idTuntutanKos="+idTuntutanKos, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
