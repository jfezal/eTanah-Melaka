                ...
                <div class="content" align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikImejLaporanListEdit}" pagesize="5" cellpadding="0" cellspacing="0" id="line"
                        ...
                        <display:column title="Hapus1">
                            <div align="center">
                                <a onclick="deleteImage(${actionBean.hakmilikPermohonan.id}, '${line.idImej}', '${line.dokumen.idDokumen}', '${line.catatan}', '${line.laporanTanahSempadan.idLaporTanahSpdn}', 'imgPopup', this.form);" onmouseover="this.style.cursor = 'pointer';" ><img alt="Hapus" height="20px" width="20px" src='${pageContext.request.contextPath}/pub/images/not_ok.gif'/></a>
                            </div>  <%--alert('edit'+${line.idLaporBangunan});--%>
                        </display:column>
                    </display:table>
                </div>
            ...
            <p>
                ...
                <c:choose>
                    <c:when test="${actionBean.pandanganImej eq 'H'}"> 
                        <s:button name="close" value="Kembali" class="btn" onclick="kembali('${actionBean.hakmilikPermohonan.id}','${actionBean.laporanTanah.idLaporan}')"/>
                    </c:when>
                    <c:when test="${actionBean.pandanganImej eq 'U'}">
                        <s:button name="close" value="Kembali" class="btn" onclick="kembali('${actionBean.hakmilikPermohonan.id}','${actionBean.laporanTanah.idLaporan}')"/>
                    </c:when>
