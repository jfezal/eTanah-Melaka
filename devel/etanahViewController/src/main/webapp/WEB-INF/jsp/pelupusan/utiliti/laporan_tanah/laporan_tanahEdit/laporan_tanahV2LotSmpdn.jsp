...
<script type="text/javascript">
    ...
    <%--alert(id);--%>
            ...
            var idPermohonan = $('#idPermohonan').val() ;
            //            alert(idHakmilik);
            window.open("${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?showFormPopUp&idHakmilik="+idHakmilik+"&noPtSementara="+noPtSementara+"&idPermohonan="+idPermohonan, "eTanah",
        ...
        function editSmpdn(idKandungan)
        {
            ...
            var noPtSementara = $('#noPtSementara').val();
            var idPermohonan = $('#idPermohonan').val() ;
            window.open("${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?showFormPopUp&idKandungan="+idKandungan+"&idHakmilik="+idHakmilik+"&noPtSementara="+noPtSementara+"&idPermohonan="+idPermohonan, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
    ...
    <c:choose>
        ...
        function uploadForm(pandanganImej,idlaporTnhSmpdn) {
            ...
            var idPermohonan = $('#idPermohonan').val() ;
            //            alert(idLapor);
            window.open("${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?uploadDoc&pandanganImej="+pandanganImej+"&idLapor="+idLapor+"&idlaporTnhSmpdn="+idlaporTnhSmpdn+"&idHakmilik="+idHakmilik+"&noPtSementara="+noPtSementara+"&idPermohonan="+idPermohonan, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
