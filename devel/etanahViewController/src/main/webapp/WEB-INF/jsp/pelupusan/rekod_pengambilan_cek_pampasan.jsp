<%-- 
    Document   : rekod_pengambilan_cek_pampasan
    Created on : Jan 20, 2010, 10:28:43 AM
...
<s:form beanclass="etanah.view.pelupusan.PelupusanActionBean">
    <p>REKOD PENGAMBILAN CEK PAMPASAN</p>
    <div class="subtitle">
   ...
   <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                ...
                <display:table name="" id="line" class="tablecloth">
                    ...
                    <display:column title="No. Kad Penganalan"/>
                    <display:column title="Alamat"/>
                    <display:column title="No. Dokumen"/>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                Maklumat Pendaftaran Pengambilan Dokumen
            </legend>
            <p>
                <label>&nbsp;</label>
                <display:table name="" id="line" class="tablecloth">
