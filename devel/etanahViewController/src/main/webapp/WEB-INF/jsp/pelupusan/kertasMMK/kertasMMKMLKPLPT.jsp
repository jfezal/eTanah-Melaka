...
<script type="text/javascript">
    ...
    function openFrame(type){
        doBlockUI();
        window.open("${pageContext.request.contextPath}/pelupusan/kertas_MMK_plpt?openFrame&type="+type, "eTanah",
    ...
    function openFramejtek(type,index){
        doBlockUI();
        window.open("${pageContext.request.contextPath}/pelupusan/kertas_MMK_plpt?openFramejtek&type="+type+'&index='+index, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=1000,height=500,scrollbars=yes");
        //        "status=0,toolbar=0,location=0,menubar=0,width=2000,height=900,scrollbars=yes,fullscreen=yes");
    }
    
    function refreshV2KertasMMK(type){
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_MMK_plpt?refreshpage&type='+type;
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
...
<s:form beanclass="etanah.view.stripes.pelupusan.KertasMMKPLPTActionBean">
    <s:errors/>
    <s:messages/>
