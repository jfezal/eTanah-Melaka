<%--
    Document   :  syorPPRU.jsp (laporan_tanahEdit)
                        ...
                        <div id="pprusokong">
                            <table class="tablecloth" align="center">
                                <tr>
                                    ...
                                    <td>
                                        <s:text name="hakmilikPermohonan.luasDiluluskan" formatPattern="#,###,##0.0000" size="20" onkeyup="validateNumber(this,this.value);"/>
                                        <s:select name="kodU" id="koduom" style="width:120px">
                                            <s:option value="">Sila Pilih</s:option>
                                            <s:option value="M">Meter Persegi</s:option>
                                            <s:option value="MP">Meter Padu</s:option>
                                        </s:select>
                                ...
                                <tr>
                                    <td><font color="red" size="4">*</font>Bayaran (RM) :</td>
                                    <td>
                                        <s:text name="amnt" size="20" formatPattern="0.00" onkeyup="validateNumber(this,this.value);"/>
                                    </td>
                                </tr>                                
                            </table>
                        </div>
