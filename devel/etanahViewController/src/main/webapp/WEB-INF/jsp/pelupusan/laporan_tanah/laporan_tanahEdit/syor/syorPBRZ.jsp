<%--
    Document   :  syorPBRZ(Editable).jsp
...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.ksn ne null}">
        ...
        function showpbrztidaksokong(val) {
            $('#pbrztidaksokong').show();
            $('#pbrzsokong').hide();
            if(val == 'SL'){
                val = 'ST';
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showpbrzsokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showpbrztidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                        ...
                        <div id="pbrztidaksokong">

                        </div>
                    </c:when>
                    <c:when test="${actionBean.kodNegeri eq '05'}">
                        <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'BMRE' and actionBean.permohonan.kodUrusan.kod ne 'WMRE' and actionBean.permohonan.kodUrusan.kod ne 'MMRE'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                <td>
                                    <font color="red" size="4">*</font>Syor : 
