...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_JKBBV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kPemohon',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kPemohon') ;
        }
    }
            ...
            <fieldset class="aras1">
                ...
                <table class="tablecloth" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiKandunganPemohon}" var="line">
                        <tr>
                            <td style="text-align: right"><c:out value="2.3.${num}"/></td>
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiKandunganPemohon[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
