...
<s:form beanclass="etanah.view.stripes.pelupusan.DrafWartaPRIZActionBean">
        ...
        <fieldset class="aras1">
           ...
           <%-- <p>
            ...
            <p>
                ...
                <%--trizabPermohonan.tarikhPengesahanWarta--%>
                <s:text name="tarikhPengesahanWarta"  class="datepicker" id="tarikh1" formatPattern="dd/MM/yyyy"/>
            </p>
            <br>
            <p>
                <label>&nbsp;</label>
