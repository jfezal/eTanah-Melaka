<%-- 
    Document   : tambah_ahli_lembaga_pengarah
    Created on : Oct 20, 2010, 9:47:10 AM
    Author     : Rohan
--%>
...
<%--              <p>
                <label for="alamat">Aktiviti Perniagaan :</label>
                <s:text name="pihak1.aktivitiPerniagaan" size="40" id="aktivitiPerniagaan" onkeyup="this.value=this.value.toUpperCase();"/>
            </p>--%>
            <%--<p>
