...
<title>ULASAN PENASIHAT UNDANG-UNDANG NEGERI</title>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_MMKV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kUlasanPenasihat',q,
            function(data){
                $('#page_div').html(data);

            }, 'html');
            self.refreshpage2('kUlasanPenasihat') ;
        }
    }
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.KertasMMKV2ActionBean" name="form">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                    <legend>ULASAN PENASIHAT UNDANG-UNDANG NEGERI</legend>
                <table class="tablecloth" border="0" align="center">
                    ...
                    <c:forEach items="${actionBean.senaraiUlasanPenasihat}" var="line">
                        <tr>
                            ...
                            <td>
                                <s:textarea  id="kandungan5${i}" name="senaraiUlasanPenasihat[${i-1}].kandungan" cols="80"  rows="5" onclick="checkKandungan(${i})" onblur="setKandungan(${i},${line.idKandungan})" class="normal_text"/>
                    ...
                    <tr>
                        <td style="text-align:center;" colspan="3">      
                            <s:button value="Tambah" class="btn" name="simpan1"  onclick="addRow('11',this.form)"/>
                            <s:submit name="simpanKandungan" value="Simpan" class="btn" onclick="NoPrompt();"/>
                            <s:hidden name="indexKertas" id="indexKertas" value="11"/>
