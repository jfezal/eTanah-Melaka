...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.kodRizab eq null}">
            $('#catatanKwsn').hide();
    </c:if>
    <c:if test="${actionBean.kodRizab ne null and actionBean.kodRizab eq '99'}">
            $('#catatanKwsn').show();
    </c:if>
        });
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.LaporanTanahGSAPelupusanActionBean" name="test">
        <s:errors/>
        <s:messages/>
                ...
                <div id="perihaltanah">
                    ...
                    <table class="tablecloth" border="0" align="center">
                        ...
                        <tr id="catatanKwsn">
                            ...
                            <td style="color:black">:</td>
                            <td align="left" style="color:black">
                                <s:textarea name="addcatatan" rows="5" cols="50" />
                            </td>
                        </tr>
                        <tr>
