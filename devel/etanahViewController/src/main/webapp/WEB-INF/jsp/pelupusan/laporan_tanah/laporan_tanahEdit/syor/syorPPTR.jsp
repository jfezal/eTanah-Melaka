<%--
    Document   :  syorPPTR(Editable).jsp
    Created on :  March 22, 2012, 12:07:00 PM
    Author     :  Shazwan
--%>
...
<script type="text/javascript">
    ...
    <c:choose>
     ...
     <c:choose>
        ...
        function showpptrtidaksokong(val) {
            $('#pptrtidaksokong').show();
            $('#pptrsokong').hide();
            setKpsn2(val);
            if(val == 'SL'){
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showpptrsokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showpptrtidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
                        ...
                        <div id="pptrsokong">
                            <table class="tablecloth" align="center">
                                <tr>
                                    <td>
                                        <font color="red" size="4">*</font>Pilih Syor :
                                    </td>
                                    <td>
                        ...
                        <div id="pptrsokong">
                            <table class="tablecloth" align="center">
                                ...
                                <tr>
                                    <td><font color="red" size="4">*</font>Luas DiSyorkan :</td>
                                    <td>
                                        <s:text name="hakmilikPermohonan.luasDiluluskan" formatPattern="0#######.####" size="15"/>
                                        <s:select name="kodU" id="koduom">
                                            <s:option value="">Sila Pilih</s:option>
                                            <s:option value="M">Meter Persegi</s:option>
                                            <s:option value="H">Hektar</s:option>
