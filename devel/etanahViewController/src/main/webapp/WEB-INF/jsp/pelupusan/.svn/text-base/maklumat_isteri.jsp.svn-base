<%--
    Document   : maklumat_isteri
    Created on : Jul 9, 2010, 12:52:44 AM
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.MaklumatPemohonActionBean">
        ...
        <c:if test="${!actionBean.tambahCawFlag}">
            ...
            <fieldset class="aras1">
                <legend>Kemasukan Maklumat Suami/Isteri Pemohon</legend><br/>
                ...
                <c:if test="${actionBean.cariFlag}">
                    <c:if test="${!actionBean.tiadaDataFlag}">
                        <p>
                            <label for="nama"><font color="red">*</font>Nama Suami/Isteri:</label>
                        ...
                        <c:if test="${actionBean.pemohonHubungan.jenisPengenalan.kod eq 'B' || actionBean.pemohonHubungan.jenisPengenalan.kod eq 'L' || actionBean.pemohonHubungan.jenisPengenalan.kod eq 'P' || actionBean.pemohonHubungan.jenisPengenalan.kod eq 'T' || actionBean.pemohonHubungan.jenisPengenalan.kod eq 'I'}">
                            ...
                            <p>
                                ...
                                <s:text name="pemohon.gaji" id="gaji" size="40" onkeyup="validateNumber(this,this.value);"/>
                            </p>
                            <p>
                            ...
                            <p id="majikanAlamat1">
                                <label for="alamat"><font color="red">*</font>Alamat Majikan: </label>
                    ...
                    <%--tiada data--%>
                    <c:if test="${actionBean.tiadaDataFlag}">
                       <s:hidden name="isteri" value="maklumatistire"/>
                        <p>
                            <label for="nama"><font color="red">*</font>Nama Suami/Isteri :</label>
...
--%>
                ...
                <c:if test="${!actionBean.cariFlag}">
                    <p>
                        <label>&nbsp;</label>
                        <s:submit name="cariSuamiIsteriPemohon" value="Cari" class="btn"/>
                ...
                <c:if test="${actionBean.cariFlag}">
                    <p>
                        <label>&nbsp;</label>
                        <%--<s:button name="simpanIsteri" id="simpan" value="Simpan" class="btn" onclick="saveMaklumatIsteri(this.name, this.form);"/>--%>
