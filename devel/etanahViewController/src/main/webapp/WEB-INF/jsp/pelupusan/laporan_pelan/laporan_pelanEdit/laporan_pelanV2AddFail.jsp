<%-- 
    Document   : laporan_pelanV2AddFail
    Created on : Mar 25, 2013, 10:33:14 AM
    Author     : zabedah
--%>
            ...
            <fieldset class="aras1">
                ...
                <div class="content" align="center">
                    <table class="tablecloth" border="0">
                        <tr>
                            <td>No Fail :</td>
                            <td><s:text name="noFail" id="noFail" class="required"/></td>
                        </tr>
                        <tr>
                            <td align="right" colspan="2">
                                <s:submit name="simpanFail" value="Simpan" class="btn" onclick="NoPrompt();"/>
