...
<s:form beanclass="etanah.view.stripes.pelupusan.LaporanPelukisPelanActionBean" name="test">
    ...
    <div id="DalamKawasanDiv" class="content" align="center">
            ...
            <table border="0" width="60%" cellspacing="7" align="center">
                ...
                <tr>
                    <td align="left" colspan="3">
                        ...
                        <%--</c:if>--%>
                        &nbsp;<s:submit name="tutupPermohonan" value="Tutup" class="btn" onclick="test1(this.name, this.form);"/>
                    </td>
                </tr>
            </table>                
        </fieldset>
