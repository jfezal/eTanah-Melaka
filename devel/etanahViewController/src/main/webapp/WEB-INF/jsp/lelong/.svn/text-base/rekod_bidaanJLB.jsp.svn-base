...
//        }
    ...
    function refreshPage(){
        var url = '${pageContext.request.contextPath}/lelong/keputusan_bidaanJLB?refreshpage';
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function popupPembida(val,id){
        window.open("${pageContext.request.contextPath}/lelong/keputusan_bidaanJLB?pembidaPopup&idLelong="+val+"&id="+id, "eTanah",
    ...
    function deletePembida2(val,val1){
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/lelong/keputusan_bidaanJLB?deletePembida2&idPihak='+ val+'&idLelong='+ val1;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
...
<s:form beanclass="etanah.view.stripes.lelong.KeputusanBidaanJLBActionBean" id="bida">
    <s:messages/>
    <s:errors/>&nbsp;
                    ...
                    <c:if test="${actionBean.bida eq true}">
                        ...
                        <c:if test="${actionBean.status eq 'AP'}">
                            <c:if test="${actionBean.negeri eq true}">
                                <p>
                                    <label><font color="red">*</font> Nama negeri : </label>
                                ...
                                <p>
                                    <label> <font color="red">*</font>Nombor Pengenalan1 : </label>
                                ...
                                <c:if test = "${actionBean.BJ eq false}">
                                    ...
                                    <div class="content" align="center">
                                        ...
                                        <c:if test="${fn:length(actionBean.senaraiPembida)>=1}">
                                            ...
                                            <s:button name="simpanPembidaFlow" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
                                        </div>
                                    </c:if>
                                </c:if>
                                ...
                                <c:if test = "${actionBean.BJ eq true}">
                                    ...
                                    <div class="subtitle">
                                        <fieldset class="aras1" id="">
                                            ...
                                            <p>
                                                <label> <font color="red">*</font>Nombor Pengenalan2 : </label>
                                                    <s:text id="nokp1" name="pembida.pihak.noPengenalan" maxlength="12"  onchange="" style="width:150px;"/>
