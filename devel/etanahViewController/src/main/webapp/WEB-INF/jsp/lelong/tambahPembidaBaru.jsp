...
<s:form name="pemohon" id="pemohon"  beanclass="etanah.view.stripes.lelong.UtilitiSenaraiPermohonanLelonganPembidaActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                Maklumat Pembida 1: ${actionBean.permohonan.idPermohonan} 
                ...
                <div class="content">
                    ...
                    <p>
                        <label> <font color="red">*</font>Nombor Pengenalan : </label>
                            <s:text id="nokp1" name="pihak.noPengenalan" maxlength="12" onkeyup="validateNumber(this,this.value);" onchange="validateIC(this.value,'${actionBean.permohonan.idPermohonan}'), validateNewICLength(this.value);" style="width:170px;"/>
                            <s:text id="nokp2" name="pihak.noPengenalan"  onchange="this.value=this.value.toUpperCase();" style="width:170px;"/>
                    </p>
                    <p>
