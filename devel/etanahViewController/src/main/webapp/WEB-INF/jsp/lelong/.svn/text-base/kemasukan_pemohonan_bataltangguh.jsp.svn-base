<%-- 
    Document   : kemasukan_pemohonan_bataltangguh
    Created on : Feb 11, 2010, 11:37:16 AM
    Author     : nurfaizati
--%>
 ...
 <div class="subtitle">
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
               <table>
                <tr>
                    <td class="rowlabel1">Jenis :</td>
                    <td class="input1">
                      <%--  <s:radio name="radio_" id="radio_" value=""/> Terima Permohonan--%>
                        <s:radio name="radio_" id="radio_" value=""/> Penangguhan Lelongan
                        <s:radio name="radio_" id="radio_" value=""/> Pembatalan Lelongan
                                           </td>
                </tr>
                </table>
    ...
    <div class="content" align="right">
        <table >
            <tr>
                <td align="right">
                    <%--<s:button name="" value="Cetak Borang 16P" class="longbtn" />--%>
