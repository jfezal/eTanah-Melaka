<%-- 
    Document   : testEnkuiri
    Created on : Jun 29, 2010, 11:58:10 AM
...
<s:form beanclass="etanah.view.stripes.lelong.KeputusanPerintahActionBean">
    <s:messages/>
    <s:errors/>
    <s:hidden name="baruKe" value="${actionBean.baruKe}"/>
    <div class="subtitle" id="lain2">
        <fieldset class="aras1">
            ...
            <br>
            <c:if test="${actionBean.terima eq true}">
                <p>
                    <em>*</em> Petunjuk : Sila Masukkan Tarikh Siasatan Yang Baru Dan Klik Butang Simpan Dan Jana Untuk Jana Surat Tangguh Dan Surat Siasatan
                </p><br>
            </c:if>
            ...
            <div class="content">
                <p align="center">
                    <c:if test="${actionBean.terima eq false}">
                        <s:button name="simpanEnkuiri" id="save" value="Simpan" class="btn" onclick="if(validation())doSubmit(this.form, this.name, 'page_div')"/>
                    </c:if>
                    <c:if test="${actionBean.terima eq true}">
                        <s:button name="simpanEnkuiri2" id="save" value="Simpan Dan Jana" class="longbtn" onclick="showReport(this.form,this.name)"/>
                    </c:if>
                </p>
            </div>
    ...
    <fieldset class="aras1">
        ...
        <div class="content" align="center">
            <display:table class="tablecloth" name="${actionBean.senaraiEnkuiri3}" id="line">
                ...
                <display:column title="Status" style="text-transform: uppercase;" class="nama${line_rowNum}">
