<%-- 
    Document   : UtilitiUploadDokumen
    Created on : Dec 1, 2010, 3:25:47 PM
...
<script type="text/javascript">
    function addNew(v){
        window.open("${pageContext.request.contextPath}/lelong/dokumen?addDocForm&permohonan.idPermohonan=" + v, "eTanah",
...
<s:form beanclass="etanah.view.stripes.lelong.UtilitiUploadDokumenActionBean" >
