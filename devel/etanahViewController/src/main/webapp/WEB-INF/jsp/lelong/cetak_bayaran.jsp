<%-- 
    Document   : cetak_bayaran
    Created on : Jan 26, 2010, 10:24:09 AM
...
<H4>CETAK SURAT PEMAKLUMAN AGIHAN BAYARAN</H4>
<s:form action="">
    <div class="subtitle">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                Senarai Penerima Cek Daripada Pembida
            </legend>
               <div class="content"  align="center">
                    <display:table class="tablecloth" name="" cellpadding="0" cellspacing="0" id="lineMP">
                   <display:column title="Bil" sortable="true"></display:column>
                   <display:column title="Bayar Kepada"/>
                   <display:column title="Amaun (RM)" />
                   <display:column title="Tarikh Cek" />
                   <display:column title="Nombor Cek" />
                </display:table>
               </div>
        </fieldset>
    </div><br>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                Arahan Penyediaan Surat Pemakluman Pengambilan Cek Kepada Penerima Cek
            </legend>
            <div class="content" align="center">
            <table>
             <tr>
                    <td class="rowlabel1"> Arahan PPTD :</td>
                    <td></td>
             </tr></table>
            </div>
       </fieldset>
