<%-- 
    Document   : penyediaan_sijil_rujukan
    Created on : Feb 11, 2010, 5:38:44 PM
    Author     : nurfaizati
--%>
...
<s:form action="">
  ...
  <%--  <div class="subtitle">
        <fieldset class="aras1"
            <legend>
                Arahan Sediakan Borang 16I Perakuan Jualan
            </legend>
            <div class="content" align="center">
            <table>
             <tr>
                    <td class="rowlabel1"> Arahan Daripada PTD :</td>
                    <td></td>
             </tr></table>
            </div>
       </fieldset>
    ...
    <div class="content" align="right">
        <table >
            <tr>
                <td align="right">
                    <s:button name="" value="Cetak Sijil Rujukan" class="longbtn" />
