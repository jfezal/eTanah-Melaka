<%-- 
    Document   : agihTugasToJurulelong
    Created on : Jan 30, 2013, 3:28:30 PM
...
<s:useActionBean beanclass="etanah.view.stripes.lelong.AgihanTugasToJurulelongActionBean" var="penggunaperanan"/>
<s:form beanclass="etanah.view.stripes.lelong.AgihanTugasToJurulelongActionBean">
    <s:messages/>
    <s:errors/>
    <c:if test="${actionBean.button eq false}">
        ...
        <c:if test="${actionBean.check eq false}">
            <div class="subtitle">
                <fieldset class="aras1">
                    <font color="red">*</font><em><font color="red">Sila Agihkan Tugas Kepada:  ${actionBean.lelong.jurulelong.nama}</font></em><br><br>
                    <legend>
                        Agihan Tugas
                    </legend>
        ...
        <c:if test="${actionBean.check eq true}">
            <center><font color="red">*</font><em><font color="red">Sila masukan Jurulelong Sebelum Membuat Agihan</font></center>
