<%-- 
    Document   : pembida_popupJLB
    Created on : 22 Mei 2013, 11:50:10 PM
    Author     : Mazurahayati
--%>
...
<s:form beanclass="etanah.view.stripes.lelong.KeputusanBidaanJLBActionBean">
    <s:messages/>
    <s:errors/>&nbsp;
    <s:hidden name="idLelong" value="${actionBean.idLelong}"/>
    <s:hidden name="idPihak" value="${actionBean.pembida.pihak.idPihak}"/>
    <s:hidden id="idPembida" name="pembida.idPembida" />
            ...
            <div class="content" align="right">
                <p>
                    <c:if test="${bayarBaki eq false}">
                        <s:button name="savePembida" id="save" value="Simpan" class="btn" onclick="simpanPihak(this.name, this.form);"/>
    ...
    <c:if test = "${actionBean.BJ eq false}">
        ...
        <div class="subtitle displaytag">
            ...
            <fieldset class="aras1">
                ...
                <br>
                <div class="subtitle displaytag">
                    <display:table class="tablecloth" name="${actionBean.senaraiPembida}" pagesize="10" id="line" requestURI="/lelong/keputusan_bidaanJLB">
