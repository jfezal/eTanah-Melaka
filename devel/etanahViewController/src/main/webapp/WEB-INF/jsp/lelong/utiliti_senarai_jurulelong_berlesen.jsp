...
<script type="text/javascript">
    ...
    function pilih(idPermohonan){
//        alert(idPermohonan);
        window.open("${pageContext.request.contextPath}/lelong/utilitiSemakanPembida?getSenaraiJurulelongBerlesan&idPermohonan=" + idPermohonan, "eTanah",
                                ...
                                <c:if test="${actionBean.display eq false}">
                                    <c:if test="${actionBean.stageJurulelongN9 eq true}">
                                        <p>
                                             ...
                                             <s:button name="" value="Pilih" class="btn" onclick="pilih('${actionBean.idPermohonan}');"/>
