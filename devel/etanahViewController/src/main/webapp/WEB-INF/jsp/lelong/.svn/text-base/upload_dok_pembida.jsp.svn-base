<%-- 
    Document   : upload_dok_pembida
    Created on : Jun 11, 2013, 5:05:22 PM
    Author     : nur.aqilah
--%>
...
<s:form beanclass="etanah.view.stripes.lelong.UtilitiSenaraiPermohonanLelonganPembidaActionBean">
    <s:errors/>
    <s:messages/>
    <s:hidden id="idPembida" name="idPembida"/>
