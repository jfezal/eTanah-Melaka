...
<s:form name="pemohon" id="pemohon"  beanclass="etanah.view.stripes.lelong.UtilitiSenaraiPermohonanLelonganPembidaActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>Maklumat Pihak Terlibat1</legend>
            ...
            <center>
                ...
                <s:button name="simpanWakil" id="simpan" value="Simpan" class="btn" onclick="save(this.name, this.form, '${actionBean.pembida.idPembida}');"/>
