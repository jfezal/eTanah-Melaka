    ...
    <script type = "text/javascript">
        ...
        <%--alert("rowCount"+rowCount);--%>
            ...
            function search(index){
                // alert("search:"+index);
                var url = '${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?kodAgensiPopup&index='+index;
                window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=910,height=800,scrollbars=yes");
            }

            function search2(index){
                // alert("search:"+index);
                var url = '${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?kodAgensiPopup2&index='+index;
                window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=910,height=800,scrollbars=yes");
            }

            function addDok(val){
                var url = '${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?addDokumen&idRujukan='+val;
                window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=910,height=800,scrollbars=yes");
            }
                      ...
                      <%--alert("idRujukan:"+idRujukan);--%>
                       ...
                       <%-- alert(i+j-1);
                        ...
                        alert(idRujukan);--%>
                         ...
                         <%--alert("javacall");--%>
                               var url = '${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?deleteRujukan&idRujukan='
                                   +idRujukan;
                                   <%--alert("url"+url)--%>
                               $.get(url,
                               function(data){
...
<s:form beanclass="etanah.view.penguatkuasaan.JabatanTeknikal2ActionBean" name="teknikal">
