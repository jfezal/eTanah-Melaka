        ...
        <div class="subtitle">
            ...
            <s:hidden name="data" id="data"/>
                <fieldset class="aras1">
                    <legend></legend>
                    <p>
                        <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodAgensi}" pagesize="15" cellpadding="0" cellspacing="0" requestURI="/penguatkuasaan/sedia_jabatan" id="line">
