<%--
    ...
    Created on : Feb 20, 2012, 11:44 AMrefreshV2
    Author     : Shazwan
--%>
...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.hakmilikPermohonan ne null}">
        ...
        function reload (val) {
            doBlockUI();
            var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?reload&idHakmilik=' + val;
            $.ajax({
                type:"GET",
                url : url,
                dataType : 'html',
        ...
        function reloadPT (val) {
            doBlockUI();
            var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?reload&noPtSementara=' + val;
            $.ajax({
                type:"GET",
                url : url,
                dataType : 'html',
        ...
        function refreshV2ManyHakmilik(type,hakmilik){
            var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?refreshpage&type='+type+'&idHakmilik='+hakmilik;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
    ...
    <%--var strStageID2 = "gis_lim";--%>
            var strStageID2 = <c:choose><c:when test="${actionBean.permohonan.kodUrusan.kod eq '49' && actionBean.stageId eq 'g_semak_ft'}">"g_semak_ft";</c:when><c:otherwise>"g_laporan_tanah";</c:otherwise></c:choose>
            var objShell = new ActiveXObject("WScript.Shell");
            var sysVar = objShell.Environment("System");            
            objShell.Run(sysVar("eTanahGISLIM") + " " + strUserID + " " + strNama2 + " " +  strJawatan2 + " " + strIDPermohonan + " " + strStageID2);
        }
        
        function openFrameAddHakmilik(type){
            doBlockUI();
            window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?openFrame&type="+type, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=1000,height=500,scrollbars=yes");
        }
</script>
<s:form beanclass="etanah.view.penguatkuasaan.LaporanTanahV2ActionBean" name="form">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <span style="float:right">
                <a onclick="openFrame('maklumatHakmilik');" onmouseover="this.style.cursor='pointer';"><img alt="Kemaskini"  height="25px" width="25x" src='${pageContext.request.contextPath}/pub/images/icons/edit_pelupusan_small.png'/> </a>
            </span>
            <div align="center">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>LIM (Land Investigation Module)</legend>
                <center>
                    <br/>
                    <p>
            ...
            <div id="perihaltanah">
                <div class="content" align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="20" cellpadding="0" cellspacing="0" id="line"
                                   requestURI="/penguatkuasaan/laporan_tanahV2">
                ...
                <tr>
                    ...
                    <display:table class="tablecloth" name="${actionBean.permohonanManualList}" cellpadding="0" cellspacing="0" id="line1">
        ...
        <fieldset class="aras1">
            ...
            <div id="latar_blkg_tanah" align="center">
                <display:table class="tablecloth" name="${actionBean.senaraiPermohonanLaporanPohon}" cellpadding="0" cellspacing="0" id="line"
                               requestURI="${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2">                              
        ...
        <fieldset class="aras1">
            ...
            <div id="keadaantanah" align="center">
                <table class="tablecloth" align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp; Pada :
                            <c:choose>
                                <c:when test="${actionBean.laporanTanah.keteranganTanahBertumpu eq '0'}">
                                    &nbsp;
                                </c:when>
                                <c:otherwise>
                            ...
                            <tr>
                                <td colspan="2">
                                    <display:table class="tablecloth" name="${actionBean.listPermohonanLaporanUsaha}" cellpadding="0" cellspacing="0"
                                                   requestURI="/penguatkuasaan/laporan_tanahV2"  id="line">
                ...
                <c:if test="${actionBean.laporanTanah.usaha eq 'Y'}">
                    <table class="tablecloth">
                        <tr>
                            <th>Jenis Tanaman</th><th>Luas Yang Ditanam (hektar)</th><th>anggaran Bil.pokok</th><th>Nilaian Tanah Termasuk Tanaman(RM)</th>
                        </tr>
                        <tr align="center">
                            <td>
                ...
                <table class="tablecloth" align="center">
                    ...
                    <c:if test="${actionBean.laporanTanah.perenggan eq 'Y'}">
                        <tr>
                            <td>Luas Diperenggan :</td>
                            <td>${actionBean.laporanTanah.perengganLuas}&nbsp;${actionBean.laporanTanah.perengganLuasUom.nama}</td>
                        </tr>
                    </c:if>
                    <tr>
    ...
    <div class="subtitle" id="updiv">
        <fieldset class="aras1">
            ...
            <span style="float: right">
                <c:if test="${actionBean.disLaporanTanahController.bBahanBatuan}">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq '352'}">
                            ...
                            <tr>
                                ...
                                <td>${actionBean.laporanTanah.tempohDitinggalkan}&nbsp;tahun</td>
                            </tr>
                        </c:when>
