<%-- 
    Document   : kembali_PU
    Created on : Aug 19, 2013, 9:39:56 PM
...
<s:form beanclass="etanah.view.penguatkuasaan.GisIntegrationActionBean" name="form">
    ...
    <html>
        ...
        <body>
            <s:button name="hantarJupem" id="hantarJupem" value="Kembali PU" class="longbtn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
        </body>
    </html>
</s:form>
