...
<s:form beanclass="etanah.view.penguatkuasaan.SenaraiAduanActionBean">
 ...
 <s:hidden name="idAduanLokasi" value="actionBean.idAduanLokasi" />
         <s:messages/>
...
<fieldset class="aras1">
            ...
            <p align="right">
                            <s:button class="btn" value="Simpan" name="editLokasi" onclick="if(validateForm())save(this.name,this.form);" />
