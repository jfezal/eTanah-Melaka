...
//        alert(url);
        ...
        function(data){
            ...
            alert("Maklumat telah berjaya dikemaskini.");
            self.opener.refreshPageMahkamah($("#idPermohonan").val());
            self.close();
        },'html');
            ...
            <div class="content">
                ...
                <fieldset class="aras2">
                    ...
                    <div align="center" >
                        ...
                        <p>
                            <s:hidden name="recordCount" id="recordCount" value="${fn:length(actionBean.senaraipermohonanRujukanLuarPeranan)}"/>
                        </p>
