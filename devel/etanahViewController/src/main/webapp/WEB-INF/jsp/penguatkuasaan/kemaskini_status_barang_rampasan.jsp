<%--
    Document   : kemaskini_status_barang_rampasan
    Created on : Oct 28, 2011, 11:16:37 AM
            ...
            <div class="content" align="center">
                <c:if test="${!multipleOp && !viewMultipleOp}">
                    <div class="instr-fieldset">
                        <font color="red">MAKLUMAN:</font> Sila kemaskini status barang rampasan......
                    </div>&nbsp;
                ...
                <c:if test="${multipleOp}">
                    ...
                    <display:table name="${actionBean.listOp}" id="line" class="tablecloth" cellpadding="0" cellspacing="0">
                        ...
                        <display:column title="Maklumat Barang Rampasan">
                            ...
                            <table width="100%" cellpadding="1">
                                ...
                                <th  width="1%" align="center"><b>Item1</b></th>
                                ...
                                <c:forEach items="${line.senaraiBarangRampasan}" var="barang">
                                    <tr>
                                        <td><s:checkbox name="barang.idBarang" checked="checked" value="${barang.idBarang}" id="barang.idBarang"/> </td>
                                    ...
                                    <%--   <td width="30%">
                                          <s:text name="tarikhTuntut${line_rowNum-1}${count}"  id="tarikhTuntut" class="datepicker" formatPattern="dd/MM/yyyy" />
                                      </td>--%>
                                    </tr>
                    ...
                    <table>
                        <tr>
                        <td align="right">
                            <s:button class="btn" value="Simpan" name="simpanStatusBarang" id="simpan" onclick="if(validate())doSubmit(this.form, this.name,'page_div')"/>
                        </td>
                        </tr>
                    </table>
                </c:if>
