<%-- 
    Document   : laporan_remedi
    Created on : Oct 5, 2012, 11:16:02 AM
...
<script language="javascript" type="text/javascript">
    ...
    <%--alert (idKandungan);--%>
                        if(document.getElementById("idKertas"+(i+j-1)) != null){
                            var url = '${pageContext.request.contextPath}/penguatkuasaan/maklumat_laporan_remedi?deleteLaporan&idKandungan='
                                +idKandungan;
    ...
    <%--alert(e);--%>
        ...
        function removeDiari(idKandungan){
            ...
            if(confirm('Adakah anda pasti untuk hapus?')) {
                var url = '${pageContext.request.contextPath}/penguatkuasaan/maklumat_laporan_remedi?deleteLaporan&idKandungan='+idKandungan;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
                },'html');
...
<s:form beanclass="etanah.view.penguatkuasaan.MaklumatLaporanRemediActionBean" name="form2">
    <s:messages/>
    <s:errors/>
                    ...
                    <table  width="50%" id="tbl" class="tablecloth">
                        ...
                        <c:forEach items="${actionBean.senaraiKertas}" var="line">
                            <tr style="font-weight:bold">
                                ...
                                <td>
                                    <s:textarea name="kandungan${i}" id="kandungan${i}" value="${line.kandungan}" cols="100" rows="7"/>
                                </td>
