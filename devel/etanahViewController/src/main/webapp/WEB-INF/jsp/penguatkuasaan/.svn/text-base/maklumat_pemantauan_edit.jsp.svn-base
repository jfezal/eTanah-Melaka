...
<div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                        ...
                        <s:text name="aduanPemantauan.tarikhPemantauan" class="datepicker" formatType="date" formatPattern="dd/MM/yyyy" id="tkhMula"/>
                    ...
                    <p>
                        <label><font color="red">*</font>Laporan Pemantauan :</label>
                         <s:textarea name="aduanPemantauan.catatan" rows="5" cols="50" id="catat" onkeyup="this.value=this.value.toUpperCase();"/>&nbsp;
                    </p>
            </div>
        </fieldset>
                    <p align="right">
                    <s:hidden name="idPermohonan" value="${actionBean.permohonan.idPermohonan}"/>
                    <s:hidden name="idPemantauan" value="${actionBean.aduanPemantauan.idPemantauan}"/>
