<%-- 
    Document   : utiliti_notis_penyampaian_scan_doc
    Created on : Sept 8, 2011, 12:10:19 AM
    Author     : ctzainal
--%>
...
<script type="text/javascript">
    ...
    function successRedirection() {
        var url = '${pageContext.request.contextPath}/penguatkuasaan/utiliti_notis_penyampaian?reload';
        $.ajax({
            type:"GET",
            url : url,
