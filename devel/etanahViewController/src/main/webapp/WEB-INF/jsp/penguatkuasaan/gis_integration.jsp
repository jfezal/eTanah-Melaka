...
<%-- Document   : gis_integration
    Created on : Feb 24, 2011, 2:36:10 PM
...
<s:form beanclass="etanah.view.penguatkuasaan.GisIntegrationActionBean" name="form">
    ...
    <html>
        ...
        <body>
            <s:button name="lakarPelan" id="lakarPelan" value="Penyediaan Pelan" class="longbtn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
        </body>
    </html>
</s:form>