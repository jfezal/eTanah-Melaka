...
<script type="text/javascript">
   function ReplaceAll(Source,stringToFind,stringToReplace){
    ...
    function RunProgram(strUserID, strNama, strJawatan, strIDPermohonan, strStageID) {
        ...
        objShell.Run(sysVar("eTanahGISB1") + " " + strUserID + " " + strNama + " " +  strJawatan + " " + strIDPermohonan + " " + strStageID);
    }
...
<s:form beanclass="etanah.view.penguatkuasaan.GisIntegrationActionBean" name="form">
    ...
    <html>
        ...
        <body>
            <s:button name="terimaB1" id="terimaB1" value="Terima B1" class="btn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','g_terima_pa_b1');"/>&nbsp;
        </body>
    </html>
</s:form>