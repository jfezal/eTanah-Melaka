<%--
    Document   : popup_view_muktamad_kompaun_detail_oks
    Created on : July 22, 2011, 7:03:22 PM
                    ...
                    <div align="center" >
                        <%--                        <display:table class="tablecloth" name="${actionBean.senaraiAduanOrangKenaSyak}" pagesize="10" cellpadding="0" cellspacing="0" id="line" >
                                                    ...
                                                    <display:column title="Syor Kompaun(RM)">
                                                        <s:text name="amaunKompaunSyor${line_rowNum-1}" formatPattern="0.00" id="amountSyor${line_rowNum-1}" size="20" maxlength="14" onblur="totalAmount();" onkeyup="validateNumber(this,this.value);" />
                                                    </display:column>
                                                    <display:footer>
                                                        <tr>
                        ...
                        <display:table class="tablecloth" name="${actionBean.senaraiKompaun}" pagesize="10" cellpadding="0" cellspacing="0" id="line" >
                            ...
                            <display:column title="Muktamad Kompaun (RM)">
                                ${line.amaun}
                                <input name="syor" value="${line.amaun}" id="amountMuktamad${line_rowNum-1}" type="hidden"/>
                            </display:column>
                            <display:footer>
                                <tr>
