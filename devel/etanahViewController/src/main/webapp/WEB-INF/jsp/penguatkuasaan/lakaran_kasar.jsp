<%-- 
    Document   : lakaran_kasar
    Created on : Nov 28, 2012, 9:39:56 PM
...
<s:form beanclass="etanah.view.penguatkuasaan.GisIntegrationActionBean" name="form">
    ...
    <html>
        ...
        <body>
            <s:button name="hantarJupem" id="hantarJupem" value="Lakaran Kasar" class="longbtn"  onclick="RunProgram('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
        </body>
    </html>
</s:form>
