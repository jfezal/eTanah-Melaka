<%-- 
    Document   : utiliti_kemasukan_tambahan_doc
...
<s:useActionBean beanclass="etanah.view.penguatkuasaan.UtilitiSenaraiDokumenActionBean" var="list"/>


<s:form action="/penguatkuasaan/utiliti_senarai_dokumen" >
    ...
    <fieldset class="aras1" >
        ...
        <p>
            <label>&nbsp;</label>
            <s:button name="simpanDokumenTambahan" value="Simpan" class="btn" onclick="if(validateForm())doSave(this.name, this.form);"/>
