<%--
    Document   : diari_siasatan
    Created on : Feb 2, 2011, 11:23:43 AM
...
<script language="javascript" type="text/javascript">
    ...
    <%--     var cell6 = row.insertCell(4);
         ...
         cell6.appendChild(e5);--%>
                     ...
                     for(var i=0; i<rowCount; i++) {
                         ...
                         if(null != chkbox && true == chkbox.checked) {
                             ...
                             if(document.getElementById("idKertas"+(i+j-1)) != null){
                                 var url = '${pageContext.request.contextPath}/penguatkuasaan/diari_siasatan?deleteDiari&idKandungan='
                                     +idKandungan;
             ...
             function removeDiari(idKandungan){
                 ...
                 if(confirm('Adakah anda pasti untuk hapus?')) {
                     var url = '${pageContext.request.contextPath}/penguatkuasaan/diari_siasatan?deleteDiari&idKandungan='+idKandungan;
                     $.get(url,
                     function(data){
                         $('#page_div').html(data);
                     },'html');
    ...
    <%--   function semakIdHakmilik(){
           ...
           if(idHakmilik != ""){
               alert("tak null");
               $.get('${pageContext.request.contextPath}/penguatkuasaan/diari_siasatan?semakIdHakmilik&idHakmilik='+idHakmilik,
               function(data){
                   alert(data);
                   if(data == "exist"){
...
<s:form beanclass="etanah.view.penguatkuasaan.DiariSiasatanActionBean" name="form2">
    <s:messages/>
    <s:errors/>
                ...
                <div class="content" align="center">
                    <table  width="75%" id="tbl" class="tablecloth">
                        <tr>
                            ...
                            <th  width="20%" align="center"><b><em>*</em>Masa</b></th>
                            <th  width="10%" align="center"><b><em>*</em>Hari</b></th>
                        ...
                        <c:forEach items="${actionBean.senaraiKertas}" var="line">
                            <tr style="font-weight:bold">
                                ...
                                <td>
                                    ...
                                    <s:text name="tarikh${i}" id="tarikh${i}" value="${line.tarikhButiran}" size="12" class="datepicker" formatPattern="dd/MM/yyyy" onchange="datePick(this.id,${i})"/>&nbsp;
                                </td>
                                ...
                                <td width="8">
                                    ...
                                    <center><span id="hari${i}"></span></center>
                                </td>                                 
    ...
    <c:if test="${view}">
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <div class="content" align="center">
                    <display:table name="${actionBean.senaraiKertas}" id="line" class="tablecloth">
