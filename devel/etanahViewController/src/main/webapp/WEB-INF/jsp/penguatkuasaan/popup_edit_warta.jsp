...
<s:form  beanclass="etanah.view.penguatkuasaan.TerimaanWartaActionBean" name="form1">
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <input name="id" value="${actionBean.mohonRujukLuar.idRujukan}" type="hidden">
            <p>
                <label><em>*</em>Jenis warta :</label>
                <s:select name="jenisWarta"  id="jenisWarta">
            ...
            <p>
                <label>Catatan :</label>
                <s:textarea name="catatan" rows="5" cols="40" value="${actionBean.mohonRujukLuar.catatan}" onchange="this.value=this.value.toUpperCase();" id="catatan" onkeydown="limitText(this,999);" onkeyup="limitText(this,999);" />&nbsp;
            </p>
        ...
        <p><label>&nbsp;</label>
            ...
            <s:button class="btn" name="edit"  onclick="if(validateForm())save(this.name,this.form);" value="Kemaskini"/>
