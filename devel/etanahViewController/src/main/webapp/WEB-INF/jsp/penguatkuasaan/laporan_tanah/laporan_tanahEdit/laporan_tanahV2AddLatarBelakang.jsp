...
<script type="text/javascript">
    ...
    function addMohonLaporPohon(){
        NoPrompt();
        var idHakmilik = $('#idHakmilik').val();
        window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?showFormPopUpLatarBelakangTanah&idHakmilik="+idHakmilik+"&idLaporTanah="+${actionBean.idLaporTanah}, "eTanah",
...
<body>
    ...
    <s:messages/>
    <div class="subtitle">
        <s:form beanclass="etanah.view.penguatkuasaan.LaporanTanahV2ActionBean" name="frm">
                ...
                <table class="tablecloth" border="0" align="center">
                    <tr>
                        ...
                        <td>
                            ...
                            <s:radio name="permohonanLaporanPohon.jenisDipohon" value="R" id="jenisDipohon" onclick="changeValue(this.value)"/>&nbsp;Rizab&nbsp;
                            <s:radio name="permohonanLaporanPohon.jenisDipohon" value="M" id="jenisDipohon" onclick="changeValue(this.value)"/>&nbsp;Di Luar Sistem&nbsp;
                        </td>
                    </tr>
                    <tr id="hakmilik">
                        <td>ID Hakmilik</td>
                        <td><s:text name="noHakmilik" id="noRujukan" /></td>
                    </tr>
                    <tr id="lesen">
                        <td>No Lesen</td>
                        <td><s:text name="noLesen" id="noRujukan" /></td>
                    </tr>
                    <tr id="permit">
                        <td>No Permit</td>
                        <td><s:text name="noPermit" id="noRujukan" /></td>
                    </tr>
                    <tr id="rizab">
                        <td>No Warta</td>
                        <td><s:text name="noWarta" id="noRujukan" /></td>
                    </tr>
                    <tr id="manual">
                        <td>No Rujukan / Fail / ID Hakmilik</td>
                        <td><s:text name="noFail" id="noRujukan" /></td>
                    </tr>
                    <tr id="manual1">
                        <td>Kegunaan</td>
                        <td><s:textarea name="permohonanLaporanPohon.kegunaan" id="kegunaan"/></td>
                    </tr>
                    <tr id="carian">
                        <td colspan="2">
                        ...
                        <tr>
                            <td>
                                <c:choose>
                                    ...
                                    <c:when test="${actionBean.permohonanLaporanPohon.jenisDipohon eq 'LP' || actionBean.permohonanLaporanPohon.jenisDipohon eq 'P'}">
                                        Nama Pemegang
                                    </c:when>
                                    <c:otherwise>
                                    </c:otherwise>
