...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.maklumatTanahSek49 eq false}">
            ...
            }else if(document.getElementById("tanahKerajaan").checked == true){
                if($('#jumlahTanahKerajaan').val() == '0'){
                    alert("Sila masukkan maklumat tanah kerajaan");
                    $('#tanahKerajaan').focus();
                    return false; 
                }
            }
    ...
    <c:if test="${actionBean.statusUlasan eq false}">
        ...
        function removeSingle(idTanahRizabPermohonan)
        {
            if(confirm('Adakah anda pasti?')) {
                var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?deleteSingle&idTanahRizabPermohonan='
        ...
        function tambahBaru(){
            window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?hakMilikPopup", "eTanah",
       ...
       $('#usahaTanam').val("");--%>
           ...
           function removeImej(idImej, idDokumen) {
               if(confirm('Adakah anda pasti untuk hapus?')) {
                   var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?deleteSelected&idImej='+idImej+'&idDokumen='+idDokumen;
                   $.get(url,
                   function(data){
           ...
           function simpan(){
               ...
               if(idHakmilik == ""){
                   ...
                   var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?carianHakmilik&idHakmilik='+idHakmilik;
                   $.get(url,
                   function(data){
                       //alert(data);
           ...
           function tambahBaruSempadan(idLapor){
               ...
               window.open("${pageContext.request.contextPath}/penguatkuasaan/jenis_sempadan?sempadanPopup&idLapor="+idLapor+"&jenisLaporan=LTNH", "eTanah",
           ...
           function addRecord(){
               ...
               var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?addRecordHakmilik';
               window.open(url, 'etanah', "status=0,toolbar=0,location=0,menubar=0,width=900,height=500, left=" + left + ",top=" + top);
           }

           function removeRecord(id){
               if(confirm('Adakah anda pasti untuk hapus?')) {
                   var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?deleteRecordHakmilik&id='+id;
                   $.get(url,
                   function(data){
                       $("#tanahMilikDiv").replaceWith($('#tanahMilikDiv', $(data)));
                   },'html');}
           ...
           function editRecord(id){
               ...
               var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?editRecordHakmilik&id='+id;
               window.open(url, 'etanah', "status=0,toolbar=0,location=0,menubar=0,width=900,height=500, left=" + left + ",top=" + top);
           }
           ...
           function addJenisHakisan(){
               var left = (screen.width/2)-(1000/2);
               var top = (screen.height/4)-(150/4);
               var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?addRecordJenisHakisan';
               window.open(url, 'etanah', "status=0,toolbar=0,location=0,menubar=0,width=900,height=500, left=" + left + ",top=" + top);
           }
           ...
           function editJenisHakisan(id){
               var left = (screen.width/2)-(1000/2);
               var top = (screen.height/4)-(150/4);
               var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?editRecordJenisHakisan&id='+id;
               window.open(url, 'etanah', "status=0,toolbar=0,location=0,menubar=0,width=900,height=500, left=" + left + ",top=" + top);
           }
    
           function removeJenisHakisan(id){
               if(confirm('Adakah anda pasti untuk hapus?')) {
                   var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?deleteJenisHakisan&id='+id;
                   $.get(url,
                   function(data){
                       $("#maklumatTanah49Div").replaceWith($('#maklumatTanah49Div', $(data)));
                   },'html');}
           ...
           //               var left = (screen.width/2)-(1000/2);
           //               var top = (screen.height/4)-(150/4);
           //               var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?addHakmilik';
           //               window.open(url, 'etanah', "status=0,toolbar=0,location=0,menubar=0,width=900,height=500, left=" + left + ",top=" + top);
           //           }
...
<script type="text/javascript">
    function addInfoHakmilik(){
        var left = (screen.width/2)-(1000/2);
        var top = (screen.height/4)-(150/4);
        var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?addHakmilik'+'&statusDisplay=edit';
        window.open(url, 'etanah', "status=0,toolbar=0,location=0,menubar=0,width=900,height=500, left=" + left + ",top=" + top);
    }
    ...
    function editHakmilik(id){
        var left = (screen.width/2)-(1000/2);
        var top = (screen.height/4)-(150/4);
        var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanah?addHakmilik&id='+id+'&statusDisplay=edit';
        window.open(url, 'etanah', "status=0,toolbar=0,location=0,menubar=0,width=900,height=500, left=" + left + ",top=" + top);
...
<s:form beanclass="etanah.view.penguatkuasaan.LaporanTanahActionBean" name="form">
                                        ...
                                        <display:column title="Kemaskini">
                                            <div align="center">
                                                <img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/pub/images/edit.gif' class='rem'
                                                     id='rem_${line_rowNum}' onmouseover="this.style.cursor='pointer';" onclick="editHakmilik('${line.id}');"/>
                                            </div>
                                        </display:column>  
                                    </c:if>
                                </c:if>
            ...
            <fieldset class="aras1">
                ...
                <c:if test="${edit}">
                    ...
                    <div id="otherInfoHakmilik">
                        ...
                        <c:if test = "${actionBean.multipleHakmilik ne true}">
                            <p>
                    ...
                    <div id="kodDunHakmilikPermohonanDiv">
                        <c:if test = "${actionBean.kodNegeri eq '04' && actionBean.multipleHakmilik ne true}">
                            <c:if test = "${actionBean.permohonan.kodUrusan.kod ne '49'}">
                ...
                <c:if test="${!edit}">
                    ...
                    <p>
                        <label>Lokaliti :</label>
                        <c:if test="${actionBean.hakmilikPermohonan.lokaliti ne null}"> ${actionBean.hakmilikPermohonan.lokaliti}&nbsp; </c:if>
                        <c:if test="${actionBean.hakmilikPermohonan.lokaliti eq null}"> Tiada </c:if>
                    </p>
                    <p>
                        <label>Kawasan PBT :</label>
                        <c:if test="${actionBean.hakmilikPermohonan.kodPbt.nama ne null}"> ${actionBean.hakmilikPermohonan.kodPbt.nama}&nbsp; </c:if>
                        <c:if test="${actionBean.hakmilikPermohonan.kodPbt.nama eq null}"> Tiada </c:if>
                    </p>
    ...
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            ...
            <c:if test="${syorPPTD}">
                ...
                <p>
                    <label><tr>Syor Penolong Pegawai Tanah Daerah :</label><td>
                    <s:textarea name="ulasanPPTK" cols="70" rows="10" class="normal_text"/></td><tr>
