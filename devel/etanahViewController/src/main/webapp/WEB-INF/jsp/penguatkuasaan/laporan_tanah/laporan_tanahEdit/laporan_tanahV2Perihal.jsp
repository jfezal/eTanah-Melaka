...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        <c:when test="${actionBean.hakmilikPermohonan.kodKawasanParlimen.kod ne null && actionBean.kodNegeri eq '05'}">
                filterKodDun();
        </c:when>    
        <c:otherwise>
                $('#jS').hide();
    ...
    <c:choose>
        ...
        function uploadForm(pandanganImej) {
            ...
            var idHakmilik = $('#idHakmilik').val();
            //            alert(idLapor);
            window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?uploadDoc&pandanganImej="+pandanganImej+"&idLapor="+idLapor+"&idHakmilik="+idHakmilik, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        function tambahPermohonanTerdahulu(){
            //            alert('test');
            NoPrompt();
            window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?permohonanTerdahuluPopup", "eTanah",
        ...
        function carianHakmilikPopUp(){
            ...
            NoPrompt();
            var idHakmilik = $('#idHakmilik').val();
            window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?carianHakmilikPopup&idHakmilik="+idHakmilik, "eTanah",
        ...
        function filterKodDun() {
            ...
            $.post('${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?senaraiKodDunByKodPar&kodPar=' + kodPar,
            function(data) {
                if (data != '') {
...
<body>
    <script>
        ...
        {
            var total = $('#hmImej > option').length;
            if (total > 1){
                return true;
            
            }
            else {
                //alert('Sila muatnaik gambar tanah');
                return true;
            }
        }
    </script>
    ...
    <s:form beanclass="etanah.view.penguatkuasaan.LaporanTanahV2ActionBean" name="form">
            ...
            <fieldset class="aras1">
                <div id="perihaltanah">
                    ...
                    <div class="content" align="center">
                        ...
                        <tr>
                            <td><font color="red" size="4">*</font>DUN :</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <s:button name="uploadDoc" id="display" value="Ubah Suai" class="btn" onclick="uploadForm('H');"/><em>Sila simpan maklumat terlebih dahulu</em>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <fieldset class="aras1">
            <table  width="100%" border="0">
                <tr>
                    <td align="center">
                        <s:submit name="simpanPerihal" value="Simpan" class="btn" onclick="NoPrompt(); return CheckGambar();"/>
