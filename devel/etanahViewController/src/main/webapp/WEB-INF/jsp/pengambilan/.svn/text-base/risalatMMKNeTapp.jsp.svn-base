<%-- 
    Document   : risalatMMKNeTapp
    Created on : Mar 18, 2014, 12:59:56 AM
    Author     : nurashidah
--%>
...
<s:form beanclass="etanah.view.stripes.pengambilan.RingkasanMMKNEtappActionBean">
    <s:messages/>
    <s:errors/>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <div class="content">
                <table width="90%" border="0" style="vertical-align: middle">
                      <c:if test="${actionBean.tajuk ne null}"> <tr><td><b>TAJUK : </b>&nbsp;${actionBean.tajuk} </td></tr><br> </c:if>  
                   <c:if test="${actionBean.tajuk eq null}"> <tr><td><b>TAJUK : </b>&nbsp; Pentadbir Tanah Daerah ${actionBean.pejTanah} (Pengarah Jabatan Ketua Pengarah Tanah dan Galian, Melaka) dengan ini memperakukan supaya :  </td></tr><br></c:if>   
                    ...
                    <tr><td><b><font style="text-transform:capitalize">NO. RUJUKAN PTG  : </b> &nbsp; ${actionBean.permohonan.idPermohonan} &nbsp; ( ${actionBean.noFailJKPTG} )</font></td></tr><br>
                </table>
                ...
                <div align="center">
                    <table class="tablecloth" border="0" width="90%">
                        ...
                        <tr><td><b>Ulasan YB Adun Kawasan</b></td>
                            ...
                            <c:if test="${!edit}">
                                <td>${actionBean.ybadun} &nbsp;</td>
                            </c:if>
                        </tr>

                        <tr><td><b>Ulasan PTD</b></td>
                            <c:if test="${edit}">
                                <td><s:textarea name="ulasanPtd" rows="5" cols="130" id="ulasanPtd" class="normal_text"/></td>   
                            </c:if>
                            <c:if test="${!edit}">
                                <td>${actionBean.ulasanPtd} &nbsp;</td>   
                            </c:if>
                        </tr>   
                          <tr><td><b>Perakuan PTD</b></td>
                            <c:if test="${edit}">
                                <td><s:textarea name="perakuanptd" rows="5" cols="130" id="perakuanptd" class="normal_text"/></td>
                            </c:if>
                            <c:if test="${!edit}">
                                <td>${actionBean.perakuanptd} &nbsp;</td>
                            </c:if>
                        </tr>
