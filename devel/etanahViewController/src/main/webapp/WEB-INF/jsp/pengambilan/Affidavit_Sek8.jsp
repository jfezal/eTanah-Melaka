<%-- 
    Document   : Affidavit_Sek8
    Created on : Jul 26, 2011, 11:43:09 AM
    Author     : Rajesh
--%>
...
$(".datepicker1").datepicker({dateFormat: 'yy'});
    ...
    function deleteRow1(formPtg,form1)
    {
        ...
        if (document.getElementById('idKandungan1'+(i)) != null) {
            var url = '${pageContext.request.contextPath}/pengambilan/affidavit_sek8?deleteSingle&idKandungan='
...
<s:form beanclass="etanah.view.stripes.pengambilan.AffidavitSek8ActionBean" name="form2">
<div id="hakmilik_details">
    ...
    <display:table class="tablecloth" name="${actionBean.permohonan.senaraiHakmilik}" pagesize="5" cellpadding="0" cellspacing="0"
                   requestURI="/pengambilan/affidavit_sek8" id="line">
        <display:column title="No" sortable="true">${line_rowNum}</display:column>
        <display:column title="Id Hakmilik">
            <s:link beanclass="etanah.view.stripes.pengambilan.AffidavitSek8ActionBean"
