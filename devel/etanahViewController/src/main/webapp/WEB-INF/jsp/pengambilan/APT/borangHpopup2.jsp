...
<s:form beanclass="etanah.view.stripes.pengambilan.sek8.PenyampaianBorangGHActionBean" id="form">
    <s:hidden name="idBorangPerPBA"/>
...
<!--    <p>
    ...
    <p>
        <label>Catatan </label>
        <s:textarea name="catatanB" />
    </p>
    <p><label>&nbsp; </label>
            <s:button class="btn" value="Simpan" name="simpanBorangH"  onclick="save(this.name,this.form);" />
