...
<s:form beanclass="etanah.view.stripes.pengambilan.sek8.PenyampaianBorangEFActionBean" id="form">
    <s:hidden name="idBorangPerHakmilikA"/>
    ...
    <p>
        <label>Nama Penampal Notis </label>
    ...
    <p><label>&nbsp; </label>
            <s:button class="btn" value="Simpan" name="simpanBorangE"  onclick="save(this.name,this.form);" />
