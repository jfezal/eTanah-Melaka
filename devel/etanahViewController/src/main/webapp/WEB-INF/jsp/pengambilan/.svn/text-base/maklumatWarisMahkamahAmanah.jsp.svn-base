<%-- 
    Document   : maklumatWarisMahkamahAmanah
    Created on : Apr 22, 2013, 5:29:43 PM
    Author     : Admin
--%>
...
$(document).ready(function() {
            var bil =  ${fn:length(actionBean.senaraiPerbicaraanKehadiran)};
            for (var i = 0; i < bil; i++){
                if($("#status"+i).val() == "1"){
...
+idPenilaian;
        ...
        function popupWaris(h){
            var url = '${pageContext.request.contextPath}/pengambilan/warisMahkamahAmanah?showEdittanahKR&idPermohonanPihakWakil='+h;
            window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=1000,height=800");
        }
}
</script>
<s:form beanclass="etanah.view.stripes.pengambilan.maklumatWarisMahkamahAmanahActionBean">
...
<fieldset class="aras1"><br/>
    ...
    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
        ...
        <display:column title="ID Hakmilik">
            <s:link beanclass="etanah.view.stripes.pengambilan.maklumatWarisMahkamahAmanahActionBean"
                  ...
                  Sila masukkan nilaian untuk setiap Tuan Tanah.
                      ...
                      <p align="center">
                        <display:table class="tablecloth" name="${actionBean.senaraiPerbicaraanKehadiran}" cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/status" id="line" pagesize="5">
                    <display:column title="No" sortable="true">${line_rowNum}</display:column>
                    ...
                    <display:column title="Catatan" >
                        ...
                        <s:textarea  rows="5"  cols="30" name="catatan[${line_rowNum - 1}]" disabled="true" id="catatan${line_rowNum - 1}"/>
                    ...
                    <display:column title="Waris" >
                        <img alt='Maklumat Waris' border='0' src='${pageContext.request.contextPath}/pub/images/edit.gif' class='rem'
