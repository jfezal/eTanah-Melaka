<%-- 
    Document   : pengambilan_MMKN_31b
    Created on : 25-May-2011, 20:34:47
    Author     : nordiyana
--%>
<%--
...
<script language="javascript" type="text/javascript">
    ...
    function deleteRow3()
    {
        ...
        if (document.getElementById('idKandungan3'+(i)) != null) {
            var url = '${pageContext.request.contextPath}/pengambilan/borang_mmkn_31b?deleteSingle&idKandungan='
            +idKandungan;
    ...
    function deleteTable5() {
        ...
        if(parseInt(count5) <= parseInt(temp5)) {
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/borang_mmkn_31b?deleteTable&bil='
            +bil;
...
<s:form beanclass="etanah.view.stripes.pengambilan.PengambilanMMKN31bActionBean" name="form2">
    <s:messages/>
    <s:errors/>
