...
<s:form beanclass="etanah.view.stripes.pengambilan.rekodKeputusanMMKn9ActionBean">
        ...
        <fieldset class="aras1">
            ...
            <table width="80%" border="0" >
               <%-- <c:if test="${bilMesyuarat}">
                ...
                <tr >
                    ...
                    <td> <s:radio name="keputusan" value="L"/>Setuju&nbsp;
                    <s:radio name="keputusan" value="TL"/>Tidak Bersetuju&nbsp;</td>
                </tr>
                </c:if>
            </table>
            ...
            <p>
                ...
                <c:if test="${simpanMesyuarat}">
                    <s:button name="simpanRundingan" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
                </c:if>
            </p>
        </fieldset >
    </div>
    ...
    <c:if test="${view}">
        ...
        <fieldset class="aras1">
            <%--<legend>Rekod Keputusan Kertas Pertimbangan Menteri Besar</legend>--%>
            <legend>Rekod Keputusan Rundingan</legend><br />
            <p>
