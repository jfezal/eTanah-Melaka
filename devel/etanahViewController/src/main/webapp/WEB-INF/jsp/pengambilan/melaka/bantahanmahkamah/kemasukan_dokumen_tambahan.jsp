<%--
    ...
    Created on : June 21, 2011, 4:42:48 PM
    Author     : Rajesh
--%>
...
<script type="text/javascript">
  ...
  function refreshPage1(){
    ...
    function addNew(v){
        window.open("${pageContext.request.contextPath}/pengambilan/kemasukanBantahanMahkamah?addDocForm&idPermohonan=" + v, "eTanah",
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <display:table name="${actionBean.senaraiKandungan}" class="tablecloth" id="row" style="width:100%">
                ...
                <display:column title="Pilih"><s:checkbox name="chkbox" id="chkbox" value="${row.dokumen.idDokumen}" onclick="enableHapus();"/></display:column>
        ...
        <p><label>&nbsp;</label>
            <s:submit name="deleteSelected" value="Hapus" class="btn" id="hapus" disabled="true"/>
        ...
        <br/>
            ...
            <p align="right">
                ...
                <s:submit class="btn" name="nextPage" value="Seterusnya"/></p>
    </div>
   </s:form>
