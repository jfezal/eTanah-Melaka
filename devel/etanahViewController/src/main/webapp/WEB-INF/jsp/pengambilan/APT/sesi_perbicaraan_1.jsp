                ...
                <s:form beanclass="etanah.view.stripes.pengambilan.sek8.PerbicaraanActionBean" name="AB" id="AB">
                    ...
                    <div class="subtitle displaytag">
                        ...
                        <fieldset class="aras1" id="locate">
                            ...
                            <label>&nbsp;</label>&nbsp;&nbsp;   <s:button name="showForm" id="save" value="Kembali" class="btn" onclick="main('${actionBean.idPermohonan}')"/> <s:submit name="hantar" id="save" value="Simpan" class="longbtn"/>      </fieldset>
