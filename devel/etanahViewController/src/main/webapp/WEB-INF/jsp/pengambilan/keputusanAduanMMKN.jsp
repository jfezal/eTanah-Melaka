<%-- 
    Document   : keputusanAduanMMKN
    Created on : 09-May-2011, 16:58:12
    Author     : nordiyana
--%>
...
<s:form beanclass="etanah.view.stripes.pengambilan.KeputusanAduanMMKNActionBean">
    ...
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            <legend>
            Keputusan MMKN Pengambilan Seksyen 4- Aduan Kerosakan
            </legend><br />
            <p>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <c:if test="${keputusan}">
                ...
                <p>
                    <label><font color="red">*</font>Jumlah yang diluluskan :</label>
                    <s:text name="jumlahPampasan" id="jumlahPampasan" size="20" onkeyup="validateNumber(this,this.value);"/>
                    <%--<s:radio name="keputusan" value="S"/>Tangguh--%>
                </p>
            </c:if>
            <p>
