...
<s:useActionBean beanclass="etanah.view.stripes.pengambilan.aduan.AgihanTugasanActionBean" var="penggunaperanan"/>
<s:form beanclass="etanah.view.stripes.pengambilan.aduan.AgihanTugasanActionBean">
    <div class="subtitle">
