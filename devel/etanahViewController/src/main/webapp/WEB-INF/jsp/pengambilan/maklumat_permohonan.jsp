<%-- 
    ...
    Created on : 12-Jan-2010, 18:06:51
    Author     : nordiyana
--%>
...
<s:form  beanclass="etanah.view.stripes.pengambilan.PengambilanActionBean">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test="${actionBean.permohonan.penyerahEmail ne null}">
                <p>
                    <label>Email :</label>
                    <font class="normal_text">${actionBean.permohonan.penyerahEmail}</font>&nbsp;
                </p>
            </c:if>
            ...
            <c:if test="${actionBean.permohonan.penyerahNoTelefon1 ne null}">
                <p>
                    ...
                    <font class="normal_text">${actionBean.permohonan.penyerahNoTelefon1}</font>&nbsp;
                </p>
            </c:if>
