<%-- 
    Document   : laporan_tanahKeadaanTanah
    Created on : Jan 17, 2013, 10:48:58 AM
    Author     : User
--%>
...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.laporanTanah.adaBangunan eq null or actionBean.laporanTanah.adaBangunan eq 'T'}">
        ...
        function tambahBangunan(kategori){
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?tambahBangunanPopup&kategori="+kategori+"&idLaporTanah="+${actionBean.laporanTanah.idLaporan}, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
        }

        function tambahLaporUsaha(kategori){
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?tambahNamaPengusahaPopup&kategori="+kategori+"&idLaporTanah="+${actionBean.laporanTanah.idLaporan}, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
        }
    ...
    <%--   </c:when>
       <c:otherwise>
        ...
        function editLaporanBangunan(idLaporBangunan,kategori){
            NoPrompt();
            var idHakmilik = $('#idHakmilik').val();
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?editBangunanPopup&kategori="+kategori+"&idHakmilik="+idHakmilik+"&idLaporBangunan="+idLaporBangunan+"&idLaporTanah="+${actionBean.laporanTanah.idLaporan}, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
        }
</script>
<body>
                    ...
                    <div class="content" align="center">
                        <table class="tablecloth" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <s:select name="hakmilikPermohonan.jarakDari" id="jarakDari" onchange="keluarNama();">
                                                ...
                                                <s:option value="Pantai">Pantai</s:option>
                                                <s:option value="Pekan">Pekan</s:option>
                                                <s:option value="Bandar">Bandar</s:option>
                                                <s:option value="Sungai">Sungai</s:option>
                                            </s:select>
                                        </td>
                                    </tr>
                            ...
                            <tr id="cerun">
                                ...
                                <td>
                                    <s:text name="laporanTanah.kecerunanBukit" id="kecerunanBukit" maxlength="10" onkeyup="validateNumber(this,this.value);"/>
                                </td>
                            </tr>
                            <tr id="dalam">
                                <td>
                            ...
                            <tr>
                                <td>
                                    <font color="red" size="4">*</font>Keadaan Atas Tanah :
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <font color="red" size="4">*</font>Tanah Diambil Bersempadan :
                                </td>
                                <td>
                            ...
                            <tr id="pengusuka">
                                ...
                                <td>
                                    <s:checkbox name="laporanTanah.diusaha" value="P" id="diusaha" /> &nbsp; Tuan Tanah
                            ...
                            <tr id="diUsahaOleh">
                                <td colspan="2">
                                    <display:table class="tablecloth" name="${actionBean.listPermohonanLaporanUsaha}" pagesize="5" cellpadding="0" cellspacing="0"
                                        ...
                                        <display:column title="Pengusaha Tanah Selain Tuan Tanah">
                                            ${line.diUsaha}
                                        </display:column>
                                    </display:table>
                            ...
                            <tr id="tarikh">
                                ...
                                <td>
                                    <%--<s:text name="laporanTanah.tarikhMulaUsaha2" class="datepicker" id="datepicker" formatType="date" formatPattern="dd/MM/yyyy"   />--%>
                                    <s:text name="laporanTanah.mercuTanda" id="mercuTanda"/>
                                </td>
                            </tr>
                            ...
                            <tr id="luasTanam">
                                <td>
                                    Luas Yang Diusahakan (meter persegi)
                                </td>
                                <td>
                            ...
                            <tr id="nilaianTanah">
                                <td>
                                    Anggaran Nilaian Tanah Termasuk Tanaman(RM)
                                </td>
                                <td>
                                    <s:text name="usahaHarga" id="usahaHarga" size="35" onkeyup="validateNumber(this,this.value);"/>
                                </td>
