...
<script language="javascript" type="text/javascript">
    ...
    alert("idKandungan:"+idKandungan);--%>
            ...
            if(idKandungan == ''){
                ...
                var url = '${pageContext.request.contextPath}/pengambilan/mmk_ns_PB_new?deleteSingle&idKandungan='
    ...
    <%--element1.value ="rayuanTuan"+(count5)+(rowCount5+1);--%>
        ...
        function deleteTable5(formPtg,form1) {
            ...
            if(parseInt(count5) <= parseInt(temp5)) {
                ...
                var url = '${pageContext.request.contextPath}/pengambilan/mmk_ns_PB_new?deleteTable&bil='
...
<s:form beanclass="etanah.view.stripes.pengambilan.Mmk_ns_PB_newActionBean" name="form2">
    <s:messages/>
    <s:errors/>
    <c:if test="${form1}">
        ...
        <div class="subtitle">
            <fieldset class="aras1" id="locate">
                <div class="content" align="center">
                    <c:if test="${actionBean.kodUrusan eq '831A'}">
                    <b>( KERTAS UNTUK PERTIMBANGAN Y.A.B MENTERI BESAR )</b>
                    </c:if>
                    <c:if test="${actionBean.kodUrusan eq '831B' or '831C'}">
                    <b>( KERTAS PERTIMBANGAN MAJLIS MESYUARAT KERAJAAN NEGERI )</b>
                    </c:if>
                    <table border="0" width="80%">
                        <tr><td> &nbsp;</td></tr>
                        <tr><td align="left">
                                    <c:if test="${actionBean.kodUrusan eq '831A'}">
                                    <b><label><font color="black">Kertas Bil<font color="red">*</font> :</font></label><s:text name="kertasBil"  size="10" style="text-align:left" id="kertasBil" disabled="true"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b>
                                    </c:if>
                                    <c:if test="${actionBean.kodUrusan eq '831B' }">
                                    <b><label><font color="black">Kertas Mesyuarat No<font color="red">*</font> :</font></label><s:text name="kertasBil"  size="10" style="text-align:left" id="kertasBil" disabled="true"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b>
                                     ...
                                     <c:if test="${actionBean.kodUrusan eq '831C' }">
                                    <b><label><font color="black">Kertas Mesyuarat No<font color="red">*</font> :</font></label><s:text name="kertasBil"  size="10" style="text-align:left" id="kertasBil" disabled="true"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b>
                                    </c:if>
                                     <c:if test="${actionBean.kodUrusan eq 'PBA' }">
                                    <b><label><font color="black">Kertas Mesyuarat No<font color="red">*</font> :</font></label><s:text name="kertasBil"  size="10" style="text-align:left" id="kertasBil" disabled="true"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b>
                                    </c:if>
                                    </td></tr>
                        ...
                        <tr><td><b><s:hidden name="heading1" class="normal_text"/><s:hidden name="heading3" class="normal_text"/>
                                    ${actionBean.heading1}
                                    <c:if test="${(actionBean.bil1) != (actionBean.bil2)}">
                                        <s:select name="heading2" id="heading2">
                                        <s:option value="">Pilih</s:option>
                                        <s:option value="SEBAHAGIAN" selected="true">SEBAHAGIAN</s:option>
                                        <s:option value="KESELURUHAN">KESELURUHAN</s:option>
                                        </s:select>
                                    </c:if>
                                    <c:if test="${(actionBean.bil1) == (actionBean.bil2)}">
                                        <s:select name="heading2" id="heading2">
                                        <s:option value="">Pilih</s:option>
                                        <s:option value="SEBAHAGIAN">SEBAHAGIAN</s:option>
                                        <s:option value="KESELURUHAN" selected="true">KESELURUHAN</s:option>
                                        </s:select>
                                    </c:if>
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>2. LATAR BELAKANG TANAH</b></td></tr>
                        <tr><td>
                                <table id ="dataTable3">
                                    <c:set var="i" value="1" />
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>3. HURAIAN PENTADBIR TANAH SEREMBAN</b></td></tr>
                        <tr><td>
                                <table id ="dataTable6">
                                    <c:set var="k" value="1" />
                                    <c:forEach items="${actionBean.senaraiKertasKandungan6}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td><c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan6${k}" id="kandungan6${k}" rows="5" cols="150"  class="normal_text">${line.kandungan}</s:textarea></font></td>
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>4. SYOR PENTADBIR TANAH SEREMBAN</b></td></tr>
                                ...
                                <table id ="dataTable8">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan8}" var="line">
                                        <tr style="font-weight:bold">
                                            ...
                                            <td><s:button class="btn" value="Hapus" name="delete" id="${k}" onclick="deleteRow8('${formPtg}','${form1}',${line.idKandungan},${i})" disabled="true"/></td>
                                        </tr>
                        ...
                        <tr>
                            <td width="100%"><b>7.1</b> 
                                <c:if test="${actionBean.kodUrusan eq '831A'}">
                                Dikemukakan kertas Bil.${actionBean.kertasBil}/${actionBean.kertasTahun} untuk pertimbangan dan kelulusan Yang Amat Berhormat Menteri Besar, Negeri Sembilan Darul Khusus.
                                </c:if>
                                <c:if test="${actionBean.kodUrusan eq '831B'}">
                ...
                <div class="content" align="center">
                   <c:if test="${actionBean.kodUrusan eq '831A'}">
                    ...
                    <table border="0" width="80%">
                        ...
                        <tr><td align="left">
                                    <c:if test="${actionBean.kodUrusan eq '831A'}">
                                    <b><label><font color="black">Kertas Bil<font color="red">*</font> :</font></label><s:text name="kertasBil"  size="10" style="text-align:left" id="kertasBil"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b>
                                    </c:if>
                                    <c:if test="${actionBean.kodUrusan eq '831B' or '831C' or 'PBA'}">
                        ...
                        <tr><td><b><s:hidden name="heading1" class="normal_text"/><s:hidden name="heading3" class="normal_text"/>
                                    ...
                                    <s:select name="heading2" id="heading2">
                                        ...
                                        <s:option value="SEBAHAGIAN">SEBAHAGIAN</s:option>
                                        <s:option value="KESELURUHAN">KESELURUHAN</s:option>
                                    </s:select>${actionBean.heading3}</b></td></tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>1. TUJUAN</b></td></tr>
                        <tr>
                            <td>
                                <table width="100%">
                                    <tr><td >&nbsp;&nbsp;&nbsp;</td><td valign="top">1.1.&nbsp;</td><td><s:textarea rows="5" cols="140" name="tujuan" class="normal_text" /></td></tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table id ="dataTable8">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan8}" var="line">
                                        <tr style="font-weight:bold">
                                            ...
                                            <td><c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan8${k}" id="kandungan8${k}" rows="5" cols="150" class="normal_text">${line.kandungan}</s:textarea></font></td>
                                            <td><s:button class="btn" value="Hapus" name="delete" id="${k}" onclick="deleteRow8('${formPtg}','${form1}',${line.idKandungan},${k})"/></td>
                                        </tr>
                                        <s:hidden name="idKandungan8${k}" id="idKandungan8${k}" value="${line.idKandungan}" />
                                        <c:set var="k" value="${k+1}" />
                                    </c:forEach>
                        ...
                        <tr><td align="right"><s:button name="ulasanPengarahTanah" value="Tambah" class="btn" onclick="addRow8('dataTable8')" />
                                <%--<s:button name="ulasanPengarahTanah" value="Hapus" class="btn" onclick="deleteRow8()" />--%>
                            </td>
                        </tr>
