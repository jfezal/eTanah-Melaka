...
<s:form beanclass="etanah.view.stripes.pengambilan.rekodKeputusanMMKn9ActionBean">
    ...
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            ...
            <legend><c:if test="${actionBean.permohonan.kodUrusan.kod eq 'SEK4' && actionBean.permohonan.cawangan.kod eq '05'}">Keputusan MMK Pengambilan Seksyen 4</c:if>
                        ...
                        <c:if test="${actionBean.permohonan.kodUrusan.kod eq '831B'}">Keputusan Jawatankuasa Khas</c:if>
                        <c:if test="${actionBean.permohonan.kodUrusan.kod eq '831C'}">Keputusan Jawatankuasa Khas</c:if>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>Keputusan Jawatankuasa Khas</legend>
            <table width="80%" border="0" >
               <%-- <c:if test="${bilMesyuarat}">
                ...
                <tr >
                    ...
                    <td> <s:radio name="keputusan"  value="L"/>Lulus&nbsp;
                        <s:radio name="keputusan" value="TL"/>Tolak&nbsp;</td>
                </tr>
                <tr >
                    <td width="50%" align="right"><font color="#003194" size="2"><b>Tarikh Mesyuarat Jawatankuasa Khas :</b></font></td>
                    <td> ${actionBean.tarikhKhas}</td>
                </tr>
                </c:if>
            </table>
            ...
            <p>
                ...
                <c:if test="${simpanMesyuarat}">
                    <s:button name="simpanKhas" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
                </c:if>
            </p>
        </fieldset >
    </div>
    ...
    <c:if test="${view}">
        ...
        <fieldset class="aras1">
            <%--<legend>Rekod Keputusan Kertas Pertimbangan Menteri Besar</legend>--%>
            <!--<legend>Rekod Keputusan Mesyuarat Jawatankuasa Khas</legend><br />-->
            <p>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>Keputusan Mesyuarat Jawatankuasa Khas</legend>
                <table width="80%" border="0" >
                    <%--<tr>
                    ...
                    <tr>
                        <td><label>Keputusan Mesyuarat Jawatankuasa Khas :</label></td>
                    ...
                    <tr>
                        <td valign="top" width="45.9%" align="right">
                            <font color="#003194" size="2"><b></b></font></td>
