...
<script type="text/javascript">
    ...
    function selectCheckBox()
    {
        ...
        if(confirm("Adakah anda pasti?")) {
            var url = '${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?simpanAgensi&item='+data ;
            $.get(url,
            function(data){
...
<body>
    ...
    <s:messages/>
    <div class="subtitle">
        <s:form beanclass="etanah.view.stripes.pengambilan.LaporanTanahNewDisposalActionBean" name="frm">
        ...
        <div class="subtitle">
            ...
            <fieldset class="aras1">
                <s:hidden name="${actionBean.sizeKod}" id="sizeKod" value="${fn:length(actionBean.listKodAgensi)}"/>
                <p>
