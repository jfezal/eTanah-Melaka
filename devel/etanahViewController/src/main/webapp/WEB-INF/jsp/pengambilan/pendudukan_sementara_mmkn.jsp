...
<script language="javascript" type="text/javascript">
    ...
    function deleteRow1()
    {
        ...
        if (document.getElementById('idKandungan1'+(i)) != null) {
            var url = '${pageContext.request.contextPath}/pengambilan/borang_mmkn_sementara?deleteSingle&idKandungan='
            +idKandungan;
...
function validation() {
    ...
    if($("#ulasan4").val() == ""){
            alert('Sila pilih " 4. ULASAN YB.ADUN KAWASAN " terlebih dahulu.');
            $("#ulasan4").focus();
            return false;
    }
...
<s:form beanclass="etanah.view.stripes.pengambilan.PendudukanSementaraMMKNActionBean" name="form2">
    <s:messages/>
    <s:errors/>
    <c:if test="${form}">
                    ...
                    <table border="0" width="80%">
                        <div class="content" align="left">
                            ...
                            <tr align="left"><td align="left">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                    <u><b>MAJLIS MESYUARAT KERAJAAN NEGERI NEGERI MELAKA</b></u><br /></td></tr>
                            <tr><td> &nbsp;</td></tr>
                            ...
                            <tr><td align="left"><b><label><font color="black">TARIKH :</font></label><s:text name="tarikhmesyuarat" id="tarikhMesyuarat" size="30" style="text-align:left" disabled="true"/></b></td></tr><br>
                        ...
                        <tr><td><b>1. TUJUAN</b></td></tr>
                        <tr><td><b>&nbsp;&nbsp;&nbsp;1.1</b></td></tr>
                        <tr><tr><tr><td colspan="2"><b> &nbsp;</b><font style="text-transform: lowercase"><s:textarea rows="5" cols="140" name="tujuan"/></font><td>
                                ...
                                <table id ="dataTable1">
                                  ...
                                  --%>      <c:forEach items="${actionBean.senaraiKertasKandungan1}" var="line">
                                        ...
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font style="text-transform: lowercase"><s:textarea name="kandungan1${i}" id="kandungan1${i}" rows="5" cols="150" onkeyup="this.value=this.value.toLowerCase();">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                                ...
                                <table id ="dataTable2">
                                    ...
                                    <%--<c:if test="${actionBean.senaraiKertasKandungan2 eq null}">
                                     ...
                                     --%>   <c:forEach items="${actionBean.senaraiKertasKandungan2}" var="line">
                                           <%-- <s:hidden name="rowCount" value="${i}"/>--%>
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font style="text-transform:  lowercase"><s:textarea name="kandungan2${i}" id="kandungan2${i}" rows="5" cols="150" onkeyup="this.value=this.value.toLowerCase();">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                                ...
                                <table id ="dataTable3">
                                    ...
                                    <%--<c:if test="${actionBean.senaraiKertasKandungan3 eq null}">
                                     ...
                                     --%>   <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                            <%--<s:hidden name="rowCount" value="${i}"/>--%>
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font style="text-transform: lowercase"><s:textarea name="kandungan3${i}" id="kandungan3${i}" rows="5" cols="150" onkeyup="this.value=this.value.toLowerCase();">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                        ...
                        <tr><td>
                                <table id ="dataTable4">
                                   ...
                                   --%>     <c:forEach items="${actionBean.senaraiKertasKandungan4}" var="line">
                                           <%-- <s:hidden name="rowCount" value="${i}"/>--%>
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font style="text-transform:lowercase"><s:textarea name="kandungan4${k}" id="kandungan4${k}" rows="5" cols="150" onkeyup="this.value=this.value.toLowerCase();">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                        ...
                        <tr><td><s:textarea name="syorPtg.kandungan" rows="5" cols="150" id="syorPtg1" readonly="true"/></td></tr><br>
                ...
                <div class="content" align="center">
                    <table border="0" width="80%">
                        <div class="content" align="left">
                            ...
                            <tr><td align="left"><b><label><font color="black">TARIKH :</font></label><s:text name="tarikhmesyuarat" id="tarikhMesyuarat" class="datepicker" size="30" style="text-align:left"/></b></td></tr><br>
                        ...
                        <tr><td>
                                <table id ="dataTable1">
                                  ...
                                  --%>      <c:forEach items="${actionBean.senaraiKertasKandungan1}" var="line">
                                            <%--<s:hidden name="rowCount" value="${i}"/>--%>
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font style="text-transform: lowercase"><s:textarea readonly="true" name="kandungan1${i}" id="kandungan1${i}" rows="5" cols="150" onkeyup="this.value=this.value.toLowerCase();">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                                        <s:hidden name="idKandungan1${i}" id="idKandungan1${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                                ...
                                <table id ="dataTable2">
                                    ...
                                    <%--<c:if test="${actionBean.senaraiKertasKandungan2 eq null}">
                                     ...
                                     --%>   <c:forEach items="${actionBean.senaraiKertasKandungan2}" var="line">
                                           <%-- <s:hidden name="rowCount" value="${i}"/>--%>
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font style="text-transform: lowercase"><s:textarea readonly="true" name="kandungan2${i}" id="kandungan2${i}" rows="5" cols="150" onkeyup="this.value=this.value.toLowerCase();">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                                        <s:hidden name="idKandungan2${i}" id="idKandungan2${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                                ...
                                <table id ="dataTable3">
                                    ...
                                    <%--<c:if test="${actionBean.senaraiKertasKandungan3 eq null}">
                                     ...
                                     --%>   <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                            <%--<s:hidden name="rowCount" value="${i}"/>--%>
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font style="text-transform: lowercase"><s:textarea readonly="true" name="kandungan3${i}" id="kandungan3${i}" rows="5" cols="150" onkeyup="this.value=this.value.toLowerCase();">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                                        <s:hidden name="idKandungan3${i}" id="idKandungan3${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                        ...
                        <tr><td><b>3. ULASAN JABATAN-JABATAN TEKNIKAL</b></td></tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>3.1 </b><s:select name="subtajuk1" style="width:400px" disabled="true">
                                <s:option value="">Sila Pilih</s:option>
                                <s:option value="Jabatan Kebajikan Masyarakat">Jabatan Kebajikan Masyarakat</s:option>
                                <s:option value="Jabatan Kerja Raya">Jabatan Kerja Raya</s:option>
                                <s:option value="Jabatan Pengairan dan Saliran">Jabatan Pengairan dan Saliran</s:option>
                        ...
                        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textarea name="ulasan1" rows="5" cols="150" readonly="true"/></td></tr><br>

                        <tr><td><b>3.2 </b><s:select name="subtajuk2" style="width:400px" disabled="true">
                                <s:option value="">Sila Pilih</s:option>
                                <s:option value="Jabatan Kebajikan Masyarakat">Jabatan Kebajikan Masyarakat</s:option>
                                <s:option value="Jabatan Kerja Raya">Jabatan Kerja Raya</s:option>
                                <s:option value="Jabatan Pengairan dan Saliran">Jabatan Pengairan dan Saliran</s:option>
                        ...
                        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textarea name="ulasan2" rows="5" cols="150" readonly="true"/></td></tr><br>

                        <tr><td><b>3.3 </b><s:select name="subtajuk3" style="width:400px" disabled="true">
                                <s:option value="">Sila Pilih</s:option>
                                <s:option value="Jabatan Kebajikan Masyarakat">Jabatan Kebajikan Masyarakat</s:option>
                                <s:option value="Jabatan Kerja Raya">Jabatan Kerja Raya</s:option>
                                <s:option value="Jabatan Pengairan dan Saliran">Jabatan Pengairan dan Saliran</s:option>
                        ...
                        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textarea name="ulasan3" rows="5" cols="150" readonly="true"/></td></tr><br>

                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>4. ULASAN YB.ADUN KAWASAN</b></td></tr>
                        <tr><td><%--<b> &nbsp;</b><font style="text-transform: uppercase">--%><s:textarea name="ulasan4" rows="5" cols="150"  readonly="true"/><%--</font>--%></td></tr><br>
                        ...
                        <tr><td>
                                <table id ="dataTable4">
                                   ...
                                   --%>     <c:forEach items="${actionBean.senaraiKertasKandungan4}" var="line">
                                           <%-- <s:hidden name="rowCount" value="${i}"/>--%>
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font style="text-transform:lowercase"><s:textarea readonly="true" name="kandungan4${k}" id="kandungan4${k}" rows="5" cols="150" onkeyup="this.value=this.value.toLowerCase();">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                                        <s:hidden name="idKandungan4${k}" id="idKandungan4${k}" value="${line.idKandungan}" />
                                            <c:set var="k" value="${k+1}" />
                                        </c:forEach>
