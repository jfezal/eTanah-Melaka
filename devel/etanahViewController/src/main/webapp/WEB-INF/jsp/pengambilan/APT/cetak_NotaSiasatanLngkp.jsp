...
//    }
    ...
    function cetak222(id1) {
        //alert(id1);
        var report = 'ACQBrgSiasatKosong_MLK.rdf';
        var url = "reportName=" + report + "%26report_p_id_mohon=" + id1;
...
<div id="laporan">
    <s:form beanclass="etanah.view.stripes.pengambilan.sek8.Laporan_DrafNotaSiasatanLngkp">
        <div class="subtitle">
                        ...
                        <td><div align="center">
                                <p align="center">
                                    <img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                         onmouseover="this.style.cursor = 'pointer';" onclick="cetak222('${actionBean.idPermohonan}');">
                                </p>
                            </div>
                        </td>
                    </tr>
