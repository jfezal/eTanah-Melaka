<%--
    ...
    Created on : June 21, 2011, 11:55:47 AM
    Author     : Rajesh
--%>
...
<s:useActionBean beanclass="etanah.view.stripes.pengambilan.KemasukkanIdhahmilik_BantahanMahkamahActionBean" var="list"/>

<s:form beanclass="etanah.view.stripes.pengambilan.KemasukkanIdhahmilik_BantahanMahkamahActionBean" >
            ...
            <display:table name="${actionBean.kandunganFolderTamb}" id="row1"  class="tablecloth"  >
                <display:column title="Pilih" >
                    <s:select name="kandunganFolderTamb[${row1_rowNum - 1}].dokumen.kodDokumen.kod"
                        ...
                        <s:options-collection collection="${actionBean.kodDokumenNotRequired}"
