...
<script type="text/javascript">
    ...
    function removeNilai(idPenilaian)
    {
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/pengambilan/maklumatPampasan_mlk?deleteNilai&idPenilaian='+idPenilaian;
            $.get(url,
            function(data){
                $('#page_div').html(data);
   ...
   function removeNilaiNotPM(idPenilaian)
    {
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/pengambilan/maklumatPampasan_mlk?deleteNilaiNotPM&idPenilaian='+idPenilaian;
            $.get(url,
            function(data){
                $('#page_div').html(data);
    <%--self.opener.refreshPageTanahRizab();--%>
...
<s:form beanclass="etanah.view.stripes.pengambilan.MaklumatPampasanMlkActionBean">
    <div  id="hakmilik_details">
            ...
            <div align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
                    ...
                    <display:column title="ID Hakmilik">
                        <s:link beanclass="etanah.view.stripes.pengambilan.MaklumatPampasanMlkActionBean"
        ...
        <c:if test="${actionBean.hakmilik ne null}">
            <fieldset class="aras1">
                ...
                <div align="center">
                    Sila masukkan nilaian untuk setiap Pihak Berkepentingan yang berkaitan.
            ...
            <fieldset class="aras1">
                ...
                <div align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilik}" cellpadding="0" cellspacing="0" id="tbl1">
                      ...
                      <%--  <display:column title="Daerah" property="daerah.nama" class="daerah" />
                        <display:column property="bandarPekanMukim.nama" title="Bandar/Pekan/Mukim" />--%>
                        <display:column title="Terima" style="vertical-align:baseline">
      ...
      <div align="center">
          <display:table class="tablecloth" name="${actionBean.penilaianTanahList}" cellpadding="0" cellspacing="0" id="tbl1">
            ...
            <table >
                ...
                <tr>
                    ...
                    <td><s:button name="simpanBngn" id="save" value="Simpan B" class="btn" onclick="if(validationBngn())doSubmit(this.form, this.name, 'page_div')"/></td>
        ...
        <c:if test="${showDetailsNOTPM}">
            <table>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>${actionBean.permohonanPihak.pihak.nama}<br /></td>
                </tr>
            </table>
            <br />
            <br/><br/>
             ...
             <table>
                 ...
                 <tr>
                     <%--if(validationTanah())--%>
                      <s:hidden name="idPermohonanPihak" value ="${actionBean.idPermohonanPihak}" />
                      <s:hidden name="idHakmilik" value ="${actionBean.idHakmilik}" />
                     <td><label for="tanahItem">Baki Pinjaman :</label></td>
                     <td width="20%"> RM <s:text name="amaunPinjaman" size="20" id="amaunPinjaman" onkeyup="validateNumber(this,this.value);"/><br/></td>
                     <%--<td ><font color="#003194" style="Tahoma" size="2px"><b>RM :</b></font></td>
                     <td width="18%"><s:text name="tanahAmaun" size="20" id="tanahAmaun" onkeyup="validateNumber(this,this.value);"/></td>--%>
                     <td><s:button name="simpanPinjaman" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/></td>
                 </tr>
             </table>
            ...
            <div align="center">
                <display:table class="tablecloth" name="${actionBean.penilaianPinjamanList}" cellpadding="0" cellspacing="0" id="tbl1">
                    <display:column title="No" sortable="true" style="vertical-align:baseline">${tbl1_rowNum}</display:column>
                    <display:column property="item" title="Item" />
                    <display:column property="amaun" title="Amaun (RM)" />
                    <display:column title="Hapus">
                        <div align="center">
                            <img alt='Klik Untuk Hapus' border='0' src='${pageContext.request.contextPath}/images/not_ok.gif' class='rem' id='rem_${line_rowNum}' onmouseover="this.style.cursor='pointer';" onclick="removeNilaiNotPM('${tbl1.idPenilaian}');" />
                        </div>
                    </display:column>
                </display:table>
            </div>
