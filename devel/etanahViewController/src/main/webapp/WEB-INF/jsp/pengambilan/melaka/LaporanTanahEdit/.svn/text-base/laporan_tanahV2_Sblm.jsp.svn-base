...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.hakmilikPermohonan ne null}">
        ...
        function reload (val) {
            doBlockUI();
            var url = '${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?reload&idHakmilik=' + val;
            $.ajax({
                type:"GET",
                url : url,
                dataType : 'html',
        ...
        function openFrame(type){
            ...
            //  alert(idHakmilik);
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_tanahV2_sblm?openFrame&idHakmilik="
        ...
        function refreshV2(type){
            var url = '${pageContext.request.contextPath}/pengambilan/laporan_tanahV2_sblm?refreshpage&type='+type;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
        ...
        function refreshV2ManyHakmilik(type,hakmilik){
            var url = '${pageContext.request.contextPath}/pengambilan/laporan_tanahV2_sblm?refreshpage&type='+type+'&idHakmilik='+hakmilik;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
...
<s:form beanclass="etanah.view.stripes.pengambilan.LaporanTanahNewDisposalSblmActionBean" name="form">
    <s:errors/>
    <s:messages/>
...
<br/>-->
        <fieldset class="aras1">
            <legend>Perihal Tanah : ${actionBean.idHakmilik}
            ...
            <div id="perihaltanah">
                <div class="content" align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="20" cellpadding="0" cellspacing="0" id="line"
                                   requestURI="/pengambilan/laporan_tanahV2_sblm">
                        <c:if test="${line.hakmilikPermohonan.hakmilik ne null}">
                            ...
                            <display:column title="Seksyen">
                                ...
                                <c:if test="${line.hakmilikPermohonan.kodSeksyen.nama ne null}">
                                    ${line.hakmilikPermohonan.seksyen.nama}
                                </c:if>
                            </display:column>
                    ...
                    <table class="tablecloth" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <s:select name="hmImej" style="width:400px;" id="hmImej" onchange="doSetDokumenHakmilik();">
                                    <c:if test="${actionBean.hakmilikImejLaporanList eq null}">
                                        <s:option value="">Sila pilih imej untuk dipaparkan</s:option>
                                    </c:if>
                                    <c:if test="${actionBean.hakmilikImejLaporanList ne null}">
    ...
    <div class="subtitle" align="center">
        <fieldset class="aras1">
            <legend>
                Terletak di dalam Kawasan : ${actionBean.idHakmilik}
                <span style="float:right">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>Bersempadan dengan : ${actionBean.idHakmilik}
                <span style="float:right">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <legend>Keadaan Tanah : ${actionBean.idHakmilik}
                <span style="float:right">
                ...
                <table class="tablecloth" align="center">
                    ...
                    <c:if test="${actionBean.laporanTanah.usaha eq 'T'}">
                        <tr>
                            ...
                            <td> <fmt:formatNumber pattern="#,##0.00" value="${actionBean.usahaHarga}"/>&nbsp;
                            </td>
                        </tr> 
                    </c:if>
                    <c:if test="${actionBean.laporanTanah.usaha eq 'Y'}">
                ...
                <c:if test="${actionBean.laporanTanah.usaha eq 'Y'}">
                    <table class="tablecloth">
                        ...
                        <tr align="center">
                            ...
                            <td>
                                <fmt:formatNumber pattern="#,##0.00" value="${actionBean.usahaHarga}"/>&nbsp;
                            </td>
                        </tr>
                    </table>
                </c:if>
    ...
    <div class="subtitle" id="updiv">
        <fieldset class="aras1">
            <legend>Perihal Lot-Lot Bersempadan : ${actionBean.idHakmilik}
                <span style="float:right">
            ...
            <div id ="lotsempadan">
                <div class="content" align="center">
                    <table class="tablecloth">
                        <tr>
                            <th>&nbsp;</th><th>ID. Hakmilik</th><th>No. Lot</th><th>Kegunaan Tanah</th><th>Keadaan Tanah</th><th>Jarak Dari Tanah Diambil</th><th>Catatan</th><th>Milik Kerajaan</th><th>Imej Tanah</th>
                            <%--UTARA--%>
    ...
    <c:if test="${actionBean.kodNegeri eq '05'}">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Jabatan - Jabatan Teknikal</legend>
                <span style="float:right">
                    <%-- <a onclick="viewDalamKawasan();" onmouseover="this.style.cursor='pointer';" ><img alt="Papar" height="25px" width="25px" src='${pageContext.request.contextPath}/pub/images/icons/view_pelupusan_small.png'/></a> | --%>
                ...
                <div id="jabatan_teknikal" align="center">
                    <display:table class="tablecloth" name="${actionBean.senaraiUlasanJabatanTeknikal}" cellpadding="0" cellspacing="0" id="line"
                                   requestURI="${pageContext.request.contextPath}/pengambilan/laporan_tanahV2">                              
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                ...
                <span style="float:right">
                    <%--<c:if test="${actionBean.pengguna.perananUtama eq '24'}">--%>
            ...
            <%--<c:choose>
                ...
                <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PTNB' }">
                    <c:import url="laporan_tanahView/syor/syorBMBT.jsp"></c:import>
                </c:when>
                <c:when test="${actionBean.permohonan.kodUrusan.kod eq 'PTNB' }">
                    <c:import url="syor.jsp"></c:import>
                </c:when>
                <c:otherwise>
            ...
            <table class="tablecloth" align="center">
                ...
                <tr><td style="text-align: right"></td>
                    <td><s:textarea value="${actionBean.syorUlasan}" cols="120" id="syorUlasan" name="syorUlasan"  rows="15"/></td>
                </tr>
                <%--<c:set var="i" value="${i+1}" />--%>
                <%--</c:forEach>--%>
                <%--</c:if>--%>
    ...
    <br/>
    <%--<c:if test="${actionBean.stageId ne 'laporan_tanah' and actionBean.stageId ne '04SediaLaporanTanah' and actionBean.stageId ne '04SediaLaporan' ne 'sedia_laporan_tanahptg' ne 'sedia_draf_jkbb'}">--%>
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:choose>
                <c:when test="${actionBean.kodNegeri eq '05'}">
                    <legend>
                        ...
                        <span style="float:right">
                            <c:if test="${actionBean.peng.perananUtama.kod eq '32'}">
                                <%-- <a onclick="viewSyor();" onmouseover="this.style.cursor='pointer';" ><img alt="Papar" height="25px" width="25px" src='${pageContext.request.contextPath}/pub/images/icons/view_pelupusan_small.png'/></a> | --%>
                    ...
                    <table class="tablecloth" align="center">
                        ...
                        <tr><td style="text-align: right"></td>
                            <td><s:textarea value="${actionBean.syorUlasanPPTK}" cols="120" readonly="true" name="syorUlasanPPTK" rows="15"/></td>
                        </tr>
                        <%--      <c:set var="i" value="${i+1}" />
                          </c:forEach>
                      </c:if>    
                      <c:if tes--%><%--t="${empty actionBean.senaraiLaporanKandunganPPTKanan}">--%>
                        <%--    <tr>
                                <td><s:textarea value="TIADA ULASAN PENOLONG PEGAWAI TANAH TELAH DIBUAT." cols="80" readonly="true" name="syorUlasan" rows="5"/></td>
                            </tr>
                        </c:if>--%>
                    ...
                    <table class="tablecloth" align="center">
                        ...
                        <c:forEach items="${actionBean.senaraiLaporanKandunganPPTKanan}" var="line">
                            <tr><td style="text-align: right">${i}</td>
                                <td><s:textarea value="${actionBean.syorUlasanPPTK}" cols="180" readonly="true" name="syorUlasanPPTK" rows="35"/></td>
                            </tr>
                            <c:set var="i" value="${i+1}" />
                        </c:forEach> 
                    </table>
