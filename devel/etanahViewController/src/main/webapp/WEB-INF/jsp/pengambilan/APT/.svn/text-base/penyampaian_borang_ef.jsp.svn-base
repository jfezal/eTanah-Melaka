...
<s:form beanclass="etanah.view.stripes.pengambilan.sek8.PenyampaianBorangEFActionBean" name="AB" id="AB">
                    ...
                    <td width="60%">
                        <div>
                            <display:table class="tablecloth" name="${actionBean.listBorangE}"
                                ...
                                <display:column title="Jumlah Pihak" sortable="true">${line.hm.hakmilik.idHakmilik}</display:column>
                                <display:column title="Papar" sortable="true">
                                    <a href="${pageContext.request.contextPath}/pengambilan/penyampaian_e_f?senaraiF&idPermohonan=${line.hm.permohonan.idPermohonan}&idHakmilik=${line.hm.hakmilik.idHakmilik}&idBorangPerHm=${line.id}&urlKembali=${actionBean.urlKembali}"><s:button name="papar" class="btn" value="Papar Senarai"/></a> </display:column>        
                            </display:table>
