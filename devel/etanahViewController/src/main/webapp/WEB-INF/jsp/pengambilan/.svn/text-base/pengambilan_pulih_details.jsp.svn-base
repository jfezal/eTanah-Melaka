...
<body>
    <script>
        ...
        function p(v){
            ...
            $.get("${pageContext.request.contextPath}/pengambilan/depositPemulihan?pihakDetails&idPihak="+v,

            function(data){
                //alert(data);

                <%--$("#perincianHakmilik").eq(0).html("");
                alert("hide");--%>
                $("#perincianHakmilik").show(data);
    ...
    <s:useActionBean beanclass="etanah.view.ListUtil" id="listUtil" />
    <s:form beanclass="etanah.view.stripes.pengambilan.PengambilanPemulihanActionBean" name="form">
        <s:errors/>
        <s:messages/>
        <fieldset class="aras1">
            <%--<c:if test="${edit}">--%>
            <c:if test="${actionBean.showPulih eq true}">
                <%--<c:import url="pengambilan_pulih.jsp"></c:import>--%>
                                    ...
                                    <div class="content" align="center">
                                        <p>
                                            <display:table style="width:75%" class="tablecloth" name="${actionBean.hakmilikPermohonan.hakmilik.senaraiPihakBerkepentingan}"
                                                ...
                                                <c:if test="${line.pihak.noPengenalan ne null && line.pihak.jenisPengenalan.kod eq null}">
                                                No.K/P :&nbsp;
                                                ${line.pihak.noPengenalan}
                                            </c:if>
                                                </display:column>--%>
                ...
                <div class="newboxes" id="perincianHakmilik">
                </div>
            </c:if>
                ...
                <div class="content" align="center">
                    ...
                    <table class="tablecloth" border="0" width="75%">
                        ...
                        <tr>
                            ...
                            <td>
                                RM <s:text name="sum" id="sum" formatPattern="#,##0.00" size="10" value="${actionBean.permohonanPihakPendeposit.amaun}"/>
                            </td>
                        </tr>
                        <tr>
