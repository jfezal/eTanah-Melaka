<%-- 
    Document   : KeputusanBorangM
    Created on : Jul 22, 2013, 11:17:55 AM
    Author     : Admin
--%>
...
<script type="text/javascript">
    ...
    function removeNilai(idPenilaian)
    {
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/pengambilan/keputusanBorangM?deleteNilai&idPenilaian='+idPenilaian;
            $.get(url,
            function(data){
                $('#page_div').html(data);
...
<s:form beanclass="etanah.view.stripes.pengambilan.KeputusanBorangMActionBean">
            ...
            <div align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
                    ...
                    <display:column title="ID Hakmilik">
                        <s:link beanclass="etanah.view.stripes.pengambilan.KeputusanBorangMActionBean"
                ...
                <div align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilik}" cellpadding="0" cellspacing="0" id="tbl1">
                        ...
                        <display:column title="Orang Berkepentingan" style="vertical-align:baseline">
                            ...
                            <%--   <display:table class="tablecloth" name="${actionBean.perbicaraanKehadiranList}" pagesize="5" cellpadding="0" cellspacing="0"
                                              requestURI="/pengambilan/maklumatPampasan" id="linec">
                                   ...
                                   <s:link beanclass="etanah.view.stripes.pengambilan.MaklumatPampasanActionBean"
                                           event="pihakDetails" onclick="return ajaxLink(this, '#hakmilik_details');" >
                                       <s:param name="idPihak" value="${linec.pihak.idPihak}"/>${senarai.pihak.nama}
                                   </s:link>
                                   <br/>
                                   No KP ${linec.pihak.noPengenalan}
                               </c:if>

                                <c:if test="${actionBean.perbicaraanKehadiran.bantahElektrik eq '1'}">

                                    <s:param name="idPihak" value="${linec.pihak.idPihak}"/>${linec.pihak.nama}
            ...
            <br />
             <table>
                 <tr>
                     ...
                     <td align="right" width="20%"><label for="keputusan">Keputusan :</label></td>
                     <td><c:if test="${actionBean.perbicaraanKehadiran.penuntut eq null}">
                         <s:radio name="pecahSyarat" value="K"/>&nbsp;Kekal
                         <s:radio name="pecahSyarat" value="X"/>&nbsp;Tambahan<br/>
                         </c:if>
                         <c:if test="${actionBean.perbicaraanKehadiran.penuntut ne null && actionBean.perbicaraanKehadiran.penuntut eq 'K'}">
                             <s:radio name="pecahSyarat" value="K" checked="true"/>&nbsp;Kekal
                             <s:radio name="pecahSyarat" value="X"/>&nbsp;Tambahan<br/>
                         </c:if>
                         <c:if test="${actionBean.perbicaraanKehadiran.penuntut ne null && actionBean.perbicaraanKehadiran.penuntut eq 'X'}">
                             <s:radio name="pecahSyarat" value="K"/>&nbsp;Kekal
                             <s:radio name="pecahSyarat" value="X" checked="true"/>&nbsp;Tambahan<br/>
                         </c:if>
                     </td>
                 </tr>
             </table>
             <table>
                 <tr>
                      <s:hidden name="idPerbicaraan" value ="${actionBean.hakmilikPerbicaraan.idPerbicaraan}" />
                     <td align="right" width="20%"><label for="keputusan">Ulasan :</label></td>
                     <td width="20%"> <s:textarea name="keputusanUlasan" rows="3" cols="50"/><br/></td>
                 ...
                 <tr>
                     ...
                     <td><label for="tanahItem">Tanah :</label></td>
                     <td width="20%"> RM <s:text name="tanahAmaun" size="20" id="tanahAmaun" onkeyup="validateNumber(this,this.value);"/><br/></td>
                     <%--<td ><font color="#003194" style="Tahoma" size="2px"><b>RM :</b></font></td>
                     <td width="18%"><s:text name="tanahAmaun" size="20" id="tanahAmaun" onkeyup="validateNumber(this,this.value);"/></td>--%>
                     <td><s:button name="simpanTanah" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/></td>
                 </tr>
             </table>
          ...
          <display:table class="tablecloth" name="${actionBean.penilaianTanahList}" cellpadding="0" cellspacing="0" id="tbl1">
            ...
            <table >
                ...
                <tr>
                    ...
                    <%--<s:text name="bngnItem" size="20" id="bngnItem"/>--%>
            ...
            <table >
                ...
                <tr>
                    ...
                    <%--<s:text name="lainItem" size="20" id="lainItem"/>--%>
            ...
            <div align="center">
                <display:table class="tablecloth" name="${actionBean.permohonanPihak}" cellpadding="0" cellspacing="0" id="tbl1">
                    ...
                    <display:column  title="Item Nilaian (RM)" >
                        ...
                        <b>Keputusan Mahkamah-Tanah : RM <fmt:formatNumber pattern="#,##0.00" value="${actionBean. itemNilaianTanah}"/></b><br/>
