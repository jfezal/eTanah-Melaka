<%--
    Document   : Laporan_Pemulihan_Tanah_Sblm
    Created on : Apr 14, 2011, 5:27:23 PM
    Author     : Rajesh
--%>
...
<s:form beanclass="etanah.view.stripes.pengambilan.LaporanPemulihanTanahSblmActionBean" name="form1">
    <s:messages />
    <s:errors/>
    <div  id="hakmilik_details">
        ...
        <fieldset class="aras1"><br/>
            <div align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/LaporanPemulihanTanah_Sblm" id="line">
        ...
        <c:if test="${showDetails}">
            <fieldset class="aras1"><br/>
                <legend>Laporan pemulihan tanah bagi tuan tanah :- <br />
