            ...
            <fieldset class="aras1">
                ...
                <table width="80%" border="0" >
                    ...
                    <c:if test="${actionBean.permohonan.kodUrusan.kod ne '831A'}">
                        <tr>
                            <td><label>Tarikh Mesyuarat MMKN :</label></td>
                    ...
                    <c:if test="${keputusan}">
                        <tr >
                            ...
                            <td> 
                                <c:if test="${actionBean.keputusanMMKN eq 'Lulus'}">
                                    <s:radio name="keputusanMMKN" checked="true" value="L"/>Lulus&nbsp;
                                    <s:radio name="keputusanMMKN" value="T"/>Tolak&nbsp;</td>
                                </c:if>
                                <c:if test="${actionBean.keputusanMMKN eq 'L'}">
                                    <s:radio name="keputusanMMKN" checked="true" value="L"/>Lulus&nbsp;
                                <s:radio name="keputusanMMKN" value="T"/>Tolak&nbsp;</td>
                            </c:if>
                            <c:if test="${actionBean.keputusanMMKN eq 'Tolak'}">
                                <s:radio name="keputusanMMKN" value="L"/>Lulus&nbsp;
                                <s:radio name="keputusanMMKN" checked="true" value="T"/>Tolak&nbsp;

                            </c:if>
                            <c:if test="${actionBean.keputusanMMKN eq 'T'}">
                                <s:radio name="keputusanMMKN" value="L"/>Lulus&nbsp;
                                <s:radio name="keputusanMMKN" checked="true" value="T"/>Tolak&nbsp;

                            </c:if>
                            <c:if test="${actionBean.keputusanMMKN eq null}">
                                <s:radio name="keputusanMMKN" value="L"/>Lulus&nbsp;
                                <s:radio name="keputusanMMKN" value="T"/>Tolak&nbsp;
            ...
            <fieldset class="aras1">
                ...
                <table width="80%" border="0" >
                    ...
                    <tr>
                        ...
                        <td width="80%"><c:if test="${actionBean.keputusanMMKN eq 'Lulus'}">
                                Lulus
                            </c:if><c:if test="${actionBean.keputusanMMKN eq 'Tolak'}">
                                Tolak
                            </c:if>
                            <c:if test="${actionBean.keputusanMMKN eq 'L'}">
                                Lulus
                            </c:if><c:if test="${actionBean.keputusanMMKN eq 'T'}">
                                Tolak
                            </c:if>
                        </td>
                    </tr>
