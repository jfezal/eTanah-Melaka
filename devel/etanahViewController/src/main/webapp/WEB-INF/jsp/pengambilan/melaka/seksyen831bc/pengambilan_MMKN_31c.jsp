...
<script language="javascript" type="text/javascript">
    ...
    function deleteTable4(formPtg,form1) {
        ...
        if(parseInt(count4) <= parseInt(temp4)) {
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/mmkn31b?deleteTable&bil='
    ...
    function deleteDynamicRow4(tableID,countID,formPtg,form1) {
        ...
        if(rowCount4 >1){
            ...
            if (obj != null) {
                ...
                var url = '${pageContext.request.contextPath}/pengambilan/mmkn31b?deleteSingle&idKandungan='
    ...
    function deleteRow1()
    {
        ...
        if (document.getElementById('idKandungan1'+(i)) != null) {
            var url = '${pageContext.request.contextPath}/pengambilan/mmkn31c?deleteSingle&idKandungan='
            +idKandungan;
...
<s:form beanclass="etanah.view.stripes.pengambilan.MMKN831CActionBean" name="form2">
    <s:messages/>
    <s:errors/>
    <c:if test="${form1}">
            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                    <div class="content" align="left">
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td align="left"><b><label><font color="black">PERSIDANGAN :</font></label><s:text name="kertasBil"  size="10" style="text-align:left" id="kertasBil" class="normal_text"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b></td></tr>--%>
                        <%--<tr>
                    ...
                    <tr><td>
                            <table id ="dataTable2">
                                ...
                                <c:forEach items="${actionBean.senaraiKertasKandungan22}" var="line">
                                    <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                        <td><font style="text-transform: uppercase"><s:textarea name="kandungan2${i}" id="kandungan2${i}" rows="5" cols="150" onkeyup="this.value=this.value.toUpperCase();">${line.kandungan}</s:textarea></font></td>
                                    </tr>
                    ...
                    <tr><td><b> &nbsp;</b><font style="text-transform: uppercase"><s:textarea name="ringkasanPermohonan.kandungan" rows="5" cols="150" id="ringkasanPermohonan" /></font></td></tr><br>

                    <tr><td> &nbsp;</td></tr>
                    <tr><td><b>3. SYOR PENGARAH UNIT PERANCANG EKONOMI NEGERI</b></td></tr>
                    <tr><td><b> &nbsp;</b><font style="text-transform: uppercase"><s:textarea name="syorPengarah.kandungan" rows="5" cols="150" id="peruntukanKewangan" /></font></td></tr><br>
                    <tr><td> &nbsp;</td></tr>

                    <tr><td><b>4. KEPUTUSAN JAWATANKUASA KHAS PENGAMBILAN TANAH NEGERI MELAKA</b></td></tr>
                        <tr><td><b> &nbsp;</b><font style="text-transform: uppercase"><s:textarea name="jawatanKuasa.kandungan" rows="5" readonly="false" cols="150" id="ulasan1"/>
                                </font></td></tr><br>
                             ...
                             <c:forEach items="${actionBean.senaraiPerakuanPengarah[i]}" var="senarai">
                                <c:set var="recordCount4" value="${recordCount4+1}"/>
                                   ...
                                   <tr> <td><b>5.${i}</b></td>
                                      ...
                                      <td><s:button class="btn" value="Tambah 5.${i}" name="add" id="tambah4${i}" onclick="addDynamicRow4('table4${i}','count4${i}')"/></td>
                                      <td><s:button class="btn" value="Hapus 5.${i} sub" name="hapus" id="hapus4${i}" onclick="deleteDynamicRow4('table4${i}','count4${i}','${formPtg}','${form1}')"/></td>
                                   </c:if>
