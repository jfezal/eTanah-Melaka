...
<script type="text/javascript">
    ...
    function removeTanahRizab(idTanahRizabPermohonan)
    {
        if(confirm('Adakah anda pasti?')) {
            var url = '${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?deleteTanahRizab&idTanahRizabPermohonan='
    ...
    <%--function RunProgram2(strUserID, strNama, strJawatan, strIDPermohonan, strStageID) {
        ...
        {
            if(confirm('Adakah anda pasti?')) {
                var url = '${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?deleteTanahMilik&id='
                    +id;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
    ...
    <%-- var url = '${pageContext.request.contextPath}/pelupusan/laporan_pelukis_pelan?deletePermohonanTerdahulu&idPermohonan='
         +idPermohonan;--%>
                     ...
                     var url = '${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?deletePermohonanTerdahulu&idMohonManual='
                         +idMohonManual;
                     $.get(url,
                     function(data){
                         $('#page_div').html(data);
             ...
             {
                 if(confirm('Adakah anda pasti?')) {
                     var url = '${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?removeLaporKawasan&idMohonlaporKws='
                         +idMohonlaporKws;
                     $.get(url,
                     function(data){
                         $('#page_div').html(data);
             ...
             function popupEditLaporKawasan(h){
                 ...
                 var url = '${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?editLaporKawasan&idMohonlaporKws='+h;
                 window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=900,height=400");
             }

             function tambahTanahRizab(){
                 var p = true ;
                 var url = '${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?tanahRizabPopup&p='+p;
    ...
    <%--window.open("${pageContext.request.contextPath}/pelupusan/laporan_pelukis_pelan?tanahRizabPopup", "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");--%>
                    ...
                    function tambahTanahMilik(){
                        window.open("${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?tanahMilikPopup", "eTanah",
                        "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
                    }

                    function tambahPermohonanTerdahulu(){
                        window.open("${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?permohonanTerdahuluPopup", "eTanah",
                        "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
                    }
                    function tambahKawasan(){
                        window.open("${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?kawasanPopup", "eTanah",
                        "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
                    }
                    function refreshRizab(){
                        var status = '1';
                        var url = '${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?refreshpage&status='+status;
                        $.get(url,
                        function(data){
                            $('#page_div').html(data);
                        },'html');
                    ...
                    function refreshSendiri(){
                        var url = '${pageContext.request.contextPath}/pengambilan/pelukis_pelan?refreshpage';
                        $.get(url,
                        function(data){
                            $('#page_div').html(data);
                        },'html');
    ...
    <%--  alert(h);--%>
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?showEditTanahRizab&idTanahRizabPermohonan='+h;
        ...
        function popup(i){
            ...
            var d = $('.x'+i).val();
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_pelukis_pelan?showEditTanahRizab&idTanahRizabPermohonan="+d, "eTanah",
...
<s:useActionBean beanclass="etanah.view.ListUtil" id="listUtil" />
<s:form beanclass="etanah.view.stripes.pengambilan.LaporanPelukisPelanPActionBean">
    <s:errors/>
    <s:messages/>
        ...
        <fieldset class="aras1" id="locate">
            ...
            <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="20" cellpadding="0" cellspacing="0" id="line"
                ...
                <c:if test="${line.hakmilik ne null}">
                    ...
                    <display:column title="Luas" property="hakmilik.luas"/>
                </c:if>
        ...
        <fieldset class="aras1" id="locate">
            ...
            <p>
                <c:if test="${actionBean.edit}">
                    ...
                    <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'BMBT' or actionBean.permohonan.kodUrusan.kod eq 'PJBTR'}">
                    ...
                    <p>
                        <label><font color="red">*</font>Isipadu :</label>
                        <s:text name="hakmilikPermohonan.luasTerlibat" formatPattern="#,###,##0.0000" maxlength="15" onkeyup="validateNumber(this,this.value);" id="Luas"/>
                        <s:select name="kodUnitLuas.kod" value="${actionBean.hakmilikPermohonan.kodUnitLuas.kod}" id="kULuas">
                            <s:option value="">Sila Pilih</s:option>
            ...
            <c:if test="${!actionBean.edit}">
                <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'BMBT' && actionBean.permohonan.kodUrusan.kod ne 'PJBTR'}">
