<%-- 
    Document   : Bayaran_Pampasan_Mahkamah
    Created on : Jul 26, 2011, 11:19:24 AM
    Author     : Rajesh
--%>
...
<s:form beanclass="etanah.view.stripes.pengambilan.BayaranPampasanMahkamahActionBean">
    <s:messages/>
    <s:errors/>
    <div  id="hakmilik_details">
        <p align="center"><font size="3"><b> REKOD PEMBERIAN BAYARAN PAMPASAN MAHKAMAH</b></font></p>
        <br/><br/>
        <fieldset class="aras1">
            ...
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.permohonan.senaraiHakmilik}" pagesize="5" cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/bayaran_pampasan_mahkamah" id="line">
                    <display:column title="No" sortable="true">${line_rowNum}</display:column>
                    <display:column title="ID Hakmilik">
                        <s:link beanclass="etanah.view.stripes.pengambilan.BayaranPampasanMahkamahActionBean"
                    ...
                    <div align="center">
                        <p align="center">
                            <display:table class="tablecloth" name="${actionBean.senaraiPerbicaraanKehadiran}" cellpadding="0" cellspacing="0"
                                           requestURI="/pengambilan/bayaran_pampasan_mahkamah" id="line" pagesize="5">
                                <display:column title="No" sortable="true">${line_rowNum}</display:column>
