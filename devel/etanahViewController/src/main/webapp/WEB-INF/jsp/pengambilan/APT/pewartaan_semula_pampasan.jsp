...
//            alert(idMH);
            ...
            window.open("${pageContext.request.contextPath}/pengambilan/perwartaanSemulaActionBean?tambahBorangH&idPermohonan=" + idMohon+"&idBorangPerPB="+idBorangPerPB, "eTanah",
...
//        alert("val" + val);
        doBlockUI();
        var url = '${pageContext.request.contextPath}/pengambilan/perwartaanSemulaActionBean?senaraiF&idPermohonan=' + idPermohonan + '&idHakmilik=' + idHakmilik + '&idBorangPerP=' + idBorangPerP;
        $.ajax({
            type: "GET",
            url: url,
            dataType: 'html',
...
//            alert(idMH);
        ...
        window.open("${pageContext.request.contextPath}/pengambilan/perwartaanSemulaActionBean?kemaskiniBicara&idPermohonan=" + idMohon + "&idPerPb=" + idPerPb, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=1000,height=700,scrollbars=yes");
    }
    function kemaskiniTuntutanA(idMohon, idPerPb) {
//            alert(idMH);

        window.open("${pageContext.request.contextPath}/pengambilan/perwartaanSemulaActionBean?kemaskiniTuntutan&idPermohonan=" + idMohon + "&idPerPb=" + idPerPb, "eTanah",
                "status=0,toolbar=0,location=0,menubar=0,width=1000,height=700,scrollbars=yes");
    }
...
//        alert("val" + val);
        doBlockUI();
        var url = '${pageContext.request.contextPath}/pengambilan/perwartaanSemulaActionBean?showForm&idPermohonan=' + idPermohonan;
        $.ajax({
            type: "GET",
            url: url,
            dataType: 'html',
...
<s:form beanclass="etanah.view.stripes.pengambilan.sek8.PerwartaanSemulaActionBean" name="AB" id="AB">
                ...
                <s:form beanclass="etanah.view.stripes.pengambilan.sek8.PerbicaraanActionBean" name="AB" id="AB">
                    ...
                    <div class="subtitle displaytag">
                        ...
                        <fieldset class="aras1" id="locate">
                                    ...
                                    <td width="100%">
                                        <div>
                                            <display:table class="tablecloth" name="${actionBean.listBorangF}"
                                                ...
                                                <display:column title="Jumlah Tuntutan Lama ">
                                                    <p>${line.jumlahTuntutan}</p>
                                                </display:column>  
                                                <display:column title="Jumlah Tuntutan Baru ">
                                                    <p>${line.jumlahTuntutanBaru}</p>
                                                </display:column>  
                            ...
                            <label>&nbsp;</label>&nbsp;&nbsp;   <s:button name="showForm" id="save" value="Kembali" class="btn" onclick="main('${actionBean.idPermohonan}')"/>      </fieldset>
