<%-- 
    Document   : mmkn_sek4_N9
    Created on : 23-Aug-2011, 11:17:42
    Author     : nordiyana
--%>
...
<script language="javascript" type="text/javascript">
    ...
    <%--element1.value ="perakuanPengarah"+(count4)+(rowCount4+1);--%>
        ...
        function deleteTable4(formPtg,form1) {
            ...
            if(parseInt(count4) <= parseInt(temp4)) {
                ...
                var url = '${pageContext.request.contextPath}/pengambilan/mmkns4Aduan?deleteTable&bil='
    ...
    <%--element2.value ="perakuanPengarah"+(count4)+(rowCount4+1);--%>
        ...
        function deleteDynamicRow4(tableID,countID,formPtg,form1) {
            ...
            if(rowCount4 >1){
                ...
                if (obj != null) {
                    ...
                    var url = '${pageContext.request.contextPath}/pengambilan/mmkns4Aduan?deleteSingle&idKandungan='
        ...
        function deleteRow1()
        {
            ...
            if (document.getElementById('idKandungan1'+(i)) != null) {
                var url = '${pageContext.request.contextPath}/pengambilan/mmkns4?deleteSingle&idKandungan='
                    +idKandungan;
    ...
    <%--alert('idKandungan3')--%>
        ...
        function addRow3a(tableID3a) {
            document.form2.rowCount3a.value = 1;
            var table = document.getElementById(tableID3a);

            var rowCount3a = table.rows.length;
            var row = table.insertRow(rowCount3a);

            var cell2 = row.insertCell(0);
            cell2.innerHTML = "<b>"+"3." +(rowCount3a+1)+"</b>";

            var cell1 = row.insertCell(1);
            var element1 = document.createElement("textarea");
            element1.t = "kandungan3a"+(rowCount3a+1);
            element1.rows = 5;
            element1.cols = 150;
            element1.name ="kandungan3a"+(rowCount3a+1);
            element1.id ="kandungan3a"+(rowCount3a+1);
            cell1.appendChild(element1);
            //alert(element1.name)
            document.form2.rowCount3a.value=rowCount3a +1;
        }
        function deleteRow3a()
        {
            var k = document.form2.rowCount3a.value;
            var x= document.getElementById('dataTable3a').rows[k-1].cells;
            var idKandungan = x[0].innerHTML;
    <%--alert(idKandungan)--%>
            if(confirm('Adakah anda pasti?')) {
                ...
                //  if (document.getElementById('idKandungan3a'+(k)) != null) {
    <%--alert('idKandungan3')--%>
                ...
                // }else{
                document.getElementById('dataTable3a').deleteRow(k-1);
                document.form2.rowCount3a.value = k-1;
                //}
            }
        }
        ...
        function deleteRow5()
        {
            ...
            if(confirm('Adakah anda pasti?')) {
                ...
                var url = '${pageContext.request.contextPath}/pengambilan/mmkns4?deleteSinglePTG&idKandungan='
                    +idKandungan;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
        ...
        function addRow6(tableID6) {
            ...
            var cell2 = row.insertCell(0);
            cell2.innerHTML = "<b>"+"7." +(rowCount6+1)+"</b>";
    ...
    <%--element1.value ="senaraiPentadbir"+(count5)+(rowCount5+1);--%>
        ...
        function deleteTable5() {
            ...
            if(parseInt(count5) <= parseInt(temp5)) {
                ...
                var url = '${pageContext.request.contextPath}/pengambilan/mmkns4?deleteTable&bil='
                    +bil;
    ...
    <%--element1.value ="senaraiPentadbir"+(count5)+(rowCount5+1);--%>
            ...
            button.className = "btn";
            button.setAttribute('name',buttonName);
            button.setAttribute('value','Tambah'+' 7.'+(count5a));
        ...
        function deleteTable5a() {
            ...
            if(parseInt(count5) <= parseInt(temp5)) {
                ...
                var url = '${pageContext.request.contextPath}/pengambilan/mmkns4?deleteTablePTG&bil='
                    +bil;
...
<s:form beanclass="etanah.view.stripes.pengambilan.MMKNS4ActionBean" name="form2">
    <s:messages/>
    <s:errors/>
                    ...
                    <table border="0" width="80%">
                        <div class="content" align="left">
                            <tr align="left"><td align="left">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                    <u><b>KERTAS UNTUK PERTIMBANGAN Y.A.B MENTERI BESAR</b></u><br /></td></tr>
                            ...
                            <tr><td> &nbsp;</td></tr>
                            <tr><td align="left"><b><label><font color="black">KERTAS BIL :</font></label><s:text name="kertasBil" disabled="false" size="10" style="text-align:left" id="kertasBil" class="normal_text"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b></td></tr>
                            <%--   <tr>
                               ...
                               <tr><td align="left"><b><label><font color="black">TARIKH :</font></label><s:text name="tarikhmesyuarat" disabled="true" id="tarikhMesyuarat" class="datepicker" size="30" style="text-align:left" /></b></td></tr>
                        ...
                        <tr><td colspan="2"><b> &nbsp;</b><%--<c:if test="${actionBean.tujuanObj eq null}">--%>
                                <s:textarea rows="5" cols="140" name="tujuan" class="normal_text"/>
                                <%--</c:if>
                                <c:if test="${actionBean.tujuanObj ne null}">
                                <s:textarea rows="5" cols="140" name="${actionBean.tujuanObj}" class="normal_text"/>
                                </c:if>--%><td>

                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>2. LATAR BELAKANG</b></td></tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><%--<b><font style="text-transform:uppercase">2.1 </font></b><--%></td></tr>
                        ...
                        <%--    <tr><td><b>3. NILAIAN TANAH DAN PERUNTUKAN</b></td></tr>
                               <tr><td>
                                       <table id ="dataTable3">
                                           <c:set var="i" value="1" />
                        ...
                        <tr><td>
                                <table id ="dataTable3a">
                                    <c:set var="i" value="1" />
                                    <c:forEach items="${actionBean.senaraiKertasKandungan3a}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan3a${i}" id="kandungan3a${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                        <c:set var="i" value="${i+1}" />
                                    </c:forEach>
                                    <s:hidden name="rowCount3a" value="${i-1}" id="rowCount3a"/>
                                </table>
                        <tr><td align="right"><s:button name="perihal3a" value="Tambah" class="btn" onclick="addRow3a('dataTable3a')" />
                                <s:button name="perihal3a" value="Hapus" class="btn" onclick="deleteRow3a()" />
                            </td>
                        </tr>
                        <tr><td> &nbsp;</td></tr>
                        ...
                        <tr><td><b><font>5. SYOR PENTADBIR TANAH DAERAH ${actionBean.hakmilik.daerah.nama}</font></b></td></tr>
                                    ...
                                    <table  width="90%" id="table5${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiPentadbir[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount5 eq 1}">
                                                <tr> <td><b>5.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" cols="130" name="senaraiPentadbir${i}${recordCount5}" id="senaraiPentadbir${i}${recordCount5}" value="${senarai.kandungan}" class="normal_text" /></td>
                                                ...
                                                <tr>  <td></td>
                                                    ...
                                                    <td><s:textarea rows="5" cols="130" name="senaraiPentadbir${i}${recordCount5}" id="senaraiPentadbir${i}${recordCount5}" value="${senarai.kandungan}" class="normal_text" /></td>
                                                </c:if>
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b><font>6. ULASAN PENGARAH TANAH DAN GALIAN, NEGERI SEMBILAN</font></b></td></tr>
                                ...
                                <table id ="dataTable5">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan5}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan5${i}" disabled="true" id="kandungan5${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                        <c:set var="i" value="${i+1}" />
                                    </c:forEach>
                                ...
                                <table id ="dataTable6">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan6}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan6${i}" disabled="true" id="kandungan6${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                        <c:set var="i" value="${i+1}" />
                                    </c:forEach>
                                        ...
                                        <c:forEach items="${actionBean.senaraiPentadbir3[i]}" var="senaraia">
                                            ...
                                            <c:if test="${recordCount5a eq 1}">
                                                <tr> <td><b>7.${i}</b></td>
                                                    ...
                                                    <td><s:button class="btn" disabled="true" value="Tambah 7.${i}" name="add" id="tambah5a${i}" onclick="addDynamicRow5a('table5a${i}','count5a${i}')"/></td>
                                                    <td> <s:button class="btn" disabled="true" value="Hapus 7.${i}" name="hapus" id="hapus5a${i}" onclick="deleteDynamicRow5a('table5a${i}','count5a${i}')"/></td>
                                                </c:if>
                                                <c:if test="${recordCount5a ne 1}">
                                                <tr>  <td></td>
                                                    <td><b><c:out value="${actionBean.str[recordCount5a-1]}"/>.</b></td>
                        ...
                        <tr><td align="right">
                                ...
                                <s:button class="btn" disabled="true" value="Tambah" name="add" onclick="addTable5a('Tables5a')"/>
                                <s:button class="btn" disabled="true" value="Hapus" name="add" onclick="deleteTable5a()"/>
                            </td></tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>8. KEPUTUSAN</b></td></tr>
                        <tr>
                            <td width="100%"><b>8.1</b> Dikemukakan kertas Bil. <b>${actionBean.kertasBil}/${actionBean.kertasTahun} </b>untuk pertimbangan dan kelulusan Yang Amat Berhormat
                                Menteri Besar, Negeri Sembilan Darul Khusus.
    ...
    <c:if test="${ptgform1}">
        ...
        <s:hidden name="form1" value="false"/>
    <div class="subtitle">
            <fieldset class="aras1" id="locate">
                <div class="content" align="center">
                    <table border="0" width="80%">
                        ...
                        <tr><td align="right"><s:button disabled="true" name="perihal2" value="Tambah" class="btn" onclick="addRow2('dataTable2')" />
                                <s:button name="perihal2" disabled="true" value="Hapus" class="btn" onclick="deleteRow2()" />
                            </td>
                        </tr>
                        <tr><td> &nbsp;</td></tr>
                        ...
                        <tr><td align="right"><s:button disabled="true" name="perihal3a" value="Tambah" class="btn" onclick="addRow3a('dataTable3a')" />
                                <s:button name="perihal3a" disabled="true" value="Hapus" class="btn" onclick="deleteRow3a()" />
                            </td>
                        </tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>4. NILAIAN TANAH DAN PERUNTUKAN</b></td></tr>
                        ...
                        <tr><td align="right"><s:button name="perihal3" disabled="true" value="Tambah" class="btn" onclick="addRow3('dataTable3')" />
                                <s:button name="perihal3" disabled="true" value="Hapus" class="btn" onclick="deleteRow3()" />
                            </td>
                        </tr>
                        <tr><td> &nbsp;</td></tr>
                                ...
                                <table id ="dataTable5">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan5}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan5${i}" class="normal_text" disabled="false" id="kandungan5${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                            </tr>
                                        <c:set var="i" value="${i+1}" />
                                    </c:forEach>
                                    <s:hidden name="rowCount9" value="${i-1}" id="rowCount9"/>
                                </table>
                        <tr><td align="right"><s:button name="perihal5" disabled="false" value="Tambah" class="btn" onclick="addRow5('dataTable5')" />
                                <s:button name="perihal5" disabled="false" value="Hapus" class="btn" onclick="deleteRow5()" />
                            </td>
                        </tr>
                        <tr><td> &nbsp;</td></tr>
                        <%--     <tr><td><b><font style="text-transform:uppercase">7. SYOR PENGARAH TANAH DAN GALIAN, NEGERI SEMBILAN</font></b></td></tr>
                                        ...
                                        <c:forEach items="${actionBean.senaraiPentadbir3[i]}" var="senaraia">
                                            ...
                                            <c:if test="${recordCount5a eq 1}">
                                                <tr> <td><b>7.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" class="normal_text" cols="130" name="senaraiPentadbir3${i}${recordCount5a}" id="senaraiPentadbir3${i}${recordCount5a}" value="${senaraia.kandungan}" /></td>
                                                    <td><s:hidden name="count5a${i}" id="count5a${i}" value="${(fn:length(actionBean.senaraiPentadbir3[i]))}" /> </td>
                                                    <td><s:button class="btn" value="Tambah 7.${i}" name="add" id="tambah5a${i}" onclick="addDynamicRow5a('table5a${i}','count5a${i}')"/></td>
                                                    <td> <s:button class="btn" value="Hapus 7.${i}" name="hapus" id="hapus5a${i}" onclick="deleteDynamicRow5a('table5a${i}','count5a${i}')"/></td>
                                                </c:if>
                                                <c:if test="${recordCount5a ne 1}">
                                                <tr>  <td></td>
                                                    <td><b><c:out value="${actionBean.str[recordCount5a-1]}"/>.</b></td>
                        ...
                        <tr><td align="right">
                                ...
                                <s:button class="btn" value="Tambah" name="add" onclick="addTable5a('Tables5a')"/>
                                <s:button class="btn" value="Hapus" name="add" onclick="deleteTable5a()"/>
                            </td></tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>8. KEPUTUSAN</b></td></tr>
                        <tr>
