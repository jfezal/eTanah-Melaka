<%-- 
    ...
    Created on : Dec 3, 2010, 11:30:56 AM
    Author     : afham
--%>
...
<div class="subtitle">
    <%--<s:form beanclass="etanah.view.stripes.common.PihakBerkepentinganActionBean" >--%>
         ...
         <s:form beanclass="etanah.view.stripes.pengambilan.LaporanPelukisPelanPActionBean" >
            ...
            <legend>
                Kemaskini Tanah Rizab Laporan Pelukis Pelan
            </legend>
            <p>
            ...
            <p>
             ...
             <p>
                ...
                <s:text name="tanahrizabpermohonan.tarikhWarta" id="datepicker" class="datepicker" size="12" formatPattern="dd/MM/yyyy" />
            </p>
            <p>
                <label>&nbsp;</label>
