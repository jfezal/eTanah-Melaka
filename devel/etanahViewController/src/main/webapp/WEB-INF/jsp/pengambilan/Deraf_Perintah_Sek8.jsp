<%-- 
    Document   : Deraf_Perintah_Sek8
    Created on : Jul 26, 2011, 11:44:45 AM
    Author     : Rajesh
--%>
...
<s:form beanclass="etanah.view.stripes.pengambilan.PerintahSek8ActionBean">
...
<fieldset class="aras1"><br/>
    ...
    <display:table class="tablecloth" name="${actionBean.permohonan.senaraiHakmilik}" pagesize="5" cellpadding="0" cellspacing="0"
                   requestURI="/pengambilan/perintah_sek8" id="line">
        <display:column title="No" sortable="true">${line_rowNum}</display:column>
        <display:column title="Id Hakmilik">
            <s:link beanclass="etanah.view.stripes.pengambilan.PerintahSek8ActionBean"
