...
<s:form name="notaForm" beanclass="etanah.view.stripes.pengambilan.PampasanBMAHKActionBean">
    <s:messages/>
            ...
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
                    ...
                    <display:column title="ID Hakmilik">
                        <s:link beanclass="etanah.view.stripes.pengambilan.PampasanBMAHKActionBean"
