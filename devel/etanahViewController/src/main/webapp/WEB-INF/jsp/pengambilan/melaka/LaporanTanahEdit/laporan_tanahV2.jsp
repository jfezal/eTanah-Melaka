...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.hakmilikPermohonan ne null}">
        ...
        function refreshV2ManyHakmilik(type,hakmilik){
            var url = '${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?refreshpage&type='+type+'&idHakmilik='+hakmilik;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
...
<s:form beanclass="etanah.view.stripes.pengambilan.LaporanTanahNewDisposalActionBean" name="form">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>Bertumpu dengan : ${actionBean.idHakmilik}
                <span style="float:right">
        ...
        <fieldset class="aras1">
            ...
            <div id="keadaantanah" align="center">
                ...
                <table class="tablecloth" align="center">
                    ...
                    <table class="tablecloth" align="center">
                        <tr>
                            <td>Tanah Diusahakan(Untuk Pertanian) :</td>
                    ...
                    <c:if test="${actionBean.laporanTanah.usaha eq 'Y'}">
                        ...
                        <tr>
                            ...
                            <td> ${actionBean.laporanTanah.mercuTanda}</td>
                        </tr>
                        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBMT'}">
                            <tr>
                ...
                <c:if test="${actionBean.laporanTanah.adaBangunan eq 'Y'}">
                    <br>
                    <display:table class="tablecloth" name="${actionBean.permohonanLaporanBangunanList}" pagesize="20" cellpadding="0" cellspacing="0"
