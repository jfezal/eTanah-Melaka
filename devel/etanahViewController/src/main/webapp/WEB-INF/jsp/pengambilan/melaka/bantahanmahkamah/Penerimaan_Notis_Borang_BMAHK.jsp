<%--
    Document   : Penerimaan_Notis_Borang_BMAHK
    Created on : May 9, 2011, 12:17:50 PM
    Author     : Rajesh @modified hazirah
--%>
...
<script type="text/javascript">
   ...
   <%-- function validate(){
    ...
    function muatNaikForm(idPihak) {
        ...
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?popupUpload&idPihak='+idPihak+'&idHakmilik='+idHakmilik+'&showPP='+showPP+'&showHP='+showHP;
    ...
    function muatNaikFormPemohon(idPihak) {
        ...
        var left = (screen.width/2)-(1000/2);
        var top = (screen.height/2)-(150/2);
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?popupUpload&idPihak='+idPihak+'&idHakmilik='+idHakmilik+'&showPP='+showPP+'&showHP='+showHP+'&isPemohonPihak=true';
        window.open(url, 'etanah2', "status=0,toolbar=0,location=0,menubar=0,width=1000,height=200, left=" + left + ",top=" + top);
    }
    ...
    function muatNaikFormMahkamah() {
        var left = (screen.width/2)-(1000/2);
        var top = (screen.height/2)-(150/2);
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?popupUpload&isMahkamah=true';
        window.open(url, 'etanah2', "status=0,toolbar=0,location=0,menubar=0,width=1000,height=200, left=" + left + ",top=" + top);
    }
    function scanMahkamah() {
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?popupScanMahkamah&isMahkamah=true';
    ...
    function scanPemohon(idPihak) {
        ...
        var showPP = $('#showPP').val();
        var showHP = $('#showHP').val();
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?popupScanPemohon&idPihak='+idPihak+'&idHakmilik='+idHakmilik+'&showPP='+showPP+'&isPemohonPihak=true';
        window.open(url, 'etanah2', "status=0,toolbar=0,location=0,menubar=0,width=800,height=700");
    }
    ...
    function addPenghantarNotis(){
        ...
        var showPP = $('#showPP').val();
        var showHP = $('#showHP').val();
        window.open("${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?popupPenghantarNotis&idHakmilik="+idHakmilik+'&showPP='+showPP+'&showHP='+showHP, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=900,height=400");
    }

    function addPenghantarNotisM(){
        window.open("${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?popupPenghantarNotis&isMahkamah=true", "eTanah","status=0,toolbar=0,location=0,menubar=0,width=900,height=400");
    }
    ...
    function scan(idPihak) {
        ...
        var showPP = $('#showPP').val();
        var showHP = $('#showHP').val();
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?popupScan&idPihak='+idPihak+'&idHakmilik='+idHakmilik;
        window.open(url, 'etanah2', "status=0,toolbar=0,location=0,menubar=0,width=800,height=700");
    }


    function refreshPagePenerimaanBorang(){
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?refreshpage';
        $.get(url,
        function(data){
            $('#page_div').html(data);
        },'html');
    ...
    function notis(h){
        var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?notisPopup&idPihak='+h;
    ...
    function refreshNotis(idHakmilik,showPP,showHP,isMahkamah){
        if(showHP == 'true'){
            if(idHakmilik !=''){
                var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?hakmilikDetails&idHakmilik='+idHakmilik+"&showPP="+showPP;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
                },'html');
                ...
                if(showPP == 'true'){
                    var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?showFormPP';
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
                    },'html');
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?showFormPemohon';
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
        }else if(isMahkamah == 'true'){
            var url = '${pageContext.request.contextPath}/pengambilan/penerimaan_notis_borang_BMAHK?showFormMahkamah';
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
...
<s:form beanclass="etanah.view.stripes.pengambilan.PenerimaanNotisBorangBMAHK_MLKActionBean">
    <div  id="hakmilik_details">
        ...
        <fieldset class="aras1"><br/>
            ...
            <c:if test="${actionBean.permohonanMahkamah ne null && actionBean.notisMahkamahNBO ne null}">
                <div align="center" >
                    <display:table class="tablecloth" name="${actionBean.permohonanMahkamah}"
                                   cellpadding="0" cellspacing="0" requestURI="/pengambilan/penerimaan_notis_borang_BMAHK" id="line">
            ...
            <br/>
            <br/>
            <%--&& ((fn:length(actionBean.listNotisPemohonASB) > 0) ||(fn:length(actionBean.listNotisPemohonPB) > 0))--%>
            <c:if test="${actionBean.showPP eq true}">
            ...
            <%--<c:if test="${actionBean.permohonanMahkamah ne null && actionBean.notisMahkamahNBO ne null && actionBean.notisMahkamahNBN ne null}">--%>
            <c:if test="${actionBean.permohonanMahkamah ne null && actionBean.notisMahkamahNBO ne null || (actionBean.showPP eq true)}">
                <div align="center">
