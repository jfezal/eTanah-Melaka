...
<s:form beanclass="etanah.view.stripes.pengambilan.BorangMActionBean">
    <s:messages/>
    <s:errors/>
        ...
        <fieldset class="aras1">
            ...
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.permohonan.senaraiHakmilik}" pagesize="5" cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/borang_m" id="line">
                    <display:column title="No" sortable="true">${line_rowNum}</display:column>
                    <display:column title="ID Hakmilik">
                        <s:link beanclass="etanah.view.stripes.pengambilan.BorangMActionBean"
           ...
           <p align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPihakList}"  cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/borang_m" id="line1" >
