...
<script language="javascript" type="text/javascript">
    ...
    alert("idKandungan:"+idKandungan);--%>
            ...
            //    }else{
            var url = '${pageContext.request.contextPath}/pengambilan/mmk_PHL?deleteSingle&idKandungan='
    ...
    <%--element1.value ="rayuanTuan"+(count5)+(rowCount5+1);--%>
        ...
        function deleteTable5(formPtg,form1) {
            ...
            if(parseInt(count5) <= parseInt(temp5)) {
                ...
                var url = '${pageContext.request.contextPath}/pengambilan/mmk_PHL?deleteTable&bil='
...
<s:form beanclass="etanah.view.stripes.pengambilan.KertasPertimbanganPHLActionBean" name="form2">
    <s:messages/>
    <s:errors/>
    <c:if test="${form1}">
                                ...
                                <table id ="dataTable8">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan8}" var="line">
                                        <tr style="font-weight:bold">
                                            ...
                                            <td><s:button class="btn" value="Hapus" name="delete" id="${k}" onclick="deleteRow8('${formPtg}','${form1}',${line.idKandungan},${k})" disabled="false"/></td>
                                        </tr>
