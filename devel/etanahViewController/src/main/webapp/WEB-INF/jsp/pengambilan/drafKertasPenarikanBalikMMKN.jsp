<%-- 
    Document   : drafKertasPenarikanBalikMMKN
...
<script language="javascript" type="text/javascript">
    ...
    if(${!mtptambil1 || !jsptambil1 || !agptambil1}){
...
<s:form beanclass="etanah.view.stripes.pengambilan.PermohonanPenarikanBalikMMKNActionBean" name="form2">
    <s:messages/>
    <s:errors/>
    <c:if test="${form}"> 
        <div class="subtitle">
                    ...
                    <table border="0" width="80%">
                        <c:choose>
                            <c:when test="${ptgptambil1 || ptg1}" >
                                ...
                                <tr><td> &nbsp;</td></tr>
                                <tr><td align="left"><b><label><font color="black">PERSIDANGAN :</font></label><s:text name="kertasBil.kandungan"  size="10" style="text-align:left" id="kertasBil" />/2010</b></td></tr>
                            ...
                            <c:otherwise>
                            <%--<c:if test="${!ptgptambil1 || !ptg1}" >--%>
                                <div class="content" align="left">
                                <%--<table align="left">--%>
                                <tr align="left"><td align="left">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                        <u><b>MAJLIS MESYUARAT KERAJAAN NEGERI MELAKA </b></u><br /></td></tr>
                                <tr><td> &nbsp;</td></tr>
                                <tr><td align="left"><b><label><font color="black">PERSIDANGAN :</font></label><s:text name="kertasBil.kandungan"  size="10" style="text-align:left" id="kertasBil" disabled="true"/>/2010</b></td></tr>
                                <tr><td align="left"><b><label><font color="black">MASA        :</font></label><s:text name="masa.kandungan"  size="30" style="text-align:left" id="masa" disabled="true"/></b></td></tr>
                                <tr><td align="left"><b><label><font color="black">TARIKH :</font></label><s:text name="tarikhmesyuarat.kandungan" id="datepicker" class="datepicker" size="30" style="text-align:left" disabled="true"/></b></td></tr><br>
                                <tr><td align="left"><b><label><font color="black">TEMPAT      :</font></label><s:textarea name="tempat.kandungan" cols="50" rows="5" style="text-align:left" id="tempat" disabled="true"/></b></td></tr>
                                <%--</table>--%>
                            </div>
                            <%--</c:if>--%>
                            </c:otherwise>
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><font style="text-transform: uppercase"><b>PERMOHONAN PENARIKAN BALIK DARIPADA PENGAMBILAN SEBAHAGIAN TANAH DI LOT ${actionBean.hakmilik.noLot}, ${actionBean.hakmilik.kodHakmilik.kod} ${actionBean.hakmilik.luas}, ${actionBean.hakmilik.bandarPekanMukim.nama}, DAERAH ${actionBean.hakmilik.daerah.nama}, BAGI ${actionBean.namaProjek}.</b></font><br /><br /><hr /><br /></td></tr>
                                ...
                                <table id ="dataTable">
                                    ...
                                    --%>    <c:forEach items="${actionBean.senaraiKertasKandungan}" var="line">
                                        ...
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <c:choose>
                                                <c:when test="${ptgptambil1 || ptg1}" >
                                                    <td><font style="text-transform: lowercase"><s:textarea name="kandungan1${i}" id="kandungan1${i}" rows="5" cols="150" onkeyup="sCase()" readonly="true">${line.kandungan}</s:textarea></font></td>
                                                </c:when>
                                                <c:otherwise>
                                                    <td><font style="text-transform: lowercase"><s:textarea name="kandungan1${i}" id="kandungan1${i}" rows="5" cols="150" onkeyup="sCase()">${line.kandungan}</s:textarea></font></td>
                                                </c:otherwise>
                                            </c:choose>
                                        </tr>
                        ...
                        <tr><td align="right">
                                <c:choose>
                                    <c:when test="${ptgptambil1 || ptg1}" >
                                        <s:button name="latarBelakang" value="Tambah" class="btn" onclick="addRow('dataTable')" disabled="true"/>
                                        <s:button name="latarBelakang" value="Hapus" class="btn" onclick="deleteRow()" disabled="true"/>
                                    </c:when>
                                    <c:otherwise>
                                        <s:button name="latarBelakang" value="Tambah" class="btn" onclick="addRow('dataTable')" />
                                        <s:button name="latarBelakang" value="Hapus" class="btn" onclick="deleteRow()" />
                                ...
                                <table id ="dataTable2">
                                    ...
                                    --%>    <c:forEach items="${actionBean.senaraiKertasKandungan2}" var="line">
                                        ...
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <c:choose>
                                                <c:when test="${ptgptambil1 || ptg1}" >
                                                    <td><s:textarea name="kandungan2${j}" id="kandungan2${j}" rows="5" cols="150" onkeyup="lower(this);" readonly="true">${line.kandungan}</s:textarea></td>
                                                </c:when>
                                                <c:otherwise>
                                                    <td><s:textarea name="kandungan2${j}" id="kandungan2${j}" rows="5" cols="150" onkeyup="lower(this);">${line.kandungan}</s:textarea></td>
                                                </c:otherwise>
                                            </c:choose>
                                        </tr>
                        ...
                        <tr><td align="right">
                                <c:choose>
                                    <c:when test="${ptgptambil1 || ptg1}" >
                                        <s:button name="perihalTanah" value="Tambah" class="btn" onclick="addRow2('dataTable2')" disabled="true"/>
                        ...
                        <%--<c:if test="${ptd}">--%>
                                <table id ="dataTable3">
                                  ...
                                  --%>      <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                        ...
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <c:choose>
                                                <c:when test="${ptgptambil1 || ptg1}" >
                                                    <td><s:textarea name="kandungan3${k}" id="kandungan3${k}" rows="5" cols="150" onkeyup="lower(this);" readonly="true">${line.kandungan}</s:textarea></td>
                                                </c:when>
                                                <c:otherwise>
                                                    <td><s:textarea name="kandungan3${k}" id="kandungan3${k}" rows="5" cols="150" onkeyup="lower(this);">${line.kandungan}</s:textarea></td>
                                                </c:otherwise>
                                            </c:choose>
                                        </tr>
                           ...
                           <tr><td align="right">
                                   <c:choose>
                                       <c:when test="${ptgptambil1 || ptg1}" >
                                           <s:button name="perakuanPentadbirTanah" value="Tambah" class="btn" onclick="addRow3('dataTable3')" disabled="true" />
                                           <s:button name="perakuanPentadbirTanah" value="Hapus" class="btn" onclick="deleteRow3()" disabled="true"/>
                                       </c:when>
                                       <c:otherwise>
                                           <s:button name="perakuanPentadbirTanah" value="Tambah" class="btn" onclick="addRow3('dataTable3')" />
                        ...
                        <%--<c:if test="${ptptdpengambilan1}">--%>
                        <%--<c:if test="${!ptptgpengambilan1 || !ptg1}" >
                            <tr><td><s:textarea name="syorPtg.kandungan" rows="5" cols="150" id="syorPtg" disabled="true" /></td></tr><br>
                        </c:if>--%>
                        <c:choose>
                            <c:when test="${ptgptambil1 || ptg1}" >
                                <tr><td><s:textarea name="syorPtg.kandungan" rows="5" cols="150" id="syorPtg"/></td></tr><br>
                            </c:when>
                            <c:otherwise>
                                <tr><td><s:textarea name="syorPtg.kandungan" rows="5" cols="150" id="syorPtg" disabled="true" /></td></tr><br>
                            </c:otherwise>
