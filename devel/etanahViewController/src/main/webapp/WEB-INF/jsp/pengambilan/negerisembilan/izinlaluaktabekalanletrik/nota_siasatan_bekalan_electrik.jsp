<%-- 
    Document   : nota_siasatan_bekalan_electrik
    Created on : Oct 26, 2010, 1:56:21 PM
    Author     : Rajesh
--%>
...
<s:form name="notaForm" beanclass="etanah.view.stripes.pengambilan.NotaSiasatanBekalanElektrikActionBean">
    <s:messages/>
    <s:errors/>
        ...
        <div align="center">
            <table style="width:99.2%" bgcolor="purple">
                <tr><td width="100%" height="20" ><div style="background-color: purple;" align="center">
                            <font style="font-family: Tahoma; font-size: 16px; font-weight: bold;"><font color="white">NOTA SIASATAN PEMOHONAN IZIN LALU DI BAWAH AKTA BEKALAN ELEKTRIK</font></font>
                        </div></td></tr>
            </table>
        </div>
        ...
        <fieldset class="aras1">
            ...
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/nota_siasatan_bekalan_elektrik" id="line">
                    <display:column title="No" sortable="true">${line_rowNum}</display:column>
                    <display:column title="ID Hakmilik">
                        <s:link beanclass="etanah.view.stripes.pengambilan.NotaSiasatanBekalanElektrikActionBean"
            ...
            <br/><br/><br/>
             <c:if test="${actionBean.hakmilik ne null}">
                 ...
                 <label for="a">Nota Siasatan Pemohonan Izin Lalu Di Bawah Akta Bekalan Elektrik :</label>
                 <s:text name="hakmilikPerbicaraan.catatan" size="20"/>
                 <br/>
                 <br/><br/>

           <legend ><b>Kehadiran</b></legend>
           <br/><br/>
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilik.senaraiPihakBerkepentingan}"  cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/nota_siasatan_bekalan_elektrik" id="line1">
            ...
            <p align="center">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <tr><td width="40%"><b>8) Ulasan dari TNB </b></td>
                        <td><b>:</b></td>
                        <td><b> <s:textarea name="hakmilikPerbicaraan.catatan" rows="3" cols="50" id="catatan"/></b></td>
                    </tr>
                    <%--<tr>
