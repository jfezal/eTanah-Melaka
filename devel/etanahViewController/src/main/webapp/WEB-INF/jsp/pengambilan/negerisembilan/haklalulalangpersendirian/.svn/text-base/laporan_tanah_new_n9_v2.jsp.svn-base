<%--
    Document   : laporan_tanah_new_n9_v2
...
<script type="text/javascript">
    ...
    <c:if test="${actionBean.jenisKegunaan eq 'U'}">
        ...
        function popup(i){
            ...
            var d = $('.x'+i).val();
            window.open("${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?showeditTanahRizab&idTanahRizabPermohonan="+d, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=890,height=600");
        }


        function refreshRizab(){
            var url = '${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?refreshpage';
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
        ...
        function addImageUtara(){
            ...
            $.post('${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?addLaporanImage&pandanganImej=U&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
        ...
        function addImageSelatan(){
            ...
            $.post('${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?addLaporanImage&pandanganImej=S&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
        ...
        function addImageTimur(){
            ...
            $.post('${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?addLaporanImage&pandanganImej=T&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
        ...
        function addImageBarat(){
            ...
            $.post('${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?addLaporanImage&pandanganImej=B&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
            function(data){
                $('#page_div').html(data);
            }, 'html');
        }
        ...
        function tambahBangunan(kategori){
            var idHakmilik = '${actionBean.hakmilik.idHakmilik}';
            window.open("${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?tambahBangunanPopup&idHakmilik="+idHakmilik+'&kategori='+kategori, "eTanah",
    ...
    <%--alert('idLaporBangunan-'+idLaporBangunan+'---idHakmilik='+idHakmilik);--%>
            window.open("${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?editBangunanPopup&idHakmilik="+idHakmilik+'&idLaporBangunan='+idLaporBangunan, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
        }
        ...
        function uploadForm(idHakmilik,pandanganImej) {
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?uploadDoc&idHakmilik='+idHakmilik+'&pandanganImej='+pandanganImej;
        ...
        function hapusUtaraImej(idHakmilik,pandanganImej){
            if((confirm("Anda pasti ingin menghapuskan imej ini?"))){
                var idDokumen = document.getElementById("utaraImej").options[document.getElementById("utaraImej").selectedIndex].value;
                //              alert(idDokumen);
                var url = '${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?hapusImej&idDokumen='+idDokumen;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
                },'html');
        ...
        function refresh(idHakmilik){
            if(idHakmilik !=''){
                var url = '${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?hakmilikDetails&idHakmilik='+idHakmilik;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
                },'html');
        ...
        function removeBangunan(idLaporBangunan)
        {
            if(confirm('Adakah anda pasti?')) {
                var url = '${pageContext.request.contextPath}/pengambilan/laporanTanahHakLaluLalang?deleteBangunan&idLaporBangunan='
                    +idLaporBangunan;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
...
<s:form beanclass="etanah.view.stripes.pengambilan.LaporanTanahHakLaluLalangActionBean">
                ...
                <fieldset class="aras1">
                    ...
                    <div class="content" align="center">
                        <display:table class="tablecloth" name="${actionBean.permohonan.senaraiHakmilik}" pagesize="5" cellpadding="0" cellspacing="0"
                                       requestURI="/pengambilan/laporanTanahHakLaluLalang" id="line">
                            <display:column title="No" sortable="true">${line_rowNum}</display:column>
                            <display:column title="ID Hakmilik">
                                <s:link beanclass="etanah.view.stripes.pengambilan.LaporanTanahHakLaluLalangActionBean"
                        ...
                        <div class="content" align="center" id="pertanian" style="display:none" >
                            <table class="tablecloth" align="center">
                                ...
                                <tr>
                                    ...
                                    <td><s:text name="laporanTanah.usahaTanam" /></td>
                                </tr>
                                <tr>
                            ...
                            <br>
                            <s:button name="simpanPertanian" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
                            <br><br>
            ...
            <div class="subtitle">
                <fieldset class="aras1">
                    ...
                    <div class="content" align="center">
                        <table>
                            <tr>
                                <td>Ulasan mengenai keluasan tanah-tanah yang <br>hendak dibuat permohonan hak lalu lalang samada luasnya <br>mengikut pelan yang dikemukakan pemohon <br>atau berbeza. Jika berbeza, berikan alasan-alasan
                                </td>
                                <td>
                                    :
                                </td>
                            ...
                            <tr>
                                <td>
                                    Ulasan samada terdapat masalah sosial atau <br>tidak akibat hak lalu lalang tersebut. Jika ada, <br>berikan syor
                                </td>
                                <td>
                                    :
                                </td>
            ...
            <div class="subtitle">
                <fieldset class="aras1">
                    ...
                    <div class="content" align="center">
                        <table>
                            <tr>
                                <td><b>Ulasan mengenai keluasan tanah-tanah yang <br>hendak dibuat permohonan hak lalu lalang samada luasnya <br>mengikut pelan yang dikemukakan pemohon <br>atau berbeza. Jika berbeza, berikan alasan-alasan</b>
                                </td>
                                <td>
                                    :
                                </td>
                            ...
                            <tr>
                                <td>
                                    <b>Ulasan samada terdapat masalah sosial atau <br>tidak akibat hak lalu lalang tersebut.Jika ada, <br>berikan syor</b>
                                </td>
                                <td>
                                    :
                                </td>
