...
<html>
    ...
    <body>
        <s:form beanclass="etanah.view.stripes.pengambilan.PenyediaanSuratPerbicaraanGantirugiActionBean">
           <s:messages/>
           <s:errors/>
           <div class="subtitle">
                <fieldset class="aras1">
                    <legend>
                        Maklum Surat Perbicaraan Kos Gantirugi
                    </legend>
                    <div class="content" align="">
                        <table border="0">
                            <td>
                                <font color="black">
                                Sila klik pada tab "Dokumen" untuk print dan tandatangan surat kepada agensi
                                pemohon dan tuan tanah/ orang berkepentingan untuk perbicaraan menentukan kos gantirugi
                                </font>
                            </td>
                        </table>
                    </div>
