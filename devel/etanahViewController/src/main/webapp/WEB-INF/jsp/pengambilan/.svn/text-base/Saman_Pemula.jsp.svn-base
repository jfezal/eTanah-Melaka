<%-- 
    Document   : Saman_Pemula
    Created on : Jun 29, 2011, 10:40:20 AM
    Author     : Rajesh
--%>
...
$(".datepicker1").datepicker({dateFormat: 'yy'});
    ...
    function deleteRow1(formPtg,form1)
    {
        ...
        if (document.getElementById('idKandungan1'+(i)) != null) {
            var url = '${pageContext.request.contextPath}/pengambilan/samanPemula?deleteSingle&idKandungan='
...
<s:form beanclass="etanah.view.stripes.pengambilan.SamanPemulaActionBean" name="form2">
<div id="hakmilik_details">
    ...
    <display:table class="tablecloth" name="${actionBean.permohonan.senaraiHakmilik}" pagesize="5" cellpadding="0" cellspacing="0"
                   requestURI="/pengambilan/samanPemula" id="line">
            ...
            <c:forEach items="${line.hakmilik.senaraiPihakBerkepentingan}" var="senarai">
                <table border="0">
                    <tr>
                        ...
                        <td>
                            <s:link beanclass="etanah.view.stripes.pengambilan.SamanPemulaActionBean"
        ...
        <fieldset class="aras1" id="locate">
            ...
            <div class="content" align="center" >
                <table border="0" width="50%" align="center">
                    ...
                    <tr><td>permohonan pihak pemohon <%--${actionBean.hakmilik.daerah.nama}--%>untuk mengeluarkan wang sebanyak RM</td></tr>
