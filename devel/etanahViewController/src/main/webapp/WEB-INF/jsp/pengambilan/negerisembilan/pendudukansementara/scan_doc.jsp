<%--
    Document   : scan_doc
    Created on : Nov 14, 2011, 5:35:21 PM
    Author     : massita
--%>
...
<script type="text/javascript">
    ...
    function successRedirection() {
        var url = '${pageContext.request.contextPath}/pengambilan/BayaranKerosakanPTSP?reload';
        $.ajax({
            type:"GET",
            url : url,
...
<s:form beanclass="etanah.view.stripes.pengambilan.BayaranKerosakanPTSPActionBean">
