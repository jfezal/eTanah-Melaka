        ...
        <fieldset class="aras1"><br/>
            ...
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="6" cellpadding="0" cellspacing="0"
                    ...
                    <display:column title="Lokasi Perbicaraan"><s:text name="lokasiBicara[${line_rowNum - 1}]" id="lokasiBicara${line_rowNum - 1}" value="lokasiBicara" class="normal_text"/></display:column>
                </display:table>
                <br/><br/><br/>
