...
var url = '${pageContext.request.contextPath}/pengambilan/borang2A_NotisMengenaiSiasatan?refreshpage';
$.get(url,
function(data){
$('#page_div').html(data);
},'html');
...
function updateDetails(h){
   var url = '${pageContext.request.contextPath}/pengambilan/borang2A_NotisMengenaiSiasatan?editDetails&rowCount='+h;
$.get(url,
function(data){
$('#page_div').html(data);
},'html');
...
<s:form beanclass="etanah.view.stripes.pengambilan.Borang2A_NotisMengenaiSiasatanActionBean">
    <s:messages/>
<div>
