...
<%-- 
    Document   : maklumat_pemohon_edit
...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        function removePengarah(val){
            if(confirm('Adakah anda pasti?')) {
                var url = '${pageContext.request.contextPath}/pengambilan/pengambilan_pemohon?/pengambilan/pengambilan_pemohon&idPengarah='+val;
                $.get(url,
                function(data){
                    $('#caw').html(data);
                },'html');
        ...
        function removePengarahPemohon(val){
            if(confirm('Adakah anda pasti?')) {
                var url = '${pageContext.request.contextPath}/pengambilan/pengambilan_pemohon?/pengambilan/pengambilan_pemohonPemohon&idPengarah='+val;
                $.get(url,
                function(data){
                    $('#caw').html(data);
                },'html');
        ...
        function editCawangan(val, val2){
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/pengambilan_pemohon?editCawanganEdit&idCawangan='+val+'&jenisPB='+jenisPB+'&idPermPihak='+val2;
            $.get(url,
            function(data){
                $('#caw').html(data);
            },'html');
        ...
        function editCawanganPemohon(val,val2){
            var url = '${pageContext.request.contextPath}/pengambilan/pengambilan_pemohon?editCawanganPemohonEdit&idCawangan='+val+'&idPemohon='+val2;
            $.get(url,
            function(data){
                $('#caw').html(data);
            },'html');
        ...
        function editPengarah(val, val2){
            var jenisPB = $('#jenis_pihak').val();
            var url = '${pageContext.request.contextPath}/pengambilan/pengambilan_pemohon?editPengarahEdit&idPengarah='+val+'&jenisPB='+jenisPB+'&idPermPihak='+val2;
            $.get(url,
            function(data){
                $('#caw').html(data);
            },'html');
        ...
        function editPengarahPemohon(val, val2){
            var url = '${pageContext.request.contextPath}/pengambilan/pengambilan_pemohon?editPengarahPemohon&idPengarah='+val+'&idPemohon='+val2;
            $.get(url,
            function(data){
                $('#caw').html(data);
            },'html');
