...
<s:form beanclass="etanah.view.stripes.pengambilan.StatusAwardActionBeanAmanah">
...
<fieldset class="aras1"><br/>
    ...
    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="20" cellpadding="0" cellspacing="0"
        ...
        <display:column title="ID Hakmilik">
            <s:link beanclass="etanah.view.stripes.pengambilan.StatusAwardActionBeanAmanah"
