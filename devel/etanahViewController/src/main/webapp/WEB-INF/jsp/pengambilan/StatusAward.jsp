...
<script type="text/javascript">
    ...
    <%--       function validateCatatan(){
            ...
            function semak(f,s)
            {
                var bil=0;
                for (i = 0; i < f; i++){
                    var c = document.getElementById("catatan" + i).value;
                    if(c==""){
                        bil++;
                    }
                }
    ...
    <div  id="hakmilik_details">
        ...
        <fieldset class="aras1"><br/>
            ...
            <div align="center">
                ...
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="15" cellpadding="0" cellspacing="0"
        ...
        <c:if test="${actionBean.hakmilik ne null}">
            <fieldset class="aras1">
                <legend>Tuan Tanah > ID Hakmilik : ${actionBean.hakmilik.idHakmilik}</legend><br />
                <div align="center">
                    ...
                    <p align="center">
                        <display:table class="tablecloth" name="${actionBean.senaraiPerbicaraanKehadiran}" cellpadding="0" cellspacing="0"
                                       requestURI="/pengambilan/status" id="line" pagesize="35">
                            <display:column title="No" sortable="true">${line_rowNum}</display:column>
                            ...
                            <display:column title="Pampasan (RM)">
                                <c:if test="${line.pihak.jenis.kod == 'PM' || line.pihak.jenis.kod == 'PA'}">
                    ...
                    <%--   <s:button name="simpan" id="save" value="Simpan" class="btn" onclick="if(validateCatatan())doSubmit(this.form, this.name, 'page_div')"/>--%>
                    <s:button class="btn" value="Simpan" name="simpanStatus" id="new" onclick="semak(${p},this);"/>&nbsp;
            ...
            <%--          <fieldset class="aras1">
                      ...
                      <p align="center">
                        <display:table class="tablecloth" name="${actionBean.senaraiHadir}" cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/status" id="line1" pagesize="15">
                    <display:column title="No" sortable="true">${line_rowNum}</display:column>
