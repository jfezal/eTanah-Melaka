    ...
    <body>
        ...
        <s:form beanclass="etanah.view.stripes.pengambilan.sek8.PenyampaianBorangEFActionBean" name="AB" id="AB">
            ...
            <div class="subtitle displaytag">
                            ...
                            <td width="100%">
                                <div>
                                    <display:table class="tablecloth" name="${actionBean.listBorangF}"
                                        ...
                                        <display:column title="Borang F " sortable="true"><img src="${pageContext.request.contextPath}/pub/images/icons/_active__document.png"
                                        ...
                                        <display:column title="Status Penghantaran ">
                                            <c:if test="${line.hantar eq false}">
                                                <p>BELUM HANTAR</p>
                                            </c:if>
                                            <c:if test="${line.hantar eq true}">
                                                <p>SUDAH HANTAR</p>
                                            </c:if>
                ...
                <a href='${pageContext.request.contextPath}/pengambilan/penyampaian_e_f?${actionBean.urlKembali}&idPermohonan=${actionBean.idPermohonan}'><s:button name="hantar" id="save" value="Kembali" class="longbtn"/></a> 
