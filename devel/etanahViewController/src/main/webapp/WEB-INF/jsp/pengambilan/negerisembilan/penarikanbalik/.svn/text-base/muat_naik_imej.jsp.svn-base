...
//            var url = '${pageContext.request.contextPath}/pembangunan/muat_naik_imej?reload';
        ...
        function popImej(idDok){
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/ImejLaporanTanahTerdahulu?viewImejPopup&idPermohonan='+id+'&idDokumen='+idDok;
            $.post(url,                     
            function(data){               
...
<s:form id="testForm" name="myform" beanclass="etanah.view.stripes.pengambilan.ImejLaporanTanahTerdahuluActionBean">
...
<div id="muatnaik" style="display: none">
    <s:form name="myform1" beanclass="etanah.view.stripes.pengambilan.ImejLaporanTanahTerdahuluActionBean">
        <fieldset class="aras1">
            <div id="error"/>
