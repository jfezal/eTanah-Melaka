...
<s:form  beanclass="etanah.view.stripes.pengambilan.share.common.RekodKpsnMMKActionBean">
    <s:errors/>
    <s:messages/>
    ...
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            <legend>Maklumat Keputusan JKKPT</legend>
            <p>
                <label for="noFail">No. Fail JKKPT :</label>
                <s:text name="noFail" size="20"/>
            </p>
            <p>
                <label for="tarikhSidang">Tarikh Bersidang :</label>
                <s:text name="tarikhSidang" class="datepicker" size="20"/>&nbsp;<font size="1" color="red"> (cth : hh / bb / tttt)</font>
            </p>

            <p>
                <label for="tarikhSah">Tarikh Sah :</label>
                <s:text name="tarikhSah" class="datepicker" size="20"/>&nbsp;<font size="1" color="red"> (cth : hh / bb / tttt)</font>
            </p>

            <p>
                <label for="tempatBersidang">Tempat Bersidang :</label>
                <s:textarea name="tempatBersidang" rows="2" cols="45"/>&nbsp;
            </p>
            <p>
                <label for="kpsnMMKN">Keputusan Mesyuarat JKKPT :</label>
                <s:radio name="kpsnMMKN" value="Y"/>&nbsp;Setuju
                <s:radio name="kpsnMMKN" value="T"/>&nbsp;Tidak
            </p>
            <p>
                <label for="keterangan">Keterangan Mesyuarat :</label>
                <s:textarea name="keterangan" rows="3" cols="45"/>&nbsp;
            </p>
        ...
        <center>
            ...
            <s:button name="simpanKpsnMMKN" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
        ...
        <c:if test="${fn:length(actionBean.senaraiKandungan) > 0}">
            ...
            <c:if test="${actionBean.permohonan.idPermohonan ne null}">
                <fieldset class="aras1">
                    ...
                    <br/>
                </fieldset><center> <s:submit name="hantar" id="save" value="Hantar" class="longbtn"/>   </center> 
                <br/>
                <br/>
            </c:if>
        </c:if>
