<%-- 
    Document   : rekodPenerimaanTuntutanLebihan
    Created on : 23-Dec-2010, 14:57:50
    Author     : nordiyana
--%>
...
<s:useActionBean beanclass="etanah.view.ListUtil" id="listUtil" />
<s:form beanclass="etanah.view.stripes.pengambilan.RekodPenerimaanTuntutanLebihanActionBean" id="form">
<div  id="hakmilik_details">
    <div align="center">
        <table style="width:99.2%" bgcolor="purple">
            <tr><td width="100%" height="20" ><div style="background-color: purple;" align="center">
                        <font style="font-family: Tahoma; font-size: 16px; font-weight: bold;"><font color="white">PENGAMBILAN: REKOD PENERIMAAN BAYARAN TUNTUTAN LEBIHAN</font></font>
            </div></td></tr>
        </table>
    </div><br /><br />
...
<fieldset class="aras1">
    ...
    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
        ...
        <display:column title="ID Hakmilik">
            <s:link beanclass="etanah.view.stripes.pengambilan.RekodPenerimaanTuntutanLebihanActionBean"
