<%-- 
    Document   : samanPemulaMahkamahAmanah
    Created on : Apr 19, 2013, 5:11:17 PM
    Author     : Admin
--%>
                ...
                <fieldset class="aras1" id="locate">
                    <div class="content" align="center">
                        <table border="0" width="80%">
                            ...
                            <tr align="left">
                                <td align="center">
                                    <b><u>DALAM MAHKAMAH TINGGI MALAYA DI SEREMBAN</u></b>
                                </td>
                            </tr>
                            <tr><td> &nbsp;</td></tr>
                            <%--&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;--%>
                            <tr align="center">
                                <td align="center">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;SAMAN PEMULA BIL:
                            ...
                            <div class="content" align="right">
                                <tr align="right"><td align="right"><br />Dalam perkara seksyen 29 Akta </td></tr><br />
                                <tr align="right"><td align="right">Pengambilan Tanah 1960</td></tr>
                                <tr align="right"><td align="right" >DAN</td></tr>
                                <tr align="right"><td align="right"><br />Dalam perkara mengenai tanah yang terkandung dalam</td></tr>
                                <tr align="right"><td align="right"><font style="text-transform: uppercase">${actionBean.heading}</font><s:hidden name="heading"/></td></tr>

                            </div>

                            <%--<tr align="left"><td align="center"><br />ANTARA</td></tr>--%>
                            <tr align="right"><td><br />Pentadbir Tanah <br><font style="text-transform: uppercase">${actionBean.hakmilik.daerah.nama}</font> - Pemohon</td></tr>
                    ...
                    <div class="content" align="center" >
                        <table border="0" width="50%" align="center">
                            <tr><td>Benarkan semua pihak berkenaan hadir di hadapan Timbalan Pendaftar / Penolong Kanan Pendaftar</td></tr>
                            <tr><td>dalam Kamar pada hari
                                    <c:if test="${actionBean.disable eq 'FALSE'}"><s:text name="hari" id="hari" /></c:if>
                                    <c:if test="${actionBean.disable eq 'TRUE'}"><s:text name="hari" id="hari" readonly="true"/></c:if>
                                    pada
                                    ...
                                    bagi mendengarkan permohonan dari pihak ${actionBean.permohonanKertas.penyediaSidang} Daerah ${actionBean.hakmilik.daerah.nama}</td></tr>
                            ...
                            <tr><td>untuk mendapatkan perintah <b>mendepositkan</b> dimahkamah sejumlah wang sebanyak RM <fmt:formatNumber pattern="#,##0.00" value="${e}"/></td></tr>
                            <tr><td>iaitu bayaran pampasan pengambilan tanah yang ditawarkan kepada tuan punya tanah <font style="text-transform: uppercase">${actionBean.heading}</font><s:hidden name="heading"/> </td></tr>
                            <tr><td>disebabkan pihak berkepentingan tidak hadir semasa hari siasatan</td></tr>
                            <tr><td>bertarikh
                            ...
                            <tr><td>Saman ini tidak bermaksud untuk diserahkan kepada mana-mana orang.Permohonan ini akan di sokong dengan Affidavit permohonan yang difailkan pada
