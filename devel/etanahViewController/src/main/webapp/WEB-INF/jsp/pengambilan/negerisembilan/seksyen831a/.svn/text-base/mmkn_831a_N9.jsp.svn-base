                ...
                <table border="0" width="80%">
                     ...
                     <tr><td><b><font>4. SYOR PENTADBIR TANAH DAERAH ${actionBean.hakmilik.daerah.nama}</font></b></td></tr>
                        ...
                        <c:forEach var="i" begin="1" end="${actionBean.count5}">
                            ...
                            <tr><td align="right">
                                    ...
                                    <s:button class="btn" value="Hapus" name="add" onclick="deleteTable5('Tables5')"/>
                            </td></tr>
                        <tr><td> &nbsp;</td></tr>
                    ...
                    <tr><td><b><font>6. SYOR PENGARAH TANAH DAN GALIAN, NEGERI SEMBILAN</font></b></td></tr>
                     ...
                     <tr><td align="right"><s:button name="perihal6" disabled="true" value="Tambah" class="btn" onclick="addRow6('dataTable6')" />
                                <s:button name="perihal6" disabled="true" value="Hapus" class="btn" onclick="deleteRow6('dataTable6')" />
                            </td>
                        </tr>
                    <tr><td align="right">
                    <div id="Tables4">
        ...
        <fieldset class="aras1" id="locate">
            <div class="content" align="center">
                <table border="0" width="80%">
                    ...
                    <tr><td><b>1. TUJUAN</b></td></tr>
                    <tr><tr><tr><td colspan="2"><b> &nbsp;</b><s:textarea rows="5" cols="140" name="tujuan" class="normal_text" disabled="false"/><td>
                                ...
                                <table id ="dataTable2">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan2}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea name="kandungan2${i}" class="normal_text" id="kandungan2${i}" disabled="false" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                ...
                                <table id ="dataTable3">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                        <tr style="font-weight:bold">
                                            ...
                                            <td><font><s:textarea name="kandungan3${i}" class="normal_text" disabled="false" id="kandungan3${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                            ...
                            <tr><td>
                                    <table  width="90%" id="table5${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiPentadbir[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount5 eq 1}">
                                                <tr> <td><b>4.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" class="normal_text" cols="130" disabled="false" name="senaraiPentadbir${i}${recordCount5}" id="senaraiPentadbir${i}${recordCount5}" value="${senarai.kandungan}" /></td>
                                                    <td><s:hidden name="count5${i}" id="count5${i}" value="${(fn:length(actionBean.senaraiPentadbir[i]))}" /> </td>
                                            ...
                                            <tr>  <td></td>
                                                <td><b><c:out value="${actionBean.str[recordCount5-1]}"/>.</b></td>
                                                <td><s:textarea rows="5" cols="130"  disabled="false" class="normal_text" name="senaraiPentadbir${i}${recordCount5}" id="senaraiPentadbir${i}${recordCount5}" value="${senarai.kandungan}" /></td>
                                            </c:if>
                                            <s:hidden name="kand5${i}${recordCount5}" id="kand5${i}${recordCount5}" value="${senarai.idKandungan}" />
                                        </c:forEach>
                                    </table>
