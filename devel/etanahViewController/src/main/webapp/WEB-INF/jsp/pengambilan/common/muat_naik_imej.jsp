<%-- 
    ...
    Created on : May 28, 2012, 4:42:09 PM
    Author     : User
--%>
...
<script type="text/javascript">
    ...
    return false;--%>
        ...
        function muatNaikForm(idPermohonan,lokasi) {
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/muat_naik_imej?uploadDoc&idPermohonan=' + idPermohonan+'&lokasi=' + lokasi;
            window.open(url, 'etanah', "status=0,toolbar=0,location=0,menubar=0,width=1000,height=200, left=" + left + ",top=" + top);
        }

        function refreshPage(){
            var url = '${pageContext.request.contextPath}/pengambilan/muat_naik_imej?reload';
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
        ...
        function muatNaikimej(f) {
            //        var url = '${pageContext.request.contextPath}/pengambilan/muat_naik_imej?uploadDoc';
//            $.blockUI({
//                message: $('#muatnaik'),
//                css: {
...
//            },'html');
        ...
        function simpanImej(event,f){
            ...
            //            var f = '${pageContext.request.contextPath}/pengambilan/muat_naik_imej';
            //            alert("simpan imej"+f);
        ...
        function hapusimej(idDokumen){
            if((confirm("Anda pasti ingin menghapuskan imej ini?"))){
                var url = '${pageContext.request.contextPath}/pengambilan/muat_naik_imej?hapusImej&idDokumen='+idDokumen;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
                },'html');
        ...
        function popImej(idDok){
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/muat_naik_imej?viewImejPopup&idPermohonan='+id+'&idDokumen='+idDok;
            ...
            //            window.open("${pageContext.request.contextPath}/pengambilan/muat_naik_imej?viewImejPopup&idPermohonan="+id+"&idDokumen="+idDok, "eTanah",
...
<s:form id="testForm" name="myform" beanclass="etanah.view.stripes.pengambilan.MuatNaikImejActionBean">
...
<div id="muatnaik" style="display: none">
    <s:form name="myform1" beanclass="etanah.view.stripes.pengambilan.MuatNaikImejActionBean">
        <fieldset class="aras1">
            <div id="error"/>
