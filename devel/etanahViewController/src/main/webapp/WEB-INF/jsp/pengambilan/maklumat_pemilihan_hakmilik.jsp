...
<script type="text/javascript">
    ...
    <%--alert(idVar.value);--%>
        ...
        $(document).ready(function() {
            ...
            for (var i = 0; i < bil; i++){
                if($("#pilih"+i).val() == "1"){
                    document.getElementById("penarikBalikan"+i).checked = true;
                }
            }
        });
        ...
        function selectAll(a){
            for (i = 0; i < 100; i++){
                var c = document.getElementById("penarikBalikan" + i);
                if (c == null) break;
                c.checked = a.checked;
            ...
            <c:if test="${!edit}">
                ...
                <p align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="20" cellpadding="0" cellspacing="0"
                        ...
                        <display:column  title="Penarikanbalik Hakmilik?<br> <input type='checkbox'  id='semua' name='semua' onclick='javascript:selectAll(this);' />" >
                        <div align="center">
                            <s:checkbox style="readonly"  name="penarikBalikan${line_rowNum - 1}"  id="penarikBalikan${line_rowNum-1}" value="${line.penarikBalikan}" />
                            <s:hidden name="pilih[${line_rowNum-1}]" value="${line.penarikBalikan}" id="pilih${line_rowNum-1}"/>
                        </div>
                    </display:column>
                ...
                <s:button name="simpanPenarikBalikan" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
