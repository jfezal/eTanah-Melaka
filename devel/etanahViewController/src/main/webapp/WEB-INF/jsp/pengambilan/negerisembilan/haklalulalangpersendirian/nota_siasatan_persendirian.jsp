<%-- 
    Document   : nota_siasatan_persendirian
    Created on : Oct 26, 2010, 1:54:05 PM
    Author     : Rajesh
--%>
...
<s:form name="notaForm" beanclass="etanah.view.stripes.pengambilan.NotaSiasatanPersendirianActionBean">
    <s:messages/>
    <s:errors/>
        ...
        <div align="center">
            <table style="width:99.2%" bgcolor="purple">
                <tr><td width="100%" height="20" ><div style="background-color: purple;" align="center">
                            <font style="font-family: Tahoma; font-size: 16px; font-weight: bold;"><font color="white">NOTA SIASATAN HAK LALU LALANG PERSENDIRIAN</font></font>
                        </div></td></tr>
            </table>
        </div>
        ...
        <fieldset class="aras1">
            ...
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/nota_siasatan_persendirian" id="line">
                    <display:column title="No" sortable="true">${line_rowNum}</display:column>
                    <display:column title="ID Hakmilik">
                        <s:link beanclass="etanah.view.stripes.pengambilan.NotaSiasatanPersendirianActionBean"
            ...
            <c:if test="${actionBean.hakmilik ne null}">
                 ...
                 <label for="a">Nota Siasatan Permohonan Hak Lalu Lalang Persendirian:</label>
           ...
           <br/><br/>
            <p align="center">
                <display:table class="tablecloth" name="${actionBean.hakmilik.senaraiPihakBerkepentingan}"  cellpadding="0" cellspacing="0"
                               requestURI="/pengambilan/nota_siasatan_persendirian" id="line1">
...
<%--                <table>
                    <tr>
                        <td><b>5) Permohonan tukar syarat/pecah sempadan.</b></td>
                        <td><b>Jika ada,bila dan bagaimana kedudukan sekarang :</b></td>
                        <td><b><s:textarea name="hakmilikPerbicaraan.tukarSyarat" rows="3" cols="50" /></b></td>
                    </tr>
                </table>--%>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><b>:</b></td>
                        <td><b> <s:textarea name="hakmilikPerbicaraan.lokasiTerkini" rows="3" cols="50" id="lokasiTerkini"/></b></td>
                    </tr>
                    <br/>
                    ...
                    <tr>
                        ...
                        <td><b>:</b></td>
                        <td><b> <s:textarea name="perbicaraanKehadiran.penilaiUlasan" rows="3" cols="50" /></b></td>
                    </tr>
                    <%--<tr>
