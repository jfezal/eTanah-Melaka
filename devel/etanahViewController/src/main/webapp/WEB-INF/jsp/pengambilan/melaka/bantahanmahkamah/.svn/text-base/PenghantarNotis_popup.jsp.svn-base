<%--
    ...
    Created on : May 9, 2011, 12:26:31 PM
    Author     : Rajesh
--%>
            ...
            <div class="content" align="right">
                <p>
                    <c:if test="${actionBean.isMahkamah eq 'true'}">
                        <s:button name="simpanPenghantarNotisM" id="save" value="Simpan" class="btn" onclick="simpanPihak(this.name, this.form);"/>
                    </c:if>
                    <c:if test="${actionBean.isMahkamah ne 'true'}">
