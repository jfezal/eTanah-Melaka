...
<s:form beanclass="etanah.view.stripes.hasil.Penyediaan8AActionBean">
<div class="subtitle">
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                ...
                <display:table class="tablecloth" name="${actionBean.senaraiHakmilikPermohonan}"
                               pagesize="5" cellpadding="0" cellspacing="0" requestURI="/hasil/penyediaan8A" id="line">
