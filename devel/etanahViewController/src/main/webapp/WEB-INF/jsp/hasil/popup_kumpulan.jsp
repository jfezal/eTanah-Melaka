<%--
    Document   : popup_kumpulan
    Created on : Sept 24, 2012, 5:14:55 PM
    Author     : haqqiem
--%>
...
<s:form beanclass="etanah.view.stripes.hasil.CarianKumpulanActionBean" id="popup_kumpulan">
    <s:errors/>
    <s:messages/>
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p align="center">
                ...
                <s:button class="btn" name="reset" value="Isi Semula" onclick="clearText('popup_kumpulan');"/>&nbsp;
                <s:button name="" value="Tutup" class="btn" onclick="self.close();"/>
            </p>
            <s:text name="" id="daerah" style="display:none;" readonly="true"/>
        </fieldset>
    </div><br>
    <div class="subtitle displaytag">
        <fieldset class="aras1">
            ...
            <center>
                <display:table name="${actionBean.senaraiKumpulan}" class="tablecloth" id="row" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/hasil/bil_cukai">
