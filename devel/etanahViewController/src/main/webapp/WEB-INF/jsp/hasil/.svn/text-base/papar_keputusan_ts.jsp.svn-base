<%-- 
    Document   : papar_keputusan_ts
    Created on : Dec 3, 2009, 8:50:37 AM
    Author     : abu.mansur
--%>
...
<s:form beanclass="etanah.view.stripes.hasil.KeputusanPaparRemTSActionBean">
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            <legend>
                ...
                <p>
                    ...
                    <s:format formatPattern="#,##0.0000" value="${actionBean.permohonanAktiviti.luasTerlibat}" />&nbsp;${actionBean.permohonanAktiviti.kodUnitLuas.nama}
                </p>
                <P>
