...
<div class="subtitle">
    ...
    <s:form name="batalResit" beanclass="etanah.view.stripes.hasil.PembatalanResitActionBean" id="pembatalan_resit_2">
        ...
        <fieldset class="aras1">
            ...
            <c:if test="${actionBean.dokumenKewangan.noRujukanManual eq null}">
                <p>
                    ...
                    ${actionBean.dokumenKewangan.idDokumenKewangan}&nbsp;<br>
                </p>
            </c:if>            
            <c:if test="${actionBean.cukaiTanah eq 'ya'}">
                <p>
                    <label  for="Id Hakmilik">ID Hakmilik :</label>
                    ${actionBean.dokumenKewangan.akaun.hakmilik.idHakmilik}&nbsp;<br>
                </p>
            </c:if>
        </fieldset>
        ...
        <c:if test="${actionBean.flag}">
            <div class="subtitle">
                <fieldset class="aras1">
                    ...
                    <div class="content" align="center">
                        <table>
                            <display:table class="tablecloth" name="${actionBean.listDK}" pagesize="10" cellpadding="0" cellspacing="0" id="line1" requestURI="/hasil/pembatalan_resit">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                ...
                <p>
                    ...
                    <%--<s:text name="dokumenKewangan.catatan" id="catatan" onblur="this.value=this.value.toUpperCase();"/>--%>
                </p>
