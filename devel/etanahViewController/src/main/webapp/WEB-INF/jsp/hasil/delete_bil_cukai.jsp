<%-- 
    Document   : delete_bil_cukai
    Created on : Oct 19, 2017, 9:55:35 PM
    Author     : andul.hakim
--%>
        ...
        <tr>
            <td width="100%" height="20" >
                <div style="background-color: green;" align="center">
                    <font style="font-family: Tahoma; font-size: 16px; font-weight: bold;">HASIL: Delete Bil Cukai</font>
                </div>
            </td>
        </tr>
    </table></div>
...
<stripes:form beanclass="etanah.view.stripes.hasil.UtilitiDeleteBilCukaiActionBean" id="delete_bil" >
