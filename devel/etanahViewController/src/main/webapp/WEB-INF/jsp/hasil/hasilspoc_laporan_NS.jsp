<%-- 
    Document   : hasilspoc_laporan_NS
    Created on : Aug 2, 2010, 4:14:56 PM
...
<script type="text/javascript">
    <%--function popupParam(nama){
        window.open("${pageContext.request.contextPath}/laporanHasilSpoc_NS/requestParam?namaReport="+nama, "eTanah",
                            ...
                            <td><div align="center">
                                    <p align="center">
                                        <img alt='Klik Untuk Papar' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                             onclick="popup('${pageContext.request.contextPath}/laporanHasilSpoc_NS/requestParam?namaReport=${actionBean.senaraiReportName[count-1]}');" onmouseover="this.style.cursor='pointer';">
                                    </p>
                                </div>
                            </td>
                        </tr>
