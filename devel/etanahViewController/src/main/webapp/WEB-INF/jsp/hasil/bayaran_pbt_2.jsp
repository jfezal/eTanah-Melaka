<%-- 
    Document   : bayaran_pbt_2
    Created on : Nov 23, 2012, 10:36:59 AM
    Author     : mansur
--%>
...
<script type="text/javascript">
    ...
    "status=0,scrollbars=1,toolbar=0,location=0,menubar=0,width=1050,height=700")--%>
        ...
        function doPrintBelakangResit1(caraByrId){
            var a = document.getElementById('applet2');
            a.printTaxInfoPBT(caraByrId.toString());
        }
</script>
<s:useActionBean beanclass="etanah.view.ListUtil" id="listUtil" />
<s:form beanclass="etanah.view.stripes.hasil.BayaranPBTActionBean" id="bayaran_pbt">
    <s:errors /><s:messages/>
            ...
            <div class="content" align="center">
                <display:table class="tablecloth" name="${actionBean.senaraiTransaksi}" requestURI="kutipanHasil" id="line">
                    ...
                    <display:column title="Cetak">
                        <s:button name=" " value="Cetak" class="btn" onclick="doPrintBelakangResit1('${line.dokumenKewangan.idDokumenKewangan}');"/>
                    </display:column>
                    <display:footer>
                        <tr>
