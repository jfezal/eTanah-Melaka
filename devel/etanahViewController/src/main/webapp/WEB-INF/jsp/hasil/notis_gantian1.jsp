...
<script type="text/javascript">
    function edit(id, idNotis){
        window.open("${pageContext.request.contextPath}/hasil/notis_gantian?popup1&idHakmilik="+id+"&idNotis="+idNotis, "eTanah",
                 "status=0,toolbar=0,location=0,menubar=0,width=1100,height=680,scrollbar=1,resizable=1");
    }
</script>
