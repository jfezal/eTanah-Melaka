<%-- 
    Document   : cukai_resit
    Created on : Mar 4, 2013, 5:12:41 PM
    Author     : haqqiem
--%>
...
<s:form beanclass="etanah.view.stripes.hasil.CukaiActionBean" id="form1">
                    ...
                    <display:table class="tablecloth" name="${actionBean.transList}" id="line">
                        ...
                        <display:footer>
                            <tr>
                                ...
                                <td class="number" align="right"><div align="right"><fmt:formatNumber value="${actionBean.jumlahCaj}" pattern="#,###,###.00"/></div></td>
                            </tr>
                            <tr>
                            ...
                            <c:if test="${actionBean.bakiFlag eq true}">
                                <tr>
                                    ...
                                    <td class="number"><div align="right"><fmt:formatNumber value="${actionBean.returnBalance}" pattern="#,###,###.00" /></div></td>
                                </tr>
                            </c:if>
                        </display:footer>
                    </display:table>
    ...
    <div align="center"><table style="width:99.2%" bgcolor="green">
        <tr>
            <td align="right">
                <s:button name=" " id="cetakSemua" onclick="cetakBil1(this.form);" value="Cetak Bil" class="btn"/>&nbsp;
