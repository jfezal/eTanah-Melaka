<%-- 
    Document   : kertasRisalatHuraianPTD
    Created on : Jun 4, 2013, 8:34:43 AM
    Author     : khadijah
--%>
...
<title>Asas-Asas Pertimbangan</title>
...
<script type="text/javascript">
    ...
    function deleteRow(idKandungan,f,tName)
    {
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/hasil/kertas_risalat?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kHuraianPtd',q,
            function(data){
                $('#page_div').html(data);
    ...
    <s:form beanclass="etanah.view.stripes.hasil.KertasRisalatMMKNActionBean" name="form">
        ...
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Asas-Asas Pertimbangan</legend>
