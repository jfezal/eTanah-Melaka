...
public class CalcTax {
  ...
  public BigDecimal calculate(String kodTanah, String kodBpm, String kodUOM, BigDecimal luas, Hakmilik hakmilik, String kodRizab) {
...
//                if (!hakmilik.getKategoriTanah().getKod().equals("3")) {
        if (!hakmilik.getKategoriTanah().getKod().equals("1")) {
          if (kodNegeri.equals("04")) {
          ...
          logger.debug(" /*KIRA CUKAI PERTANIAN N9*/ ");
          if (!"H".equals(hakmilik.getKodUnitLuas().getKod())) { // if UOM luas is not Hectare
            /*CONVERT UNIT KE HEKTAR*/
            total = toHectare(kodUOM, luas).multiply(kadarCukaiList.get(0).getKadarMinimum());
          } else {
            total = luas.multiply(kadarCukaiList.get(0).getKadarMinimum());
          }
        }
...
//                    if (!hakmilik.getKategoriTanah().getNama().equalsIgnoreCase("Pertanian")) {
        ...
        if (kodNegeri.equals("04")) {
          logger.debug("set cukai minima utk hakmilik: " + hakmilik.getKodHakmilik().getKod());
          BigDecimal minimaAll = new BigDecimal(12);
          total = total.max(minimaAll);
          if (hakmilik.getKodHakmilik().getKod().equals("GMM") || hakmilik.getKodHakmilik().getKod().equals("PMM")
                  || hakmilik.getKodHakmilik().getKod().equals("HMM")) {
...
//    public BigDecimal calculate(String kodGunaTanah, String kodTanah, String kodBpm, String kodUOM, BigDecimal luas, Hakmilik hakmilik, String kodRizab) {
//        kodNegeri = etanahConf.getKodNegeri();
//        logger.debug(":start kira cukai:");
//        logger.debug("kodGunaTanah : " + kodGunaTanah);
//        logger.debug("kodBpm : " + kodBpm);
//        logger.debug("kodTanah :" + kodTanah);
//        logger.debug("kodUOM :" + kodUOM);
//        logger.debug("kodRizab :" + kodRizab);
//        //String result = "";
//        if (StringUtils.isNotBlank(kodBpm) && StringUtils.isNotBlank(kodTanah) && StringUtils.isNotBlank(kodGunaTanah)) {
//
//            double q = 0;
//            double r = 0;
//            BigDecimal conv = BigDecimal.ZERO;
...
//            if (kodNegeri.equals("04")) {
//                logger.debug(":kira Cukai for MELAKA:");
//                if (kodGunaTanah.equals("P03") || kodGunaTanah.equals("P01") || kodGunaTanah.equals("P02")) {
//                    logger.debug("unitLuas:" + kodUOM);
//                    logger.debug("luas:" + luas);
//                    /*CONVERT UNIT KE HEKTAR*/
//                    totalLuasByH = toHectare(kodUOM, luas);
...
//                    /*check luas < 5 hectar*/
//                    if (totalLuasByH.compareTo(bg) < 0) {
//                        kadarCukaiList = regService.searchKadarCukai(kodBpm, kodGunaTanah, kodTanah, zero);
//                    } else {
//                        kadarCukaiList = regService.searchKadarCukai(kodBpm, kodGunaTanah, kodTanah, five);
//                    }
//                } else {
//                    kadarCukaiList = regService.searchKadarCukai(kodBpm, kodGunaTanah, kodTanah, zero);
//                }
...
//                        total = luas.multiply(kC);
//                    } else if (kodNegeri.equals("05")) {
//                        //if not pertanian get Kadar Minimum -- N9
//                            BigDecimal minima = kadarCukaiList.get(0).getKadarMinimum();
//                            total = total.max(minima);
//                    }
//                    
