...
@UrlBinding("/utility_kod/kodAliran")
public class KodAliranActionBean extends AbleActionBean {
    ...
    private int id_rekod_aliran;
    private List<KodAliran>listKodAliran;
    ...
    public Resolution showForm() {
     ...
     public Resolution KodList() throws Exception {
        ...
        listKodAliran =service.allKodAliran(); 
   ...
   public Resolution updateData() throws Exception {
        ...
        if(details.getKeteranganRingkas()==null){
            details.setKeteranganRingkas("");
        }
        ...
        if(result == 0){
          ...
          return new RedirectResolution(KodAliranActionBean.class, "viewKodAliran").addParameter("table_name", nameTable).addParameter("kod", kod);
    ...
    public Resolution simpanData() throws Exception {
        ...
        KU.setKod(urusan);
        KA.setKod(kod_Aliran);
        KA.setNama(nama);
        KA.setKodUrusan(KU);
        KA.setIdAliran(idAliran);
        ...
        statusTambah = true;
          return new RedirectResolution(KodAliranActionBean.class, "viewKodAliran").addParameter("table_name", nameTable).addParameter("kod", KA.getKod());
    ...
    public String getKod_Aliran() {
        return kod_Aliran;
    }

    public void setKod_Aliran(String kod_Aliran) {
        this.kod_Aliran = kod_Aliran;
    }
