...
@UrlBinding("/utility_kod/kemasukanAdun")
public class KemasukanAdunActionBean extends AbleActionBean {
    ...
    public Resolution KodList() throws Exception {
        ...
        listKodAgensi = service.findAllForAdun("ADN");



        if (listKodAgensi.size() > 0) {
            setFlag(true);
            addSimpleMessage(listKodAgensi.size() + " ADUN ditemui.");

        } else {
            addSimpleError("Tiada ADUN ditemui.");
        }


        return new JSP("/utiliti/utiliti_kod_ruj/adun/listAdun.jsp");
    ...
    public Resolution KodList2() throws Exception {
        ...
        listKodAgensi = service.findForAdun(nama, gelaran, "ADN", daerah);
    ...
    public Resolution viewAddForm() throws Exception {
        ...
        return new JSP("/utiliti/utiliti_kod_ruj/adun/tambahRekodAdun.jsp");
    }
    ...
    public Resolution viewKodAgensi() throws Exception {
        ...
        return new JSP("/utiliti/utiliti_kod_ruj/adun/kemaskiniAdun.jsp");
    }
...
//        LOG.debug("nameTable = "+nameTable+" kodMenteri = "+details.getKodKementerian()+" nama = "+details.getNama()+"alamat1 = "+details.getAlamat1()+" alamat2 = "+details.getAlamat2()+" alamat3 = "+details.getAlamat3()+"alamat 4 = "+details.getAlamat4()+" kodnegeri = "+details.getKodNegeri().getKod()+" poskod = "+details.getPoskod()+" aktif = "+details.getAktif()+" KATG_AGENSI = "+details.getKategoriAgensi().getKod()+" emel = "+details.getEmel()+" kodgelaran = "+details.getKodGelaran().getKod());
        ...
        query += ",ALAMAT1 = '" + details.getAlamat1() + "',ALAMAT2 = '" + details.getAlamat2() + "',ALAMAT3 = '" + details.getAlamat3() + "',"
                + "ALAMAT4 = '" + details.getAlamat4() + "',POSKOD = '" + details.getPoskod() + "', "
        ...
        return new RedirectResolution(KemasukanAdunActionBean.class, "viewKodAgensi").addParameter("table_name", nameTable).addParameter("kod", kod);
...
//        KA.setKodNegeri(KN);
        ...
        return new RedirectResolution(KemasukanAdunActionBean.class, "viewKodAgensi").addParameter("table_name", nameTable).addParameter("kod", KA.getKod()).addParameter("statusTambah", true);
