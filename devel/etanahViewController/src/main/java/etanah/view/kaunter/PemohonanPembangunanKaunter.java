...
@UrlBinding("/pembangunan/permohonan")
public class PemohonanPembangunanKaunter extends AbleActionBean {

    public static final String KOD_JABATAN_PENDAFTARAN = "16";
    public static final String KOD_DOKUMEN_AKUAN_PENERIMAAN = "UNKN1";
    public static final int KAUNTER_HAKMILIK_MAKSIMUM = 200;
...
//            LOG.debug("pguna.getKodCawangan().getKod():" + pguna.getKodCawangan().getKod());
        ...
        if (tambahUrusan == 'Y') {
            return new ForwardResolution("/WEB-INF/jsp/pembangunan/permohonan/main.jsp");
        }
    ...
    public Resolution selectDocuments() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pembangunan/permohonan/senarai_semakan_2.jsp");
    }
    ...
    public Resolution selectTitles() {
        ...
        if (urusan.suratSWD != null && urusan.suratSWD.size() > 0) {
            ...
            if (invalidSurat != null && invalidSurat.size() > 0) {
                ...
                addSimpleMessage("AMARAN: Surat Kuasa Wakil ini tiada dalam rekod: "
                        + msg);
                // return new
        ...
        String JSP = "/WEB-INF/jsp/pembangunan/permohonan/pilih_hakmilik_2.jsp";

        if (urusan.kodUrusan.equals("SMK") || urusan.kodUrusan.equals("SMBT")) {
            JSP = "/WEB-INF/jsp/pembangunan/permohonan/caj_tamb_2.jsp";
        }
    ...
    public Resolution getSpecificInfoForUrusan() {
        ...
        // hakmilik validation
        KodUrusan ku = kodUrusanDAO.findById(urusan.kodUrusan);
        if (ku.getBilMinimumHakmilik() != null && ku.getBilMinimumHakmilik() > 0) {
            boolean found = false;
            ...
            if (!found) {
                ...
                return new ForwardResolution("/WEB-INF/jsp/pembangunan/permohonan/pilih_hakmilik_2.jsp");
            }
        }
        ...
        /* Cater for PHPC By Syafiq Az(STRATA)*/
        ...
        if (needInfo) {
            return new ForwardResolution("/WEB-INF/jsp/pembangunan/permohonan/urusan_info_tamb_2.jsp");
        } else {
    ...
    public Resolution getAdditionalPaymentInfo() {
        ...
        if (!isUrusanNull(urusan)) {
            ...
            if (infos != null) {
                ...
                } else if (urusan.getKodUrusan().equals("PBTS")) {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pembangunan/permohonan/caj_tamb_2.jsp");
    }
    ...
    /*    if (!"Y".equals(abaiAmaran)) {
            ...
            if (errs != null && errs.size() > 0) {
                ...
                String[] kodursns = {"RMHS1", "RMH1A", "RMHS5", "RMHS6", "RMHS7", "RTHS"};
        ...
        /*End*/
          ...
          String  permohonanSblm = getContext().getRequest().getParameter("permohonanSblm");
          
        /*Add by hakim for Module Consent*/
          LOG.info("----Id Sblm from Urusan-----:"+urusan.getIdPermohonanSebelum());
          LOG.info("----Id Sblm from User-----:"+permohonanSblm);
        ...
        if(permohonanSblm!=null){
              urusan.setIdPermohonanSebelum(permohonanSblm);
              getContext().getRequest().getSession().setAttribute("idSblm", urusan.getIdPermohonanSebelum());
          }
        /*End*/
        etanahActionBeanContext ctx = (etanahActionBeanContext) getContext();
        ...
        // reset all values
        resetUrusan();
        return new RedirectResolution(PembangunanTerimaBayaran.class);
    }
