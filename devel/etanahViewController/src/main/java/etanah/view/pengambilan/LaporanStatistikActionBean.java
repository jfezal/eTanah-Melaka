...
import etanah.view.strata.laporan.*;
 ...
 * @author abu.mansur
 */
@UrlBinding("/pengambilan/laporanstatistik")
public class LaporanStatistikActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/negerisembilan/laporan_utiliti_main.jsp");
    }
...
//                "ACQkenyataankemajuan.rdf",
                "ACQLU831A_MLK.rdf",
                "ACQLU831B_MLK.rdf",
                "ACQLU831C_MLK.rdf",
                "ACQtanahkePTG.rdf",
                "ACQlaporanteknikal.rdf",
                "ACQlaporanEFT.rdf",
                "ACQtanahkePTG.rdf"
            };
     //   }
...
//        getPenggunaCaw(kodCaw);
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/negerisembilan/laporan_utiliti_n9.jsp").addParameter("popup", "true");
    }
