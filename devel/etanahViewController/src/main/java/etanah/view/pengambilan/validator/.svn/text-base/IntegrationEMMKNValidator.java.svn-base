 ...
 *
 */
public class IntegrationEMMKNValidator implements StageListener {
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        if (idPermohonan != null) {
            ...
            mohonKertas = plpservice.findKertasByKod(idPermohonan, "MMKN"); //change name kod
