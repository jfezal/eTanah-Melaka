 ...
 */
public class IntergrationMMKN1 implements StageListener {
   ...
   // HakmilikPermohonan hakmilikPermohonan;
    private static final Logger LOG = Logger.getLogger(etanah.view.pengambilan.validator.IntergrationMMKN1.class);
...
//            LOG.info("###### pemohon noTelefon " + noTelefon);
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(IntergrationMMKN1.class.getName()).log(Level.SEVERE, null, ex);
            }
