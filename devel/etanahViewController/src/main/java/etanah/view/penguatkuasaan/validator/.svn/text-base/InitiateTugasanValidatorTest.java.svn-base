 ...
 */
public class InitiateTugasanValidatorTest implements StageListener {
    ...
    private static final Logger LOG = Logger.getLogger(InitiateTugasanValidatorTest.class);
...
//                reportName.add("ENFSERAH_MLK.rdf,SERAH"); // report serahan barang rampasan
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        try {
            ...
            if (permohonan.getKodUrusan().getKod().equalsIgnoreCase("p")) {
...
//                        nextStage = WorkFlowService.updateTaskOutcome(taskId, ctxOnBehalf, "T"); // 
            ...
            java.util.logging.Logger.getLogger(InitiateTugasanValidatorTest.class.getName()).log(Level.SEVERE, null, ex);
