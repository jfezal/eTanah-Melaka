 ...
 */
@UrlBinding("/penguatkuasaan/utiliti_diari_siasatan")
public class UtilitiDiariSiasatanActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(UtilitiDiariSiasatanActionBean.class);
    @Inject
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (permohonan != null) {
                diariSiasatan = enforceService.findByIdKrts(idPermohonan, "DIARI");
    ...
    public Resolution simpanDiariSiasatan() {
        ...
        if (idPermohonan != null) {
            ...
            if (permohonan != null) {
                ...
                diariSiasatan.setKodDokumen(kodDokumenDAO.findById("DIARI"));
                ...
                for (int i = 0; i < row; i++) {
                    ...
                    if ("04".equals(conf.getProperty("kodNegeri"))) {
                        reportName = "ENFDS_MLK.rdf";
                    } else {
                        reportName = "ENFDS_NS.rdf";
                    }
...
//        return new ForwardResolution("/WEB-INF/jsp/penguatkuasaan/carian_diari_siasatan.jsp");
        ...
        saveToSession(ctx);
        return new RedirectResolution(UtilitiDiariSiasatanActionBean.class, "locate");
    }
