...
//                            pemohon.getPekerjaan(), pendapatanPemohon, pihak.getTempatLahir(), umurPemohon);
                    ...
                    try {
                        LOGGER.info("::::: Pemohon null");
                        Calendar c1 = Calendar.getInstance();
                        c1.setTime(permohonan.getInfoAudit().getTarikhMasuk());
                        DatatypeFactory df = DatatypeFactory.newInstance();
                        GregorianCalendar gc = new GregorianCalendar();
                        XMLGregorianCalendar tarikhDitubuhkan = df.newXMLGregorianCalendar(gc);
                        service.addCompany("Tiada Data", "Tiada Data",
                                "Tiada Data", "Tiada Data",
                                "", BigDecimal.ZERO, BigDecimal.ZERO,
                                "Tiada Data", "Tiada Data", "Tiada Data", tarikhDitubuhkan);
                    } catch (DatatypeConfigurationException ex) {
                        java.util.logging.Logger.getLogger(IntegrationEMMKNV2.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                ...
                for (HakmilikPermohonan hakmilikMohon : listHakmilikPermohonan) {
                    ...
                    if (hakMohon.getHakmilik() != null) {
                        ...
                        //kalau takde no lot & kod lot 1 or 2 --- 
                        //ada error 
                        /* LotInformationDTO:
                         ----------------------------------------------------------------------------
                         ...
                         Lot No.or PT No.
                         ----------------------------------------------------------------------------
                         The fields below are missing mapping in EMMKN :
                         Kod Mukim eTanah Code: NULL*/
                        noLotPT = hakMohon.getHakmilik().getNoLot();
                        service.addLotInformation(null, String.valueOf(hakMohon.getBandarPekanMukimBaru() != null ? hakMohon.getBandarPekanMukimBaru().getKod() : "30"), hakMohon.getHakmilik() != null ? hakMohon.getHakmilik().getNoHakmilik() : null, typeLotPT.equals("1") ? noLotPT : "0", typeLotPT.equals("2") ? noLotPT : "0");
                        ...
                        if (hakMohon.getLot() != null) {
                            ...
                            System.out.println(":::: 1::" + hakMohon.getBandarPekanMukimBaru());
                            System.out.println(":::: 2::" + hakMohon.getHakmilik());
                            //kod bpm set 31 if null

                            service.addLotInformation(null, String.valueOf(hakMohon.getBandarPekanMukimBaru() != null ? hakMohon.getBandarPekanMukimBaru().getKod() : "30"), hakMohon.getHakmilik() != null ? hakMohon.getHakmilik().getNoHakmilik() : null, typeLotPT.equals("1") ? noLotPT : "0", typeLotPT.equals("2") ? noLotPT : "0");

                        } else {
                            service.addLotInformation(null, String.valueOf(hakMohon.getBandarPekanMukimBaru() != null ? hakMohon.getBandarPekanMukimBaru().getKod() : "30"), hakMohon.getHakmilik() != null ? hakMohon.getHakmilik().getNoHakmilik() : null, "0", "0");
                        }
