 ...
 */
public class InitiatePSPBNValidator implements StageListener {
    ...
    private static final Logger LOG = Logger.getLogger(InitiatePSPBNValidator.class);
...
//        if (permohonan.getKeputusan().getKod().equals("WJ")) {
        ...
        if (!senaraiHakmilik.isEmpty()) {
            ...
            LOG.info("buat urusan tukar ganti PSPBN");
        ...
        KodUrusan kod = kodUrusanDAO.findById("PSPBN");
