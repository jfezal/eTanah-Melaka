 ...
 */
@UrlBinding("/penguatkuasaan/maklumat_keputusan_MMKN")
public class MaklumatKeputusanMMKNActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(MaklumatKeputusanMMKNActionBean.class);
    ...
    public Resolution showForm() {
        ...
        return new JSP("penguatkuasaan/surat_keputusan_mmkn.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            try {
                ...
                kertas = enforceService.findByIdKrts(permohonan.getIdPermohonan(), "SKM");
    ...
    public Resolution simpan() throws ParseException {
        ...
        kertas.setKodDokumen(kodDokumenDAO.findById("SKM"));
        ...
        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        rehydrate();
        return new ForwardResolution("/WEB-INF/jsp/penguatkuasaan/surat_keputusan_mmkn.jsp").addParameter("tab", "true");
    }
