 ...
 */
@UrlBinding("/penguatkuasaan/diari_siasatan")
public class DiariSiasatanActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(DiariSiasatanActionBean.class);
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            try {
                ...
                kertas = enforceService.findByIdKrts(permohonan.getIdPermohonan(), "DIARI");

                if (kertas != null) {
                    tajuk = kertas.getTajuk();
                    senaraiKertas = enforceService.findByIdKertas2(kertas.getIdKertas());
                } else {
                    LOG.info("diari siasatan null");
                    if (permohonan.getKodUrusan().getKod().equalsIgnoreCase("426") || permohonan.getKodUrusan().getKod().equalsIgnoreCase("425A") || permohonan.getKodUrusan().getKod().equalsIgnoreCase("425")|| permohonan.getKodUrusan().getKod().equalsIgnoreCase("49")) {
                        if (permohonan.getPermohonanSebelum() != null) {
                            ...
                            //1)  find mohon kertas based on id permohonan sebelum (IP create new id permohonan)
                            kertas = enforceService.findByIdKrts(permohonan.getPermohonanSebelum().getIdPermohonan(), "DIARI");
                            ...
                            if (kertas == null) {
                                ...
                                if (permohonanIP != null) {
                                    kertas = enforceService.findByIdKrts(permohonanIP.getPermohonanSebelum().getIdPermohonan(), "DIARI");
                                }
...
//    }
    public Resolution simpan() throws ParseException {
        ...
        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        rehydrate();
        return new ForwardResolution("/WEB-INF/jsp/penguatkuasaan/diari_siasatan.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution deleteDiari() {
        ...
        rehydrate();
//        return new ForwardResolution("/WEB-INF/jsp/pelupusan/diari_siasatan.jsp").addParameter("tab", "true");
        return showForm();
    }
