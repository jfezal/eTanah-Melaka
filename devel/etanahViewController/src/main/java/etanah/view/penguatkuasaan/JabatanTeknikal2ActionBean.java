 ...
 * @author w.fairul
 */
@UrlBinding("/penguatkuasaan/jabatan_teknikal12")
public class JabatanTeknikal2ActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("penguatkuasaan/pilih_jabatan_teknikal_2.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution showSyorSDP() {
        ...
        return new JSP("penguatkuasaan/syor_SDP.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution showEditJabatanTeknikal() {
        ...
        return new JSP("penguatkuasaan/surat_ulasan_teknikal.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution showEditJabatanTeknikal1() {
        ...
        return new JSP("penguatkuasaan/surat_ulasan_teknikalView.jsp").addParameter("popup", "true");
    }
...
//                mohonRujLuarTemp.setTarikhTerima(curDate);
        ...
        return new JSP("penguatkuasaan/terima_ulasan_jabatan_teknikal.jsp").addParameter("tab", "true");
    }
...
//             }
    ...
    public Resolution deleteRujukan() {
        ...
        rehydrate();
        return new ForwardResolution("/WEB-INF/jsp/penguatkuasaan/pilih_jabatan_teknikal_2.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution kodAgensiPopup() {
        ...
        return new JSP("penguatkuasaan/search_Page.jsp").addParameter("popup", "true");
    }
...
//code changed by rohan
        if (kod != null) {
            ...
            if (listKodAgensi.size() < 1) {
                ...
                return new JSP("/penguatkuasaan/kodAgensi_Page.jsp").addParameter("popup", "true");
...
//                ia.setTarikhKemaskini(new java.util.Date());
        ...
        return new JSP("/penguatkuasaan/pilih_jabatan_teknikal_NS.jsp").addParameter("tab", "true");
    }
