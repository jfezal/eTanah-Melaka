...
@UrlBinding("/penguatkuasaan/RingkasanMMKN")
public class RisalatMMKNActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("penguatkuasaan/risalatMMKN.jsp").addParameter("tab", "true");
    }
...
//        LOG.info("------Pemohon Nama------:"+nama);
        ...
        kertasMMKN = enforceService.findByIdKrts(permohonan.getIdPermohonan(), "MMKN");

        if (kertasMMKN != null) {
            tajuk = kertasMMKN.getTajuk();
...
//                        if (StringUtils.isBlank(ulasanPtd)) {
                        ulasanPtd = permohonanKertasKandungan.getKandungan();
//                        }
                    }
...
//                        if (StringUtils.isBlank(perakuanptg)) {
                        perakuanptg = permohonanKertasKandungan.getKandungan();
//                        }
                    }
    ...
    public Resolution simpan() {
        ...
        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        return new ForwardResolution("/WEB-INF/jsp/penguatkuasaan/risalatMMKN.jsp").addParameter("tab", "true");
    }
