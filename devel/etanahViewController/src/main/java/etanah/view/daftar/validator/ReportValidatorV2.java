/*
 * 2nd Version of ReportValidator for Orogenic
 * 
 */
 ...
 * @author fikri
 */
public class ReportValidatorV2 implements StageListener {
    ...
    private static final Logger LOGGER = Logger.getLogger(ReportValidatorV2.class);
...
//                        }
                ...
                if (fp.getKeputusan().getKod().equals("SD")) {
                    ...
                    if (ku.getKod().startsWith("KVS")
                            ...
                            || ku.getKod().equals("KVLT")) {  // retest melacca -CUG
        ...
        if (p != null) {
            ...
            for (FasaPermohonan fp : senaraiFasa) {
                ...
                if (fp.getIdAliran().equalsIgnoreCase("kemasukan")
                    ...
                    if (!p.getKodUrusan().getKod().equals("BETSW") && !validationService.semakHakmilik(p)) {
...
//                        }
                        ...
                        if (p.getSenaraiRujukanLuar().isEmpty()) {
                            if (p.getKodUrusan().getKod().equalsIgnoreCase("IRTBB")) {
                                return Boolean.TRUE;
                            } else {
                                ctx.addMessage("Sila Kemaskini Maklumat Nota");
                            }
                            return false;
                            //Untuk urusan pembatalan
                        } else if (p.getKodUrusan().getKod().equalsIgnoreCase("IGSAB")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("IKOAB")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("KBB")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("IRTBB")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("ADBSL")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("KBB")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("KRMB")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("LMTPB")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("PSPBB")
                                || p.getKodUrusan().getKod().equalsIgnoreCase("SHKB")     
                                || p.getKodUrusan().getKod().equalsIgnoreCase("SHSB")            
                                || p.getKodUrusan().getKod().equalsIgnoreCase("TTB")                
                                || p.getKodUrusan().getKod().equalsIgnoreCase("TTWB")
                                ) {
                            if (p.getSenaraiPermohonanAtasPerserahan().isEmpty()) {
                                ctx.addMessage("Perserahan Terlibat Tidak Dipilih");
                                return false;
                            }
                        } else {
                            ...
                            for (PermohonanRujukanLuar prl : p.getSenaraiRujukanLuar()) {
                                if (StringUtils.isBlank(prl.getNoFail())) {
                                    if (p.getKodUrusan().getKod().equalsIgnoreCase("AEROD") || p.getKodUrusan().getKod().equalsIgnoreCase("IRTBB")
                                            || p.getKodUrusan().getKod().equalsIgnoreCase("IRTB")
                                            || p.getKodUrusan().getKod().equalsIgnoreCase("PMDPT")
                                            || p.getKodUrusan().getKod().equalsIgnoreCase("PPM")                         
                                            ) {
                                        return Boolean.TRUE;
                                    } else {
