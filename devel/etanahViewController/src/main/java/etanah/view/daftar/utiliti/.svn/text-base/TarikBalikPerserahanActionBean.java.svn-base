 ...
 * @author ei
 */
@UrlBinding("/utiliti/tarikBalikPerserahan")
public class TarikBalikPerserahanActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(TarikBalikPerserahanActionBean.class);
    private static boolean isDebug = LOG.isDebugEnabled();

    @DefaultHandler
    public Resolution showForm() {
        return new JSP("daftar/utiliti/tarik_balik_perserahan.jsp");
    }
                        ...
                        for (Task t : l) {
                            ...
                            if (perserahan != null) {
                                ...
                                if ((stage.equalsIgnoreCase("keputusan")) || ("SS".equals(status))) {
                                    ...
                                    return new ForwardResolution("/WEB-INF/jsp/daftar/utiliti/tarik_balik_perserahan.jsp");
                                }
                                if ("W".equals(status)){
