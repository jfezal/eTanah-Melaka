...
//                }
                 listluas = new String[sum];
                 listluas[0] = permohonan.getSenaraiHakmilik().get(0).getLuasTerlibat().toString();
                 LOG.info(listluas[0]);
          hmb.setBandarPekanMukim(hm.getBandarPekanMukim()); //HARDCODED
