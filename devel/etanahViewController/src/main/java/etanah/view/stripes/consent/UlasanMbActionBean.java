 ...
 */
@UrlBinding("/consent/ulasan_mb")
public class UlasanMbActionBean extends AbleActionBean {
    ...
    public Resolution showPtCon() {
        ...
        return new JSP("consent/ulasan_mb.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (permohonan.getPermohonanSebelum() != null) {
            ...
            if (!(permohonan.getSenaraiPihak().isEmpty()) && !(permohonan.getSenaraiPemohon().isEmpty()) && !(permohonan.getSenaraiHakmilik().isEmpty())) {
                ...
                permohonanKertasTemp = conService.findMohonKertasByTajuk(idPermohonan, "KERTAS MB");
                ...
                if (permohonanKertasTemp == null) {
                    ...
                    if (permohonan.getKodUrusan().getKod().equals("MCGMB")) {
    ...
    public void simpanFirst() {
        ...
        permohonanKertas.setTajuk("KERTAS MB");
    ...
    public Resolution simpanPtCon() {
        ...
        getContext().getRequest().setAttribute("tajuk", Boolean.TRUE);
        getContext().getRequest().setAttribute("ptd", Boolean.TRUE);
        return new ForwardResolution("/WEB-INF/jsp/consent/ulasan_mb.jsp").addParameter("tab", "true");
    }
