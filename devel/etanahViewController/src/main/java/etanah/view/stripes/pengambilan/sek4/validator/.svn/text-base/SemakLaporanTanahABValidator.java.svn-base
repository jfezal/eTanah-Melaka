 ...
 * @author mohd.faidzal
 */
public class SemakLaporanTanahABValidator implements StageListener {
    ...
    public void onGenerateReports(StageContext context) {
        ...
        String namaReport[] = new String[4];
        String kodReport[] = new String[4];
        namaReport[0] = "ACQLT_PTG_MLK.rdf";
        namaReport[1] = "ACQLTAPT_PTG_MLK.rdf";
        namaReport[2] = "ACQDocA_MLK.rdf";
        namaReport[3] = "ACQDocB_MLK.rdf";
        ...
        if (hakmilikPermohonan.size() > 1) {
            namaReport = new String[3];
            kodReport = new String[3];
            namaReport[0] = "ACQLTAPT_PTG_MLK.rdf";
            kodReport[0] = "LTPG";
            namaReport[1] = "ACQDocA_MLK.rdf";
            kodReport[1] = "A";
            namaReport[2] = "ACQDocB_MLK.rdf";
            kodReport[2] = "B";
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        sek4IntegrationFlowService.completeTask(ref.REKOD_KPSN_MMK, context.getPermohonan(), context.getPengguna());
