 ...
 * @author w.fairul
 */
@UrlBinding("/pelupusan/jabatan_teknikalpbmt")
public class JabatanTeknikal2PBMTActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(JabatanTeknikal2PBMTActionBean.class);
    ...
    public Resolution showSyorSDP() {
       ...
       permohonanLaporPelan = pelupusanService.findByIdPermohonanPelan(idPermohonan);
        return new JSP("pelupusan/syor_SDP_pbmt.jsp").addParameter("tab", "true");
    }
...
//             }
   ...
   Date  baseDate = new Date();
    ...
    public Resolution deleteDok() {
        ...
        rehydrate();
        return new RedirectResolution(JabatanTeknikal2PBMTActionBean.class, "addDokumen");
    }
...
//            pelupusanService.simpanPermohonanDokTT(tandatanganDokumen);
        ...
        return new RedirectResolution(JabatanTeknikal2PBMTActionBean.class, "showForm");
    }
