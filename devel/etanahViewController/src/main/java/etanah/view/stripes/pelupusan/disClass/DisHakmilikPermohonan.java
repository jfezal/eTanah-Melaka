...
public class DisHakmilikPermohonan {
    ...
    private String kedalamanTanahUOM;
    ...
    public HakmilikPermohonan copyPropertiesHakmilikToMH(Permohonan mohon, HakmilikPermohonan mohonHakmilikNew, Hakmilik hakmilik, String[] data, DisLaporanTanahService disLaporanTanahService) {
        ...
        if (data.length > 0) {
            ...
            mohonHakmilikNew.setLuasTerlibat(!StringUtils.isEmpty(data[12]) ? new BigDecimal(df.format(Float.valueOf(data[12]))) : new BigDecimal(0));
            ...
            if (mohon.getKodUrusan().getKod().equals("MMMCL")) {
                if (hakmilik.getCukaiSebenar() != null) {
                    Double convert = 0.00;
    ...
    public Hakmilik copyPropertiesMohonHMToHakmilik(Permohonan mohon, HakmilikPermohonan mohonHakmilik, Hakmilik hakmilikNew, String[] data, DisLaporanTanahService disLaporanTanahService) {
        ...
        if (data.length > 0) {
            ...
            NumberFormat df = new DecimalFormat("#.####");
            hakmilikNew.setLuas(!StringUtils.isEmpty(data[12]) ? new BigDecimal(df.format(Float.valueOf(data[12]))) : new BigDecimal(0));
    ...
    public String getKedalamanTanahUOM() {
        return kedalamanTanahUOM;
    }

    public void setKedalamanTanahUOM(String kedalamanTanahUOM) {
