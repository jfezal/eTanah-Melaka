...
@UrlBinding("/pengambilan/KebenaranMemasukiTanah")
public class SediaSuratMemasukiTanahActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(SediaSuratMemasukiTanahActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/sediaSuratMemasukiTanah.jsp").addParameter("tab", "true");
    }
}
