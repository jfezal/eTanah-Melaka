 ...
 * @author Afham
 */
@UrlBinding("/pelupusan/rekod_keputusanJKBB")
public class RekodKeputusanJKBBActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(RekodKeputusanJKBBActionBean.class);
    ...
    public Resolution viewOnlyRekodKeputusanPT() {
        ...
        return new JSP(DisPermohonanPage.getJK_MAIN_PAGE()).addParameter("tab", "true");
    }
...
//                senaraiHakmilikPermohonan = permohonan.getPermohonanSebelum().getSenaraiHakmilik();
    ...
    public String refreshData(String type) {
        ...
        switch (typeNum) {
            case 1:
                forwardJSP = DisPermohonanPage.getJK_MM_PAGE();
            ...
            case 3:
                ...
                forwardJSP = DisPermohonanPage.getJK_MAIN_PAGE();
                break;
        }
        return forwardJSP;
    }
    ...
    public String getSyaratLulus() {
        ...
        switch (typeNum) {
            case 1: // Urusan = BMBT
                forwardJSP = DisPermohonanPage.getJK_SYRT_BMBT();
                break;
            case 2: // Urusan = PJBTR
                forwardJSP = DisPermohonanPage.getJK_SYRT_PJBTR();
                break;
        }
        return forwardJSP;
    }
...
//                }
        ...
        return new JSP(DisPermohonanPage.getJK_MAIN_PAGE()).addParameter("tab", Boolean.TRUE);
    }
...
//        rehydrate();
        ...
        return new JSP(DisPermohonanPage.getJK_MM_PAGE()).addParameter("tab", "true");
    }
