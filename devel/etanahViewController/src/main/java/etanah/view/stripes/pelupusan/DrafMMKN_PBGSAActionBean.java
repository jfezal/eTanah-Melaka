 ...
 * 
 */
@UrlBinding("/pelupusan/draf_mmkn_mlk_PBGSA")
public class DrafMMKN_PBGSAActionBean extends AbleActionBean {

    Logger LOG = Logger.getLogger(DrafMMKN_PBGSAActionBean.class);
    @Inject
...
//    RegService regService;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/gsa/draf_mmkn_mlk_PBGSA.jsp").addParameter("tab", "true");
    }
...
//        String currentStageId = "19SmkDrafPertmbgnMMKN";
...
//                }
     ...
     //   String kws = "";
        ...
        if (permohonan.getKodUrusan().getKod().equals("PBGSA")) {
            ursan1 = " PERMOHONAN PEMBERIMILIKAN TANAH BERKELOMPOK GSA DI BAWAH AKTA TANAH (KAWASAN-KAWASAN PENEMPATAN BERKELOMPOK) 1960.";
        }
        if (pemohon != null) {
        ...
        if (hakmilikPermohonan != null) {
         ...
         tajuk1 = "PERMOHONAN UNTUK PEMBERIMILIKAN TANAH " +tajukLot+" "+noLot+ "  " + " SELUAS LEBIH KURANG " + luas + " " + kodUnitLuas + 
                  " " + "DI " + lokasi + ", " + bpm + ", DAERAH " + daerah+
                  " " + "DI KAWASAN PENEMPATAN BERKELOMPOK DI BAWAH SEKSYEN 44 AKTA TANAH (KAWASAN-KAWASAN PENEMPATAN BERKELOMPOK) 1960  " + ".";
         if(!lokasi.isEmpty()){
             lokasi = pelupusanUtiliti.convertStringtoInitCap(lokasi);
         }
         tujuan = "\n" + "Tujuan kertas ini ialah untuk mendapatkan pertimbangan Majlis Mesyuarat Kerajaan Negeri Melaka mengenai permohonan untuk pemberimilikan tanah "+tajukLot+" "+noLot
...
//                            mohonRujuk.setUlasan(ulasanAgensi);
    ...
    public Resolution simpanNew() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/gsa/draf_mmkn_mlk_PBGSA.jsp").addParameter("tab", "true");
    }
...
//                break;
    ...
    public void updateKandungan(int i, String kand) {
        ...
        permohonanKertas.setInfoAudit(infoAudit);
        permohonanKertas.setPermohonan(permohonan);
        permohonanKertas.setTajuk(tajuk1);
