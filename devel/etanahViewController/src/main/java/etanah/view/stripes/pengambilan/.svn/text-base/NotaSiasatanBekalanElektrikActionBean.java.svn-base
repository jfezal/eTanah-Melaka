 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/nota_siasatan_bekalan_elektrik")
public class NotaSiasatanBekalanElektrikActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/negerisembilan/izinlaluaktabekalanletrik/nota_siasatan_bekalan_electrik.jsp").addParameter("tab", "true");
    }
...
//        hakmilikPerbicaraanTemp.setNoRujukan(hakmilikPerbicaraan.getNoRujukan());
        ...
        if(hakmilikPerbicaraan.getIdPerbicaraan() > 0) {
            ...
            for(int i=0; i<hpList.size(); i++) {
                ...
                System.out.println("----permohonanPihak-----"+permohonanPihak.getIdPermohonanPihak());
                ...
                perbicaraanKehadiran.setPenilaiUlasan(getContext().getRequest().getParameter("penilaiUlasan"));
