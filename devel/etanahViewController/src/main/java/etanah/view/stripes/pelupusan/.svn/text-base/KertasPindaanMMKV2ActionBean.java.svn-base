 ...
 * @author afham
 */
@UrlBinding("/pelupusan/kertas_pindaan_MMKV2")
public class KertasPindaanMMKV2ActionBean extends AbleActionBean {
...
//    private List<PermohonanKertasKandungan> senaraiKandunganTajuk;  //Bil - 0
    ...
    private List<PermohonanKertasKandungan> senaraiKandunganPerihalTanah; //Bil - 2
    private List<PermohonanKertasKandungan> senaraiKandunganHuraianPtd; // Bil - 3
    private List<PermohonanKertasKandungan> senaraiKandunganSyorPtd; // Bil - 7
    private List<PermohonanKertasKandungan> senaraiKandunganPerakuanPtg; // Bil -5
    private List<PermohonanKertasKandungan> senaraiKandunganHuraianPtg; // Bil - 4
    private List<PermohonanKertasKandungan> senaraiKandunganKeputusan; // Bil - 6
    ...
    private static final Logger LOG = Logger.getLogger(KertasPindaanMMKV2ActionBean.class);
    //For syarat tambahan
    ...
    public Resolution editOnlyKertasMMKPT() {
        ...
        return new JSP(DisPermohonanPage.getKPMMK_MAIN_PAGE()).addParameter("tab", "true");
    ...
    public void setObjectPermohonanKertas(Permohonan permohonan, String kodDok) {
        ...
        permohonanKertas.setTajuk("Draf Pindaan MMK");
    ...
    public String setDefaultKandunganTajukKertas(Permohonan p, String caw, HakmilikPermohonan hp, Pemohon pmhn, String kodNegeri) {
        ...
        kandunganTajuk = "PERMOHONAN UNTUK MEMINDA KELUASAN TANAH DARIPADA ";
    ...
    public String setDefaultKandunganTujuanKertas(Permohonan p, String caw, HakmilikPermohonan hp, Pemohon pmhn, String kodNegeri) {
        ...
        String daerah = p.getCawangan() != null ? p.getCawangan().getDaerah().getNama() : null;
        String tujuan = p.getSebab() != null ? p.getSebab() : null;
        kandunganTujuan = "Tujuan kertas ini adalah untuk mendapatkan pertimbangan Majlis Mesyuarat bagi permohonan daripada Pentadbir Tanah ";
        ...
        switch (typeNum) {
            case 12: //Urusan PBMT
                ...
                if (kodKatTanah != null && kodGunaTanah != null) {
                    kandunganTujuan += " untuk ";
                    kandunganTujuan += kodKatTanah;
                    kandunganTujuan += " (";
                    kandunganTujuan += kodGunaTanah;
                    kandunganTujuan += ").";
                }
...
//                senaraiHakmilikPermohonan = disLaporanTanahService.getPlpservice().getHakmilikPermohonanListByCatatanNIdMohon(new String(), idPermohonan);
            ...
            if (!senaraiLaporanTanah.isEmpty()) {
                ...
                if (senaraiLaporanTanah.size() == 1) {
                    ...
                    if (hakmilikPermohonan != null) {
                        kandunganPerihalTanah1 = setDefaultKandunganPerihalTanah(hakmilikPermohonan, laporanTanah, 3);
                    }
            ...
            if (StringUtils.isNotBlank(kodDok)) {
                ...
                if (permohonanKertas != null) {
                    ...
                    senaraiKandunganPerihalTanah = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 2);
                    senaraiKandunganHuraianPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 3);
                    senaraiKandunganHuraianPtg = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 4);
                    senaraiKandunganPerakuanPtg = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 5);
                    senaraiKandunganKeputusan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 6);
                    senaraiKandunganSyorPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 7);
...
//        permohonanKertas = new PermohonanKertas();
        ...
        int typeNum = type.equals("kTajuk") ? 0
                ...
                : type.equals("kTanah") ? 2
                : type.equals("kHuraianPtd") ? 3
                : type.equals("kHuraianPtg") ? 4
                : type.equals("kPerakuanPtg") ? 5
                : type.equals("kKeputusan") ? 6
                : type.equals("main") ? 7
                : type.equals("tBorang") ? 8
                : type.equals("kSyorPtd") ? 9
                : 10;
        ...
        switch (typeNum) {
            case 0:
                ...
                forwardJSP = DisPermohonanPage.getKPMMK_TAJUK();
                break;
            case 1:
                senaraiKandunganTujuan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 1);
                forwardJSP = DisPermohonanPage.getKPMMK_TUJUAN();
                break;
            case 2:
                senaraiKandunganPerihalTanah = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 2);
                forwardJSP = DisPermohonanPage.getKPMMK_LATAR_BELAKANG();
                break;
            case 3:
                senaraiKandunganHuraianPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 3);
                forwardJSP = DisPermohonanPage.getKPMMK_HURAIAN_PTD();
                break;
            case 4:
                senaraiKandunganHuraianPtg = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 4);
                forwardJSP = DisPermohonanPage.getKPMMK_HURAIAN_PTG();
                break;
            case 5:
                senaraiKandunganPerakuanPtg = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 5);
                forwardJSP = DisPermohonanPage.getKPMMK_SYOR_PTG();
                break;
            case 6:
                senaraiKandunganKeputusan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 6);
                forwardJSP = DisPermohonanPage.getKPMMK_KEPUTUSAN();
                break;
            ...
            case 7:
                ...
                forwardJSP = DisPermohonanPage.getKPMMK_MAIN_PAGE();
                break;
            case 8:
                listPermohonanTuntutanKos = new ArrayList<PermohonanTuntutanKos>();
                List<PermohonanTuntutanKos> listMohonTT = new ArrayList<PermohonanTuntutanKos>();
                ...
                forwardJSP = DisPermohonanPage.getKPMMK_SYRT_TMBHN();
                break;
             case 9:
                senaraiKandunganSyorPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 7);
                forwardJSP = DisPermohonanPage.getKPMMK_SYOR_PTD();
                break;   
        }
        return forwardJSP;
    }
...
//        LOG.info("CHECKING:..... index :" + index + " kand :" + kand);
        ...
        switch (index) {
            ...
            case 2:
                forwardJSP = DisPermohonanPage.getKPMMK_LATAR_BELAKANG();
                updateKandungan(kand, "kTanah", permohonanKertas, 2);
                break;
            case 3:
                forwardJSP = DisPermohonanPage.getKPMMK_HURAIAN_PTD();
                updateKandungan(kand, "kHuraianPtd", permohonanKertas, 3);
                break;
            case 4:
                forwardJSP = DisPermohonanPage.getKPMMK_HURAIAN_PTG();
                updateKandungan(kand, "kHuraianPtg", permohonanKertas, 4);
                break;
            case 5:
                forwardJSP = DisPermohonanPage.getKPMMK_SYOR_PTG();
                updateKandungan(kand, "kPerakuanPtg", permohonanKertas, 5);
                break;
            case 6:
                forwardJSP = DisPermohonanPage.getKPMMK_KEPUTUSAN();
                updateKandungan(kand, "kKeputusan", permohonanKertas, 6);
                break;
            case 7:
                forwardJSP = DisPermohonanPage.getKPMMK_KEPUTUSAN();
                updateKandungan(kand, "kSyorPtd", permohonanKertas, 7);
                break ;
...
//                rehydrate();
            ...
            case 6:
             ...
             case 7:
                ...
                disLaporanTanahService.getPelupusanService().simpanPermohonanKertasKandungan(permohonanKertasKandungan);
                rehydrate();
                forwardJSP = refreshData("kSyorPtd");
                break;   
            default:
                break;
        }
    ...
    public Resolution showFormPopUp() {
        ...
        return new JSP(DisPermohonanPage.getKPMMK_SYRT_TMBHN_ADD()).addParameter("popup", "true");
    }
    ...
    public Resolution showFormKemaskiniNilai() {
        ...
        return new JSP(DisPermohonanPage.getKPMMK_SYRT_TMBHN_EDIT()).addParameter("popup", "true");
    }
    ...
    public Resolution kemaskiniAmaun() {
        ...
        rehydrate();
        return new JSP(DisPermohonanPage.getKPMMK_SYRT_TMBHN()).addParameter("popup", "true");
    }
    ...
    public List<PermohonanKertasKandungan> getSenaraiKandunganSyorPtd() {
        return senaraiKandunganSyorPtd;
    }

    public void setSenaraiKandunganSyorPtd(List<PermohonanKertasKandungan> senaraiKandunganSyorPtd) {
        this.senaraiKandunganSyorPtd = senaraiKandunganSyorPtd;
    }
