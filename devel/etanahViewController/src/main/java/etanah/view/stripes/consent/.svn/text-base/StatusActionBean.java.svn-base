...
import etanah.view.stripes.StageActionBean;
...
public class StatusActionBean extends AbleActionBean {
    ...
    public void rehydrate() {
        ...
        permohonan2 = permohonanDAO.findById(idPermohonan);
...
//            }
//        }
        return new ForwardResolution("/WEB-INF/jsp/consent/keputusan.jsp").addParameter("tab", "true");
    }
...
//            permohonan.setUlasan(fasaPermohonan.getUlasan());
        if (permohonan2 != null) {
            permohonan.setUlasan(permohonan2.getUlasan());
        }
