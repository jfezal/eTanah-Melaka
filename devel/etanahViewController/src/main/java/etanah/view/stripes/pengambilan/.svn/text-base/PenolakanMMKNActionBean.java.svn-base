...
@UrlBinding("/pengambilan/Penolakan")
public class PenolakanMMKNActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(PenolakanMMKNActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/melaka/pendudukansementara/penolakanMMKN.jsp").addParameter("tab", "true");
    }
}
