 ...
 */
@UrlBinding("/pelupusan/draf_mmkn_pjbtr")
public class DrafMMKN_PJBTRActionBean extends AbleActionBean {
    ...
    Logger logger = Logger.getLogger(DrafMMKN_PJBTRActionBean.class);
    @Inject
    BPelService service;
    @Inject
...
//    private PermohonanKertas permohonankertas;
    ...
    public Resolution showForm1() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/pjbtr/draf_mmkn_pjbtr_mlk.jsp").addParameter("tab", "true");
    }
//    @DefaultHandler
...
//        stageId = "semak_syor_draf_MMKN_PTG";
...
//                //PTD
//                if (stageId.equals("masuk_keputusan_mesyuarat") || stageId.equals("sedia_draf_JKBB") || stageId.equals("semak_draf_JKBB_PTD") || stageId.equals("perakuan_draf_JKBB_PTD")) {
//                    if (stageId.equals("sedia_draf_JKBB")) {
//                        viewOnlyPTD = false;
//                        openPTD = true;
//                    }
//                    if (stageId.equals("semak_draf_JKBB_PTD")) {
//                        viewOnlyPTD = false;
//                        openPTD = true;
//                    } else if (stageId.equals("perakuan_draf_JKBB_PTD")) {
//                        openPTD = true;
//                        viewOnlyPTD = true;
...
//                }
//                //PTG
                if (stageId.equals("sedia_draf_MMKN_PTG") || stageId.equals("semak_draf_MMKN_PTG") || stageId.equals("semak_draf_MMKN_PTG2") || stageId.equals("semak_syor_draf_MMKN_PTG") || stageId.equals("pindaan_draf_MMKN_PTG") || stageId.equals("peraku_draf_MMKN_PTG")) {
                    if (stageId.equals("sedia_draf_MMKN_PTG") || stageId.equals("pindaan_draf_MMKN_PTG")) {
                        viewOnlyPTG = true;
                        openPTG = true;
...
////                    viewOnlyPTD = true;
            ...
            if (permohonan.getKodUrusan().getKod().equals("PJBTR")) {
                tujuanUrusanPriz = "Permohonan Pajakan Stratum Tanah Bawah Tanah dibawah Tanah Rizab Sub-Seksyen 92f(1)a & 92f(1)b";
...
//            }
            ...
            tajukTujuanDraf = " Tujuan rencana ini adalah untuk mendapatkan Permohonan Pajakan Stratum Tanah Bawah Tanah Dibawah Tanah " + sbb + "  seluas " + luas + " " + koduom
                    + lotntajuk + bpm + ", Daerah " + daerah + " di bawah Sub-Seksyen 92f(1)a & 92f(1)b Kanun Tanah Negara";
...
//            }
            ...
            tajukMainDraf = " PERMOHONAN DARIPADA  " + pihakName + " UNTUK MEMAJAK TANAH BAWAH TANAH DIBAWAH TANAH RIZAB " + lotntajuk.toUpperCase() + "SELUAS " + luas + " " + koduom1 + ", " + bpm + ", DAERAH " + daerah + " BAGI TUJUAN " + tujuanTajukPriz + " DI BAWAH SUB SEKSYEN 92f(1)a & 92f(1)b KANUN TANAH NEGARA.";
...
//                    + ",daerah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " untuk tujuan " + permohonan.getSebab() + " diluluskan seperti pelan yang dilampirkan.";
            if (kpsn != null) {
                if (kpsn.equals("SL")) {
                    perakuPTD = "Pentadbir Tanah Daerah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " dengan ini memperakukan supaya permohonan daripada "
                            + pelUtiliti.convertStringtoInitCap(pemohon.getPihak().getNama()) + " untuk mendapatkan permohonan pajakan  stratum tanah bawah tanah di bawah tanah rizab" + lotntajuk + pelUtiliti.convertStringtoInitCap(hakmilikPermohonan.getHakmilik().getBandarPekanMukim().getNama())
...
//        }
    ...
    public void settingDefaultValue() {
        ...
        perihaltanah1 = " Permohonan Pajakan Stratum Tanah  ";
        ...
        perakuan = " Pentadbir Tanah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " telah meneliti permohonan ini memperakukan supaya permohonan untuk mendapatkan pajakan Stratum ";
        perakuan2 = " Pajakan Stratum tanah";
//        perakuan3 = " sebanyak ";
//        perakuan4 = " meter padu daripada ";
        perakuan5 = " di bawah tanah ";
        perakuan6 = " Mukim ";
