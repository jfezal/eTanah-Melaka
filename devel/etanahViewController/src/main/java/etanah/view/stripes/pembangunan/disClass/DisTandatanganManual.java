...
//                            kodDok = keputusan.equals("L")?"SL":keputusan.equals("T")?"STP":new String(); 
    ...
    public String getKodDokByCaseRAYK(String stageId, int numnegeri, String kodCaw, Permohonan permohonan) {
        ...
        switch (numnegeri) {
            ...
            case 2:
                //NEGERI SEMBILAN
                if (stageId.equalsIgnoreCase("05TerimaKeputusanL")) {
                    kodDok = "SL";
                } else if (stageId.equalsIgnoreCase("07TerimaKeputusanT")) {
                    kodDok = "STT";
                } else if (stageId.equalsIgnoreCase("16SediaSuratLulus")) {
                    kodDok = "SL";
                } else if (stageId.equalsIgnoreCase("20SediaSuratTolak")) {
                    kodDok = "STT";
                }
                break;
        }
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                if (stageId.equalsIgnoreCase("05TerimaKeputusanL")) {
                    ...
                    kodDok = "STT";
                } else if (stageId.equalsIgnoreCase("01KemasukanKertasRingkas")) {
                    kodDok = "KRPTD";
                }
                break;
        }
    ...
    public String getKodDokByCasePTMTA(String stageId, int numnegeri, String kodCaw, Permohonan permohonan) {
        ...
        switch (numnegeri) {
            ...
            case 2:
                //NEGERI SEMBILAN
                if (stageId.equalsIgnoreCase("04SediaNotisBicara")) {
                    kodDok = "NB";
                } else if (stageId.equalsIgnoreCase("08SediaNotisBicara")) {
                    kodDok = "NB";
                } else if (stageId.equalsIgnoreCase("11TerimaBayaranPerintah")) {
                    kodDok = "SPR";
                } else if (stageId.equalsIgnoreCase("12SediaPerintahTolak")) {
                    kodDok = "SPR";
                }
                break;
        }
