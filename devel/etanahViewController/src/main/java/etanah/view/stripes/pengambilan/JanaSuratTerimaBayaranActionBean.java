...
@UrlBinding("/pengambilan/suratTerimaBayaran")
public class JanaSuratTerimaBayaranActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(JanaSuratTerimaBayaranActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/negerisembilan/haklalulalangpersendirian/janaSuratTerimaBayaran.jsp").addParameter("tab", "true");
    }
}
