 ...
 * @author john
 */
@UrlBinding("/pembangunan/melaka/terima_pelan_precomp")
public class PenerimaanDokumenPrecompActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        return new JSP("pembangunan/common/pengesahan_terima_precomp.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution selesaiTugasan() {
        ...
        if (stageId.equals("terima_pelan_b2")) {
...
//            sBMSIntegrationFlowService.insertTugasanTable(permohonanDAO.findById("0401DEV2017000171"), "JKBB", peng.getIdPengguna());
        ...
        addSimpleMessage("Tugasan Telah Berjaya Dihantar ke Peringkat Seterusnya.");
