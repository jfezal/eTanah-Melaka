 ...
 * @author nurashidah
 */
@UrlBinding("/pengambilan/ulasanKpptPt")
public class ulasanKpptPtEtapp extends AbleActionBean {

    private static Logger logger = Logger.getLogger(ulasanKpptPtEtapp.class);
    @Inject
    ...
    public Resolution showForm() {
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/ulasan_Kppt_Pt.jsp").addParameter("tab", "true");
    }
