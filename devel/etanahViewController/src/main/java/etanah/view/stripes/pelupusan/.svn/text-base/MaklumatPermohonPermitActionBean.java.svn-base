...
@UrlBinding("/pelupusan/maklumat_pemohon_permit")
public class MaklumatPermohonPermitActionBean extends AbleActionBean {

   private static Logger logger = Logger.getLogger(MaklumatPermohonPermitActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/maklumat_pemohon_permit.jsp").addParameter("tab", "true");
    }

    public Resolution showTambahPemohon() {
        return new JSP("pelupusan/tambah_pemohon_permit.jsp").addParameter("popup", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (p != null) {
            ...
            if (!(pemohonList.isEmpty())) {
                hakmilikList.clear();
                Pemohon pemohon = pemohonList.get(0) ;
...
//            pihakTemp.setSuku(pihak.getSuku());
        ...
        if (pmohon != null) {
            ...
            //return new RedirectResolution("/pelupusan/maklumat_pemohon_permit?showForm").addParameter("tab", "true");
        }
     ...
     public Resolution updatePihak() {
        ...
        try {
            ...
            pemohon.setPekerjaan(pekerjaan);
            pemohon.setPendapatan(gaji);
            pemohon.setTanggungan(tanggungan);

            strService.updatePihak(pihak);
            pelupusanService.updatePemohon(pemohon);
...
//            p.setInfoAudit(infoAudit);
    ...
    public Resolution simpanCawanganPemohon() {
        ...
        if (cariFlag) {
            return new RedirectResolution("/pelupusan/maklumat_pemohon_permit?getTambahCawanganPemohon&idPihak=" + id).addParameter("popup", "true");
        }
    ...
    public Resolution showEditPemohon() {
        ...
        pemohon = pemohonService.findPemohonByPermohonanPihak(p, pihak);
         if(pemohon.getPekerjaan() != null){
                pekerjaan = pemohon.getPekerjaan() ;
            }
        ...
        return new JSP("pelupusan/edit_pemohon_permit2.jsp").addParameter("popup", "true");
    }
