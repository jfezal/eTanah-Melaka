 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/statusAmanah")
public class StatusAwardActionBeanAmanah extends AbleActionBean {
...
//    private List<PerbicaraanKehadiran> hakmilikPerbicaraanList;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/StatusAward_1_1.jsp").addParameter("tab", "true");
    }
...
//        permohonanPihak = permohonanPihakService.getSenaraiMohonPihakByIdPihakIdHakmilik(idPihak, idHakmilik, idPermohonan);
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (permohonan != null)
            hakmilikPermohonanList = notisService.getMHAmanah(permohonan.getPermohonanSebelum().getIdPermohonan());
        }
    }
