...
@UrlBinding("/pelupusan/RingkasanMMKN")
public class RisalatMMKNActionBean extends AbleActionBean {
    ...
    @Inject
    PermohonanRujukanLuarService permohonanRujukanLuarServ;
...
//    private List<PermohonanRujukanLuar> listMohonRujLuar;
    private List<PermohonanRujukanLuar> listMohonRujLuar = new ArrayList<PermohonanRujukanLuar>();
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/risalatMMKN.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (mohonKertas != null) {
            pkk = disService.findByBilNIdKertas(0, mohonKertas.getIdKertas());
...
//            }
        ...
        listMohonRujLuar = permohonanRujukanLuarServ.findByidPermohonanList(permohonan.getIdPermohonan());
        if (listMohonRujLuar.size() > 0) {
            for (PermohonanRujukanLuar mrl : listMohonRujLuar) {
                if (mrl.getAgensi().getKategoriAgensi().getKod().equals("ADN")) {
                    ulasanAdun = mrl.getUlasan();
                }
            }
        }
...
//        LOG.info("------Pemohon Nama------:"+nama);
        if (!(permohonan.getKodUrusan().getKod().equals("PBMT")) && !(permohonan.getKodUrusan().getKod().equals("PPTR")) && !(permohonan.getKodUrusan().getKod().equals("PBGSA")) && !(permohonan.getKodUrusan().getKod().equals("LPSP")) && !(permohonan.getKodUrusan().getKod().equals("PLPS")) && !(permohonan.getKodUrusan().getKod().equals("PRIZ"))) {
        ...
        if (!(permohonan.getKodUrusan().getKod().equals("PBGSA")) && !(permohonan.getKodUrusan().getKod().equals("PBMT")) && !(permohonan.getKodUrusan().getKod().equals("PPTR")) && !(permohonan.getKodUrusan().getKod().equals("PLPS")) && !(permohonan.getKodUrusan().getKod().equals("PRIZ"))) {
            for (int w = 0; w < hakmilikPermohonanList.size(); w++) {
                hp = permohonan.getSenaraiHakmilik().get(w);
                hakmilik = hakmilikDAO.findById(hp.getHakmilik().getIdHakmilik());
...
//        }
        ...
        //ulasanPtd
        if (permohonan.getKodUrusan().getKod().equals("PPTR") || permohonan.getKodUrusan().getKod().equals("LPSP") || permohonan.getKodUrusan().getKod().equals("PLPS") || permohonan.getKodUrusan().getKod().equals("PRIZ")) {
            ...
            fp = devService.findFasaPermohonanByIdAliran(idPermohonan, "perakuan_kertas_mmkPTD");
            if (fp.getKeputusan() != null) {
        ...
        if (!permohonan.getKodUrusan().getKod().equalsIgnoreCase("PBSK") && !permohonan.getKodUrusan().getKod().equals("PBGSA") && !permohonan.getKodUrusan().getKod().equals("PBMT") && !permohonan.getKodUrusan().getKod().equals("PRMP") && !permohonan.getKodUrusan().getKod().equals("PPTR") && !permohonan.getKodUrusan().getKod().equals("LPSP") && !permohonan.getKodUrusan().getKod().equals("PPRU") && !permohonan.getKodUrusan().getKod().equals("PLPS") && !permohonan.getKodUrusan().getKod().equals("PRIZ")) {
        ...
        if (kertasK != null) {
            ...
            if (!kertasK.getKandungan().isEmpty()) {
                ...
                for (int j = 0; j < permohonanKertas.getSenaraiKandungan().size(); j++) {
                    ...
                    PermohonanKertasKandungan kertasKandungan = permohonanKertas.getSenaraiKandungan().get(j);
