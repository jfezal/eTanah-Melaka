 ...
 */
@UrlBinding("/pelupusan/draf_mmkn_priz")
public class DrafMMKN_PRIZActionBean extends AbleActionBean {
    ...
    Logger logger = Logger.getLogger(DrafMMKN_PRIZActionBean.class);
    @Inject
    BPelService service;
    @Inject
...
//    private PermohonanKertas permohonankertas;
    ...
    private PermohonanKertas permohonankertas;
    private PermohonanKertasKandungan permohonanKertasKand22;
    ...
    public Resolution showForm1() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/priz/draf_mmkn_PRIZ_mlk.jsp").addParameter("tab", "true");
    }
//    @DefaultHandler
    ...
    public Resolution showFormPTG() {
        ...
        viewOnlyPTD = Boolean.TRUE;
        viewOnlyPTDOnly = Boolean.TRUE;
        viewOnlyPTG = Boolean.TRUE;
        viewOnlyPTGOnly = Boolean.FALSE;
    ...
    public void rehydrate() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PRIZ")) {
            ...
            fasaPermohonan = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "12PenyediaanDrfKrtsMMK");
        }
        ...
        if (idPermohonan != null) {
            ...
            if (urusanStatus.equals("PRIZ")) {
                tajukHeader = "DRAF MMKN";
                //PTD
                if (stageId.equals("sedia_draf_mmkn") || stageId.equals("semak_draf_mmkn1") || stageId.equals("perakuan_ptd_risalat_mmkn")) {
                    if (stageId.equals("sedia_draf_mmkn")) {
                        viewOnlyPTD = false;
                        openPTD = true;
                    }
                    if (stageId.equals("semak_draf_mmkn1")) {
                        viewOnlyPTD = false;
                        openPTD = true;
                    } else if (stageId.equals("perakuan_ptd_risalat_mmkn")) {
                        openPTD = true;
                        viewOnlyPTD = true;
...
//                    viewOnlyPTD = true;
            ...
            if (urusanStatus.equals("PRMMK")) {
                tajukHeader = "DRAF MMK";
                //PTD
                if (stageId.equals("12PenyediaanDrfKrtsMMK") || stageId.equals("13SmkDrfKrtsMMK") || stageId.equals("14SmkDrfKrtsMMK") || stageId.equals("15PerakuKrtsMMK")) {
                    if (stageId.equals("12PenyediaanDrfKrtsMMK") || stageId.equals("13SmkDrfKrtsMMK") || stageId.equals("14SmkDrfKrtsMMK")) {
                        viewOnlyPTD = false;
                        openPTD = true;
                    } else if (stageId.equals("15PerakuKrtsMMK")) {
                        openPTD = true;
                        viewOnlyPTD = true;
                        viewOnlyPTDOnly = false;
                    }
                ...
                //PTG
                if (stageId.equals("16TrmDrfMMK") || stageId.equals("17SmkHuraiandanSyor") || stageId.equals("18SmkHuraiandanSyor") || stageId.equals("19Perakuan") || stageId.equals("20CtkKrtsMMK")) {
                    if (stageId.equals("16TrmDrfMMK") || stageId.equals("17SmkHuraiandanSyor") || stageId.equals("18SmkHuraiandanSyor")) {
                        viewOnlyPTD = true;
                        viewOnlyPTG = true;
                        openPTG = true;
                        viewOnlyPTGOnly = false;
...
//                    viewOnlyPTD = true;
            ...
            if (permohonan.getKodUrusan().getKod().equals("PRIZ") || permohonan.getKodUrusan().getKod().equals("PRMMK")) {
...
//            }
            ...
            tajukTujuanDraf = " Tujuan rencana ini adalah untuk mendapatkan Pertimbangan Majlis Mesyuarat Kerajaan Negeri mengenai permohonan perizaban tanah bagi tujuan " + sbb + "  seluas " + luas + " " + koduom
                    + lotntajuk + bpm + ", Daerah " + daerah + " di bawah Seksyen 62(1) Kanun Tanah Negara";
...
//            }
            ...
            tajukMainDraf = " PERMOHONAN DARIPADA  " + pihakName + " UNTUK MENDAPATKAN PERIZABAN TANAH BAGI TUJUAN " + tujuanTajukPriz + lotntajuk.toUpperCase() + "SELUAS " + luas + " " + koduom1 + ", " + bpm + ", DAERAH " + daerah + " DI BAWAH SEKSYEN 62(1) KANUN TANAH NEGARA.";
...
//                    + ",daerah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " untuk tujuan " + permohonan.getSebab() + " diluluskan seperti pelan yang dilampirkan.";
            if (kpsn != null) {
                if (kpsn.equals("SL")) {
                    perakuPTD = "Pentadbir Tanah Daerah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " dengan ini memperakukan supaya permohonan daripada "
                            + pelUtiliti.convertStringtoInitCap(pemohon.getPihak().getNama()) + " untuk mendapatkan perizaban tanah" + lotntajuk + bpm
...
//            }
            ...
            if (permohonan.getKodUrusan().getKod().equals("PPBB") || permohonan.getKodUrusan().getKod().equals("PRIZ")) {
...
//            }
            ...
            if (fasaPermohonan != null) {
                ...
                if (permohonan.getKodUrusan().getKod().equals("PRIZ")) {
                    ...
                    fasaPermohonan.setIdAliran("12PenyediaanDrfKrtsMMK");
                }
...
//            List<PermohonanKertasKandungan> plk = pelPtService.findByIdLaporSubtajuk(a, 22, subtajuk);
    ...
    public Resolution kemaskini() {
        ...
        if (idKand != null) {
            if (!idKand.equals("0")) {
                ...
                permohonankertas = pelPtService.findKertasByKod(idPermohonan, "RMN");
                ...
                PermohonanKertasKandungan pLK = new PermohonanKertasKandungan();
                logger.info("index :" + index + " kand :" + kand + " id_lapor :" + a);

                if (plk.isEmpty()) {
                    pLK.setSubtajuk("1");
                    logger.info("PLK" + pLK.getSubtajuk());
                } else {
                    logger.info("plk.size()  : " + plk.size());
                    logger.info("sub tajuk : " + plk.get(plk.size() - 1).getSubtajuk());
...
//        }
    ...
    public Resolution showsyortolaklulus() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PRIZ")) {
            ...
            idAliran = "12PenyediaanDrfKrtsMMK";
        }
        ...
        if (mohonFasaSyorTolak != null) {
            ...
            mohonFasaSyorTolak.setInfoAudit(ia);
            mohonFasaSyorTolak.setKeputusan(kodKeputusanDAO.findById(kpsn));
            pelupusanService.simpanFasaPermohonanBaru(mohonFasaSyorTolak);
        }
    ...
    public int getKandungan22() {
        return kandungan22;
    }

    public void setKandungan22(int kandungan22) {
        this.kandungan22 = kandungan22;
    }

    public PermohonanKertasKandungan getPermohonanKertasKand22() {
        return permohonanKertasKand22;
    }

    public void setPermohonanKertasKand22(PermohonanKertasKandungan permohonanKertasKand22) {
        this.permohonanKertasKand22 = permohonanKertasKand22;
    }
}
