...
@UrlBinding("pelupusan/draf_mmk_mpcrg")
public class DrafMMK_MPCRGActionBean extends AbleActionBean{
Logger logger = Logger.getLogger(DrafMMK_MPCRGActionBean.class);
    @Inject
    BPelService service;
    @Inject
...
//    KodItemPermitDAO kodItemPermitDAO;
    ...
    private List<SenaraiKodKadarPremium> listSenaraikkp = new ArrayList<SenaraiKodKadarPremium>();
    ...
    private boolean ptd;
    private boolean ptg;
    private String utaraLot = "TIADA";
    private String utaraGuna = "TIADA";
    private String timurLot = "TIADA";
    private String timurGuna = "TIADA";
    private String baratLot = "TIADA";
    private String baratGuna = "TIADA";
    private String selatanLot = "TIADA";
    private String selatanGuna = "TIADA";

//    private BPelService service;
    @DefaultHandler
    public Resolution showForm() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/mpcrg/draf_mmkn_mlk.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution search() {
        ...
        return new JSP("pelupusan/searchSyaratNyata_mpjlt.jsp").addParameter("popup", "true");
    }

    public Resolution showFormCariKodSekatan() {
        index = getContext().getRequest().getParameter("index");
        return new JSP("pelupusan/searchSekatanKpntngn_mpjlt.jsp").addParameter("popup", "true");
    }
    ...
    public void rehydrate() {
        ...
        senaraikodKadarPremium = pelupusanService.findDistinctKodKadarPremiumNama();
        listSenaraikkp.clear();
        for (String s : senaraikodKadarPremium) {
            SenaraiKodKadarPremium skkp = new SenaraiKodKadarPremium();
            skkp.setNama(s);
            listSenaraikkp.add(skkp);
...
//        stageId = "sedia_draf_mmkn";
        ...
        FasaPermohonan fp = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "04PenydanDraf");
        if (fp != null && fp.getKeputusan() != null) {
            peraku = fp.getKeputusan().getKod();
        }
        ...
        String tujuanursan = " ";
        if (permohonan.getKodUrusan().getKod().equals("MPJLT")) {
            tujuanursan = "pemberimilikan tanah kerajaan";
        }
        if (permohonan.getKodUrusan().getKod().equals("MPCRG")) {
            tujuanursan = "permit mencarigali / penjelajahan";
        }
        //Added by asnida
        String subseksyenupper = " ";
        String subseksyenlower = " ";
        if (permohonan.getKodUrusan().getKod().equals("MPJLT")) {
            subseksyenupper = "DI BAWAH SEKSYEN 76 KANUN TANAH NEGARA";
            subseksyenlower = "Di Bawah Seksyen 76 Kanun Tanah Negara";
        }

        sbb = permohonan.getSebab();
        tujuan = "Tujuan kertas ini adalah untuk mendapatkan pertimbangan dan keputusan Majlis Mesyuarat Kerajaan Negeri mengenai permohonan "
                + tujuanursan + " di atas tanah seluas " + luas + " " + koduom + " di " + bpm + ", Daerah " + daerah + " bagi tujuan"
                + " " + (sbb) + " " + subseksyenlower + ".";
        ...
        String ursan1 = " ";
        if (permohonan.getKodUrusan().getKod().equals("MPCRG")) {
            ursan1 = "memperbaharui lesen carigali / penjelajahan";
        }

        perihalpermohonan = "Pentadbir Tanah " + daerah + " telah menerima satu permohonan daripada " + pihakname + " pada " + mtarikmasuk + " untuk "
                + ursan1 + " di " + hklokasi + ", " + " seluas " + luas + " " + koduom + " di mukim/kawasan " + bpm + ", "
                + " Daerah " + daerah + " untuk tujuan " + sbb + ".";
        ...
        //Added by Aizuddin
        String kecerunan = " ";
        if ((laporanTanah != null) && (laporanTanah.getKecerunanTanah().getNama() != null)) {
            kecerunan = laporanTanah.getKecerunanTanah().getNama().toLowerCase();
        }
        String klafikasi = " ";
        if ((laporanTanah != null) && (laporanTanah.getStrukturTanah().getNama() != null)) {
            klafikasi = laporanTanah.getStrukturTanah().getNama().toLowerCase();
        }
        String keadaan = " ";
        if ((laporanTanah != null) && (laporanTanah.getKodKeadaanTanah().getNama() != null)) {
            keadaan = laporanTanah.getKodKeadaanTanah().getNama().toLowerCase();
        }

        if (laporanTanah != null) {
            laporanTanahSempadanList = pelupusanService.getListLaporanTanahSempadan(idPermohonan);
            for (LaporanTanahSempadan ls : laporanTanahSempadanList) {
                if (ls.getJenisSempadan() != null && ls.getJenisSempadan().equals("U")) {
                    utaraGuna = ls.getGuna();
                    utaraLot = ls.getNoLot();
                }
                if (ls.getJenisSempadan() != null && ls.getJenisSempadan().equals("T")) {
                    timurGuna = ls.getGuna();
                    timurLot = ls.getNoLot();
                }
                if (ls.getJenisSempadan() != null && ls.getJenisSempadan().equals("S")) {
                    selatanGuna = ls.getGuna();
                    selatanLot = ls.getNoLot();
                }
                if (ls.getJenisSempadan() != null && ls.getJenisSempadan().equals("B")) {
                    baratGuna = ls.getGuna();
                    baratLot = ls.getNoLot();
                }
            }
        }
        perihaltanah = "Tanah ini ialah tanah " + kodmilik + " dan terletak di " + hklokasi + " lebih kurang " + jarak + " " + ujarak
                + " dari " + jarakd + ". Keadaan tanah adalah " + kecerunan + ", " + klafikasi + " dan " + keadaan + ".";
        ...
        //Added by Asnida - add condition
        //String perihaltanah1 = " ";
        if (laporanTanah != null) {
            if (laporanTanah.getBolehBerimilik() != null && laporanTanah.getBolehBerimilik().equals("Y")) {
                perihaltanah1 = "Tanah yang dipohon adalah tanah Kerajaan yang boleh diberimilik. ";
            }
            if (laporanTanah.getBolehBerimilik() != null && laporanTanah.getBolehBerimilik().equals("T")) {
                perihaltanah1 = "Tanah yang dipohon adalah tanah Kerajaan yang tidak boleh diberimilik. " + laporanTanah.getSebabTidakBolehBerimilik();
            }
        ...
        String tarikhDaftar = " ";
        if ((pihak != null) && (pihak.getTarikhLahir() != null)) {
            tarikhDaftar = sdf.format(pihak.getTarikhLahir());
        }

        perihalpemohon_s = "Pemohon adalah syarikat " + pihaknama + " yang didaftarkan di Malaysia pada " + tarikhDaftar
                + ", dengan nombor pendaftaran " + nopengalan + "," + '\n' + "Senarai Ahli Lembaga Pengarah adalah seperti berikut : " + '\n';
        if (listPengarah != null) {
            for (PihakPengarah pp : listPengarah) {
                perihalpemohon_s = perihalpemohon_s + '\n' + pp.getNama() + "  " + "(No. K/P : " + pp.getNoPengenalan() + ")";
            }
        }
        ...
        pentabirtanah1 = "Pentadbir Tanah Daerah " + cawangan + " setelah meneliti permohonan tersebut serta setelah mengambil kira ulasan Jabatan-Jabatan Teknikal "
                + " ( dan ulasan YB ADUN Kawasan " + agency + " ) " + " dan telah mengambil asas-asas pertimbangan seperti berikut:- ";
        ...
        if ((permohonan != null) && (permohonan.getSebab() != null)) {
            sbbTajuk = permohonan.getSebab();
        }

        tajuk = "PERMOHONAN DARIPADA " + pihakName + " UNTUK " + ursan + " DI ATAS TANAH SELUAS " + luas + " " + koduom1 + " DI "
                + bpm + ", DAERAH " + daerah + " BAGI TUJUAN " + sbbTajuk + " " + subseksyenupper + ".";
        ...
        String ursan2 = " ";
        if (permohonan.getKodUrusan().getKod().equals("MPCRG")) {
            ursan2 = "memperbaharui permit carigali";
        }
        ...
        if (peraku == "SL") {
            pentabirtanah2 = "Pentadbir Tanah Daerah " + cawangan + " dengan ini memperaku permohonan daripada " + pihakName
                    ...
                    + " di bawah Seksyen 76 Kanun Tanah Negara dan didaftar atas nama pemohon diluluskan dengan syarat-syarat seperti berikut:- ";
        } else {
            if (peraku == "ST") {
                pentabirtanah2 = "Pentadbir Tanah Daerah " + cawangan + " dengan ini memperaku permohonan daripada " + pihakName
                        + " No. KP: " + pnopng + " untuk " + ursan2 + " di PT/Lot " + hpnolot + " , " + " seluas " + luasterlibat + " " + koduom2 + " di Mukim/Kawasan "
                        + bpm + " , " + " Daerah " + cawangan + " seperti ditunjuk dengan garis sempadan berwarna merah dalam pelan berkembar, "
                        + " di bawah Seksyen 76 Kanun Tanah Negara, ditolak";
            }
        }
        String noruj = " ";
        ...
        if ((permohonanRujukanLuar != null) && (permohonanRujukanLuar.getUlasan() != null)) {
            ulasanAdun = permohonanRujukanLuar.getUlasan();
        } else {
            ulasanAdun = "Tiada ulasan diterima";
        }

        if (permohonanRujukanLuar.getAgensi().getKategoriAgensi().getNama() != null) {
            logger.info("permohonanRujukanLuar.getNamaAgensi()" + permohonanRujukanLuar.getNamaAgensi());
            String agensiyb = permohonanRujukanLuar.getNamaAgensi();
            logger.info("noruj: " + noruj);
            ulasanyb = "Pentadbir Tanah Melaka Tengah telah meminta ulasan " + agensiyb + " melalui surat bilangan PTMT: A4/ " + noruj
                    + " bertarikh " + trhruj + " dan ulasan beliau adalah " + ulasanAdun;
        }
        ...
        if (permohonankertas != null) {
            ...
            senaraiLaporanKandunganptg2 = pelupusanService.findByIdLapor(permohonankertas.getIdKertas(), 8);
        ...
        //Added by Aizuddin for Laporan Tanah Sempadan
        ...
        logger.info("listLaporTanahSpdnU.size():" + disLaporanTanahSempadan.getListLaporTanahSpdnU().size());
...
//        hakmilikPermohonan =pelupusanService.findByIdPermohonan(idPermohonan);
        ...
        if (pemohon.getPihak().getJenisPengenalan().getKod().equals("U") || pemohon.getPihak().getJenisPengenalan().getKod().equals("D") || pemohon.getPihak().getJenisPengenalan().getKod().equals("S")) {
            logger.info("Pemohon is syarikat");
...
//            permohonanRujukanLuar.setUlasan(kandungan);
        ...
        //Added by Aizuddin to save keputusan
//        peraku = ctx.getRequest().getParameter("syorKpsn");
        peraku = getContext().getRequest().getParameter("peraku");
        logger.info("%%%%%%% Kod keputusan %%%%%%%%%%%" + peraku);
        if (peraku != null) {
            KodKeputusan kkp = disLaporanTanahService.getKodKeputusanDAO().findById(peraku);
...
//        rehydrate();
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/mpcrg/draf_mmkn_mlk.jsp").addParameter("tab", "true");
    }
...
//            }
    ...
    public List<SenaraiKodKadarPremium> getListSenaraikkp() {
        return listSenaraikkp;
    }

    public void setListSenaraikkp(List<SenaraiKodKadarPremium> listSenaraikkp) {
        this.listSenaraikkp = listSenaraikkp;
    }

    public String getBaratGuna() {
        return baratGuna;
    }

    public void setBaratGuna(String baratGuna) {
        this.baratGuna = baratGuna;
    }

    public String getBaratLot() {
        return baratLot;
    }

    public void setBaratLot(String baratLot) {
        this.baratLot = baratLot;
    }

    public String getSelatanGuna() {
        return selatanGuna;
    }

    public void setSelatanGuna(String selatanGuna) {
        this.selatanGuna = selatanGuna;
    }

    public String getSelatanLot() {
        return selatanLot;
    }

    public void setSelatanLot(String selatanLot) {
        this.selatanLot = selatanLot;
    }

    public String getTimurGuna() {
        return timurGuna;
    }

    public void setTimurGuna(String timurGuna) {
        this.timurGuna = timurGuna;
    }

    public String getTimurLot() {
        return timurLot;
    }

    public void setTimurLot(String timurLot) {
        this.timurLot = timurLot;
    }

    public String getUtaraGuna() {
        return utaraGuna;
    }

    public void setUtaraGuna(String utaraGuna) {
        this.utaraGuna = utaraGuna;
    }

    public String getUtaraLot() {
        return utaraLot;
    }

    public void setUtaraLot(String utaraLot) {
        this.utaraLot = utaraLot;
    }
