...
@UrlBinding("/pengambilan/rekodMaklumatBayaran")
public class RekodMaklumatBayaranPTSPActionBean extends AbleActionBean {
...
//        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
    ...
    public Resolution hakmilikDetails() {
       ...
       // HakmilikPermohonan hp=new HakmilikPermohonan();
        ...
        hakmilikPerbicaraan = pengambilanService1.getHakmilikPerbicaraanByidMH(hakmilikPermohonan.getId());
        permohonanPengambilan = pengambilanService1.getPermohonanPengambilanByidSblm(idSblm);

        if (idSblm != null) {
            Permohonan permohonanSblm= permohonanDAO.findById(idSblm);
            pengambilanService1.simpanPermohonanPihak(permohonanSblm, peng);
            hakmilikPerbicaraan = pengambilanService1.getHakmilikPerbicaraanByidMH(hakmilikPermohonan.getId());
            ...
            for(HakmilikPihakBerkepentingan hp : hakmilikPihakList) {
                ...
                permohonanPihak = pengambilanService1.getPmohonPihakByIdHakmilikIdPihak(idSblm,hakmilik.getIdHakmilik(),idPihak);
                if(hakmilikPerbicaraan != null){
                    perbicaraanKehadiran = pengambilanService1.getPerbicaraanKehadiranbyidMPidBicara(permohonanPihak.getIdPermohonanPihak(), hakmilikPerbicaraan.getIdPerbicaraan());
                    if(perbicaraanKehadiran != null){
                        List<AmbilPampasan> ambilPampasanList1 = pengambilanService1.getAmbilPampasanListByidHadir(perbicaraanKehadiran.getIdKehadiran());
...
//                    }
    ...
    public Resolution simpan() {
        ...
        if(hakmilikPermohonan != null){
            if(pengambilanService1.getHakmilikPerbicaraanByidMH(hakmilikPermohonan.getId()) == null) {
            ...
            if(hakmilikPerbicaraan != null) {
                PermohonanPihak permohonanPihak = pengambilanService1.getPmohonPihakByIdHakmilikIdPihak(idSblm, idHakmilik, idPihak);
                if(pengambilanService1.getPerbicaraanKehadiranbyidMPidBicara(permohonanPihak.getIdPermohonanPihak(), hakmilikPerbicaraan.getIdPerbicaraan()) == null) {
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(RekodMaklumatBayaranPTSPActionBean.class, "locate");
    }
    ...
    public Resolution showAmbilPampasanList() {
        ...
        long idPihak = Long.parseLong(getContext().getRequest().getParameter("idPihak"));
        hakmilikPermohonan = pengambilanService1.findByIdHakmilikIdPermohonan(idSblm, idHakmilik);
        ...
        if(hakmilikPermohonan != null){
            ...
            if(hakmilikPerbicaraan != null) {
                ...
                perbicaraanKehadiran = pengambilanService1.getPerbicaraanKehadiranbyidMPidBicara(permohonanPihak.getIdPermohonanPihak(), hakmilikPerbicaraan.getIdPerbicaraan());
                if(perbicaraanKehadiran != null) {
                    senaraiAmbilPampasan = pengambilanService1.getAmbilPampasanListByidHadir(perbicaraanKehadiran.getIdKehadiran());
                }
            }
        }
