...
@UrlBinding("/lelong/penghantarnotis")
public class UtilitiPenghantarNotisActionBean extends AbleActionBean {
...
//        listPenghantar = penghantarNotisDAO.findAll();
        ...
        return new ForwardResolution("/WEB-INF/jsp/lelong/penghantarNotis_popup.jsp");
    }
...
//        listPenghantar = penghantarNotisDAO.findAll();
    ...
    public Resolution delete() {
        ...
        try {
            ...
            LOG.info("idPenghantarNotis : " + idPenghantarNotis);
            penghantarNotis = penghantarNotisDAO.findById(Integer.parseInt(idPenghantarNotis));
            LOG.info("PenghantarNotis : " + penghantarNotis.getIdPenghantarNotis());
            ...
            e.printStackTrace();
            tx.rollback();
            LOG.debug("results catch : " + results);
    ...
    //added by nur.aqilah
    //edit maklumat penghantar notis
    public Resolution showEdit() {
        String idPenghantarNotis = getContext().getRequest().getParameter("idPenghantarNotis");

        penghantarNotis = penghantarNotisDAO.findById(Integer.parseInt(idPenghantarNotis));

        return new JSP("lelong/penghantar_notis_edit.jsp").addParameter("popup", "true");
    }

    //added by nur.aqilah
    //simpan maklumat penghantar notis 
    public Resolution simpanEdit() {
        ...
        try {
            ...
            if (!penghantarNotis.getKodJenisPengenalan().getKod().equals(penghantarNotisTemp.getKodJenisPengenalan().getKod()) || !penghantarNotis.getNoPengenalan().equals(penghantarNotisTemp.getNoPengenalan())) {
                List<PenghantarNotis> listPenghantarCheck = lelongService.findSenaraiPenghantarNotisByNoKpAndCaw(penghantarNotis.getKodJenisPengenalan().getKod(), penghantarNotis.getNoPengenalan(), pengguna.getKodCawangan().getKod(), "Y");
            ...
            if (!duplicate) {
                ...
                lelongService.saveOrUpdate(penghantarNotisTemp);
            ...
            return new JSP("/lelong/penghantarNotis_popup.jsp");
        }
