 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/laporan_tanah_sebelum")
public class LaporanTanahSebelumActionBean extends AbleActionBean {
    @Inject
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/Laporan_Tanah_Sebelum.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(LaporanTanahSebelumActionBean.class, "locate");
    }
...
//        String idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        ...
        if(mohon.getPermohonanSebelum()!=null){
            idPermohonan = mohon.getPermohonanSebelum().getIdPermohonan();
        }
...
//        String idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        ...
        if(mohon.getPermohonanSebelum()!=null){
            ...
            idPermohonan = mohon.getPermohonanSebelum().getIdPermohonan();
            System.out.println("--------sebelum---------"+idPermohonan);
        }
...
//            }
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/Laporan_Tanah_Sebelum.jsp").addParameter("tab", "true");
    }
