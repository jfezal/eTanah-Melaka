...
@UrlBinding("/pelupusan/draf_warta_priz")
public class DrafWartaPRIZActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/priz/draf_warta_priz.jsp").addParameter("tab", "true");

    }

    public Resolution showForm2() {
        return new JSP("pelupusan/priz/draf_warta_priz_view.jsp").addParameter("tab", "true");
...
//                    trizabPermohonan.setTarikhPengesahanWarta(sdf.parse(tarikhBaru));
                    ...
                    trizabPermohonan.setNoPW(trizabPermohonan.getNoPW());
                    trizabPermohonan.setTarikhPengesahanWarta(tarikhPengesahanWarta);
                    pelupusanService.simpanTanahRizabPermohonan(trizabPermohonan);
    ...
    public void retrieveData() {
        ...
        if (trizabPermohonan != null) {
            ...
            this.setTarikhPengesahanWarta(trizabPermohonan.getTarikhPengesahanWarta());
            if (hakmilikPermohonan.getBandarPekanMukimBaru() != null) {
                ...
                this.setDaerah(hakmilikPermohonan.getHakmilik().getBandarPekanMukim().getDaerah().getNama());
            }
            if (hakmilikPermohonan.getBandarPekanMukimBaru() != null) {
                this.setMukimBandarPekan(hakmilikPermohonan.getBandarPekanMukimBaru().getNama());
            } else {
                this.setMukimBandarPekan(hakmilikPermohonan.getHakmilik().getBandarPekanMukim().getNama());
            }
            this.setNoPelanAkui(trizabPermohonan.getNoPW());
            if (hakmilikPermohonan.getNoLot() != null) {
                this.setNoLot(hakmilikPermohonan.getNoLot());
            } else {
                this.setNoLot(hakmilikPermohonan.getHakmilik().getNoLot());
            }
