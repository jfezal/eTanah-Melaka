...
@UrlBinding("/hasil/ulasan_rayuan_mmk_ns")
public class UlasanRayuanMMKNSActionBean extends AbleActionBean {
    private static final Logger LOG = Logger.getLogger(UlasanRayuanMMKNSActionBean.class);
...
//    String tarikhMesyuarat;
    ...
    public Resolution showForm() {
        ...
        return new JSP("hasil/ulasan_kertas_rayuanmmk_ns.jsp").addParameter("tab", "true");
    }
...
//            pemohon = listPemohon.get(0);
        ...
        return new ForwardResolution("/WEB-INF/jsp/hasil/ulasan_kertas_rayuanmmk_ns.jsp").addParameter("tab", "true");
    }
