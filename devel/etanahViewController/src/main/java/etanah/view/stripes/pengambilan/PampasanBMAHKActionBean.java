 ...
 * @author Rajesh Reddy
 */
@UrlBinding("/pengambilan/pampasanBMAHK")
public class PampasanBMAHKActionBean extends AbleActionBean {

    private static final Logger LOG = Logger.getLogger(PampasanBMAHKActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/pampasanBMAHK.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution hakmilikDetails() {
        ...
        permohonanRujukanLuarList = service.findByIDMohonWartaAll(idSblm);
