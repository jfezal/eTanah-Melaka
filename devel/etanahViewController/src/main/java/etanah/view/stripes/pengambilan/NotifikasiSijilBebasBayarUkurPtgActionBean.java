...
@UrlBinding("/pengambilan/notifikasiSijil")
public class NotifikasiSijilBebasBayarUkurPtgActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(NotifikasiSijilBebasBayarUkurPtgActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/negerisembilan/haklalulalangawam/notifikasiBebasBayarUkur.jsp").addParameter("tab", "true");
    }
}
