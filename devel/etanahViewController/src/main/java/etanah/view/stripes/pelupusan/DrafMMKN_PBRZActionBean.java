 ...
 */
@UrlBinding("/pelupusan/draf_mmk_pbrz")
public class DrafMMKN_PBRZActionBean extends AbleActionBean {
    ...
    Logger logger = Logger.getLogger(DrafMMKN_PBRZActionBean.class);
    @Inject
    BPelService service;
    @Inject
...
//    private PermohonanKertas permohonankertas;
    ...
    private List<PermohonanKertasKandungan> senaraiTujuan = new Vector();
    ...
    private String tajukPBRZ;
    private String tujuanPBRZ;
    ...
    public Resolution showForm1() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/draf_mmk_pbrz.jsp").addParameter("tab", "true");
    }
//    @DefaultHandler
    ...
    public void rehydrate() {
        ...
        if(kodNeg.equals("04")){
            ...
            fasaPermohonan = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "07SedDrfKrtsMMK"); 
        }
...
//            stageId="013_pertimbanganMMKN";
            if(kodNeg.equals("04")){
                    if (urusanStatus.equals("PBRZ")) {
                    tajukHeader = "DRAF MMKN";
                    //PTD
                    if (stageId.equals("009_SediakanRisalatMMKN") || stageId.equals("010_Semak")
                            ||stageId.equals("011_PerakuanRisalatMMKN")||stageId.equals("063A_PerakuRisalat")||stageId.equals("066A_SemakResalat")
                            ||stageId.equals("066_SemakResalat")) {

                        if (stageId.equals("009_SediakanRisalatMMKN")||stageId.equals("066_SemakResalat")||stageId.equals("011_PerakuanRisalatMMKN")) {
                            viewOnlyPTD = false;
                            openPTD = true;
                        }

                        if (stageId.equals("010_Semak")
                               ||stageId.equals("051_TerimadanSemakRisalatMMKN")
                                ||stageId.equals("052_SemakDrafPertimbanganMMKN")||stageId.equals("053_SemakDrafPertimbanganMMKN")) {
                            viewOnlyPTD = false;
                            openPTD = true;
                        } else if (stageId.equals("066_SemakResalat")||stageId.equals("063A_PerakuRisalat")||stageId.equals("066A_SemakResalat")) {
                            openPTD = true;
                            viewOnlyPTD = true;
                    ...
                    //PINDAAN PTD
                    if (stageId.equals("062_BetulkanPindaan") || stageId.equals("063_PerakuRisalat") || stageId.equals("064_SemakPindaan") 
                            || stageId.equals("065_BetulkanPindaanMMKN") || stageId.equals("066_SemakResalat")) {

                        if (stageId.equals("062_BetulkanPindaan") || stageId.equals("064_SemakPindaan") || stageId.equals("065_BetulkanPindaanMMKN")
                                ||stageId.equals("066_SemakResalat")) {
                            viewOnlyPTD = false;
                            openPTD = true;
                        } else if (stageId.equals("063_PerakuRisalat")) {
                            openPTD = true;
                            viewOnlyPTD = true;
                            viewOnlyPTDOnly = false;
                        }
                     ...
                     if (stageId.equals("062A_BetulkanPindaan") || stageId.equals("063A_PerakuRisalat") || stageId.equals("064A_SemakPindaan") 
                            || stageId.equals("065A_BetulkanPindaanMMKN") || stageId.equals("066A_SemakResalat")) {

                        if (stageId.equals("062A_BetulkanPindaan") || stageId.equals("064A_SemakPindaan") || stageId.equals("065A_BetulkanPindaanMMKN")
                                ||stageId.equals("066A_SemakResalat")) {
                            viewOnlyPTD = false;
                            openPTD = true;
                        } else if (stageId.equals("063A_PerakuRisalat")) {
                            openPTD = true;
                            viewOnlyPTD = true;
                            viewOnlyPTDOnly = false;
                        }
    ...
    //                //PTG
                    if (stageId.equals("016_MembuatPindaan") || stageId.equals("017_PertimbanganMMKN") || stageId.equals("018_KeputusanMMKN") 
                            || stageId.equals("021_Makluman") || stageId.equals("035_terimawarta") || stageId.equals("14PerakuMMK")
                            ||stageId.equals("051_TerimadanSemakRisalatMMKN")||stageId.equals("052_SemakDrafPertimbanganMMKN")
                            ||stageId.equals("053_SemakDrafPertimbanganMMKN")||stageId.equals("054_SemakdanSediakanDraf")||stageId.equals("055_MembuatPindaan")
                            ||stageId.equals("056_PerakuanuntukPertimbangan")||stageId.equals("013_pertimbanganMMKN")||stageId.equals("012_SemakRisalat")
                             ||stageId.equals("014_pertimbanganMMKN")|| stageId.equals("015_drafPerakuan")) {

                        if (stageId.equals("016_MembuatPindaan") || stageId.equals("017_PertimbanganMMKN") || stageId.equals("14PerakuMMK")
                                ||stageId.equals("055_MembuatPindaan")||stageId.equals("056_PerakuanuntukPertimbangan")
                                ||stageId.equals("051_TerimadanSemakRisalatMMKN")||stageId.equals("012_SemakRisalat")) {
                            viewOnlyPTD = true;
                            viewOnlyPTG = true;
                            openPTG = true;
                            viewOnlyPTGOnly = false;
                        }
                        if (stageId.equals("018_KeputusanMMKN") || stageId.equals("021_Makluman") || stageId.equals("035_terimawarta")
                               ||stageId.equals("052_SemakDrafPertimbanganMMKN")
                            ||stageId.equals("053_SemakDrafPertimbanganMMKN")||stageId.equals("054_SemakdanSediakanDraf")||stageId.equals("013_pertimbanganMMKN")
                            ||stageId.equals("014_pertimbanganMMKN")|| stageId.equals("015_drafPerakuan")) {
                            viewOnlyPTG = false;
                            openPTG = true;
                            viewOnlyPTD = true;
    ...
    //                    viewOnlyPTD = true;
                ...
                //PTD
                if (stageId.equals("07SedDrfKrtsMMK") || stageId.equals("08SmkSyrDrfMMK")||stageId.equals("09SmkSyrDrfMMK")||stageId.equals("10Perakuan")) {
                   
                    if (stageId.equals("07SedDrfKrtsMMK")||stageId.equals("10Perakuan")) {
                        viewOnlyPTD = false;
                        openPTD = true;
                    }
                    
                    if (stageId.equals("08SmkSyrDrfMMK") ||stageId.equals("09SmkSyrDrfMMK")
                            ) {
                        viewOnlyPTD = false;
                        openPTD = true;
                    } else if (stageId.equals("066_SemakResalat")||stageId.equals("063A_PerakuRisalat")||stageId.equals("066A_SemakResalat")) {
                ...
                //PTG
                if (stageId.equals("11TrmDrfMMK") || stageId.equals("12SmkHuraianSyr") || stageId.equals("13SmkHuraianSyr") || stageId.equals("14Perakuan") || stageId.equals("15CtkKrtsMMK") || stageId.equals("16TrmKptsnMMK") || stageId.equals("17BatalKeseluruhan")) {
                    
                    if (stageId.equals("11TrmDrfMMK") || stageId.equals("14Perakuan")) {
                        viewOnlyPTD = true;
                        viewOnlyPTG = true;
                        openPTG = true;
                        viewOnlyPTGOnly = false;
                    }
                    if (stageId.equals("12SmkHuraianSyr") || stageId.equals("13SmkHuraianSyr") || stageId.equals("15CtkKrtsMMK") || stageId.equals("16TrmKptsnMMK") || stageId.equals("17BatalKeseluruhan")) {
                        viewOnlyPTG = false;
                        openPTG = true;
                        viewOnlyPTD = true;
                    } else {
            ...
            String tujuanTajukPBRZ = "TIADA";
            if (permohonan.getKodUrusan().getKod().equals("PBRZ")) {
                tujuanTajukPBRZ = permohonan.getSebab();
            }

            String tujuanUrusanPBRZ = " ";
            if (permohonan.getKodUrusan().getKod().equals("PBRZ")) {
                tujuanUrusanPBRZ = "perizaban tanah di bawah Seksyen 64(1) Kanun Tanah Negara";
...
//            }
            ...
            tajukTujuanDraf = "Tujuan rencana ini adalah untuk mendapatkan Pertimbangan Majlis Mesyuarat Kerajaan Negeri mengenai permohonan pembatalan perizaban tanah bagi tujuan " + sbb + "  seluas " + luas + " " + koduom
                    + lotntajuk + bpm + ", Daerah " + daerah + " di bawah Seksyen 64 Kanun Tanah Negara";



//            if (keputusan.equals("SL")) {
//                tajukMainDraf = tajuk + pemohon.getPihak().getNama() + " UNTUK MENDAPATKAN PERMOHONAN PERIZABAN " + tujuanPBRZ
//                        + " UNTUK TUJUAN " + permohonan.getSebab() + " DI BAWAH SEKSYEN 62(1) KANUN TANAH NEGARA";
//            } else {
//                tujuanPBRZ = tajuk + pemohon.getPihak().getNama() + " UNTUK MENDAPATKAN PERMOHONAN PERIZABAN " + tujuanPBRZ
//                        + " UNTUK TUJUAN " + permohonan.getSebab() + " DI BAWAH SEKSYEN 62 KANUN TANAH NEGARA";
//            }

            tajukMainDraf = " PERMOHONAN DARIPADA  " + pihakName + " UNTUK MEMBATALKAN PERIZABAN TANAH BAGI TUJUAN " + tujuanTajukPBRZ + lotntajuk.toUpperCase() + "SELUAS " + luas + " " + koduom1 + ", " + bpm + ", DAERAH " + daerah + " DI BAWAH SEKSYEN 64 KANUN TANAH NEGARA.";
...
//                    + ",daerah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " untuk tujuan " + permohonan.getSebab() + " diluluskan seperti pelan yang dilampirkan.";
            if (kpsn != null) {
                if (kpsn.equals("SL")) {
                    perakuPTD = "Pentadbir Tanah Daerah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " dengan ini memperakukan supaya permohonan daripada "
                            + pelUtiliti.convertStringtoInitCap(pemohon.getPihak().getNama()) + " untuk membatalkan perizaban tanah" + lotntajuk + pelUtiliti.convertStringtoInitCap(hakmilikPermohonan.getBandarPekanMukimBaru().getNama())
                    ...
                    perakuPTD = "Pentadbir Tanah Daerah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " dengan ini memperakukan supaya permohonan daripada "
                            + pelUtiliti.convertStringtoInitCap(pemohon.getPihak().getNama()) + " untuk mendapatkan perizaban tanah" + lotntajuk + pelUtiliti.convertStringtoInitCap(hakmilikPermohonan.getBandarPekanMukimBaru().getNama())
...
//            }
            ...
            if (permohonankertas != null) {
                ...
                senaraiTujuan = pelupusanService.findByIdLapor(permohonankertas.getIdKertas(), 1);
...
//            if(senaraiL)
            if (mohonKertas != null) {
                logger.info("mohonKertas not null "+mohonKertas.getIdKertas());
                        ...
                        switch (pkk.getBil()) {
                            ...
                            case (1):
                                if (pkk.getSubtajuk().equals("1.1")) {
                                    String kand="";
                                    if(pkk.getKandungan().contains("62(1)")){
                                        kand=pkk.getKandungan().replace("62(1)", "64");
                                    }else{
                                        kand=pkk.getKandungan();
                                    }
                                    logger.info("kand before : "+pkk.getKandungan());
                                    logger.info("kand after : "+kand);
                                    tajukTujuanDraf = kand;
                                    checkExistBil1 = true;
                                }
                                break;
                            case (2):
...
//        mohonLaporTanah = pelupusanService.findLaporanTanahByIdPermohonan(idPermohonan) ;
    ...
    public void settingDefaultValue() {
        ...
        perihalpermohonan = " Pentadbir Tanah " + pelUtiliti.convertStringtoInitCap(permohonan.getCawangan().getDaerah().getNama()) + " telah menerima permohonan untuk mendapatkan perizaban tanah ";
...
//        int checkSenarai = this.senaraiLaporanKandunganPerihalTanah.size();
        ...
        if (!checkingValidation()) {
            ...
            if (fasaPermohonan != null) {
                ...
                fasaPermohonan.setIdAliran("sedia_draf_mmkn");
            }
                        ...
                        for (int i = 0; i < listmohonKertasKandungan.size(); i++) {
                            ...
                            switch (mohonKertasKandungan.getBil()) {
                                ...
                                case 2: /*
                                     * DEFAULT VALUE
                                     */
                                    if (mohonKertasKandungan.getSubtajuk().equals("2.1.1")) {
                                        ...
                                        pelupusanService.simpanPermohonanKertasKandungan(mohonKertasKandungan);
                                        checkExistSubTajuk211 = true;
                                    } else if (mohonKertasKandungan.getSubtajuk().equals("2.2.1")) {
...
//            showForm1();
    ...
    public Resolution showTambahTujuan() {
        ...
        mohonKertas = pelupusanService.findPermohonanKertasByIdPermohonanNKodDokumen(idPermohonan, "RMN");
        if (mohonKertas != null) {
            if (senaraiTujuan.size() > 0) {
                PermohonanKertasKandungan mohonKertasKand = new PermohonanKertasKandungan();
                mohonKertasKand = senaraiTujuan.get(senaraiTujuan.size() - 1);
                String endSubTajuk = new String();
                String frontSubTajuk = new String();
                if (mohonKertasKand.getSubtajuk().length() > 5) {
                    frontSubTajuk = mohonKertasKand.getSubtajuk().substring(0, mohonKertasKand.getSubtajuk().length() - 2);
        ...
        getContext().getRequest().setAttribute("flag", Boolean.TRUE);
        return new JSP("pelupusan/pbrz/tambah_tujuan.jsp").addParameter("popup", "true");
    }
...
//        logger.info(permohonankertas.getKodDokumen().getKod());
    ...
    public Resolution showsyortolaklulus() {
        ...
        pelPtService.saveFasaMohon(mohonFasaSyorTolak);
        rehydrate();
        return new JSP("pelupusan/draf_mmk_pbrz.jsp").addParameter("tab", "true");
    }
    ...
    public String getTajukPBRZ() {
        return tajukPBRZ;
    }

    public void setTajukPBRZ(String tajukPBRZ) {
        this.tajukPBRZ = tajukPBRZ;
    }

    public String getTujuanPBRZ() {
        return tujuanPBRZ;
    }

    public void setTujuanPBRZ(String tujuanPBRZ) {
        this.tujuanPBRZ = tujuanPBRZ;
    }
