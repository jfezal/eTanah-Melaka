...
/**
 *
 * @author abdul.hakim 19/10/2017 9:45 PM
 *
 */
@Wizard(startEvents = {"Step1"})
@UrlBinding("/hasil/delete_bilCukai")
public class UtilitiDeleteBilCukaiActionBean extends AbleActionBean {

    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(UtilitiDeleteBilCukaiActionBean.class);
    private static final String DEFAULT_VIEW = "/WEB-INF/jsp/hasil/delete_bil_cukai.jsp";
    ...
    public Resolution search() {
        ...
        String sql = "SELECT d FROM BilCukai d WHERE d.untukTahun = :year AND d.kodCawangan.kod = :caw AND d.jenisCukai = 'L'";
        Session s = sessionProvider.get();
        Query q = s.createQuery(sql);
