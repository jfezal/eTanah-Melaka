 ...
 */
@UrlBinding("/pelupusan/maklumat_tanah_mpjlt")
public class MaklumatTanahMPJLTActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(MaklumatTanahMPJLTActionBean.class);
    ...
    private List<KodBandarPekanMukim> senaraiKodBPMMPJLT;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/maklumat_tanah_dipohon_MPJLT.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution carianIndependent() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("MPJLT") || permohonan.getKodUrusan().getKod().equals("PJLB")) {
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (!permohonan.getKodUrusan().getKod().equals("MPJLT") && !permohonan.getKodUrusan().getKod().equals("MPJLB")) {
...
//        String kod2 = getContext().getRequest().getParameter("kodUnitLuas");
        ...
        if (!validateluas) {
            ...
            if (negeri.equals("04") && permohonan.getKodUrusan().getKod().equals("MPJLT")) {
                permohonanLaporanPelan = pelupusanService.findByIdPermohonanPelan(idPermohonan);
                InfoAudit info = new InfoAudit();
                if (permohonanLaporanPelan == null) {
                    info = new InfoAudit();
...
//        logger.info("THIS IS KODDAERAH->"+kod);
    ...
    public static void setLogger(Logger logger) {
        MaklumatTanahMPJLTActionBean.logger = logger;
    }
...
//        logger.info("THIS IS KODBPM ->"+kodBpm);
    ...
    public List<KodBandarPekanMukim> getSenaraiKodBPMMPJLTPJLB() {
    ...
    public void setSenaraiKodBPMMPJLTPJLB(List<KodBandarPekanMukim> senaraiKodBPMMPJLTPJLB) {
        this.senaraiKodBPMMPJLT = senaraiKodBPMMPJLTPJLB;
    }
    ...
    public static void setKodDaerahStatic(String kodDaerahStatic) {
        MaklumatTanahMPJLTActionBean.kodDaerahStatic = kodDaerahStatic;
    }
