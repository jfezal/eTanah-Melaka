...
@UrlBinding("/pelupusan/pihak_berkepentingan")
public class PihakBerkepentinganActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(PihakBerkepentinganActionBean.class);
    @Inject
...
//    private HakmilikPermohonan hakmilikPermohonan;
    ...
    public Resolution showForm() {
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/hak_lalulalang/dev_senarai_pihak_berkepentingan.jsp").addParameter("tab", "true");
    }
    public Resolution showForm2() {
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/hak_lalulalang/maklumat_pengambilan_pemohon.jsp").addParameter("tab", "true");
    }
...
//            p = permohonanService.findById(idPermohonan);
        ...
        return new JSP("pelupusan/hak_lalulalang/dev_senarai_pihak_berkepentingan.jsp").addParameter("tab", "true");
    }
...
//            getContext().getMessages().add(new SimpleMessage("Data {1}.", mpk));
    ...
    public Resolution pihakKepentinganPopup() {
        ...
        return new JSP("pelupusan/hak_lalulalang/dev_kemasukan_pihak_berkepentingan.jsp").addParameter("popup", "true");
    }
...
//        getContext().getRequest().setAttribute("popup", "false");
    ...
    public Resolution showEditNamaPemohon() {
        ...
        return new JSP("pelupusan/edit_nama_pemohon.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution showEditAlamatPemohon() {
        ...
        return new JSP("pelupusan/edit_alamat_pemohon.jsp").addParameter("popup", "true");
    }
...
//                permohonanPihak.setCawangan(pihakCawangan);
            ...
            if (StringUtils.isNotBlank(tmp)) {
                ...
                if(permohonan.getKodUrusan().getKod().equals("PMG") || permohonan.getKodUrusan().getKod().equals("PMP")) {
                    return new RedirectResolution("/pembangunan/pihak_berkepentingan?senaraiHakmilikPindahMilikBerkepentingan")
...
//            return new RedirectResolution("/pengambilan/pihak_berkepentingan?getSenaraiHakmilikKepentingan").addParameter("tab", "true");
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/maklumat_pengambilan_pemohon.jsp").addParameter("tab", "true");
//        return new StreamingResolution("text/plain", "1");
    }
...
//        tx.commit();
        ...
        return new JSP("pelupusan/maklumat_pengambilan_pemohon.jsp").addParameter("tab", "true");
    ...
    public Resolution simpanCawangan() {
        ...
        if (cariFlag) {
            return new RedirectResolution("/pelupusan/pihak_berkepentingan?getTambahCawanganPenerima&idPihak=" + id).addParameter("popup", "true");
        }
...
//                pihakKepentinganList2 = hakmilikPihakKepentinganService.findHakmilikPihakByKod(hakmilikPermohonan2, kodPihak);
            }
