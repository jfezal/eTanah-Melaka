 ...
 * @author nordiyana
 */
@UrlBinding("/pengambilan/maklumat_pengambilan_sek4")
public class maklumatpengambilansek4ActionBean extends AbleActionBean {
...
//    }
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/melaka/seksyen4/maklumat_pengambilan_sek4.jsp").addParameter("tab", "true");
    }
