 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/penerimaan_notis_borang_BantahanMLK")
public class PenerimaanNotisBorangBantahanMahkamah_MLKActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(PenerimaanNotisBorangBantahanMahkamah_MLKActionBean.class);
    ...
    public Resolution showFormPP() {
        ...
        return new JSP("pengambilan/melaka/bantahanmahkamah/Penerimaan_Notis_Borang.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution showFormMahkamah() {
        ...
        if(idPermohonan != null) {
            ...
            fasaPermohonan = notisPenerimaanService.getFasaPermohonan(idPermohonan, "03Keputusan");

            if(fasaPermohonan != null){
                if(fasaPermohonan.getIdAliran().equalsIgnoreCase("03Keputusan")){
...
//                    if(notisMahkamahNBO != null && notisMahkamahNBN != null){
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(PenerimaanNotisBorangBantahanMahkamah_MLKActionBean.class, "locate");
    }
