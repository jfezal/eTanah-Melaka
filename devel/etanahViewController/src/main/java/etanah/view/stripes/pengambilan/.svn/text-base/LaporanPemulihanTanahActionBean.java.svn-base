...
@UrlBinding("/pengambilan/LaporanPemulihanTanah")
public class LaporanPemulihanTanahActionBean extends AbleActionBean
{
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/rekod_Laporan_Pemulihan_Tanah.jsp").addParameter("popup", "true");
    }

    public Resolution hideSimpanLaporan() {
        simpanLaporan = Boolean.FALSE;
        return new JSP("pengambilan/rekod_Laporan_Pemulihan_Tanah.jsp").addParameter("tab", "true");
    }
...
//            }
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(LaporanPemulihanTanahActionBean.class, "locate");
    }
...
//            laporanPemulihanTanah = pengambilanService1.getLaporanPemulihanTanahByidMHidMP(hakmilikPermohonan.getId(),permohonanPihak.getIdPermohonanPihak());
            laporanPemulihanTanah = pengambilanService1.getLaporanPemulihanTanahByidMHidMP2(hakmilikPermohonan.getId(),permohonanPihak.getIdPermohonanPihak(),idPermohonan);
    ...
    public Resolution simpan() {
        ...
        long idPihak = Long.parseLong(getContext().getRequest().getParameter("idPihak"));
        hakmilikPermohonan = pengambilanService1.findByIdHakmilikIdPermohonan(idPermohonan, idHakmilik);
        PermohonanPihak permohonanPihak = pengambilanService1.getPmohonPihakByIdHakmilikIdPihak(idPermohonan, idHakmilik, idPihak);
        InfoAudit infoAudit;
        laporanPemulihanTanah = pengambilanService1.getLaporanPemulihanTanahByidMHidMP2(hakmilikPermohonan.getId(),permohonanPihak.getIdPermohonanPihak(),idPermohonan);
        if(laporanPemulihanTanah == null) {
