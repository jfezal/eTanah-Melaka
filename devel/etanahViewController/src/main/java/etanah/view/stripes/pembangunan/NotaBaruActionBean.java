 ...
 * @author NageswaraRao
 */
@UrlBinding("/pembangunan/melaka/notaBaru")
public class NotaBaruActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("/pembangunan/melaka/nota_baru.jsp").addParameter("tab", "true");
    }
...
//        stageId = "agihancharting";

        permohonan = permohonanDAO.findById(idPermohonan);
//        listNota = pembangunanService.findListNotaByIdMohon(idPermohonan, stageId);
        listNota = pembangunanService.findListNotaByIdMohonDesc(idPermohonan);

        if (listNota.size() != 0) {
            //permohonanNota = listNota.get(0);
            permohonanNota = pembangunanService.findNotaByIdMohon(idPermohonan, stageId);
...
//        stageId = "agihancharting";
        ...
        pembangunanService.simpanNota(permohonanNota);
