...
@UrlBinding("/pelupusan/pihak_kepentingan")
public class PihakKepentinganActionBean extends AbleActionBean {
    ...
    private static String MAIN_PAGE = "pelupusan/kemasukan_pihak_main.jsp";
    ...
    public void rehydrate() {
        ...
        if (StringUtils.isNotBlank(idPermohonan)) {
            ...
            LOG.info("----------------------------permohonan" + permohonan.getSebab());
...
//        }
    ...
    public Resolution simpanTujuan() {
        ...
        permohonan = permohonanDAO.findById(idPermohonan);
        if (permohonan.getKodUrusan().getKod().equals("PLPT") ||permohonan.getKodUrusan().getKod().equals("BMBT") || permohonan.getKodUrusan().getKod().equals("PBHL") || permohonan.getKodUrusan().getKod().equals("PHLP") || permohonan.getKodUrusan().getKod().equals("PWGSA") || permohonan.getKodUrusan().getKod().equals("MMMCL")|| permohonan.getKodUrusan().getKod().equals("PBGSA")) {
    ...
    public Resolution simpanPemohon() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("MMMCL")) {
            ...
            senaraiHakmilik = disLaporanTanahService.getPelupusanService().getHakmilikPermohonan(permohonan.getIdPermohonan());
            if (!senaraiHakmilik.isEmpty()) {
                for (HakmilikPermohonan hakmilikPermohonan : senaraiHakmilik) {
                    ...
                    hakmilikPermohonan.setInfoAudit(disLaporanTanahService.findAudit(hakmilikPermohonan, "update", pengguna));
                    hakmilikPermohonan = disHakmilikPermohonan.copyPropertiesHakmilikToMH(permohonan, hakmilikPermohonan, hakmilikPermohonan.getHakmilik(), new String[]{}, disLaporanTanahService);
...
//    }
    public Resolution carianHakmilikPopup() {
        ...
        return new JSP("pelupusan/carian_Hakmilik_PopupLaluLalangPemohon.jsp").addParameter("popup", "true").addParameter("showForm", "false");
    }
    ...
    public Resolution cariHakmilik() {
        ...
        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/carian_Hakmilik_PopupLaluLalangPemohon.jsp").addParameter("tab", "true");
//        return new JSP("pelupusan/carian_Hakmilik_PopupLaluLalangPemohon.jsp").addParameter("popup", "true");
    ...
    public Resolution simpan() {
        ...
        if (hakmilik == null) {
            ...
            hakmilikPermohonan = pservice.findByIdPermohonanNCatatan(idPermohonan, new String(), hakmilik.getIdHakmilik());
...
//        ForwardResolution("/WEB-INF/jsp/pelupusan/carian_Hakmilik_PopupLaluLalang.jsp").addParameter("tab", "true");
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(PihakKepentinganActionBean.class, "locate");
    }
