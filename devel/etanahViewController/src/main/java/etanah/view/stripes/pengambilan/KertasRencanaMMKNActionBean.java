 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/kertas_rencana_mmkn")
public class KertasRencanaMMKNActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(KertasRencanaMMKNActionBean.class);
    @Inject
...
//                        StringBuilder sb = new StringBuilder();
                    ...
                    tujuan = "Tujuan kertas ini ialah untuk mendapatkan pertimbangan Mesyuarat JawatanKuasa Khas Pengambilan Tanah Negeri Melaka` mengenai permohonan pengambilan tanah "
                            + "di bawah Seksyen 3(1)(b)(c) Akta Pengambilan Tanah 1960, di atas sebahagian "+ noLotList + " di " + hakmilik.getBandarPekanMukim().getNama() +", Daerah " + hakmilik.getDaerah().getNama()
                            +" seluas "+ totalLuas + " " + uom + " untuk tujuan "+ permohonan.getSebab() +" oleh " + pem + ".";
                    }
                }
            }
        }
...
//            hh
            permohonanKertas = pendudukanSementaraMMKNService.findMMKNByIdPermohonanRENC(idPermohonan);
    ...
    public Resolution simpan() throws ParseException {
        ...
        getContext().getRequest().setAttribute("form1", Boolean.TRUE);
        return new RedirectResolution(KertasRencanaMMKNActionBean.class, "locate");
    }
