...
@UrlBinding("/pengambilan/pengambilan_pemohon1")
public class pActionBean_1 extends AbleActionBean {
...
//    private boolean isLayak = true;
    ...
    public Resolution showForm() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/negerisembilan/maklumat_pemohon1.jsp").addParameter("tab", "true");
    }
...
//            penyerahJenisPengenalan = permohonan.getPenyerahNoPengenalan();
...
//        }
    ...
    public Resolution deletePemohon() {
        ...
        rehydrate();
        return new JSP("pengambilan/negerisembilan/maklumat_pemohon1.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution deleteSelectedPemohon() {
        ...
        if (StringUtils.isNotBlank(idHakmilik)) {
            return new RedirectResolution(pActionBean_1.class, "doGetPartialPage").addParameter("idHakmilik", idHakmilik);
        } else {
            return new RedirectResolution(pActionBean_1.class, "getSenaraiHakmilikKepentingan");
        }
    }
    ...
    public Resolution pihakKepentinganPopup() {
        ...
        kodNegeri = conf.getProperty("kodNegeri");
        return new JSP("pengambilan/negerisembilan/maklumat_pemohon1.jsp").addParameter("popup", "true");
    }

    public Resolution pemohonPopup() {

        getContext().getRequest().setAttribute("pemohon", Boolean.TRUE);
        return new JSP("pengambilan/common/maklumat_pemohon_popup_1.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution showEditPemohon() {
        ...
        return new JSP("pengambilan/common/maklumat_pemohon_edit_1.jsp").addParameter("popup", "true");
    }
...
//    }
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(pActionBean_1.class, "locate");
    }
...
//        pihak = pihakService.findPihak(pihak.getJenisPengenalan().getKod(), pihak.getNoPengenalan());
    ...
    public Resolution deleteCawanganPemohon() {
        ...
        return new JSP("pengambilan/maklumat_pemohon_edit_1.jsp").addParameter("popup", "true");
    }
...
//        getContext().getRequest().setAttribute("hakmilik", permohonanPihak.getHakmilik().getIdHakmilik());
    ...
    public Resolution simpanCawangan() {
        ...
        if (cariFlag) {
            return new RedirectResolution("/pengambilan/pengambilan_pemohon1?getTambahCawanganPenerima&idPihak=" + id + "&jenisPB=" + jenisPihak).addParameter("popup", "true");
        }
    ...
    public Resolution simpanCawanganEdit() {
        ...
        if (cariFlag) {
            return new RedirectResolution("/pengambilan/pengambilan_pemohon1?getTambahCawanganPenerimaEdit&idPihak=" + id + "&jenisPB=" + jenisPihak + "&idPermPihak=" + id2).addParameter("popup", "true");
        }
        return new StreamingResolution("text/plain", "1");
    }
    ...
    public Resolution simpanCawanganPemohon() {
        ...
        if (cariFlag) {
            return new RedirectResolution("/pengambilan/pengambilan_pemohon1?getTambahCawanganPemohon&idPihak=" + id + "&idPemohon=" + pemohon.getIdPemohon()).addParameter("popup", "true");
        }
    ...
    public Resolution simpanPengarah() {
        ...
        if (cariFlag) {
            return new RedirectResolution("/pengambilan/pengambilan_pemohon1?getTambahPengarahPenerima&idPihak=" + id + "&jenisPB=" + jenisPihak).addParameter("popup", "true");
        }
        return new StreamingResolution("text/plain", "1");
    }
    ...
    public Resolution simpanPengarahPemohon() {
        ...
        if (cariFlag) {
            return new RedirectResolution("/pengambilan/pengambilan_pemohon1?getTambahPengarahPemohon&idPihak=" + id + "&idPemohon=" + pemohon.getIdPemohon()).addParameter("popup", "true");
        }
        return new StreamingResolution("text/plain", "1");
    }
    ...
    public Resolution simpanPengarahEdit() {
        ...
        if (cariFlag) {
            return new RedirectResolution("/pengambilan/pengambilan_pemohon1?getTambahPengarahPenerimaEdit&idPihak=" + id + "&jenisPB=" + jenisPihak + "&idPermPihak=" + id2).addParameter("popup", "true");
        }
        return new StreamingResolution("text/plain", "1");
    }
