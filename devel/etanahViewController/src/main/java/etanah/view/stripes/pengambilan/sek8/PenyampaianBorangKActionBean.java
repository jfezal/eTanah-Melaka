 ...
 * @author zipzap
 */
@UrlBinding("/pengambilan/penyampaian_k")
public class PenyampaianBorangKActionBean extends AbleActionBean {
    ...
    public Resolution showForm() throws ParseException {
        ...
        return new JSP("/pengambilan/APT/penyampaian_borang_k.jsp");
    }
