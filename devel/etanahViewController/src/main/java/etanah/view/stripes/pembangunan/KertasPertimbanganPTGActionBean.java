 ...
 * @author NageswaraRao
 */
@UrlBinding("/pembangunan/kertasPertimbanganPTG")
public class KertasPertimbanganPTGActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pembangunan/pecahBahagian/kertas_pertimbangan_PTG.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        System.out.println("---******--Pihak Name------" + nama);
        ...
        if ((permohonan.getSenaraiKertas().isEmpty()) || (kertasP == null)) {
            if (permohonan.getKodUrusan().getKod().equals("TSPTD") || permohonan.getKodUrusan().getKod().equals("TSPTG") || permohonan.getKodUrusan().getKod().equals("TSMMK")) {
                tajuk = "Kertas untuk pertimbangan Pengarah Tanah dan Galian Negeri Sembilan Darul Khusus bagi " + permohonan.getKodUrusan().getNama() + " di " + lokasi + ", daripada " + hakmilik.getSyaratNyata().getSyarat() + " kepada " + hp.getSyaratNyataBaru().getSyarat();
            } else {
                tajuk = "Kertas untuk pertimbangan Pengarah Tanah dan Galian Negeri Sembilan Darul Khusus bagi " + permohonan.getKodUrusan().getNama() + " bagi " + lokasi + ".";
            }
            tujuan = "Tujuan kertas ini adalah untuk mendapat pertimbangan Pengarah Tanah Dan Galian Negeri Sembilan Darul Khusus daripada " + WordUtils.capitalizeFully(nama) + " untuk " + permohonan.getKodUrusan().getNama() + " di " + lokasi + ".";
    ...
    public Resolution simpan() {
        ...
        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
//        rehydrate();
        return new ForwardResolution("/WEB-INF/jsp/pembangunan/pecahBahagian/kertas_pertimbangan_PTG.jsp").addParameter("tab", "true");
    }
