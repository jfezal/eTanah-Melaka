    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
       ...
       // List<HakmilikPermohonan> hakmilikPermohonanList = p.getSenaraiHakmilik() ;
        ...
        ia.setDimasukOleh(p.getInfoAudit().getDimasukOleh());
            ...
            PermohonanTuntutanKos permohonanTuntutanKos = pelupusanService.findMohonTuntutKosByIdPermohonanAndIdTuntut(p.getPermohonanSebelum().getIdPermohonan(), "DISPRM");
