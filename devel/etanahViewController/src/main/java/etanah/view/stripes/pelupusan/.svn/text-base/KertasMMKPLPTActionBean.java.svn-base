 ...
 * @author afham
 */
@UrlBinding("/pelupusan/kertas_MMK_plpt")
public class KertasMMKPLPTActionBean extends AbleActionBean {
...
//    private List<PermohonanKertasKandungan> senaraiKandunganTajuk;  //Bil - 0
    ...
    public Resolution editOnlyKertasMMKPT() {
        ...
        httpSession.setAttribute("disKertasMMKController", disKertasMMKController);
            ...
            return new JSP("pelupusan/kertasMMK/kertasMMKMLKPLPT.jsp").addParameter("tab", "true");
