 ...
 * @author massita
 */
@UrlBinding("/pengambilan/pihak_berkepentingan_TarikBalik")
public class PihakBerkepentinganPermohonanTarikBalikActionBean extends AbleActionBean {
...
//    private HakmilikPermohonan hakmilikPermohonan;
    ...
    public Resolution showForm() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/dev_senarai_pihak_berkepentingan_tarik.jsp").addParameter("tab", "true");
    }
...
//        List<HakmilikPermohonan> hakmilikPermohonanList = p.getSenaraiHakmilik();
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(PihakBerkepentinganPermohonanTarikBalikActionBean.class, "locate");
    }
...
//            getContext().getMessages().add(new SimpleMessage("Data {1}.", mpk));
        ...
        return new RedirectResolution(PihakBerkepentinganPermohonanTarikBalikActionBean.class, "getSenaraiHakmilikKepentingan");
    }
...
//            Permohonan Sebelum = permohonanDAO.findById(idSblm);
              ...
              //  hakmilikPermohonanList2 = p.getSenaraiHakmilik();
                hakmilikPermohonanList2 = hakmilikPermohonanService.findIDMHByIDMohonPenarikan(idSblm);
