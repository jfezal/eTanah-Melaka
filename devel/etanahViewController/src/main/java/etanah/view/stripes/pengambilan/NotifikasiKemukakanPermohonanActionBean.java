...
@UrlBinding("/pengambilan/notifikasiPermohonan")
public class NotifikasiKemukakanPermohonanActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(NotifikasiKemukakanPermohonanActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/negerisembilan/haklalulalangawam/notifikasiKemukakanPermohonan.jsp").addParameter("tab", "true");
    }
}
