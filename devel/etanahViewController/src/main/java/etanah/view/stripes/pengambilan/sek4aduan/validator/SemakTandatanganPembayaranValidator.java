 ...
 * @author mohd.faidzal
 */
public class SemakTandatanganPembayaranValidator implements StageListener{
     @Inject
...
@Override
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        sek4AduanIntegrationFlowService.completeTask(ref.REKOD_TERIMA_PAMPASAN, context.getPermohonan(), context.getPengguna());
