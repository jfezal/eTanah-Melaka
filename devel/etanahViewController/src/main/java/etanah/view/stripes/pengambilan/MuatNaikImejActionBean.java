...
@UrlBinding("/pengambilan/muat_naik_imej")
public class MuatNaikImejActionBean extends BasicTabActionBean {
    ...
    String catatan = "";
    String msg;
    String _PAGE_IMEJ_POP_ = "pengambilan/common/muat_naik_imej_pop.jsp";
    String _PopUp_ = "pengambilan/common/muatnaik.jsp";
    String _Main = "pengambilan/common/muat_naik_imej.jsp";
...
//        return new JSP("pengambilan/common/maklumat_imej.jsp").addParameter("tab", "true");
        return new JSP("pengambilan/common/maklumat_naik_imej.jsp").addParameter("tab", "true");
    }
...
//bak        return new RedirectResolution(MuatNaikImejActionBean.class, "showMuatNaikImej");
    ...
    public Resolution showRefresh() {
        ...
        getContext().getRequest().setAttribute("cheackingLT", Boolean.TRUE);
        rehydrate();
//        return new JSP("pengambilan/common/muat_naik_imej.jsp").addParameter("popup", "true");
...
//        rehydrate();
//        return new JSP("pengambilan/common/muat_naik_imej.jsp").addParameter("tab", "true");
