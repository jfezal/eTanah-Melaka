 ...
 * @author abu.mansur
 */
@UrlBinding("/hasil/papar_keputusan_RemSBM")
public class KeputusanPaparRemSBMActionBean extends AbleActionBean {

    private static final Logger LOG = Logger.getLogger(KeputusanPaparRemSBMActionBean.class);
    ...
    public Resolution showForm(){
        return new JSP("hasil/papar_keputusan_sbm.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate(){
        ...
        if(idPermohonan != null){
            ...
            //for maklumat sekolah bantuan modal
