...
@UrlBinding("/pelupusan/draf_suk_pptr")
public class DrafSUK_PPTRActionBean extends AbleActionBean {
...
//    private String perihaltanah1;
    ...
    private boolean ulasanEmpty = false;
...
//        edit = Boolean.TRUE;
        ...
        return new JSP("pelupusan/pptr/draf_pertimbangan_SUK.jsp").addParameter("tab", "true");
    }
...
//        }
//REMOVE
        stageId = "sedia_surat_ulasan_pengawal";
...
//                + bpm + ", Daerah " + daerah + " untuk tujuan " + sbb + " .";
        ...
        if (permohonan.getKodUrusan().getKod().equals("PPTR")) {
            String rizabString = new String();
            if(hakmilikPermohonan.getKodMilik()!=null&&hakmilikPermohonan.getKodMilik().getKod().equals('R')){
               rizabString =  " tahun tanah ";
            }else{
               rizabString =  " tahun tanah rizab";
            }
            tujuanUrusanPlps = "memajak selama "+hakmilikPermohonan.getTempohPajakan()+rizabString+pelUtiliti.convertStringtoInitCapOnlyOnce(hakmilikPermohonan.getKodMilik().getNama());
...
//                tanggungan = 0;
        ...
        if(!StringUtils.isBlank(tanahrizabpermohonan1.getPenjaga())){
            penjaga = tanahrizabpermohonan1.getPenjaga().equals("SUK Negeri")?"YB. Setiausaha Kerajaan Negeri":
                      pelUtiliti.convertStringtoInitCap(tanahrizabpermohonan1.getPenjaga());
        }
        String tujuanPTLot = !noLot.isEmpty()?" ke atas PT/LOT " + noLot: " ";
        tujuanPlps = " Kertas ini bertujuan untuk mendapatkan pertimbangan dan kelulusan "+penjaga+" mengenai permohonan daripada " 
                + nama + ", No. K/P: " + noPengenalan + " untuk " + tujuanUrusanPlps + tujuanPTLot + ", seluas " + luas + " " + koduom + ", "
                + bpm + ", Daerah " + daerah + " untuk tujuan " + sbb + " di bawah Seksyen 63 Kanun Tanah Negara.";
...
//        if(stageId.equals("sedia_draf_mmkn")){
            if(permohonan.getKodUrusan().getKod().equals("PPTR")){
                 fasaPermohonan = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "sedia_surat_ulasan_pengawal");
            }
            ...
            if (fasaPermohonan != null && fasaPermohonan.getKeputusan() != null) {
                ...
                if(syortolaklulus!=null&&syortolaklulus.equals("SL")){
                    ...
                    pentabirtanah1 = " Adalah disyorkan supaya YB Setiausaha Kerajaan Negeri untuk mempertimbangkan permohonan tersebut diluluskan memandangkan tanah "
                                       +"berkenaan telah dirizabkan sebagai "+ permohonan.getSebab();
                }
                if(syortolaklulus!=null&&syortolaklulus.equals("ST")){
                        pentabirtanah1 = new String();
                                pentabirtanah1 = "  Adalah disyorkan supaya YB Setiausaha Kerajaan Negeri untuk mempertimbangkan permohonan tersebut ditolak memandangkan tanah "
                                       +"berkenaan telah dirizabkan sebagai "+ permohonan.getSebab();
                }
            }
//        }
...
//        permitItem = pelupusanService.findByIdMohonPermitItem(idPermohonan) ;
         ...
         String tajukLot = " " ;
         String tajukLotUpper = " ";
         String noLotString = " ";
         if((hakmilikPermohonan != null) && (hakmilikPermohonan.getLot() != null)){
             tajukLot = hakmilikPermohonan.getLot().getNama() ;
             tajukLotUpper = tajukLot.toUpperCase();
             noLotString = hakmilikPermohonan.getNoLot();
         }  
      
        tajukPlps =" PERMOHONAN MEMAJAK SELAMA "+hakmilikPermohonan.getTempohPajakan()+" TAHUN TANAH RIZAB KERAJAAN "+tajukLotUpper+noLotString+" SELUAS " + luas + " " + koduom1 + " " + bpm + ", DAERAH " + daerah + " OLEH "+pihakName+" UNTUK TUJUAN " + permohonan.getSebab().toUpperCase() + " DI BAWAH SEKSYEN 63 KANUN TANAH NEGARA.";
...
//        }
        ...
        String penjagaString = new String();
        if(!StringUtils.isBlank(tanahrizabpermohonan1.getPenjaga())){
            if(tanahrizabpermohonan1.getPenjaga().equals("SUK Negeri"))
                penjagaString = "YB. Setiausaha Kerajaan Negeri";
            else{
                penjagaString = pelUtiliti.convertStringtoInitCap(tanahrizabpermohonan1.getPenjaga());
            }
        }
        
        pentabirtanah2 = " Adalah disyorkan supaya "+penjagaString+" untuk mempertimbangkan permohonan tersebut diluluskan";
...
//                + " bertarikh " + trhruj + " dan ulasan beliau adalah " + permohonanRujukanLuar.getUlasan() ;
        ...
        permohonankertas = pelupusanService.findKertasByKod(idPermohonan, "KPSUK");
...
//                kertasK = new PermohonanKertasKandungan();
        ...
        if (permohonankertas != null) {
            ...
            senaraiLaporanKandunganptg1 = pelupusanService.findByIdLapor(permohonankertas.getIdKertas(), 4);
...
//            senaraiLaporanKandunganpbtanah = pelupusanService.findBySubtajuk(permohonankertas.getIdKertas(), 5);
        ...
        ulasanEmpty = senaraiLaporanKandunganUtil.size()>0?Boolean.FALSE:Boolean.TRUE;
...
//                break;
    ...
    public void updateKandungan(int i, String kand) {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PPTR")) {
            permohonankertas.setTajuk("KERTAS PERTIMBANGAN SUK");
            KodDokumen kod = kodDokumenDAO.findById("KPSUK");
...
//                LOG.info("alamak!! tiada index");
    ...
    public Resolution simpanNew() {
        ...
        if (permohonankertas == null) {
            ...
            permohonankertas.setPermohonan(permohonan);
            permohonankertas.setTajuk("KERTAS PERTIMBANGAN SUK");
            permohonankertas.setKodDokumen(kodDokumenDAO.findById("KPSUK"));
...
//                pelupusanService.simpanPermohonanKertasKandungan(permohonanKertasKandungan1);
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/pptr/draf_pertimbangan_SUK.jsp").addParameter("tab", "true");
    }
...
//    }
    public Resolution showsyortolaklulus(){
        ...
        if(permohonan.getKodUrusan().getKod().equals("PPTR")){
            idAliran = "sedia_surat_ulasan_pengawal";
        }
...
//    }
    ...
    public boolean isUlasanEmpty() {
        return ulasanEmpty;
    }

    public void setUlasanEmpty(boolean ulasanEmpty) {
        this.ulasanEmpty = ulasanEmpty;
    }
