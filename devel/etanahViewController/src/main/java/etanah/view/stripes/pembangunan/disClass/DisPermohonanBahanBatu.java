 ...
 * purpose : Seperate mohon Bahan Batu
 * 
 */

public class DisPermohonanBahanBatu  {
    
    private PermohonanBahanBatuan syaratBahanBatu;
    private String jumlahIsipaduUOM;
    ...
    public String getJumlahIsipaduUOM() {
        return jumlahIsipaduUOM;
    }

    public void setJumlahIsipaduUOM(String jumlahIsipaduUOM) {
