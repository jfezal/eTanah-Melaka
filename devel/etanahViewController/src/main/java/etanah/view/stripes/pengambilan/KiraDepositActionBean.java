...
@UrlBinding("/pengambilan/kiraDeposit")
public class KiraDepositActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(KiraDepositActionBean.class);
    @Inject
    ...
    @Inject
    public KiraDepositActionBean(AkaunDAO akaunDAO, HakmilikDAO hakmilikDAO) {
...
//    private static final String DEFAULT_VIEW = "/WEB-INF/jsp/pengambilan/kiraDeposit.jsp";
...
//    private BigDecimal jum;
    ...
    public Resolution defaultPage() {
     ...
     //   pengambilanService.simpanPermohonanSebelum(permohonan,peng);
        return new JSP("pengambilan/kiraDeposit.jsp").addParameter("tab", "true");
    }
...
//        showMaklumatPemilik = false;
    ...
    public Resolution kembali() {
        return new RedirectResolution(KiraDepositActionBean.class);
    }
    ...
    public Resolution pihakDetails() {
        ...
        if(idSblm!=null)
        permohonanPihak = pengambilanService.getSenaraiPmohonPihakByIdHakmilikIdPihak(idSblm,hakmilik.getIdHakmilik(),idPihak);
...
//        permohonanTuntutanKos1.setAmaunSebenar(amaunSebenar);
    ...
    public Resolution simpanTuntutan() {
        ...
        addSimpleMessage("Maklumat telah berjaya disimpan.");
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/kiraDeposit.jsp").addParameter("tab", "true");
    }
...
//    }
    ...
    public void calculateMaklumatHakmilikTotal() {
        ...
        if(idSblm!=null){
        Permohonan idSblmPermohonan = permohonanDAO.findById(idSblm);
        ...
        if (senaraiPihakBerkepentingan != null && senaraiPihakBerkepentingan.size() > 0) {
            for (int i = 0; i < senaraiPihakBerkepentingan.size(); i++) {
                ...
                permohonanPihak1 = pengambilanService.getSenaraiPmohonPihakByIdHakmilikIdPihak(idSblm,hakmilik.getIdHakmilik(),hakmilikPihakBerkepentingan.getPihak().getIdPihak());
                if (permohonanPihak1 != null) {
                    permohonanTuntutanKosList1 = pengambilanService.findByIdPermohonanPihak2(permohonanPihak1.getIdPermohonanPihak());
...
//                    amaunSebenarTotalList.add(amaunSebenarTotal);
        ...
        amaunSebenarTotal  = amaunSebenarTuanTotal;
    ...
    public void rehydrate() {
        ...
        if (p != null) {
            ...
            if(permohonanTuntutanKos != null)
            {
                ...
                item = permohonanTuntutanKos.getItem();
                System.out.println("---------iterm kt rehydrate------------"+item);
                System.out.println("---------permohonan kt rehydrate------------"+idPermohonan);
            }
            }
    }
    ...
    public Resolution deleteSingle() {
        ...
        if (permohonanTuntutanKos != null) {
         ...
         if(getContext().getRequest().getSession().getAttribute("idHakmilik")!=null){
            ...
            if(permohonanPihak!=null){
             permohonanTuntutanKosList =  pengambilanService.findByIDMohonKos(idPermohonan);
            }
...
//        aduanLokasi = enforceService.findAduanLokasiByIdAduan(Long.parseLong(idAduanLokasi));
        ...
        logger.debug("KiraDepositActionBean::simpan::" + permohonanTuntutanKos.getIdKos());
        return new JSP("pengambilan/kiraDeposit.jsp").addParameter("tab", "true");
//        return new RedirectResolution(KiraDepositActionBean.class, "locate");
    }
