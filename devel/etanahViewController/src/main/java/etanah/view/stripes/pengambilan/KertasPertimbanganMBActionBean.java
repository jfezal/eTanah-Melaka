/*
    Document   : KertasPertimbanganMBActionBean
    Created on : Jun 26, 2010, 4:13:01 PM
    Author     : MASSITA
 ...
 * @author massita
 */
@UrlBinding("/pengambilan/kertasPertimbanganMB")
public class KertasPertimbanganMBActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(KertasPertimbanganMBActionBean.class);
    @Inject
...
//        getContext().getRequest().setAttribute("ptd", Boolean.FALSE);
//        getContext().getRequest().setAttribute("ptg", Boolean.FALSE);
        return new JSP("pengambilan/kertasPertimbanganMenteriBesar.jsp").addParameter("tab", "true");
    }
...
//           getContext().getRequest().setAttribute("form", Boolean.TRUE);
    ...
    public void rehydrate() {
        ...
        sb.append(permohonan.getSebab()).append(".");
...
//                    //TODO : change peranan utama// 4 ptg
//                    if (p.getPerananUtama().getKod().equals("12")) {
//                        listPp.add(p);
//                        getContext().getRequest().setAttribute("form", Boolean.TRUE);
//                        getContext().getRequest().setAttribute("ptg", Boolean.TRUE);
//                         getContext().getRequest().setAttribute("ptd", Boolean.TRUE);
//                     }
//                        4 ptptdpengambilan
//                       if (p.getPerananUtama().getKod().equals("14")) {
//                        listPp.add(p);
//                        getContext().getRequest().setAttribute("form", Boolean.TRUE);
//                        getContext().getRequest().setAttribute("ptg", Boolean.FALSE);
//                        getContext().getRequest().setAttribute("ptd", Boolean.FALSE);
...
////                       4 kptptdpengambilan1- ketua pembantu tdbir pengambilan
//                       if (p.getPerananUtama().getKod().equals("15")) {
//                        listPp.add(p);
////                            getContext().getRequest().setAttribute("form", Boolean.TRUE);
//                        getContext().getRequest().setAttribute("!ptg", Boolean.TRUE);
//                        getContext().getRequest().setAttribute("!ptd", Boolean.TRUE);
//                    }
//
//                     4 tptd1- timbalan pentadbir tanah
//                       if (p.getPerananUtama().getKod().equals("17")) {
//                        listPp.add(p);
//                        getContext().getRequest().setAttribute("form", Boolean.TRUE);
//                        getContext().getRequest().setAttribute("ptd", Boolean.TRUE);
//                        getContext().getRequest().setAttribute("ptg", Boolean.FALSE);
//                     }
////
//                    4 ptd1- pentadbir tanah
//                       if (p.getPerananUtama().getKod().equals("53")) {
//                        listPp.add(p);
//                            getContext().getRequest().setAttribute("form", Boolean.TRUE);
//                            getContext().getRequest().setAttribute("ptd", Boolean.TRUE);
//                            getContext().getRequest().setAttribute("!ptg", Boolean.TRUE);
...
//            }
//        }
//        getContext().getRequest().setAttribute("from", Boolean.TRUE);
//        getContext().getRequest().setAttribute("ptg", Boolean.TRUE);
...
//                }
       ...
       if (getContext().getRequest().getParameter("syorPtg.kandungan") != null) {
        ...
        getContext().getRequest().setAttribute("form", Boolean.TRUE);
        return new RedirectResolution(KertasPertimbanganMBActionBean.class, "locate");
    }
