 ...
 * @author user
 */
@UrlBinding("/pelupusan/draf_jksmn/{currentStage}")
public class DrafJKSMNActionBean extends AbleActionBean {
...
//    Logger logger = Logger.getLogger(DrafJKMActionBean.class);
    ...
    public Resolution showForm1() {
        ...
        return new JSP("pelupusan/pcrg/draf_jkm_mlk.jsp").addParameter("tab", "true");
    }
...
//             }
    ...
    public void settingDefaultValue() {
        ...
        if (urusanStatus.equals("PCRG")) {
            ...
            tajuk3 = ", DAERAH ";
        } else if (urusanStatus.equals("PJLB") || urusanStatus.equals("LSTP")) {
        ...
        if (viewForMMKN) {
            ...
            tujuan = "Tujuan permohonan ini adalah untuk mendapatkan pertimbangan Jawatankuasa Sumber Mineral Negeri Sembilan mengenai permohonan daripada " + namaPemohon;
        }
        if (urusanStatus.equals("PJLB") || urusanStatus.equals("LSTP")) {
    ...
    public Resolution simpanPTG() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/pcrg/draf_jkm_mlk.jsp").addParameter("tab", "true");
    }
