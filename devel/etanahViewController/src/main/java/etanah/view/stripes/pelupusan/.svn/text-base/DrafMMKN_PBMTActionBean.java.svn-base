...
@UrlBinding("/pelupusan/draf_mmkn_pbmt")
public class DrafMMKN_PBMTActionBean extends AbleActionBean {
...
//    private BPelService service;
    ...
    public Resolution search() {
        ...
        return new JSP("pelupusan/searchSyaratNyata_pbmt.jsp").addParameter("popup", "true");
    }

    public Resolution showFormCariKodSekatan() {
        index = getContext().getRequest().getParameter("index");
        return new JSP("pelupusan/searchSekatanKpntngn_pbmt.jsp").addParameter("popup", "true");
    }
...
//        stageId = "sedia_draf_mmkn";
	...
	//String perihaltanah1 = " ";
        ...
        ulasanyb = "Pentadbir Tanah Melaka Tengah telah meminta ulasan " + permohonanRujukanLuar.getNamaAgensi() + " melalui surat bilangan PTMT: A4/ " + noruj
...
//        rehydrate();
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/pbmt/draf_mmkn_mlk.jsp").addParameter("tab", "true");
    }
