 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/laporanTanahPengambilan")
public class LaporanTanahPengambilanActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(LaporanTanahPengambilanActionBean.class);
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/melaka/seksyen4/laporan_tanah_new_n9_v2.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (laporanUlasanPPT != null && laporanUlasanPPT.getUlasan() != null) {
                ...
                LOG.info("Laporan Ulasan PPT"+ulasan1);
            }
        ...
        if (idPermohonan != null) {
            ...
            if (idHakmilik != null) {
                ...
                if (jenisKegunaan == 'B') {
                    ...
                    if (pengguna.getKodCawangan().getKod().equals("00")) {
                        if (laporanTanahService.findLaporanTanahByIdMohonIdMH(permohonan.getIdPermohonan(),hakmilikPermohonan.getId()) != null) {
                            permohonanLaporanBangunanPList = laporanTanahService.getLaporBngnByIdLaporan(laporanTanah.getIdLaporan(), "P");
            ...
            if (laporanTanah != null) {
                ...
                return new ForwardResolution("/WEB-INF/jsp/pengambilan/melaka/seksyen4/laporan_tanah_new_n9_v2.jsp").addParameter("tab", "true");
            }
        }
        hakmilikDetails();
        refreshpage();
...
//       refreshpage();
    ...
    public Resolution hapusImej() {
        ...
        return new RedirectResolution(LaporanTanahPengambilanActionBean.class, "showForm");
    }
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(LaporanTanahPengambilanActionBean.class, "locate");
    }
