...
@UrlBinding("/pendaftaran/kemasukan_perincian_hakmilik_utiliti")
public class KemasukanPerincianHakmilikUtilitiActionBean extends AbleActionBean {
...
//    private List<Pihak> listTuanTanah;
    ...
    public Resolution showForm() {
        ...
        String hiddenIdHakmilik = null;
        logger.debug("listKodSeksyenByBpm.size : " + idHakmilik);
        logger.debug("listKodSeksyenByBpm.size : " + idPermohonan);
...
//        idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        ...
        hiddenIdHakmilik = (String) getContext().getRequest().getAttribute("hiddenIdHakmilik");
        ...
        return new JSP("daftar/kemasukan_perincian_hakmilik_utiliti.jsp").addParameter("tab", "true");
    }
...
//        return new JSP("common/paparan_maklumat_hakmilik_permohonan_terperinci.jsp").addParameter("tab", "true");
        ...
        return new RedirectResolution(KemasukanPerincianHakmilikUtilitiActionBean.class
        ).addParameter("showForm2", "").addParameter("tab", "true").addParameter("idHakmilik", idHakmilik).addParameter("idPermohonan", idPermohonan);
    }

    @Before(stages = {LifecycleStage.BindingAndValidation}, on = {"!simpan", "!simpanKelompok"})
    public void rehydrate() {
        
         logger.debug("::rehydrate kodNegeri :" + idHakmilik);
          logger.debug("::rehydrate kodNegeri :" + idPermohonan);
        idHakmilik = (String) getContext().getRequest().getParameter("idHakmilik");
            ...
            for (HakmilikUrusan hakmilikUrusanHmLama1 : hakmilikUrusanHmLama) {
                ...
                if (senaraiPermohonanPihak1.size() > 0) {
                    for (PermohonanPihak mohonPihak : senaraiPermohonanPihak1) {
                        HakmilikPihakBerkepentingan hp = hakmilikPihakKepentinganService.findHakmilikPihakByIdPihak(mohonPihak.getPihak(), mohonPihak.getHakmilik());
                        if (hp == null) {
