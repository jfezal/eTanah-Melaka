...
/**
 *
 * @author shazwan Edit by Aizuddin 6 Jun 2012
 */
@UrlBinding("/pelupusan/lesen_terdahulu_mlcrg")
public class LesenTerdahuluMLCRGActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(LesenTerdahuluMLCRGActionBean.class);
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/lesen_terdahulu_mlcrg.jsp").addParameter("tab", "true");
    }
                ...
                if (permohonan.getPermohonanSebelum() != null) {
                    ...
                    if (permit != null) {
                        ...
                        if (permohonan.getKodUrusan().getKod().equals("MPJLB") || permohonan.getKodUrusan().getKod().equals("MLCRG")) {
                            ...
                            PermohonanLaporanPelan permohonanLaporanPelan = pelupusanService.findByNoLitho(permit.getPermohonan().getIdPermohonan());
                            hakmilikPermohonan.setKeteranganKadarUkur(permohonanLaporanPelan.getNoLitho());
                            mohonTuntutKos = pelupusanService.findMohonTuntutKosByIdPermohonanAndIdTuntut(permit.getPermohonan().getIdPermohonan(), "DISCR");
                            pihak = permit.getPihak();
                        } //End
                    }
                    if (permohonan.getKodUrusan().getKod().equals("PJLB")) {
