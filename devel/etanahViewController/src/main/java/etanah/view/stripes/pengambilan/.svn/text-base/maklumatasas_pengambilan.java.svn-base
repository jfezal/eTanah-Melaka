 ...
 * @author nordiyana
 */
@UrlBinding("/pengambilan/maklumat_asas_pengambilan")
public class maklumatasas_pengambilan extends AbleActionBean {
    private static final Logger logger = Logger.getLogger(maklumatasas_pengambilan.class);
    @Inject
...
//    String tarikhDaftar;
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/maklumat_asas_tanah_pengambilan.jsp").addParameter("tab", "true");
    }
...
//            h.setSyaratNyata(hakmilik.getSyaratNyata());
        ...
        return new RedirectResolution(maklumatasas_pengambilan.class).addParameter("tab", "true");
