 ...
 * @author Rohan
 */
@UrlBinding("/pelupusan/carian_permohonan_terdahulu")
public class CarianPermohonanTerdahuluActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        return new JSP("pelupusan/PopupButton.jsp").addParameter("tab", "true");
    }
