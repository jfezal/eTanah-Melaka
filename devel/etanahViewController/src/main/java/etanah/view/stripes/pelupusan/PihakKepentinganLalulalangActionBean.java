...
@UrlBinding("/pelupusan/pihak_kepentingan_lalulalang")
public class PihakKepentinganLalulalangActionBean extends AbleActionBean {

    private static final Logger LOG = Logger.getLogger(PihakKepentinganLalulalangActionBean.class);
    private static final boolean isDebug = LOG.isDebugEnabled();
    private static String SEARCH_PAGE = "pelupusan/carian_pihak_kepentingan.jsp";
    private static String MAIN_PAGE = "pelupusan/kemasukan_pihak_lalulalang.jsp";
    private static String MAIN_PAGE_POPUP = "pelupusan/kemasukan_pihak_popup.jsp";
    ...
    private PermohonanLaporanPelan mohonLaporPelan;
    private String idHakmilik;
    private String idHakmilikCari;
    private String noLot;
    private String noHM;
    private Hakmilik hakmilik;
    private Hakmilik hakmilikTanah;
    ...
    private String statusPage = new String();
    private String statusBtn = new String();
...
//            }
            ...
            senaraiHakmilikTerlibat = new ArrayList<HakmilikPermohonan>();
            senaraiHakmilikTerlibat = pservice.getHakmilikPermohonanListByCatatanNIdMohon("L", idPermohonan);
            if (StringUtils.isBlank(idHakmilik)) {
                if (senaraiHakmilikTerlibat.size() > 0) {
                    idHakmilik = senaraiHakmilikTerlibat.get(0).getHakmilik().getIdHakmilik();
                    mohonHakmilik = senaraiHakmilikTerlibat.get(0);
                    hakmilikTanah = mohonHakmilik.getHakmilik();
                    mohonLaporPelan = laporanPelukisPelanService.findMohonLaporPelanByidMohon(idPermohonan);
                }
            }
            if (!StringUtils.isBlank(idHakmilik)) {
                hakmilik = hakmilikDAO.findById(idHakmilik);
                hakmilikTanah = hakmilikDAO.findById(idHakmilik);
                mohonLaporPelan = laporanPelukisPelanService.findMohonLaporPelanByidMohon(idPermohonan);
            }
            ...
            if (hakmilik != null) {
                senaraiKeempunyaan = pservice.findHakmilikPihakActiveByHakmilik(hakmilik);
            }
...
//                    }
    ...
    public Resolution showFormLalulalang() {
...
//        }
//        senaraiKeempunyaan = new ArrayList<HakmilikPihakBerkepentingan>();
//        if(StringUtils.isBlank(statusPage)){
//            senaraiHakmilikTerlibat = new ArrayList<HakmilikPermohonan>();
//            senaraiHakmilikTerlibat = pservice.getHakmilikPermohonanListByCatatanNIdMohon(new String(), idPermohonan);
////                senaraiHakmilikTerlibat = permohonan.getSenaraiHakmilik();
//        }else if(statusPage.equals("PHLP_LALU")){
//            senaraiHakmilikTerlibat = new ArrayList<HakmilikPermohonan>();
//            senaraiHakmilikTerlibat = pservice.getHakmilikPermohonanListByCatatanNIdMohon("L", idPermohonan);
//        }
//        if(senaraiHakmilikTerlibat.size()>0){
...
//        }
//        }
        statusPage = "PHLP_LALU"; // THIS IS FOR PHLP PEMILIK LALULALANG
        statusBtn = "OPEN";
        ctx.getRequest().setAttribute("edit", Boolean.TRUE);
        return new JSP(MAIN_PAGE).addParameter("tab", Boolean.TRUE);
    }
    ...
    public Resolution showFormDisplayLalulalang() {
        statusPage = "PHLP_LALU";
        statusBtn = "HIDE";
        return new JSP(MAIN_PAGE).addParameter("tab", Boolean.TRUE);
    }
    ...
    public Resolution simpanPemohon() {
        ...
        return new RedirectResolution(PihakKepentinganLalulalangActionBean.class).addParameter("idHakmilik", idHakmilik);
    }
    ...
    public Resolution editPenerima() {
        ...
        return new JSP("pelupusan/pihak_berkepentingan_edit.jsp").addParameter("popup", "true");
    }
...
//        String tarikhLahir = getContext().getRequest().getParameter("tarikhLahir");
        ...
        if (StringUtils.isNotBlank(copyToAllHakmilik)) {
            ...
            if (StringUtils.isNotBlank(pilih)) {
                ...
                permohonanPihak.setPihakCawangan(pc);
            }
    ...
    public Resolution savePemohonPopup() throws ParseException {
        ...
        return new RedirectResolution(PihakKepentinganLalulalangActionBean.class);
    }
    ...
    public Resolution savePihak() throws ParseException {
        ...
        return new RedirectResolution(PihakKepentinganLalulalangActionBean.class, "selectPihak").addParameter("idPihak", pihakTemp.getIdPihak()).addParameter("idHakmilik", idHakmilik);
        ...
        if (pihakTemp != null) {
            ...
            if (permohonan.getSenaraiHakmilik().size() > 1) {
                ...
                if (StringUtils.isNotBlank(pilih)) {
                    ...
                    permohonanPihakTemp.setPihakCawangan(pc);
                }
    ...
    public Resolution deletePihakCaw() {
        ...
        if (jenisAction.equals("editPenerima")) {
            if (idPemohon.isEmpty()) {
                return new RedirectResolution(PihakKepentinganLalulalangActionBean.class, "editPenerima").addParameter("idMohonPihak", idMohonPihak);
            } else {
                return new RedirectResolution(PihakKepentinganLalulalangActionBean.class, "editPemohon").addParameter("idPemohon", idPemohon);
            }
        } else {
            return new RedirectResolution(PihakKepentinganLalulalangActionBean.class, "selectPihak").addParameter("idPihak", idPihak).addParameter("idHakmilik", idHakmilik);
        }
    }
...
//    private Fraction getSyerTerlibat(
//            String jenisPihak) {
//
...
//                }
//
//                LOG.debug("pihak = " + pemohon.getPihak().getIdPihak());
//                LOG.debug("hakmilik = " + hakmilik.getIdHakmilik());
//                HakmilikPihakBerkepentingan hm = syerService.findSyerPihakFromHakmilikPihak(pemohon.getPihak().getIdPihak(), hakmilik.getIdHakmilik(), null);
//
//                if (hm == null) {
//                    hm = syerService.findSyerPihakFromHakmilikPihak(pemohon.getPihak().getIdPihak(), hakmilik.getIdHakmilik(), jenisPihak);
//                    if (hm == null) {
//                        continue;
//                    }
//
...
//                }
//
//                syerTerlibat = syerTerlibat.add(new Fraction(hm.getSyerPembilang(), hm.getSyerPenyebut()));
//            }
//
//        } else if (senaraiPermohonanAtasPihak != null && senaraiPermohonanAtasPihak.size() > 0) {
//            for (PermohonanAtasPihakBerkepentingan papb : senaraiPermohonanAtasPihak) {
//                if (papb == null) {
//                    continue;
//                }
//
//                HakmilikPihakBerkepentingan hm = papb.getPihakBerkepentingan();
//                if (hm.getSyerPembilang() == 0 && hm.getSyerPenyebut() == 0) {
//                    continue;
//                }
//
...
//    }
    public Resolution carianHakmilikPopup() {
        ...
        return new JSP("pelupusan/carian_Hakmilik_PopupLaluLalang.jsp").addParameter("popup", "true").addParameter("showForm", "false");
    }
    ...
    public Resolution cariHakmilik() {
        ...
        //hakmilik = hakmilikDAO.findById(idHakmilik);
        listHakmilik = pservice.findHakmilikByNoLotORNoHMOrIDHM(!StringUtils.isBlank(noLot) ? noLot : new String(), !StringUtils.isBlank(noHM) ? noHM : new String(), !StringUtils.isBlank(idHakmilikCari) ? idHakmilikCari : new String());
        ...
        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/carian_Hakmilik_PopupLaluLalang.jsp").addParameter("tab", "true");
//        return new JSP("pelupusan/carian_Hakmilik_PopupLaluLalangPemohon.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution simpan() {
        ...
        if (hakmilik == null) {
            ...
            getContext().getRequest().setAttribute("edit", Boolean.TRUE);
            return new JSP("pelupusan/carian_Hakmilik_PopupLaluLalang.jsp").addParameter("popup", "true");

        } else {
            InfoAudit ia = new InfoAudit();
            HakmilikPermohonan hakmilikPermohonan = new HakmilikPermohonan();

//            hakmilikPermohonan = pservice.findByIdPermohonanNCatatan(idPermohonan, "L", hakmilik.getIdHakmilik());
            hakmilikPermohonan = pservice.findIdMH(idPermohonan, hakmilik.getIdHakmilik());
            ...
            hakmilikPermohonan.setCatatan("L");
            ...
            pservice.simpanHakmilikPermohonan(hakmilikPermohonan);
...
//         hakmilikPermohonanList = permohonan.getSenaraiHakmilik();
    ...
    public Resolution deleteIdHakmilik() {
        Pengguna pguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        String idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        permohonan = permohonanDAO.findById(idPermohonan);
        String deleteIdHakmilik = (String) getContext().getRequest().getParameter("deleteIdHakmilik");
        statusPage = (String) getContext().getRequest().getParameter("statusPage");

        LOG.info("deleteIdHakmilik ==== " + deleteIdHakmilik);

        HakmilikPermohonan deletehp = pservice.findIdMH(idPermohonan, deleteIdHakmilik);

        if (deletehp != null) {
            pservice.deletePermohanHakmilik(deletehp);
            addSimpleMessage("Maklumat Hakmilik telah berjaya dihapuskan.");
        }
//         hakmilikPermohonanList = permohonan.getSenaraiHakmilik();
//        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        rehydrate();
//        ForwardResolution("/WEB-INF/jsp/pelupusan/carian_Hakmilik_PopupLaluLalang.jsp").addParameter("tab", "true");
        return new RedirectResolution(PihakKepentinganLalulalangActionBean.class).addParameter("idHakmilik", idHakmilik);
    }

    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(PihakKepentinganLalulalangActionBean.class, "locate");
    }
    ...
    public Hakmilik getHakmilikTanah() {
        return hakmilikTanah;
    }

    public void setHakmilikTanah(Hakmilik hakmilikTanah) {
        this.hakmilikTanah = hakmilikTanah;
    }
    ...
    public PermohonanLaporanPelan getMohonLaporPelan() {
        return mohonLaporPelan;
    }

    public void setMohonLaporPelan(PermohonanLaporanPelan mohonLaporPelan) {
        this.mohonLaporPelan = mohonLaporPelan;
    }
}
