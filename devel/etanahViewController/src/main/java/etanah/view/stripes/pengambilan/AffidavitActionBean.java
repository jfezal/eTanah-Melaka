 ...
 * @author massita
 */
@UrlBinding("/pengambilan/affidavit")
public class AffidavitActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(AffidavitActionBean.class);
    @Inject
...
//    private int bil = 0;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/affidavit.jsp").addParameter("tab", "true");
    }
...
//            if (getContext().getRequest().getParameter("tarikhIkrar.kandungan") != null) {
                ...
                tarikhIkrar.setCawangan(cawangan);
                iaP = new InfoAudit();
                iaP.setTarikhMasuk(new Date());
                iaP.setDimasukOleh(peng);
