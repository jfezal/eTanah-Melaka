 ...
 * @author afham
 */
public class UrusanLPSPermitReportValidator implements StageListener {
        ...
        for (Task t : l) {
        	if(t.getSystemAttributes().getStage() != null) {
                ...
                //Semua batuan untuk report jabatan teknikal and Adun
                  ...
                  //Semua batuan untuk surat laporan tanah
                     if(stage.contentEquals("semak_laporan_tanah")){
                    ...
                    if (stage.contentEquals("semakan_rencana2")) {
                     ...
                     //Untuk keluar surat wang cagaran tidak dipulangkan
                      if(stage.contentEquals("keluar_surat")){
                             gen1 = "DISWC_MLK.rdf";
                                code1 = "SWC";
                                kd = kodDokumenDAO.findById(code1);
                                LOGGER.info(kd);
