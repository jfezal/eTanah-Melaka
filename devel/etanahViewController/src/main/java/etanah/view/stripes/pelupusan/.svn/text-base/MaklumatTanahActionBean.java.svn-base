 ...
 */
@UrlBinding("/pelupusan/maklumat_tanah")
public class MaklumatTanahActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/maklumat_tanah_dipohon.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("PRMP")) {
                ...
                if (pmi != null) {
                    kodGunaTanah = pmi.getKodItemPermit().getKod();
                }
            }
            ...
            if (negeri.equals("04") && permohonan.getKodUrusan().getKod().equals("LMCRG")) {
                ...
                if (permohonanLaporanPelan != null) {
                    ...
                    if (hakmilikPermohonan != null) {
                        if (!StringUtils.isEmpty(hakmilikPermohonan.getNoUnitPetak())) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("PLPS") || permohonan.getKodUrusan().getKod().equals("PTPBP") || permohonan.getKodUrusan().getKod().equals("PRMP") || permohonan.getKodUrusan().getKod().equals("PLPTD") || permohonan.getKodUrusan().getKod().equals("RLPS") || permohonan.getKodUrusan().getKod().equals("RLPSK")) {
...
//                     permohonanLaporanPelan.setCatatan(tandaBlok);
            ...
            if (permohonan.getKodUrusan().getKod().equalsIgnoreCase("PLPS") || permohonan.getKodUrusan().getKod().equalsIgnoreCase("PLPTD") || permohonan.getKodUrusan().getKod().equalsIgnoreCase("RLPS") || permohonan.getKodUrusan().getKod().equalsIgnoreCase("RLPSK")) {
    ...
    public Resolution simpanHakmilikPRIZMLK() {
        ...
        if (permohonan != null) {
            if (permohonan.getKodUrusan().getKod().equals("PRIZ") || permohonan.getKodUrusan().getKod().equals("PRMMK")) { //Tambah else if utk priz
                TanahRizabPermohonan mohonTrizabTemp = new TanahRizabPermohonan();
                mohonTrizabTemp = pelupusanService.findTanahRizabByIdPermohonan(idPermohonan);
                InfoAudit ia = new InfoAudit();
                if (mohonTrizabTemp != null) {
...
//        logger.info("THIS IS KODDAERAH->"+kod);
    ...
    public static void setLogger(Logger logger) {
        MaklumatTanahActionBean.logger = logger;
    }
...
//        logger.info("THIS IS KODBPM ->"+kodBpm);
    ...
    public static void setKodDaerahStatic(String kodDaerahStatic) {
        MaklumatTanahActionBean.kodDaerahStatic = kodDaerahStatic;
    }
