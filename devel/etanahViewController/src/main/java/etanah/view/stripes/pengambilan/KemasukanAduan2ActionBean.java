 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/kemasukanaduan2")
public class KemasukanAduan2ActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(KemasukanAduan2ActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/kemasukan_aduan_menu.jsp").addParameter("tab", "true");
    }
