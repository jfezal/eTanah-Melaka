/*
    Document   : Draf MMK for MPJLB
    Created on : May 28, 2012, 5:45 PM
    Author     : Aizuddin Orogenic Group
    Description: Draf MMK for MPJLB and MLCRG
 */
...
@UrlBinding("/pelupusan/draf_mmk_mpjlb/{currentStage}")
public class DrafMMK_MPJLBActionBean extends AbleActionBean{
    
    Logger logger = Logger.getLogger(DrafMMK_MPJLBActionBean.class);
    @Inject
    ...
    //Add for changing urusan MPJLB because of HakmilikPermohonan is getting from permohonan.getPermohonanSebelum
    ...
    public Resolution editForm() {
        ...
        return new JSP("pelupusan/carigali/draf_jkm_mlk_mpjlb.jsp").addParameter("tab", "true");
    } 
    ...
    public Resolution editFormMMKN() {
...
//        }
        ...
        if (mohonKertas != null) {
            ...
            mohonKertas.setTajuk("DRAF KERTAS JKSMN");
...
//         0401DIS2011012501 
     ...
     public void settingDefaultValue() {
        ...
        if(urusanStatus.equals("MLCRG"))
            tajuk = " PERMOHONAN UNTUK MEMPERBAHARUI LESEN MENCARIGALI DAN PENJELAJAHAN (S.41) ";
        else if(urusanStatus.equals("MPJLB"))
            tajuk = " PERMOHONAN UNTUK MEMPERBAHARUI LESEN PAJAKAN MELOMBONG (S.66) ";
            tajuk2 = " LOT "+mohonHakmilik.getNoLot()+" ";
            tajuk3 = ", DAERAH ";
            tajuk4 = " UNTUK TUJUAN JUALAN";
        
        if(viewForMMKN) {
            topTopic = "MAJLIS MESYUARAT KERAJAAN NEGERI MELAKA";
            ...
            topTopic = "MESYUARAT JAWATANKUASA SUMBER MINERAL NEGERI MELAKA";
        ...
        if(urusanStatus.equals("MLCRG"))
            tujuan2 = " untuk memperbaharui Lesen Mencarigali Dan Penjelajahan ";
        else if(urusanStatus.equals("MPJLB"))
            tujuan2 = " untuk memperbaharui Lesen Pajakan Melombong ";
            tujuan3 = ", ";
            tujuan4 = ", Daerah ";
        if(urusanStatus.equals("MPJLB"))
            tujuan5 = " untuk tujuan memperbaharui lesen pajakan lombong";
        else
            tujuan5 = " ";
    ...
    public Resolution simpanPTG() {
        ...
        mohonKertas = pservice.findKertasByKod(idPermohonan, "MPJLB");
...
//        return new ForwardResolution("/WEB-INF/jsp/pelupusan/draf_mmkn_ptd.jsp").addParameter("tab", "true");
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/carigali/draf_jkm_mlk_mpjlb.jsp").addParameter("tab", "true");
    }
...
//                LOG.info("alamak!! tiada index");
     ...
     public void updateKandungan(int i, String kand) {
        ...
        if (permohonan.getKodUrusan().getKod().equals("MPJLB")) {
            mohonKertas.setTajuk("DRAF MAJLIS MESYUARAT KERAJAAN NEGERI");
