 ...
 */
@UrlBinding("/pelupusan/draf_jkbb")
public class DrafJKBBActionBean extends AbleActionBean {
...
//    private PermohonanKertas permohonankertas;
    ...
    private FasaPermohonan fp; //Add for filtering keputusan sokong and tidak disokong
    private String kpsn;
    ...
    public Resolution showForm1() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/batuan/draf_jkbb_mlk.jsp").addParameter("tab", "true");
    }
//    @DefaultHandler
    ...
    public Resolution showFormNS1() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/draf_jkbb_ns.jsp").addParameter("tab", "true");
    }

    public Resolution showFormNS2() {
        edit = Boolean.TRUE;
        return new JSP("pelupusan/draf_jkbb_ns.jsp").addParameter("tab", "true");
    }
...
//        stageId = "semak_draf_rencana_ptd2";
        PermohonanRujukanLuar mrl = pelupusanService.findPermohonanRujByIdPermohonanKodRuj(idPermohonan, "UT");
        logger.info("mrl = " + mrl);
        if (mrl != null) {
            logger.info("surat = " + mrl.getNoRujukan());
            logger.info("tarikh = " + mrl.getTarikhRujukan());
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            String tarikh = getContext().getRequest().getParameter("tarikh");

            surat = mrl.getNoRujukan();
            if (mrl.getTarikhRujukan() != null) {
                tarikh = sdf.format(mrl.getTarikhRujukan());
            }
        }
//        stageId = "semak_laporan_tanah";
        fp = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, stageId);
...
//            stageId = "sedia_rencana_syor";
            ...
            if (kodNeg.equals("04")) {
                if (urusanStatus.equals("PPBB")) {
                    tajukHeader = "DRAF RENCANA UNTUK PERTIMBANGAN MESYUARAT JAWATANKUASA BELAH BAHAGI NEGERI " + namaNegeri;
                    if (stageId.equals("perakuan_draf_rencana_km") || stageId.equals("sedia_draf_rencana_km") || stageId.equals("semak_draf_rencana_km1") || stageId.equals("semak_draf_rencana_km2") || stageId.equals("sedia_draf_jkbb")) {
                        if (stageId.equals("sedia_draf_rencana_km") || stageId.equals("semak_draf_rencana_km1") || stageId.equals("semak_draf_rencana_km2")) {
                            viewOnlyPTD = false;
                        }
                        if (stageId.equals("perakuan_draf_rencana_km")) {
                            viewOnlyPTD = true;
                    ...
                    if (stageId.equals("perakuan_rencana_jkbb") || stageId.equals("sedia_dokumen") || stageId.equals("sedia_draf_jkbb") || stageId.equals("semak_rencana_jkbb") || stageId.equals("semak_rencana_jkbb2") || stageId.equals("terima_permohonan_ptd")) {
                        if (stageId.equals("terima_permohonan_ptd") || stageId.equals("perakuan_rencana_jkbb") || stageId.equals("sedia_draf_jkbb") || stageId.equals("semak_rencana_jkbb") || stageId.equals("semak_rencana_jkbb2")) {
//                        viewOnlyPTG = false;
                            viewOnlyPTG = true;
                    ...
                    if (stageId.equals("terima_permohonan_ptd2") || stageId.equals("sedia_dokumen2") || stageId.equals("sedia_draf_km") || stageId.equals("semak_rencana_km") || stageId.equals("semak_rencana_km2") || stageId.equals("perakuan_rencana_km")) {
                        if (stageId.equals("terima_permohonan_ptd2") || stageId.equals("perakuan_rencana_km") || stageId.equals("sedia_draf_km") || stageId.equals("semak_rencana_km") || stageId.equals("semak_rencana_km2")) {
//                        viewOnlyPTG = false;
                            viewOnlyPTG = true;
                            viewOnlyPTGOnly = false;
                        } else {
...
//                stageId = "semak_draf_rencana_ptd2";
                if (urusanStatus.equals("PBPTD")) {
                    tajukHeader = "RENCANA UNTUK PERTIMBANGAN PENTADBIR TANAH DAERAH " + drafDaerah;
                    stageId = "semak_draf_rencana_ptd2";
                    if (stageId.equals("laporan_tanah") || stageId.equals("sedia_draf_rencana_ptd") || stageId.equals("semak_draf_rencana_ptd1") || stageId.equals("semak_draf_rencana_ptd2") || stageId.equals("perakuan_draf_rencana_ptd")) {
                        if (stageId.equals("laporan_tanah") || stageId.equals("sedia_draf_rencana_ptd") || stageId.equals("semak_draf_rencana_ptd1") || stageId.equals("semak_draf_rencana_ptd2")) {
                            viewOnlyPTD = false;
                        }
                        if (stageId.equals("perakuan_draf_rencana_ptd")) {
                            viewOnlyPTD = true;
                            viewOnlyPTDOnly = false;
                        } else {
                            viewOnlyPTD = true;
                ...
                if (urusanStatus.equals("PBPTG")) {
                    tajukHeader = "RENCANA UNTUK PERTIMBANGAN YANG BERBAHAGIA PENGARAH TANAH DAN GALIAN NEGERI MELAKA ";
                    if (stageId.equals("laporan_tanah") || stageId.equals("semakan_rencana2") || stageId.equals("semak_draf_rencana_ptg2") || stageId.equals("semak_draf_rencana_ptg1") || stageId.equals("sedia_draf_rencana_ptg") || stageId.equals("semakan_rencana1") || stageId.equals("perakuan_draf_rencana_ptg")) {
                        if (stageId.equals("laporan_tanah") || stageId.equals("semak_draf_rencana_ptg2") || stageId.equals("semak_draf_rencana_ptg1") || stageId.equals("sedia_draf_rencana_ptg")) {
                            viewOnlyPTD = false;
                        }
                        if (stageId.equals("perakuan_draf_rencana_ptg")) {
                            viewOnlyPTD = true;
                            viewOnlyPTDOnly = false;
                        } else {
                            viewOnlyPTD = true;
                    ...
                    if (stageId.equals("semakan_peraku") || stageId.equals("semak_peraku") || stageId.equals("semakan_rencana2") || stageId.equals("semakan_rencana1") || stageId.equals("sedia_rencana_syor") || stageId.equals("semakan_rencana1a")) {
                        if (stageId.equals("semakan_peraku") || stageId.equals("semak_peraku") || stageId.equals("semakan_rencana2") || stageId.equals("semakan_rencana1") || stageId.equals("sedia_rencana_syor") || stageId.equals("semakan_rencana1a")) {
//                        viewOnlyPTG = false;
                            viewOnlyPTD = true;
                            viewOnlyPTG = true;
                ...
                if (urusanStatus.equals("LPSP")) {
                    tajukHeader = "DRAF MMKN ";
                    if (stageId.equals("sedia_draf_rencana_ptg") || stageId.equals("semak_draf_rencana_ptg1") || stageId.equals("semak_draf_rencana_ptg2") || stageId.equals("perakuan_draf_rencana_ptg")) {
                        if (stageId.equals("sedia_draf_rencana_ptg")) {
                            viewOnlyPTD = false;
                        } else {
                            viewOnlyPTD = true;
                        }
                    ...
                    if (stageId.equals("06TerimaMMKN") || stageId.equals("07SemakDrafMMKN") || stageId.equals("08SemakanMMKN") || stageId.equals("09SemakanMMKN") || stageId.equals("10PindaanMMKN") || stageId.equals("11PerakuMMKN")) {
                        if (stageId.equals("06TerimaMMKN")) {
                            viewOnlyPTG = false;
                        } else {
                            viewOnlyPTG = true;
                        }
                ...
                if (urusanStatus.equals("PBPTD")) {
                    tajukHeader = "RENCANA UNTUK PERTIMBANGAN PENTADBIR TANAH DAERAH " + drafDaerah;
                    if (stageId.equals("sedia_kertas_ptd") || stageId.equals("semak_draf_ptd") || stageId.equals("semakhurai_draf_ptd") || stageId.equals("keputusan")) {
                        if (stageId.equals("sedia_kertas_ptd") || stageId.equals("semak_draf_ptd") || stageId.equals("semakhurai_draf_ptd")) {
                            viewOnlyPTD = false;
                        }
                ...
                if (urusanStatus.equals("PBPTG")) {
                    tajukHeader = "RENCANA UNTUK PERTIMBANGAN PENGARAH TANAH DAN GALIAN ";
                    if (stageId.equals("sedia_kertas_ptg") || stageId.equals("semak_draf_ptg") || stageId.equals("semakhurai_draf_ptg") || stageId.equals("perakuan_draf_ptg")) {
                        if (stageId.equals("sedia_kertas_ptg") || stageId.equals("semak_draf_ptg") || stageId.equals("semakhurai_draf_ptg")) {
                            viewOnlyPTD = false;
                        }
                        if (stageId.equals("perakuan_draf_ptg")) {
                            viewOnlyPTD = true;
                            viewOnlyPTDOnly = false;
                        } else {
                            viewOnlyPTD = true;
                    ...
                    if (stageId.equals("semakan_draf") || stageId.equals("semakan_syor_draf") || stageId.equals("perakuan_draf") || stageId.equals("keputusan_ptg")) {
                        if (stageId.equals("semakan_draf") || stageId.equals("semakan_syor_draf") || stageId.equals("perakuan_draf") || stageId.equals("keputusan_ptg")) {
//                        viewOnlyPTG = false;
                            viewOnlyPTD = true;
                            viewOnlyPTG = true;
                ...
                if (urusanStatus.equals("PBMMK")) {
                    tajukHeader = "DRAF RENCANA UNTUK PERTIMBANGAN MAJLIS MESYUARAT KERAJAAN " + namaNegeri;
                    if (stageId.equals("sedia_kertas_ptg") || stageId.equals("semak_draf_ptg") || stageId.equals("semakhurai_draf_ptg") || stageId.equals("perakuan_draf_ptg")) {
                        if (stageId.equals("sedia_kertas_ptg") || stageId.equals("semak_draf_ptg") || stageId.equals("semakhurai_draf_ptg")) {
                            viewOnlyPTD = false;
                        }
                    ...
                    if (stageId.equals("semakan_draf_mmk") || stageId.equals("semakan_syor_draf") || stageId.equals("semakhurai_draf") || stageId.equals("perakuan_draf") || stageId.equals("cetak_kertas_mmk")) {
                        if (stageId.equals("semakan_draf_mmk") || stageId.equals("semakan_syor_draf") || stageId.equals("semakhurai_draf") || stageId.equals("perakuan_draf")) {
//                        viewOnlyPTG = false;
                            viewOnlyPTG = true;
                            viewOnlyPTGOnly = false;
                        } else {
...
//                        viewOnlyPTG = false;
            ...
            syaratBahanBatu = pelupusanService.findPermohonanBahanBatuanByIdMohon(idPermohonan);
...
//                            mohonRujuk.setUlasan(ulasanAgensi);
            ...
            if (kpsn != null) {
                if (kpsn.equals("SL")) {
                    if (hakmilikPermohonan.getKodMilik() != null) {
                        if (hakmilikPermohonan.getKodMilik().getKod().equals('H') || hakmilikPermohonan.getKodMilik().getKod().equals('S')) {
                            if (syaratBahanBatu.getJenisBahanBatu().getKod().equals("BG") || syaratBahanBatu.getJenisBahanBatu().getKod().equals("PS")
                                ...
                                royalti = syaratBahanBatu.getJenisBahanBatu().getRoyaltiTanahMilik().toString();
            ...
            if (mohonKertas != null) {
                no_ruj = mohonKertas.getNoLaporan();
...
//                BigDecimal percent = BigDecimal.valueOf(percentDouble);
    ...
    public void settingBil0(List senaraiMohonPermitItem) {
        /*
        ...
        for (int i = 0; i < senaraiMohonPermitItem.size(); i++) {
            ...
            } else if (i != senaraiMohonPermitItem.size() - 1) {
        ...
        if (hakmilikPermohonan.getBandarPekanMukimBaru().getNama() != null) {
            if (pemohon != null) {
                logger.info("masuk != null");
                tajukMainDraf = tajuk + permitItem + " " + jenisBahanBatu + " sebanyak " + mohonBahanBatuan.getJumlahIsipaduDipohon() + " " + mohonBahanBatuan.getJumlahIsipaduDipohonUom().getNama() + " DARIPADA "
                        + pemohon.getPihak().getNama() + tajuk4 + " " + hakmilikPermohonan.getBandarPekanMukimBaru().getNama() + " DAERAH " + permohonan.getCawangan().getDaerah().getNama() + " UNTUK TUJUAN " + permohonan.getSebab() + noktah;
            } else {
                tajukMainDraf = tajuk + permitItem + " " + jenisBahanBatu + " sebanyak " + mohonBahanBatuan.getJumlahIsipaduDipohon() + " " + mohonBahanBatuan.getJumlahIsipaduDipohonUom().getNama()
                        + tajuk4 + " " + hakmilikPermohonan.getBandarPekanMukimBaru().getNama() + " DAERAH " + permohonan.getCawangan().getDaerah().getNama() + " UNTUK TUJUAN " + permohonan.getSebab() + noktah;
            }
        }
    }
    ...
    public void settingBil1(List senaraiMohonPermitItem) {
        ...
        if (permohonan.getSebab() != null) {
            sebab = pelUtiliti.convertStringtoInitCap(permohonan.getSebab());
        }

        if (mohonBahanBatuan.getJumlahIsipaduUom() != null) {
            uom_name = pelUtiliti.convertStringtoInitCap(mohonBahanBatuan.getJumlahIsipaduUom().getNama());
        }
        ...
        if (kpsn != null) {
            if (kpsn.equals("SL")) {
                ...
                System.out.println(pelUtiliti.convertStringtoInitCap(tempohUnit));
                if (pemohon != null) {
                    tajukTujuanDraf = tujuan + tujuan2 + jenisBahanBatu + tujuan3 + mohonBahanBatuan.getJumlahIsipadu() + " " + uom_name + " pada tempoh " + mohonBahanBatuan.getTempohKeluar() + " " + pelUtiliti.convertStringtoInitCap(tempohUnit) + " daripada " + pemohon != null ? pelUtiliti.convertStringtoInitCap(pemohon.getPihak().getNama()) : null + " " + pelUtiliti.convertStringtoInitCap(hakmilikPermohonan.getBandarPekanMukimBaru().getNama()) + " Daerah " + pemohon != null ? pelUtiliti.convertStringtoInitCap(pemohon.getCawangan().getDaerah().getNama()) : null + " untuk tujuan " + sebab + noktah;
                } else {
                    tajukTujuanDraf = tujuan + tujuan2 + jenisBahanBatu + tujuan3 + mohonBahanBatuan.getJumlahIsipadu() + " " + uom_name + " pada tempoh " + mohonBahanBatuan.getTempohKeluar() + " " + pelUtiliti.convertStringtoInitCap(tempohUnit) + " " + pelUtiliti.convertStringtoInitCap(hakmilikPermohonan.getBandarPekanMukimBaru().getNama()) + " untuk tujuan " + sebab + noktah;
                }
            } else {
                String tempohUnit = new String();
                tempohUnit = mohonBahanBatuan.getUnitTempohKeluar().getKod().equalsIgnoreCase("B") ? "Bulan" : mohonBahanBatuan.getUnitTempohKeluar().getKod().equalsIgnoreCase("T") ? "Tahun" : "Hari";
                System.out.println(pelUtiliti.convertStringtoInitCap(tempohUnit));
                tajukTujuanDraf = tujuan + tujuan2 + jenisBahanBatu + tujuan3 + mohonBahanBatuan.getJumlahIsipaduDipohon() + " " + uom_name + " pada tempoh " + mohonBahanBatuan.getTempohKeluar() + " " + pelUtiliti.convertStringtoInitCap(tempohUnit) + " daripada " + pelUtiliti.convertStringtoInitCap(pemohon.getPihak().getNama()) + " " + pelUtiliti.convertStringtoInitCap(hakmilikPermohonan.getBandarPekanMukimBaru().getNama()) + " Daerah " + pelUtiliti.convertStringtoInitCap(pemohon.getCawangan().getDaerah().getNama()) + " untuk tujuan " + sebab + noktah;
            }
        }
    }

    public void settingBil211(List senaraiMohonPermitItem) {
        /*
        ...
        if (pemohon != null) {
            tajukPerihalPermohonan = perihalpermohonan + jenisBahanBatu + perihalpermohonan2 + pelUtiliti.convertStringtoInitCap(pemohon.getPihak().getNama()) + " " + perihalpermohonan3 + date2 + noktah;
        } else {
            tajukPerihalPermohonan = perihalpermohonan + jenisBahanBatu + " " + perihalpermohonan3 + date2 + noktah;
        }
    }

    public void settingBil221(List senaraiMohonPermitItem) {
        /*
        ...
        if (pemohon != null) {
            ...
            } else if (pemohon.getPihak().getJenisPengenalan().getKod().equals("0")) {
                perihalPemohon = pelUtiliti.convertStringtoInitCap(pemohon.getPihak().getJenisPengenalan().getNama());
            } else {
    ...
    public void settingBil231(List senaraiMohonPermitItem) {
        /*
    ...
    public void settingDefaultValue() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PPBB")) {
            ...
            if (kodNeg.equals("04")) {
                tujuan = " Tujuan rencana ini ialah untuk mendapatkan pertimbangan Yang Berbahagia Pengarah Tanah dan Galian negeri Melaka mengenai permohonan ";
            } else if (kodNeg.equals("05")) {
                tujuan = " Tujuan rencana ini ialah untuk mendapatkan pertimbangan Pengarah Tanah dan Galian, Negeri Sembilan mengenai permohonan ";
            }
        } else if (permohonan.getKodUrusan().getKod().equals("PBMMK")) {

            tujuan = " Tujuan rencana ini ialah untuk mendapatkan pertimbangan Majlis Mesyuarat Kerajaan Negeri Sembilan mengenai permohonan ";
        ...
        kuantiti = " Kuantiti Disyorkan ";
        kuantiti2 = " Meter padu. ";

        tempoh = " Tempoh Disyorkan ";

        kadarBayar = " Kadar Royalti ";
        kadarBayar2 = " RM " + royalti + "semeter padu ";

        jumlahBayar = "Jumlah Royalti yang dikenakan";
        jumlahBayar2 = " RM " + royalti + " x ";
...
//        }
    ...
    public Resolution SimpandrafJKBB() throws ParseException {
        idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        peng = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        String editTest = (String) getContext().getRequest().getParameter("edit");
        if (editTest != null && !("").equals(editTest)) {
...
//                addSimpleError("Sila pilih keputusan di Perakuan Pentadbir Tanah.");
//
//                return new JSP("pelupusan/batuan/draf_jkbb_mlk.jsp").addParameter("tab", "true");
//            }
            /*
...
//                            mohonRujuk.setUlasan(ulasanAgensi);
                ...
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                String surat = getContext().getRequest().getParameter("surat");
                String tarikh = getContext().getRequest().getParameter("tarikh");

                PermohonanRujukanLuar mrl = pelupusanService.findPermohonanRujByIdPermohonanKodRuj(permohonan.getIdPermohonan(), "UT");
                if (mrl == null) {
                    ...
                    prl.setCawangan(peng.getKodCawangan());
                    prl.setNoRujukan(surat);

                    if (!tarikh.isEmpty()) {
                        prl.setTarikhRujukan(sdf.parse(tarikh));
                    } else {
                        prl.setTarikhRujukan(null);
                    }

                    KodRujukan kr = new KodRujukan();
                    kr = kodRujukanDAO.findById("UT");
                    prl.setKodRujukan(kr);

                    pelupusanService.simpanPermohonanRujLuar(prl);
                } else {
                    PermohonanRujukanLuar prl = pelupusanService.findPermohonanRujByIdPermohonanKodRuj(permohonan.getIdPermohonan(), "UT");
                ...
                String keputusan = getContext().getRequest().getParameter("keputusan");
                logger.info("keputusan -- " + keputusan);
                fp = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, stageId);
//                if (fp != null) {
//                    KodKeputusan kp = new KodKeputusan();
//                    kp = kodKeputusanDAO.findById(keputusan);
//                    fp.setKeputusan(kp);
//
//                    pelupusanService.simpanFasaPermohonan(fp);
//                }
...
//        String lulus = (String) getContext().getRequest().getParameter("lulus");
        String tolakTulus = (getContext().getRequest().getParameter("keputusan"));
//        String lulus = (String) getContext().getRequest().getSession().getAttribute("lulus");
        stageId = "semak_draf_rencana_ptd2";
        if (stageId.equals("semak_draf_rencana_ptd2")) {
            FasaPermohonan fasa = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, stageId);
            if (tolakTulus != null) {
                KodKeputusan kp = kodKeputusanDAO.findById(tolakTulus);
                fasa.setKeputusan(kp);
                pelupusanService.simpanFasaPermohonan(fasa);
            }
        }
        rehydrate();
...
//        logger.info(permohonankertas.getKodDokumen().getKod());
        ...
        System.out.println("PBMMK :" + kod.getKod());
...
//            LOG.info("PLK" + pLK.getSubtajuk());
    ...
    public Resolution SimpandrafJKBBNS() {
        System.out.println("no ruj 2:" + no_ruj);
        idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        peng = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        String editTest = (String) getContext().getRequest().getParameter("edit");
        if (editTest != null && !("").equals(editTest)) {
            ...
            if (permohonan != null) {
                ...
                if (mohonKertas == null) {
                    ...
                    if (permohonan.getKodUrusan().getKod().equals("PBMMK")) {
                        mohonKertas.setTajuk("Draf MMK");
                        mohonKertas.setKodDokumen(kodDokumenDAO.findById("MMK"));
                    } else {
                        mohonKertas.setTajuk("Draf JKBB");
                        mohonKertas.setKodDokumen(kodDokumenDAO.findById("JKBB"));
                    }
                ...
                if (mohonKertas != null) {
                    if (urusanStatus.equals("PBMMK")) {
                        if (stageId.equals("semakan_draf_mmk")) {
                            System.out.println("no ruj 1:" + no_ruj);
                            mohonKertas.setNoLaporan(no_ruj);
                            pelupusanService.simpanPermohonanKertas(mohonKertas);
                        }
                    }
                    if (urusanStatus.equals("PPTR")) {
                        if (stageId.equals("PPTR")) {
                            System.out.println("no ruj 1:" + no_ruj);
                            mohonKertas.setNoLaporan(no_ruj);
                            pelupusanService.simpanPermohonanKertas(mohonKertas);
                        }
...
//                            mohonRujuk.setUlasan(ulasanAgensi);
    ...
    public Resolution simpanKandunganNS() throws ParseException {
...
//                  break;   
    ...
    public Resolution deleteRowNS() throws ParseException {
    ...
    public void updateKandunganNS(int i, String kand) {
