 ...
 * @author mohd.faidzal
 */
public class SemakKemasukanADOValidator implements StageListener {
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        sek8aIntegrationFlowService.completeTask(ref.AGIHAN_PPELAN_LAPORAN_TANAH, context.getPermohonan(), context.getPengguna());
