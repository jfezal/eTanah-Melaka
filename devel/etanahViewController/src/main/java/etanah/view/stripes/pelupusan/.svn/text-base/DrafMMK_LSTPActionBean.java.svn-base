 ...
 * @author user
 */
@UrlBinding("/pelupusan/draf_MMKLSTP/{currentStage}")
public class DrafMMK_LSTPActionBean extends AbleActionBean {
...
//    Logger logger = Logger.getLogger(DrafJKMActionBean.class);
    ...
    public Resolution showForm1() {
        ...
        return new JSP("pelupusan/pjlb/draf_mmk_LSTP.jsp").addParameter("tab", "true");
    }
...
//        String nolot = mohonHakmilik.getLot().getKod();
        ...
        mohonKertas = pservice.findPermohonanKertasByIdPermohonanNKodDokumen(idPermohonan, "RMN");
        if (mohonKertas != null) {
            ...
            mohonKertas.setTajuk("KERTAS MMKN");
...
//             }
    ...
    public void settingDefaultValue() {
        ...
        if (viewForMMKN) {
            ...
            tujuan = "Kertas ini bertujuan untuk mendapatkan pertimbangan dan keputusan Majlis Mesyuarat Kerajaan Negeri, Negeri Sembilan terhadap rayuan daripada " + namaPemohon;
        }
        if (urusanStatus.equals("PJLB")) {
            ...
            tujuan2 = " untuk mendapatkan Lesen Melombong Tuan Punya ";
            tujuan3 = ", ";
            tujuan4 = ", Daerah ";
        } else if (urusanStatus.equals("LPJH")) {
    ...
    public void settingBil2() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PJLB") || permohonan.getKodUrusan().getKod().equals("LSTP")) {
            tujuanPermohonan = tujuan + tujuan2 + " di " + mukim + ", " + daerah + " seluas lebih kurang " + mohonHakmilik.getLuasTerlibat() + " " + mohonHakmilik.getKodUnitLuas().getNama() + " mengikut Seksyen 41 Enakmen Mineral Negeri 2002 " + noktah;
    ...
    public Resolution simpanPTG() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/pjlb/draf_mmk_LSTP.jsp").addParameter("tab", "true");
    }
