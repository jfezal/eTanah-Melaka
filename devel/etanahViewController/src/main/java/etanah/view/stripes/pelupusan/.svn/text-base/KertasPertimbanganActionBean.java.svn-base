 ...
 */
@UrlBinding("/pelupusan/kertas_pertimbangan")
...
//        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        return new JSP("pelupusan/kertas_pertimbangan.jsp").addParameter("tab", "true");
    }
...
////                    Logger.getLogger(KertasPertimbanganActionBean.class.getName()).log(Level.SEVERE, null, ex);
////                }
////
...
//            }
        ...
        return new ForwardResolution("/WEB-INF/jsp/common/kertas_pertimbangan.jsp").addParameter("tab", "true");
    }
