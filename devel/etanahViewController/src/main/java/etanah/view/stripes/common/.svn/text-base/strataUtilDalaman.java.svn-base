 ...
 * @author khairil
 */
@UrlBinding("/strataUtilDalaman")
public class strataUtilDalaman extends AbleActionBean {

    private static final Logger logger = Logger.getLogger(strataUtilDalaman.class);
    ...
    private static final Logger LOG = Logger.getLogger(strataUtilDalaman.class);

    @DefaultHandler
    public Resolution showForm() {
        getContext().getRequest().setAttribute("details", Boolean.FALSE);
        return new ForwardResolution("/WEB-INF/jsp/common/strata_util_dlmn.jsp");
    }
...
//        return new JSP("common/strata_util_dlmn.jsp");
//    }
...
//        addSimpleMessage("Maklumat berjaya dikemaskini.");
        return new ForwardResolution("/WEB-INF/jsp/common/strata_util_dlmn2.jsp").addParameter("popup", "true");
    }
...
//                    KodStatusAkaunDAO kodStatusAkaunDAO = new KodStatusAkaunDAO();
    ...
    public Resolution simpanPetakAk() throws Exception {
        ...
        rehydrate();
//        return new JSP("common/strata_util_dlmn2.jsp");
        return new ForwardResolution("/WEB-INF/jsp/common/strata_util_dlmn2.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution reload() {
        LOG.info("------reload----");
        return new RedirectResolution(strataUtilDalaman.class, "search");
    }
