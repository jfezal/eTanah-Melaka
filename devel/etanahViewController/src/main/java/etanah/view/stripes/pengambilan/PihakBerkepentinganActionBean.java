...
@UrlBinding("/pengambilan/pihak_berkepentingan")
...
//            p = permohonanService.findById(idPermohonan);
            ...
            hakmilikPermohonanList2 = hakmilikpermohonanservice.findIDMHByIDMohonIDHakmilikXnull(idPermohonan);//p.getSenaraiHakmilik();
