 ...
 * @author massita
 */
@UrlBinding("/pengambilan/maklumatBantahanMahkamah")
    ...
    public Resolution maklumatBantahanMahkamah() {
        if (permohonan != null) {
           // idPermohonanPengambilan = permohonan.getPermohonanSebelum().getIdPermohonan();
            idPermohonanPengambilan = permohonan.getIdPermohonan();
        ...
        return new JSP("pengambilan/melaka/bantahanmahkamah/maklumatBantahanMahkamah.jsp").addParameter("tab", "true");
    }
