 ...
 * @author w.fairul
 * @edited by Afham
 * @edited by muhammad.amin
 */
@UrlBinding("/consent/jabatan_teknikal")
...
//    private PermohonanTandatanganDokumen mohonTandatanganDokumen;
    ...
    public Resolution showForm() {
        ...
        if (idPermohonan != null) {
            senaraiRujukanLuar = consentService.findSenaraiRujLuarByIdMohonAgensi(idPermohonan);

        }
        return new JSP("consent/jabatan_teknikal.jsp").addParameter("tab", "true");
    }

    @Before(stages = {LifecycleStage.BindingAndValidation})
    public void rehydrate() {
        LOG.info("--------------rehydrate jabatan teknikal--------------");
        idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        pguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        permohonan = permohonanDAO.findById(idPermohonan);
        if (permohonan != null) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("PMJTL")) {
                ...
                PermohonanRujukanLuar mohonRujukanLuar = consentService.findMohonRujukanByKodAgensi(idPermohonan, "6005");
                if (mohonRujukanLuar == null) {
                    for (int i = 0; i < 3; i++) {

                        String kodAgensi = null;
                        if (i == 0) {
                            kodAgensi = "6005";
                        } else if (i == 1) {
                            kodAgensi = "6007";
                        ...
                        mohonRujukanLuar = new PermohonanRujukanLuar();
                        mohonRujukanLuar.setInfoAudit(ia);
                        mohonRujukanLuar.setCawangan(permohonan.getCawangan());
                        mohonRujukanLuar.setPermohonan(permohonan);
                        LOG.info(":: KOD AGENSI : " + kodAgensi);
                        KodAgensi agen = kodAgensiDAO.findById(kodAgensi);
                        KodRujukan kodRujukan = kodRujukanDAO.findById("FL");
                        mohonRujukanLuar.setAgensi(agen);
                        mohonRujukanLuar.setNamaAgensi(agen.getNama());
                        mohonRujukanLuar.setKodRujukan(kodRujukan);
                        mohonRujukanLuar.setTempohHari(14);

                        if (kodAgensi.equals("6007")) {
                            BigDecimal bd = new BigDecimal(1);
                            mohonRujukanLuar.setNilai(bd);
                        } else if (kodAgensi.equals("6005")) {
                            BigDecimal bd = new BigDecimal(2);
                            mohonRujukanLuar.setNilai(bd);
                        } else if (kodAgensi.equals("6021")) {
                            BigDecimal bd = new BigDecimal(3);
                            mohonRujukanLuar.setNilai(bd);
                        }

                        mohonRujukanLuar.setTarikhDisampai(new java.util.Date());
                        mohonRujukanLuar.setTarikhJangkaTerima(getDateAfterDays(14));
                        mohonRujukanLuar.setUlasanMandatori("T");
                        pelupusanService.simpanPermohonanRujLuar(mohonRujukanLuar);
                ...
                PermohonanRujukanLuar mohonRujukanLuar = consentService.findMohonRujukanByKodAgensi(idPermohonan, "301");
                if (mohonRujukanLuar == null) {
                    for (int i = 0; i < 2; i++) {

                        String kodAgensi = null;
                        if (i == 0) {
                            kodAgensi = "301"; //KEMENTERIAN DALAM NEGERI
                        } else if (i == 1) {
                            kodAgensi = "3204";//JABATAN IMIGRATION 
                        }
                        mohonRujukanLuar = new PermohonanRujukanLuar();
                        mohonRujukanLuar.setInfoAudit(ia);
                        mohonRujukanLuar.setCawangan(permohonan.getCawangan());
                        ...
                        if (kodAgensi.equals("301")) {
                            BigDecimal bd = new BigDecimal(1);
                            mohonRujukanLuar.setNilai(bd);
                        } else if (kodAgensi.equals("3204")) {
                            BigDecimal bd = new BigDecimal(2);
                            mohonRujukanLuar.setNilai(bd);
                        }
    ...
    public Resolution showForm2() {
        return new JSP("pelupusan/common/sedia_jabatan_teknikal.jsp").addParameter("tab", "true");
    }
...
//        idDokTt = getContext().getRequest().getParameter("idDokTt");
    ...
    public Resolution kodAgensiPopup() {
        ...
        getContext().getRequest().setAttribute("agensi", Boolean.TRUE);
        return new JSP("consent/jabatan_teknikal_popup.jsp").addParameter("popup", "true");
    }

    public Resolution kodAgensiPopup2() {
        index = getContext().getRequest().getParameter("index");
        getContext().getRequest().setAttribute("salinan", Boolean.TRUE);
        return new JSP("pelupusan/common/pilih_salinan_agensi.jsp").addParameter("popup", "true");
    }
    /*
    ...
    public Resolution kodAgensiPopup3() {
        ...
        return new JSP("pelupusan/common/pilih_dokumen_serta.jsp").addParameter("popup", "true");
    }
...
//                mohonRujLuar.setTarikhRujukan(new java.util.Date());
                ...
                List<PermohonanRujukanLuar> listRujukanLuar = conService.findSenaraiMohonRujukanByAgensiNotNull(idPermohonan);
                for (PermohonanRujukanLuar rujukanLuar : listRujukanLuar) {
                    if (rujukanLuar.getTarikhTamat() != null) {
                        mohonRujLuar.setTarikhTamat(rujukanLuar.getTarikhTamat());
                    }
                }
        ...
        return new ForwardResolution("/WEB-INF/jsp/consent/jabatan_teknikal.jsp").addParameter("tab", "true");
    }
...
//
    ...
    public Resolution simpanKekananan() {
        ...
        for (PermohonanRujukanLuar mohonRujukanLuar : senaraiRujukanLuar) {
            LOG.info("::: KEKANANAN : " + mohonRujukanLuar.getAgensi().getNama() + " - " + mohonRujukanLuar.getNilai());
            InfoAudit infoAudit = mohonRujukanLuar.getInfoAudit();
            infoAudit.setDiKemaskiniOleh(pengguna);
            infoAudit.setTarikhKemaskini(new java.util.Date());
            mohonRujukanLuar.setInfoAudit(infoAudit);
            consentService.simpanRujukanLuar(mohonRujukanLuar);
        }
