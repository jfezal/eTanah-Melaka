 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/derafPerintahPtsp")
public class DerafPerintahPtspActionBean extends AbleActionBean {
...
//        show = "Edit";
        ...
        return new JSP("pengambilan/Deraf_Perintah_ptsp.jsp").addParameter("tab", "true");
    }

    public Resolution showForm2() {
        logger.info("::: masuk showSaman :::");
//        show = "Details";
...
//    }
    ...
    public int getSizeNotm() {
        return sizeNotm;
    }

    public void setSizeNotm(int sizeNotm) {
        this.sizeNotm = sizeNotm;
    }
}
