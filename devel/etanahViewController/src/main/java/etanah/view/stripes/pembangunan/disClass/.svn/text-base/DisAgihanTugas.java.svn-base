    ...
    public List<Pengguna> getPenggunaByBPELCasePJLB(String stageID, int numnegeri, String kodCaw) {
        ...
        switch (numnegeri) {
            ...
            case 2:
                //NEGERI SEMBILAN
                //TO DO HERE                
                if (stageID.equalsIgnoreCase("02ArahanChartingJTK")) {
                    bpelName.add("PPelan");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("10Peraku")) {
                    bpelName.add("tptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("12SemakArahSediaFail")) {
                    bpelName.add("ptptglupus");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("14ArahSediaMinit")) {
                    bpelName.add("pptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("17TerimaKeputusan")) {
                    bpelName.add("tptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("18ArahSuratDeposit")) {
                    bpelName.add("pptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("19ArahPerkiraanDeposit")) {
                    bpelName.add("pptk");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("21TerimaAmaunArahSurat")) {
                    bpelName.add("ptptglupus");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("25ArahMMK")) {
                    bpelName.add("tptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("26ArahSediaMMK")) {
                    bpelName.add("pptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("27ArahSediaMMK")) {
                    bpelName.add("ptptglupus");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("34SemakArahCetak")) {
                    bpelName.add("ptptglupus");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("37ArahSediaSurat")) {
                    bpelName.add("tptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("38ArahSediaSurat")) {
                    bpelName.add("pptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("40KiraanBayaran")) {
                    bpelName.add("pptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("41ArahSuratMaklum")) {
                    bpelName.add("ptptglupus");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("45ArahSediaPajakan")) {
                    bpelName.add("tptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("46ArahSediaPajakan")) {
                    bpelName.add("pptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("47ArahSediaPajakan")) {
                    bpelName.add("ptptglupus");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("49SemakPajakan")) {
                    bpelName.add("ptptglupus");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("50SemakPerakuPajakan")) {
                    bpelName.add("ptg");
                    kodCaw = "00";
                }
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                if (stageID.equalsIgnoreCase("02ArahanCharting")) {
                    ...
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("17ArahanPenangguhan")) {
                    bpelName.add("KPPTanahPTG");
                } else if (stageID.equalsIgnoreCase("22TerimaKpsnArahDraf")) {
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("34ArahanCharting")) {
                    bpelName.add("PPelan");
                }
