 ...
 * @author Admin
 */
@UrlBinding("/pengambilan/warisMahkamahAmanah")
public class maklumatWarisMahkamahAmanahActionBean extends AbleActionBean {
    private static Logger logger = Logger.getLogger(maklumatWarisMahkamahAmanahActionBean.class);
    @Inject
...
//    private List<PerbicaraanKehadiran> hakmilikPerbicaraanList;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/maklumatWarisMahkamahAmanah.jsp").addParameter("tab", "true");
    }
...
//        permohonanPihak = permohonanPihakService.getSenaraiMohonPihakByIdPihakIdHakmilik(idPihak, idHakmilik, idPermohonan);
        ...
        idPermohonanPihak = permohonanPihak.getIdPermohonanPihak();
        perbicaraanKehadiran = notisPenerimaanService.getPerbicaraanKehadiranbyidMPidBicara(idPermohonanPihak,hakmilikPerbicaraan.getIdPerbicaraan());
//        permohonanPihakWakil = notisPenerimaanService.getPerbicaraanKehadiranbyidMPidBicara(idPermohonanPihakWakil);
...
//        if (senaraiPPTB != null) {
            ...
            permohonanPihakWakil = new PermohonanPihakWakil();
            long idPermohonanPhkTdkBerptg = Long.parseLong(getContext().getRequest().getParameter("idPermohonanPhkdkBerptg"));
//            pptb = pptbDAO.findById(idPermohonanPhkTdkBerptg);
            ...
            permohonanPihakWakil.setHakmilikPermohonan(hp);
            if (getContext().getRequest().getParameter("typesender").equalsIgnoreCase("phtbadd")) {
                permohonanPihakWakil.setBank(kodB);
                permohonanPihakWakil.setNegeri(kodN);
                permohonanPihakWakil.setTelefon1(getContext().getRequest().getParameter("permohonanPihakWakil.nomborTelefon"));
                permohonanPihakWakil.setNoAkaunBank(getContext().getRequest().getParameter("permohonanPihakWakil.nomborAkaun"));
                ...
                kodB2.setKod(getContext().getRequest().getParameter("permohonanPihakWakil.kodBank.kod"));
                kodN2.setKod(getContext().getRequest().getParameter("permohonanPihakWakil.kodNegeri.kod"));
                permohonanPihakWakil.setBank(kodB2);
                permohonanPihakWakil.setNegeri(kodN2);
                permohonanPihakWakil.setTelefon1(getContext().getRequest().getParameter("permohonanPihakWakil.nomborTelefon1"));
                permohonanPihakWakil.setNoAkaunBank(getContext().getRequest().getParameter("permohonanPihakWakil.nomborAkaunBank"));
            }
            permohonanPihakWakil.setIdWakilPermohonanPihak(idPermohonanPhkTdkBerptg);
            permohonanPihakWakil.setNama(getContext().getRequest().getParameter("permohonanPihakWakil.nama"));
            permohonanPihakWakil.setNoPengenalan(getContext().getRequest().getParameter("permohonanPihakWakil.nomborPengenalan"));
            ...
            try {
//                notisPenerimaanService.saveOrUpdatePPTB(permohonanPihakWakil);
            } catch (Exception o) {
            }
