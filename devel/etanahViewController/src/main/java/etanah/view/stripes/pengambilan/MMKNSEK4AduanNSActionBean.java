...
@UrlBinding("/pengambilan/sek4ammknNS")
public class MMKNSEK4AduanNSActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(MMKNSEK4AduanNSActionBean.class);
    @Inject
...
//    private final String tajuk = "KERTAS PERMOHONAN ADUAN KEROSAKAN PENGAMBILAN TANAH SEKSYEN 4 NEGERI MELAKA";
    ...
    private final String tajuk2 = "KERTAS PERMOHONAN ADUAN KEROSAKAN PENGAMBILAN TANAH SEK 4 NEGERI SEMBILAN";
...
//    private PermohonanKertasKandungan ulasan1;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/negerisembilan/seksyen4/MMKN_SEK4A.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if(permohonan.getSenaraiPemohon().size() > 0){
            pihakNama = permohonan.getSenaraiPemohon().get(0).getPihak().getNama();
        }
      ...
      tujuan ="Kertas ini bertujuan untuk mendapatkan pertimbangan yang amat berhormat Menteri Besar Negeri Sembilan Darul Khusus ke atas "
                + "permohonan pengambilan tanah daripada "+ pihakNama+ " seluas lebih kurang "
...
//        "Tujuan kertas ini dikemukakan adalah untuk mendapatkan pertimbangan dan keputusan Majlis Mesyuarat "
//                + "Kerajaan Negeri Sembilan bagi permohonan pengambilan tanah di atas "
//                + noLotList + ",seluas " + totalLuas +" " + uom + ",di "
//                + hakmilik.getBandarPekanMukim().getNama() + "," + " Daerah " + hakmilik.getDaerah().getNama() + ", Negeri Sembilan untuk tujuan "
//                + p.getSebab()+ " di bawah Seksyen 4, Akta Pengambilan Tanah 1960.";


       String temp = "PERMOHONAN ADUAN KEROSAKAN PENGAMBILAN TANAH SEKSYEN 4 DARIPADA "+ p.getSenaraiPemohon().get(0).getPihak().getNama() +" SELUAS LEBIH KURANG "
               + totalLuas + " " + uom + " UNTUK " + p.getSebab() + " DI "
...
//            }
        ...
        getContext().getRequest().setAttribute("form1", Boolean.TRUE);
        return new RedirectResolution(MMKNSEK4AduanNSActionBean.class, "locate");
//        return new JSP("pengambilan/negerisembilan/seksyen4/MMKN_SEK4A.jsp").addParameter("tab", "true");
    }
