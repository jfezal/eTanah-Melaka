 ...
 * @author mohd.faidzal
 */
public class BorangCValidator implements StageListener{
  private static final Logger LOG = Logger.getLogger(SemakBorangDTandatanganValidator.class);
    ...
    public void onGenerateReports(StageContext context) {
        ...
        if (permohonanPengambilan != null) {
          //  if (permohonanPengambilan.getKatPengambilan().equals("1")) {
                namaReport = new String[5];
                kodReport = new String[5];
                namaReport[0] = "ACQSrtPNB8_MLK.rdf";
                kodReport[0] = "SIID";
                namaReport[1] = "ACQDocC_MLK.rdf";
                kodReport[1] = "C";
                 namaReport[2] = "ACQDocD_MLK.rdf";
                kodReport[2] = "D";
                namaReport[3] = "ACQSrtEWarta8_MLK.rdf";
                kodReport[3] = "SEWD";
                
          //  } else {
          //      namaReport = new String[0];
          //      kodReport = new String[0];
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        try {
            myeTappIntegrationFlowService.completeTask(ref.SEK8_TERIMA_BORANGC, context.getPermohonan(), context.getPengguna(),context.getPermohonan().getCawangan().getDaerah());
        } catch (IOException ex) {
            java.util.logging.Logger.getLogger(HantarBorangAValidator.class.getName()).log(Level.SEVERE, null, ex);
        }
