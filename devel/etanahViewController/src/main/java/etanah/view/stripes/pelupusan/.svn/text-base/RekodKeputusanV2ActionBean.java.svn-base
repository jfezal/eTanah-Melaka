 ...
 * @author Afham
 */
@UrlBinding("/pelupusan/rekod_keputusanV2")
public class RekodKeputusanV2ActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(RekodKeputusanV2ActionBean.class);
...
//                senaraiHakmilikPermohonan = permohonan.getPermohonanSebelum().getSenaraiHakmilik();
    ...
    public String kertasDok(String urusan) {
        ...
        int typeUrusan =   urusan.equals("BMBT")  ? 1
                         ...
                         : urusan.equals("PTBTC") ? 4
                         : urusan.equals("PTBTS") ? 5
                         : 0;
    ...
    public String getSyaratLulus() {
        ...
        int typeNum =  permohonan.getKodUrusan().getKod().equals("BMBT") ? 1
                     ...
                     : permohonan.getKodUrusan().getKod().equals("PBMT") ? 3
                     : permohonan.getKodUrusan().getKod().equals("PTBTC") ? 4
                     : permohonan.getKodUrusan().getKod().equals("PTBTS") ? 5
                     : 0;
        ...
        switch (typeNum) {
            ...
            case 2: // Urusan = PJBTR
                ...
                break;
            case 3: // Urusan = PBMT
                forwardJSP = DisPermohonanPage.getRK_SYRT_PBMT();
                break;
            case 4: // Urusan = PTBTC
                forwardJSP = DisPermohonanPage.getRK_SYRT_PTBTC();
                break;
            case 5: // Urusan = PTBTS
                forwardJSP = DisPermohonanPage.getRK_SYRT_PTBTS();
                break; 
        }
        return forwardJSP;
    }
...
//        display = Boolean.TRUE;
        ...
        int typeNum =  permohonan.getKodUrusan().getKod().equals("BMBT")  ? 1
                     : permohonan.getKodUrusan().getKod().equals("PJBTR") ? 2
                     : permohonan.getKodUrusan().getKod().equals("PTBTC") ? 3
                     : permohonan.getKodUrusan().getKod().equals("PTBTS") ? 4
                     : 0;
...
//        rehydrate();
        ...
        return new JSP(DisPermohonanPage.getRK_MM_PAGE()).addParameter("tab", "true");
    }
    ...
    public Resolution simpanSyarat() throws ParseException {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PTBTC")) {
            updateMohonHakmilik();
        }
        if (permohonan.getKodUrusan().getKod().equals("PTBTS")) {
            updateMohonHakmilik();
        }
        rehydrate();
