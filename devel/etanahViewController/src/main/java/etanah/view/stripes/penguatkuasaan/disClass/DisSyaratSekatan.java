...
/**
 *
 * @author Shazwan 16032012 0342 PM
 * purpose : Utiliti for Syarat Nyata & Sekatan Kepentingan
 * 
 */

public class DisSyaratSekatan  {
    ...
    public String getSyaratSekatan() {
        return syaratSekatan;
    }

    public void setSyaratSekatan(String syaratSekatan) {
        this.syaratSekatan = syaratSekatan;
    }
