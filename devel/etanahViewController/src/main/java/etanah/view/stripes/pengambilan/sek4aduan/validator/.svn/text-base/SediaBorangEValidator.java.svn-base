 ...
 * @author mohd.faidzal
 */
public class SediaBorangEValidator implements StageListener {

    private static final Logger LOG = Logger.getLogger(SediaBorangEValidator.class);
    @Inject
    ...
    public void onGenerateReports(StageContext context) {
        ...
        for (HakmilikPermohonan hp : context.getPermohonan().getSenaraiHakmilik()) {
            ...
            if (context.getStageName().equals("sedia_surat")) {
                namaReport = new String[1];
                kodReport = new String[1];
                namaReport[0] = "ACQDocE_aduan_MLK.rdf";
                kodReport[0] = "E";
            }
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        if (context.getStageName().equals("semak_tandatangan")) {
            RefPeringkat ref = new RefPeringkat();
            sek4AduanIntegrationFlowService.completeTask(ref.REKOD_KPSN_BNCG, context.getPermohonan(), context.getPengguna());
        }
    ...
    public Dokumen janaDokumenPH(Permohonan permohonan, Pengguna pengguna, String namaReport, String kodReport, BorangPerHakmilik ph) {
        ...
        try {
            ...
            String[] params = new String[]{"p_id_mohon", "id_borang_per_hakmilik"};
