...
// * @author massita
// */
//@UrlBinding("/pengambilan/laporanTanahPengambilan1")
//public class LaporanTanahPengambilanActionBean1 extends AbleActionBean {
//    @Inject
...
//        return new JSP("pengambilan/negerisembilan/laporan_tanah_new_n9_v2.jsp").addParameter("tab", "true");
//    }
//
...
//        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
//
//        return new ForwardResolution("/WEB-INF/jsp/pengambilan/negerisembilan/laporan_tanah_new_n9_v2.jsp").addParameter("tab", "true");
//    }
//
