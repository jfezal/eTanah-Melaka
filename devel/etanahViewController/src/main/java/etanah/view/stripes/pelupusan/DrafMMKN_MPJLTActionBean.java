...
@UrlBinding("/pelupusan/draf_mmkn_mpjlt")
public class DrafMMKN_MPJLTActionBean extends AbleActionBean {

    Logger logger = Logger.getLogger(DrafMMKN_MPJLTActionBean.class);
    @Inject
    BPelService service;
    @Inject
...
//    private BPelService service;
    ...
    public Resolution showForm() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/mpjlt/draf_mmkn_mlk.jsp").addParameter("tab", "true");
    }
...
//        stageId = "sedia_draf_mmkn";
        ...
        //Added by Aizuddin for keputusan laporan_tanah
        FasaPermohonan fp = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "sedia_draf_mmkn");
        ...
        String ursan1 = " ";
        if (permohonan.getKodUrusan().getKod().equals("MPJLT")) {
            ursan1 = "memiliki tanah kerajaan";
        }
...
//        rehydrate();
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/mpjlt/draf_mmkn_mlk.jsp").addParameter("tab", "true");
    }
