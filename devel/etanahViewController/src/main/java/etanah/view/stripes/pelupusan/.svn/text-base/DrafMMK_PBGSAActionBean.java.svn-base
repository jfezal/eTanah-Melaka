 ...
 * 
 */
@UrlBinding("/pelupusan/draf_mmk_pbgsa")
public class DrafMMK_PBGSAActionBean extends AbleActionBean {

    Logger LOG = Logger.getLogger(DrafMMK_PBGSAActionBean.class);
    @Inject
...
//    RegService regService;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/gsa/draf_mmk_pbgsa.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
      ...
      //  permohonanLaporPelan = pelupusanService.findByIdPermohonanPelan(idPermohonan);
        ...
        if (permohonan.getKodUrusan().getKod().equals("PTGSA")) {
            fasaPermohonan = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "07SedDrfMMK");
        } else {
...
//                }
     ...
     //   String kws = "";
        ...
        if (permohonan.getKodUrusan().getKod().equals("PBGSA")) {
            ursan1 = " PERMOHONAN PEMBERIMILIKAN TANAH GSA DI BAWAH AKTA TANAH (KAWASAN-KAWASAN PENEMPATAN BERKELOMPOK) 1960.";
        } else if (permohonan.getKodUrusan().getKod().equals("PTGSA")) {
            ursan1 = " PERMOHONAN PEMBATALAN TANAH GSA MENGIKUT SEKSYEN 124(1) KANUN TANAH NEGARA 1965.";
        }
        if (pemohon != null) {
...
//                 noLot = hakmilikPermohonan.getNoLot();
         ...
         if (permohonan.getKodUrusan().getKod().equals("PBGSA")) {
             tajuk1 = "PERMOHONAN UNTUK PEMBERIMILIKAN TANAH SELUAS LEBIH KURANG " + luas + " " + kodUnitLuas + 
                  " " + "DI " + lokasi + ", " + bpm + ", DAERAH " + daerah+
                  " " + "DI (KAWASAN-KAWASAN PENEMPATAN BERKELOMPOK) 1960  " + ".";
         }else if (permohonan.getKodUrusan().getKod().equals("PTGSA")) {
             tajuk1 = "PERMOHONAN DARIPADA " + convNama + " UNTUK MEMBATAL SEKATAN KEPENTINGAN TANAH GSA DI " +lokasi+ " " +kodHmlk1+ " " +tajukLot+ " " +noLot+", " + bpm + ", DAERAH " + daerah+
                  " " + "MENGIKUT SEKSYEN 124(1) KANUN TANAH NEGARA.";
         }
         ...
         if (permohonan.getKodUrusan().getKod().equals("PBGSA")) {
             tujuan = "\n" + "Tujuan kertas ini ialah untuk mendapatkan pertimbangan Majlis Mesyuarat Kerajaan Negeri Sembilan mengenai permohonan untuk pemberimilikan tanah "+tajukLot+" "+noLot
                  +" seluas lebih kurang "+ luas +" "+kodUnitLuas+" di "+lokasi+", "+pelupusanUtiliti.convertStringtoInitCap(bpm)+", Daerah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" di kawasan penempatan berkelompok di bawah Seksyen 44 Akta Tanah (Kawasan-kawasan Penempatan Berkelompok) 1960 .";

             perihalPemohon21 = "Pentadbir Tanah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" telah menerima permohonan daripada "+convNama+" untuk pemberimilikan tanah "+tajukLot+" "+noLot
                            +" seluas lebih kurang "+ luas +" "+kodUnitLuas+" di "+lokasi+", "+pelupusanUtiliti.convertStringtoInitCap(bpm)+", Daerah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" di kawasan penempatan berkelompok di bawah Seksyen 44 Akta Tanah (Kawasan-kawasan Penempatan Berkelompok) 1960."
                            + " Tanah yang dipohon adalah ditunjuk dengan perimeter berwarna merah dalam pelan berkembar";
             
         }else if (permohonan.getKodUrusan().getKod().equals("PTGSA")) {
             tujuan = "\n" + "Tujuan kertas ini ialah untuk mendapatkan pertimbangan Majlis Mesyuarat Kerajaan Negeri, Negeri Sembilan Darul Khusus mengenai permohonan daripada " + convNama + " untuk membatal sekatan kepentingan tanah GSA di "+lokasi+" "+kodHmlk1+" "+tajukLot+" "+noLot
                  + " " +pelupusanUtiliti.convertStringtoInitCap(bpm)+", Daerah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" mengikut Seksyen 124(1) Kanun Tanah Negara 1965.";

             perihalPemohon21 = "Pentadbir Tanah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" telah menerima permohonan daripada "+convNama+" untuk membatalkan sekatan kepentingan tanah GSA di "+lokasi+" "+kodHmlk1+" "+tajukLot+" "+noLot+" "
                            +pelupusanUtiliti.convertStringtoInitCap(bpm)+", Daerah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" mengikut Seksyen 124(1) Kanun Tanah Negara 1965.";
...
//                            mohonRujuk.setUlasan(ulasanAgensi);
        ...
        perihalPemohon42 = "Tujuan permohonan dibuat adalah untuk mengeluarkan tanah "+tajukLot+" "+noLot
                  +" seluas lebih kurang "+ luas +" "+kodUnitLuas+" di "+lokasi+", "+pelupusanUtiliti.convertStringtoInitCap(bpm)+", Daerah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" dari kawasan penempatan berkelompok di bawah Seksyen 44 Akta Tanah (Kawasan-kawasan Penempatan Berkelompok) 1960 .";
        ...
        if (currentStageId.equals("15PenyediaanDraf")) {
            simpanNew();
        }
    }
    ...
    public Resolution simpanNew() {
        ...
        if (permohonanKertas == null) {
            ...
            if(permohonan.getKodUrusan().getKod().equals("PTGSA")) {
                if(stageId.equals("11SyrKrtsMMK"))
                {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/gsa/draf_mmk_pbgsa.jsp").addParameter("tab", "true");
    }
...
//                break;
    ...
    public void updateKandungan(int i, String kand) {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PBGSA") || permohonan.getKodUrusan().getKod().equals("PTGSA")) {
            permohonanKertas.setTajuk("KERTAS MMKN");
