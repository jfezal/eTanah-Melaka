...
@UrlBinding("/pengambilan/PenyediaanSuratPerbicaraan")
public class PenyediaanSuratPerbicaraanGantirugiActionBean extends AbleActionBean
{
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/suratMaklumGantiRugi.jsp").addParameter("tab", "true");
    }

    public Resolution showForm1() {
        return new JSP("pengambilan/negerisembilan/penarikanbalik/tandatanganSuratMaklumGantiRugi.jsp").addParameter("tab", "true");
    }
}
