 ...
 * @author nurashidah
 */
@UrlBinding("/pengambilan/mmknEtapp")
public class MMKNPengambilanEtappActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(MMKNPengambilanEtappActionBean.class);
    @Inject
...
//    private List<PermohonanKertasKandungan> senaraiKertasKandungan4;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/MMKNMyeTapp_NS.jsp").addParameter("tab", "true");
    }
...
//                + WordUtils.capitalizeFully(permohonan.getSebab())+ " di bawah Seksyen 4, Akta Pengambilan Tanah 1960.";
        ...
        if (permohonan.getKodUrusan().getKod() == "ESK4") {
            if (hakmilikPermohonanList.size() < 11) {

                String temp = "PERMOHONAN PENGAMBILAN TANAH YANG BERKEMUNGKINAN AKAN DIAMBIL DI ATAS KESELURUHAN LOT-LOT BERKENAAN DI "
                        + noLotList + " DAERAH " + hakmilik.getDaerah().getNama() + " " + totalLuas + " " + uom + " UNTUK " + permohonan.getSebab() + " DI ";
        ...
        if (idPermohonan != null) {
            ...
            EtappPermohonan e = ambilService.getNofail(permohonan.getIdPermohonan());
            TBLPPTINTDERAFMMKTAJUK mmkTjk = ambilService.findTajuk(e.getNoFail());
            permohonanKertas = ambilService.findMohonKertasByIdMohon(idPermohonan, "MB");
            if (permohonanKertas != null) {

                permohonanKertas = ambilService.findMohonKertasByIdMohon(permohonan.getIdPermohonan(), "MB");
                ...
                permohonanKertas.setKodDokumen(kodDokumenDAO.findById("MB"));
                logger.info("Tajuk : " + mmkTjk.getTajuk());
                ...
                if (noRujUPT != null) {
                    for (int u = 0; u < noRujUPT.size(); u++) {
                        if (noRujUPT.get(u).getKeteranganMMK() != null) {
                            ...
                            noRujukanMMKN.setSubtajuk("0." + (u + 1));
...
//                        }
                    ...
                    //2. LATAR BELAKANG
                    permohonanList = ambilService.findMMKdrafKand(e.getNoFail(), "LATARBELAKANG");
...
//                        for (TBLINTPPTDERAFMMK permohonanLIST : permohonanList) {
                            ...
                            PKKPermohonan.setBil(2);
                            PKKPermohonan.setSubtajuk("2." + (i + 1));
                    ...
                    //3. PERIHAL TANAH
                    tanahList = ambilService.findMMKdrafKand1(e.getNoFail(), "PERIHALTANAH");
                    if (tanahList != null) {
...
//
                    ...
                    //4.NILAI TANAH
                    pampasanList = ambilService.findMMKdrafKand(e.getNoFail(), "NILAITANAH");
                    if (pampasanList != null) {
                        ...
                        for (int i = 0; i < pampasanList.size(); i++) {
                            ...
                            PKKPampasan.setBil(4);
                            PKKPampasan.setSubtajuk("4." + (i + 1));
                    ...
                    //5. syor pentadbir tanah
                    ulasanList = ambilService.findMMKdrafKand1(e.getNoFail(), "SYOR");
                    if (ulasanList != null) {
                        System.out.println("simpan ulasan PT 2");
                        ...
                        logger.info("simpan SYOR.. Ade : " + ulasanList.size());
                        ...
                        for (int i = 0; i < ulasanList.size(); i++) {
                            ...
                            PKKUTeknikal.setBil(51);
                            PKKUTeknikal.setSubtajuk("5.1." + (i + 1));
                    ...
                    if (PerakuanPTG != null) {
                        ...
                        for (int i = 0; i < PerakuanPTG.size(); i++) {
                            ...
                            PKKPerakuanPTG.setBil(6);
                            PKKPerakuanPTG.setSubtajuk("6." + (i + 1));
                    ...
                    //7. KEPUTUSAN
                    PerakuanPT = ambilService.findMMKdrafKand(e.getNoFail(), "KEPUTUSAN");
                    if (PerakuanPT != null) {
                        logger.info("simpan KEPUTUSAN.. Ade : " + PerakuanPT.size());
                        ...
                        for (int i = 0; i < PerakuanPT.size(); i++) {
                            ...
                            PKKPerakuanPT.setBil(7);
                            PKKPerakuanPT.setSubtajuk("7." + (i + 1));
...
//        PermohonanKertas pk = ambilService.findMohonKertasByIdMohon(idPermohonan);
                ...
                senaraiKertasKandungan21 = ambilService.findMMKdrafKandNew(idKertas, 2);
                ...
                senaraiKertasKandungan4 = ambilService.findMMKdrafKandNew(idKertas, 6);
...
//                kandungan = "TIADA DATA";
        ...
        senaraiKertasKandungan21 = pendudukanSementaraMMKNService.findByKertas(permohonanKertas.getIdKertas(), 2);
...
//                kandungan = "TIADA DATA";
        ...
        for (int y = 1; y <= kira2; y++) {
            if (senaraiKertasKandungan9.size() != 0 && y <= senaraiKertasKandungan9.size()) {
                Long id = senaraiKertasKandungan9.get(y - 1).getIdKandungan();
                if (id != null) {
            ...
            permohonanKertasKandungan2.setBil(3);
...
//                kandungan = "TIADA DATA";
            ...
            permohonanKertasKandungan2.setSubtajuk("3." + y);
        ...
        for (int x = 1; x <= kira4; x++) {
            if (senaraiKertasKandungan3.size() != 0 && x <= senaraiKertasKandungan3.size()) {
                Long id = senaraiKertasKandungan3.get(x - 1).getIdKandungan();
                if (id != null) {
            ...
            permohonanKertasKandungan4.setSubtajuk("4." + x);
        ...
        senaraiKertasKandungan5 = pendudukanSementaraMMKNService.findByKertas(permohonanKertas.getIdKertas(), 7);
        ...
        senaraiKertasKandungan4 = pendudukanSementaraMMKNService.findByKertas(permohonanKertas.getIdKertas(), 6);
        ...
        for (int j = 1; j <= kira6; j++) {
            ...
            permohonanKertasKandungan7.setBil(6);
            ...
            permohonanKertasKandungan7.setSubtajuk("6." + j);
    ...
    public Resolution deleteSingle2() {
        ...
        addSimpleMessage("Maklumat telah berjaya dihapus.");
        return new RedirectResolution(etanah.view.stripes.pengambilan.MMKNPengambilanEtappActionBean.class, "locate");
    }
    ...
    public Resolution deleteJabatanTeknikal() {
        ...
        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        addSimpleMessage("Maklumat telah berjaya dihapus.");
        return new RedirectResolution(MMKNPengambilanEtappActionBean.class, "locate");
    }
