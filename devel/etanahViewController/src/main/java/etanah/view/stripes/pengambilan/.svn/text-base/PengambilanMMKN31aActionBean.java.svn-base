 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/borang_mmkn_31a")
public class PengambilanMMKN31aActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(PengambilanMMKN31aActionBean.class);
    @Inject
    ...
    private final String tajuk = "KERTAS PERMOHONAN PENGAMBILAN TANAH 8(3)(1)(a)";
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/melaka/seksyen831a/pengambilan_MMKN_31a.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        tujuan = "Tujuan kertas ini dikemukakan adalah untuk mendapatkan pertimbangan dan keputusan Majlis Mesyuarat "
                ...
                + permohonan.getSebab()+ " di bawah Seksyen 3(1)(a), Akta Pengambilan Tanah 1960.";
        ...
        String temp = "PERMOHONAN PENGAMBILAN TANAH DARIPADA "+ permohonan.getSenaraiPemohon().get(0).getPihak().getNama() +" SELUAS LEBIH KURANG "
                ...
                + noLotList + " DAERAH " + hakmilik.getDaerah().getNama() + " DI BAWAH SEKSYEN 3(1)(A) AKTA PENGAMBILAN TANAH 1960.";
...
//            }
        ...
        getContext().getRequest().setAttribute("form", Boolean.TRUE);
        return new RedirectResolution(PengambilanMMKN31aActionBean.class, "locate");
    }
