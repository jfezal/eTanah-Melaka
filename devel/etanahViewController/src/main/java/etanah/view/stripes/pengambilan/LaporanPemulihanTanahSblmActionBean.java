...
@UrlBinding("/pengambilan/LaporanPemulihanTanah_Sblm")
public class LaporanPemulihanTanahSblmActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(LaporanPemulihanTanahSblmActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/melaka/pemulihantanah/Laporan_Pemulihan_Tanah_Sblm.jsp").addParameter("tab", "true");
    }
...
//            laporanPemulihanTanah = pengambilanService.getLaporanPemulihanTanahByidMHidMP(hakmilikPermohonan.getId(),permohonanPihak.getIdPermohonanPihak());
            ...
            laporanPemulihanTanah = pengambilanService.getLaporanPemulihanTanahByJenisLaporan(idPermohonan,hakmilikPermohonan.getId(),permohonanPihak.getIdPermohonanPihak(),"PTD");
            if(laporanPemulihanTanah != null){
                logger.info("laporanPemulihanTanah x null ");
...
//        laporanPemulihanTanah = pengambilanService.getLaporanPemulihanTanahByidMHidMP(hakmilikPermohonan.getId(),permohonanPihak.getIdPermohonanPihak());
        ...
        if(laporanPemulihanTanah == null) {
            ...
            laporanPemulihanTanah.setJenisLaporan("PTD");
