 ...
 * @author mohd.faidzal
 */
public class SediaBaucerValidator implements StageListener {
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        sek8aIntegrationFlowService.completeTask(ref.TERIMA_AWARD, context.getPermohonan(), context.getPengguna());
