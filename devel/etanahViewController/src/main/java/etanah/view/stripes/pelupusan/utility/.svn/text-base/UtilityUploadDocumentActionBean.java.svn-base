...
@UrlBinding("/pelupusan/caridokumen")
public class UtilityUploadDocumentActionBean extends AbleActionBean {
    ...
    private List<Permohonan> permohonanSblm;
    private List<KodKadarBayaran> kodKadarBayaran;
    ...
    public List<Permohonan> getPermohonanSblm() {
        return permohonanSblm;
    }

    public void setPermohonanSblm(List<Permohonan> permohonanSblm) {
    ...
    public Resolution showForm() {
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/utiliti/utilityUploadDocument.jsp");
    }
    ...
    public Resolution saveFolderInfo() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/utiliti/utilityUploadDocument.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution find() {
        ...
        if (StringUtils.isNotBlank(idPermohonan)) {
            ...
            //Added for Rayuan SBMS
            permohonanSblm = permohonanService.findByIdSblmRyn(idPermohonan);   
    ...
    public Resolution findRayuan() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/utiliti/utilityUploadDocumentRayuan.jsp").addParameter("popup", true);
    }
    ...
    public Resolution deleteSelected() {
        ...
        try {
            for (int i = 0; i < ids.length; i++) {
                if (!ids[i].equals("T")) {
                    Dokumen d = dokumenDAO.findById(Long.parseLong(ids[i]));
                    if (d != null) {
