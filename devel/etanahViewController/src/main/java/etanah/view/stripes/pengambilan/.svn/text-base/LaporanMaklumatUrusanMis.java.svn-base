...
public class LaporanMaklumatUrusanMis extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        showReports();
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/melaka/laporan_maklumaturusan_pengambilan.jsp");
...
//            doFilterDaerahBPM();
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/melaka/laporan_maklumaturusan_param_pengambilan.jsp").addParameter("popup", "true");
    }
