 ...
 * @author user
 */
@UrlBinding("/pengambilan/aduan_kerosakan/sedia_surat/maklumat_rundingan")
public class MaklumatRundinganActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        System.out.println("inside show form MaklumatRundinganActionBean ++ ");
        ...
        return new JSP("pengambilan/aduan_kerosakan/sedia_surat/maklumat_rundingan.jsp").addParameter("tab", "true");
