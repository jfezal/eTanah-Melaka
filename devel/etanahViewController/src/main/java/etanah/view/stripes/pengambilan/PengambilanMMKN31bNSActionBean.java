 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/borang_mmkn_31b_ns")
public class PengambilanMMKN31bNSActionBean extends AbleActionBean {


    private static Logger logger = Logger.getLogger(PengambilanMMKN31bNSActionBean.class);
    @Inject
    ...
    private final String tajuk = "KERTAS PERMOHONAN PENGAMBILAN TANAH 3(1)(b)";
    SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss aaa");

    @DefaultHandler
    public Resolution showForm() {
        getContext().getRequest().setAttribute("form", Boolean.TRUE);
        return new JSP("pengambilan/negerisembilan/seksyen831bc/pengambilan_MMKN_31b.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        String temp = "PERMOHONAN PENGAMBILAN TANAH DARIPADA "+ permohonan.getSenaraiPemohon().get(0).getIdPemohon()+" SELUAS LEBIH KURANG "
                + totalLuas + " Meter Persegi UNTUK " + permohonan.getSebab() + " DI "
                + noLotList + " DAERAH " + hakmilik.getDaerah().getNama() + " DI BAWAH SEKSYEN 831B AKTA PENGAMBILAN TANAH 1960.";

        heading = temp.toUpperCase();

        tujuan = "Kertas ini disediakan untuk mendapat pertimbangan Majlis Mesyuarat kerajaan Negeri, Negeri Sembilan Darul Khusus mengenai "
                + "permohonan "+permohonan.getKodUrusan().getNama()+" daripada "+ permohonan.getSenaraiPemohon().get(0).getIdPemohon()+ " untuk "
                + permohonan.getSebab() +" di "+ noLotList + " Daerah " + hakmilik.getDaerah().getNama()+", seperti di Borang C mengikut"
                + " seksyen 3(1)(b) Akta Pengambilan Tanah 1960 di bawah perwakilan kuasa seperti yang "
...
//                tarikhmesyuarat = pendudukanSementaraMMKNService.findbil1ByIdKertas(permohonanKertas.getIdKertas(), 11);
                ...
                ulasanObj1 = pendudukanSementaraMMKNService.findbil1ByIdKertas(permohonanKertas.getIdKertas(), 4);
                if(ulasanObj1 != null)
                    ulasan1 = ulasanObj1.getKandungan().toLowerCase();
                ulasanObj2 = pendudukanSementaraMMKNService.findbil1ByIdKertas(permohonanKertas.getIdKertas(), 5);
                if(ulasanObj2 != null)
...
//            }
        ...
        getContext().getRequest().setAttribute("form", Boolean.TRUE);
        return new RedirectResolution(PengambilanMMKN31bNSActionBean.class, "locate");
    }
