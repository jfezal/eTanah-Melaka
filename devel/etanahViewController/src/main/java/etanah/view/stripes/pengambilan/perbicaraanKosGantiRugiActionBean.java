...
@UrlBinding("/pengambilan/gantiRugi")
public class perbicaraanKosGantiRugiActionBean extends AbleActionBean {
    ...
    @Inject
    public perbicaraanKosGantiRugiActionBean(AkaunDAO akaunDAO, HakmilikDAO hakmilikDAO) {
