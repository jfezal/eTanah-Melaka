...
public class LaporanMaklumatUrusanMis extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        showReports();
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/utiliti/laporan_maklumaturusan_pelupusan.jsp");
    ...
    private void showReports() {
        ...
        if ("04".equals(conf.getProperty("kodNegeri"))) {
            ...
            senaraiKeluasanTanah = new String[]{"Laporan Syeksen 3 (a)"};
...
//        "Maklumat Keluasan Mengikut Jenis Hakmilik"};
            ...
            senaraiPemilikan = new String[]{"Laporan Syeksen 3 (b)"};
...
//
            statistikKeluasanTanah = new String[]{"Laporan Syeksen 3 (c)",};
...
//        "Senarai Perserahan Urusniaga Kiv",
...
//        "ETMIS42_1.rdf"};
            ...
            senaraiKeluasanTanahRN = new String[]{"ACQLU831A_MLK.rdf"};
...
//        "ETMIS57_1.rdf"};
            ...
            senaraiPemilikanRN = new String[]{"ACQLU831B_MLK.rdf"};

            statistikKeluasanTanahRN = new String[]{"ACQLU831C_MLK.rdf"};
...
//      };
        ...
        if ("05".equals(conf.getProperty("kodNegeri"))) {
            ...
            senaraiKeluasanTanah = new String[]{"Pewartaan Tanah Dibawah GSA"};

            senaraiPemilikan = new String[]{"Permohonan Permit Bahan Batuan (Kelulusan MMK)"};

            senaraiKeluasanTanahRN = new String[]{"REP_PERMOHONAN.rdf"};

            senaraiPemilikanRN = new String[]{"REP_PERMOHONAN.rdf"};
...
//            doFilterDaerahBPM();
        ...
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/utiliti/laporan_maklumaturusan_param_pelupusan.jsp").addParameter("popup", "true");
    }
