 ...
 * @author wan.fairul
 */
@UrlBinding("/pemohon/pemohonMCL")
public class MaklumatPemohonMCLActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(MaklumatPemohonMCLActionBean.class);
