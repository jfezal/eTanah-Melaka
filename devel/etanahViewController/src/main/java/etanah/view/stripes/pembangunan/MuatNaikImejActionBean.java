 ...
 * @author Syaiful
 */
@UrlBinding("/pembangunan/muat_naik_imej")
public class MuatNaikImejActionBean extends BasicTabActionBean {
    ...
    String catatan = "";
    String msg;
    String _PAGE_IMEJ_POP_ = "pembangunan/common/muat_naik_imej_pop.jsp";
    String _PopUp_ = "pembangunan/common/muatnaik.jsp";
    String _Main = "pembangunan/common/muat_naik_imej.jsp";
...
//        return new JSP("pembangunan/common/maklumat_imej.jsp").addParameter("tab", "true");
        return new JSP("pembangunan/common/maklumat_naik_imej.jsp").addParameter("tab", "true");
    }
