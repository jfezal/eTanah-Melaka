 ...
 * @modified by massita
 */
@UrlBinding("/pengambilan/ImejLaporanTanahTerdahulu")
public class ImejLaporanTanahTerdahuluActionBean extends BasicTabActionBean {
...
//            laporanTanah = laporanTanahService.findLaporanTanahByIdMohon(idSblm);
            senarailaporanTanah=laporanTanahService.findSenaraiLaporanTanahByIdMohon(idSblm);
        }
        ...
        if (idSblm != null && idPermohonan != null) {
            ...
            if (permohonanSebelum != null) {
                ...
                if (!senarailaporanTanah.isEmpty()) {
                    ...
                    for(LaporanTanah k:senarailaporanTanah){
                    senaraiImejLaporan = pembangunanService.findImejlaporan(k.getIdLaporan());
...
//        laporanTanah = laporanTanahService.findLaporanTanahByIdMohon(idSblm);
        ...
        imejLaporanUP = new ImejLaporan();
         for(LaporanTanah lt:senarailaporanTanah) 
         {
             imejLaporanUP = pembangunanService.findImejlaporan(lt.getIdLaporan(), dokumen.getIdDokumen());
