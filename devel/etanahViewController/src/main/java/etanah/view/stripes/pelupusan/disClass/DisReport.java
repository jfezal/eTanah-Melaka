 ...
 * @purpose : To Cater Report Based On Their Urusan And Stages1
 */
public class DisReport {
    ...
    public HashMap getReportMap(int numUrusan, String stageID, String negeri, Permohonan p, HakmilikPermohonan hp) {
        ...
        switch (numUrusan) {
            case 1:
                //PBMT
                reportMap = getReportByCasePBMT(stageID, numnegeri, p);
                break;
            case 2:
                //PLPS
            ...
            case 6:
                //MMMCL
                reportMap = getReportByCaseMMMCL(stageID, numnegeri, hp, p);
                break;
            case 7:
                //PPTR
            ...
            case 17:
                //PBRZ
                reportMap = getReportByCasePBRZ(stageID, numnegeri, hp, p);
                break;
            case 18:
                //PRIZ
            ...
            case 44:
                //LPJH
                reportMap = getReportByCaseLPJH(stageID, numnegeri, p);
                break;
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("tolak_ringkas")) {
                    ...
                    reportMap.put("reportName2", "DISKRPMCMMMCL_MLK.rdf");
                    reportMap.put("reportKod2", "RENC");
                    ...
                    reportMap.put("reportName1", "DISSMTOLAKRINGKAS_MLK.rdf");
                    reportMap.put("reportKod1", "SMT");
                ...
                } else if (stageID.contentEquals("minit_syor_tolak_awal")) {
                    reportMap.put("reportName1", "DISMB_MLK.rdf");
                    reportMap.put("reportKod1", "MINB");
                    ...
                    reportMap.put("reportKod1", "MMKND"); //NOT RMN FOR PTD
                ...
                } else if (stageID.contentEquals("sedia_surat_tolak2")) {
...
//                    reportMap.put("reportKod1", "SL");
                    reportMap.put("reportName1", "DISSMLULUSRINGKAS_MLK.rdf");
                    reportMap.put("reportKod1", "SL");
...
//                    reportMap.put("reportKod1", "SMT");
                ...
                //                    reportMap.put("reportName1", "DISSPLPSL_MLK.rdf");
                //                    reportMap.put("reportKod1", "SL");
                //                    reportMap.put("reportName2", "DISSMLULUSRINGKAS_MLK.rdf");
                //                    reportMap.put("reportKod2", "SL");
                //                }
                else if (stageID.contentEquals("sedia_borang_4a")) {
                    reportMap.put("reportName1", "DISB4AePLPS_MLK.rdf");
                    reportMap.put("reportKod1", "4A");
//                    reportMap.put("reportName2", "DISBL1e_MLK.rdf");
//                    reportMap.put("reportKod2", "L1e");
                    ...
                    reportMap.put("reportName1", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod1", "KMN");
                    reportMap.put("reportName2", "DISKMMKNPLPSandLPSPPTG_MLK.rdf");
                    reportMap.put("reportKod2", "RMN");
                } else if (stageID.contentEquals("semak_draf_mmkn3_1")) {
                    reportMap.put("reportName1", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod1", "KMN");
                } else if (stageID.contentEquals("semak_draf_mmkn3_2")) {
                    reportMap.put("reportName1", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod1", "KMN");
                    reportMap.put("reportName2", "DISKMMKNPLPSandLPSPPTG_MLK.rdf");
                    reportMap.put("reportKod2", "RMN");
    ...
    public HashMap getReportByCasePBMT(String stageID, int numnegeri, Permohonan p) {
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    /*
                     * TO CHECK WHICH REPORT IS MORE RELEVENT TO USED
                     */
                    reportMap.put("reportName1", "DISMB_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "MINB");
                    reportMap.put("reportName2", "DISSrtMaklumanTolakPTD_MLK_PBMT.rdf");
                    reportMap.put("reportKod2", "SMT");
                } else if (stageID.contentEquals("semak_surat_tolak")) {
                    /*
                     * TO CHECK WHICH REPORT IS MORE RELEVENT TO USED
                     */
                ...
                } else if (stageID.contentEquals("sedia_draf_mmk")) {
                    reportMap.put("reportName1", "DISKMMKNPBMTPTD_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_draf_mmkSO")) {
                    reportMap.put("reportName1", "DISKMMKNPBMTPTD_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_draf_mmkKPT")) {
                    reportMap.put("reportName1", "DISKMMKNPBMTPTD_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("perakuan_kertas_mmkPTD")) {
                    reportMap.put("reportName1", "DISKMMKNPBMTPTD_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_draf_MMKN_PTG2")) {
                ...
                } else if (stageID.contentEquals("semak_draf_MMKN_PTG")) {
                    reportMap.put("reportName1", "DISKMMKNPBMTPTG_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                    reportMap.put("reportName2", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod2", "KMN");
                } else if (stageID.contentEquals("terima_draf_MMKN_PTG")) {
                    reportMap.put("reportName1", "DISKMMKNPBMTPTG_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                    reportMap.put("reportName2", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod2", "KMN");
                } else if (stageID.contentEquals("pindaan_draf_MMKN_PTG")) {
                    reportMap.put("reportName1", "DISKMMKNPBMTPTG_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                    reportMap.put("reportName2", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod2", "KMN");
                    ...
                    reportMap.put("reportName1", "DISKMMKNPBMTPTD_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_pindaan_MMKN_PTD_3_1")) {
                    reportMap.put("reportName1", "DISKMMKNPBMTPTD_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "RMN");
                    ...
                    reportMap.put("reportKod1", "SMT");
                } else if (stageID.contentEquals("semak_surat_tolak_MMK")) {
                    reportMap.put("reportName1", "DISSrtMaklumanTolakPTD_MLK_PBMT.rdf");
                    reportMap.put("reportKod1", "SMT");
                } else if (stageID.contentEquals("semak_Brg5A")) {
                    ...
                    reportMap.put("reportName1", "DISSrtTuntutTambahan_MLK.rdf");
                    reportMap.put("reportKod1", "STPT");
                }
...
//                }
            ...
            case 2:
                ...
                if (stageID.contentEquals("sedia_surat_tolak")) {
                    ...
                    reportMap.put("reportKod1", "PER");
                } else if (stageID.contentEquals("semak_draf_jktdKPT")) {
                    ...
                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("cetak_kertas_makluman")) {
                    reportMap.put("reportName1", "DISMAKLUM_MMK_NS.rdf");
...
//                    reportMap.put("reportName1", "DISSPLPSL_PBMT_NS.rdf");
                    ...
                    reportMap.put("reportKod1", "SL");
                    reportMap.put("reportName2", "DISB5A_NS.rdf");
                    reportMap.put("reportKod2", "5AA");
                ...
                //                } 
                    ...
                    reportMap.put("reportName2", "DISBPU_PBMT_NS.rdf");
                    reportMap.put("reportKod2", "PU");
                } else if (stageID.contentEquals("semak_precomp")) {
                    reportMap.put("reportName1", "DISSrtIringanPU_PBMT_NS.rdf");
                    reportMap.put("reportKod1", "OC");
                    reportMap.put("reportName2", "DISBPU_PBMT_NS.rdf");
                    reportMap.put("reportKod2", "PU");
                    ...
                    reportMap.put("reportName1", "PTD_PINDA_PBMT_NS.rdf");
                    reportMap.put("reportKod1", "KPTD");
                } else if (stageID.contentEquals("cetak_kertas_mmk2")) {
                    reportMap.put("reportName1", "MMK_PINDA_PBMT_NS.rdf");
                    reportMap.put("reportKod1", "PMMK");
                } else if (stageID.contentEquals("semak_draf_mmk2_1")) {
//                    reportMap.put("reportName1", "DISKMMKNPKPTD_NS.rdf");
//                    reportMap.put("reportKod1", "MMKS");
                    reportMap.put("reportName1", "MMK_PINDA_PBMT_NS.rdf");
...
//                }
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportName1", "DISLTLPSP_MLK.rdf");
                    reportMap.put("reportKod1", "LTPD");
                } else if (stageID.contentEquals("sedia_surat_tolak")) {
                    ...
                    reportMap.put("reportKod2", "SUA");
                } else if (stageID.contentEquals("sedia_draf_rencana_ptg")) {
                    reportMap.put("reportName1", "DISKMMKNLPSPTD_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_draf_rencana_ptg1")) {
                    reportMap.put("reportName1", "DISKMMKNLPSPTD_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_draf_rencana_ptg2")) {
                    reportMap.put("reportName1", "DISKMMKNLPSPTD_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("perakuan_draf_rencana_ptg")) {
                    reportMap.put("reportName1", "DISKMMKNLPSPPTD_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("10TerimaDraf")) {
                    reportMap.put("reportName1", "DISKMMKNLPSPPTG_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                    reportMap.put("reportName2", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod2", "KMN");
                } else if (stageID.contentEquals("10aSemakDraf")) {
    ...
    public HashMap getReportByCaseMMMCL(String stageID, int numnegeri, HakmilikPermohonan hp, Permohonan p) {
        /*
         * NOTE: reportBil = numOfReportsCalled reportName{intCount} =
         * reportName reportKod{intCount} = reportKodDokumen
         */
...
//                    reportMap.put("reportKod3", "SBTA");
                } else if (stageID.contentEquals("surat_kelulusan_brg5A1")) {
                    reportMap.put("reportName1", "DISBrg5AMCMMMCL_MLK.rdf");
                    reportMap.put("reportKod1", "5A");
                    reportMap.put("reportName2", "DISNotisB5AMCMMMCL_MLK.rdf");
                    reportMap.put("reportKod2", "5AA");
                    ...
                    for (FasaPermohonan fasa : p.getSenaraiFasa()) {
                        if (fasa.getIdAliran().contentEquals("surat_kelulusan_brg5A")) {
                            reportMap.put("reportName1", "DISSrtBatalMCL_MLK.rdf");
                            reportMap.put("reportKod1", "STP");
                            report = true;
                            break;
                        }
                    ...
                    if (!report) {
                        reportMap.put("reportName1", "DISMCMMMCLG_MLK.rdf");
                        reportMap.put("reportKod1", "STP");
                        break;
                    }
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportKod1", "LTPD");
                } else if (stageID.contentEquals("sedia_surat_ulasan_jabtek")) {
                    ...
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_draf_mmkn")) {
                    reportMap.put("reportName1", "DISKMMKNPPTRPTG_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("peraku_risalat_mmkn")) {
                    reportMap.put("reportName1", "DISKMMKNPPTRPTG_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("10TerimaDraf")) {
                    reportMap.put("reportName1", "DISKMMKNPPTRPTG_MLK.rdf");
                    ...
                    reportMap.put("reportName2", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod2", "KMN");
                } else if (stageID.contentEquals("11SemakDraf")) {
                    reportMap.put("reportName1", "DISKMMKNPPTRPTG_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                    reportMap.put("reportName2", "DISSUMMMKN_MLK.rdf");
                    reportMap.put("reportKod2", "KMN");
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    if (p.getKeputusan().getKod().equalsIgnoreCase("SL")) {
                        reportMap.put("reportName1", "DISRJKBBPTD_MLK.rdf");
                        reportMap.put("reportKod1", "JKBB");
                    } else if (p.getKeputusan().getKod().equalsIgnoreCase("ST")) {
                        reportMap.put("reportName1", "DISRJKBBPTDT_MLK.rdf");
                        reportMap.put("reportKod1", "JKBB");
                    }
                } else if (stageID.contentEquals("semak_draf_rencana_km2")) {
                    reportMap.put("reportName1", "DISRJKBBPPBB_MLK.rdf");
                    reportMap.put("reportKod1", "JKBB");
                ...
                } else if (stageID.contentEquals("sedia_laporan_pantau")) {
                    reportMap.put("reportName1", "DISLTekWC_MLK.rdf");
                    reportMap.put("reportKod1", "LTWC");
                } else if (stageID.contentEquals("semak_laporan_pantau")) {
                    reportMap.put("reportName1", "DISLTekWC_MLK.rdf");
                    reportMap.put("reportKod1", "LTWC");
                }
    ...
    public HashMap getReportByCasePBPTD(String stageID, int numnegeri, Permohonan p) {
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                ...
                } else if (stageID.contentEquals("semak_surat_lulus")) {
                    if (p.getKeputusan().getKod().equalsIgnoreCase("L")) {
                        reportMap.put("reportName1", "DISSKpsnLPBPTD_MLK.rdf");
                        reportMap.put("reportKod1", "SL");
                    } else if (p.getKeputusan().getKod().equalsIgnoreCase("T")) {
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportName2", "DIS_BorangP1e_MLK.rdf");
                    reportMap.put("reportKod2", "P1e");
                    reportMap.put("reportName3", "DISSKpsnLPBPTG_MLK.rdf");
                    reportMap.put("reportKod3", "SL");
                    reportMap.put("reportName4", "DISSrtKpsnMMKNPBPTGL_MLK.rdf");
                    reportMap.put("reportKod4", "SKM");
                } else if (stageID.contentEquals("tandatangan_permit")) {
                    reportMap.put("reportName1", "DISBrg4Ce_MLK.rdf");
                    reportMap.put("reportKod1", "4Ce");
                    reportMap.put("reportName2", "DIS_BorangP1e_MLK.rdf");
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportName1", "DISSPPRUT_MLK.rdf");
                    reportMap.put("reportKod1", "STP");
                } else if (stageID.contentEquals("semak_surat_kelulusan")) {
            ...
            case 2: //NEGERI SEMBILAN
                ...
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportName1", "DISLTPPRUPPT_NS.rdf");
                    reportMap.put("reportKod1", "LT");
                } else if (stageID.contentEquals("06SmkLapTnh")) {
                    reportMap.put("reportName1", "DISLTPPRUPPTK_NS.rdf");
                    reportMap.put("reportKod1", "LT");
                } else if (stageID.contentEquals("07KnlpstiJbtnTknkl")) {
                    reportMap.put("reportName1", "DISSUT_NS.rdf");
                    reportMap.put("reportKod1", "SUT");
                } else if (stageID.contentEquals("09SedSrtPeringatan")) {
                    reportMap.put("reportName1", "DISSUT_NS.rdf");
                    reportMap.put("reportKod1", "SUT");
                } else if (stageID.contentEquals("12SmkDrfMMK")) {
                    reportMap.put("reportName1", "DISKMMKNPPRUPTD_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("17SmkDrfMMK")) {
                    reportMap.put("reportName1", "DISKMMKNPPRUPTG_NS.rdf");
                    reportMap.put("reportKod1", "MMK");
//                } else if (stageID.contentEquals("23TrmKptsnSiasatan")) {
...
//                    reportMap.put("reportKod1", "MLM");
                } else if (stageID.contentEquals("24Perakukan")) {
                    reportMap.put("reportName1", "DISKMMKTangguh_NS.rdf");
                    reportMap.put("reportKod1", "KSM");
                } else if (stageID.contentEquals("29TdtgnSrtLulus")) {
                    reportMap.put("reportName1", "DISSPPRUL_NS.rdf");
                    reportMap.put("reportKod1", "SL");
                } else if (stageID.contentEquals("32TdtgnSrtTlk")) {
                    reportMap.put("reportName1", "DISSPLPSG_NS.rdf");
                    reportMap.put("reportKod1", "STP");
                } else if (stageID.contentEquals("37Tdtgn4de")) {
...
//                }
    ...
    public HashMap getReportByCasePBRZ(String stageID, int numnegeri, HakmilikPermohonan hp, Permohonan p) {
        /*
         * NOTE: reportBil = numOfReportsCalled reportName{intCount} =
         * reportName reportKod{intCount} = reportKodDokumen
         */
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_draf_mmkSO") || stageID.contentEquals("semak_draf_mmkKPT") || stageID.contentEquals("perakuan_kertas_mmkPTD")) {
                    reportMap.put("reportName1", "DISKMMKNPBRZPTD_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("semak_draf_MMKN_PTG2") || stageID.contentEquals("semak_syor_draf_MMKN_PTG")) {
                    reportMap.put("reportName1", "DISKMMKNPBRZPTG_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("rekod_keputusan_MMKN_PTG") || stageID.contentEquals("rekod_keputusan_MMKN_PTG2")) {
                    if (hp.getKeputusan() != null) {
                        if (hp.getKeputusan().getKod().equals("L")) {
                            reportMap.put("reportName1", "DISSrtKpsnMMKNPBRZL_MLK.rdf");
                            reportMap.put("reportKod1", "SL");
                        } else if (hp.getKeputusan().getKod().equals("T")) {
                            reportMap.put("reportName1", "DISSrtKpsnMMKNPBRZG_MLK.rdf");
                            reportMap.put("reportKod1", "STP");
                        }
                        // reportMap.put("reportKod1", "MMKT");
                    } else if (stageID.contentEquals("sediadrafwarta")) {
                        reportMap.put("reportName1", "DISdrafWartaRizabPBRZ.rdf");
                        reportMap.put("reportKod1", "DWP");
                        reportMap.put("reportName2", "DISSrtIringanWartaRizabPBRZ.rdf");
                        reportMap.put("reportKod2", "8PNB");
                    } else if (stageID.contentEquals("sedia_nota_siasatan")) {
                        reportMap.put("reportName1", "DIS_NOTIS_SIASATAN_MLK.rdf");
                        reportMap.put("reportKod1", "NSIA");
                    } else if (stageID.contentEquals("sedia_draf_mmk_batal_rizab")) {
                        reportMap.put("reportName1", "DISKMMKNPBRZPTD_MLK.rdf");
                        reportMap.put("reportKod1", "RMN");
                    } else if (stageID.contentEquals("semak_draf_mmk_batal_rizab1")) {
                        reportMap.put("reportName1", "DISKMMKNPBRZPTD_MLK.rdf");
                        reportMap.put("reportKod1", "RMN");
                    } else if (stageID.contentEquals("semak_draf_MMKN_PTG4")) {
                        reportMap.put("reportName1", "DISKMMKNPBRZPTG_MLK.rdf");
                        reportMap.put("reportKod1", "RMN");
                    } else if (stageID.contentEquals("semak_draf_MMKN_PTG5")) {
                        reportMap.put("reportName1", "DISKMMKNPBRZPTG_MLK.rdf");
                        reportMap.put("reportKod1", "RMN");
...
//                    reportMap.put("reportKod1", "SLPBS");
                        ...
                        reportMap.put("reportKod2", "PU");
                    } else if (stageID.contentEquals("sdia_drf_pngcualian_ukr")) {
                        reportMap.put("reportName1", "DISSBUU_MLK.rdf");
                        reportMap.put("reportKod1", "SPU");
                        reportMap.put("reportName2", "DISSIPUPBMT_MLK.rdf");
                        reportMap.put("reportKod2", "SIPU");
                    } else if (stageID.contentEquals("sediadrafwarta2")) {
                        reportMap.put("reportName1", "DISdrafWartaRizabPBRZ.rdf");
                        reportMap.put("reportKod1", "DWP");
                        reportMap.put("reportName2", "DISSrtIringanWartaRizabPBRZ.rdf");
                        reportMap.put("reportKod2", "8PNB");
...
//                }
            ...
            case 2: //NEGERI SEMBILAN
                if (stageID.contentEquals("48SedDrfWrtaPmbtlnRiz")) {
                    for (FasaPermohonan fasa : p.getSenaraiFasa()) {
                        if (fasa.getIdAliran().equalsIgnoreCase("30Bantahan")) {
                            if (fasa.getKeputusan() != null) {
                                if (fasa.getKeputusan().getKod().equalsIgnoreCase("XT")) { //XT = Ada Bantahan
                                    reportMap.put("reportName1", "DISDWPBRZBantahan_NS.rdf");
                                    System.out.println("::::::: reportName::: DISDWPBRZBantahan_NS.rdf");
                                } else if (fasa.getKeputusan().getKod().equalsIgnoreCase("NB")) { //NB = Tiada Bantahan
                                    reportMap.put("reportName1", "DISDWPBRZTiadaBantahan_NS.rdf");
                                    System.out.println("::::::: reportName::: DISDWPBRZTiadaBantahan_NS.rdf");
                                }
                                reportMap.put("reportKod1", "DWP");
                            }
                        }
        ...
        switch (numnegeri) {
            ...
            case 2: //NEGERI SEMBILAN
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportName1", "DISLaporanTanahV2_NS.rdf");
                    reportMap.put("reportKod1", "LT");
...
//                }
    ...
    public HashMap getReportByCaseRAYL(String stageID, int numnegeri, Permohonan p) {
        ...
        switch (numnegeri) {
            ...
            case 2: //NEGERI SEMBILAN
                if (stageID.contentEquals("01DaftarPermohonan")) {
                    reportMap.put("reportName1", "DISKRRAYLPTDH_NS.rdf.rdf");
                    reportMap.put("reportKod1", "KRPTD");
                } else if (stageID.contentEquals("07SmkSahkandanTdtgnLulus")) {
                    reportMap.put("reportName1", "DISSRAYLPTDL_NS.rdf");
                    reportMap.put("reportKod1", "SL");
                } else if (stageID.contentEquals("08TrmKptsndanSedSrtTlk")) {
                    reportMap.put("reportName1", "DISSRAYLPTDT_NS.rdf");
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("04SemakMMKN")) {
                    ...
                    reportMap.put("reportKod1", "SL");
                    reportMap.put("reportName1", "DISB5ARAYK_MLK.rdf");
                    reportMap.put("reportKod1", "N5A");
                }
                break;
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("004_Semak")) {
                    ...
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("005_Perakuan")) {
                    reportMap.put("reportName1", "DISKMMKNRAYTPTD_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("009_Semak_MMKN")) {
                    reportMap.put("reportName1", "DISKMMKNRAYTPTG_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("010_Pindaan")) {
                    reportMap.put("reportName1", "DISKMMKNRAYTPTG_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("011_PertimbanganMMKN")) {
                    reportMap.put("reportName1", "DISKMMKNRAYTPTG_MLK.rdf");
                    reportMap.put("reportKod1", "RMN");
    ...
    public HashMap getReportByCasePJTK(String stageID, int numnegeri, Permohonan p) {
        ...
        switch (numnegeri) {
            case 2: //NEGERI SEMBILAN
                ...
                } else if (stageID.contentEquals("26PenyediaanSrtKelulusan")) {
                    reportMap.put("reportName1", "DISSLPJTK_NS.rdf");
                    reportMap.put("reportKod1", "SL");
                } else if (stageID.contentEquals("tandatangan_borang_5A")) {
//                    reportMap.put("reportName1", "DISB5A_NS.rdf");
//                    reportMap.put("reportKod1", "5AA");
                    reportMap.put("reportName1", "DISSrtKelulusan_PBMT_NS.rdf");
                    reportMap.put("reportKod1", "SL");
                } else if (stageID.contentEquals("hantar_keputusan_MMK")) {
                    reportMap.put("reportName1", "DISSKpsnMMKNPBMT_NS.rdf");
                    reportMap.put("reportKod1", "SKM");
                } else if (stageID.contentEquals("semak_draf_mmkKPT")) {
                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    ...
                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("rekod_keputusan_MMKPTD")) {
                    reportMap.put("reportName1", "DISSKpsnMMKNPBMT_NS.rdf");
                    reportMap.put("reportKod1", "SKM");
                } else if (stageID.contentEquals("g_penyediaan_pu")) {
                    reportMap.put("reportName1", "DISSrtIringanPU_PBMT_NS.rdf");
    ...
    public HashMap getReportByCasePTBTC(String stageID, int numnegeri, Permohonan p) {
        ...
        switch (numnegeri) {
            case 2: //NEGERI SEMBILAN
                if (stageID.contentEquals("08SedSrtTlk")) {
                    reportMap.put("reportName1", "DISSMTPTD_NS.rdf");
                    reportMap.put("reportKod1", "SMT");
                } else if (stageID.contentEquals("13TrmUlsn")) {
                    reportMap.put("reportName1", "DISSUT_NS.rdf");
                    reportMap.put("reportKod1", "SUT");
                } else if (stageID.contentEquals("14SedSrtPeringatan")) {
                    reportMap.put("reportName1", "DISSUT_NS.rdf");
                    reportMap.put("reportKod1", "SUT");
                } else if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportKod1", "LT");
                } else if (stageID.contentEquals("17SmkDrfJKTD")) {
                    reportMap.put("reportName1", "DISKJKTDPTBTC_NS.rdf");
                    reportMap.put("reportKod1", "JKTD");
                } else if (stageID.contentEquals("22SmkSyorPerakuanPTD")) {
                    reportMap.put("reportName1", "DISKMMKPTBTC_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("27SmkDrfMMK")) {
                    reportMap.put("reportName1", "DISKMMKPTBTC_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("33TrmKptsnSiasatan")) {
                    reportMap.put("reportName1", "DISKMMKPTBTC_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("39SedSyrtKelulusan")) {
                    reportMap.put("reportName1", "DISB5A_NS.rdf");
                    reportMap.put("reportKod1", "5AA");
                } else if (stageID.contentEquals("g_penyediaan_pu")) {
    ...
    public HashMap getReportByCasePCRG(String stageID, int numnegeri, Permohonan p) {
        ...
        switch (numnegeri) {
            case 2: //NEGERI SEMBILAN
                if (stageID.contentEquals("g_laporan_tanah")) {
                    reportMap.put("reportName1", "DISLTLesen_NS.rdf");
                    reportMap.put("reportKod1", "LT");
                } else if (stageID.contentEquals("kenalpasti_jabatan_teknikal")) {
//                    reportMap.put("reportName1", "DISSUTPBMT_NS.rdf");
                    reportMap.put("reportName1", "DISSUT_NS.rdf");
                    reportMap.put("reportKod1", "SUT");
                } else if (stageID.contentEquals("11terimaUlasanTeknikal")) {
                    reportMap.put("reportName1", "DISKJKMPCRG_NS.rdf");
                    reportMap.put("reportKod1", "JKSMN");
                } else if (stageID.contentEquals("14SahKertasJKSMN")) {
                    reportMap.put("reportName1", "DISKJKMPCRG_NS.rdf");
                    reportMap.put("reportKod1", "JKSMN");
                } else if (stageID.contentEquals("20SediaDrafMmk")) {
                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("21SemakDrafMMK")) {
                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("24PerakuKertasMMK")) {
                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("25CetakKertasMMK")) {
                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("27MaklumKpsnMMK")) {
//                    for (FasaPermohonan fasa : p.getSenaraiFasa()) {
//                        if (fasa.getIdAliran().equalsIgnoreCase("19KeputusanJKSMN")) {
//                            if (fasa.getKeputusan() != null) {
//                                if (fasa.getKeputusan().getKod().equalsIgnoreCase("L")) { //L = Lulus
//                                    reportMap.put("reportName1", "DISSLPCRG_NS.rdf");
//                                    reportMap.put("reportKod1", "SL");
//                                    System.out.println("::::::: reportName::: DISSLPCRG_NS.rdf");
//                                } else if (fasa.getKeputusan().getKod().equalsIgnoreCase("T")) { //T = Tolak
//                                    reportMap.put("reportName1", "DISSMTPTG_NS.rdf");
//                                    reportMap.put("reportKod1", "SMT");
//                                    System.out.println("::::::: reportName::: DISSMTPTG_NS.rdf");
//                                }
//
//                            }
//                        }
...
//                    }
                    for (FasaPermohonan fasa : p.getSenaraiFasa()) {
                        if (fasa.getIdAliran().equalsIgnoreCase("27MaklumKpsnMMK")) {
                            if (fasa.getKeputusan() != null) {
                                if (fasa.getKeputusan().getKod().equalsIgnoreCase("L")) { //L = Lulus
                                    reportMap.put("reportName1", "DISSKpsnLPBPTG_NS.rdf");
                                    reportMap.put("reportKod1", "SL");
                                    reportMap.put("reportName2", "DISSLPCRG_NS.rdf");
                                    reportMap.put("reportKod2", "SL");
                                    System.out.println("::::::: reportName::: DISSKpsnLPBPTG_NS.rdf");
                                } else if (fasa.getKeputusan().getKod().equalsIgnoreCase("T")) { //T = Tolak
                                    reportMap.put("reportName1", "DISSKpsnGPBPTG_NS.rdf");
                                    reportMap.put("reportKod1", "SMT");
                                    System.out.println("::::::: reportName::: DISSKpsnGPBPTG_NS.rdf");
                                }
                    ...
                    reportMap.put("reportName1", "DISLPPJLB_NS.rdf");
                    reportMap.put("reportKod1", "LPE");
                } else if (stageID.contentEquals("35SediaLesen")) {
                    reportMap.put("reportName1", "DISBrgD_NS.rdf");
                    reportMap.put("reportKod1", "BD");
                } else if (stageID.contentEquals("16SediaSuratMesyuarat")) {
                    reportMap.put("reportName1", "DISPMESY_NS.rdf");
                    reportMap.put("reportKod1", "SPM");
                } else if (stageID.contentEquals("39TandatanganLesen")) {
                    reportMap.put("reportName1", "DISBrgF_NS.rdf");
                    reportMap.put("reportKod1", "F");
                }
                break;
    ...
    public HashMap getReportByCaseLPJH(String stageID, int numnegeri, Permohonan p) {
        /*
         * NOTE: reportBil = numOfReportsCalled reportName{intCount} =
         * reportName reportKod{intCount} = reportKodDokumen
         */
...
//                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    reportMap.put("reportName1", "DISKMMKPCRG_NS.rdf");
                    reportMap.put("reportKod1", "RMN");
                } else if (stageID.contentEquals("21SemakDrafMMK")) {
//                    reportMap.put("reportName1", "DISMMKNPBMT_NS.rdf");
                    reportMap.put("reportName1", "DISKMMKPCRG_NS.rdf");
...
//                                    reportMap.put("reportName1", "DISSKpsnLPBPTG_NS.rdf");
//                                    reportMap.put("reportKod1", "SL");
                                    reportMap.put("reportName1", "DISLPJH_NS.rdf");
                                    reportMap.put("reportKod1", "SL");
                                    System.out.println("::::::: reportName::: DISSKpsnLPBPTG_NS.rdf");
                                } else if (fasa.getKeputusan().getKod().equalsIgnoreCase("T")) { //T = Tolak
                                    reportMap.put("reportName1", "DISSKpsnGPBPTG_NS.rdf");
                    ...
                    reportMap.put("reportName1", "DISBrgE_NS.rdf");
                    reportMap.put("reportKod1", "F");
                }
                break;
    ...
    public HashMap getReportByCasePWGSA(String stageID, int numnegeri, Permohonan p) {
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                ...
                break;
            case 2: //NEGERI SEMBILAN
                if (stageID.contentEquals("g_charting_keputusan")) {
                    reportMap.put("reportName1", "DISLPPWGSA_NS.rdf");
                    reportMap.put("reportKod1", "LPE");
                } else if (stageID.contentEquals("04SedPermhnanSBU")) {
                    reportMap.put("reportName1", "DISSPUUWGSA_NS.rdf");
                    reportMap.put("reportKod1", "SBU");
                } else if (stageID.contentEquals("8aSedPU")) {
                    reportMap.put("reportName1", "DISSIPUWGSA_NS.rdf");
                    reportMap.put("reportKod1", "OC");
                    reportMap.put("reportName2", "DISBorangPUPWGSA_NS.rdf");
                    reportMap.put("reportKod2", "PU");
                } else if (stageID.contentEquals("15SmkdanSyrDrafWrta")) {
                    reportMap.put("reportName1", "DISSWGWSA_NS.rdf");
                    reportMap.put("reportKod1", "DW");
                } else if (stageID.contentEquals("17PerakudanCtkWrta")) {
                    reportMap.put("reportName1", "DISSWGWSA_NS.rdf");
                    reportMap.put("reportKod1", "DW");
                } else if (stageID.contentEquals("18KmskniMklmnAgensi")) {
    ...
    public HashMap getReportByCaseMLCRG(String stageID, int numnegeri, Permohonan p) {
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                ...
                } else if (stageID.contentEquals("21sedia_surat_kelulusan")) {
                    if (p.getKeputusan() != null) {
                        if (p.getKeputusan().getKod().equals("L")) {
                            reportMap.put("reportName1", "DISSPJLBL_MLK.rdf");
                            reportMap.put("reportKod1", "SL");
                            reportMap.put("reportName2", "DISBrgD_MLK.rdf");
                            reportMap.put("reportKod2", "BD");
                            reportMap.put("reportName3", "DISBrgE_MLK.rdf");
                            reportMap.put("reportKod3", "RE");
                        } else if (p.getKeputusan().getKod().equals("T")) {
                            reportMap.put("reportName1", "DISSPJLBL_MLK.rdf");
                            reportMap.put("reportKod1", "SL");
                        }
        ...
        switch (numnegeri) {
            case 1: //MELAKA
                if (stageID.contentEquals("g_charting_permohonan")) {
                    ...
                    reportMap.put("reportKod1", "LPE");
                } else if (stageID.contentEquals("07sedia_dokumen")) {
