 ...
 * @author mohd.faidzal
 */
public class PLPTEndorsanPembatalanValidator implements StageListener {

    private static final Logger LOG = Logger.getLogger(PLPTEndorsanPembatalanValidator.class);
    @Inject
