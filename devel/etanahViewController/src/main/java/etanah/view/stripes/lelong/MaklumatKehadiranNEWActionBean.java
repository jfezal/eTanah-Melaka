 ...
 */
@UrlBinding("/lelong/maklumat_kehadiran_NEW")
public class MaklumatKehadiranNEWActionBean extends AbleActionBean {

    private static final Logger LOG = Logger.getLogger(MaklumatKehadiranNEWActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("lelong/maklumat_Kehadiran_NEW.jsp").addParameter("tab", "true");
    }
...
//        listKehadiran = lelongService.getListWakil(Long.parseLong(idPihak), idPermohonan);
        ...
        LOG.info("idMP : " + idMP);
        return new JSP("lelong/tambah_pemeganggadai_wakil.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution showForm4() {
        return new JSP("lelong/view_kehadiran_NEW.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (permohonan.getIdPenyerah() != null) {
                Long idPenyerah = permohonan.getIdPenyerah();
                LOG.info("ID PENYERAH = " + permohonan.getIdPenyerah());
            ...
            if (!listKehadiran.isEmpty()) {
                ...
                for (Kehadiran kk : listKehadiran) {
                    LOG.info("APe benda dalam nie = ; " + kk.getIdKehadiran());
                    if (kk.getIdPenyerah() == null) {
                        listKehadiran2.add(kk);
                        if (kk.getHakmilikPihakBerkepentingan() != null) {
                            if (kk.getHakmilikPihakBerkepentingan().getJenis().getKod().equals("PG")) {
                                LOG.info("--------PG---------");
                                if (!StringUtils.isEmpty(kk.getHadir())) {
                                    if ((kk.getHadir().equals("N")) && (StringUtils.isEmpty(kk.getWakilNama()))) {
                                        xhadir = true;
                                        LOG.info("----------Tak hadir----------");
                                    } else {
                                        LOG.info("----------Hadir----------");
                        ...
                        if (kk.getPermohonanPihak() != null) {
                            if (kk.getPermohonanPihak().getJenis().getKod().equals("PG")) {
                                LOG.info("--------PG---------");
                                if (!StringUtils.isEmpty(kk.getHadir())) {
                                    if ((kk.getHadir().equals("N")) && (StringUtils.isEmpty(kk.getWakilNama()))) {
                                        xhadir = true;
                    ...
                    if (kk.getIdPenyerah() != null) {
                        if (!StringUtils.isEmpty(kk.getHadir())) {
                            if (kk.getHadir().equals("Y")) {
                                idPeguam = "yes";
                            }
                        }
                    }
                }
                if (idPeguam.equals("yes")) {
                    xhadir = false;
                }
            } else {
                showForm2();
    ...
    public Resolution save() {
        ...
        if ("05".equals(conf.getProperty("kodNegeri"))) {
            //negeri9
            if (xhadir == true) {
                addSimpleMessage("Maklumat Telah Berjaya Disimpan.Sila Masukkan Kos Kehadiran");
            } else {
                addSimpleMessage("Maklumat Telah Berjaya Disimpan");
            }
