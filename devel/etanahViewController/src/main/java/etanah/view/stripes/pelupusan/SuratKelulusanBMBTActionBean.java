 ...
 * @author afham
 */
@UrlBinding("/pelupusan/suratKelulusanBMBT")
public class SuratKelulusanBMBTActionBean extends AbleActionBean {
    ...
    public Resolution showForm(){
        return new JSP("pelupusan/bmbt/surat_kelulusan_BMBT.jsp").addParameter("tab", "true") ;
    }
    ...
    public Resolution searchHakmilik() throws ParseException {
        ...
        hakmilikPermohonan = hakmilikPermohonanDAO.findById(new Long(idhakmilikpermohonan));
        rehydrate();
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/bmbt/surat_kelulusan_BMBT.jsp").addParameter("tab", "true");
    }
