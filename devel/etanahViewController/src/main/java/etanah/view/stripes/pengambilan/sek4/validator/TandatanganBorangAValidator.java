 ...
 * @author mohd.faidzal
 */
public class TandatanganBorangAValidator implements StageListener {
...
//terima_warta "TRWT";   
        ...
        sek4IntegrationFlowService.completeTask(ref.HANTAR_WARTA, context.getPermohonan(), context.getPengguna());
