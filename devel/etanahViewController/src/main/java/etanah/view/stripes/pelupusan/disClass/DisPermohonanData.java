...
public class DisPermohonanData {   
    ...
    public ArrayList getProposedByCasePBMT(int numUrusan, String stageID, String negeri, Permohonan p,DisLaporanTanahService disLaporanTanahService) {
        ...
        return proposedList;
    } //getProposedByCasePBMT
    
    public ArrayList getProposedByCasePJTK(int numUrusan, String stageID, String negeri, Permohonan p,DisLaporanTanahService disLaporanTanahService) {
        ...
        switch (Integer.valueOf(negeri)) {
            ...
            case 05: 
                // NEGERI SEMBILAN
                if (stageID.contentEquals("01Kemasukan")) {
    ...
    } //getProposedByCasePJTK
    
    public ArrayList getProposedByCasePWGSA(int numUrusan, String stageID, String negeri, Permohonan p,DisLaporanTanahService disLaporanTanahService) {
