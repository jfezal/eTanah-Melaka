 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/maklumatPampasan")
public class MaklumatPampasanActionBean extends AbleActionBean {
...
//    private HakmilikPermohonanService hakmilikPermohonanService;
    ...
    private static final Logger LOG = Logger.getLogger(MaklumatPampasanActionBean.class);
//    private List<PerbicaraanKehadiran> hakmilikPerbicaraanList;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/maklumat_pampasan.jsp").addParameter("tab", "true");
    }
