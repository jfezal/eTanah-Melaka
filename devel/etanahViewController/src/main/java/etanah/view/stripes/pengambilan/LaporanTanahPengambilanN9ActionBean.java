 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/laporanTanahPengambilan_n9")
public class LaporanTanahPengambilanN9ActionBean extends AbleActionBean {
    @Inject
    ...
    private static final Logger LOG = Logger.getLogger(LaporanTanahPengambilanN9ActionBean.class);
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/negerisembilan/laporan_tanah_n9.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            laporanUlasanPPT = laporanTanahService.getLaporUlasanByIdMohonJenis(idPermohonan, "PPT");
            if(laporanUlasanPPT != null && laporanUlasanPPT.getUlasan() != null)
                ulasan1 = laporanUlasanPPT.getUlasan();

            laporanUlasanSOCIAL = laporanTanahService.getLaporUlasanByIdMohonJenis(idPermohonan, "SOCIAL");
            if(laporanUlasanSOCIAL != null && laporanUlasanSOCIAL.getUlasan() != null)
                ulasan2 = laporanUlasanSOCIAL.getUlasan();

            laporanUlasanPPTK = laporanTanahService.getLaporUlasanByIdMohonJenis(idPermohonan, "PPTK");
    ...
    public Resolution simpanLaporanTanah() throws Exception {
        ...
        if (idPermohonan != null) {
            ...
            if(jenisKegunaan == 'B'){
                ...
                if(laporanTanahService.findLaporanTanahByIdMohonMH(idPermohonan,hakmilikPermohonan.getId()) != null){
                    permohonanLaporanBangunanPList = laporanTanahService.getLaporBngnByIdLaporan(laporanTanah.getIdLaporan(),"P");
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/negerisembilan/laporan_tanah_n9.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution tambahBangunanPopup() {
        ...
        return new JSP("pengambilan/negerisembilan/laporan_tanah_popup.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution uploadDoc() {
        ...
        return new JSP("pengambilan/negerisembilan/Upload_Imej_Laporan.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution simpanImejLaporan() throws Exception{
      ...
      public Resolution refreshpage() {
          rehydrate();
          return new RedirectResolution(LaporanTanahPengambilanN9ActionBean.class, "locate");
      }
