 ...
 */
@UrlBinding("/consent/makluman_mmk")
public class MaklumanMmkActionBean extends AbleActionBean {
    ...
    public Resolution showPtPtg() {
        ...
        return new JSP("consent/makluman_mmk.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (!(permohonan.getSenaraiPihak().isEmpty()) && !(permohonan.getSenaraiPemohon().isEmpty()) && !(permohonan.getSenaraiHakmilik().isEmpty())) {
            ...
            if (permohonanKertasTemp == null) {
                ...
                } else if (permohonan.getKodUrusan().getKod().equals("MCMMK") || permohonan.getKodUrusan().getKod().equals("MCGMB")) {
                ...
                if (permohonan.getPermohonanSebelum() == null) {
                    ...
                    if (permohonan.getKodUrusan().getKod().equals("PCMMK") || permohonan.getKodUrusan().getKod().equals("PGDMB")) {
    ...
    public Resolution simpanPtPtg() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/consent/makluman_mmk.jsp").addParameter("tab", "true");
    }
