 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/kertas_rencana_31b")
public class PengambilanKRencana831bActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(PengambilanMMKN31bActionBean.class);
    @Inject
    ...
    private final String tajuk = "MESYUARAT JAWATANKUASA KHAS PENGAMBILAN TANAH NEGERI MELAKA";
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/melaka/kertasRencana831b.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        tujuan = "Tujuan kertas ini dikemukakan adalah untuk mendapatkan pertimbangan dan keputusan Majlis Mesyuarat "
                ...
                + permohonan.getSebab()+ " di bawah Seksyen 3(1)(b), Akta Pengambilan Tanah 1960.";
        ...
        String temp = "PERMOHONAN PENGAMBILAN TANAH DARIPADA "+ permohonan.getSenaraiPemohon().get(0).getPihak().getNama() +" SELUAS LEBIH KURANG "
                ...
                + noLotList + " DAERAH " + hakmilik.getDaerah().getNama() + " DI BAWAH SEKSYEN 3(1)(B) AKTA PENGAMBILAN TANAH 1960.";
