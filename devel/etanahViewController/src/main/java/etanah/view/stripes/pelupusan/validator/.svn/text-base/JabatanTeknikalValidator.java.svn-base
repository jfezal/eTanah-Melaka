...
//            LOG.info("--------------senaraiRujukanLuar------------------------"+senaraiRujukanLuar.size());
        ...
        if (flagSubmit) {
            ...
            // tambah untuk urusan PRIZ
            FasaPermohonan fasaPermohonan = new FasaPermohonan();
            fasaPermohonan = disLaporanTanahService.getPelupusanService().findMohonFasaByIdMohonIdPengguna(permohonan.getIdPermohonan(), "terima_ulasan_teknikal");

            if (permohonan.getKodUrusan().getKod().equalsIgnoreCase("PCRG") || permohonan.getKodUrusan().getKod().equalsIgnoreCase("LPJH")) {
                fasaPermohonan = disLaporanTanahService.getPelupusanService().findMohonFasaByIdMohonIdPengguna(permohonan.getIdPermohonan(), "11terimaUlasanTeknikal");
            }
            if (fasaPermohonan == null) {
                if (disLaporanTanahService.getConf().getKodNegeri().equals("05")) {
                    if (permohonan.getKodUrusan().getKod().equals("PJLB") || permohonan.getKodUrusan().getKod().equals("LSTP")) {
                        fasaPermohonan = disLaporanTanahService.getPelupusanService().findMohonFasaByIdMohonIdPengguna(permohonan.getIdPermohonan(), "09TerimaJTEK_JKSMN");
                    }
                } else {
                    if (permohonan.getKodUrusan().getKod().equals("LMCRG") || permohonan.getKodUrusan().getKod().equals("MLCRG")) {
                        fasaPermohonan = disLaporanTanahService.getPelupusanService().findMohonFasaByIdMohonIdPengguna(permohonan.getIdPermohonan(), "03laporan_tanah");
                        ...
                        fasaPermohonan = disLaporanTanahService.getPelupusanService().findMohonFasaByIdMohonIdPengguna(permohonan.getIdPermohonan(), "10SmkCtkdanTndtngn");
                    } else if (permohonan.getKodUrusan().getKod().equals("PTSP")) { //PENGAMBILAN
                        fasaPermohonan = disLaporanTanahService.getPelupusanService().findMohonFasaByIdMohonIdPengguna(permohonan.getIdPermohonan(), "10KMTerimaTeknikal");
                    }else {
                        fasaPermohonan = disLaporanTanahService.getPelupusanService().findMohonFasaByIdMohonIdPengguna(permohonan.getIdPermohonan(), "sedia_draf_mmkn");
                    }
                }
            }
            ...
            if (fasaPermohonan.getKeputusan() != null) {
                if (fasaPermohonan.getKeputusan().getKod().equals("Y")) {
                    if (senaraiJTekUlas.size() > 0) {
                        for (UlasanJabatanTeknikal jTekUlas : senaraiJTekUlas) {
                            if (jTekUlas.getKodStatusUlasanJabatanTeknikal() != null) {
                ...
                if (senaraiKelompokIdMohonInduk.size() > 0) {
                    if (senaraiKelompokIdMohonInduk.get(0).getJenisKelopok().equals("T") || senaraiKelompokIdMohonInduk.get(0).getJenisKelopok().equals("R")) {
                        for (PermohonanKelompok pk : senaraiKelompokIdMohonInduk) {
                            ...
                            // aku tambah untuk urusan PRIZ
                            if (idAliranTerkini.equals("terima_ulasan_teknikal") || (idAliranTerkini.equals("sedia_draf_mmkn"))) {
                                if (disLaporanTanahService.getConf().getKodNegeri().equals("05")) {
                                    FasaPermohonan fasaPermohonan = new FasaPermohonan();
                                    fasaPermohonan = disLaporanTanahService.getPelupusanService().findMohonFasaByIdMohonIdPengguna(pk.getPermohonan().getIdPermohonan(), "terima_ulasan_teknikal");
                                    if (fasaPermohonan != null) {
                                        if (fasaPermohonan.getKeputusan() != null) {
                                            if (fasaPermohonan.getKeputusan().getKod().equals("Y")) {
                                                count++;
