...
@UrlBinding("/pelupusan/draf_mmk_mmre")
public class DrafMMK_MMREActionBean extends AbleActionBean {
...
//    private PermohonanKertas permohonankertas;
    ...
    public Resolution showForm1() {
        ...
        return new JSP("pelupusan/mmre/draf_mmkn_PRIZ_mlk.jsp").addParameter("tab", "true");
    }
//    @DefaultHandler
    ...
    public void rehydrate() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("MMRE")) {
           ...
           fasaPermohonan = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "08PenyediaanDrafMMK"); 
        } else if(permohonan.getKodUrusan().getKod().equals("JMRE")) {
           fasaPermohonan = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "01Kemasukan"); 
...
//            }
            ...
            if (permohonan.getKodUrusan().getKod().equals("MMRE") || permohonan.getKodUrusan().getKod().equals("WMRE") || permohonan.getKodUrusan().getKod().equals("JMRE") || permohonan.getKodUrusan().getKod().equals("BMRE")) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("BMRE")) {
                tajukTujuanDraf = "Tujuan kertas ini adalah untuk mendapatkan pertimbangan Majlis Mesyuarat Kerajaan Negeri Sembilan Darul Khusus bagi permohonan daripada " + nama + " yang beralamat di " + alamat + " untuk mengeluarkan tanah miliknya " 
                              + lotntajuk + ", " + bpm + ", Daerah " + daerah + " dari Rizab Melayu";
           
                tajukMainDraf = "PERMOHONAN DARIPADA  " + pihakName + " BAGI MENGELUARKAN TANAH MILIKNYA " + lotntajuk.toUpperCase() + ", " + bpm.toUpperCase() + ", DAERAH " + daerah.toUpperCase()+ " DARI RIZAB MELAYU";
            }else{
...
//                                break;
            ...
            if(permohonan.getKodUrusan().getKod().equals("MMRE")){
                ...
                if(stageId.equals("08PenyediaanDrafMMK")){
                 PermohonanKertasKandungan mohonKertasKand = new PermohonanKertasKandungan();           
                            if (mohonKertasKand == null) {
                                SimpandrafJKBB();
                            }
...
//        }
    ...
    public void settingDefaultValue() {
        ...
        tujuan = " Tujuan rencana ini ialah untuk mendapatkan pertimbangan Majlis Mesyuarat Kerajaan Negeri, Negeri Sembilan mengenai permohonan ";
...
//            }
            ...
            if (fasaPermohonan != null) {
                ...
                if (permohonan.getKodUrusan().getKod().equals("WMRE")){
                   fasaPermohonan.setIdAliran("08PenyediaanDrafMMK"); 
                }
                if (permohonan.getKodUrusan().getKod().equals("JMRE")){
                   fasaPermohonan.setIdAliran("01Kemasukan"); 
                }
                if (permohonan.getKodUrusan().getKod().equals("BMRE")){
                   fasaPermohonan.setIdAliran("08PenyediaanDrfMMK"); 
                }
...
//            LOG.info("PLK" + pLK.getSubtajuk());
    ...
    public Resolution showsyortolaklulus() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("WMRE")) {
            idAliran = "08PenyediaanDrafMMK";
        }
        if (permohonan.getKodUrusan().getKod().equals("JMRE")) {
            idAliran = "01Kemasukan";
        }
        if (permohonan.getKodUrusan().getKod().equals("BMRE")) {
            idAliran = "08PenyediaanDrfMMK";
        }
