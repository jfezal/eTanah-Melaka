...
@UrlBinding("/pengambilan/perintah_sek8")
public class PerintahSek8ActionBean extends AbleActionBean {
    ...
    private static final Logger logger= Logger.getLogger(PerintahSek8ActionBean.class);
    ...
    public Resolution showForm1() {
        ...
        show = "Edit";
        return new JSP("pengambilan/Deraf_Perintah_Sek8.jsp").addParameter("tab", "true");
    }
