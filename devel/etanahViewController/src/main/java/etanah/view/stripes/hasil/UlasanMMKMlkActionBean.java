 ...
 * @author abu.mansur
 */
@UrlBinding("/hasil/ulasan_mmk_mlk")
public class UlasanMMKMlkActionBean extends AbleActionBean {
    private static final Logger LOG = Logger.getLogger(UlasanMMKMlkActionBean.class);
...
//    String tarikhMesyuarat;
    ...
    public Resolution showForm() {
        ...
        return new JSP("hasil/ulasan_kertas_mmk_mlk.jsp").addParameter("tab", "true");
    }
...
//                    tarikhMesyuarat = sdf.format(kertasKandungan.getInfoAudit().getTarikhMasuk());
        ...
        for (Transaksi transaksi : senaraiTransaksi) {
            if(transaksi.getKodTransaksi().getKod().equals(khconf.getProperty("dendaLewat")))
...
//        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        ...
        return new ForwardResolution("/WEB-INF/jsp/hasil/ulasan_kertas_mmk_mlk.jsp").addParameter("tab", "true");
    }
