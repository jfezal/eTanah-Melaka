 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/borangM")
public class BorangMActionBean_1 extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/Borang_M_1.jsp").addParameter("tab", "true");
    }

    public Resolution showForm2() {
        LOG.info(":: masuk showform 2 ::");
