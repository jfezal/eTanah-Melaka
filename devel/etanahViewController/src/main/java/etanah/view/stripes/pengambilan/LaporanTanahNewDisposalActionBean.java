 ...
 * @author User
 */
@UrlBinding("/pengambilan/laporan_tanahV2")
public class LaporanTanahNewDisposalActionBean extends AbleActionBean {
    ...
    private DisLaporanTanahSempadan disLaporanTanahSempadan = new DisLaporanTanahSempadan();
    ...
    public Resolution viewOnlyLaporanTanahPPT() {
        ...
        return new JSP(AcqPermohonanPage.getLT_MAIN_PAGE()).addParameter("tab", "true");
    }
...
//                senaraiHakmilikPermohonan = permohonan.getPermohonanSebelum().getSenaraiHakmilik();
            ...
            if (senaraiHakmilikPermohonan.size() > 0) {
                ...
                } else if (permohonan.getKodUrusan().getKod().equals("PJLB") && permohonan.getPermohonanSebelum() != null) {
...
//        rehydrate();
     ...
     */
    public String refreshData(String type, String catatan) {
        idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        idHakmilik = ctx.getRequest().getParameter("idHakmilik");
        ...
        switch (typeNum) {
            case 1:
                ...
                hakmilikPermohonan = pembangunanService.findHakmilikPermohonanByIdHakmilik(idPermohonan, idHakmilik);
                ...
                if (StringUtils.isEmpty(idHakmilik)) {
                    ...
                    permohonanLaporanPelan = (PermohonanLaporanPelan) disLaporanTanahService.getPlpservice().findByIdPermohonanPelan1WithMh(idPermohonan, hakmilikPermohonan.getId());
//                    permohonanLaporanPelan = (PermohonanLaporanPelan) disLaporanTanahService.findObject(permohonanLaporanPelan, new String[]{idPermohonan}, 0);
//                    permohonanLaporanPelan = (PermohonanLaporanPelan) disLaporanTanahService.findObject(permohonanLaporanPelan, new String[]{idPermohonan, idHakmilik}, 1);
            ...
            case 3:
                ...
                if (laporanTanah.getUsahaHarga() != null) {
            ...
            case 4:
                ...
                hakmilikPermohonan = new HakmilikPermohonan();
                hakmilikPermohonan = (HakmilikPermohonan) disLaporanTanahService.findObject(hakmilikPermohonan, new String[]{idPermohonan, idHakmilik}, 0);
                LOG.info("id hm - " + hakmilikPermohonan.getId());

                laporanTanah = new LaporanTanah();
                laporanTanah = (LaporanTanah) disLaporanTanahService.findObject(laporanTanah, new String[]{String.valueOf(hakmilikPermohonan.getId())}, 0);
                LOG.info("id laporan tanah - " + laporanTanah.getIdLaporan());
                ...
                if (laporanTanah.getPermohonan() == null) {
                    ...
                    listLaporTanahSpdnTemp = disLaporanTanahService.getPlpservice().findLaporTanahSmpdnByIdLaporNJSmpdn(laporanTanah.getIdLaporan(), "U");
//                    listLaporTanahSpdnTemp = disLaporanTanahService.getPlpservice().findLaporTanahSmpdnByIdLaporNJSmpdnNIdMohon(laporanTanah.getPermohonan().getIdPermohonan(), "U"); // UTARA
                ...
                if (laporanTanah.getPermohonan() == null) {
                    ...
                    listLaporTanahSpdnTemp = disLaporanTanahService.getPlpservice().findLaporTanahSmpdnByIdLaporNJSmpdn(laporanTanah.getIdLaporan(), "S");
//                    listLaporTanahSpdnTemp = disLaporanTanahService.getPlpservice().findLaporTanahSmpdnByIdLaporNJSmpdnNIdMohon(laporanTanah.getPermohonan().getIdPermohonan(), "S"); // SELATAN
                ...
                if (laporanTanah.getPermohonan() == null) {
                    ...
                    listLaporTanahSpdnTemp = disLaporanTanahService.getPlpservice().findLaporTanahSmpdnByIdLaporNJSmpdn(laporanTanah.getIdLaporan(), "T");
//                    listLaporTanahSpdnTemp = disLaporanTanahService.getPlpservice().findLaporTanahSmpdnByIdLaporNJSmpdnNIdMohon(laporanTanah.getPermohonan().getIdPermohonan(), "T"); // TIMUR
                ...
                if (laporanTanah.getPermohonan() == null) {
                    ...
                    listLaporTanahSpdnTemp = disLaporanTanahService.getPlpservice().findLaporTanahSmpdnByIdLaporNJSmpdn(laporanTanah.getIdLaporan(), "B");
...
//                        senaraiLaporanKawasan = disLaporanTanahService.getPlpservice().findLaporanKawasanByIdPermohonanNidMH(idPermohonan, hp.getId());
            ...
            case 6:
                ...
                laporanTanah = pengambilanService.findLaporanTanahByIdPermohonanidMH(idPermohonan, mohonHakmilik.getId());
                laporanUlasanPPT = laporanTanahService.getLaporUlasanByIdMohonJenisIdLapor(idPermohonan, "PPT", "24", laporanTanah.getIdLaporan());
...
//                forwardJSP = AcqPermohonanPage.getLT_SYOR_PAGE();
                ...
                break;
            case 10:
                senaraiUlasanJabatanTeknikal = disLaporanTanahService.getPelupusanService().findPermohonanRujLuarByIdPermohonanNADUNWithPTD2(idPermohonan, "JTK");
    ...
    public Resolution simpanImejLaporan() throws Exception {
        ...
        if (idPermohonan != null) {
            ...
            if (fileToBeUpload == null) {
                addSimpleError("Sila pilih fail untuk dimuat naik.");
                return new JSP("pengambilan/melaka/LaporanTanahEdit/Upload_imej_Laporan_Tanah_Pelupusan.jsp").addParameter("popup", "true");
            }
...
//                addSimpleError("Sila mengikut format yang ditetapkan.");
//                return new JSP("pengambilan/melaka/LaporanTanahEdit/Upload_imej_Laporan_Tanah_Pelupusan.jsp").addParameter("popup", "true");
//            }
...
//                imejLaporan.setInfoAudit(disLaporanTanahService.findAudit(imejLaporan, "update", peng));
        ...
        return new JSP("pengambilan/melaka/LaporanTanahEdit/Edit_Upload_imej_Laporan_Tanah_Pelupusan.jsp").addParameter("popup", "true");
    }
...
//        display = Boolean.TRUE;
        ...
        int typeNum = permohonan.getKodUrusan().getKod().equals("PPBB") ? 1
                ...
                : permohonan.getKodUrusan().getKod().equals("BMBT") ? 19
                : permohonan.getKodUrusan().getKod().equals("PTNB") ? 20
                : permohonan.getKodUrusan().getKod().equals("831A") ? 21
                : 0;
...
//                }
            ...
            case 20: // Urusan = PTNB
                ...
                break;
            case 21: // Urusan = 831A
                stageId = "05LaporanTanah";
                if (stageId.equalsIgnoreCase("05LaporanTanah")) {
                    disLaporanTanahController = disLaporanTanahController.viewOnlyLaporanTanahPPT();
                    httpSession.setAttribute("disLaporanTanahController", disLaporanTanahController);
                }
                break;
    ...
    public void rehydrate() {
        ...
        if (!StringUtils.isEmpty(idHakmilik)) {
            ...
            for (HakmilikPermohonan hp : permohonan.getSenaraiHakmilik()) {
                ...
                laporanTanah = pengambilanService.findLaporanTanahByIdPermohonanidMH(idPermohonan, hp.getId());
                if (laporanTanah != null) {
                    laporanUlasanPPT = laporanTanahService.getLaporUlasanByIdMohonJenisIdLapor(idPermohonan, "PPT", "24", laporanTanah.getIdLaporan());
                }
            }
//            mohonHakmilik = permohonan.getSenaraiHakmilik().get(0);
        }
...
//                listLaporTanahSpdnTemp = disLaporanTanahService.getPlpservice().findLaporTanahSmpdnByIdLaporNJSmpdnNIdMohon(laporanTanah.getPermohonan().getIdPermohonan(), "B"); // BARAT
        ...
        } else if ((hakmilikPermohonan != null) && (hakmilikPermohonan.getLuasLulusUom() != null)) {
            kodU = hakmilikPermohonan.getLuasLulusUom().getKod();
        }
...
//        if (pandanganImej == 'H') {
        ...
        for (ImejLaporan il : hakmilikImejLaporanListEdit) {
            LOG.info("catatan : " + il.getCatatan());
            catatan = il.getCatatan();
        }
//        }
    ...
    public Resolution kemaskiniKandunganSempadan() throws ParseException {
        ...
        lts.setNoLot(noLot);
        if (idHakmilikSmpdn != null) {
            Hakmilik hm = disLaporanTanahService.getHakmilikDAO().findById(idHakmilikSmpdn);
            lts.setHakmilik(hm);
        }
    ...
    public Resolution simpanKandunganSempadan() throws ParseException {
        ...
        switch (numType) {
            case 1:
                updateKandungan("U", data, idHm);
                break;
            case 2:
                updateKandungan("B", data, idHm);
                break;
            case 3:
                updateKandungan("T", data, idHm);
                break;
            case 4:
                updateKandungan("S", data, idHm);
                break;
        }
        rehydrate();
...
//        return new JSP("pelupusan/laporan_tanahTemplate.jsp").addParameter("tab", "true");
    ...
    public void updateKandungan(String jnsSmpdn, String[] data, String idHm) {
            ...
            if (lt != null) {
                ...
                if (StringUtils.isNotBlank(disLaporanTanahSempadan.getStatusSempadan()) && (disLaporanTanahSempadan.getStatusSempadan().equals("U"))) {
                    ...
                    if (listLTS.size() > 0) {
                        ...
                        HakmilikPermohonan hp = pelupusanService.findByIdHakmilikIdPermohonan(idPermohonan, idHm);
                        LaporanTanah mlt = pelupusanService.findLaporanTanahByIdPermohonanAndIdMH(idPermohonan, hp.getId());
...
//                }
    ...
    public Resolution simpanPerihal() throws ParseException {
        ...
        idHakmilik = ctx.getRequest().getParameter("idHakmilik");
        HakmilikPermohonan mohonHakmilik = new HakmilikPermohonan();
        mohonHakmilik = pembangunanService.findHakmilikPermohonanByIdHakmilik(idPermohonan, idHakmilik);
//        if (!StringUtils.isEmpty(idHakmilik)) {
//            mohonHakmilik = (HakmilikPermohonan) disLaporanTanahService.findObject(mohonHakmilik, new String[]{idPermohonan, idHakmilik}, 0);
//        } else {
...
//            mohonLaporPelan = (PermohonanLaporanPelan) disLaporanTanahService.getPlpservice().findByIdPermohonanPelan1(idPermohonan);
             permohonanLaporanPelan = (PermohonanLaporanPelan) disLaporanTanahService.getPlpservice().findByIdPermohonanPelan1WithMh(idPermohonan, mohonHakmilik.getId());
...
//            mohonLaporPelan = (PermohonanLaporanPelan) disLaporanTanahService.findObject(mohonLaporPelan, new String[]{idPermohonan, idHakmilik}, 1);
        ...
        if (StringUtils.isNotBlank(kodT)) {
            ...
            if (permohonanLaporanPelan != null) {
                permohonanLaporanPelan.setKodTanah(ktt);
                permohonanLaporanPelan.setInfoAudit(disLaporanTanahService.findAudit(permohonanLaporanPelan, "update", pguna));
            } else {
                permohonanLaporanPelan = new PermohonanLaporanPelan();
                permohonanLaporanPelan.setCawangan(permohonan.getCawangan());
                permohonanLaporanPelan.setPermohonan(permohonan);
                permohonanLaporanPelan.setInfoAudit(disLaporanTanahService.findAudit(mohonLaporPelan, "new", pguna));
                permohonanLaporanPelan.setHakmilikPermohonan(mohonHakmilik);
            }
            ...
            disLaporanTanahService.getPlpservice().simpanPermohonanLaporanPelan(permohonanLaporanPelan);
        }
    ...
    public Resolution simpan() {
        ...
        if (hakmilik == null) {
            ...
            } else if (permohonan.getKodUrusan().getKod().equals("PHLP") || permohonan.getKodUrusan().getKod().equals("PTGSA")) {
    ...
    public Resolution deleteImage() {
        ...
        if (!type.isEmpty()) {
            ...
            try {
                ...
                forwardJSP = refreshData(type, catatan);

            } catch (Exception ex) {
                System.out.println("Error delete imej >> " + ex.getMessage());
                tx.rollback();
                Throwable t = ex;
    ...
    public Resolution simpanKawasan() throws ParseException {
        ...
        LOG.info("kod rizab : " + String.valueOf(kr.getKod()));
        LOG.info("pguna : " + pguna.getIdPengguna());
//        kws = (PermohonanLaporanKawasan) disLaporanTanahService.findObject(kws, new String[]{Long.toString(mohonHakmilik.getId()), String.valueOf(kr.getKod())}, 2);
        permohonanLaporanKawasan = pelupusanService.findPermohonanLaporanKawasanByIdMH(mohonHakmilik.getId(), kr.getKod());
        InfoAudit ia = new InfoAudit();
        ...
        if (permohonanLaporanKawasan == null) {
            ...
            if (kr != null) {
                LOG.info("kr tu ape : " + kr.getKod());
                kws.setKodRizab(kodRizabDAO.findById(kr.getKod()));
            }
            ...
            permohonanLaporanKawasan.setInfoAudit(ia);
            if (kr != null) {
                permohonanLaporanKawasan.setKodRizab(kr);
            }
            permohonanLaporanKawasan.setNoWarta(disLaporTanahKawasan.getNoWarta());
            if (disLaporTanahKawasan.getTarikhWarta() != null && !("").equals(disLaporTanahKawasan.getTarikhWarta())) {
                permohonanLaporanKawasan.setTarikhWarta(sdf.parse(disLaporTanahKawasan.getTarikhWarta()));
            }
            permohonanLaporanKawasan.setNoPelanWarta(disLaporTanahKawasan.getPelanWarta());
            ...
            if (disLaporTanahKawasan.getStringRizab().equals("99")) {
                permohonanLaporanKawasan.setCatatan(disLaporTanahKawasan.getCatatan());
            }
 ...
 /*
    ...
    public Resolution cariKodAgensiJTK() {
        ...
        if (!StringUtils.isBlank(idPermohonan)) {
            listMohonRujLuar = pelupusanService.findPermohonanRujLuarByIdPermohonanNADUNWithPTD(idPermohonan, "JTK");
        }
