 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/status")
public class StatusAwardActionBean extends AbleActionBean {
...
//    private HakmilikPermohonanService hakmilikPermohonanService;
    ...
    private List<Penilaian> senaraiPenilaian = new ArrayList<Penilaian>();
    private Pihak pihak;
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            try {
                ...
                System.out.println("Error fasa Permohonan rehydrate " + h);
                try {
                    /// semua desak
                    hakmilikPermohonanList = pengambilanService.findbyIdHakmilikAdaKedesakan(idPermohonan);
                    ...
                    System.out.println("Error fasa Permohonan rehydrate " + x);
