 ...
 */
@UrlBinding("/pembangunan/PhantarNotis7G")
public class PenghantaranNotis7GActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(etanah.view.stripes.pembangunan.PenghantaranNotis7GActionBean.class);
    private String _PAGE = "pembangunan/pecahBahagian/rekod_penghantaran_N7G.jsp";
...
//
    ...
    public Resolution showFormMelaka() {
        rehydrate();
        LOG.info("------showFormMelaka-----");
        if (listNotis.isEmpty()) {
            addSimpleError("Dokumen Belum Dijana.Sila Jana Dokumen Terlebih Dahulu..");
            show = true;
            return new JSP(_PAGE).addParameter("tab", "true");
...
//
    ...
    public void simpanNotis(String kodNotis7g) {

        idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        listKandunganFolder = devServices.getListDokumen7G(permohonan.getFolderDokumen().getFolderId(),kodNotis7g);
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (conf.getProperty("kodNegeri").equals("04")) {
                kodNotis7g = "NTS7G";
                //listNotis = devServices.getListNotis2(idPermohonan, "NTS7G");
                
            }else if (conf.getProperty("kodNegeri").equals("05")) {
                kodNotis7g = "N7G";
                //listNotis = devServices.getListNotis2(idPermohonan, "N7G");
...
//            listNotis.get(0).getHakmilikPihakBerkepentingan().getHakmilik().getSenaraiPihakBerkepentingan().get(0).get
            ...
            if (listNotis.isEmpty()) {//(listNotis.size() == 0)
                ...
                simpanNotis(kodNotis7g);
                listNotis = devServices.getListNotis2(idPermohonan, kodNotis7g);
            }
