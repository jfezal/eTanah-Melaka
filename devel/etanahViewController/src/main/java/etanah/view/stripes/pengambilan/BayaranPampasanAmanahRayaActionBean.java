 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/bayaran_pampasan_amanah_raya")
public class BayaranPampasanAmanahRayaActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(BayaranPampasanAmanahRayaActionBean.class);
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/Bayaran_Pampasan_Amanah_Raya.jsp").addParameter("tab", "true");
    }
        ...
        if (idPermohonan != null && idHakmilik != null) {
            ...
            if(hakmilikPermohonan != null){
                ...
                if(hakmilikPerbicaraan != null) {
                    senaraiPerbicaraanKehadiran = pengambilanService.getPerbicaraanKehadiranByKetarangan(hakmilikPerbicaraan.getIdPerbicaraan(), "Amanah");
                }
            }
        }
