...
import etanah.view.stripes.pengambilan.sek4.validator.LaporanTanahPTGValidator;
 ...
 * @author mohd.faidzal
 */
public class SemakLaporanTanahPTGValidator implements StageListener {
    @Inject
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        sek8BCIntegrationFlowService.completeTask(ref.REKOD_KEPUTUSAN_JKKPT, context.getPermohonan(), context.getPengguna());
