...
@UrlBinding("/pengambilan/ulasan_mmk")
public class UlasanMMKActionBean extends AbleActionBean {
    ...
    public void rehydrate() {
        ...
        tujuan = "Tujuan kertas ini dikemukakan adalah untuk mendapatkan pertimbangan Yang Amat Berhormat Menteri Besar Negeri Sembilan mengenai permohonan pengambilan mengikut Seksyen 3(1)(a) Akta Pengambilan Tanah 1960 daripada Pemohon bagi tujuan "+permohonan.getSebab()+ " di kawasan "+hakmilik.getBandarPekanMukim().getNama()+", " +hakmilik.getDaerah().getNama()+" seluas " +hakmilik.getLuas()+ " hektar keseluruhan/sebahagian tanah lot " + hakmilik.getLot().getKod() + ", di bawah perwakilan kuasa seperti yang diisytiharkan dalam Warta Kerajaan No.148 bertarikh 26.03.1987.Kawasan yang dimaksudkan seperti yang bertanda merah dalam pelan Lampiran A ";
...
//            }
            ...
            if (ulasan1== null || ulasan1.equals("")) {
                ulasan1 = "TIADA DATA.";
            }
            if (ulasan2 == null || ulasan2.equals("")) {
                ulasan2 = "TIADA DATA.";
            }
            if (ulasan3 == null || ulasan3.equals("")) {
                ulasan3 = "TIADA DATA.";
            }
            if (ulasan4 == null || ulasan4.equals("")) {
                ulasan4 = "TIADA DATA.";
            }
            if (ulasan5 == null || ulasan5.equals("")) {
                ulasan5 = "TIADA DATA.";
            }
            ...
            listUlasan.add(kertasbil);
            listUlasan.add(tujuan);
            listUlasan.add(latarBelakang);
            listUlasan.add(latarBelakang2);
            listUlasan.add(latarBelakang3);
            listUlasan.add(ulasan1);
            listUlasan.add(ulasan2);
            listUlasan.add(ulasan3);
            listUlasan.add(ulasan4);
            listUlasan.add(ulasan5);
            ...
            listSubtajuk.add("");
            listSubtajuk.add("");
            listSubtajuk.add(subtajuk1);
            listSubtajuk.add(subtajuk2);
            listSubtajuk.add(subtajuk3);
            listSubtajuk.add(subtajuk4);
            listSubtajuk.add(subtajuk5);
            listSubtajuk.add("");
            listSubtajuk.add("");
            listSubtajuk.add("");
            ...
            if (kandunganK != null) {
                ...
                if (!kandunganK.getKandungan().isEmpty()) {
                    ...
                    for (int j = 0; j < permohonanKertas.getSenaraiKandungan().size(); j++) {
                        ...
                        } else if (kertasKand.getBil() == 11) {
                            kertasKand.setKandungan(syorPentadbir);
                        } else if (kertasKand.getBil() == 12) {
                            kertasKand.setKandungan(huraianPtg);
                        }else if (kertasKand.getBil() == 13) {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/ulasan_mmk_pengambilan.jsp").addParameter("tab", "true");
    }
