...
@UrlBinding("/pelupusan/permohonanlpspt")

public class PermohonanLPSPTActionBean extends AbleActionBean {
    private static Logger logger = Logger.getLogger(PermohonanLPSPTActionBean.class);
    @Inject
...
@DefaultHandler
    public Resolution showForm() {
        return new JSP("pelupusan/permohonanlpspt.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution showTambahPemohon4() {
        return new JSP("pelupusan/pengesahan_borang4A.jsp").addParameter("popup", "true");
    }
