 ...
 * @author nursyazwani
 */
@UrlBinding("/pembangunan/sedia_suratKeputusan_borang5A")
public class SediaSuratBorang5AActionBean extends AbleActionBean {
    ...
    public Resolution showForm(){
        return new JSP("pembangunan/pecahSempadan/sedia_cetak_surat_keputusan_borang5A.jsp").addParameter("tab", "true");
    }
