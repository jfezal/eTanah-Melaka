...
@UrlBinding("/pembangunan/melaka/Kertas_MMKN_PBSK")
public class KertasMMKNPbskActionBean extends AbleActionBean {
    
    private static final Logger LOG = Logger.getLogger(KertasMMKNPbskActionBean.class);
    @Inject
...
//    private String perihalRayuan;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pembangunan/melaka/Kertas_MMKN_PBSK.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution showForm3() {
        ...
        if (stageId.equals("sediarisalatmmkn")) {
            btn = true;
        }
    ...
    public void rehydrate() {
        ...
        if (senaraiKertas.size() > 0) {
            ...
            senaraiKandungan4 = devService.findKertasKandByIdKertas(kertasP.getIdKertas(), 3);
...
//             "yang berbunyi \n\n"+ sekatan +"\n\n"+sekatanBaru);
    ...
    public String getCurrentStageId() {
        ...
        return stageId;
        // testing purpose
//        return stageId = "sediarisalatmmkn";
    }
...
//                LOG.info("--------masa--------:"+(jam+":"+minit+" "+pagiPetang));
        ...
        getContext().getRequest().setAttribute("edit2", Boolean.TRUE);
        btn = false;
        return new ForwardResolution("/WEB-INF/jsp/pembangunan/melaka/Kertas_MMKN_PBSK.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution deleteSingle() {
        ...
        return new RedirectResolution(KertasMMKNPbskActionBean.class, "locate");
    }
