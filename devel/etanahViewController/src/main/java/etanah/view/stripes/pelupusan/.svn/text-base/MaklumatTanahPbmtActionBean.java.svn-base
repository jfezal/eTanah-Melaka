 ...
 */
@UrlBinding("/pelupusan/maklumat_tanah_pbmt")
public class MaklumatTanahPbmtActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(MaklumatTanahPbmtActionBean.class);
    ...
    private String tujuan = "true";
    private String stageId;

    @DefaultHandler
    public Resolution showForm() {
        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        return new JSP("pelupusan/maklumat_tanah_dipohon_pbmt.jsp").addParameter("tab", "true");
    }
...
//        stageId="agihan_tugas"; Uncomment line 331-337 when commit
...
//            tujuan="true";
 ...
 //       }
        ...
        if (idPermohonan != null) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("PLPS") || permohonan.getKodUrusan().getKod().equals("PRMP") || permohonan.getKodUrusan().getKod().equals("PLPTD") || permohonan.getKodUrusan().getKod().equals("RLPS") || permohonan.getKodUrusan().getKod().equals("RLPSK")) {
...
//        logger.info("THIS IS KODDAERAH->"+kod);
    ...
    public static void setLogger(Logger logger) {
        MaklumatTanahPbmtActionBean.logger = logger;
    }
...
//        logger.info("THIS IS KODBPM ->"+kodBpm);
    ...
    public static void setKodDaerahStatic(String kodDaerahStatic) {
        MaklumatTanahPbmtActionBean.kodDaerahStatic = kodDaerahStatic;
    }
