 ...
 * @author shah
 */
@UrlBinding("/pelupusan/draf_jkm/{currentStage}")
public class DrafJKMActionBean extends AbleActionBean{
...
//    private String kuantiti2;
    ...
    public Resolution showForm1() {
        ...
        return new JSP("pelupusan/carigali/draf_jkm_mlk.jsp").addParameter("tab", "true");
    }
...
//         0401DIS2011012501 
     ...
     public void settingDefaultValue() {
        ...
        noktah = ".";
        noktahbertindih = ":";
        if(urusanStatus.equals("LMCRG"))
            tajuk = " PERMOHONAN UNTUK MENDAPATKAN LESEN MENCARIGALI DAN PENJELAJAHAN DI ATAS TANAH ";
        else if(urusanStatus.equals("PJLB"))
            tajuk = " PERMOHONAN UNTUK MENDAPATKAN LESEN PAJAKAN MELOMBONG DI ATAS TANAH ";
        ...
        if(urusanStatus.equals("LMCRG"))
            tujuan2 = " untuk mendapatkan Lesen Mencarigali Dan Penjelajahan di atas tanah ";
        else if(urusanStatus.equals("PJLB"))
...
//        return new ForwardResolution("/WEB-INF/jsp/pelupusan/draf_mmkn_ptd.jsp").addParameter("tab", "true");
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/carigali/draf_jkm_mlk.jsp").addParameter("tab", "true");
    }
