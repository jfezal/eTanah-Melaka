...
//------------------------------------------//
@UrlBinding("/pengambilan/maklumat_hakmilikpengambilanTarikBalik")
public class MaklumatHakmilikTarikBalikActionBean extends AbleActionBean {
...
//        return new JSP("common/paparan_maklumat_hakmilik_permohonan_terperinci.jsp").addParameter("tab", "true");
        ...
        getContext().getRequest().setAttribute("!edit", Boolean.TRUE);
        return new JSP("pengambilan/maklumat_hakmilik_pengambilanTarikBalik.jsp").addParameter("tab", "true");
    }
...
//                hakmilikPermohonanList = current.getSenaraiHakmilik();
                ...
                hakmilikPermohonanList = hakmilikPermohonanService.findIDMHByIDMohonPenarikan(idSblm);
...
//        JOptionPane.showConfirmDialog(null, hakmilikPermohonanList.size());
        ...
        return new RedirectResolution(MaklumatHakmilikTarikBalikActionBean.class, "locate");
...
//                JOptionPane.showMessageDialog(null, id);
        ...
        return new RedirectResolution(MaklumatHakmilikTarikBalikActionBean.class);
    }
