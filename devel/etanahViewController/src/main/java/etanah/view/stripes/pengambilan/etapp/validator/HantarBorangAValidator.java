 ...
 * @author zipzap
 */
public class HantarBorangAValidator implements StageListener {
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        try {
            myeTappIntegrationFlowService.completeTask(ref.SEK4_HANTAR_BORANGA, context.getPermohonan(), context.getPengguna(),context.getPermohonan().getCawangan().getDaerah());
