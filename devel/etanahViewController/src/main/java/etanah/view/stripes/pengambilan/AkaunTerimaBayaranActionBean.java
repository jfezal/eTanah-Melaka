 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/akaunTerimaBayaran")
public class AkaunTerimaBayaranActionBean extends AbleActionBean {
   ...
   @Inject
    ...
    private List<PermohonanPihak> permohonanPihakList2;
    ...
    private static final Logger LOG = Logger.getLogger(AkaunTerimaBayaranActionBean.class);
    ...
    public Resolution showForm3() {
        ...
        return new JSP("pengambilan/AkaunTerimaBayaran2.jsp").addParameter("tab", "true");
    }
...
//                hakmilikPermohonanList = permohonan.getSenaraiHakmilik();
                ...
                for (HakmilikPermohonan hakmilikPermohonan : hakmilikPermohonanList) {
                    ...
                    for (HakmilikPihakBerkepentingan hp : hakmilikPihakList) {
                        ...
                        permohonanPihakList2 = permohonanPihakService.getSenaraiPmohonPihakByIdHakmilikIdPihak2(idPermohonan, hakmilik.getNoHakmilik(), idPihak);
...
//                        permohonanPihakSblm = permohonanPihakService.getSenaraiPmohonPihakByIdHakmilikIdPihak2(idPermohonanSblm, hakmilik.getNoHakmilik(), idPihak);
                        for (PermohonanPihak p : permohonanPihakList2) {
                            if (hakmilikPerbicaraan != null) {
                                perbicaraanKehadiran = pengambilanService.getPerbicaraanKehadiranbyidMPidBicara(p.getIdPermohonanPihak(), hakmilikPerbicaraan.getIdPerbicaraan());
...
//            hakmilikPerbicaraan = pengambilanService.getHakmilikPerbicaraanByidMH(hakmilikPermohonan.getId());
            ...
            if (hakmilikPerbicaraan != null) {
                ...
                if (perbicaraanKehadiran != null) {
                    ...
                    ambilPampasan.setNoRujukan(noRujukan);
                    InfoAudit info = new InfoAudit();
                    info.setDimasukOleh(peng);
                    info.setTarikhMasuk(new java.util.Date());
    ...
    public Resolution showAkuanBayaranList() {
        ...
        long idPihak = Long.parseLong(getContext().getRequest().getParameter("idPihak"));
        idPermohonanSblm = permohonan.getPermohonanSebelum().getIdPermohonan();
        System.out.println("id mohon sblm " + idPermohonanSblm);
        if (hakmilikPermohonan != null) {
//            hakmilikPerbicaraan = pengambilanService.getHakmilikPerbicaraanByidMH(hakmilikPermohonan.getId());
            hakmilikPerbicaraan = perbicaraanService.getHakmilikPerbicaraanByIdMH(hakmilikPermohonan.getId());
            if (hakmilikPerbicaraan != null) {
                PermohonanPihak permohonanPihak = pengambilanService.getPmohonPihakByIdHakmilikIdPihak(idPermohonan, idHakmilik, idPihak);
                PermohonanPihak permohonanPihak2 = pengambilanService.getPmohonPihakByIdHakmilikIdPihak(idPermohonanSblm, idHakmilik, idPihak);
                System.out.println("permohonanPihak.getIdPermohonanPihak() " + permohonanPihak.getIdPermohonanPihak());
    ...
    public List<PermohonanPihak> getPermohonanPihakList2() {
        return permohonanPihakList2;
    }

    public void setPermohonanPihakList2(List<PermohonanPihak> permohonanPihakList2) {
        this.permohonanPihakList2 = permohonanPihakList2;
    }
