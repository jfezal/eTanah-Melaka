...
@UrlBinding("/pengambilan/draf_NotaSiasatanLngkp")
public class Laporan_DrafNotaSiasatanLngkp extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        showReports();
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/APT/cetak_NotaSiasatanLngkp.jsp");
