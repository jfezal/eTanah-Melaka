...
@UrlBinding("/pelupusan/warta_GSA2")
public class WartaGSAActionBean extends AbleActionBean{
    ...
    public Resolution showForm() {
        return new JSP("pelupusan/gsa/warta_GSA2.jsp").addParameter("tab", "true");
    }
...
//        senaraiLaporanKawasan = pelupusanService.findLaporanKawasanByIdPermohonanNKodRizab(idPermohonan);
//        if (!senaraiLaporanKawasan.isEmpty()) {
