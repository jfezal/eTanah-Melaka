 ...
 * @author mohd.faidzal
 */
public class SemakTandatanganEFValidator implements StageListener {
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        try {
            ...
            sek8aIntegrationFlowService.completeTask(ref8a.PENYAMPAIAN_EF, context.getPermohonan(), context.getPengguna());
            return proposedOutcome;
        } catch (StaleObjectException ex) {
            java.util.logging.Logger.getLogger(SemakTandatanganEFValidator.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(SemakTandatanganEFValidator.class.getName()).log(Level.SEVERE, null, ex);
            return null;
