 ...
 * Shafful
 */
@UrlBinding("/pelupusan/laporan_pelukis_pelan")
public class LaporanPelukisPelanActionBean extends AbleActionBean {
    ...
    public Resolution permohonanTerdahuluPopup() {
        ...
        return new JSP("pelupusan/carian_permohonan_terdahulu.jsp").addParameter("popup", "true").addParameter("showForm", "false");
    }

    public Resolution kawasanPopup() {
        getContext().getRequest().setAttribute("status", Boolean.FALSE);
        return new JSP("pelupusan/tambahKawasan.jsp").addParameter("popup", "true");
    }
...
//            senaraiLaporanKawasan = plpservice.find
            ...
            if (hakmilikPermohonanList != null) {
                if (permohonan.getKodUrusan().getKod().equals("PHLP") || permohonan.getKodUrusan().getKod().equals("PTGSA") || permohonan.getKodUrusan().getKod().equals("PHLA") || permohonan.getKodUrusan().getKod().equals("PBHL") || permohonan.getKodUrusan().getKod().equals("PJLB")) {
                    List senaraiHakmilikTerlibat = new ArrayList<HakmilikPermohonan>();
                    if (permohonan.getKodUrusan().getKod().equals("PTGSA") || permohonan.getKodUrusan().getKod().equals("PJLB")) {
...
//            }
        ...
        for (PermohonanManual mohonManual : permohonanManualList) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("PLPS")) {
                mohon = (Permohonan) disLaporanTanahService.findObject(mohon, new String[]{mohonManual.getNoFail()}, 1);
            } else {
...
//        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        return new JSP("pelupusan/popup_edit_kawasan.jsp").addParameter("popup", "true");
    }
