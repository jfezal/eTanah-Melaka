 ...
 * @author zipzap
 */
@UrlBinding("/pengambilan/penyampaian_e_f")
public class PenyampaianBorangEFActionBean extends AbleActionBean {
    ...
    public Resolution showForm() throws ParseException {
        ...
        return new JSP("/pengambilan/APT/penyampaian_borang_ef.jsp");
    }
    ...
    public Resolution senaraiF() {
        ...
        return new JSP("/pengambilan/APT/penyampaian_borang_f.jsp").addParameter("popup", true);
    }

    public Resolution tambahBorangE() throws ParseException {

        return new JSP("/pengambilan/APT/borangEpopup.jsp").addParameter("popup", true);

    }

    public Resolution tambahBorangF() throws ParseException {
        String idpbF = (String) getContext().getRequest().getParameter("idBorangPerPBA");
        BorangPerPB borangPerPB = borangPerPBDAO.findById(Long.parseLong(idpbF));
        ...
        if (borangPerPB != null) {
            ...
            return new JSP("/pengambilan/APT/borangFpopup.jsp").addParameter("popup", true);
    ...
    public Resolution simpanBorangE() throws ParseException {
        Pengguna pengguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
    ...
    public Resolution simpanBorangF() throws ParseException {
        Pengguna pengguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        ...
        InfoAudit infoAudit = setInfoAudit(pengguna);
        HantarBorangPB bm = new HantarBorangPB();
