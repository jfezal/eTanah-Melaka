 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/nota_siasatan_awam")
public class NotaSiasatanAwamActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/negerisembilan/haklalulalangawam/nota_siasatan_awam.jsp").addParameter("tab", "true");
    }
