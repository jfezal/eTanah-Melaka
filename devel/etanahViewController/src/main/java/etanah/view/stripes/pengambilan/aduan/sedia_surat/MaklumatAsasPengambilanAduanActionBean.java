...
@UrlBinding("/pengambilan/aduan_kerosakan/sedia_surat/maklumat_asas")
public class MaklumatAsasPengambilanAduanActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/aduan_kerosakan/sedia_surat/maklumat_asasAPT.jsp").addParameter("tab", "true");
