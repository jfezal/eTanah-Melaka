...
@UrlBinding("/pengambilan/rekodBayaranAduan")
public class rekodBayaranAduan extends AbleActionBean {

    private static Logger logger = Logger.getLogger(rekodBayaranAduan.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/Aduan/rekodbayaranAduan.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            logger.info("id mh -- " + hakmilikPermohonanList.get(0).getId());
            for (HakmilikPermohonan hakmilikPermohonan : hakmilikPermohonanList) {
                ...
                for (HakmilikPihakBerkepentingan hp : hakmilikPihakList) {
                    ...
                    String kodPB = hp.getJenis().getKod();

                    if (permohonan.getKodUrusan().getKod().equals("SEK4A")) {
                        permohonanPihak = permohonanPihakService.getSenaraiPmohonPihakByIdHakmilikIdPihakKodPihak(permohonan.getPermohonanSebelum().getIdPermohonan(), hakmilik.getIdHakmilik(), idPihak, kodPB);
                    } else {
    ...
    public Resolution showAmbilPampasanList() {
        ...
        return new JSP("pengambilan/Aduan/rekodBayaranAduan_popup.jsp").addParameter("popup", "true");
    }
