//    Document   : DrafMMKN_RayuanActionBean.java
//    Created on : June 21, 2011, 5:08:36 PM
//    Author     : Akmal
...
@UrlBinding("/pelupusan/drafMMKN_rayuan")
public class DrafMMKN_RayuanActionBean extends AbleActionBean {

    Logger logger = Logger.getLogger(DrafMMKN_RayuanActionBean.class);
    @Inject
    BPelService service;
    @Inject
...
//    private BPelService service;
    ...
    public Resolution showForm() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/rayuan/draf_mmkn_rayuan_mlk.jsp").addParameter("tab", "true");
    }
   ...
   public Resolution viewFormPTD() {
    ...
    public void rehydrate() {
        ...
        String idPermohonanSebelum = permohonan.getPermohonanSebelum().getIdPermohonan();
        permohonanRujukanLuar = pelupusanService.findPermohonanRujByIdPermohonan(idPermohonanSebelum);
        peng = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        senaraiKodItemPermit = pelupusanService.getSenaraiKodItemPermit();
        pemohon = pelupusanService.findPemohonByIdPemohon(idPermohonanSebelum);
          permohonanLaporanPelan = pelupusanService.findByIdPermohonanPelan(idPermohonanSebelum);
          laporanTanah = pelupusanService.findLaporanTanahByIdPermohonan(idPermohonanSebelum);
        }
        if (pemohon != null) {
        ...
        if (pemohon != null) {
            ...
            senaraikodKadarPremium = pelupusanService.findAllKodKadarPremium();
...
//            }
 ...
 // rohan added
        ...
        logger.info("----syaratNyata1---------"+syaratNyata1);
            ...
            ursan = permohonan.getKodUrusan().getNama();
...
//        }
        ...
        if ((hakmilikPermohonan != null) && (hakmilikPermohonan.getKodUnitLuas() != null)) {
            ...
            String tujuanursan = permohonan.getKodUrusan().getNama();
        ...
        tujuan = " Tujuan kertas ini adalah untuk mendapatkan pertimbangan dan keputusan Majlis Mesyuarat Kerajaan Negeri mengenai permohonan untuk "
                + tujuanursan + " Lot " + noLot + " seluas " + luas + " " + koduom + " di " + bpm + " Daerah " + daerah + " untuk tujuan "
                + ktanah + " " + (sbb) + " .";
        ...
        String ursan1 = permohonan.getKodUrusan().getNama();
        


        perihalpermohonan = " Pentadbir Tanah Melaka Tengah telah menerima satu permohonan daripada " + pihakname + " pada " + mtarikmasuk + " untuk "
                + ursan1 + " bagi permohonan bernombor "+permohonan.getPermohonanSebelum().getIdPermohonan()+" di " + hklokasi + ", " + " seluas " + luas + " " + koduom + " di mukim/kawasan " + bpm + ", "
        ...
        perihaltanah = " Tanah ini ialah tanah " + kodmilik + " dan terletak di " + hklokasi + " lebih kurang " + jarak + " " + ujarak
                + " dari " + jarakd + " dan keadaan tanah adalah rata, kering dan " + dan;
        ...
        perihalpemohon_s = "Jika syarikat: Pemohon adalah syarikat " + pihaknama + " yang didaftarkan di Malaysia pada " + tarikhLahir 
                + " ,nombor pendaftarannya ialah " + nopengalan + " Senerai Ahli Lembaga Pengarah adalah seperti berikut; " + '\n' + '\n';
        ...
        perihalpemohon1 = " Pemohon tinggal di " + hklokasi + " semenjak " + tahun + " tahun yang lalu. Pemohon adalah anak tempatan di Kawasan tersebut. ";
...
//            tajuksbb = hakmilikPermohonan.getKodKegunaanTanah().getNama();
        ...
        tajuk = " PERMOHONAN DARIPADA  " + pihakName.toUpperCase() + " UNTUK " + ursan.toUpperCase() + " LOT " + noLot.toUpperCase() + " SELUAS " + luas + " " + koduom1.toUpperCase() + " DI "
                + bpm.toUpperCase() + " DAERAH " + daerah.toUpperCase() + " UNTUK TUJUAN " + tajukktanah.toUpperCase() + " " + tajuksbb.toUpperCase() + ".";
        String pnopng = " ";
        ...
        if ((hakmilikPermohonan != null) && (hakmilikPermohonan.getLuasTerlibat() != null)) {
           ...
           String ursan2 = permohonan.getKodUrusan().getNama();
        ...
        pentabirtanah2 = " Pentadbir Tanah Daerah " + cawangan + " dengan ini memperakukan supaya permohonan daripada " + pihakName
                + " No. KP: " + pnopng + " untuk " + ursan2 + " di Lot " + hpnolot + " , " + " seluas " + luasterlibat + " " + koduom2 + " di Mukim/Kawasan "
                + bpm + " , " + " Daerah " + cawangan + " seperti ditunjuk dengan garis sempadan berwarna merah dalam pelan berkembar, "
                + " di bawah Seksyen 42(1)a Kanun Tanah Negara dan didaftar atas nama pemohon";
        ...
        ulasanyb = " Pentadbir Tanah Melaka Tengah telah meminta ulasan Y.B ADUN Kawasan " + lokasiagency + " melalui surat bilangan PTMT: A4/ " + noruj
        ...
        if (permohonankertas != null) {
            ...
            senaraiLaporanKandunganRujukLuar = pelupusanService.findByIdMohonRujukLuar(permohonan.getPermohonanSebelum().getIdPermohonan());
            ...
            senaraiLaporanKandunganUtil = new Vector();
            senaraiPermohonanRujLuar = pelupusanService.senaraiPermohonanRujLuarByIdPermohonan(permohonan.getPermohonanSebelum().getIdPermohonan());
            ...
            if (!senaraiPermohonanRujLuar.isEmpty()) {
                for (int i = 0; i < senaraiPermohonanRujLuar.size(); i++) {
                    PermohonanRujukanLuar rujLuar = new PermohonanRujukanLuar();
                     rujLuar = senaraiPermohonanRujLuar.get(i);
                    ...
                    if(rujLuar!=null){
                        if(rujLuar.getAgensi()!=null){
                           ...
                           //senaraiLaporanKandungan2.add(kand1);
                            senaraiLaporanKandunganUtil.add(pelUtil);
                            logger.info("KATEGORI AGENSI -"+rujLuar.getAgensi().getKategoriAgensi().getKod());
                            }
                        }
                    }
...
//                    }
            ...
            permohonankertas.setTajuk("Rayuan Premium MMKN");
...
//        rehydrate();
 ...
 return new ForwardResolution("/WEB-INF/jsp/pelupusan/rayuan/draf_mmkn_rayuan_mlk.jsp").addParameter("tab", "true");
    }
