 ...
 * @author afham
 */
@UrlBinding("/pelupusan/kertas_pindaanPTDV2")
public class KertasRencanaPindaanPTDV2ActionBean extends AbleActionBean {
    ...
    private String kandunganKeputusan ;
...
//    private List<PermohonanKertasKandungan> senaraiKandunganTajuk;  //Bil - 0
    ...
    private List<PermohonanKertasKandungan> senaraiKandunganHuraianPPtd; // Bil - 2
    private List<PermohonanKertasKandungan> senaraiKandunganSyorPPtd; // Bil - 3
    private List<PermohonanKertasKandungan> senaraiKandunganKeputusan; // Bil - 4
    private List<PermohonanKertasKandungan> senaraiKandunganLatarBelakang; // Bil - 5
    ...
    private static final Logger LOG = Logger.getLogger(KertasRencanaPindaanPTDV2ActionBean.class);
    ...
    public Resolution editOnlyKertasMMKPT() {
        ...
        disKertasMMKController = disKertasMMKController.editKertasMMKPTPindaan();
        httpSession.setAttribute("disKertasMMKController", disKertasMMKController);
        return new JSP(DisPermohonanPage.getKPTD_PD_MAIN_PAGE()).addParameter("tab", "true");
    }
    ...
    public void setObjectPermohonanKertas(Permohonan permohonan, String kodDok) {
        ...
        permohonanKertas.setTajuk("Draf Rencana PTD (Pindaan)");
    ...
    public void setObjectKertasKandunganKeputusan(String kand, PermohonanKertas permohonanKertas) {
        Pengguna pengguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        cawangan = new KodCawangan();
        cawangan = (KodCawangan) disLaporanTanahService.getPlpservice().findDAOByPK(pengguna.getKodCawangan(), pengguna.getKodCawangan().getKod());
        PermohonanKertasKandungan pkk = new PermohonanKertasKandungan();
        ...
        pkk.setKandungan(kand);
        disLaporanTanahService.getPelupusanService().simpanPermohonanKertasKandungan(pkk);
        LOG.info("Saving Default Object Kertas Kandungan Keputusan");
    }
     ...
     public String setDefaultKandunganTajukKertas(Permohonan p, String caw, HakmilikPermohonan hp, Pemohon pmhn, String kodNegeri) {
        ...
        BigDecimal luasDipinda = new BigDecimal(0);
        String unitLuas = new String();
        String lot = new String();
        String bpm = new String();
        String kodKatTanah = new String();
        String kodGunaTanah = new String() ;
        ...
        if (hp.getHakmilik() != null) {
            ...
            kodKatTanah = hp.getHakmilik().getKategoriTanah() != null ? hp.getHakmilik().getKategoriTanah().getNama() : null ;
            kodGunaTanah = hp.getHakmilik().getKegunaanTanah() != null ? hp.getHakmilik().getKegunaanTanah().getNama() : null ;
            lokasi = hp.getHakmilik().getLokasi() != null ? hp.getHakmilik().getLokasi() : null ;
        } else {
            luasTerlibat = hp.getLuasDiluluskan() != null ? hp.getLuasDiluluskan() : new BigDecimal(0);
            luasDipinda = hp.getLuasPelanB1() != null ? hp.getLuasPelanB1() : new BigDecimal(0);
            ...
            kodKatTanah = hp.getKategoriTanahBaru() != null ? hp.getKategoriTanahBaru().getNama() : null ;
            kodGunaTanah = hp.getKodKegunaanTanah() != null ? hp.getKodKegunaanTanah().getNama() : null ;
            lokasi = hp.getLokasi() != null ? hp.getLokasi() : null ;
        }
        ...
        {
            kandunganTajuk = "PERMOHONAN UNTUK MEMINDA KELUASAN DARIPADA ";
        }
        ...
        switch (typeNum) {
            case 12: //Urusan PBMT
                ...
                if (luasTerlibat != null && unitLuas != null) {
                    ...
                    kandunganTajuk += " KEPADA ";
                }

                if (luasDipinda != null && unitLuas != null) {
                    kandunganTajuk += luasDipinda;
                    kandunganTajuk += " ";
                    kandunganTajuk += unitLuas.toUpperCase();
                }
                kandunganTajuk += " DI BAWAH SEKSYEN 83(3) KANUN TANAH NEGARA ";
                ...
                if (kodKatTanah != null && kodGunaTanah != null) {
                    kandunganTajuk += " UNTUK ";
                    kandunganTajuk += kodKatTanah.toUpperCase() ;
                    kandunganTajuk += " (" ;
                    kandunganTajuk += kodGunaTanah.toUpperCase() ;
                    kandunganTajuk += ")." ;
                }
    ...
    public String setDefaultKandunganTujuanKertas(Permohonan p, String caw, HakmilikPermohonan hp, Pemohon pmhn, String kodNegeri) {
        ...
        String daerah = p.getCawangan() != null ? p.getCawangan().getDaerah().getNama() : null;
        String tujuan = p.getSebab() != null ? p.getSebab() : null;
        kandunganTujuan = "Tujuan kertas ini adalah untuk mendapatkan pertimbangan Pentadbir Tanah ";
        kandunganTujuan += daerah;
        kandunganTujuan += " untuk meminda keluasan tanah daripada ";
        ...
        switch (typeNum) {
            case 12: //Urusan PBMT
                if (luasTerlibat != null && unitLuas != null) {
                    ...
                    kandunganTujuan += " kepada ";
                }
                
                 if (luasDipinda != null && unitLuas != null) {
                    kandunganTujuan += luasDipinda;
                    kandunganTujuan += " ";
                    kandunganTujuan += unitLuas.toUpperCase();
                }
                ...
                kandunganTujuan += " di bawah Seksyen 83(3) Kanun Tanah Negara ";
    ...
    public String setDefaultKandunganKeputusan(Permohonan p, String caw, HakmilikPermohonan hp, Pemohon pmhn, String kodNegeri) {
        Pengguna pengguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        String kandunganKeputusan = new String();
        String daerah = p.getCawangan() != null ? p.getCawangan().getDaerah().getNama() : null;
        kandunganKeputusan = "Dibentangkan untuk pertimbangan dan kelulusan ";
        if(p.getCawangan() != null && p.getCawangan().getKod().equals("08")){
            kandunganKeputusan += "Timbalan Pentadbir Tanah " ;
        }else {
            kandunganKeputusan += "Pentadbir Tanah " ;
        }
        kandunganKeputusan += daerah;
        kandunganKeputusan += " mengikut Perwakilan Kuasa sebagaimana disiarkan Warta Kerajaan Negeri Sembilan No. 314 (Tambahan No.1) bertarikh 17 Ogos 2006.";
        return kandunganKeputusan;
    }
...
//                senaraiHakmilikPermohonan = disLaporanTanahService.getPlpservice().getHakmilikPermohonanListByCatatanNIdMohon(new String(), idPermohonan);
            ...
            if (StringUtils.isNotBlank(kodDok)) {
                ...
                if (permohonanKertas != null) {
                    ...
                    senaraiKandunganHuraianPPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 2);
                    senaraiKandunganSyorPPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 3);
                    senaraiKandunganKeputusan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 4);
                    senaraiKandunganLatarBelakang = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 5);
                } else {
                    if (hakmilikPermohonan != null) {
                        ...
                        kandunganKeputusan = setDefaultKandunganKeputusan(permohonan, permohonan.getCawangan().getDaerah().getKod(), hakmilikPermohonan, permohonan.getSenaraiPemohon().get(0), kodNegeri);
                    } else {
                        //Not Implemented Yet
                    }
                    ...
                    if (permohonanKertas != null) {
                        ...
                        setObjectKertasKandunganKeputusan(kandunganKeputusan, permohonanKertas);
             ...
             * Syarat Tambahan 
             */
            listPermohonanTuntutanKos = new ArrayList<PermohonanTuntutanKos>();
            List<PermohonanTuntutanKos> listMohonTT = new ArrayList<PermohonanTuntutanKos>() ;
            listMohonTT = permohonan.getSenaraiTuntutanKos() ;
            List<PermohonanTuntutanBayar> listMohonTB = new ArrayList<PermohonanTuntutanBayar>();
            ...
            if (listMohonTT.size() > 0) {
                ...
                for (PermohonanTuntutanKos ptk : listMohonTT) {
                    ...
                    ptb = disLaporanTanahService.getPelupusanService().findMohonTuntutanBayarByIdTuntutKos(ptk.getIdKos());
                    if(ptb != null){
                        listMohonTB.add(ptb);
                    }else{
                        listPermohonanTuntutanKos.add(ptk);
...
//        permohonanKertas = new PermohonanKertas();
        ...
        int typeNum = type.equals("kTajuk") ? 0
                ...
                : type.equals("kHuraianPPtd") ? 2
                : type.equals("kSyorPPtd") ? 3
                : type.equals("kKeputusan") ? 4
                : type.equals("tBorang") ? 7
                : type.equals("main") ? 5
                : type.equals("kLatarBelakang") ? 6
                : 11;
        ...
        switch (typeNum) {
            case 0:
                ...
                forwardJSP = DisPermohonanPage.getKPTD_PD_TAJUK();
                break;
            case 1:
                senaraiKandunganTujuan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 1);
                forwardJSP = DisPermohonanPage.getKPTD_PD_TUJUAN();
                break;
            case 2:
                senaraiKandunganHuraianPPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 2);
                forwardJSP = DisPermohonanPage.getKPTD_PD_HURAIAN_PPTD();
                break;
            case 3:
                senaraiKandunganSyorPPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 3);
                forwardJSP = DisPermohonanPage.getKPTD_PD_SYOR_PPTD();
                break;
            case 4:
                senaraiKandunganKeputusan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 4);
                forwardJSP = DisPermohonanPage.getKPTD_PD_KEPUTUSAN();
                break;
            case 5:
                rehydrate();
                disKertasMMKController = (DisKertasMMKController) getContext().getRequest().getSession().getAttribute("disKertasMMKController");
                forwardJSP = DisPermohonanPage.getKPTD_PD_MAIN_PAGE();

                break;
            case 6:
                senaraiKandunganLatarBelakang = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 5);
                forwardJSP = DisPermohonanPage.getKPTD_PD_LATAR_BELAKANG();
                break;    
            case 7:
                listPermohonanTuntutanKos = new ArrayList<PermohonanTuntutanKos>();
            List<PermohonanTuntutanKos> listMohonTT = new ArrayList<PermohonanTuntutanKos>() ;
            ...
            if (!listMohonTT.isEmpty()) {
                ...
                forwardJSP = DisPermohonanPage.getKPTD_SYRT_TMBHN();
                break;     
        }
        return forwardJSP;
    }
...
//        LOG.info("CHECKING:..... index :" + index + " kand :" + kand);
        ...
        switch (index) {
            ...
            case 2:
                forwardJSP = DisPermohonanPage.getKPTD_PD_HURAIAN_PPTD();
                updateKandungan(kand, "kHuraianPPtd", permohonanKertas, 2);
                break;
            case 3:
                forwardJSP = DisPermohonanPage.getKPTD_PD_SYOR_PPTD();
                updateKandungan(kand, "kSyorPPtd", permohonanKertas, 3);
                break;
            case 4:
                forwardJSP = DisPermohonanPage.getKPTD_PD_KEPUTUSAN();
                updateKandungan(kand, "kKeputusan", permohonanKertas, 4);
                updateMohonFasa();
                break;
            case 5:
                forwardJSP = DisPermohonanPage.getKPTD_PD_LATAR_BELAKANG();
                updateKandungan(kand, "kLatarBelakang", permohonanKertas, 5);
                break;    
            default:
                break;
        }
...
//                        mohonTuntutKosCagarJln.setKuantiti(kuponQty);
    ...
    public Resolution tambahRow() {
        ...
        switch (index) {
            ...
            case 2:
                ...
                disLaporanTanahService.getPelupusanService().simpanPermohonanKertasKandungan(permohonanKertasKandungan);
                rehydrate();
                forwardJSP = refreshData("kHuraianPPtd");
                break;
            case 3:
                cawangan = new KodCawangan();
                cawangan = disLaporanTanahService.getKodCawanganDAO().findById(pengguna.getKodCawangan().getKod());
                ...
                disLaporanTanahService.getPelupusanService().simpanPermohonanKertasKandungan(permohonanKertasKandungan);
                rehydrate();
                forwardJSP = refreshData("kSyorPPtd");
                break;
    ...
    public Resolution showFormPopUp() {
        ...
        return new JSP(DisPermohonanPage.getKPTD_SYRT_TMBHN_ADD()).addParameter("popup", "true");
    }
    ...
    public Resolution showFormKemaskiniNilai() {
        ...
        return new JSP(DisPermohonanPage.getKPTD_SYRT_TMBHN_EDIT()).addParameter("popup", "true");
    }
    ...
    public Resolution kemaskiniAmaun() {
        ...
        rehydrate();
        return new JSP(DisPermohonanPage.getKPTD_SYRT_TMBHN()).addParameter("popup", "true");
    }
    ...
    public List<PermohonanKertasKandungan> getSenaraiKandunganHuraianPPtd() {
        return senaraiKandunganHuraianPPtd;
    }

    public void setSenaraiKandunganHuraianPPtd(List<PermohonanKertasKandungan> senaraiKandunganHuraianPPtd) {
        this.senaraiKandunganHuraianPPtd = senaraiKandunganHuraianPPtd;
    }

    public List<PermohonanKertasKandungan> getSenaraiKandunganSyorPPtd() {
        return senaraiKandunganSyorPPtd;
    }

    public void setSenaraiKandunganSyorPPtd(List<PermohonanKertasKandungan> senaraiKandunganSyorPPtd) {
        this.senaraiKandunganSyorPPtd = senaraiKandunganSyorPPtd;
    }
    ...
    public String getKandunganKeputusan() {
        return kandunganKeputusan;
    }

    public void setKandunganKeputusan(String kandunganKeputusan) {
        this.kandunganKeputusan = kandunganKeputusan;
    }
