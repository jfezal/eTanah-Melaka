...
@UrlBinding("/daftar/pembetulan/PihakBerkepentingan")
public class PihakBerkepentinganActionBean extends AbleActionBean {
    ...
    private List<PermohonanAtasPihakBerkepentingan> senaraiPhk;
...
// alamat surat menyurat
    ...
    public String getSyarikatTubuh() {
        return syarikatTubuh;
    }

    public void setSyarikatTubuh(String syarikatTubuh) {
    ...
    public List<PermohonanAtasPihakBerkepentingan> getSenaraiPhk() {
        return senaraiPhk;
    }

    public void setSenaraiPhk(List<PermohonanAtasPihakBerkepentingan> senaraiPhk) {
        this.senaraiPhk = senaraiPhk;
    }
    ...
    public Resolution showForm() {
        ...
        return new JSP("daftar/pembetulan/betulPihakBerkepentingan.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        hwList = new ArrayList<HakmilikWaris>();
        ...
        if (p != null) {
            ...
            for (PermohonanAtasPihakBerkepentingan MohonAtasPihak : senaraiMAP) {
                ...
                if (MohonAtasPihak.getJenisTugasan().equals("KEMASKINI")) {
                ...
                } else if (MohonAtasPihak.getJenisTugasan().equals("KEMASKINIWARIS")) {
                    Long idHP = MohonAtasPihak.getPihakBerkepentingan().getIdHakmilikPihakBerkepentingan();
                    List<HakmilikWaris> senaraihpw = pService.findHakmilikWaris(String.valueOf(idHP));
                    hwList.addAll(senaraihpw);
                }
            }
    ...
    public Resolution simpanPemohonPihak() {
        ...
        return new RedirectResolution(PihakBerkepentinganActionBean.class, "showForm").addParameter("error", error).addParameter("message", msg);
    }
...
//            HakmilikPihakBerkepentingan hpk = pService.findByIdHp(idHakmilikPihakBerkepentingan);
            PermohonanAtasPihakBerkepentingan ppihak = pService.findByAtasPihakByIdPemohon(idPemohon, p.getIdPermohonan());
            LOG.info("idPemohon1 = " + pmhn1.getPermohonan().getIdPermohonan());
            LOG.info("idPemohon2 = " + p.getIdPermohonan());
            LOG.info("idPemohon3 = " + idPemohon);
            LOG.info("ppihak = " + ppihak);
            if (ppihak == null) {
                PermohonanAtasPihakBerkepentingan pe = new PermohonanAtasPihakBerkepentingan();
                ia.setDimasukOleh(pguna);
                ia.setTarikhMasuk(new java.util.Date());
...
//                        PermohonanAtasPihakBerkepentingan pp = pService.findByAtasPihak(idPemohon, p.getIdPermohonan());
                    PermohonanAtasPihakBerkepentingan pp = permohonanAtasPihakBerkepentinganDAO.findById(pe.getIdAtasPihak());
                    ia.setDiKemaskiniOleh(pguna);
                    ia.setTarikhKemaskini(new java.util.Date());
...
//                error = "Pihak Berkepentingan ini telah diPohon";
    ...
    public Resolution caripihak2() {
        ...
        rehydrate();
        return new JSP("daftar/pembetulan/edit_PihakBerkepentingan_lama.jsp").addParameter("popup", "true");
    }

    public Resolution cariWaris() {

        String[] param = getContext().getRequest().getParameterValues("idHakmilikPihakBerkepentingan");
        PermohonanAtasPihakBerkepentingan mohonAtasP = new PermohonanAtasPihakBerkepentingan();
        pguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);


        for (String idHakmilikPihakBerkepentingan : param) {
            HakmilikPihakBerkepentingan hp = hakmilikPihakBerkepentinganDAO.findById(Long.parseLong(idHakmilikPihakBerkepentingan));
            ...
            if (map == null) {
                mohonAtasP.setHakmilik(hp.getHakmilik());
                mohonAtasP.setPermohonan(p);
                mohonAtasP.setPihakBerkepentingan(hp);
                mohonAtasP.setInfoAudit(ia);
                mohonAtasP.setJenisTugasan("KEMASKINIWARIS");
                if (hp.getPerserahan() != null) {
                    mohonAtasP.setCatatan(hp.getPerserahan().getIdPerserahan());
                }
//                permohonanAtasPihakBerkepentinganDAO.save(mohonAtasP);
                pService.simpanMohonAtasPihak(mohonAtasP);
            }
        }
            ...
            for (PermohonanPihakKemaskini pbMap : phkList) {
                if (pbMap != null) {
                    ...
                    if (pbMap.getNamaMedan().equals("syarikatTubuh")) {
                        syarikatTubuh = pbMap.getNilaiBaru();
                    }
...
//        }
    ...
    public Resolution editWaris() {
        ...
        waris = pService.findWarisBetulByIDwaris(idWaris);
//        warisbetul = pService.findWarisBetulByID(idWaris);



        if (waris != null) {
            List<PermohonanPihakKemaskini> mpkkList = permohonanPihakKemaskiniService.findKemaskiniWarisByIdHPW(p.getIdPermohonan(), String.valueOf(waris.getPemegangAmanah().getIdHakmilikPihakBerkepentingan()), String.valueOf(waris.getIdWaris()));

            for (PermohonanPihakKemaskini mpkk : mpkkList) {
                if (mpkk.getNamaMedan().equals("nama")) {
                    nama = mpkk.getNilaiBaru();
                }
                if (mpkk.getNamaMedan().equals("jenisPengenalan")) {
                    jenisPengenalan = mpkk.getNilaiBaru();
                }
                if (mpkk.getNamaMedan().equals("noPengenalan")) {
                    noPengenalan = mpkk.getNilaiBaru();
                }
                if (mpkk.getNamaMedan().equals("negeri")) {
                    negeri = mpkk.getNilaiBaru();
                }
                if (mpkk.getNamaMedan().equals("pembilang")) {
                    pembilang = mpkk.getNilaiBaru();
                }
                if (mpkk.getNamaMedan().equals("penyebut")) {
                    penyebut = mpkk.getNilaiBaru();
                }
                if (mpkk.getNamaMedan().equals("warganegara")) {
                    warganegara = mpkk.getNilaiBaru();
                }
            }
        }
    ...
    public Resolution deletePihak() {
        ...
        if (idAtasPihak != null) {
            ...
            if (phk == null) {
                senaraiPhk = pService.findByAtasPihakByIdPemohonList(idAtasPihak, idMhn);
//                phk = pService.findByAtasPihakByIdPemohon(idAtasPihak, idMhn);
            }

            List<PermohonanPihakKemaskini> mpkk = pService.findListbyIdMohonIdPemohon(p.getIdPermohonan(), Long.parseLong(idAtasPihak));
            if (mpkk.size() <= 0) {
                mpkk = pService.findAtasIdHpOnly(p.getIdPermohonan(), idAtasPihak);
            }
            if (mpkk.size() <= 0) {
                mpkk = pService.findAtasIdHpMohonPihak(p.getIdPermohonan(), idAtasPihak);
            }



            if (senaraiPhk != null) {
                if (senaraiPhk.size() > 0) {
                    for (PermohonanAtasPihakBerkepentingan phk1 : senaraiPhk) {
                        phk = phk1;
            ...
            for (PermohonanPihakKemaskini pk : mpkk) {
                if (pk != null) {
                    pService.delete(pk);
                }
            }
...
//            }
        ...
        return new RedirectResolution(PihakBerkepentinganActionBean.class, "showForm");
    }
...
//                    PermohonanAtasPerserahan mohonAtsUrusan = permohonanAtasPihakBerkepentinganDAO.findById(map.getIdAtasPihak());
                    ...
                    if (StringUtils.isNotBlank(nama)) {
                        ...
                        if (hpBerkepentingan != null) {
                            msg = saveAndUpdateMedan("nama", nama, (StringUtils.isBlank(hpBerkepentingan.getNama()) ? "" : hpBerkepentingan.getNama()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
                    }
                    
                    if (StringUtils.isNotBlank(syarikatTubuh)) {
                        LOG.info("syarikat Tubuh::" + syarikatTubuh);
                        if (syarikatTubuh.equalsIgnoreCase("-")) {
                            syarikatTubuh = "";
                        }
                        
                        if (hpBerkepentingan.getPenubuhanSyarikat() != null) {
                            msg = saveAndUpdateMedan("syarikatTubuh", syarikatTubuh, (StringUtils.isBlank(hpBerkepentingan.getPenubuhanSyarikat().getKod()) ? "" : hpBerkepentingan.getPenubuhanSyarikat().getKod()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        } else {
                            msg = saveAndUpdateMedan("syarikatTubuh", syarikatTubuh, "null", String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
                    ...
                    if (StringUtils.isNotBlank(jenisPengenalan)) {
                        ...
                        if (hpBerkepentingan.getJenisPengenalan() != null) {
                            msg = saveAndUpdateMedan("jenisPengenalan", jenisPengenalan, (StringUtils.isBlank(hpBerkepentingan.getJenisPengenalan().getKod()) ? "" : hpBerkepentingan.getJenisPengenalan().getKod()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        } else {
                            msg = saveAndUpdateMedan("jenisPengenalan", jenisPengenalan, "null", String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
                    ...
                    if (StringUtils.isNotBlank(bangsa)) {
                        ...
                        if (lama != null) {
                            msg = saveAndUpdateMedan("bangsa", bangsa, (StringUtils.isBlank(hpBerkepentingan.getNama()) ? "" : hpBerkepentingan.getNama()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        } else {
                    ...
                    if (StringUtils.isNotBlank(warganegara)) {
                        ...
                        msg = saveAndUpdateMedan("warganegara", warganegara, ((hpBerkepentingan.getWargaNegara() == null) ? "" : hpBerkepentingan.getWargaNegara().getKod()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        LOG.info("MSG = " + msg);
                    }
...
// alamat daftar
                    ...
                    if (StringUtils.isNotBlank(alamat1)) {
                        ...
                        if (hpBerkepentingan != null) {
                            msg = saveAndUpdateMedan("alamat1", alamat1, (StringUtils.isBlank(hpBerkepentingan.getAlamat1()) ? "" : hpBerkepentingan.getAlamat1()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
                    ...
                    if (StringUtils.isNotBlank(alamat2)) {
                        ...
                        if (hpBerkepentingan != null) {
                            msg = saveAndUpdateMedan("alamat2", alamat2, (StringUtils.isBlank(hpBerkepentingan.getAlamat2()) ? "" : hpBerkepentingan.getAlamat2()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
                    ...
                    if (StringUtils.isNotBlank(alamat3)) {
                        ...
                        if (hpBerkepentingan != null) {
                            msg = saveAndUpdateMedan("alamat3", alamat3, (StringUtils.isBlank(hpBerkepentingan.getAlamat3()) ? "" : hpBerkepentingan.getAlamat3()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
                    }
                    ...
                    if (StringUtils.isNotBlank(alamat4)) {
                        ...
                        if (hpBerkepentingan != null) {
                            msg = saveAndUpdateMedan("alamat4", alamat4, (StringUtils.isBlank(hpBerkepentingan.getAlamat4()) ? "" : hpBerkepentingan.getAlamat4()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
                    }
                    if (StringUtils.isNotBlank(poskod)) {
                        ...
                        if (hpBerkepentingan != null) {
                            msg = saveAndUpdateMedan("poskod", poskod, (StringUtils.isBlank(hpBerkepentingan.getPoskod()) ? "" : hpBerkepentingan.getPoskod()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
                    }
                    ...
                    if (StringUtils.isNotBlank(negeri)) {
                        ...
                        if (hpBerkepentingan != null) {
                            msg = saveAndUpdateMedan("negeri", negeri, (hpBerkepentingan.getNegeri() == null ? "" : hpBerkepentingan.getNegeri().getKod()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()));
                        }
            ...
            if (map.getPemohon() != null) {
                ...
                if (mhn.getKodUrusan().equals("BETPB")) {
                    ...
                    if (StringUtils.isNotBlank(nama)) {
                        ...
                        if (pemhn != null) {
                            msg = saveAndUpdateMedan("nama", nama, (StringUtils.isBlank(pemhn.getNama()) ? "" : pemhn.getNama()), String.valueOf(pemhn.getIdPemohon()), String.valueOf(map.getIdAtasPihak()));
                        }
                    }

                    if (StringUtils.isNotBlank(jenisPengenalan)) {
                        LOG.info("Jenis Pengenalan::" + jenisPengenalan);
                        LOG.info("Jenis Pengenalan Lama ::" + pemhn.getPihak().getJenisPengenalan().getKod());
                        if (jenisPengenalan.equalsIgnoreCase("-")) {
                            jenisPengenalan = "";
                        }
                        if (jenisPengenalan != null) {
                            msg = saveAndUpdateMedan("jenisPengenalan", jenisPengenalan, pemhn.getPihak().getJenisPengenalan().getKod(), String.valueOf(pemhn.getIdPemohon()), String.valueOf(map.getIdAtasPihak()));
                        } else {
                            msg = saveAndUpdateMedan("jenisPengenalan", jenisPengenalan, "null", String.valueOf(pemhn.getIdPemohon()), String.valueOf(map.getIdAtasPihak()));
                        }
...
// alamat surat menyurat
                    ...
                    if (jenisPengenalan != null) {
                        ...
                        msg = saveAndUpdateMedan("jenisPengenalan", jenisPengenalan,pemhn.getJenisPengenalan().getKod(), String.valueOf(pemhn.getIdPemohon()), String.valueOf(map.getIdAtasPihak()));
                    }
                    ...
                    if (StringUtils.isNotBlank(noPengenalan)) {
                        ...
                        msg = saveAndUpdateMedan("noPengenalan", noPengenalan, (StringUtils.isBlank(pemhn.getNoPengenalan()) ? "" : pemhn.getNoPengenalan()), String.valueOf(pemhn.getIdPemohon()), String.valueOf(map.getIdAtasPihak()));
                    }
//                    if (StringUtils.isNotBlank(noPengenalanLama)) {
//                        LOG.info("No Pengenalan Lama::" + noPengenalanLama);
//                        if (noPengenalanLama.equalsIgnoreCase("-")) {
    ...
    public Resolution saveBetulMohonPihak() {
        ...
        if (idHakmilikPihakBerkepentingan != null) {
            ...
            if (map.getPermohonanPihak() != null) {
                ...
                LOG.info("yus :" + mhn.getKodUrusan().getKod());
...
//                    PermohonanAtasPerserahan mohonAtsUrusan = pService.findMohonAtsUrusanbyIdMhn(p.getIdPermohonan());
                    ...
                    if (StringUtils.isNotBlank(nama)) {
                        ...
                        if (mohonPihak2 != null) {
                            msg = saveAndUpdateMedan("nama", nama, (StringUtils.isBlank(mohonPihak2.getNama()) ? "" : mohonPihak2.getNama()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                        }
                    }
                    ...
                    if (StringUtils.isNotBlank(jenisPengenalan)) {
                        ...
                        msg = saveAndUpdateMedan("jenisPengenalan", jenisPengenalan, (StringUtils.isBlank(mohonPihak2.getNama()) ? "" : mohonPihak2.getNama()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                        LOG.info("MSG = " + msg);
                    }
                    if (StringUtils.isNotBlank(noPengenalan)) {
                        LOG.info("No Pengenalan::" + noPengenalan);
                        ...
                        msg = saveAndUpdateMedan("noPengenalan", noPengenalan, (StringUtils.isBlank(mohonPihak2.getNama()) ? "" : mohonPihak2.getNama()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                        LOG.info("MSG = " + msg);
                    }
                    if (StringUtils.isNotBlank(noPengenalanLama)) {
                        LOG.info("No Pengenalan Lama::" + noPengenalanLama);
                        ...
                        msg = saveAndUpdateMedan("noPengenalanLama", noPengenalanLama, (StringUtils.isBlank(mohonPihak2.getNama()) ? "" : mohonPihak2.getNama()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                        LOG.info("MSG = " + msg);
                    }
                    if (StringUtils.isNotBlank(bangsa)) {
                        LOG.info("Bangsa::" + bangsa);
                    ...
                    if (StringUtils.isNotBlank(syarikatTubuh)) {
                        LOG.info("Nama::" + syarikatTubuh);
                        if (syarikatTubuh.equalsIgnoreCase("-")) {
                            syarikatTubuh = "";
                        }

                        if (mohonPihak2.getPenubuhanSyarikat() != null) {
                            msg = saveAndUpdateMedan("syarikatTubuh", syarikatTubuh, (StringUtils.isBlank(mohonPihak2.getPenubuhanSyarikat().getKod()) ? "" : mohonPihak2.getPenubuhanSyarikat().getKod()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                        } else {
                            msg = saveAndUpdateMedan("syarikatTubuh", syarikatTubuh, "null", String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                        }
...
// alamat daftar
                    ...
                    if (StringUtils.isNotBlank(alamat1)) {
                        ...
                        if (mohonPihak2.getAlamat() != null) {                            
                            if (mohonPihak2.getAlamat().getAlamat1() != null) {
                                ...
                                msg = saveAndUpdateMedan("alamat1", alamat1, (StringUtils.isBlank(mohonPihak2.getPihak().getAlamat1()) ? "" : ""), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            }
                        }
...
// alamat surat menyurat
                    ...
                    if (StringUtils.isNotBlank(jenisPengenalan)) {
                        ...
                        msg = saveAndUpdateMedan("jenisPengenalan", jenisPengenalan, (StringUtils.isBlank(mohonPihak2.getJenisPengenalan().getKod()) ? "" : mohonPihak2.getJenisPengenalan().getKod()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                    }
                    if (StringUtils.isNotBlank(noPengenalan)) {
                        LOG.info("No Pengenalan::" + noPengenalan);
                        if (noPengenalan.equalsIgnoreCase("-")) {
                        ...
                        msg = saveAndUpdateMedan("noPengenalan", noPengenalan, (StringUtils.isBlank(mohonPihak2.getNoPengenalan()) ? "" : mohonPihak2.getNoPengenalan()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                    }
...
// alamat daftar
                    LOG.info("::Alamat Berdaftar2::");
//                    if (StringUtils.isNotBlank(alamat1)) {
//                        LOG.info(alamat1);
//                        if (alamat1.equalsIgnoreCase("-")) {
//                            alamat1 = "";
//                        }
//                        msg = saveAndUpdateMedan("alamat1", alamat1, (StringUtils.isBlank(mohonPihak2.getAlamatSurat().getAlamatSurat1()) ? "" : mohonPihak2.getAlamatSurat().getAlamatSurat1()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
//                    }
                    if (StringUtils.isNotBlank(alamat1)) {
                        LOG.info("data alamat1:" + alamat1);
                        if (alamat1.equalsIgnoreCase("-")) {
                            alamat1 = "";
                        }
                        //LOG.info("yus2 :" + mohonPihak2.getAlamat().getAlamat1());
                        if (mohonPihak2.getAlamat() != null) {
                            if (mohonPihak2.getAlamat().getAlamat1() != null) {
                                msg = saveAndUpdateMedan("alamat1", alamat1, (StringUtils.isBlank(mohonPihak2.getAlamat().getAlamat1()) ? "" : mohonPihak2.getAlamat().getAlamat1()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            } else {
                                msg = saveAndUpdateMedan("alamat1", alamat1, "", String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            }
                    ...
                    if (StringUtils.isNotBlank(alamat2)) {
                        ...
                        if (mohonPihak2.getAlamat() != null) {
                            if (mohonPihak2.getAlamat().getAlamat2() != null) {
                                msg = saveAndUpdateMedan("alamat2", alamat2, (StringUtils.isBlank(mohonPihak2.getPihak().getAlamat2()) ? "" : mohonPihak2.getPihak().getAlamat2()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            } else {
                                msg = saveAndUpdateMedan("alamat2", alamat2, (StringUtils.isBlank(mohonPihak2.getPihak().getAlamat2()) ? "" : ""), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            }
                    ...
                    if (StringUtils.isNotBlank(alamat3)) {
                        ...
                        if (mohonPihak2.getAlamat() != null) {
                            if (mohonPihak2.getAlamat().getAlamat3() != null) {
                                msg = saveAndUpdateMedan("alamat3", alamat3, (StringUtils.isBlank(mohonPihak2.getPihak().getAlamat3()) ? "" : mohonPihak2.getPihak().getAlamat3()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            } else {
                                msg = saveAndUpdateMedan("alamat3", alamat3, (StringUtils.isBlank(mohonPihak2.getPihak().getAlamat3()) ? "" : ""), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            }
                    ...
                    if (StringUtils.isNotBlank(alamat4)) {
                        ...
                        if (mohonPihak2.getAlamat() != null) {
                            if (mohonPihak2.getAlamat().getAlamat4() != null) {
                                msg = saveAndUpdateMedan("alamat4", alamat4, (StringUtils.isBlank(mohonPihak2.getPihak().getAlamat4()) ? "" : mohonPihak2.getPihak().getAlamat4()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            } else {
                                msg = saveAndUpdateMedan("alamat4", alamat4, (StringUtils.isBlank(mohonPihak2.getPihak().getAlamat4()) ? "" : ""), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            }
                    ...
                    if (StringUtils.isNotBlank(poskod)) {
                        ...
                        if (mohonPihak2.getAlamat() != null) {
                            if (mohonPihak2.getAlamat().getPoskod() != null) {
                                msg = saveAndUpdateMedan("poskod", poskod, (StringUtils.isBlank(mohonPihak2.getPihak().getPoskod()) ? "" : mohonPihak2.getPihak().getPoskod()), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            } else {
                                msg = saveAndUpdateMedan("poskod", poskod, (StringUtils.isBlank(mohonPihak2.getPihak().getPoskod()) ? "" : ""), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                            }
...
//                        LOG.info("Test 1 :" + mohonPihak2.getAlamatSurat());
//                        LOG.info("Test 2 :" + mohonPihak2.getAlamatSurat().getNegeriSurat());  
//                        LOG.info("Test 3 :" + mohonPihak2.getIdPermohonanPihak());
                        if(mohonPihak2.getAlamatSurat() != null){
                            msg = saveAndUpdateMedan("negeri", negeri, (mohonPihak2.getAlamatSurat().getNegeriSurat() == null ? "" : ""), String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                        }else {
                            msg = saveAndUpdateMedan("negeri", negeri, "", String.valueOf(mohonPihak2.getIdPermohonanPihak()), String.valueOf(map.getIdAtasPihak()));
                        }
...
//                    pemohonService.saveOrUpdateMultiple(pmh);
    ...
    public String saveAndUpdateMedanPihakWaris(String namaMedan, String valueMedan, String nilaiLama, String idHakmilikPihakBerkepentingan, String idAtasPihak, HakmilikWaris waris) {
        String error = "";
        String msg = "";
        pguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        ...
        } else if (idAtasPihak != null) {
            permohonanPihakKemaskini = pService.findByidMohonNamaMedanidAtasPihak(idPermohonan, namaMedan, idAtasPihak);
        }
...
//                    permohonanPihakKemaskini.setPihak(idPihak);
                    ...
                    if (mohonAtasPerserahan != null) {
                        if (hpMAP != null) {
                            permohonanPihakKemaskini.setJenis(hpMAP.getJenis());
                            permohonanPihakKemaskini.setPihak(hpMAP.getPihak());
                            permohonanPihakKemaskini.setPihakTerlibat(hpMAP);
                        }
                        if (mpMap != null) {
                            ...
                            permohonanPihakKemaskini.setIdMohonPihak(String.valueOf(mpMap.getIdPermohonanPihak()));
                        }
                        if (pemohonMap != null) {
                            permohonanPihakKemaskini.setJenis(pemohonMap.getJenis());
                            permohonanPihakKemaskini.setIdPermohonanLama(pemohonMap.getPermohonan().getIdPermohonan());
                            permohonanPihakKemaskini.setPihak(pemohonMap.getPihak());
                            permohonanPihakKemaskini.setPemohon(pemohon);
                        }
                    }
                    permohonanPihakKemaskiniService.save(permohonanPihakKemaskini);
...
//                permohonanPihakKemaskini.setPihak(idPihak);
            ...
            if (hpMAP != null) {
                ...
                permohonanPihakKemaskini.setPihak(hpMAP.getPihak());
                permohonanPihakKemaskini.setPihakTerlibat(hpMAP);
                permohonanPihakKemaskini.setWarisTerlibat(waris);
            }
            if (mpMap != null) {
                permohonanPihakKemaskini.setJenis(mpMap.getJenis());
                permohonanPihakKemaskini.setIdPermohonanLama(mpMap.getPermohonan().getIdPermohonan());
        ...
        if (mohonAtasPerserahanList.size() > 0) {
            for (PermohonanAtasPerserahan mohonAtasPerserahan : mohonAtasPerserahanList) {
                if (permohonanPihakKemaskini == null) {
                    ...
                    permohonanPihakKemaskini.setNamaMedan(namaMedan);//not null
                    permohonanPihakKemaskini.setNilaiBaru(valueMedan);
                    if (nilaiLama.equals(null) || nilaiLama != "null") {
                        permohonanPihakKemaskini.setNilaiLama(nilaiLama);
                    } else {
                        permohonanPihakKemaskini.setNilaiLama("");
                    }
                    pService.saveKKini(permohonanPihakKemaskini);
                    if (mohonAtasPerserahan != null) {
...
//                permohonanPihakKemaskini.setPihak(idPihak);
    ...
    public Resolution saveBetulPihakWaris() {
        String idHakmilikPihakBerkepentingan = getContext().getRequest().getParameter("idHakmilikPihakBerkepentingan");
        String idMP = getContext().getRequest().getParameter("idPermohonanPihak");
        String idPemohon = getContext().getRequest().getParameter("idPemohon");
        Pengguna peng = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        ...
        PermohonanAtasPihakBerkepentingan mohonAtasPihak = pService.findByAtasPihak(idHakmilikPihakBerkepentingan, p.getIdPermohonan());
...
//                    PermohonanAtasPerserahan mohonAtsUrusan = permohonanAtasPihakBerkepentinganDAO.findById(map.getIdAtasPihak());
                    ...
                    if (StringUtils.isNotBlank(nama)) {
                        ...
                        if (warisbetul != null) {
                            msg = saveAndUpdateMedanPihakWaris("nama", nama, (StringUtils.isBlank(warisbetul.getNama()) ? "" : warisbetul.getNama()), String.valueOf(warisbetul.getPemegangAmanah().getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()), warisbetul);
                        }
                    }
                    ...
                    if (StringUtils.isNotBlank(jenisPengenalan)) {
                        ...
                        msg = saveAndUpdateMedanPihakWaris("jenisPengenalan", jenisPengenalan, (StringUtils.isBlank(warisbetul.getJenisPengenalan().getKod()) ? "" : warisbetul.getJenisPengenalan().getKod()), String.valueOf(warisbetul.getPemegangAmanah().getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()), warisbetul);
                        LOG.info("MSG = " + msg);
                    }
                    if (StringUtils.isNotBlank(noPengenalan)) {
                        LOG.info("No Pengenalan::" + noPengenalan);
                        ...
                        msg = saveAndUpdateMedanPihakWaris("noPengenalan", noPengenalan, (StringUtils.isBlank(warisbetul.getNoPengenalan()) ? "" : warisbetul.getNoPengenalan()), String.valueOf(warisbetul.getPemegangAmanah().getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()), warisbetul);
                        LOG.info("MSG = " + msg);
                    }
                    ...
                    if (StringUtils.isNotBlank(warganegara)) {
                        ...
                        msg = saveAndUpdateMedanPihakWaris("warganegara", warganegara, ((hpBerkepentingan.getPihak().getWargaNegara() == null) ? "" : hpBerkepentingan.getPihak().getWargaNegara().getKod()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()), warisbetul);
                        LOG.info("MSG = " + msg);
                    }
                    ...
                    if (StringUtils.isNotBlank(penyebut)) {
                        ...
                        msg = saveAndUpdateMedanPihakWaris("penyebut", penyebut, String.valueOf(hpBerkepentingan.getSyerPenyebut()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()), warisbetul);
                    }
                    if (StringUtils.isNotBlank(pembilang)) {
                        LOG.info("Pembilang::" + pembilang);
                        if (pembilang.equalsIgnoreCase("-")) {
                        ...
                        msg = saveAndUpdateMedanPihakWaris("pembilang", pembilang, String.valueOf(hpBerkepentingan.getSyerPembilang()), String.valueOf(hpBerkepentingan.getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()), warisbetul);
                    }
// alamat daftar
                    LOG.info("::Alamat Berdaftar::");
                    ...
                    if (StringUtils.isNotBlank(negeri)) {
                        ...
                        if (hpBerkepentingan != null) {
                            msg = saveAndUpdateMedanPihakWaris("negeri", negeri, (warisbetul.getNegeri() == null ? "" : warisbetul.getNegeri().getKod()), String.valueOf(warisbetul.getPemegangAmanah().getIdHakmilikPihakBerkepentingan()), String.valueOf(map.getIdAtasPihak()), warisbetul);
                        }
...
//        return new RedirectResolution(PihakBerkepentinganActionBean.class, "showForm").addParameter("error", error).addParameter("message", msg);
        return new RedirectResolution(PihakBerkepentinganActionBean.class, "showForm1").addParameter("error", error).addParameter("message", msg);
    ...
    public Resolution deleteWaris() {
        ...
        if (idWaris != null) {
            ...
            warisbetul = pService.findWarisBetulByIDwaris(idWaris);
            List<PermohonanAtasPihakBerkepentingan> mapList = pService.findByAtasPihakByIdPB(String.valueOf(warisbetul.getPemegangAmanah().getIdHakmilikPihakBerkepentingan()), p.getIdPermohonan());


            if (mapList.size() >= 0) {
                for (PermohonanAtasPihakBerkepentingan map : mapList) {
                    List<PermohonanPihakKemaskini> mpkkList = pService.findAtasIdHp(p.getIdPermohonan(), String.valueOf(map.getIdAtasPihak()));
                    permohonanPihakKemaskiniService.delete(mpkkList);
                    permohonanAtasPihakBerkepentinganDAO.delete(map);
                }
            }
        ...
        return new RedirectResolution(PihakBerkepentinganActionBean.class, "showForm1");
    }
