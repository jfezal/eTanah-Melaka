...
@UrlBinding("/strata/pecahPetak/penyatuanPetak")
public class PenyatuanPetakActionBean extends BasicTabActionBean{
    ...
    public Resolution showForm() {
        return new JSP("strata/pecahPetak/penyatuanPetak.jsp").addParameter("tab", "true");
    }
