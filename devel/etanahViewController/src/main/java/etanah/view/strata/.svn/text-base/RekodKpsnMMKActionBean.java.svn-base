 ...
 * @author zipzap
 */
@UrlBinding("/strata/rekodKpsnMMKActionBean")
...
//    private List<HakmilikPihakBerkepentingan> pihakKepentinganList;
    ...
    public Resolution showForm() {
        ...
        return new JSP("/strata/bngn_khas/kpsn_MMMKN.jsp").addParameter("tab", "true");
        // }
...
//        }
        return new JSP("/strata/bngn_khas/kpsn_MMMKNView.jsp").addParameter("tab", "true");
    }
        ...
        if (tugasanUtiliti != null) {
            ...
            if (infoMmkn != null) {
                ...
                if (kk != null) {
                            ...
                            fasaPermohonan.setTarikhKeputusan(sdf.parse(tarikhSah));
...
//            stageId = "rekod_kpsn_mmkn";
            if (permohonan.getKodUrusan().getKod().equals("PKBK")) {
                if (stageId.equals("keputusan")) {
                    kodPeringkat = kodPeringkatDAO.findById("MMKBK"); 
                }
...
//                        urusanDokumen = strataService.findUrusanDokbyKOD(kd.getKod(), permohonan.getKodUrusan().getKod());
                    ...
                    if (tugasanUtiliti != null) {
                        if (tugasanUtiliti.getKodPeringkat() != null) {
                            if (tugasanUtiliti.getKodPeringkat().getKod().equals("MMKBK")) {
    ...
    public Resolution hantar() throws IOException {
        ...
        if (mohon.getKodUrusan().getKod().equals("PKBK")) {
            ...
            pkbkIntegrationFlowService.completeTask(ref.SEDIA_TERIMA_KPSN_MMK, mohon, pengguna);
        } 
...
//        }
        ...
        if (infoMmkn != null) {
            if (infoMmkn.getKodPeringkat().getKod().equals("JKKPT")) {
                senaraiKodMMK = listUtil.getSenaraiKodDokumenJKKPT();
            } else if (infoMmkn.getKodPeringkat().getKod().equals("MMKBC") || infoMmkn.getKodPeringkat().getKod().equals("RKMK") 
                    || infoMmkn.getKodPeringkat().getKod().equals("RKMMK") || infoMmkn.getKodPeringkat().getKod().equals("RAMMK") 
                    || infoMmkn.getKodPeringkat().getKod().equals("ETHMK")|| infoMmkn.getKodPeringkat().getKod().equals("ET8MK") 
                    || infoMmkn.getKodPeringkat().getKod().equals("MMKBK")) {
                senaraiKodMMK = listUtil.getSenaraiKodDokumenMMKN();
            } else if (infoMmkn.getKodPeringkat().getKod().equals("JKKPT")) {
                senaraiKodMMK = listUtil.getSenaraiKodDokumenJKKPT();
            }
...
//                dokumenService.saveKandunganWithDokumen(kf);
    ...
    public PkbkIntegrationFlowService getPkbkIntegrationFlowService() {
        return pkbkIntegrationFlowService;
    }

    public void setPkbkIntegrationFlowService(PkbkIntegrationFlowService pkbkIntegrationFlowService) {
        this.pkbkIntegrationFlowService = pkbkIntegrationFlowService;
    }
