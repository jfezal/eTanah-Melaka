 ...
 */
@UrlBinding("/strata/ekstrakPHPC")
public class MaintainBangunanPHPCActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(MaintainBangunanPHPCActionBean.class);
    ...
    public Resolution selectedPitak() {
        ...
        return new JSP("strata/pbbm/jadualpetakPHPC.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution tambahBangunan() {
        ...
        return new RedirectResolution(MaintainBangunanPHPCActionBean.class, "showForm1").addParameter("error", error).addParameter("message", msg);
    ...
    public Resolution tambahPetak() {
        ...
        return new RedirectResolution(MaintainBangunanPHPCActionBean.class, "showForm1");
    }
...
//                BigDecimal jumlah_unit_syer;
                ...
                for (int i = 0; i < n1.getLength(); i++) {
                    ...
                    for (a = 0; a < n2.getLength(); a++) {
                        ...
                        bgn.setBilanganPetak(bilangan_petak);
    ...
    public Resolution extrakTgkt(NodeList n3, NodeList n4, NodeList n6, NodeList n7, long IdBangunan) {
        ...
        int tgkt2 = bgn.getBilanganPetak();

        LOG.info("-----------tgkt bngn-------------:" + tgkt2);

        for (int b = hv; b < tgkt2 + hv; b++) {
    ...
    public Resolution extrakPetak(NodeList n4, NodeList n6, NodeList n7, long idTingkat, long IdBangunan, int petakIndex, int petakAksIndex) {
        ...
        int c;
        ArrayList<BangunanPetak> listPetak = new ArrayList<BangunanPetak>();
        for (c = 0; c < bgn.getBilanganPetak(); c++) {
            ...
            if (bgn.getBilanganPetak() > petakIndex) {
    ...
    public Resolution HapusXml() {
        ...
        return new RedirectResolution(MaintainBangunanPHPCActionBean.class, "showForm4").addParameter("message", msg);
    }
