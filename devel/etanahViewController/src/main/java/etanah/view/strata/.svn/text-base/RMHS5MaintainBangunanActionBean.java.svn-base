 ...
 * @author Murali
 */
@UrlBinding("/strata/urusan_pbsReadonly")
public class RMHS5MaintainBangunanActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(RMHS5MaintainBangunanActionBean.class);
...
//        getContext().getRequest().setAttribute("ekstrak", Boolean.TRUE);
        return new JSP("strata/bngn_sementara/maklumat_jadualpetak_PBSReadonly.jsp").addParameter("tab", "true");
    }
...
//        getContext().getRequest().setAttribute("ekstrak", Boolean.TRUE);
    ...
    @DefaultHandler
    public Resolution readonlyPBS() throws ParserConfigurationException, SAXException, IOException {
...
//                        - Integer.parseInt(namaBngn2Pecahan);
        ...
        Permohonan permohonanRMHS5 = permohonanDAO.findById(idPermohonan);
        LOG.info("---permohonan--RMHS5----" + permohonanRMHS5.getIdPermohonan());
        LOG.info("---permohonan--PBS---" + permohonanRMHS5.getPermohonanSebelum().getIdPermohonan());
        pBangunanL = strService.findByIDPermohonan(permohonanRMHS5.getPermohonanSebelum().getIdPermohonan());
        LOG.info("---pBangunanL---" + pBangunanL);

        if (pBangunanL != null) {
            permohonan = permohonanDAO.findById(permohonanRMHS5.getPermohonanSebelum().getIdPermohonan());
...
//                            listPetakaksr = ptk1.getSenaraiPetakAksesori();
        ...
        Permohonan permohonanRMHS51 = permohonanDAO.findById(idPermohonan);
        LOG.info("---permohonan--RMHS5----" + permohonanRMHS51.getIdPermohonan());
        LOG.info("---permohonan--PBS----" + permohonanRMHS51.getPermohonanSebelum().getIdPermohonan());
        pBangunanLandParcel = strService.findByIDPermohonanByLandparcel(permohonanRMHS51.getPermohonanSebelum().getIdPermohonan());
        LOG.info("---pBangunanLandParcel---" + pBangunanLandParcel);


        if (pBangunanLandParcel != null) {
            permohonan = permohonanDAO.findById(permohonanRMHS51.getPermohonanSebelum().getIdPermohonan());
        ...
        Permohonan permohonanRMHS5p = permohonanDAO.findById(idPermohonan);
        LOG.info("---permohonan--RMHS5----" + permohonanRMHS5p.getIdPermohonan());
        LOG.info("---permohonan--PBS----" + permohonanRMHS5p.getPermohonanSebelum().getIdPermohonan());
        pBangunanProvisionalBlock = strService.findByIDPermohonanByProvisional(permohonanRMHS5p.getPermohonanSebelum().getIdPermohonan());
        LOG.info("---pBangunanProvisionalBlock---" + pBangunanProvisionalBlock);

        if (pBangunanProvisionalBlock != null) {
            permohonan = permohonanDAO.findById(permohonanRMHS5p.getPermohonanSebelum().getIdPermohonan());
        ...
        if (mc != null) {
            ...
            LOG.info("--Jumlah Unit Syor--" + mohonSkim.getJumlahUnitSyer());
        }
        if (mohonSkim != null) {
...
//                            Collections.sort(listPetakaksr, c3);
        ...
        getContext().getRequest().setAttribute("ekstrak", Boolean.FALSE);
        return new JSP("strata/bngn_sementara/maklumat_jadualpetak_PBS.jsp").addParameter("tab", "true");
    }
...
//        stageId = "g_semakkemasukan";
    ...
    public Resolution tambahBangunan() {
        ...
        return new RedirectResolution(RMHS5MaintainBangunanActionBean.class, "showForm1").addParameter("error", error).addParameter("message", msg);
    ...
    public Resolution tambahPetak() {
        ...
        return new RedirectResolution(RMHS5MaintainBangunanActionBean.class, "showForm1");
    }
...
//                    List<BangunanPetakAksesori> pk1 = p2.getSenaraiPetakAksesori();
        ...
        return new RedirectResolution(RMHS5MaintainBangunanActionBean.class, "showForm4").addParameter("message", msg);
    }
