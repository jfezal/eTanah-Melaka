 ...
 * @author Murali
 */
@UrlBinding("/strata/SemakKertasSiasatanFoliC")
public class SenaraiKertasSiasatanFoliCActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(SenaraiKertasSiasatanFoliCActionBean.class);
    ...
    private List<KodDokumen> KodDokumenRequiredFiloC = new ArrayList<KodDokumen>();
    private String cat;
    ...
    public Resolution showForm() {
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_siasataan_C.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution addDocForm() {
        ...
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_tambahan_doc_FC.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution simpanDokumenTambahan() {
        ...
        return new RedirectResolution(SenaraiKertasSiasatanFoliCActionBean.class, "showForm");
    }
    ...
    public Resolution muatNaikForm1() {
        ...
        return new JSP("strata/kuatkuasa/muat_naik_siasatan_C.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution processUpload() {
        ...
        if (fileToBeUpload != null) {
            try {
                ...
                Logger.getLogger(SenaraiKertasSiasatanFoliCActionBean.class).error(ex);
    ...
    public Resolution showRefresh() {
        LOG.info("------Refreshed----");
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_siasataan_C.jsp").addParameter("popup", "true");
    }
    
    public Resolution showCatatanEdit() {
        return new JSP("strata/kuatkuasa/CatatanEdit_C.jsp").addParameter("popup", "true");
    }
    ...
    public List<KodDokumen> getKodDokumenRequiredFiloC() {
        return strService.getKodDokumenRequiredFiloC(senaraiKodUrusan);
    }
