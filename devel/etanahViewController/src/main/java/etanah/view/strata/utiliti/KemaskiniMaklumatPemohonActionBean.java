...
@UrlBinding("/strata/kemaskini_maklumat_pemohon")
public class KemaskiniMaklumatPemohonActionBean extends AbleActionBean {
    ...
    private String syor;
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++
    private static final Logger LOG = Logger.getLogger(KemaskiniMaklumatPemohonActionBean.class);

    @DefaultHandler
    public Resolution showForm() {
        idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        LOG.debug("================== idPermohonanKemaskiniPemohon : " + idPermohonan);
        return new ForwardResolution("/WEB-INF/jsp/strata/utiliti/kemaskini_maklumat_pemohon.jsp");
    }

    public Resolution viewMaklumatPemohon() {
        ...
        return new JSP("strata/utiliti/kemaskini_maklumat_pemohon.jsp").addParameter("popup", "true");
    }
    ...
    public void rehydrate() {
        ...
        LOG.debug("================= Permohonan : " + idPermohonan);
    ...
    public Resolution resetForm() {
        ...
        return new RedirectResolution(KemaskiniMaklumatPemohonActionBean.class, "showForm");
    }
    
    public Resolution simpanPemohon(){
        LOG.debug("=============masukk simpanPemohon==============");
        idPermohonan = (String) getContext().getRequest().getParameter("idPermohonan");
