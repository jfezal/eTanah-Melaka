 ...
 * @author wan.fairul
 */
@UrlBinding("/strata/maklumatview_pemohon")
public class RTHSMaklumatViewPemohonActionBean extends BasicTabActionBean {
    ...
    public Resolution showForm() {
     ...
     Permohonan permohonanLama = permohonanBaru.getPermohonanSebelum();
        List<Pemohon> listPemohon;
        listPemohon = permohonanLama.getSenaraiPemohon();
        ...
        return new JSP("strata/Lanjutan_Tempo_Mohon/viewmaklumat_pemohon.jsp").addParameter("tab", "true");
    }
