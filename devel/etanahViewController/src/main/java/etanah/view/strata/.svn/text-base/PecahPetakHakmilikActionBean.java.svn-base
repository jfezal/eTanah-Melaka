...
@UrlBinding("/strata/pecahPetak/pecahPetakHakmilik")
public class PecahPetakHakmilikActionBean extends BasicTabActionBean{
    ...
    public Resolution showForm() {        
        return new JSP("strata/pecahPetak/pecahPetakHakmilik.jsp").addParameter("tab", "true");
    }
