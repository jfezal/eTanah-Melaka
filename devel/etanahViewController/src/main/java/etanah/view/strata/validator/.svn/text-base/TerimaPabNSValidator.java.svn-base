 ...
 * @author Murali
 */
public class TerimaPabNSValidator implements StageListener {
    ...
    private static final Logger LOG = Logger.getLogger(TerimaPabNSValidator.class);
        ...
        if (mohonHTB == null || mohonHT == null) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("PBBS")
                ...
                try {
                    ...
                    java.util.logging.Logger.getLogger(TerimaPabNSValidator.class.getName()).log(Level.SEVERE, null, ex);
                }
