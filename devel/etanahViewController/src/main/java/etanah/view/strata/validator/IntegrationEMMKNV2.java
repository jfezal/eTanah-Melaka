...
public class IntegrationEMMKNV2 implements StageListener {
    ...
    public int settingUrusan(String kodUrusan) {
        int numUrusan = kodUrusan.equals("PPRU") ? 1
                ...
                : kodUrusan.equals("831A") ? 25
                : kodUrusan.equals("PBA") ? 26
                : kodUrusan.equals("PKKR") ? 27
                : 0;
        return numUrusan;
    }
...
//                        senaraiLaporanKandunganpbtanah = disLaporanTanahService.getPelupusanService().findByIdbyBil(mohonKertas.getIdKertas(), 7); //FOR No 7 PERAKUAN PENTADBIR TANAH DAERAH
                    ...
                    case 26: //PBA
                        ...
                        break;
                    case 27: //PKKR
                        senaraiLaporanKandunganpbtanah = disLaporanTanahService.getPelupusanService().findByIdbyBil(mohonKertas.getIdKertas(), 2); //FOR No 7 PERAKUAN PENTADBIR TANAH DAERAH
                        senaraiLaporanKandunganptg1 = disLaporanTanahService.getPelupusanService().findByIdbyBil(mohonKertas.getIdKertas(), 4); //For No9 PERAKUAN PENTADBIR TANAH DAN GALIAN
                        break;
                }
...
//                            pemohon.getPekerjaan(), pendapatanPemohon, pihak.getTempatLahir(), umurPemohon);
                ...
                /**
                 * New service for sending file @Afham
                 */
                ...
                if (permohonan != null) {
                    ...
                    switch (numUrusan) {
                        ...
                        case 21: //PTNB   
                            ...
                            gen2 = "ACQRisalatMMKN_IZINLALU_MLK.rdf";
                            code2 = "8PAQ";
                            break;
                        case 22: //SEK4
                        ...
                        case 24: //PTSP
                            ...
                            break;
                        case 25: //831A
                            gen1 = "ACQKertasMMKNSEK431Abaru_MLK.rdf";
                            code1 = "MMKN";

                            gen2 = "ACQSUMMMKNbaru_MLK.rdf";
                            code2 = "8PAQ";
                            break;
                        case 26: //PBA
                            gen1 = "ACQKertasMMKNPB_MLK.rdf";
                            code1 = "MMKN";
...
//                            service.addRisalat(mohonKertas.getInfoAudit().getTarikhMasuk(), new java.util.Date(), service.createFile(reportMMKN, "Risalat MMKN"), service.createFile(reportRingkasanMMKN, "Ringkasan MMKN"));
                 ...
                 */
//        //Set kertas risalat
                service.createRisalat("", bpm, permohonan.getCawangan().getDaerah().getKod(), permohonan.getIdPermohonan(), permohonan.getIdPermohonan(), sks, mohonKertas.getTajuk());
