 ...
 * @author wan.fairul
 */
@UrlBinding("/strata/permohonanStrata_PHPP")
public class PermohonanStrataPHPPActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(PermohonanStrataPHPPActionBean.class);
    ...
    public Resolution showForm6() {
        ...
        if (list == null) {
            ...
            LOG.info(error);
            return new RedirectResolution(PermohonanStrataPHPPActionBean.class, "showForm").addParameter("error", error).addParameter("message", msg);
        } else {
            if (pemilik != null) {
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (idMh == null) {
                ...
                idMh1 = Long.parseLong(idMh);//getContext().getRequest().getParameter("idMh"));
            }
    ...
    public Resolution updateListKemudahan() {
        ...
        simpanListKemudahan();
        rehydrate();
        return new RedirectResolution(PermohonanStrataPHPPActionBean.class, "showForm2").addParameter("error", error).addParameter("message", msg);
    }
    ...
    public Resolution reload() {
        return new RedirectResolution(PermohonanStrataPHPPActionBean.class, "showForm2");
    }

    public Resolution reload2() {
        return new RedirectResolution(PermohonanStrataPHPPActionBean.class, "showForm3");
    }
    ...
    public Resolution simpanLaporanTanah() {
        ...
        //pemilik = strService.findID(idPermohonan);
        String same = "No";
        same = getContext().getRequest().getParameter("checkLaporan");
        LOG.info("--------------- USER Check :--------" + same);
        if (same != null) {
            LOG.info("--------------- USER klik check box :--------");
            senaraiHakmilikPermohonan = permohonan.getSenaraiHakmilik();
        ...
        msg = "Maklumat telah berjaya disimpan.";
        return new RedirectResolution(PermohonanStrataPHPPActionBean.class, "showForm2").addParameter("error", error).addParameter("message", msg).addParameter("idMh", idMh);
    }
    ...
    public Resolution resetForm() {
        ...
        return new RedirectResolution(PermohonanStrataPHPPActionBean.class, "showForm2").addParameter("idMh", idMh);
    }
    ...
    public Resolution simpanSempadan() {
        ...
        msg = "Maklumat telah berjaya disimpan.";
        return new RedirectResolution(PermohonanStrataPHPPActionBean.class, "showForm3").addParameter("error", error).addParameter("message", msg);
    ...
    public Resolution simpanBngn() throws ParseException {
        ...
        return new RedirectResolution(PermohonanStrataPHPPActionBean.class, "showForm6").addParameter("error", error).addParameter("message", msg);
    ...
    public Resolution processimejUpload() throws Exception {
        ...
        Logger.getLogger(PermohonanStrataPHPPActionBean.class).info(" PARAMETER: " + getContext().getRequest().getParameter("lokasi"));
        String error = "";
        String msg = "";
        Logger.getLogger(PermohonanStrataPHPPActionBean.class).info("simpanMuatNaik::start");
        Pengguna peng = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        InfoAudit ia = new InfoAudit();
        ia.setTarikhMasuk(new Date());
        ia.setDimasukOleh(pguna);
        String dokumenPath = conf.getProperty("document.path");
        permohonan = permohonanDAO.findById(idPermohonan);
        Logger.getLogger(PermohonanStrataPHPPActionBean.class).info("INI ADALAH FOLDER DOKUMEN" + permohonan.getFolderDokumen().getFolderId());
        dokumenPath = dokumenPath + (dokumenPath.endsWith(File.separator) ? "" : File.separator) + permohonan.getFolderDokumen().getFolderId();
        ...
        Logger.getLogger(PermohonanStrataPHPPActionBean.class).info("KOD CAWANGAN" + peng.getKodCawangan().getKod());
        ...
        Logger.getLogger(PermohonanStrataPHPPActionBean.class).info("LOKASI" + lokasi);
        char c = 0;
        if (StringUtils.isNotEmpty(lokasi)) {
            c = (lokasi).charAt(0);
        ...
        Logger.getLogger(PermohonanStrataPHPPActionBean.class).info("simpanMuatNaik::finish");
        addSimpleMessage("Muat naik fail berjaya.");
    ...
    /**
     * @param lainLainOnly the lainLainOnly to set
     */
