...
@UrlBinding("/utiliti/strata/utiliti_cetak_semula")
public class UtilitiCetakActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(UtilitiCetakActionBean.class);
    ...
    public Resolution view() {
        return new ForwardResolution("/WEB-INF/jsp/strata/utiliti/cetak_dokumen.jsp");
    }
        ...
        if (permohonan == null) {
            ...
            if (id != null && id.length() > 0) {
                ...
                if (id != null && id.length() > 0) {
                    ...
                    LOG.debug("======== folder Dokumen :" + folderDokumen);
                    LOG.debug("======== folderDokumen.tajuk :" + folderDokumen.getTajuk());
                    if (permohonan.getPermohonanSebelum() != null) {
                        LOG.debug("======== Permohonan Sebelum is NOT null");
                        folderDokumenSebelum = permohonan.getPermohonanSebelum().getFolderDokumen();
                        LOG.debug("======== folder Dokumen Sebelum: " + folderDokumenSebelum);
...
//        return new ForwardResolution("/WEB-INF/jsp/daftar/utiliti/tambah_dokumen_tertinggal.jsp");
        return new RedirectResolution(UtilitiCetakActionBean.class, "search").addParameter("permohonan.idPermohonan", permohonan.getIdPermohonan());
    }
...
//             return new JSP("dokumen/dokumen_tambahan.jsp");
        return new RedirectResolution(UtilitiCetakActionBean.class, "reload").addParameter("permohonan.idPermohonan", permohonan.getIdPermohonan());
    }
//Setter and Getter
