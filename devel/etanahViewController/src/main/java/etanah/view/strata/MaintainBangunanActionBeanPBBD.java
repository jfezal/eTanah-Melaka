 ...
 * @author wan.fairul
 */
@UrlBinding("/strata/urusan_pbbd")
public class MaintainBangunanActionBeanPBBD extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(MaintainBangunanActionBeanPBBD.class);
    ...
    private List<String> seqNum = new ArrayList<String>();
    ...
    private PermohonanBangunan bgn = new PermohonanBangunan();
    private BangunanTingkat bgnTgkt = new BangunanTingkat();
    private BangunanPetak bgnPetak = new BangunanPetak();
    private BangunanPetakAksesori bgnPetakAksr = new BangunanPetakAksesori();
...
//        stageId = "g_semakkemasukan";
    ...
    public Resolution tambahPetak() {
        ...
        return new RedirectResolution(MaintainBangunanActionBeanPBBD.class, "showForm1");
    }
...
//                    List<BangunanPetakAksesori> pk1 = p2.getSenaraiPetakAksesori();
        ...
        return new RedirectResolution(MaintainBangunanActionBeanPBBD.class, "showForm4").addParameter("message", msg);
    }
     ...
     */
    public void setSeqNum(List<String> seqNum) {
        this.seqNum = seqNum;
    }
     ...
     * @return the bgn
     */
    public PermohonanBangunan getBgn() {
        return bgn;
    }

    /**
     * @param bgn the bgn to set
     */
    public void setBgn(PermohonanBangunan bgn) {
        this.bgn = bgn;
    }
     ...
     * @return the bgnTgkt
     */
    public BangunanTingkat getBgnTgkt() {
        return bgnTgkt;
    }

    /**
     * @param bgnTgkt the bgnTgkt to set
     */
    public void setBgnTgkt(BangunanTingkat bgnTgkt) {
        this.bgnTgkt = bgnTgkt;
    }
    ...
    /**
     * @param bgnPetak the bgnPetak to set
     */
    ...
    /**
     * @return the bgnPetakAksr
     */
    public BangunanPetakAksesori getBgnPetakAksr() {
        return bgnPetakAksr;
    }

    /**
     * @param bgnPetakAksr the bgnPetakAksr to set
     */
    public void setBgnPetakAksr(BangunanPetakAksesori bgnPetakAksr) {
        this.bgnPetakAksr = bgnPetakAksr;
    }
    ...
    /**
     * @param bgnList the bgnList to set
     */
    ...
    /**
     * @param bgnTgktList the bgnTgktList to set
     */
    ...
    /**
     * @param bgnPetakList the bgnPetakList to set
     */
    ...
    /**
     * @param bgnPetakAksrList the bgnPetakAksrList to set
     */
