 ...
 * @author Murali
 */
@UrlBinding("/strata/SemakKertasSiasatanFoliD")
public class SenaraiKertasSiasatanFoliDActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(SenaraiKertasSiasatanFoliDActionBean.class);
    ...
    private List<KodDokumen> KodDokumenRequiredFiloD = new ArrayList<KodDokumen>();
    private String cat;
    ...
    public Resolution showForm() {
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_siasataan_D.jsp").addParameter("tab", "true");
    }
                ...
                if (folderDokumen != null) {
                    ...
                    if (folderDokumen.getSenaraiKandungan() != null) {
                        ...
                        for (KandunganFolder kf : kfd) {
                            ...
                            String[] koddoc = {"SLPPS", "SAD", "LTPS", "LRPS", "PC3", "CRH", "SDH", "CF", "PA", "MSSM" ,"LKRTP", "GTK", "MMO"};
    ...
    public Resolution addDocForm() {
        ...
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_tambahan_doc_FD.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution simpanDokumenTambahan() {
        ...
        return new RedirectResolution(SenaraiKertasSiasatanFoliDActionBean.class, "showForm");
    }
    ...
    public Resolution muatNaikForm1() {
        ...
        return new JSP("strata/kuatkuasa/muat_naik_siasatan_D.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution processUpload() {
        ...
        if (fileToBeUpload != null) {
            try {
                ...
                Logger.getLogger(SenaraiKertasSiasatanFoliDActionBean.class).error(ex);
    ...
    public Resolution showRefresh() {
        LOG.info("------Refreshed----");
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_siasataan_D.jsp").addParameter("popup", "true");
    }

    public Resolution showCatatanEdit() {
        return new JSP("strata/kuatkuasa/CatatanEdit_D.jsp").addParameter("popup", "true");
    }
    ...
    public List<KodDokumen> getKodDokumenRequiredFiloD() {
        return strService.getKodDokumenRequiredFiloD(senaraiKodUrusan);
    }
