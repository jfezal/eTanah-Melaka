 ...
 * @author wan.fairul
 */
@UrlBinding("/strata/urusan_pbbm")
public class MaintainBangunanActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(MaintainBangunanActionBean.class);
    ...
    public Resolution showForm1() throws ParserConfigurationException, SAXException, IOException {
        ...
        if (!mhnBngn.isEmpty()) {
            if (mhnBngn.get(0).getNamaLain() != null) {
                ...
                getContext().getRequest().setAttribute("manual", Boolean.FALSE);
            }
        }
