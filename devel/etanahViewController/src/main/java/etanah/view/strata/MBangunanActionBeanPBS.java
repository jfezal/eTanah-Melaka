 ...
 * @author Murali
 */
@UrlBinding("/strata/pbs")
public class MBangunanActionBeanPBS extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(MBangunanActionBeanPBS.class);
...
//        getContext().getRequest().setAttribute("ekstrak", Boolean.TRUE);
        return new JSP("strata/bngn_sementara/jadualpetak_PBS.jsp").addParameter("tab", "true");
    }
...
//        stageId = "g_semakkemasukan";
    ...
    public Resolution tambahBangunan() {
        ...
        return new RedirectResolution(MBangunanActionBeanPBS.class, "showForm1").addParameter("error", error).addParameter("message", msg);
    ...
    public Resolution tambahPetak() {
        ...
        return new RedirectResolution(MBangunanActionBeanPBS.class, "showForm1");
    }
...
//                    List<BangunanPetakAksesori> pk1 = p2.getSenaraiPetakAksesori();
        ...
        return new RedirectResolution(MBangunanActionBeanPBS.class, "showForm4").addParameter("message", msg);
    }
