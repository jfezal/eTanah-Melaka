 ...
 * @faidzal
 */
@UrlBinding("/strata/bangunanPKKR")
public class BangunanKosRendahActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(BangunanKosRendahActionBean.class);
    ...
    public Resolution resetForm() throws ParseException {
        ...
        if (mhnStrata != null) {
            ...
            if (mhnBangunan != null) {
                try {
                    ...
                    addSimpleMessage("Maklumat Bangunan Kos Rendah Berjaya Dikosongkan.");
                } catch (Exception e) {
                    LOG.error(e);
        ...
        rehydrate();
        return new RedirectResolution(BangunanKosRendahActionBean.class, "showForm");
    }

    public Resolution tambahBngnKosRendah() {
        ...
        return new JSP("strata/kos_rendah/tambah_bangunan_kosrendah.jsp").addParameter("popup", "true");
    }

    public Resolution simpanBngnKosRendah() throws ParseException {
        String error = null;
        String message = null;
        ...
        if (pb != null) {
            ...
            try {
                ...
                LOG.error(e);
                addSimpleError("Terdapat masalah semasa menambah Bangunan Kos Rendah. Ralat : " + e);
            }
        }
        rehydrate();
        return new JSP("strata/kos_rendah/maklumat_bangunan.jsp").addParameter("tab", "true").addParameter("error", error);
    }
    ...
    public Resolution popupKemaskiniBngn() {
        ...
        return new JSP("strata/kos_rendah/update_bangunan_kosrendah.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution simpanBngn() throws ParseException {
        ...
        try {
            ...
            addSimpleMessage("Maklumat Bangunan Kos Rendah Telah Disimpan");
        } catch (Exception e) {
            LOG.error(e);
