 ...
 */
@UrlBinding("/strata/CetakanSiFUS")
public class CetakanSiFUS extends AbleActionBean {

    private static final Logger LOG = Logger.getLogger(CetakanSiFUS.class);
    @Inject
    ...
    public Resolution showForm() {
        ...
        bdnUrus = null;
        return new ForwardResolution("/WEB-INF/jsp/strata/utiliti/cetakanSiFUS.jsp");
    }
