 ...
 * @author Murali
 */
@UrlBinding("/strata/urusan_pbs")
public class MaintainBangunanActionBeanPBS extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(MaintainBangunanActionBeanPBS.class);
...
//        stageId = "g_semakkemasukan";
    ...
    public Resolution tambahBangunan() {
        ...
        return new RedirectResolution(MaintainBangunanActionBeanPBS.class, "showForm1").addParameter("error", error).addParameter("message", msg);
    ...
    public Resolution tambahPetak() {
        ...
        return new RedirectResolution(MaintainBangunanActionBeanPBS.class, "showForm1");
    }
...
//            extrakPetak(n4, n6, n7, tgkt.getIdTingkat(), bgn.getIdBangunan());
    ...
    public Resolution extrakPetak(NodeList n4, NodeList n6, NodeList n7, long idTingkat, long IdBangunan, int petakIndex) {
        ...
        int c;
        ArrayList<BangunanPetak> listPetak = new ArrayList<BangunanPetak>();
        String Petakno = n4.item(0).getAttributes().getNamedItem("petakno").getNodeValue();
        String temp = Petakno.substring(3, Petakno.length());
        LOG.info("-----------petak Test-------------:" + temp);
        ...
        for (c = 0; c < bangunanTingkat.getBilanganPetak(); c++) {
            ...
            int noPetakTgkt = Integer.parseInt(temp)+c+sum4;
            LOG.info("-----------petak Test 2-------------:" + noPetakTgkt);
            //petak.setNama(String.valueOf(sum4 + c + 1));
            petak.setNama(String.valueOf(noPetakTgkt));
...
//                    List<BangunanPetakAksesori> pk1 = p2.getSenaraiPetakAksesori();
        ...
        return new RedirectResolution(MaintainBangunanActionBeanPBS.class, "showForm4").addParameter("message", msg);
    }
