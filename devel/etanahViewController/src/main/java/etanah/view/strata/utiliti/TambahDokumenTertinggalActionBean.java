...
@UrlBinding("/strata/utiliti/muatnaik")
public class TambahDokumenTertinggalActionBean extends AbleActionBean {
    ...
    @DefaultHandler
    public Resolution view() throws WorkflowException {
       ...
       // search();
        ...
        return new ForwardResolution("/WEB-INF/jsp/strata/utiliti/tambah_dokumen_tertinggal.jsp");
    }
    ...
    public Resolution search() throws WorkflowException {
        ...
        if (permohonan == null && idMohon == null) {
...
//             return new JSP("dokumen/dokumen_tambahan.jsp");
        return new RedirectResolution(TambahDokumenTertinggalActionBean.class, "reload").addParameter("permohonan.idPermohonan", permohonan.getIdPermohonan());
    }
//Setter and Getter
