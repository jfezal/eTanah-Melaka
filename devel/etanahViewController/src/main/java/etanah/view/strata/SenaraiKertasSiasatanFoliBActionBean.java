 ...
 * @author Murali
 */
@UrlBinding("/strata/SemakKertasSiasatanFoliB")
public class SenaraiKertasSiasatanFoliBActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(SenaraiKertasSiasatanFoliBActionBean.class);
    ...
    private List<KodDokumen> KodDokumenRequiredFiloB = new ArrayList<KodDokumen>();
    private String cat;
    ...
    public Resolution showForm() {
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_siasataan_B.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution addDocForm() {
        ...
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_tambahan_doc_FB.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution simpanDokumenTambahan() {
        ...
        return new RedirectResolution(SenaraiKertasSiasatanFoliBActionBean.class, "showForm");
    }
    ...
    public Resolution muatNaikForm1() {
        ...
        return new JSP("strata/kuatkuasa/muat_naik_siasatan_B.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution processUpload() {
        ...
        if (fileToBeUpload != null) {
            try {
                ...
                Logger.getLogger(SenaraiKertasSiasatanFoliBActionBean.class).error(ex);
    ...
    public Resolution showRefresh() {
        LOG.info("------Refreshed----");
        return new JSP("strata/kuatkuasa/senarai_semak_kertas_siasataan_B.jsp").addParameter("popup", "true");
    }
    
    public Resolution showCatatanEdit() {
        return new JSP("strata/kuatkuasa/CatatanEdit_B.jsp").addParameter("popup", "true");
    }
    ...
    public List<KodDokumen> getKodDokumenRequiredFiloB() {
        return strService.getKodDokumenRequiredFiloB(senaraiKodUrusan);
    }
