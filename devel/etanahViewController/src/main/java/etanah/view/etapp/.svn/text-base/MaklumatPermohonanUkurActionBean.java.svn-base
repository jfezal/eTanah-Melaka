 ...
 * @author mohd.faidzal
 */
@UrlBinding("/etapp/permohonan_ukur")
public class MaklumatPermohonanUkurActionBean extends BasicTabActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("etapp/permohonan_ukur.jsp").addParameter("tab", "true");
    }
