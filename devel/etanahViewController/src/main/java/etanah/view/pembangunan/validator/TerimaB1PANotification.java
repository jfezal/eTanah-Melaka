 ...
 * @author nursyazwani
 */
public class TerimaB1PANotification implements StageListener{
   @Inject
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        n.setTajuk("Makluman Terima Pelan B1 dan PA");
        n.setMesej("Terima Pelan B1 dan PA untuk id permohonan:" + context.getPermohonan().getIdPermohonan() + ".");
