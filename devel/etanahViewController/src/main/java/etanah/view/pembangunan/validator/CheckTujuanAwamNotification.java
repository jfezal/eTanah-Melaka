 ...
 * @author nursyazwani
 */
public class CheckTujuanAwamNotification implements StageListener {
    @Inject
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        if(context.getPermohonan().getCatatan()!=null){
            // permohonan.catatan - PSBT
            // 0 - tujuan awam
            // 1 - bukan tujuan awam
            if(context.getPermohonan().getCatatan().equalsIgnoreCase("1")){
                proposedOutcome = "CL";
            }
        }
