 ...
 */
public class RekodBidaanValidatorJLB implements StageListener {

    private static final Logger LOG = Logger.getLogger(RekodBidaanValidatorJLB.class);
    @Inject
...
//        }
        ...
        List<FasaPermohonan> fasaPermohonanList = lelongService.findFasaPermohonanRekodBidaanJLBlist(permohonan.getIdPermohonan());
...
//                FasaPermohonan fp = lelongService.findFasaPermohonanSemakPembida(permohonan.getIdPermohonan());
                List<FasaPermohonan> ListFp = lelongService.findListFasaPermohonanSemakPembida(permohonan.getIdPermohonan());
