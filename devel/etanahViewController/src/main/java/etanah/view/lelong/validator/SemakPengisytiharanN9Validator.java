 ...
 */
public class SemakPengisytiharanN9Validator implements StageListener {
    
    private static final Logger LOG = Logger.getLogger(SemakPengisytiharanN9Validator.class);
    @Inject
