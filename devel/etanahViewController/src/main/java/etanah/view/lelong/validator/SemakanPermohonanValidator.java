 ...
 */
public class SemakanPermohonanValidator implements StageListener {

    private static final Logger LOG = Logger.getLogger(SemakanPermohonanValidator.class);
    @Inject
...
//        }
        ...
        List<FasaPermohonan> senaraiFasa = lelongService.findFasaPermohonanSemakPermohonanList(idPermohonan);
        FasaPermohonan fasa = senaraiFasa.get(0);
//        if (senaraiFasa.size() > 0){
//            senaraiFasa.get(0);
//        }
        
//        FasaPermohonan fasa = lelongService.findFasaPermohonanSemakPermohonan(permohonan.getIdPermohonan());
