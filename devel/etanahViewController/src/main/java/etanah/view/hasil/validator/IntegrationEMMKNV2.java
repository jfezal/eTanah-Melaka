...
import etanah.view.pengambilan.validator.IntergrationMMKN;
...
public class IntegrationEMMKNV2 implements StageListener {
    ...
    private static final Logger LOGGER = Logger.getLogger(etanah.view.pengambilan.validator.IntegrationEMMKNV2.class);
    ...
    public int settingUrusan(String kodUrusan) {
        int numUrusan = kodUrusan.equals("PPDL") ? 1
                : kodUrusan.equals("RPPP") ? 2
                : kodUrusan.equals("RCTN") ? 3
                : kodUrusan.equals("PPPT") ? 4
                : kodUrusan.equals("PRCT") ? 5
                : kodUrusan.equals("REMRI") ? 6
//                : kodUrusan.equals("REMSB") ? 7
                : 0;
        return numUrusan;
    }
...
//                }
                ...
                if (permohonan.getKodUrusan().getKod().equalsIgnoreCase("PPDL")) {
                    drafType = "RIS";
                } else {
                    drafType = "RIS";
                }
...
//                mohonRujukLuarList = plpservice.getSenaraiRujLuarByIDPermohonanAgensi(permohonan.getIdPermohonan());
                ...
                for (HakmilikPermohonan hakmilikMohon : permohonan.getSenaraiHakmilik()) {
                    ...
                    switch (numUrusan) {
                        case 1: //PPDL
                            landApplicant[0] = hasilCfg.getProperty("mmknPPDL");
                            landApplicant[1] = kategoriTanah;
                            break;
                        case 2: //RPPP
                            landApplicant[0] = hasilCfg.getProperty("mmknRPPP");
                            landApplicant[1] = kategoriTanah;
                            break;
                        case 3: //RCTN
                            ...
                            break;
                        case 4: //PPPT                       
                            landApplicant[0] = hasilCfg.getProperty("mmknPPPT");
                            landApplicant[1] = kategoriTanah;
                            break;
                        case 5: //PRCT                        
                            landApplicant[0] = hasilCfg.getProperty("mmknPRCT");
                            landApplicant[1] = kategoriTanah;
                            break;
                        case 6: //REMRI                        
                            landApplicant[0] = hasilCfg.getProperty("mmknREMRI");
                            ;
                            landApplicant[1] = kategoriTanah;
                            break;
//                        case 7: //REMSB                        
//                            landApplicant[0] = hasilCfg.getProperty("mmknREMSB");
//                            ;
//                            landApplicant[1] = kategoriTanah;
//                            break;
                ...
                if (permohonan != null) {
                    ...
                    switch (numUrusan) {
                        ...
                        case 5: //PJLB                              
                            break;
                        case 6: 
                            gen1 = "HSLMMKN_MLK_REMRI.rdf";
                            code1 = "RIS";

                            gen2 = "HSLSUMMMKN_MLK.rdf";
                            code2 = "RMN";
