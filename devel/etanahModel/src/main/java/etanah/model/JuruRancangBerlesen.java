...
@Entity
@Table (name = "jr_blsn")
@SequenceGenerator(name = "seq_jr_blsn", sequenceName = "seq_jr_blsn")
public class JuruRancangBerlesen implements Serializable, Penyerah {
    
    @Id
        @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_jr_blsn")
        @Column (name = "ID_JR_BLSN")
	private long idJururancangBerlesen;
    ...
    public long getIdJururancangBerlesen() {
        return idJururancangBerlesen;
    }

    public void setIdJururancangBerlesen(long idJururancangBerlesen) {
        this.idJururancangBerlesen = idJururancangBerlesen;
    }
