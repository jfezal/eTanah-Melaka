...
@Entity
@Table (name = "peguam")
@SequenceGenerator(name = "seq_peguam", sequenceName = "seq_peguam")
public class Peguam implements Serializable, Penyerah {
	
	@Id
        @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_peguam")
	@Column (name = "id_peguam")
    ...
    public String getNoTelefon3() {
        return noTelefon3;
    }

    public void setNoTelefon3(String noTelefon3) {
        this.noTelefon3 = noTelefon3;
    }
}
