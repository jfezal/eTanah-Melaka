...
@Entity
@Table(name = "ETAPP_BORANGE")
@SequenceGenerator(name = "seq_ETAPP_BORANGE", sequenceName = "seq_ETAPP_BORANGE")
public class EtappBorangE implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_ETAPP_BORANGE")
    @Column(name = "ID_ET_BE")
    private Long idEtBe;
    @ManyToOne
    ...
    public Long getIdEtBe() {
        return idEtBe;
    }

    public void setIdEtBe(Long idEtBe) {
        this.idEtBe = idEtBe;
    }
