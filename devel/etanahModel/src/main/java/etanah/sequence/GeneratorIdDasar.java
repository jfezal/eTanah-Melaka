/**
 * Generator class to generate Id Dasar.
...
public class GeneratorIdDasar extends SequenceGenerator {

	@Override
	public String generate(String kodNegeri, KodCawangan caw, Object obj) {
		if (!(obj instanceof DasarTuntutanCukai)){
			throw new IllegalArgumentException("Parameter is not DasarTuntutanCukai class");
		}
		...
		String seqNo = df.format(getSerialNo("seq_dasar_cukai"));
		String padZero = "1";
		...
		if(IS_DEBUG) {
			LOG.debug("Generated Id Dasar: " + id);
		}
