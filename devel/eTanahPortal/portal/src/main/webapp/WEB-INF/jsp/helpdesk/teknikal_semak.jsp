...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function pulangsemulaKontraktorSemak() {

//                alert('d');
                var noteKontraktor = $('#noteKontraktor').val();
                if ((noteKontraktor == '')) {


                } else {
//                    alert(noteKontraktor);
                    var noteKontraktor = $('[name=noteKontraktor]').val();
                    var reportId = $('[name=reportId]').val();
//                    alert(reportId);
                    var url = "${pageContext.request.contextPath}/helpdesk/kontraktor?pulangSemulaKontraktorSemak&reportId=" + reportId + "&noteTeknikal=" + noteKontraktor;
                    $.post(url,
                            function (data) {
//                                alert('s');
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <display:table class="table table-hover table table-striped table-bordered" name="${actionBean.listOfDocument}" style="width:90;" requestURI="/saveDocuments" id="line">
                                                    ...
                                                    <display:column title="Nama Fail">
                                                        <a href="${line.urlDownload}" target="_blank"> ${line.fileName}</a>
                                                    </display:column>
