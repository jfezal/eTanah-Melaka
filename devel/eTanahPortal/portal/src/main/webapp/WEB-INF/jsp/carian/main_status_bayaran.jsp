    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cetak(pkid) {
                ...
                var url = '${pageContext.request.contextPath}/main?cetak&' + params;
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="col-sm-7 form-group">
                                                    <p class="form-control-static">[${actionBean.cmBayaran.byrSamJabatanPkid.kod}]&nbsp;${actionBean.cmBayaran.byrSamJabatanPkid.perihal}</p>
                                                </div>
                                                <label class="col-sm-3 control-label">PTJ Pembayar : </label>
                                                <div class="col-sm-7 form-group">
                                                    <p class="form-control-static">[${actionBean.cmBayaran.byrSamPtjPkid.kod}]&nbsp;${actionBean.cmBayaran.byrSamPtjPkid.perihal}</p>
                                                </div>
                                            </div>
                                            <div class="container">
                                                <label class="col-md-3 control-label" for="textinput">No Baucar Bayaran :</label>  
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/main?status_bayaran" class="btn btn-primary">Keluar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
