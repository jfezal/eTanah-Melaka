...
<html>
    <head>
        ...
        <title>.: eTanah : Tambah Maklumat Pengguna :.</title> 
        <script>
                                            ...
                                            <div class="form-horizontal">
                                                <div class="container">
                                                    ...
                                                    <div class="col-sm-6 form-group">
                                                        <s:text name="userTable.userName" id="emel" class="form-control"/>                                                     
                                                    </div>
                                                </div>
                                                <div class="container">
                                                    <label class="col-sm-2 control-label">Kata Laluan :</label>                                                                   
                                                    <div class="col-sm-6 form-group"> 
                                                        <s:password  class="form-control" name="userTable.password" data-minlength="6" id="inputPassword" placeholder="Kata Laluan" required="true" data-toggle="popover" title="Password Strength" data-content="Masukkan Kata Laluan..."/>
                                                    </div>
                                                </div>
                                                <div class="container">
                                        ...
                                        <div class="form-group">
                                            <div style="text-align: right">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <s:submit name="addUserProfile" value="Simpan" class="btn-primary" tabindex="1" id="addNew"/>&nbsp;                    
