                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <p class="form-control-static">${actionBean.userTable.userName}
                                                            <s:hidden name="userName" value="${actionBean.userTable.userName}" class="form-control"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <s:submit name="updatePasswdUser" value="Simpan" class="btn btn-primary" tabindex="1"/>&nbsp;  
                                                        <a href="${pageContext.request.contextPath}/helpdesk/admin/userProfile?resetPassword&userName=${actionBean.userTable.userName}" class="btn btn-primary">Isi Semula</a>&nbsp;
                                                        <a href="${pageContext.request.contextPath}/helpdesk/admin/userProfile?edit" class="btn btn-primary">Keluar</a>&nbsp;
