    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12">
                <s:messages/>
                <s:errors/>
                <s:form beanclass="com.theta.portal.stripes.dms.upload.MuatNaikActionBean" data-toggle="validator"> 
                            ...
                            <div id="collapse-3" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        <div class="container">
                                            <label class="col-sm-2 control-label">Id Permohonan :</label>
                                            <div class="col-sm-6 form-group">
                                                <p class="form-control-static">sss</p>
                                            </div>
                                        </div>
                                        <div class="container">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <div class="container">
                                            <label class="col-sm-2 control-label">Jenis Urusniaga :</label>
                                            <div class="col-sm-6 form-group">
                                                 <p class="form-control-static">sss</p>
                                            </div>
                                        </div>
