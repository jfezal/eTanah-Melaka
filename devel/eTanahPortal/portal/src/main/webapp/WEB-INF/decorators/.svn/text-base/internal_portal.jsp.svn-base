                ...
                <div class="col-sm-5 col-xs-12">
                    <div class="well">
                        ...
                        <div class="list-group">
                            ...
                            <a href="${pageContext.request.contextPath}/semakan_akaun" class="list-group-item"><img src="${pageContext.request.contextPath}/images/iconsPortal/SemakAkaunIcon.jpeg" width="10%"> Semakan Cukai</a>
