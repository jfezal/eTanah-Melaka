<%-- 
    Document   : maklumat_pbttidakberdaftar_popup
    Created on : 15-Dec-2011, 11:35:49
    Author     : nordiyana
--%>
...
<div class="subtitle">
    ...
    <s:form beanclass="etanah.view.stripes.pengambilan.maklumatpbttidakberdaftarActionBean" >
        <s:hidden name="typesender" value="phtbadd"/>
        <fieldset class="aras1">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><s:text name="pptb.nomborTelefon" id="noTelefon" size="40" maxlength="11"/><font color="red">*</font></td>
                ...
                <tr>
                    ...
                    <td><s:text name="pptb.nomborAkaun" id="noAkaun" size="50"/><font color="red">*</font></td>
                </tr>
            </table>
            <br/>
            <center>
