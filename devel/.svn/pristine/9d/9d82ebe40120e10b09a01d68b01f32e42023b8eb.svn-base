<%-- 
    Document   : terima_maklumat_notis2
    Created on : Jan 26, 2010, 11:20:44 AM
...
<H4>TERIMA DAN KEMASKINI MAKLUMAT NOTIS</H4>
<s:form action="">
    <div class="subtitle">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <legend>
                Sila Klik Pada Bil Untuk Kemaskini Maklumat Penerima Notis
            </legend>
            <div class="content"  align="center">
                <display:table class="tablecloth" name="" cellpadding="0" cellspacing="0" id="lineMP">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <table>
               <tr>
                    <td class="rowlabel1"> Arahan kepada :</td>
                    <td></td>
               </tr>
               <tr>
