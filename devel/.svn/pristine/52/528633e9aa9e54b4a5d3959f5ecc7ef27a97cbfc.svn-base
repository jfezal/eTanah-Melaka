 ...
 */
@UrlBinding("/pengambilan/mmk_ns_PB_new")
public class Mmk_ns_PB_newActionBean extends AbleActionBean {
    ...
    private static Logger logger = Logger.getLogger(Mmk_ns_PB_newActionBean.class);
...
//        getContext().getRequest().setAttribute("form1", Boolean.TRUE);
        return new JSP("pengambilan/negerisembilan/penarikanbalik/mmk_ns_PB_new.jsp").addParameter("tab", "true");
    }
...
//        hakmilikPermohonanList = hakmilikPermohonanDAO.findByEqualCriterias(tname, model, null);
        ...
        if (!hakmilikPermohonanList.isEmpty()) {
                    ...
                    if (permohonan != null) {
                        ...
                        if (permohonan.getPermohonanSebelum() != null) {
                            ...
                            if (permohonan.getPermohonanSebelum().getKodUrusan().getKod().equalsIgnoreCase("831B")) {
                                urusan = "3(1)(b)";
                                apt = " Di Bawah Seksyen 35(1) Akta Pengambilan Tanah 1960 Bagi Pengambilan Balik Mengikut Seksyen 3(1)(b) Akta Pengambilan Tanah 1960";
                            }
                            if (permohonan.getPermohonanSebelum().getKodUrusan().getKod().equalsIgnoreCase("831C")) {
                                urusan = "3(1)(c)";
                                apt = " Di Bawah Seksyen 35(1) Akta Pengambilan Tanah 1960 Bagi Pengambilan Balik Mengikut Seksyen 3(1)(c) Akta Pengambilan Tanah 1960";
                            }
            ...
            if (permohonan.getPermohonanSebelum().getKodUrusan().getKod().equalsIgnoreCase("831A")) {
                tujuan = "Kertas ini bertujuan untuk mendapat pertimbangan Yang Amat Berhormat Menteri Besar, Negeri Sembilan Darul Khusus mengenai permohonan penarikan balik dari pengambilan ke atas "
                        + lokasi + apt + " yang telah disiarkan melalui Warta Kerajaan Negeri Sembilan bil" + "____" + " bertarikh " + "__________";
            } else {
                tujuan = "Kertas ini bertujuan untuk mendapat pertimbangan Majlis Mesyuarat Kerajaan , Negeri Sembilan Darul Khusus mengenai permohonan penarikan balik dari pengambilan ke atas "
                        + lokasi + apt + " yang telah disiarkan melalui Warta Kerajaan Negeri Sembilan bil" + "____" + " bertarikh " + "__________";
            }
            String temp1 = "PERMOHONAN PENARIKAN BALIK PENGAMBILAN DI ATAS ";

            String temp2 = " TANAH " + lokasi + apt;
            heading1 = temp1;
...
//                 permohonanKertasKandungan7.setSubtajuk("7."+ i+"."+str[k-1]);
        ...
        getContext().getRequest().setAttribute("form1", Boolean.TRUE);
        return new RedirectResolution(Mmk_ns_PB_newActionBean.class, "locate");
    }
