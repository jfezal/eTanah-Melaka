 ...
 * @author Rajesh Reddy
 */
@UrlBinding("/pengambilan/RekodAmbilCek")
public class RekodAmbilCekActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(RekodAmbilCekActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/melaka/bantahanmahkamah/rekodAmbilCek.jsp").addParameter("tab", "true");
    }
...
//            permohonanPihakList = pengambilanService.getSenaraiPermohonPihakByIdHakmilik(idPermohonan, hakmilik.getIdHakmilik());
    ...
    public Resolution showAmbilPampasanList() {
        logger.info("::showAmbilPampasanList::");
        idPermohonan = (String) getContext().getRequest().getSession().getAttribute("idPermohonan");
        ...
        if (idPermohonan != null) {
            ...
            if (hakmilikPermohonan != null) {
               ...
               // logger.info("::pPihak::----" +pPihak.getIdPermohonanPihak());
                if (hakmilikPerbicaraan != null && pPihak != null) {
