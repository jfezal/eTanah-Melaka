...
<script type="text/javascript">
    ...
    function findNoKadPengenalan(idPenghantarNotis,index){
        if(idPenghantarNotis != ""){
            $.get('${pageContext.request.contextPath}/pembangunan/PhantarNotis5A?findNoPengenalan&idPenghantarNotis='+idPenghantarNotis+'&index='+index,
            function(data){
                $('#icLoad'+index).empty();
...
<s:form beanclass="etanah.view.stripes.pembangunan.PenghantaranNotis5AActionBean" id="folder_div">
