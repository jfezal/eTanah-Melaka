...
//            p(idHakmilik);
    ...
    <s:form beanclass="etanah.view.etapp.HantarBorangDActionBean">
...
Sila muat naik pada TAB Dokumen : Dokumen yang diperlukan ialah Sijil Carian Rasmi, Surat Iringan Endorsan Borang D
            <div align="center">
                 <fieldset class="aras1">
                    <br/> 
