...
/**
 * <p>Java class for DokumenInfo complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DokumenInfo">
 *   &lt;complexContent>
...
@XmlType(name = "DokumenInfo", namespace = "http://ws.dokumen.view.etanah", propOrder = {
    "bytes",
    "docType",
    "fileName"
})
public class DokumenInfo {

    @XmlElementRef(name = "bytes", namespace = "http://ws.dokumen.view.etanah", type = JAXBElement.class)
    protected JAXBElement<byte[]> bytes;
    @XmlElementRef(name = "docType", namespace = "http://ws.dokumen.view.etanah", type = JAXBElement.class)
    protected JAXBElement<String> docType;
    @XmlElementRef(name = "fileName", namespace = "http://ws.dokumen.view.etanah", type = JAXBElement.class)
    ...
    public void setBytes(JAXBElement<byte[]> value) {
        this.bytes = ((JAXBElement<byte[]> ) value);
    }
