...
@Entity
@Table(name = "mohon_pguna_tolak")
@SequenceGenerator(name = "seq_mohon_pguna_tolak", sequenceName = "seq_mohon_pguna_tolak")
public class PermohonanPenggunaDitolak implements Serializable {



	@Id
        @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_mohon_pguna_tolak")
	@Column (name = "id_mohon_pguna_tolak")
	private long idMohonPgunaTolak;
    ...
    public long getIdMohonPgunaTolak() {
        return idMohonPgunaTolak;
    }

    public void setIdMohonPgunaTolak(long idMohonPgunaTolak) {
        this.idMohonPgunaTolak = idMohonPgunaTolak;
    }
