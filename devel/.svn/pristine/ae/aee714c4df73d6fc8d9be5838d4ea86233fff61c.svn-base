 ...
 * @author wan.fairul
 */
@UrlBinding("/strata/RMHSUrusan_rmhs")
public class RMHSMaintainBangunanActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(RMHSMaintainBangunanActionBean.class);
...
//        getContext().getRequest().setAttribute("ekstrak", Boolean.TRUE);
        return new JSP("strata/pbbm/maklumat_jadualpetak_readonly.jsp").addParameter("tab", "true");
    }
