<%-- 
    Document   : kemaskini_saudara
    Created on : Jul 11, 2011, 12:27:21 PM
    Author     : afham
--%>
...
<div class="subtitle" id="caw">
    <s:form beanclass="etanah.view.stripes.pelupusan.MaklumatPemohon1ActionBean">
        ...
        <fieldset class="aras1">
            ...
            <legend>
               Kemasukan Maklumat Saudara Pemohon
            </legend>
            ...
            <p>
                ...
                <s:text name="pemohonHbgn.gaji" size="40" value="${actionBean.pemohonHbgn.gaji}" onkeyup="this.value=this.value.toUpperCase();"/>
            </p>
            <p>
            ...
            <p>
                <label>&nbsp;</label>
                <s:submit name="simpanEditSaudara" id="simpan" value="Simpan" class="btn" />
