    ...
    <s:form beanclass="etanah.view.stripes.pembangunan.utiliti.UtilitiLtActionBean" >        
        ...
        <fieldset class="aras1">
            ...
            <p>
                ...
                <s:text name="permohonanLaporanBangunan.namaPemunya" size="20" id="namaPemunya" class="normal_text"/>
            </p>
            <p>
                <label >Nama Penyewa :</label>
                <s:text name="permohonanLaporanBangunan.namaPenyewa" size="20" id="namaPenyewa" class="normal_text"/>
            </p>
            <p>
                <label>
            ...
            <p>
                ...
                <s:textarea name="permohonanLaporanBangunan.keteranganTahunBinaan" id="tahunDibina" cols="50" />
            </p>
            <p>
                <label>
                    <c:if test="${actionBean.TB eq 'T'}">Jenis Tanaman :</c:if> <c:if test="${actionBean.TB eq 'B'}">Kegunaan Bangunan :</c:if>
                </label>
                <s:textarea name="permohonanLaporanBangunan.namaKetua" cols="50" rows="2" id="namaKetua" class="normal_text"/>
            </p>
            <p>
