 ...
 * @author Admin
 */
@UrlBinding("/strata/depositMahkamahedit")
public class depositMahkamahStrataActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(depositMahkamahStrataActionBean.class);
    @Inject
