 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/mmkn31c")
public class MMKN831CActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(MMKN831CActionBean.class);
    @Inject
...
//    private String tajuk;
    ...
    private String tajuk = "KERTAS PERMOHONAN PENGAMBILAN TANAH 3(1)(c)";
...
//                        StringBuilder sb = new StringBuilder();
                    ...
                    tujuan = "Tujuan kertas ini ialah untuk mendapatkan pertimbangan Majlis Mesyuarat Kerajaan Negeri mengenai permohonan pengambilan tanah "
                            + "di bawah Seksyen 3(1)(c) Akta Pengambilan Tanah 1960, di atas sebahagian "+ noLotList + " seluas "
...
//        permohonanKertas.setTempatSidang(tempat);
        ...
        getContext().getRequest().setAttribute("form1", Boolean.TRUE);
        return new RedirectResolution(MMKN831CActionBean.class, "locate");
    }
