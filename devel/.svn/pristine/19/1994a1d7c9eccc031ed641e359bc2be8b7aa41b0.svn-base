 ...
 * @author afham
 */
@UrlBinding("/pelupusan/kertas_ringkas")
public class KertasRingkasActionBean extends AbleActionBean {
     @Inject
...
//    private List<PermohonanKertasKandungan> listKertasSyorPTD = new ArrayList<PermohonanKertasKandungan>();
    ...
    private static final Logger LOG = Logger.getLogger(KertasRingkasActionBean.class);
    ...
    public Resolution showForm() {
         getContext().getRequest().setAttribute("edit", Boolean.TRUE);
          if(permohonan.getKodUrusan().getKod().equals("RAYL") || permohonan.getKodUrusan().getKod().equals("RAYK")){
         ...
         return new JSP("pelupusan/rayuan/kertas_ringkas.jsp").addParameter("tab", "true");
     }
    ...
    public void rehydrate() {
     ...
     if(pemohon.getUmur() != null && pemohon.getTanggungan() != null)
      ...
      if(mohonKertas == null){
        ...
        tajuk = "RAYUAN UNTUK MELANJUTKAN TEMPOH BAYARAN PREMIUM DI ATAS KELULUSAN PEMBERIMILIKAN TANAH KERAJAAN " + luas.toUpperCase() + " DI " + lokasi.toUpperCase() 
         ...
         tajuk = "RAYUAN UNTUK MENGURANGKAN BAYARAN PREMIUM DI ATAS KELULUSAN PEMBERIMILIKAN TANAH KERAJAAN " + luas.toUpperCase() + " DI " + lokasi.toUpperCase() 
                + ", " + bpm.toUpperCase() + ", " + daerah.toUpperCase() + " UNTUK TUJUAN " + ktanah.toUpperCase() ;
        ...
        if(plk2Rayuan.isEmpty()){
            ...
            perihalRayuan = "Pentadbir Tanah" + daerahPTD + "telah menerima surat rayuan pemohon pada " + sdf.format(permohonan.getInfoAudit().getTarikhMasuk()) + " dengan alasan :" ;
