...
<script type="text/javascript">
    ...
    function openFrame(type){
        doBlockUI();
        window.open("${pageContext.request.contextPath}/pelupusan/kertas_MMKPPTR?openFrame&type="+type, "eTanah",
...
<s:form beanclass="etanah.view.stripes.pelupusan.KertasMMKPPTRActionBean">
    <s:errors/>
    <s:messages/>
    <div class="subtitle">
                    ...
                    <table class="tablecloth" align="center">
                        <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBPTG'}">
                            <tr>
                                <td>Keputusan :</td>
                                <td>
                                    <c:if test="${actionBean.fasaPermohonanptg.keputusan.kod eq 'SL'}">
                                        Syor Lulus
                                    </c:if>
                                    <c:if test="${actionBean.fasaPermohonanptg.keputusan.kod eq 'ST'}">
                                        Syor Tolak
                                    </c:if>
                                </td>
                            </tr>
