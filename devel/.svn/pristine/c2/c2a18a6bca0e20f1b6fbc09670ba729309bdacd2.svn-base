 ...
 * @author asri
 */
public class KeputusanPerintah implements StageListener {
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        fasaPermohonan = pengambilanService.findFasaPermohonan15SiasatanPerintah(permohonan.getIdPermohonan());
...
//        fasaPermohonanDAO.saveOrUpdate(fasaPermohonan);
        KodKeputusan kodKeputusan = pengambilanService.findByKodKeputusan("CL");
        KodKeputusan kodKeputusan2 = pengambilanService.findByKodKeputusan("CP");
        if (fasaPermohonan.getKeputusan().getKod().equals("A")) {
            permohonan1.setKeputusan(kodKeputusan);
        } else if (fasaPermohonan.getKeputusan().getKod().equals("XA")) {
            permohonan1.setKeputusan(kodKeputusan2);
        }
        permohonanDAO.saveOrUpdate(permohonan1);
