 ...
 */
@UrlBinding("/penguatkuasaan/ringkasan_kes")
public class RingkasanKesActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("/penguatkuasaan/ringkasan_kes.jsp").addParameter("tab", "true");
    }
