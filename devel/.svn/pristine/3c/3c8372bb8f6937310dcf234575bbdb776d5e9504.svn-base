...
<c:if test="${actionBean.urusan.kodUrusan eq 'PPTGM' || actionBean.urusan.kodUrusan eq 'PMKMM' || actionBean.urusan.kodUrusan eq 'PLPT'}">
  <span class=instr><font color="red">Jika Amaun Fi (RM) Tidak Tepat.Sila Kemaskini Syarat Nyata Untuk Hakmilik Terlibat. Terima Kasih</font></span><br/>  
        ...
        <display:table name="${actionBean.senaraiTransaksiPra}" id="row1" class="tablecloth" style="width:95%;" >
            ...
            <display:footer>
                <tr>
                    <td>${row1_rowNum + 1}</td>
                    <td></td><td></td>
                    <td align="left"><b>(-) Pelepasan / Pengecualian</b><br>
                        &nbsp;&nbsp;&nbsp;&nbsp;Nyatakan  : <br>
...
<!--                <tr>
                ...
                <tr>
                    <td>${row1_rowNum + 4}</td>
                    <td></td><td></td>
                    <td align="left"><b>(+) Lain-lain </b><br>
                        &nbsp;&nbsp;&nbsp;&nbsp;Nyatakan : <br>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:text name="urusan.sebabLain" size="50" id="sbb" onkeyup="this.value=this.value.toUpperCase();"/><br>
                        &nbsp;&nbsp;&nbsp;&nbsp;Pegawai Meluluskan : <br>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:text name="urusan.pegawaiLain" size="50" id="pegSbb" onkeyup="this.value=this.value.toUpperCase();"/></td>
                    <td></td>
                    <td><br><div align="right"><br><s:text name="urusan.cajLain" size="10"  style="text-align:right"
