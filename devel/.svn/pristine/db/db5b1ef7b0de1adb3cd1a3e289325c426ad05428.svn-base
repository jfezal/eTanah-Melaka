...
<div class="subtitle">
    ...
    <s:form beanclass="etanah.view.stripes.pengambilan.NotaSiasatanActionBean" >
        <fieldset class="aras1">
            <legend align="center">
                PBT Tidak Berdaftar - Maklumat Orang Hadir
            </legend>
            <div  align="center">
                <br>
                <br>
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td><b>:</b></td>
                        <td><s:text name="pbttidakpenting.nama" size="40"/></td>
                    </tr>
                    <tr>
                        <td width="30%"><b>No. Pengenalan</b></td>
                        <td><b>:</b></td>
                        <td><s:text name="pbttidakpenting.noPengenalan" id="kp" size="40"/>&nbsp;<em style="font-style:normal">(cth : 800620125177)</em></td>
                    </tr>
                    <tr>
                        <td ><b>Jawatan</b></td>
                        <td><b>:</b></td>
                        <td><s:text name="pbttidakpenting.jawatan" size="40" id="wakil"/></td>

                    </tr>
                    <tr>
                        <td ><b>Ulasan/Catatan</b></td>
                        <td><b>:</b></td>
                        <td><s:textarea name="pbttidakpenting.penilaiUlasan" rows="4" cols="35" id="ulasan"/>&nbsp;
                        </td>
                        <%-- <tr>
                ...
                <table align="center">
                    <tr>
                        <td>&nbsp;</td>
                        <td><s:button name="simpanPBTTidakPenting" id="simpan" value="Simpan" class="btn" onclick="savePenjaga(this.name, this.form);"/></td>
