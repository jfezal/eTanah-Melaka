...
//        Pengguna pengguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
    ...
    public Object findObject(Object obj, String[] data, int num) {
        ...
        if (obj instanceof HakmilikPermohonan) {
            ...
            if (num == 0) {
                ...
                obj = plpservice.findLaporanTanahByIdPermohonanAndJenisLaporan3(data[0], data[1], Long.parseLong(data[2]));
            }
        } else if (obj instanceof PermohonanLaporanPelan) {
            if (num == 0) {
                // data[0] = idPermohonan
            ...
            } else if (num == 1) { //filter by id_lapor_tanah_spnd
                obj = enforceService.findImejLaporanByIdLaporTanahSpdn(Long.valueOf(data[0]));
            }
        } else if (obj instanceof Dokumen) {
            if (num == 0) {
                // data[0] = idDokumen
    ...
    public String delObject(String tName, String[] data, String typeName) {
        ...
        if (tName.equals("mohonLaporSempadan")) {
            ...
            if (plk != null) {
                ImejLaporan imej = new ImejLaporan();
                imej = (ImejLaporan) this.findObject(imej, new String[]{String.valueOf(data[0])}, 1);

                if (imej != null) {
                    enforceService.deleteImejLaporan(imej);
                }
