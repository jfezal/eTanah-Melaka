...
//    Created on : July 16, 2013, 9:00:05 AM
//    Author     : user
...
@UrlBinding("/pelupusan/draf_mmk_pjlb")
public class DrafMMK_PJLBActionBean extends AbleActionBean {

    Logger logger = Logger.getLogger(DrafMMK_PJLBActionBean.class);
    @Inject
...
//        edit = Boolean.FALSE;
        ...
        return new JSP("pelupusan/pjlb/draf_mmkn_mlk.jsp").addParameter("tab", "true");
    }
...
//        ptg = Boolean.TRUE;
    ...
    public void rehydrate() {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PCRG")) {
            ...
            tujuanUrusanPlps = "memperbaharui Lesen Pajakan Lombong";
        }
        String nama = " ";
...
//        perihalpermohonan = " Pentadbir Tanah " + permohonan.getCawangan().getDaerah().getNama() + " telah menerima permohonan ini pada " + mtarikmasuk + ".";
        ...
        if (permohonan.getKodUrusan().getKod().equals("PCRG")) {
            ...
            urusanPlps1 = "Memperbaharui Lesen Pajakan Lombong di atas tanah kerajaan";
        }
...
//            tajuksbb = hakmilikPermohonan.getKodKegunaanTanah().getNama();
        ...
        if (permohonan.getKodUrusan().getKod().equals("PCRG")) {
            ...
            urusanPlps = "MEMPERBAHARUI LESEN PAJAKAN LOMBONG DI ATAS TANAH KERAJAAN";
        }
...
//        }
        if (permohonan.getKodUrusan().getKod().equals("PCRG") || permohonan.getKodUrusan().getKod().equals("MPCRG") || permohonan.getKodUrusan().getKod().equals("PJLB") || permohonan.getKodUrusan().getKod().equals("MPJLB")) {
...
//                }
        ...
        if (permohonankertas != null) {
            ...
            senaraiLaporanKandungan1 = pelupusanService.findByIdLapor(permohonankertas.getIdKertas(), 2);
//            logger.info("senaraiLaporanKandungan1 " + senaraiLaporanKandungan1);
//            for (PermohonanKertasKandungan pkk : senaraiLaporanKandungan1) {
//                kandungan2 = pkk.getKandungan();
//                logger.info("kandungan2 " + kandungan2);
//
//            }
...
//        }
        if (kodNegeri.equals("05")) {
            if (permohonan.getKodUrusan().getKod().equals("PCRG")) {
                ...
                if (stageId.equals("31SediakanDrafMMK")) {
                    permohonankertas = new PermohonanKertas();
                    permohonankertas = pelupusanService.findKertasByKod(idPermohonan, "RMN");
                    if (permohonankertas == null) {
                        simpanNew();
                ...
                if (stageId.equals("62SedDrafKrtsMMK")) {
                    permohonankertas = new PermohonanKertas();
                    permohonankertas = pelupusanService.findKertasByKod(idPermohonan, "RMN");
                    if (permohonankertas == null) {
                        simpanNew();
    ...
    public void updateKandungan(int i, String kand) {
        ...
        if (permohonan.getKodUrusan().getKod().equals("PCRG") || permohonan.getKodUrusan().getKod().equals("MPCRG") || permohonan.getKodUrusan().getKod().equals("PJLB") || permohonan.getKodUrusan().getKod().equals("MPJLB") || permohonan.getKodUrusan().getKod().equals("LSTP")) {
...
//                pelupusanService.simpanPermohonanKertasKandungan(permohonanKertasKandungan1);
        ...
        if (permohonan.getKodUrusan().getKod().equals("PCRG") || permohonan.getKodUrusan().getKod().equals("MPCRG") || permohonan.getKodUrusan().getKod().equals("PJLB") || permohonan.getKodUrusan().getKod().equals("MPJLB")) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("PJLB") || permohonan.getKodUrusan().getKod().equals("MPJLB")) {
                permohonanTuntutanKosTemp.setKodTransaksi(kodTuntutDAO.findById("DISLB").getKodKewTrans());
                permohonanTuntutanKosTemp.setItem(kodTuntutDAO.findById("DISLB").getNama());
                permohonanTuntutanKosTemp.setKodTuntut(kodTuntutDAO.findById("DISLB"));
            }
        ...
        // END : LPS
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/pjlb/draf_mmkn_mlk.jsp").addParameter("tab", "true");
    }
