<%--
    Document   : popup_barang_tahanan
    Created on : May 5, 2010, 11:44:05 AM
    Author     : nurshahida.radzi
    Modify by : ctzainal 20june 2011 and sitifariza.hanim (02Ogos2011)
    Modified by: ctzainal (12Sept2011)-add namaPemandu
--%>
...
<script type="text/javascript">
    ...
    $(document).ready( function(){
        ...
        if($('#kuantitiBarang').val()=="0"){
            document.getElementById("kuantitiBarang").value = "";
        }
    });
    ...
    <c:if test="${actionBean.kodNegeriPermohonan ne '05'}">
        ...
        function changeJnsBrgRampasan(value){
            ...
            if(value == 'B'){
                ...
                //                document.getElementById("namaPemunyaWajibBukanKenderaan").value = "";
                ...
                //                document.getElementById("namaPemunyaWajib").value = "";
    ...
    <%--  function validateNumber(elmnt,content) {
          ...
          function findPemunya(id){
              if(id != "" && id != "TDD"){
                  var add = 'add';
                  $.get('${pageContext.request.contextPath}/penguatkuasaan/maklumat_barang_tahanan?findOks&idOks='+id+'&pagePass='+add,
                  function(data){
...
<s:form  beanclass="etanah.view.penguatkuasaan.MaklumatBarangTahananActionBean" name="form1">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                ...
                <input type="radio" name="kodKategoriItemRampasan" checked="checked" id="kod1" value="B" onclick="changeJnsBrgRampasan('B');" />Bukan Kenderaan
                <input type="radio" name="kodKategoriItemRampasan" id="kod" value="K" onclick="changeJnsBrgRampasan('K');"/>Kenderaan

            </p>
            <div id="kenderaan">
                <p>
                    <label><em>*</em>Jenis Kenderaan :</label>
                    <s:text name="item" onchange="this.value=this.value.toUpperCase();" id="item1" maxlength="50" size="40"/>
                    <font color="red" size="1">cth : Lori, Kereta </font>
                </p>
                <p>
                ...
                <p>
                    ...
                    <font color="red" size="1">cth : Honda, Toyota, Nissan </font>
                </p>
                <p>
                    <label>Nama Model :</label>
                    <s:text name="namaModel" onchange="this.value=this.value.toUpperCase();" id="namaModel" maxlength="30" size="40"/>
                    <font color="red" size="1">cth : c200, 525i </font>
                </p>
                <p>
                    <label>Keupayaan Enjin :</label>
                    <s:text name="kapasitiEnjin" onchange="this.value=this.value.toUpperCase();" id="kapasitiEnjin" maxlength="10"/>&nbsp;cc
                    &nbsp;<font color="red" size="1">250cc 2000cc </font>
                </p>
                <p>
                    <label>Bahan Bakar :</label>
                    <s:select name="kbbb" id="kbbb" >
                        <s:option value="">Pilih</s:option>
                        <s:options-collection collection="${list.senaraiKodBahanBakar}" label="nama" value="kod" />
                    </s:select>&nbsp;
                ...
                <p>
                    ...
                    <font color="red" size="1">cth : Merah, Biru </font>
                </p>
                <p>
                    <label>Kelas Kegunaan :</label>
                    <s:select name="kkkk" id="kkkk" >
                        <s:option value="">Pilih</s:option>
                        <s:options-collection collection="${list.senaraiKodKegunaanKenderaan}" label="nama" value="kod" />
                    </s:select>&nbsp;<font color="red" size="1">Cth : Barangan Regid, Barangan Tak Regid</font>
                </p>
                <p>
                    <label>Jenis Badan :</label>
                    <s:select name="kodjbk" id="kodjbk" >
                        <s:option value="">Pilih</s:option>
                        <s:options-collection collection="${list.senaraiKodJenisBadanKenderaan}" label="nama" value="kod" />
                    </s:select>&nbsp;<font color="red" size="1">Cth : Lori regid-dumper/tipper</font>
                </p>
                <p>
            ...
            <%--jika pilih  Jenis Barang Rampasan = bukan kenderaan--%>
            <fieldset class="aras1">
                <div id="BukanKenderaan">
                    <p>
                    ...
                    <p>
                        ...
                        <s:text name="tarikhRampas" class="datepicker" formatPattern="dd/MM/yyyy" id="datepicker2" />&nbsp;
                    </p>
                    <p><label>&nbsp;</label>
                        <font color="red" size="1">cth : hh / bb / tttt</font>
                    </p>
                    <p>
                        ...
                        <s:select name="jam"  id="jam1" style="width:56px">
                            <s:option value="">Jam</s:option>
                            <s:option value="01">01</s:option>
                            <s:option value="02">02</s:option>
                            <s:option value="03">03</s:option>
                        ...
                        <s:select name="minit" id="minit1" style="width:60px">
                            <s:option value="">Minit</s:option>
                            <s:option value="00">00</s:option>
                            <s:option value="05">05</s:option>
                            <s:option value="10">10</s:option>
                        ...
                        <s:select name="ampm" id="ampm1" style="width:80px">
                            <s:option value="">Pilih</s:option>
                            <s:option value="AM">PAGI</s:option>
                            <s:option value="PM">PETANG</s:option>
                        </s:select>
                    ...
                    <p>
                        ...
                        <s:text name="kuantiti" id="kuantitiBarang" onkeyup="validateNumber(this,this.value);" maxlength="3" />
                    ...
                    <c:choose>
                        <c:when test="${actionBean.permohonan.kodUrusan.kod eq '425' || actionBean.permohonan.kodUrusan.kod eq '425A' || actionBean.permohonan.kodUrusan.kod eq '426' || actionBean.permohonan.kodUrusan.kod eq '999'}">
                            ...
                            <p>
                                ...
                                <s:select name="kodJenisPengenalanPemunya" id="kodJenisPengenalanPemunya" style="width:139px;" onchange="jenisPengenalanPemunya()" class="normal_text">
                                    <s:option value="">Sila Pilih</s:option>
                                    <s:options-collection collection="${list.senaraiKodJenisPengenalan}" label="nama" value="kod" sort="nama" />
                                </s:select>
                            </p>
        ...
        <fieldset class="aras1">
            ...
            <div class="instr-fieldset">
                Sila Masukkan Maklumat Penjamin.
            </div>&nbsp;
            <p>

                <label>Nama Penjamin:</label>
                <s:text name="namaPenjamin" id="namaPenjamin" onchange="this.value=this.value.toUpperCase();" maxlength="249" size="40"/>&nbsp;
            </p>
            ...
            <p id="noPengenalanBaruPenjamin" style="visibility: hidden; display: none">
                <label>No.Pengenalan :</label>
                <s:text name="noPengenalanPenjamin" id="penyerahNoPengenalanBaruPenjamin" maxlength="12" size="15" onkeyup="validateNumber(this,this.value);" />
                <font color="red" size="1">cth : 850510071213 </font>
                &nbsp;
            </p>
            <p>
            ...
            <p>
                <label>&nbsp;</label>
                <s:text name="alamat2Penjamin" onkeyup="this.value=this.value.toUpperCase();" maxlength="49" size="40"/>&nbsp;</p>
            <p>
                <label> &nbsp; </label>
                <s:text name="alamat3Penjamin" onkeyup="this.value=this.value.toUpperCase();" maxlength="49"size="40"/>&nbsp;</p>
            <p>
                <label> &nbsp; </label>
                <s:text name="alamat4Penjamin" onkeyup="this.value=this.value.toUpperCase();" maxlength="49" size="40"/>&nbsp; </p>
            ...
            <p>
                ...
                <s:select name="kj"  style="width:139px;">
                    <s:option value="">Sila Pilih</s:option>
                    <s:options-collection collection="${list.senaraiKodJantina}" label="nama" value="kod" sort="nama" />
                </s:select>
                &nbsp;
            </p>
