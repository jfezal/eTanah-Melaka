 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/permohonan_supaya_bantahan")
public class PermohonanSupayaBantahanActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/permohonan_supaya_bantahan.jsp").addParameter("tab", "true");
    }
