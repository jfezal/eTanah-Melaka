<%-- 
    Document   : MMKN_SEK4A
    Created on : 16-May-2011, 18:13:29
    Author     : nordiyana
--%>
...
<script language="javascript" type="text/javascript">
    ...
    function deleteRow3()
    {
        ...
        if (document.getElementById('idKandungan3'+(i)) != null) {
            var url = '${pageContext.request.contextPath}/pengambilan/sek4ammknNS?deleteSingle&idKandungan='
            +idKandungan;
    ...
    function deleteTable5() {
        ...
        if(parseInt(count5) <= parseInt(temp5)) {
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/sek4ammknNS?deleteTable&bil='
            +bil;
  ...
  <s:form beanclass="etanah.view.stripes.pengambilan.MMKNSEK4AduanNSActionBean"  id="form2">
                                    ...
                                    <table  width="90%" id="table7${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPengarah[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount7 eq 1}">
                                                <tr> <td><b>7.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" cols="130" readonly="true" name="syorPengarah${i}${recordCount7}" id="syorPengarah${i}${recordCount7}" value="${senarai.kandungan}" /></td>
                                            ...
                                            <tr>  <td></td>
                                                  ...
                                                  <td><s:textarea rows="5" cols="130" readonly="true" name="syorPengarah${i}${recordCount7}" id="syorPengarah${i}${recordCount7}" value="${senarai.kandungan}" /></td>
                                            </c:if>
                ...
                <div class="content" align="center">
                    <table border="0" width="80%">
                       ...
                       <tr><td><br/><b>1. <%--<font style="text-transform: uppercase">PERMOHONAN PENGAMBILAN TANAH DI ATAS LOT
                        ...
                        <tr><td align="right"><s:button name="perihalPermohonan" disabled="true" value="Tambah" class="btn" onclick="addRow3('dataTable3')" />
                        ...
                        <tr><td align="right"><s:button name="nilaianTanah" disabled="true" value="Tambah" class="btn" onclick="addRow4('dataTable4')" />
                                <s:button name="nilaianTanah" value="Hapus" disabled="true" class="btn" onclick="deleteRow4()" />
                            </td>
                        </tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b><font style="text-transform:uppercase">5. SYOR PENTADBIR TANAH DAERAH ${actionBean.hakmilik.daerah.nama}</font></b></td></tr>
                        ...
                        <c:forEach var="i" begin="1" end="${actionBean.count5}">
                            ...
                            <tr><td align="right">
                                    ...
                                    <s:button class="btn" value="Hapus" disabled="true" name="add" onclick="deleteTable5()"/>
