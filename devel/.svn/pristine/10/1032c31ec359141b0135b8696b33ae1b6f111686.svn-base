...
<s:form beanclass="etanah.view.stripes.lelong.MaklumatPenghantaran16HActionBean">
    <s:errors/>
    <s:messages/>
    ...
    <fieldset class="aras1">
        ...
        <p>
            <label>&nbsp;</label>&nbsp;
            <s:submit name="processUploadDoc" value="Simpan" class="btn" onclick="simpanPihak();"/>
