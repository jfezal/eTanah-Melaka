<%-- 
    ...
    Created on : Dec 3, 2010, 10:44:45 AM
    Author     : afham
--%>
...
<div class="subtitle">
    ...
    <s:form beanclass="etanah.view.stripes.pengambilan.LaporanPelukisPelanPActionBean">
            ...
            <legend>
                Kemasukan Tanah Rizab Laporan Pelukis Pelan
            </legend>
            <p>
            ...
            <p>
                ...
                <s:button name="simpanTanahRizab" value="SimpanLPP" class="btn" onclick="save1(this.name, this.form);" />
