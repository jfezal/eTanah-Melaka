    ...
    <%-- alert("test");--%>
        ...
        function selectCheckBox()
        {
            ...
            if(confirm("Adakah anda pasti?")) {
                var url = '${pageContext.request.contextPath}/pelupusan/utiliti/laporanTanah?simpanAgensi&item='+data+'&idPermohonan='+idPermohonan ;
                $.get(url,
                function(data){
...
<body>
    ...
    <s:messages/>
    <div class="subtitle">
        <s:form beanclass="etanah.view.stripes.pelupusan.utility.UtilitiLaporanTanahActionBean" name="frm">
