 ...
 */
public class Sedia16HValidator implements StageListener {

    private static final Logger LOG = Logger.getLogger(Sedia16HValidator.class);
    @Inject
...
//            if(kf.getDokumen().getKodDokumen().getKod().equals("SRW")){
//                srw = "SRW";
//            }
        }
        LOG.info("h16 : " +h16);
...
//        if(!srw.equals("SRW")){
//            LOG.info("---SRW-Error---");
//            context.addMessage(idPermohonan + " - Sila Jana Warta 16H Di Tab Warta 16H");
//            return null;
//        }
