<%-- 
    Document   : Upload_Imej_Laporan
    Created on : May 30, 2011, 12:13:47 PM
    Author     : Rajesh
--%>
...
<s:form beanclass="etanah.view.stripes.pengambilan.LaporanTanahPengambilanN9ActionBean">
    ...
    <fieldset class="aras1">
        ...
        <p> <p>
                <label>Catatan :</label><s:textarea name="catatan" />
         &nbsp;<p></p>
            <label>&nbsp;</label>&nbsp;
        ...
        <p>
            <label>&nbsp;</label>&nbsp;
            <s:submit name="simpanImejLaporan" value="Simpan" class="btn"/>
