<%-- 
    Document   : carian_permohonan_terdahuluGSA
    Created on : Jun 27, 2012, 11:19:39 AM
    Author     : Admin
--%>
...
<s:form beanclass="etanah.view.stripes.pelupusan.LaporanPelukisPelanGSAActionBean" name="test">
    <s:errors/>
    <s:messages/>
    <div class="subtitle1">
        <c:if test="${!status}">
        <fieldset class="aras1">
            ...
            <p>
                <label>&nbsp;</label>
                <s:submit name="cariPermohonan" value="Cari" class="btn"/>
