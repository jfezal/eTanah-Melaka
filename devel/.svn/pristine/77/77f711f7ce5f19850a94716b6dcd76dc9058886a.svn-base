<%-- 
    Document   : calender_lelong5
    Created on : Sep 27, 2010, 5:41:04 PM
    ...
    <c:forEach items="${actionBean.listCalender2}" var="k" varStatus="l" >
            ...
            $('#calendar').fullCalendar({
                ...
                dayClick: function(date, allDay, jsEvent, view) {
                    ...
                    var kodUrusan = '${actionBean.permohonan.permohonanSebelum.kodUrusan.kod}';
                    var dateEn = dateValidation2(dE);
                    if(kodUrusan == "PPJP"){
                        dateEn = dateValidation2(dE);
                    }
                    if(kodUrusan == "PJTA"){
                        dateEn = dateValidation3(dE);
                    }
                    if(dateEn > date){
