 ...
 * @author Murali
 */
@UrlBinding("/strata/maklumat_hakmilik_permohonanPH")
public class PHStrataMaklumatHakmilikPermohonanActionBean extends AbleActionBean {

    private static final Logger LOG = Logger.getLogger(PHStrataMaklumatHakmilikPermohonanActionBean.class);
    @Inject
    ...
    public Resolution deleteHakmilik() {
        ...
        return new RedirectResolution(PHStrataMaklumatHakmilikPermohonanActionBean.class, "senaraiHakmilikIsmen").addParameter("tab", "true").addParameter("idHakmilik", idHakmilik);
    }
    ...
    public void rehydrate() {
        ...
        Permohonan mohonPBCTM = strService.findIDSblmByKodUrusan(p.getIdPermohonan(), "PBCTM");
        Permohonan mohonPBCTL = strService.findIDSblmByKodUrusan(p.getIdPermohonan(), "PBCTL");
        ...
        } else if (p.getKodUrusan().getKod().equals("PHPC")) {
            if (mohonPBCTM == null || mohonPBCTL == null) {
                addSimpleError("Sila pastikan endorsan telah didaftarkan! ");
            } else if (mohonPBCTM.getKeputusan() == null || mohonPBCTL.getKeputusan() == null) {
                addSimpleError("Sila pastikan endorsan telah didaftarkan! ");
            }
        ...
        if (listHakmilik.size() <= 0) {
         ...
         if (listHakmilik.size() > 0 && hakmilikPermohonanList.size() == 1) {
                comm.generateHakmilikStrata3(ia, p, pengguna);
            }
        } else if (p.getKodUrusan().getKod().equals("PHPP")) {
         if (listHakmilik.size() > 0 && hakmilikPermohonanList.size() == 2) {
                comm.generateHakmilikStrata4(ia, p, pengguna);
            }
        }
...
//        Pengguna peng = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
    ...
    public Resolution simpanHakmilikStrataReg() {
        ...
        addSimpleMessage("Kemaskini Data Berjaya");
//        return new JSP("strata/pbbm/paparan_maklumat_hakmilik_permohonan_terperinci_strata_reg.jsp").addParameter("tab", "true");
        return new RedirectResolution(PHStrataMaklumatHakmilikPermohonanActionBean.class, "showForm3");
    }
...
//        hakmilikPermohonanList = strService.findIdHakmilikSortIDHMAsc(idPermohonan);
        ...
        addSimpleMessage("Kemaskini Data Berjaya");
//        return new JSP("strata/pbbm/paparan_maklumat_hakmilik_permohonan_terperinci_strata_reg.jsp").addParameter("tab", "true");
        return new RedirectResolution(PHStrataMaklumatHakmilikPermohonanActionBean.class, "showFormHm");
    }
...
//        return new JSP("strata/pbbm/paparan_maklumat_hakmilik_permohonan_terperinci_strata_reg.jsp").addParameter("tab", "true");
    ...
    public Resolution simpanHakmilikStrata() {
        ...
        addSimpleMessage("Kemaskini Data Berjaya");
        return new RedirectResolution(PHStrataMaklumatHakmilikPermohonanActionBean.class, "showForm2");
    }
