...
<script type="text/javascript">
    ...
    function simpan(){
        ...
        var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?simpan&perihalHakmilik='+perihalHakmilik;
        $.get(url,
        function(data){
            $('#page_div').html(data);
    ...
    function openFrame(type){        
        ...
        NoPrompt();
        //    alert(perihalHakmilik);
        window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?openFrame&perihalHakmilik="+perihalHakmilik+"&type="+type, "eTanah",
