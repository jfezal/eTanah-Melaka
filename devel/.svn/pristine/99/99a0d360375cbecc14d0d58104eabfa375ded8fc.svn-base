 ...
 * @modified hazirah
 */
@UrlBinding("/pengambilan/affidavitMahkamahPtsp")
public class AffidavitMahkamahPtspActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(AffidavitMahkamahPtspActionBean.class);
    @Inject
...
//    private int bil = 0;
    ...
    private static final Logger LOG = Logger.getLogger(AffidavitMahkamahPtspActionBean.class);
    ...
    public Resolution showForm() {
        ...
        if (idPermohonan != null) {
            ...
            if (permohonan != null) {
                permohonanSupayaBantahanService.simpanPermohonanPihak(permohonan, peng);
            }
        }

        return new JSP("pengambilan/AffidavitPtsp.jsp").addParameter("tab", "true");
    }
...
//                        LOG.info("DAPAT ID HADIR " + pk.getIdKehadiran());
                    ...
                    if (permohonanKertas == null) {
                        ...
                        permohonanKertas.setPermohonanPihak(pp);
                    ...
                    permohonanKertas = permohonanSupayaBantahanService.findPermohonanKertasByidMP(pp.getIdPermohonanPihak());
                    penyediaSidang1 = permohonanKertas.getPenyediaSidang();
                    ...
                    senaraiKertasKandungan3 = pendudukanSementaraMMKNService.findByKertas(permohonanKertas.getIdKertas(), 1);
                    logger.info("senaraiKertasKandungan3 = " + senaraiKertasKandungan3.size());
                    ...
                    if (kandList5 != null && !kandList5.isEmpty()) {
                        logger.info("id kertas : " + permohonanKertas.getIdKertas());
...
//        permohonanPihak = permohonanSupayaBantahanService.getSenaraiPmohonPihakByIdHakmilikIdPihak(idPermohonan, idHakmilik, idPihak);
        ...
        for (PermohonanPihak pp : mohonPihakList) {
            if (pp != null) {
                permohonanKertas = permohonanSupayaBantahanService.findPermohonanKertasByidMP2(pp.getIdPermohonanPihak(), idPermohonan);
                ...
                for (int k = 1; k <= kira3; k++) {
                    ...
                    permohonanKertasKandungan3.setBil(1);
                    ...
                    permohonanKertasKandungan3.setSubtajuk("1." + k);
...
//        getContext().getRequest().setAttribute("edit", Boolean.TRUE);
        ...
        return new RedirectResolution(AffidavitMahkamahPtspActionBean.class, "locate");
    }
    ...
    public Resolution deleteTable() {
        ...
        getContext().getRequest().setAttribute("showTuanTanah", Boolean.TRUE);
        getContext().getRequest().setAttribute("showDetails", Boolean.TRUE);
        return new JSP("pengambilan/affidavit_mahkamahPtsp.jsp").addParameter("tab", "true");
    ...
    public String getIdPihak2() {
        return idPihak2;
    }

    public void setIdPihak2(String idPihak2) {
        this.idPihak2 = idPihak2;
    }
}
