 ...
 */
public class ReportUtil implements ReportGenerator, ReportUtilMBean {
...
//            if (httpConn.getContentType() != null) contentType = httpConn.getContentType().getValue();
            ...
            if( pengguna != null) {
                ...
                if(isAkuan) DMS_PATH = DMS_PATH + File.separator + "AkaunPenerimaan";
                if(isResit) DMS_PATH = DMS_PATH + File.separator + "RESIT";
                DMSPATH_WO_DMSBASE = dmsUtil.getFizikalPath(pengguna);
                if(isAkuan) DMSPATH_WO_DMSBASE = DMSPATH_WO_DMSBASE + File.separator + "AkaunPenerimaan";
                if(isResit) DMSPATH_WO_DMSBASE = DMSPATH_WO_DMSBASE + File.separator + "RESIT";
            } else {
