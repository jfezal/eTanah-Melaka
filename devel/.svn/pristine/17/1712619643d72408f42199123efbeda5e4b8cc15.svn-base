 ...
 * @author wan.fairul
 */
@UrlBinding("/strata/pbbs/mlk")
public class MaintainBangunanpbbsActionBean extends BasicTabActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(MaintainBangunanpbbsActionBean.class);
    ...
    public Resolution selectedPitak() {
        ...
        return new JSP("strata/pbbm/maklumat_jadualpetak_mlk.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution tambahBangunan() {
        ...
        return new RedirectResolution(MaintainBangunanpbbsActionBean.class, "showForm1").addParameter("error", error).addParameter("message", msg);
    ...
    public Resolution tambahPetak() {
        ...
        return new RedirectResolution(MaintainBangunanpbbsActionBean.class, "showForm1");
    }
    ...
    public Resolution HapusXml() {
        ...
        return new RedirectResolution(MaintainBangunanpbbsActionBean.class, "showForm4").addParameter("message", msg);
    }
