...
@UrlBinding("/pengambilan/taipSemulaWarta")
public class TaipSemulaWartaBrgDActionBean  extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(TaipSemulaWartaBrgDActionBean.class);
    @Inject
    ...
    public Resolution showForm1() {
        return new JSP("pengambilan/taipSemulaWartaBrgD.jsp").addParameter("tab", "true");
    }
}
