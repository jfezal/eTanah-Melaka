...
<script type="text/javascript">
    ...
    function muatNaikForm1(folderId, idPermohonan, dokumenKod, idOrangKenaSyak) {
        var left = (screen.width/2)-(1000/2);
        var top = (screen.height/2)-(150/2);
        var url = '${pageContext.request.contextPath}/penguatkuasaan/upload?muatNaikForm1&folderId=' + folderId
            + '&idPermohonan=' + idPermohonan + '&dokumenKod=' + dokumenKod + '&idOrangKenaSyak=' + idOrangKenaSyak;
        ...
        if(noPengenalan.length =="12"){
            ...
               for (var i = 0; i < selectKodUrusan.options.length; ++i){
                if (selectKodUrusan.options[i].value == bulan){
                    ...
                    //alert("bulan dob : "+document.getElementById('bulanReadonly').value);
                    break;
                 }
              }
    ...
    function jenisPengenalan(){
        if($('#pengenalan').val() == 'B'){
            ...
            $('#noPengenalanLainOks').attr("disabled", true);
            $('#noPengenalanOksBaru').attr("disabled", false);
            ...
            $('#noPengenalanOksBaru').attr("disabled", true);
            $('#noPengenalanLainOks').attr("disabled", false);
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p id="noPengenalanLain">
                ...
                <s:text name="noPengenalanLain" id="noPengenalanLainOks" maxlength="20" onkeyup="this.value=this.value.toUpperCase();" />
                &nbsp;
            </p>
            ...
            <p>
                ...
                <s:text name="pekerjaanOKS" id="kerja" size="30" onchange="this.value=this.value.toUpperCase();"/>&nbsp;
            </p>
            <p>
                <label>Alamat :</label>
            ...
            <p>
                <label>Negeri :</label>
                <s:select name="negeriO" style="width:139px;">
                    <s:option value="">Sila Pilih</s:option>
        ...
        <fieldset class="aras1">
            ...
            <p>
                <label>Negeri :</label>
                <s:select name="kodNegeriMajikan.kod" style="width:139px;">
                    <s:option value="">Sila Pilih</s:option>
                    <s:options-collection collection="${listUtil.senaraiKodNegeri}" label="nama" value="kod" />
                </s:select>&nbsp;
            </p>
        ...
        <fieldset class="aras1">
            ...
            <p>
                <label>Negeri :</label>
                <s:select name="kodNegeriWaris.kod" style="width:139px;">
                    <s:option value="">Sila Pilih</s:option>
                    <s:options-collection collection="${listUtil.senaraiKodNegeri}" label="nama" value="kod" />
                </s:select>&nbsp;
            </p>
            ...
            <p>
                ...
                <s:select name="jenisPengenalanWaris.kod"  style="width:139px;" id="pengenalanWaris" onchange="jenisPengenalanWaris(this.value);">
                    <s:option value="">Sila Pilih</s:option>
                    <s:options-collection collection="${listUtil.senaraiKodJenisPengenalan}" label="nama" value="kod" sort="nama" />
                </s:select>
                &nbsp;
        ...
        <p align="center">
            ...
            <%--<s:button class="btn" value="Simpan" name="oksSave"  onclick="if(validateForm()!== false){save(this.name,this.form);}" />--%>
            ...
            <%--<s:button class="btn" onclick="doSubmit(this.form, this.name, 'page_div');" name="oksSave" value="Simpan"/>--%>
        </p>
        <br>
    </div>
</s:form>
