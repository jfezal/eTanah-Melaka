 ...
 */
public class InitiateN8ABValidator implements StageListener {
    ...
    private static final Logger LOG = Logger.getLogger(InitiateN8ABValidator.class);
...
//        if (permohonan.getKeputusan().getKod().equals("WJ")) {
        ...
        KodUrusan kod = kodUrusanDAO.findById("N8AB");
