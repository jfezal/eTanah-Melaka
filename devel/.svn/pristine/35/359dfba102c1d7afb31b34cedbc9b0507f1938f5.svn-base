...
<!--                                PADA <font color="red">*</font> <s:text name="tarikhMesyuarat" id="datepicker" class="datepicker" size="12" />)-->
                     ...
                     <tr><td>
                            <table id ="dataTable1">
                                ...
                                <c:forEach items="${actionBean.senaraiLaporanKandungan1}" var="line">
                                    <tr><td style="display:none">${line.idKandungan}</td><td valign="top" style="font-weight:bold"><c:out value="1.${k}"/></td>
                                        <td><font style="text-transform: uppercase">
                                            <s:textarea name="kandungan1${i}" id="kandungan1${i}"  readonly="readonly"  rows="5" cols="100" onkeyup="this.value=this.value.toUpperCase();">${line.kandungan}</s:textarea> </font>
                     ...
                     <tr><td>
                             <table id ="dataTable2" border="0">
                                ...
                                <c:forEach items="${actionBean.senaraiLaporanKandungan2}" var="line">
                                    <tr><td style="display:none">${line.idKandungan}</td><td valign="top" style="font-weight:bold"><c:out value="2.${k}"/></td>
                                        <td><font style="text-transform: uppercase">
                                           <!-- ${line.kandungan}</font> -->
                                            <s:textarea name="kandungan2${i}" id="kandungan2${i}" readonly="readonly"  rows="5" cols="100" onkeyup="this.value=this.value.toUpperCase();">${line.kandungan}</s:textarea></font>
                                        </td></tr><tr><td colspan="2">&nbsp;</td></tr>
                                        <c:set var="i" value="${i+1}" />
                                        <c:set var="k" value="${k+1}" />
                                    </c:forEach>
                   ...
                   <tr><td><b>3. ASAS PERMOHONAN</b></td></tr>
                     ...
                     <tr><td>
                            <table id ="dataTable3">
                                ...
                                <c:forEach items="${actionBean.senaraiLaporanKandungan3}" var="line">
                                    <tr><td style="display:none">${line.idKandungan}</td><td valign="top" style="font-weight:bold"><c:out value="3.${k}"/></td>
                                        <td><font style="text-transform: uppercase">
                                            <s:textarea name="kandungan3${i}" id="kandungan3${i}" readonly="readonly"  rows="8" cols="100" onkeyup="this.value=this.value.toUpperCase();">${line.kandungan}</s:textarea> </font>
                                        </td></tr><tr><td colspan="2">&nbsp;</td></tr>
                                        <c:set var="i" value="${i+1}" />
                                        <c:set var="k" value="${k+1}" />
                                    </c:forEach>
                    ...
                    <tr><td>&nbsp; </td></tr>
                    <%--<tr><td align="center"><s:button name="simpan" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/></td></tr>--%>
            </table>
            </div>
