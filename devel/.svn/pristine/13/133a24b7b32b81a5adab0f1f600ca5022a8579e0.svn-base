<%-- 
    ...
    Created on : Nov 18, 2011, 12:04:20 PM
    Author     : NageswaraRao
--%>
...
<style type="text/css">
    ...
    function deleteRow()
    {
        ...
        var c1 = $('#count').val();
            ...
            alert("c3:"+c1);--%>
        if(rc1 == c1){
            var url = '${pageContext.request.contextPath}/pembangunan/melaka/sediaSuratKeputusan?deleteSingle&idKandungan='+idKandungan;
            $.get(url,
            function(data){
                $('#page_div').html(data);
            },'html');
...
<s:form beanclass="etanah.view.stripes.pembangunan.SediaSuratKeputusanActionBean">
    <s:messages/>    
