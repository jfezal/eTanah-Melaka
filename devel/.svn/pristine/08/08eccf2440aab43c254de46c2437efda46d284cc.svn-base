 ...
 * @author mohd.faidzal
 */
public class SediaSuratKLValidator implements StageListener {

    private static final Logger LOG = Logger.getLogger(SediaSuratKLValidator.class);
    @Inject
    ...
    public void onGenerateReports(StageContext context) {
        ...
        namaReport[0] = "ACQDocK_MLK.rdf";
        kodReport[0] = "K";
        namaReport[1] = "ACQDocL_MLK.rdf";
        kodReport[1] = "L";
        ...
        for (HakmilikPermohonan hp : context.getPermohonan().getSenaraiHakmilik()) {
            ...
            BorangPerHakmilik ph = aduanService.findByIdMHNBE(hp.getId(), "NBK");
            if (ph != null) {
                ...
                List<BorangPerPB> listPb = aduanService.findBorangPBbyKodNotis(ph, "NBL");
                for (BorangPerPB pb : listPb) {
                    namaReport = new String[1];
                    kodReport = new String[1];
                    namaReport[0] = "ACQDocL_MLK.rdf";
                    kodReport[0] = "L";
