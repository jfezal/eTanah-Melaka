 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/borang_mmkn_31a_ns")
public class PengambilanMMKN31aNSActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(PengambilanMMKN31aNSActionBean.class);
    @Inject
    ...
    private final String tajuk = "KERTAS PERMOHONAN PENGAMBILAN TANAH 3(1)(a) NEGERI SEMBILAN";
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/negerisembilan/seksyen831a/pengambilan_MMKN_31a.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        tujuan = "Kertas ini bertujuan untuk mendapatkan pertimbangan yang amat berhormat Menteri Besar Negeri Sembilan Darul Khusus ke atas "
                + "permohonan pengambilan tanah daripada "+ permohonan.getSenaraiPemohon().get(0).getIdPemohon()+ " seluas lebih kurang "
                + totalLuas + " Meter Persegi untuk " + permohonan.getSebab() +" "+ noLotList + " Daerah " + hakmilik.getDaerah().getNama()
                +", seperti di Borang C mengikut seksyen 831a Akta Pengambilan Tanah 1960 dibawah perwakilan kuasa seperti yang "
        ...
        String temp = "PERMOHONAN PENGAMBILAN TANAH DARIPADA "+ permohonan.getSenaraiPemohon().get(0).getIdPemohon()+" SELUAS LEBIH KURANG "
                ...
                + noLotList + " DAERAH " + hakmilik.getDaerah().getNama() + " DI BAWAH SEKSYEN 831A AKTA PENGAMBILAN TANAH 1960.";
...
//            }
        ...
        getContext().getRequest().setAttribute("form", Boolean.TRUE);
        return new RedirectResolution(PengambilanMMKN31aNSActionBean.class, "locate");
    }
