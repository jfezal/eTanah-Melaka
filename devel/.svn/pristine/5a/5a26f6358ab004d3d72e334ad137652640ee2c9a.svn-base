...
<s:form beanclass="etanah.view.kaunter.BayaranPerihalStrataActionBean">
    ...
    <p align="center">
        ...
        <c:if test="${actionBean.stageId eq 'terimabayaran2'}">
            ...
            <%--  <c:if test="${actionBean.bayaran2Visible ne 'true' && actionBean.permohonRBHS == null}">
              <center><p><em>*</em><font color="red">Arahan: Sila pergi ke kaunter untuk daftar Urusan: Rayuan Perlanjutan Tempoh Bayaran Kelulusan Permohonan Hakmilik Strata.</font></p></center>
          </c:if> --%>
