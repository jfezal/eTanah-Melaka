...
@Entity 
@Table (name = "jubl")
@SequenceGenerator(name = "seq_jubl", sequenceName = "seq_jubl")
public class JUBL implements Serializable, Penyerah {
	
	@Id
        @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_jubl")
        @Column (name = "id_jubl")
	private long idJubl;
	...
	public long getIdJubl() {
		return idJubl;
	}

	public void setIdJubl(long idJubl) {
		this.idJubl = idJubl;
	}
