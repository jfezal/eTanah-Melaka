...
<script language="javascript" type="text/javascript">
    ...
    function deleteRow1()
    {
        ...
        if (document.getElementById('idKandungan1'+(i)) != null) {
            var url = '${pageContext.request.contextPath}/pengambilan/borang_mmkn_ptsp?deleteSingle&idKandungan='
            +idKandungan;
    ...
    function deleteRow4()
    {
        ...
        if (document.getElementById('idKandungan4'+(k)) != null) {
            var url = '${pageContext.request.contextPath}/pengambilan/borang_mmkn_ptsp?deleteJabatanTeknikal&idKandungan1='
    ...
    function deleteTable6() {
        ...
        if(parseInt(count6) <= parseInt(temp6)) {
            ...
            var url = '${pageContext.request.contextPath}/pengambilan/borang_mmkn_ptsp?deleteTable&bil='
            +bil;
...
<s:form beanclass="etanah.view.stripes.pengambilan.PengambilanMMKNPtspMLKActionBean"  id="form2">
    <s:messages/>
    <s:errors/>
                                ...
                                <table id ="dataTable3">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                        <tr style="font-weight:bold">
                                            ...
                                            <td><font><s:textarea class="normal_text" name="kandungan3${i}" id="kandungan3${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                ...
                <%--                            <s:select name="cawangan.kod" id="cawangan" >
                                        ...
                                        <c:if test="${k%2 eq 0}">
                                                <tr><td style="display:none">${line.idKandungan}</td><td></td>
                                                    <td><font>
                                                            <s:textarea class="normal_text" name="kandungan4${k}"  id="kandungan4${k}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                                </tr>
                                                <s:hidden name="idKandungan4${k}" id="idKandungan4${k}" value="${line.idKandungan}" />
                                        </c:if>
                                ...
                                <table id ="dataTable5">
                                    <c:set var="i" value="1" /><c:forEach items="${actionBean.senaraiKertasKandungan5}" var="line">
                                        <tr style="font-weight:bold">
                                            ...
                                            <td><font><s:textarea class="normal_text" name="kandungan5${i}" id="kandungan5${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                    ...
                                    <table  width="90%" id="table6${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPentadbir[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount6 eq 1}">
                                                <tr> <td><b>6.${i}</b></td>
                                                    <td colspan="2"><s:textarea class="normal_text" rows="5" cols="130" name="syorPentadbir${i}${recordCount6}" id="syorPentadbir${i}${recordCount6}" value="${senarai.kandungan}" /></td>
                                    ...
                                    <c:set var="k" value="1" />
                                      <c:forEach items="${actionBean.senaraiKertasKandungan7}" var="line">
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea class="normal_text" name="kandungan7${k}" id="kandungan7${k}" rows="5" cols="150">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                        ...
                        <tr><td><b> &nbsp;</b><font><s:textarea class="normal_text" name="ulasan1.kandungan" rows="5" cols="150" id="ulasan1"/>
                                </font></td></tr><br>
                                    ...
                                    <table  width="90%" id="table9${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPengarah[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount9 eq 1}">
                                                <tr> <td><b>9.${i}</b></td>
                                                    <td colspan="2"><s:textarea class="normal_text" rows="5" cols="130" name="syorPengarah${i}${recordCount9}" disabled="true" id="syorPengarah${i}${recordCount9}" value="${senarai.kandungan}" /></td>
                        ...
                        <s:button disabled="true" class="btn" value="Tambah" name="add" onclick="addTable9('Tables9')"/>
                        <s:button disabled="true" class="btn" value="Hapus" name="add" onclick="deleteTable9()"/>
        ...
        <div class="subtitle">
            <fieldset class="aras1" id="locate">
                    ...
                    <table border="0" width="80%">
                       ...
                       <tr><td><br/><b>1. <%--<font style="text-transform: uppercase">PERMOHONAN PENGAMBILAN TANAH DI ATAS LOT
                                ...
                                <table id ="dataTable3">
                                    ...
                                    <c:forEach items="${actionBean.senaraiKertasKandungan3}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea class="normal_text" readonly="true" name="kandungan3${i}" id="kandungan3${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                        <s:hidden name="idKandungan3${i}" id="idKandungan3${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                        ...
                        <tr><td align="right"><s:button disabled="true" name="perihalPermohonan" value="Tambah" class="btn" onclick="addRow3('dataTable3')" />
                                <s:button disabled="true" name="perihalPermohonan" value="Hapus" class="btn" onclick="deleteRow3()" />
                            </td>
                        </tr>
                ...
                <%--                            <s:select name="cawangan.kod" id="cawangan" >
                        ...
                        <tr><td align="right">
                                <s:button disabled="true" name="jabatanTeknikal" value="Tambah" class="btn" onclick="addRow4('dataTable4')" />
                                <s:button disabled="true" name="jabatanTeknikal" value="Hapus" class="btn" onclick="deleteRow4()" />
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b>5. Perihal Tanah</b></td></tr>
                        <tr><td>
                                <table id ="dataTable5">
                                    <c:set var="i" value="1" /><c:forEach items="${actionBean.senaraiKertasKandungan5}" var="line">
                                        <tr style="font-weight:bold">
                                            <td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea class="normal_text" readonly="true" name="kandungan5${i}" id="kandungan5${i}" rows="5" cols="150">${line.kandungan}</s:textarea></font></td>
                                        </tr>
                                        <s:hidden name="idKandungan5${i}" id="idKandungan5${i}" value="${line.idKandungan}" />
                                            <c:set var="i" value="${i+1}" />
                                        </c:forEach>
                        ...
                        <tr><td align="right"><s:button disabled="true" name="nilaianTanah" value="Tambah" class="btn" onclick="addRow5('dataTable5')" />
                                <s:button disabled="true" name="nilaianTanah" value="Hapus" class="btn" onclick="deleteRow5()" />
                            </td>
                        </tr>
                        <tr><td> &nbsp;</td></tr>
                        <tr><td><b><font style="text-transform:uppercase">6. SYOR PENTADBIR TANAH DAERAH ${actionBean.hakmilik.daerah.nama}</font></b></td></tr>
                        ...
                        <c:forEach var="i" begin="1" end="${actionBean.count6}">
                            <tr><td>
                                    <table  width="90%" id="table6${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPentadbir[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount6 eq 1}">
                                                <tr> <td><b>6.${i}</b></td>
                                                    <td colspan="2"><s:textarea class="normal_text" readonly="true" rows="5" cols="130" name="syorPentadbir${i}${recordCount6}" id="syorPentadbir${i}${recordCount6}" value="${senarai.kandungan}" /></td>
                                                    <td><s:hidden name="count6${i}" id="count6${i}" value="${(fn:length(actionBean.senaraiSyorPentadbir[i]))}" /> </td>
                                                    <td><s:button disabled="true" class="btn" value="Tambah 6.${i}" name="add" id="tambah6${i}" onclick="addDynamicRow6('table6${i}','count6${i}')"/></td>
                                                    <td><s:button disabled="true" class="btn" value="Hapus 6.${i}" name="hapus" id="hapus6${i}" onclick="deleteDynamicRow6('table6${i}','count6${i}')"/></td>
                                            </c:if>
                                            <c:if test="${recordCount6 ne 1}">
                                            <tr>  <td></td>
                                                <td><b><c:out value="${actionBean.str[recordCount6-1]}"/>.</b></td>
                                                <td><s:textarea readonly="true" rows="5" cols="130" name="syorPentadbir${i}${recordCount6}" id="syorPentadbir${i}${recordCount6}" value="${senarai.kandungan}" /></td>
                                            </c:if>
                                            <s:hidden name="kand6${i}${recordCount6}" id="kand6${i}${recordCount6}" value="${senarai.idKandungan}" />
                                        </c:forEach>
                                    </table>
                            ...
                            <tr><td align="right">
                                    ...
                                    <s:button disabled="true" class="btn" value="Tambah" name="add" onclick="addTable6('Tables6')"/>
                                    <s:button disabled="true" class="btn" value="Hapus" name="add" onclick="deleteTable6()"/>
                        ...
                        <tr><td>
                                <table id ="dataTable7">
                                    <c:set var="k" value="1" />
                                      <c:forEach items="${actionBean.senaraiKertasKandungan7}" var="line">
                                        <tr style="font-weight:bold"><td style="display:none">${line.idKandungan}</td><td><c:out value="${line.subtajuk}"/></td>
                                            <td><font><s:textarea class="normal_text" readonly="true" name="kandungan7${k}" id="kandungan7${k}" rows="5" cols="150">${line.kandungan}</s:textarea></font>
                                            </td></tr>
                                        <s:hidden name="idKandungan7${k}" id="idKandungan7${k}" value="${line.idKandungan}" />
                                            <c:set var="k" value="${k+1}" />
                                        </c:forEach>
                        ...
                        <tr><td align="right"><s:button disabled="true" name="ulasanPengarahTanah" value="Tambah" class="btn" onclick="addRow7('dataTable7')" />
                                <s:button disabled="true" name="ulasanPengarahTanah" value="Hapus" class="btn" onclick="deleteRow7()" />
                            ...
                            <tr><td>
                                    <table  width="90%" id="table9${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiSyorPengarah[i]}" var="senarai">
                                            ...
                                            <c:if test="${recordCount9 eq 1}">
                                                <tr> <td><b>9.${i}</b></td>
                                                    <td colspan="2"><s:textarea class="normal_text" rows="5" cols="130" name="syorPengarah${i}${recordCount9}" id="syorPengarah${i}${recordCount9}" value="${senarai.kandungan}" /></td>
                                                    <td><s:hidden name="count9${i}" id="count9${i}" value="${(fn:length(actionBean.senaraiSyorPengarah[i]))}" /> </td>
                                                    <td><s:button class="btn" value="Tambah 9.${i}" name="add" id="tambah9${i}" onclick="addDynamicRow9('table9${i}','count9${i}')"/></td>
                                                    <td><s:button class="btn" value="Hapus 9.${i}" name="hapus" id="hapus9${i}" onclick="deleteDynamicRow9('table9${i}','count9${i}')"/></td>
                                            </c:if>
