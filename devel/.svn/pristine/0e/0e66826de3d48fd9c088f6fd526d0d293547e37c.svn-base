...
<script type="text/javascript">
    ...
    function openFrame2(type,idPihakPendeposit){
        doBlockUI();
        var idHakmilik = $('#idHakmilik').val();
        //        alert(idHakmilik);
        window.open("${pageContext.request.contextPath}/pelupusan/pendepositV2?openFrame&idHakmilik="
            +idHakmilik+"&type="+type+"&idPihakPendeposit="+idPihakPendeposit, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=1000,height=500,scrollbars=yes");
        //        "status=0,toolbar=0,location=0,menubar=0,width=2000,height=900,scrollbars=yes,fullscreen=yes");
    }
        ...
        <fieldset class="aras1">
            <legend>Maklumat Pendeposit
                <span style="float:right">
                    ...
                    <c:if test="${actionBean.disPendepositController.pendeposit}">
                        ...
                        <tr>
                            ...
                            <tr>
                                <c:forEach items="${actionBean.permohonanPihakPendepositList}" var="line">
                                    ...
                                    <td>
                                        <a onclick="openFrame2('papar',${line.idPermohonanPihakPendeposit});" onmouseover="this.style.cursor='pointer';"><u>${line.pihak.noPengenalan}</u> </a>
                                        <%--<s:hidden  id="kandunganSpdnUHM${i}" name="listLaporTanahSpdnU[${i-1}].laporanTanahSmpdn.hakmilik.idHakmilik" />--%>
                                    </td>
                                    <td>
                                        ${line.caraBayaran} - 
