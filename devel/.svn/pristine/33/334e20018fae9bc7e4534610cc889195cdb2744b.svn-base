            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                     <div class="content" align="left">
                        ...
                        <tr><td> &nbsp;</td></tr>
                        <tr><td align="left"><b><label><font color="black">KERTAS MESYUARAT :</font></label><s:text name="kertasBil"  size="10" style="text-align:left" id="kertasBil" class="normal_text"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b></td></tr>
                        <%--<tr>
            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                  ...
                  --%>      <tr><td align="left"><b><label><font color="black">TARIKH :</font></label><s:text name="tarikhmesyuarat" id="tarikhmesyuarat" class="datepicker" size="15" style="text-align:left" /></b></td></tr>
                    ...
                    <tr><td><b>2. LATAR BELAKANG</b></td></tr>
                    <tr><td> &nbsp;</td></tr>
                    <tr><td><b><%--<font style="text-transform:uppercase">--%> <%--</font>--%></b></td></tr>
