<%-- 
    Document   : jadualPetak
    Created on : Jul 20, 2010, 1:52:16 PM
    Author     : User
--%>

<%--
    Document   : bangunan
    Created on : Jul 20, 2010, 1:45:45 PM
    Author     : User
--%>
...
<s:form beanclass="etanah.view.strata.RMHSMaintainBangunanActionBean" name="form1">
    <s:messages/>
    <s:errors/>
    <c:if test="${edit123}">
        <div class="subtitle">
