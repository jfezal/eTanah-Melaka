 ...
 * @author ei
 */
@UrlBinding("/daftar/utiliti/kutipanDataHakmilik")
public class KutipanDataHakmilikActionBean extends AbleActionBean {
...
//  private List<HakmilikUrusan> listHakmilikUrusanNB;
  ...
  private static final Logger LOG = Logger.getLogger(KutipanDataHakmilikActionBean.class);
  SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
  SimpleDateFormat dateTimeFormat = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss aaa");
  /* JSP file name */
  private static String KUTIPAN_MAIN = "daftar/utiliti/kutipan_data_main_hakmilik.jsp";
  private static String KUTIPAN_TAB = "daftar/utiliti/kutipan_data_tab_1.jsp";
...
//      hm = hakmilikDAO.findById(idHakmilik);
      hm = kutipanDataService.findIDHakmilikbyIdhakmilikandCaw(idHakmilik, pguna.getKodCawangan().getKod());
      if (hm == null) {
...
//          listHakmilik.clear(); // clear array
  ...
  public Resolution maklumatDetail() throws ParseException {
    ...
    if (idHakmilik != null) {
      ...
      listHakmilikPihak = kutipanDataService.findListPemilik1(idHakmilik);                    // find list pemilik 
      listHakmilikAsal = kutipanDataService.findListHakmilikAsalByIdHakmilik(idHakmilik);    // find list hakmilik asal
      listHakmilikSblm = kutipanDataService.findListHakmilikSebelumByIdHakmilik(idHakmilik); // find list hakmilik sebelum
    }
    listSenaraiHakmilik = kutipanDataService.findListHakmilikByKump(kumpHm);
...
//    LOG.info(" > no Folio : " + noFolio);
  ...
  public Resolution simpanPerinci() {
    ...
    return new RedirectResolution(KutipanDataHakmilikActionBean.class, "refreshPage").addParameter("idHakmilik", idHakmilik).addParameter("kumpHm", kumpHm);
  }
...
//    return new JSP(KUTIPAN_TAB).addParameter("kumpHm", kumpHm);
    idHakmilik = null;
    return new RedirectResolution(KutipanDataHakmilikActionBean.class, "refreshPage").addParameter("kumpHm", kumpHm);
  }
...
//    selectedTab = "maklumat_urusan";
  ...
  public Resolution hapusUrusan() {
    ...
    return new RedirectResolution(KutipanDataHakmilikActionBean.class, "refreshPage").addParameter("kumpHm", kumpHm).addParameter("selectedTab", selectedTab);
  }
...
//      hpb.setWargaNegara(kodWarganegaraDAO.findById(pihak.getWargaNegara().getKod()));
  ...
  public Resolution simpanSyer() {
    ...
    return new RedirectResolution(KutipanDataHakmilikActionBean.class, "refreshPage")
  ...
  public Resolution janaDokumen() {
    ...
    return new RedirectResolution(KutipanDataHakmilikActionBean.class, "refreshPage").addParameter("idHakmilik", idHakmilik).addParameter("kumpHm", kumpHm).addParameter("selectedTab", selectedTab);
  }
