            ...
            $.get("${pageContext.request.contextPath}/daftar/check_idhakmilik?doCheckHakmilik&idHakmilik=" + val + "&kodUrusan=" + kod,
                    function(data) {
                        ...
                        if (data == '1') {
                            ...
                            $("#hakmilik" + idxHakmilik).val("");
                            alert("ID Hakmilik " + val + " ini tidak boleh dibuat Penangguhan atau Pembatalan Lelongan kerana Hakmilik ini tiada permohonan Lelongan!");
                            ...
                            // $("#collectPayment").attr("disabled", "true");
    <%--$("#hakmilik" + idxHakmilik).val("");--%>
                            alert("Versi hakmilik " + val + " adalah versi 0.Urusan BOLEH DITERUSKAN.");
                            // $("#msg" + idxHakmilik).html("<font color=red>ID Hakmilik " + val + " tidak wujud!</font>");
                            $('#Step4').removeAttr("disabled");
                        } else if (data == '2') {
                            // disable if invalid Hakmilik 
...
//                      alert('Perhatian: Hakmilik sudah mempunyai urusan Tukarganti yang masih aktif.');
                            ...
                            // $("#collectPayment").attr("disabled", "true");
                            $("#hakmilik" + idxHakmilik).val("");
                            alert("Sijil sudah dikeluarkan. Sila buat bayaran pelbagai untuk dapatkan salinan pendua Sijil Perbadanan Pengurusan dari Unit Strata PTG");
                            // $("#msg" + idxHakmilik).html("<font color=red>ID Hakmilik " + val + " tidak wujud!</font>");
                            $('#Step4').attr("disabled", "true");
...
//                } 
            ...
            $.get("${pageContext.request.contextPath}/daftar/check_kaveat?doCheckPajakan&idHakmilik=" + val,
                    function(data) {
                        if (data == '0') {
                            // nothing to do
                        } else if (data == '1') {
//                            alert("Hakmilik " + val + " Telah Tamat Pajakan");
                            //for PAT Pembangunan   13/02/2013
                            $('#Step4').removeAttr("disabled");     //FIXME
                        } else if (data != '1' || data != '0') {
                            alert("Hakmilik mempunyai Pajakan dan akan tamat pada " + data);
                            $('#Step4').removeAttr("disabled");
                        } 
                    });
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var kod = document.getElementById('kodUrusan');
        if (h.value == '' && (kod.value != "SA" && kod.value != "SB" && kod.value != "SW"
                && kod.value != "PRMP" && kod.value != "PPBB" && kod.value != "PBMMK" && kod.value != "PPRU"
                && kod.value != "PBPTD" && kod.value != "PBPTG" && kod.value != "SWDB" && kod.value != "SADB")) {
            $('#Step4').attr("disabled", "true");
        }
