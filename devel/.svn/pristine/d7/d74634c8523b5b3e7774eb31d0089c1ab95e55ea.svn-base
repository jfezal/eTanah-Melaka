<%-- 
    Document   : ulasan_mmk_pengambilan
    Created on : 01-Apr-2010, 11:38:51
    Author     : nordiyana
--%>
        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                <table border="0" width="80%">
                    ...
                    <%--<c:if test="${edit}">
                        <tr><td><b><font style="text-transform: uppercase">PERMOHONAN PENGAMBILAN TANAH DI ATAS KESELURUHAN/SEBAHAGIAN TANAH LOT ${actionBean.hakmilik.noLot},KG. GEDONG LALANG LAMA ${actionBean.hakmilik.noLot},DI ${actionBean.hakmilik.bandarPekanMukim.nama},DAERAH ${actionBean.hakmilik.daerah.nama},NEGERI SEMBILAN UNTUK TUJUAN ${actionBean.permohonan.sebab} DARIPADA ${actionBean.pemohon.pihak.nama} TERHADAP PERINTAH PENTADBIR TANAH ${actionBean.hakmilik.daerah.nama} DI BAWAH SEKSYEN 3(1)(a) AKTA PENGAMBILAN TANAH 1960.</font></b></td></tr><br>
                    </c:if>
                    <c:if test="${!edit}">
                    ...
                    <c:if test="${edit}">
                        <tr><td><b><font style="text-transform: uppercase">PERMOHONAN PENGAMBILAN TANAH DI ATAS KESELURUHAN/SEBAHAGIAN TANAH LOT
                                        <c:forEach items="${actionBean.hakmilikPermohonanList}" var="senaraiHakmilik" >
                                           ...
                                           NEGERI SEMBILAN UNTUK TUJUAN ${actionBean.permohonan.sebab} DARIPADA ${actionBean.pemohon.pihak.nama}, TERHADAP PERINTAH PENTADBIR TANAH ${actionBean.hakmilik.daerah.nama} DI BAWAH SEKSYEN 3(1)(a) AKTA PENGAMBILAN TANAH 1960.</font></b></td></tr><br>
