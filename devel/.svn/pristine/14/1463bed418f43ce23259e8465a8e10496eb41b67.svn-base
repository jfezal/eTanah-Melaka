            ...
            <c:if test="${tambahLaporan}">
                <div class="subtitle">
                    <fieldset class="aras1">
                        ...
                        <p>
                            <label>Tarikh :</label>
                            <s:text name="tarikhLaporan"  id="tarikhLaporan" class="datepicker" formatPattern="dd/MM/yyyy" />&nbsp;
                        ...
                        <div class="content" align="center">
                            <table  width="50%" id="tbl" class="tablecloth">
                                ...
                                <c:forEach items="${actionBean.senaraiKertas}" var="line">
                                    <tr style="font-weight:bold">
                                        ...
                                        <td>
                                            <s:textarea name="kandungan${i}" id="kandungan${i}"  cols="100" rows="7" class="normal_text"/>
                                        </td>
                            ...
                            <table>
                                <tr><td align="center">
                                        ...
                                        <s:button class="btn"  name="simpanTambah" onclick="if(validateForm())saveKertas(this.name,this.form);" value="Simpan"/>
                                        <%--<s:submit name="simpanTambah" id="save" value="Simpan" class="btn" onclick="if(validateForm())doSubmit(this.form, this.name, 'page_div')"/>--%>
