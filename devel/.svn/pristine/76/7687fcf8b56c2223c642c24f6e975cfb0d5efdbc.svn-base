 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/penerimaan_notis_831BC")
public class PenerimaanNotisBorang831BCActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(PenerimaanNotisBorang831BCActionBean.class);
    ...
    public Resolution showFormPP() {
        ...
        if(idPermohonan != null) {
            ...
            if(fasaPermohonan != null){
                if(fasaPermohonan.getIdAliran().equalsIgnoreCase("34RekodSampaiTampalNB") || fasaPermohonan.getIdAliran().equalsIgnoreCase("32RekodSampaiTampalDesakan")){
                    showPP = true;
                    for(HakmilikPermohonan hp : permohonan.getSenaraiHakmilik()){
        ...
        return new JSP("pengambilan/melaka/PenerimaanNotisBorang831BC.jsp").addParameter("tab", "true");
    }
...
//            }
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(PenerimaanNotisBorang831BCActionBean.class, "locate");
    }
    ...
    public Resolution processUploadDoc() {
        ...
        return new JSP("pengambilan/melaka/upload_file_831BC.jsp").addParameter("popup", "true");
    }
    ...
    public Resolution processUploadDocPemohon() {
     ...
     public Resolution popupScan() {
        ...
        return new JSP("pengambilan/melaka/scan_doc_831BC.jsp").addParameter("popup", "true");
    }
     ...
     public Resolution popupScanPemohon() {
      ...
      public Resolution reload() {
        rehydrate();
        return new JSP("pengambilan/melaka/scan_doc_831BC.jsp").addParameter("tab", "true");
    }
