        ...
        <fieldset class="aras1">
            ...
            <c:if test="${edit}">
                ...
                <p>
                    ...
                    <c:if test="${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama ne null}">Dalam &nbsp;<br>
                    <p>
                        <label>&nbsp;</label>
                        ${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama}&nbsp;
                    </p>   
                    </c:if>
                    <c:if test="${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama eq null}">Luar</c:if>
                ...
                <div class="content" align="center">
                    ...
                    <table class="tablecloth">
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="laporanTanah.namaSempadanJalanraya" class="normal_text"/>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="laporanTanah.namaSempadanKeretapi" class="normal_text"/>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="laporanTanah.namaSempadanLaut" class="normal_text"/>
                            </td>
                            <td>
                            ...
                            <td>
                                <s:text name="laporanTanah.namaSempadanSungai" class="normal_text"/>
                            </td>
                            <td>
                ...
                <p>
                    <label>Catatan :</label>
                    <s:textarea name="laporanTanah.catatanJalanMasuk" cols="50" rows="4" class="normal_text"/>
                </p>
            </c:if>
            <c:if test="${!edit}">
                <p>
                ...
                <p>
                    <label>Kawasan PBT :</label>
                    <c:if test="${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama ne null}">Dalam &nbsp;
                    ${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama}&nbsp;
                    </c:if>
                    <c:if test="${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama ne null}">Luar</c:if>
                    <%--<c:if test="${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama ne null}"> ${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama}&nbsp; </c:if>
                    <c:if test="${actionBean.permohonan.senaraiHakmilik[0].hakmilik.pbt.nama eq null}"> Tiada </c:if>--%>
                </p>
                <br>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test="${edit}">
                ...
                <%--<p id="lain">
                    <label>Catatan (jika lain-lain) :</label>
                    <s:textarea name="catatan" cols="50" class="normal_text"/>
                </p>--%>
                <p>
        ...
        <fieldset class="aras1">
            ...
            <c:if test="${edit}">
                ...
                <p>
                    ...
                    <s:text name="laporanTanah.diusaha" size="40" maxlength="100" class="normal_text"/>
                </p>
                <p>
                ...
                <p>
                    ...
                    <s:text name="laporanTanah.usahaTanam" size="40" maxlength="100" class="normal_text"/>
                </p>
                <p>
                ...
                <p>
                    ...
                    <s:text name="laporanTanah.rancanganKerajaan" size="40" maxlength="100" class="normal_text"/>
                </p>
                <div class="content" align="center">
                    Tanah Milik
                ...
                <div class="content" align="center">
                    <table class="tablecloth">
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="laporanTanah.sempadanUtaraNoLot" class="normal_text"/>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="laporanTanah.sempadanSelatanNoLot" class="normal_text"/>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:text name="laporanTanah.sempadanTimurNoLot" class="normal_text"/>
                            </td>
                            <td>
                            ...
                            <td>
                                <s:text name="laporanTanah.sempadanBaratNoLot" class="normal_text"/>
                            </td>
                            <td>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test="${edit}">
                <p>
                    <label>Ulasan :</label>
                    <s:textarea name="fasaPermohonan.ulasan" cols="150" rows="5" class="normal_text"/>

                </p>
                <p>
                    <label>&nbsp;</label>
                    <s:button name="simpanLaporanTanah" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div')"/>
                    <s:button name="lim" id="lim" value="LIM" class="btn" onclick=""/>
                </p>
            </c:if>
            <c:if test="${!edit}">
                <p>
