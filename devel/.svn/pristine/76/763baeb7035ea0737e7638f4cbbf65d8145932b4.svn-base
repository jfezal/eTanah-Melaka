<%-- 
    Document   : senarai_pihak_berkepentingan_Terdahulu
    Created on : April 14, 2011, 5:55:32 PM
    Author     : massita
--%>
...
<div class="subtitle displaytag">
    <s:messages/>
    <s:errors/>
    <s:form beanclass="etanah.view.stripes.pengambilan.PihakBerkepentinganTerdahuluActionBean">
                ...
                <div class="content" align="center">
                        <label for="Maklumat Pengambilan">Bilangan Pihak Berkepentingan :&nbsp;${actionBean.size}</label>&nbsp;
                             <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList2}" cellpadding="0" cellspacing="0" id="line"
                                           requestURI="${pageContext.request.contextPath}/pihak_berkepentingan_Terdahulu">
