...
//            channelSftp = (ChannelSftp) channel;
    ...
    void archiveRemove(String remoteFolderPath, String fileName) throws JSchException, SftpException {
        ChannelSftp channelSftp = null;
        try {
            if (isSSH) {
                channelSftp = setupJschSsh();
...
//FileDirectory = "/appl/user/home/test/";
            channelSftp.cd(remoteFolderPath);
           String a =channelSftp.pwd();
String b =channelSftp.pwd()+"/archive/";
                channelSftp.rename(a+"/"+fileName,
                        b+"/"+ fileName);
                channelSftp.cd(remoteFolderPath);
