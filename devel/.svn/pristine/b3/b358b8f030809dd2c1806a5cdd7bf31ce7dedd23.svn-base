...
<script type="text/javascript">
    ...
    <%--alert(id);--%>
            window.open("${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?showEditJabatanTeknikal&idRujukan="+id, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }

        function editJabatanTeknikal1(id){
    <%--alert(id);--%>
            window.open("${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?showEditJabatanTeknikal1&idRujukan="+id, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                <display:table class="tablecloth" name="${actionBean.senaraiRujukanLuar}" cellpadding="0" cellspacing="0" id="line"
                               requestURI="${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12">
