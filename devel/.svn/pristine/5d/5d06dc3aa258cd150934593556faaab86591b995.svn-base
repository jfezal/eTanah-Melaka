...
@UrlBinding("/pelupusan/draf_mmkn_plps")
public class DrafMMKN_PLPSActionBean extends AbleActionBean {
...
//        edit = Boolean.FALSE;
        ...
        return new JSP("pelupusan/plps/draf_mmkn_mlk.jsp").addParameter("tab", "true");
    }
...
//                + bpm + ", Daerah " + daerah + " untuk tujuan " + sbb + " .";
        ...
        if (permohonan.getKodUrusan().getKod().equals("PLPS")) {
            ...
            tujuanUrusanPlps = "menggunakan ruang udara di atas tanah " + pelUtiliti.convertStringtoInitCapOnlyOnce(hakmilikPermohonan.getKodMilik().getNama()) + " di bawah seksyen 75A Kanun Tanah Negara";
            permitItem = pelupusanService.findByIdMohonPermitItem(idPermohonan);
            sbb = permohonan.getSebab();
        } else if (permohonan.getKodUrusan().getKod().equals("LPSP")) {
            tujuanUrusanPlps = "memiliki tanah Kerajaan di bawah Seksyen 65(1) Kanun Tanah Negara secara Lesen Pendudukan Sementara";
            permitItem = pelupusanService.findByIdMohonAndIdKodPermitPermitItem(idPermohonan, "MB");
            sbb = permitItem.getKodItemPermit().getNama();
        }
        String nama = " ";
        ...
        if (pemohon.getPihak().getJenisPengenalan().getKod().equals("S")) {
            jenispengenalan = "No. Syarikat";
        }
        if ((pemohon.getPihak().getJenisPengenalan().getKod().equals("B")) && (pemohon.getPihak().getJenisPengenalan().getKod().equals("B"))) {
            jenispengenalan = "No. K/P";
        }
        ...
        tujuanPlps = " Tujuan kertas ini adalah untuk mendapatkan pertimbangan dan keputusan Majlis Mesyuarat Kerajaan Negeri " + negeri + " mengenai permohonan daripada "
                + nama + ", " + jenispengenalan + ": " + noPengenalan + " untuk " + tujuanUrusanPlps + tujuanPTLot + ", seluas " + luas + " " + koduom + ", "
                + bpm + ", Daerah " + daerah + " untuk tujuan " + sbb + " .";
...
//        perihaltanah1 = " Tanah yang dipohon adalah tanah Kerajaan yang boleh diberimilik. ";
        ...
        perihalpemohon_s = "Pemohon adalah syarikat " + pihaknama + " yang didaftarkan di Malaysia pada " + noPengenalan
                + " Nombor pendaftaranya ialah " + noPengenalan + " Senarai Ahli Lembaga Pengarah adalah seperti berikut; " + '\n' + '\n';
...
//        if(stageId.equals("sedia_draf_mmkn")){
        if (permohonan.getKodUrusan().getKod().equals("PLPS") || permohonan.getKodUrusan().getKod().equals("PPRU") || permohonan.getKodUrusan().getKod().equals("LPSP")) {
            String stageFasa = new String();
            if (kodNegeri.equals("04")) {
                stageFasa = "sedia_draf_mmkn";
            } else {
                if (permohonan.getKodUrusan().getKod().equals("PPRU")) {
                    stageFasa = "08Terima_ulasan";
                } else if (permohonan.getKodUrusan().getKod().equals("LPSP")) {
                    stageFasa = "15TrmLapSdknDrafMMK";
                } else if (permohonan.getKodUrusan().getKod().equals("PLPS")) {
                    stageFasa = "20TrmKtpsnJKTD";
                } else {
                    stageFasa = "sedia_draf_mmkn";
                }
            }
...
//            senaraiLaporanKandunganpbtanah = pelupusanService.findBySubtajuk(permohonankertas.getIdKertas(), 5);
        ...
        if (stageId.equals("sedia_draf_mmkn") || stageId.equals("sedia_draf_rencana_ptg")) {
            ...
            if (permohonan.getKodUrusan().getKod().equals("PPRU")) {
                if (stageId.equals("08Terima_ulasan")) {
                    simpanNew();
                }
                if (stageId.equals("11ATrmBuatHuraian")) {
                    no_ruj = permohonankertas.getNoLaporan();
                }
            } else if (permohonan.getKodUrusan().getKod().equals("LPSP")) {
                if (stageId.equals("15TrmLapSdknDrafMMK")) {
                    simpanNew();
                }
                ...
                if (stageId.equals("20TrmKtpsnJKTD")) {
                    simpanNew();
                }
                if (stageId.equals("24TrmDrafMMK")) {
                    no_ruj = permohonankertas.getNoLaporan();
                }
            }
        }
    ...
    public Resolution simpanNew() {
        ...
        if (permohonankertas == null) {
            ...
            if (permohonankertas != null) {
                ...
                if (StringUtils.isNotBlank(pemohon.getStatusKahwin())) {
                    if (pemohon.getStatusKahwin().equals("Berkahwin")) {
                        permohonanKertasKandungan1 = new PermohonanKertasKandungan();
                        permohonanKertasKandungan1.setKertas(permohonankertas);
                        permohonanKertasKandungan1.setBil(4);
