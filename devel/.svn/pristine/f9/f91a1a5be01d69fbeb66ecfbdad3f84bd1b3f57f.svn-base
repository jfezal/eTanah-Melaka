    ...
    <head>
        ...
        <script type="text/javascript">
                function addRow(index,f)
                {
                    ...
                    $.post('${pageContext.request.contextPath}/pelupusan/kertas_siasatan?tambahRow&index='+index,q,
                    function(data){
                        $('#page_div').html(data);
                    }, 'html');
                }
                ...
                {
                    var q = $(f).formSerialize();
                    $.post('${pageContext.request.contextPath}/pelupusan/kertas_siasatan?tambahRow1&index='+index,q,
                    function(data){
                        $('#page_div').html(data);
                    }, 'html');
                }
                ...
                function deleteRow(idKandungan,f)
                {
                    if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                         var q = $(f).formSerialize();
                        $.post('${pageContext.request.contextPath}/pelupusan/kertas_siasatan?deleteRow&idKandungan='+idKandungan,q,
                        function(data){
                            $('#page_div').html(data);
                        }, 'html');
                    }
       ...
       <fieldset class="aras1">
                <table width="100%" border="0">
                    ...
                    <tr>
                            ...
                            <td align="left"><s:button value="Hapus" class="btn" name="hapus" onclick="deleteRow(${line.idKandungan},this.form)"></s:button></td>
                    </tr>
                    ...
                    <tr>
                            ...
                            <td align="left"><s:button value="Hapus" class="btn" name="hapus" onclick="deleteRow('1')"></s:button></td>
                    </tr>
                    </c:if>
                    <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td colspan="2"> <s:button value="Tambah" class="btn" name="tambah"  onclick="addRow1('1',this.form)"></s:button>
                                        <s:button name="simpan1" id="save1" value="Simpan" class="btn" onclick="addRow('1',this.form)"></s:button></td>
                    </tr>
                    <tr>
                        <td colspan="4">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                            ...
                            <td colspan="3"><div align="left"><b style="color:#003194;font-weight:bold;font-family:Tahoma;font-size: 13px;">HASIL SIASATAN</b></div></td>
                    </tr>
