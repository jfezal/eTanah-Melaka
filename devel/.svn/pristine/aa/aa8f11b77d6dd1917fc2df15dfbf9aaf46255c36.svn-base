...
//------------------------------------------//
@UrlBinding("/pengambilan/aduan_kerosakan/semak/maklumat_hakmilikpengambilan")
...
//    private BigDecimal totalLuas;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/aduan_kerosakan/semak/maklumat_hakmilik_pengambilan.jsp").addParameter("tab", "true");
    }
