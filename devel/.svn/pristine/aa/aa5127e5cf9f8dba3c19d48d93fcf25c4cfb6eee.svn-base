...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        function showbmbtsokong(val) {
            $('#bmbtsokong').show();
            $('#bmbttidaksokong').hide();
            setKpsn2(val);
        }
    
        function showbmbttidaksokong(val) {
            $('#bmbttidaksokong').show();
            $('#bmbtsokong').hide();
            setKpsn2(val);
        }
        ...
        {   
            ...
            var url = '${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?tambahRow&index='+index+'&kodksn='+kodksn;
            window.open(url, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
        ...
        {   
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?deleteRow',{idKandungan:idKandungan,tName:tName,typeName:'PPT'},
                function(data){
                    $('#page_div').html(data);
        ...
        function cariPopup(val){
            NoPrompt();
            window.open("${pageContext.request.contextPath}/penguatkuasaan/laporan_tanahV2?searchSyarat&jenisSyarat="+val, "eTanah",
                            ...
                            <c:choose>
                                ...
                                <c:when test="${actionBean.permohonan.kodUrusan.kod eq '49'}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <s:radio name="laporanTanah.adaKes" id="ksn" value="T" onclick="showbmbttidaksokong(this.value);" />&nbsp;Tiada Maraan                                             
                                            <s:hidden name="syorKpsn" id="syorKpsn"/>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <s:text name="laporanTanah.perengganLuasSebelum"/>
                                ...
                                <c:when test="${actionBean.permohonan.kodUrusan.kod eq '352'}">
                                    ...
                                    <tr>
                                        ...
                                        <td><s:text name="laporanTanah.tempohDitinggalkan" maxlength="6" onkeyup="validateNumber(this,this.value);"/>&nbsp;tahun</td>
                                    </tr>
                                </c:when>
