...
<html>
        ...
        <script type="text/javascript">
            ...
            function removeDok(val,val2){
                if(confirm('Adakah anda pasti?')) {
                    var url = '${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?deleteDok&idDokumen='+val+'&idRujukan='+val2;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
                    },'html');
            ...
            function addDokumen(val){
                ...
                var url = '${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?simpanDokumen'+param +'&idRujukan='+val;
           ...
           function reload(v)
    {
        ...
        var url = "${pageContext.request.contextPath}/penguatkuasaan/jabatan_teknikal12?addDokumen&idRujukan="+v;
        frm.action = url;
        frm.submit();
    ...
    <body>
        ...
        <s:messages/>
        <div class="subtitle">
            <s:form beanclass="etanah.view.penguatkuasaan.JabatanTeknikalActionBean" name="form1">
