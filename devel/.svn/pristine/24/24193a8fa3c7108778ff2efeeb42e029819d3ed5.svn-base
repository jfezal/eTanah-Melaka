...
@UrlBinding("/pengambilan/suratBayaranPampasan")
public class JanaSuratBayaranPampasanActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(JanaSuratBayaranPampasanActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/negerisembilan/haklalulalangpersendirian/janaSuratBayaranPampasan.jsp").addParameter("tab", "true");
    }
}
