    ...
    <fieldset class="aras1">
        ...
        <p>
            ...
            <s:select name="idperpb" id="idperpb">
                    ...
                    <s:options-collection collection="${actionBean.listBorangPerPB}" label="nama" value="id"/>
                </s:select>
        </p>
    ...
    <fieldset class="aras1">
        ...
        <p align="center">
            <display:table class="tablecloth" name="${actionBean.listAmbilPampasan}" pagesize="30" cellpadding="0" cellspacing="0"
                ...
                <display:column title="Nama Penerima"  value="${line.borangPerPb.nama}"/>
                <display:column title="Amaun Pampasan" >${line.jumTerimaPampasan}</display:column>
                <display:column title="Tarikh Terima" >${line.jumTerimaPampasan}</display:column>
