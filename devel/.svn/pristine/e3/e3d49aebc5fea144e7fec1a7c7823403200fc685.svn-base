...
@UrlBinding("/pengambilan/MaklumKeputusan")
public class MaklumKeputusanMMKNActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(MaklumKeputusanMMKNActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/maklumanKeputusanMMKN.jsp").addParameter("tab", "true");
    }
}
