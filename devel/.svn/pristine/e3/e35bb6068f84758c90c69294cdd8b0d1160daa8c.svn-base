 ...
 * @author nursyazwani
 */
public class CheckKeputusanPSMTNotification implements StageListener {
    @Inject
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        if(context.getPermohonan().getKeputusan()!=null){
            proposedOutcome = context.getPermohonan().getKeputusan().getKod();
        }
