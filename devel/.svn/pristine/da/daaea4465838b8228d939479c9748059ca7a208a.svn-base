<%-- 
    Document   : penyediaan_notis_2a
    Created on : Jan 20, 2010, 5:53:08 PM
...
<s:form beanclass="etanah.view.pelupusan.PelupusanActionBean">
    ...
    <p>
        <label>&nbsp;</label>
        <s:submit name="" value="Sedia Notis 2A" class="btn"/>
