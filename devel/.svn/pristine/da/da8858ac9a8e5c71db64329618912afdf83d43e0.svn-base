...
@UrlBinding("/pelupusan/maklumat_pemohon1_mlcrg")
public class MaklumatPemohon1MLCRGActionBean extends AbleActionBean {
    ...
    private Date tarik;
    private Long hbgn;
    private static final Logger LOG = Logger.getLogger(MaklumatPemohon1MLCRGActionBean.class);
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/maklumat_pemohon1_mlcrg.jsp").addParameter("tab", "true");
    }
...
//                    pbList = hakmilikPihakBerkepentinganDAO.findByEqualCriterias(tname, model, null);
    ...
    public Resolution refreshMaklumatPemohon() {
        rehydrate();
        return new RedirectResolution(MaklumatPemohon1MLCRGActionBean.class, "locate");
    }
...
//            pemohonHubunganTemp.setKaitan(pemohonHbgn.getKaitan());
    ...
    public Resolution simpanEditPemohon() {
        ...
        if (pihakTemp.getJenisPengenalan().getKod().equals("B") || pihakTemp.getJenisPengenalan().getKod().equals("L") || pihakTemp.getJenisPengenalan().getKod().equals("T") || pihakTemp.getJenisPengenalan().getKod().equals("I")) {
            if (pemohon.getPekerjaan().equalsIgnoreCase("TIDAK BEKERJA") || pemohon.getPekerjaan() == null) {
