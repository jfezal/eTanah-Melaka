 ...
 * @author nordiyana
 */
@UrlBinding("/pengambilan/maklumat_asas_pengambilanTerdahulu")
public class maklumatasas_pengambilanTerdahulu extends AbleActionBean {
    private static final Logger logger = Logger.getLogger(maklumatasas_pengambilanTerdahulu.class);
    @Inject
...
//    String tarikhDaftar;
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/negerisembilan/penarikanbalik/maklumat_asas_tanah_pengambilanTerdahulu.jsp").addParameter("tab", "true");
    }
...
//            h.setSyaratNyata(hakmilik.getSyaratNyata());
        ...
        return new RedirectResolution(maklumatasas_pengambilanTerdahulu.class).addParameter("tab", "true");
