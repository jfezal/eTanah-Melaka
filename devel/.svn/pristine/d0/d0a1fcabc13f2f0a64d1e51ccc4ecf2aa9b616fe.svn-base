<%--
    ...
    Author     :  Shazwan @modified hazirah
--%>
                ...
                <div id="perihaltanah">
                    ...
                    <div class="content" align="center">
                        <table class="tablecloth" border="0">
                            ...
                            <tr id="jenisTanah">
                                ...
                                <td>
                                    ...
                                    <%--  <c:when test="${!empty actionBean.disLaporanTanahSempadan.statusSempadan}">
                                          ...
                                          <s:checkbox id="idHakmilikChecked" name="idHakmilikChecked" value="hakmilik" onclick="openHakmilik(this)" checked="true" />&nbsp;ID Hakmilik
                                      </c:when>    
                                      <c:otherwise>
                            ...
                            <tr>
                                <td>Jarak Dari Tanah Diambil :</td>
                                <td>
                                    <c:if test="${empty actionBean.disLaporanTanahSempadan.jarakDariTanah}">
                                        <s:text name="disLaporanTanahSempadan.jarakDariTanah" id="jarakDariTanah" formatPattern="#,###,##0.0000" maxlength="15" value="0" onkeyup="validateNumber(this,this.value);"></s:text>
