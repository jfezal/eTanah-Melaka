...
<script type="text/javascript">    
    ...
    function muatNaikForm1(folderId, dokumenId, idPermohonan) {
        ...
        var url = '${pageContext.request.contextPath}/strata/SemakKertasSiasatanFoliD?muatNaikForm1&folderId=' + folderId + '&dokumenId='
    ...
    <%--alert(url);--%>
        ...
        function addNew(v){
            window.open("${pageContext.request.contextPath}/strata/SemakKertasSiasatanFoliD?addDocForm&permohonan.idPermohonan=" + v, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=1500,height=800");
        }
        
        function kemaskiniCatatan(folderId, dokumenId){        
            var url = '${pageContext.request.contextPath}/strata/SemakKertasSiasatanFoliD?showCatatanEdit&folderId=' + folderId + '&dokumenId='
                + dokumenId;
...
<s:form beanclass="etanah.view.strata.SenaraiKertasSiasatanFoliDActionBean" name="form1" id="form1">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <display:table name="${actionBean.senaraiKandungan1}" class="tablecloth" id="row" style="width:100%">
                ...
                <display:column title="No.Folio"> Folio D${row_rowNum} </display:column>
