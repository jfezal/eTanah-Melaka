 ...
 * @author afham
 */
@UrlBinding("/pelupusan/surat_hakmilik_MCL_sementara")
public class PenyediaanSuratHakMilikSementaraMCL_ActionBean extends AbleActionBean {
    ...
    public Resolution showForm(){
        return new JSP ("pelupusan/surat_hakmilik_sementara_MCL.jsp").addParameter("tab", "true") ;
    }
