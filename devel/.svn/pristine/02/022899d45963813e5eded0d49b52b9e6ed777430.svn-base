...
//           $('.idHakmilikAsal').each(function(index){
//            $(this).blur(function(){
...
<s:form name="form1" beanclass="etanah.view.stripes.nota.pembetulanActionBean">
    ...
    <div class="subtitle">
        ...
        <fieldset class="aras1">
            ...
            <p style="color:red">
                *Isi ID Hakmilik Asal kemudian tekan butang simpan.<br/>
            ...
            <div class="content" align="center" id="tanahMilik">
                <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}"  cellpadding="0" cellspacing="0" id="line">
                  ...
                  <display:column title="ID Hakmilik Asal">
                        <s:text name="idHakmilikAsal" id="hakmilik${line_rowNum}" class="idHakmilikAsal"/>
