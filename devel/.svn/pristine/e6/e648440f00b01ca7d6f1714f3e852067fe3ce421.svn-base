<%--
    Document   : Upload_imej_Laporan_Tanah_Pelupusan_ns
    Created on : July 03, 2011, 5:47:08 PM
    Author     : Akmal
--%>
...
<img id="displayBox" src="${pageContext.request.contextPath}/pub/images/logo.gif" width="50" height="50" style="display: none"/>
    ...
    <fieldset class="aras1">
        ...
        <p>
            ...
            <%--<s:button name="close" value="Tutup" onclick="self.close();" class="btn"/>--%>
            <%--<s:submit name="simpanImejLaporan" value="Simpan" class="btn" onclick="save1(this.name, this.form);"/>--%>
            <s:submit name="simpanImejLaporan1" value="Simpan" class="btn"/>
            <%--<s:button name="close" value="Tutup" onclick="test();" class="btn"/>--%>
            <s:button name="close" value="Tutup" class="btn" onclick="refreshlptn();"/>
        </p>
    </fieldset>
</s:form>
