 ...
 * @author nordiyana
 */
@UrlBinding("/pengambilanmodule")
public class PengambilanActionBean extends AbleActionBean {
    ...
    public Resolution showForm2() {
        return new JSP("pengambilan/paparan_maklumat_permohonan.jsp").addParameter("tab", "true");
    }
