...
<s:form beanclass="etanah.view.stripes.pembangunan.KertasPertimbanganPTG2ActionBean">
    <s:messages/>
    <s:errors/>
        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                <table border="0" width="80%" cellspacing="10">
                    ...
                    <tr><td align="center"><b>KERTAS UNTUK PERTIMBANGAN PENGARAH TANAH DAN GALIAN </b></td></tr>
                    <%--<c:if test="${edit}">
                    ...
                    <tr><td>
                            <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" cellpadding="0" cellspacing="0" id="tbl1">
                                ...
                                <display:column title="Kategori Kegunaan Tanah" style="vertical-align:baseline">
                                ...
                                <display:column title="Cukai Tanah" style="vertical-align:baseline">
                    ...
                    <c:if test="${actionBean.peng.kodCawangan.kod ne '00'}">
                        <c:set var="i" value="4"/>
                        <c:set var="i" value="${i+1}"/>
                        <tr><td><b><font style="text-transform: uppercase">${i}.HURAIAN TIMBALAN / PENOLONG PENGARAH TANAH DAN GALIAN  ${actionBean.pejTanah}&nbsp;</font></b></td></tr>
                        <c:if test="${!edit}">
                        ...
                        <c:set var="i" value="5"/>
                        <c:set var="i" value="${i+1}"/>
                        <tr><td><b><font style="text-transform: uppercase">${i}. SYOR TIMBALAN / PENOLONG PENGARAH TANAH DAN GALIAN ${actionBean.pejTanah}&nbsp;</font></b></td></tr>
