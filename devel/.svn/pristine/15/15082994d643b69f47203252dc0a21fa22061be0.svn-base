 ...
 * @author Afham
 */
@UrlBinding("/pelupusan/laporanNilaianBMBT")
public class LaporanNilaianBMBTActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(LaporanNilaianBMBTActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/bmbt/laporan_nilaian_BMBT.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        List<KodUrusanAgensi> listKUA = new ArrayList<KodUrusanAgensi>();
        listKUA = pelupusanService.findKodUrusanAgensiByKodUrusan(permohonan.getKodUrusan().getKod());
        String stringAgensi = new String();
        for (KodUrusanAgensi kua : listKUA) {
            stringAgensi = kua.getKodAgensi().getKod();
        }
    ...
    public Resolution searchHakmilik() throws ParseException {
        ...
        hakmilikPermohonan = hakmilikPermohonanDAO.findById(new Long(idhakmilikpermohonan));
        rehydrate();
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/bmbt/laporan_nilaian_BMBT.jsp").addParameter("tab", "true");
    }
