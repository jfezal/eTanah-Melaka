...
@UrlBinding("/uam/new_update")
public class NewAndUpdateActionBean extends AbleActionBean {
  ...
  private  FileBean imejtt;
    ...
    public Resolution showForm() {
        ...
        findKodNegeri();
        return new JSP("uam/newAndUpdateUser.jsp");
    }
...
//                       byte[] bytes = IOUtils.toByteArray(imejtt.getInputStream());
//                        pguna.setTandatangan(bytes);
//                        service.savePengguna( pguna);
        ...
        return new ForwardResolution(
                "/WEB-INF/jsp/uam/newAndUpdateUser.jsp");
    }
...
//                getContext().getRequest().setAttribute("id", Boolean.FALSE);
                getContext().getRequest().setAttribute("kataLaluan", Boolean.FALSE);
                addSimpleError("Pengguna telah wujud. Sila pilih id pengguna lain.");
...
//                }
    ...
    public FileBean getImejtt() {
        return imejtt;
    }

    public void setImejtt(FileBean imejtt) {
        this.imejtt = imejtt;
    }
