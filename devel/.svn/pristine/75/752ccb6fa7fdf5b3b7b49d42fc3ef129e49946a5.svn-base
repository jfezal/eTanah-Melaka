        ...
        <c:if test="${actionBean.permohonan.kodUrusan.kod ne 'KVAT'
            ...
            <fieldset class="aras1">
                                    ...
                                    <display:column title="Kemaskini">
                                        <p align="center">
                                            <img alt='Klik Untuk Kemaskini' border='0' src='${pageContext.request.contextPath}/images/edit.gif'
                                                 onclick="doEdit('${line1.idAtasPihak}', 'pemohon','${line1.pihakBerkepentingan.pihak.idPihak}');return false;" onmouseover="this.style.cursor='pointer';">
                                        </p>
                                    </display:column>
                                </c:if>
                ...
                <c:if test="${edit && (fn:length(actionBean.senaraiPemohon) > 0 || fn:length(actionBean.senaraiPermohonanAtasPihak) > 0)}">
                    <p align="center">
                        <label></label>
                        <s:button name="delete" onclick="remove(this.name, 'remove', 'pemohon', 'rm');" value="Hapus" class="btn"/>
                    </p>
                </c:if>
            </fieldset>
        </c:if>
            ...
            <c:if test="${edit}">
                ...
                <p align="center">
                    ...
                    <c:if test="${fn:length(actionBean.senaraiPermohonanPihak) > 0}">                       
                        ...
                        <s:button name="delete" onclick="remove(this.name, 'remove', 'penerima', 'rm_mp');" value="Hapus" class="btn"/>&nbsp;
                    </c:if>
