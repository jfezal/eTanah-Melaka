 ...
 * @author mohd.faidzal
 */
public class HantarPermohonanUkurValidator implements StageListener{
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        PermohonanPengambilan m = pengambilanAPTService.findPermohonanPengambilanByIdMH(context.getPermohonan().getIdPermohonan());
            ...
            sek8aIntegrationFlowService.completeTask(ref.SEMAK_PA, context.getPermohonan(), context.getPengguna());
