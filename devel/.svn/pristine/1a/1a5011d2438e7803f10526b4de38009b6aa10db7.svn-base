...
<script language="javascript" type="text/javascript">
    ...
    <%--document.form2.rowCount1.value=rowCount1 +1;--%>
        ...
        function deleteRow1(s)
        {
            ...
            if (idKandungan != null) {
                var url = '${pageContext.request.contextPath}/pengambilan/mmkn_etapp?deleteSingle2&idKandungan='
                        + idKandungan;
...
//        document.form2.rowCount1.value = i -1;
    ...
    <%--document.form2.rowCount6.value = 1;--%>
            ...
            var cell2 = row.insertCell(0);
            cell2.innerHTML = "<b>" + "6.1." + (rowCount6 + 1) + "</b>";
...
<s:form beanclass="etanah.view.stripes.pengambilan.MMKNeTappActionBean"  id="form2">
    <s:messages/>
    <s:errors/>
                    ...
                    <table border="0" width="80%">
                        ...
                        <tr><td><b> TAJUK : <b></td></tr>
                                        ...
                                        <tr><td align="right"><s:button name="perihalPemohon"  value="Tambah" class="btn" onclick="addRow3('dataTable3')" />
                                                <s:button name="perihalPemohon" value="Hapus"  class="btn" onclick="deleteRow3('dataTable3')" />
                                        ...
                                        <tr><td> &nbsp;</td></tr>
                                        <tr><td> &nbsp;</td></tr>
                                        <tr><td><b><font <%--style="text-transform:uppercase"--%>>6. PERAKUAN PENTADBIR TANAH</font></b></td></tr>
                                        <tr><td>                       
                                                <table >
                                                    ...
                                                    <tr style="font-weight:bold"><td style="display:none">${actionBean.perakuanPT21.idKandungan}</td><td><c:out value="${actionBean.perakuanPT21.subtajuk}"/></td>
                                                        <td><font><s:textarea name="akuanpt" id="akuanpt" rows="5" cols="150" class="normal_text">${actionBean.akuanpt}</s:textarea></font></td>
                                                        </tr>
                                        ...
                                        <tr><td align="right">
                                                ...
                                                <s:button name="perakuanPentadbir" value="Hapus" class="btn" onclick="deleteRow6('dataTable6')" />
                                        <tr><td> &nbsp;</td></tr>
