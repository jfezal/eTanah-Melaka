 ...
 * @author Rohan
 */
@UrlBinding("/pelupusan/borang_5A_Mlk")
public class Borang5AMlkActionBean  extends AbleActionBean {
private static final Logger LOG = Logger.getLogger(Borang5AMlkActionBean.class);
    @Inject
    ...
    public Resolution showForm(){
        return new JSP("pelupusan/borang_5A_Mlk.jsp").addParameter("tab", "true");
    }
