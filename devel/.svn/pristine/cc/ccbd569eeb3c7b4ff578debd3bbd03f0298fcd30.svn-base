 ...
 * @author nordiyana
 */
@UrlBinding("/pengambilan/deposit")
public class DepositActionBean extends AbleActionBean {
    ...
    List<PermohonanTuntutanKos> senaraiDeposit2;
    private String kod = "11304";
    private String kod2 = "11304";
    private String kodTuntut50 = "ACQD50";
    private String simpan = "false";
    private String kodTuntut75 = "ACQD75";
...
//        idHakmilik = (String) getContext().getRequest().getParameter("idHakmilik");
        if (idPermohonan != null) {
            ...
            System.out.println("permohonan " + p.getIdPermohonan());
            senaraiDeposit = service.findByIDMohonTuntut(idPermohonan, kod);
            System.out.println("senarai deposit " + senaraiDeposit.size());
...
//            hakmilikPermohonanList = p.getSenaraiHakmilik();
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(DepositActionBean.class, "locate");
    }
...
//        amaun75=nilaitanah.multiply(getKira2());
        ...
        if (idPermohonan != null) {
            ...
            senaraiDeposit2 = service.findByIDMohonTuntutKod(idPermohonan, kodTuntut50);
            if (senaraiDeposit2.size() == 0) {
                ...
                KodTransaksi kodTransaksi = service.findKodTransaksibyKod(kod);//kodTransaksiDAO.findById(kod);
                mohontuntut.setKodTransaksi(kodTransaksi);
                KodTuntut kodTuntut = service.findKodTuntutbyKod(kodTuntut50);
                mohontuntut.setKodTuntut(kodTuntut);
...
//            serviceMohon.saveOrUpdateMohonTuntut(mohontuntut);
                ...
                mohontuntut = service.findByIDMohonTuntutKod2(idPermohonan, kodTuntut50);
                mohontuntut.setCawangan(cawangan);
                KodTransaksi kodTransaksi = service.findKodTransaksibyKod(kod);//kodTransaksiDAO.findById(kod);
                mohontuntut.setKodTransaksi(kodTransaksi);
                KodTuntut kodTuntut = service.findKodTuntutbyKod(kodTuntut50);
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/AkaunDeposit.jsp").addParameter("tab", "true");
    }
    ...
    public Resolution simpanDepositKedua() {
        ...
        if (idPermohonan != null) {
            senaraiDeposit2 = service.findByIDMohonTuntutKod(idPermohonan, kodTuntut75);
            if (senaraiDeposit2.size() == 0) {
                mohontuntut = new PermohonanTuntutanKos();
                InfoAudit info = peng.getInfoAudit();
                info.setDimasukOleh(peng);
                ...
                mohontuntut.setPermohonan(permohonan);
                mohontuntut.setCawangan(cawangan);
                // KodTransaksi kodTransaksi = kodTransaksiDAO.findById(kod2);
                KodTransaksi kodTransaksi = service.findKodTransaksibyKod(kod2);
                mohontuntut.setKodTransaksi(kodTransaksi);
                KodTuntut kodTuntut = service.findKodTuntutbyKod(kodTuntut75);
                mohontuntut.setKodTuntut(kodTuntut);
...
//            serviceMohon.saveOrUpdateMohonTuntut(mohontuntut);
                ...
                mohontuntut = service.findByIDMohonTuntutKod2(idPermohonan, kodTuntut75);
                KodTransaksi kodTransaksi = service.findKodTransaksibyKod(kod2);
                mohontuntut.setKodTransaksi(kodTransaksi);
                KodTuntut kodTuntut = service.findKodTuntutbyKod(kodTuntut75);
                mohontuntut.setKodTuntut(kodTuntut);
