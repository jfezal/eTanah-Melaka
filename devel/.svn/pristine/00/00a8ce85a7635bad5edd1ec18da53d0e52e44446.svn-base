 ...
 * @author haqqiem
 */
@UrlBinding("/hasil/batal_endorsan")
public class PenyediaanPembatalanEndorsanActionbean extends AbleActionBean {
   private static final Logger LOG = Logger.getLogger(PenyediaanPembatalanEndorsanActionbean.class);
