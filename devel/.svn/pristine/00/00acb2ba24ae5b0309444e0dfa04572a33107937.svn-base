 ...
 */
@UrlBinding("/consent/ulasan_tanah_ladang_melaka")
public class UlasanTanahLadangMelakaActionBean extends AbleActionBean {
    ...
    public Resolution showFormUlasan() {
        ...
        return new JSP("consent/ulasan_tanah_ladang_melaka.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (!(permohonan.getSenaraiPihak().isEmpty()) && !(permohonan.getSenaraiPemohon().isEmpty()) && !(permohonan.getSenaraiHakmilik().isEmpty())) {
            ...
            permohonanKertasTemp = conService.findMohonKertas(idPermohonan);
            ...
            if (permohonanKertasTemp == null) {
                ...
                if (permohonanUrusan != null) {
                    ...
                    tujuan = "Tujuan kertas ini adalah untuk mendapatkan pertimbangan Lembaga Tanah Ladang mengenai " + permohonanUrusan.getCatatan() + " untuk kelulusan Lembaga Tanah Ladang Negeri Melaka.";
                    keputusan = "Lembaga Tanah Ladang diminta untuk menimbangkan permohonan ini.";
                }
                simpanFirst();
    ...
    public Resolution simpan() {
        ...
        if (permohonanKertasTemp.getNomborRujukan() == null) {
            addSimpleError("Sila Masukkan Nombor Kertas");
        ...
        return new ForwardResolution("/WEB-INF/jsp/consent/ulasan_tanah_ladang_melaka.jsp").addParameter("tab", "true");
    }
