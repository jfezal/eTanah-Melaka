...
//                var idHakmilik = $('#idHakmilik').val();
    ...
    <c:choose>
        ...
        function refreshpage2(type, pandanganImej, idLapor, idlaporTnhSmpdn, idMohonHakmilik, idImej, idDokumen) {
            var url = '${pageContext.request.contextPath}/common/laporan/tanah/laporantanahNewActionBean?refreshpageTnhSmpdn&type=' + type + '&pandanganImej=' + pandanganImej + '&idLapor=' + idLapor + '&idlaporTnhSmpdn=' + idlaporTnhSmpdn + '&idMohonHakmilik=' + idMohonHakmilik+ '&idImej=' + idImej + '&idDokumen=' + idDokumen;
        ...
        function deleteImage(idMohonHakmilik, idImej, idDokumen, type, f) {
            ...
            if (confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}}/common/laporan/tanah/laporantanahNewActionBean?deleteImage&idImej=' + idImej + '&idDokumen=' + idDokumen + '&type=' + type + '&imageType=' + imageType + '&idLapor=' + idLapor + '&idlaporTnhSmpdn=' + idlaporTnhSmpdn, q,
                        function(data) {
                            $('#page_div').html(data);
