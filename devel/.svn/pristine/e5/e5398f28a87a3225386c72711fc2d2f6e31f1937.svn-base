        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                <table border="0" width="20%" align="center">
                    <tr>
                        <td><b><font color="#003194">MAKLUMAT PERMINTAAN UKUR </font></b></td>
                    </tr>
                </table>
                <br><br>
                <c:if test="${actionBean.edit1}">
                    ...
                    <table border="0" width="55%" cellspacing="10">
                        ...
                        <tr>
                            ...
                            <td id="tdLabel"><b> : </b></td>
                            <td><s:text name="permohonanUkur.noRujukanPejabatUkur" size="30" id="rujukan" disabled="disabled"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td id="tdLabel"><b> : </b></td>
                            <td id="tdLabel">   <s:text name="permohonanUkur.jumlahPengecualian"  formatPattern="#,#00.00" onkeyup="validateNumber(this,this.value);" size="15"/>
                        ...
                        <tr>
                            ...
                            <td id="tdLabel"><b> : </b></td>
                            <td><s:text name="permohonanUkur.noResit" size="30"/></td>
                        </tr>
                        <tr>
                ...
                <c:if test="${actionBean.view}">
                    ...
                    <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PBHL'}">
                        <s:button name="simpan" id="save" value="Semak PU" class="longbtn" onclick="SemakPU('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
                        <s:button name="simpan" id="save" value="Sah PU" class="longbtn" onclick="SahPU('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;
                    </c:if>
                        
                    <%--<s:button name="simpan" id="save" value="Semak PU" class="longbtn" onclick="SemakPU('${actionBean.pguna.idPengguna}','${actionBean.pguna.nama}','${actionBean.pguna.jawatan}','${actionBean.idPermohonan}','${actionBean.stageId}');"/>&nbsp;--%>
                </c:if>

                <c:if test="${actionBean.viewSah}">
                    <table border="0" width="55%" cellspacing="10">
                        <tr>
                            <td id="tdLabel" width="45%"><b>Rujukan Pejabat Tanah </b></td>
                            <td id="tdLabel"><b> : </b></td>
