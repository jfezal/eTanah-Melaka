 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/penerimaan_notis_borang_n9")
public class PenerimaanNotisBorangN9ActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(PenerimaanNotisBorangN9ActionBean.class);
...
//            fasaPermohonan = notisPenerimaanService.getFasaPermohonan(idPermohonan, "24SediaSuratKeputusan");
            fasaPermohonan = notisPenerimaanService.getFasaPermohonan(idPermohonan, "14KeputusanBicara");
...
//                if(fasaPermohonan.getIdAliran().equalsIgnoreCase("24SediaSuratKeputusan")){
                        if(fasaPermohonan.getIdAliran().equalsIgnoreCase("14KeputusanBicara")){
                    showPP = true;
                    for(HakmilikPermohonan hp : permohonan.getSenaraiHakmilik()){
        ...
        return new JSP("pengambilan/negerisembilan/Penerimaan_Notis_Borang.jsp").addParameter("tab", "true");
    }
...
//                if(fasaPermohonan.getIdAliran().equalsIgnoreCase("24SediaSuratKeputusan")){
                    ...
                    notisPemohonQ = notisPenerimaanService.getNotisByidMPkodNotis(idPermohonan, permohonanPihak.getIdPermohonanPihak(), "NBQ");
...
//            if(fasaPermohonan.getIdAliran().equalsIgnoreCase("24SediaSuratKeputusan")){
            if(fasaPermohonan.getIdAliran().equalsIgnoreCase("14KeputusanBicara")){
                dokumenASB = notisPenerimaanService.getDokumenBykod(idPermohonan, "KMD");
                if(dokumenASB != null ){
                    ...
                    for(Pemohon pemohon : permohonan.getSenaraiPemohon()){
                        ...
                        if(permohonanPihak != null){
                            Notis notisPemohonASB = notisPenerimaanService.getNotisByidMPkodNotis(idPermohonan, permohonanPihak.getIdPermohonanPihak(), "KMD");
                            if(notisPemohonASB == null){
                                Notis notis1 = new Notis();
                                notis1.setInfoAudit(info);
                                notis1.setPermohonan(permohonan);
                ...
                if(dokumenQ != null ){
                    ...
                    for(Pemohon pemohon : permohonan.getSenaraiPemohon()){
                        ...
                        if(permohonanPihak != null){
                            Notis notisPemohonASB = notisPenerimaanService.getNotisByidMPkodNotis(idPermohonan, permohonanPihak.getIdPermohonanPihak(), "NBQ");
                            if(notisPemohonASB == null){
                                Notis notis1 = new Notis();
                                notis1.setInfoAudit(info);
                                notis1.setPermohonan(permohonan);
                                notis1.setTarikhNotis(new java.util.Date());
                                notis1.setKodNotis(kodNotisDAO.findById("NBQ"));
                                notis1.setPihak(permohonanPihak);
...
//        if(fasaPermohonan.getIdAliran().equalsIgnoreCase("24SediaSuratKeputusan")){
        ...
        String DMS_PATH = null;
        String fname = null;
        if(fasaPermohonan.getIdAliran().equalsIgnoreCase("14KeputusanBicara") || fasaPermohonan.getIdAliran().equalsIgnoreCase("15DrafSuratBayar")){
        ...
        try {
            if (p != null && fname != null && fileToBeUploaded != null) {
                ...
                Long idDoc = lelongService.simpanOrUpdateDokumen(doc);
                LOG.info("idDoc :" + idDoc);
                // update at DasarTuntutanNotis //24SediaSuratKeputusan replace with 14KeputusanBicara
                if(fasaPermohonan.getIdAliran().equalsIgnoreCase("14KeputusanBicara") || fasaPermohonan.getIdAliran().equalsIgnoreCase("15DrafSuratBayar")){
