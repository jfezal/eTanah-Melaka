...
<script type="text/javascript">
    ...
    function selectRadioBox()
    {
        ...
        if(confirm("Adakah anda pasti?")) {
            var url = '${pageContext.request.contextPath}/pelupusan/maklumat_pemohonV2?simpanPemilik&idPihak='+data ;
            $.get(url,
            function(data){
                $('#page_div').html(data);
    ...
    function openFrame(type){
        NoPrompt();
        var url = '${pageContext.request.contextPath}/pelupusan/maklumat_pemohonV2?openFrame&type='+type;
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pelupusan.MaklumatPemohonV2ActionBean" name="frm">
            ...
            <fieldset class="aras1">
                <div id="maklumatborang" align="center">
                    ...
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.senaraiTuanTanah}" cellpadding="0" cellspacing="0" requestURI="/pelupusan/pihak_kepentingan" id="line">
                         <%--<s:radio name="radiomate" id="radiomate"--%>
                        <display:column> <s:checkbox name="checkmate" id="checkmate" value="${line.pihak.idPihak}"/></display:column>
                    ...
                    <c:if test="${fn:length(actionBean.senaraiTuanTanah) > 0 }">
                        ...
                        <s:button class="btn" value="Kembali" name="kembali" id="kembali" onclick="openFrame('tPemohon')"/>
                    </c:if>
                </div>
            </fieldset>
        </div>
