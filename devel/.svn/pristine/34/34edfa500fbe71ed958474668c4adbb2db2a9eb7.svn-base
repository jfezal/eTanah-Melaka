...
<script type="text/javascript">
    ...
    function refreshpage(){
        //        alert('aa');
        NoPrompt();
        opener.refreshRekodKeputusan('main');
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pengambilan.RekodKeputusanActionBean" name="form">
        <s:errors/>
        <s:messages/>
                    ...
                    <div class="content" align="center">
                        <table class="tablecloth" border="0">
                            ...
                            <tr>
                                ...
                                <td><s:text name="permohonanKertas.tempatSidang"/>&nbsp;</td>
                            </tr>
                            <tr>
