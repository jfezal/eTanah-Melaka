                    ...
                    <div class="content" align="center">
                        <table class="tablecloth" border="0">
                            ...
                            <tr id="lain">
                                ...
                                <td>
                                    <s:text name="laporanTanah.strukturTambahanKedudukan" id="strukturTambahanKedudukan"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <s:checkbox name="laporanTanah.syor" value="Y" id="ulasan"/>
                                </td>
                            </tr>
                            <tr id="catatan">
                                <td>
                                ...
                                <td>
                                    <s:textarea name="laporanTanah.ulasan" rows="5" cols="50"/>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr id="luasTanam">
                                ...
                                <td>
                                    ...
                                    <s:select name="usahaLuasUom" id="usahaLuasUom" >
                                        <s:option value="0">--Sila Pilih--</s:option>
