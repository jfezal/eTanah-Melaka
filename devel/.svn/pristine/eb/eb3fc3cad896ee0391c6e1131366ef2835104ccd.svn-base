<%-- 
    Document   : kpsn_draf_PTD_Masuk_MCL
    Created on : Aug 10, 2010, 3:50:23 PM
    Author     : afham
--%>
...
<s:form beanclass="etanah.view.stripes.pelupusan.KeputusanPermohonanPertimbanganPTD_MasukMCLActionBean">
     <div class="subtitle">
         <s:messages/>
        <fieldset class="aras1">


            <legend><center>${actionBean.tajuk}</center></legend><br><br>
                    <p align="center">i. &nbsp; &nbsp; KEBENARAN UNTUK MENCATITKAN MCL
                <br>            ii. &nbsp; &nbsp; KEBENARAN UNTUK SERAH DAN MOHON SEMULA</p>
            <br><br>
            <b>1:</b> &nbsp; &nbsp; &nbsp; &nbsp; <u><b>TUJUAN</b></u> <br><br>
            <p align="left">&nbsp; &nbsp; &nbsp; &nbsp; 1.1 &nbsp; &nbsp; <s:textarea name="tujuan" readonly="true" rows="2" cols="140"/>
            <br><br></p>

            <b>2:</b> &nbsp; &nbsp; &nbsp; &nbsp; <u><b>LATAR BELAKANG</b></u> <br><br>
            <p> &nbsp; &nbsp; &nbsp; &nbsp; 2.1 &nbsp; &nbsp; Perihal Permohonan</p><br>
            <p> &nbsp; &nbsp; &nbsp; &nbsp; 2.1.1 &nbsp; &nbsp; <s:textarea name="latarBelakang1" readonly="true" rows="2" cols="140"/><br><br></p>
            <p> &nbsp; &nbsp; &nbsp; &nbsp; 2.1.2 &nbsp; &nbsp; ${actionBean.latarBelakang2}<br><br></p>
