...
//        Pengguna pengguna = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        ...
        } else if (obj instanceof PermohonanPlotPelan) {
            PermohonanPlotPelan permohonanPlotPelan = new PermohonanPlotPelan();
            permohonanPlotPelan = (PermohonanPlotPelan) obj;
            info = permohonanPlotPelan.getInfoAudit();
        } else if (obj instanceof LaporanTanahSempadan) {
            LaporanTanahSempadan laporanTanahSempadan = new LaporanTanahSempadan();
            laporanTanahSempadan = (LaporanTanahSempadan) obj;
            info = laporanTanahSempadan.getInfoAudit();
        }
    ...
    public Object findObject(Object obj, String[] data, int num) {
        ...
        if (obj instanceof HakmilikPermohonan) {
            if (num == 0) {
                ...
                obj = plpservice.findByNoLotIdPermohonan(data[0], data[1]);
            }
        } else if (obj instanceof Permohonan) {
            if (num == 0) {
                // data[0] = idPermohonan, data[1] = idHakmilik            
                ...
                // data[0] = idPermohonan, not like DIS
                obj = plpservice.findByIdNotDis(data[0]);
            }
            ...
            if (num == 0) {
                ...
                obj = plpservice.findLaporanTanahByIdPermohonanAndJenisLaporan(data[0], data[1]);
            } else if (num == 4) {
                obj = plpservice.findLaporanTanahByIdPermohonanAndJenisLaporan2(data[0], data[1]);
            }
        } else if (obj instanceof PermohonanLaporanPelan) {
            if (num == 0) {
                // data[0] = idPermohonan
                ...
                obj = plpservice.findByIdPermohonanPelanNIdMHBaru(data[0], (data[1]));
            }
            ...
            if (num == 0) {
                ...
                // data[0] = "idPermohonan", data[1] = "kod Rizab"
                obj = plpservice.findPermohonanLaporanKawasanByIdMH(Long.parseLong(data[0]), Integer.parseInt(data[1]));
            }
        } else if (obj instanceof PermohonanTuntutanKos) {
            if (num == 0) {
                ...
                // data[0] = "idKos"
                obj = permohonanTuntutanKosDAO.findById(Long.valueOf(data[0]));
            }
        } else if (obj instanceof PermohonanPermitItem) {
            if (num == 0) {
                ...
                obj = plpservice.findByIdMohonPermitItem(data[0], data[1]);
            }
        } else if (obj instanceof NoPt) {
            if (num == 0) {
                // data[0] = hakmilikPermohonan.getId()
            ...
            if (num == 0) {
                ...
                //data[0] = Id Pemohon
                obj = pelupusanService.findByIdPemohon(data[0]);
            }
            ...
            if (num == 0) {
                ...
                obj = pelupusanService.findHubunganByIdPemohonHubungan(Long.parseLong(data[0]));
            }
        } else if (obj instanceof UlasanJabatanTeknikal) {
            if (num == 0) {
                //data[0] = Id Laporan Pohon
        ...
        } else if (obj instanceof PihakPengarah) {
            if (num == 0) {
                obj = pihakPengarahDAO.findById(Long.parseLong(data[0]));
            }
        } else if (obj instanceof SalinanKepada) {
            if (num == 0) {
                obj = salinanKepadaDAO.findById(Long.parseLong(data[0]));
            }
        } else if (obj instanceof PermohonanPlotPelan) {
            if (num == 0) {
                //permohonanPlotPelan.idPlot
                obj = permohonanPlotPelanDAO.findById(Long.parseLong(data[0]));
            } else if (num == 1) {
                //idMH
                obj = pelupusanService.findByPermohonanPlotPelanByIDMH(Long.parseLong(data[0]));
            }
        }
    ...
    public String delObject(String tName, String[] data, String typeName) {
        ...
        if (tName.equals("mohonLaporSempadan")) {
            ...
            p = (Permohonan) this.findObject(p, new String[]{pm.getNoFail()}, 0);
            if (pm != null) {
            ...
            Permohonan p = new Permohonan();
            pm = (PermohonanManual) this.findObject(pm, new String[]{String.valueOf(data[0])}, 0);
            p = (Permohonan) this.findObject(p, new String[]{pm.getNoFail()}, 1);
//            if (p != null) {
//                pelupusanService.deleteAll(p);
//            }
            if (pm != null) {
                pelupusanService.deletePermohonanManual(pm);
            }
            ...
            if (!StringUtils.isEmpty(typeName)) {
                if (typeName.equals("kTujuan")) {
                    ...
                    type = "kMakluman";
                } else if (typeName.equals("kKeputusanJktd")) {
                    type = "kKeputusanJktd";
                } else if (typeName.equals("kHuraianPtg")) {
                    type = "kHuraianPtg";
                } else if (typeName.equals("kUlasan")) {
                    type = "kUlasan";
                } else if (typeName.equals("kHuraianPPtd")) {
                    type = "kHuraianPPtd";
                } else if (typeName.equals("kSyorPPtd")) {
                    type = "kSyorPPtd";
                } else if (typeName.equals("kSiasatan")) {
                    type = "kSiasatan";
                }
            }
            ...
            type = "lBelakangTanah";
        } else if (tName.equals("mohonTuntutKos")) {
            PermohonanTuntutanKos ptk = new PermohonanTuntutanKos();
            ptk = (PermohonanTuntutanKos) this.findObject(ptk, new String[]{String.valueOf(data[0])}, 2);
            if (ptk != null) {
                pelupusanService.deletePermohonanTuntutanKos(ptk);
            }
            type = "tBorang";
        } else if (tName.equals("pemohon")) {
            Pemohon pmhn = new Pemohon();
            pmhn = (Pemohon) this.findObject(pmhn, new String[]{String.valueOf(data[0])}, 1);
            if (pmhn != null) {
                pelupusanService.deletePemohon(pmhn);
            }
            type = "tPemohon";
        } else if (tName.equals("pemohonHubungan")) {
            PemohonHubungan ph = new PemohonHubungan();
            ph = (PemohonHubungan) this.findObject(ph, new String[]{data[0]}, 2);
            if (ph != null) {
                pelupusanService.deletePemohonHubungan(ph);
            }
            type = "mKeluarga";
        } else if (tName.equals("pihakPengarah")) {
            PihakPengarah pp = new PihakPengarah();
            pp = (PihakPengarah) this.findObject(pp, new String[]{data[0]}, 0);
            if (pp != null) {
                pelupusanService.deletePihakPengarah(pp);
            }
            type = "mPengarah";
        } else if (tName.equals("salinanKepada")) {
            SalinanKepada sk = new SalinanKepada();
            sk = (SalinanKepada) this.findObject(sk, new String[]{data[0]}, 0);
            if (sk != null) {
                pelupusanService.deleteSalinanKepada(sk);
            }
            type = "salinanKepada";
        } else if (tName.equals("mohonBatu")) {
            PermohonanBahanBatuan bahanBatuan = new PermohonanBahanBatuan();
            bahanBatuan = (PermohonanBahanBatuan) this.findObject(bahanBatuan, new String[]{data[0]}, 0);
            if (bahanBatuan != null) {
                pelupusanService.deletePermohonanBahanBatuan(bahanBatuan);
            }
            type = "bBahanBatuan";
        }
    ...
    public PihakAlamatTambDAO getPihakAlamatTambDAO() {
        return pihakAlamatTambDAO;
    }

    public void setPihakAlamatTambDAO(PihakAlamatTambDAO pihakAlamatTambDAO) {
        this.pihakAlamatTambDAO = pihakAlamatTambDAO;
    }

    public PemohonHubunganDAO getPemohonHubunganDAO() {
        return pemohonHubunganDAO;
    }

    public void setPemohonHubunganDAO(PemohonHubunganDAO pemohonHubunganDAO) {
        this.pemohonHubunganDAO = pemohonHubunganDAO;
    }

    public PihakPengarahDAO getPihakPengarahDAO() {
        return pihakPengarahDAO;
    }

    public void setPihakPengarahDAO(PihakPengarahDAO pihakPengarahDAO) {
        this.pihakPengarahDAO = pihakPengarahDAO;
    }
    ...
    public PermohonanKelompokDAO getPermohonanKelompokDAO() {
        return permohonanKelompokDAO;
    }

    public void setPermohonanKelompokDAO(PermohonanKelompokDAO permohonanKelompokDAO) {
        this.permohonanKelompokDAO = permohonanKelompokDAO;
    }

    public SalinanKepadaDAO getSalinanKepadaDAO() {
        return salinanKepadaDAO;
    }

    public void setSalinanKepadaDAO(SalinanKepadaDAO salinanKepadaDAO) {
        this.salinanKepadaDAO = salinanKepadaDAO;
    }
}
