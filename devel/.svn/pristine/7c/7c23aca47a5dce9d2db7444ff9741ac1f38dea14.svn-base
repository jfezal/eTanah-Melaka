 ...
 */
@Entity
@Table (name = "bdn_kanun")
@SequenceGenerator(name = "seq_bdn_kanun", sequenceName = "seq_bdn_kanun")
public class BadanBerkanun implements Serializable, Penyerah{
    
    @Id
        @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_bdn_kanun")
        @Column (name = "ID_BDN_KANUN")
	private long idBadanBerkanun;
    ...
    public long getIdBadanBerkanun() {
        return idBadanBerkanun;
    }

    public void setIdBadanBerkanun(long idBadanBerkanun) {
        this.idBadanBerkanun = idBadanBerkanun;
    }
