<%-- 
    Document   : edit_pemohon_permit2
    Created on : Apr 21, 2010, 5:44:31 PM
--%>
...
<script type="text/javascript">
	...
	<%--if($("#alamat1").val() == ""){
		...
		return false;
          ...
          if(document.edit.bangsa.value == "Sila Pilih"){
		alert('Sila pilih " Bangsa/Jenis Syarikat " terlebih dahulu.');
  		document.edit.bangsa.value.focus();
		return false;
	}
        if(document.edit.nama.value == ""){
...
<s:useActionBean beanclass="etanah.view.ListUtil" var="list"/>
        <s:form beanclass="etanah.view.stripes.pelupusan.MaklumatPermohonPermitActionBean" name="edit">
     <div class="subtitle">
        <fieldset class="aras1">
            ...
            <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L' || actionBean.pihak.jenisPengenalan.kod eq 'P' || actionBean.pihak.jenisPengenalan.kod eq 'T' || actionBean.pihak.jenisPengenalan.kod eq 'I'}">
                <p>
                    ...
                    <s:select name="bangsa" value="${actionBean.pihak.bangsa.kod}" style="width:200px">
                 ...
                 <p>
                                ...
                                <s:text name="pekerjaan" size="40" value="${actionBean.pemohon.pekerjaan}" maxlength="250" onkeyup="this.value=this.value.toUpperCase();"/><s:hidden name="pemohon.idPemohon"/>
                            </p>
                            <p>
                                <label>Pendapatan Bulanan (RM) :</label>
                                <s:text name="gaji" size="40" value="${actionBean.pemohon.pendapatan}" onkeyup="validateNumber(this,this.value);"/>
                            </p>
                            <p>
                                <label>Tanggungan :</label>
                                <s:text name="tanggungan" size="40" value="${actionBean.pemohon.tanggungan}" maxlength="3" onkeyup="validateNumber(this,this.value);"/>
                            </p>
            </c:if>
            <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'S' || actionBean.pihak.jenisPengenalan.kod eq 'U'}">
                <p>
                    ...
                    <s:select name="bangsa"  value="${actionBean.pihak.bangsa.kod}" style="width:400px" id="bangsa">
                        <s:option>Sila Pilih</s:option>
        ...
        <fieldset class="aras1">
            ...
            <p>
                <label>Nama Syarikat/Nama :</label>
            ...
            <c:if test="${actionBean.pihak.jenisPengenalan.kod eq 'B' || actionBean.pihak.jenisPengenalan.kod eq 'L' || actionBean.pihak.jenisPengenalan.kod eq 'P' || actionBean.pihak.jenisPengenalan.kod eq 'T' || actionBean.pihak.jenisPengenalan.kod eq 'I'}">
                ...
                <p>
                       <label>Kewarganegaraan gubhnj :</label>
                ...
                <p>
                                <label>Kewarganegaraan tfgjk:</label>
                ...
                <p>
                 ...
                 <p>
                    <label>Telefon :</label>
                    <s:text name="pemohon.telefon" size="40"/>
                </p>
                <p>
                    <label>Pendapatan Bulanan (RM) :</label>
