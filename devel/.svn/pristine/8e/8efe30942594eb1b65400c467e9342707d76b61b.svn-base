...
<s:form beanclass="etanah.view.stripes.pengambilan.RekodBayaranActionBean" id="form">
<div  id="hakmilik_details">
    <div align="center">
        <table style="width:99.2%" bgcolor="purple">
            <tr><td width="100%" height="20" ><div style="background-color: purple;" align="center">
                        <font style="font-family: Tahoma; font-size: 16px; font-weight: bold;"><font color="white">PENGAMBILAN: REKOD BAYARAN </font></font>
            </div></td></tr>
        </table>
    </div><br /><br />
...
<fieldset class="aras1"><br/>
    ...
    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
                   requestURI="/pengambilan/rekod_bayaran" id="line">
        <display:column title="No" sortable="true">${line_rowNum}</display:column>
        <display:column title="ID Hakmilik">
            <s:link beanclass="etanah.view.stripes.pengambilan.RekodBayaranActionBean"
      ...
      <c:if test="${showDetails}">          
          <table width="100%">
              ...
              <tr>
                ...
                <fmt:formatNumber pattern="#,##0.00" value="${actionBean.jumlahPampasan}"/>
