 ...
 */
public class KpsnSiasatanWithdrawValidation implements StageListener {
    ...
    private static final Logger LOG = Logger.getLogger(KpsnSiasatanWithdrawValidation.class);
...
//        throw new UnsupportedOperationException("Not supported yet.");
    ...
    public String beforeComplete(StageContext context, String proposedOutcome) {
        ...
        FasaPermohonan fasaPermohonan = lelongService.findFasaPermohonanSiasatan(idPermohonan);
