<%-- 
    Document   : Rekod_Bayaran_pop
    Created on : Mar 04, 2010, 11:14:55 AM
    Author     : Rajesh
--%>
...
<div class="subtitle">
         ...
         <s:form beanclass="etanah.view.stripes.pengambilan.RekodBayaranActionBean" >
            ...
            <legend>
                 ...
                 <display:table class="tablecloth" name="${actionBean.senaraiAmbilPampasan}" pagesize="5" cellpadding="0" cellspacing="0"
                     ...
                     <display:column property="jumTerimaPampasan" title="Jumlah Pampasan Yang Diterima(RM)"/>
