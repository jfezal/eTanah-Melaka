...
<html>
    ...
    <body>
        ...
        <div class="subtitle">
            <s:form action="/utiliti/kod_jadual_ketiga">
                <%--  <s:hidden name="idHakmilik" />--%>
                <fieldset class="aras1">
                    
                    <c:if test="${actionBean.kodNegeri eq 'Ketiga'}">
                        <legend> Carian Jadual Ketiga </legend>                                            
                    </c:if>
                    <c:if test="${actionBean.kodNegeri eq 'Ketujuh'}">
                        <legend> Carian Jadual Ketujuh [Section 108] - "Persons To Whom or Bodies to Which Land Subject To Part VIII May Be Charged" </legend>                                              
                    </c:if>
                        <br>
            ...
            <div class="subtitle">
                ...
                <fieldset class="aras1">
                    ...
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.list}" pagesize="10" cellpadding="0" cellspacing="0" 
                            id="row" requestURI="/utiliti/kod_jadual_ketiga">
