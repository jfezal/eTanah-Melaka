 ...
 */
package etanah.view.penguatkuasaan.laporan;
 ...
 * @author abu.mansur
 */
@UrlBinding("/enf/laporanEnforcement")
public class enfLaporanActionBean extends AbleActionBean {

    private static final Logger LOG = Logger.getLogger(enfLaporanActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        LOG.info("showForm");
        showReports();
        return new ForwardResolution("/WEB-INF/jsp/penguatkuasaan/laporan/enf_laporan.jsp");
    }
    ...
    private void showReports() {
        ...
        if ("05".equals(conf.getProperty("kodNegeri"))) { //for Negeri Sembilan
            senaraiReport = new String[]{
                "Rekod Aduan untuk Seksyen 422, 423, 424, 425, 425A, 427, 428, 429 KTN",
                "Rekod Aduan untuk Seksyen 49, 100, 127, 128, 129, 130, 351, 352, 426 KTN",
            ...
            senaraiReportName = new String[]{
                "ENFRekodAduan_425_NS.rdf",
                "ENFRekodAduan_351_NS.rdf",
                "ENFKeseluruhanRekod_NS.rdf",
                "ENFLaporanKemajuan_NS.rdf",              
                "ENFRekodKesalahan_NS.rdf",                
                "ENFRekodPBN_NS.rdf",
                "ENFRekodBaitulmal_NS.rdf",
                "ENFRekodMBI_NS.rdf",
                "ENFKutipanKompaun_NS.rdf",               
                "ENFKutipanDenda_NS.rdf"
            };
        }
...
//        getPenggunaCaw(kodCaw);
        return new ForwardResolution("/WEB-INF/jsp/penguatkuasaan/laporan/laporan_param_enf.jsp").addParameter("popup", "true");
    }
