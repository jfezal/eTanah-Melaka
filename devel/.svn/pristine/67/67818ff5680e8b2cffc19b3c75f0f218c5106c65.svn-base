<%--
    Document   :  syorPBHL(Editable).jsp
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showpbhlsokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showpbhltidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
