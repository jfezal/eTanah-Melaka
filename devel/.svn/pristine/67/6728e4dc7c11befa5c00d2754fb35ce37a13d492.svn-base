 ...
 * @author user
 */
@UrlBinding("/pengambilan/aduan_kerosakan/semak_tandatangan")
public class SemakTandatanganActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        System.out.println("inside show form SemakTandatanganActionBean ");
        return new JSP("pengambilan/aduan_kerosakan/semakTandatangan.jsp").addParameter("tab", "true");
