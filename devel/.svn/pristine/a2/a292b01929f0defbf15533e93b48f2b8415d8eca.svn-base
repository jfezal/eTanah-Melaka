 ...
 */
@UrlBinding("/pelupusan/draf_mmknLPSP")
public class DrafMMKN_LPSPActionBean extends AbleActionBean {
...
//    private PermohonanKertas permohonankertas;
    ...
    public Resolution showForm1() {
        edit = Boolean.FALSE;
        return new JSP("pelupusan/lpsp/draf_mmknLPSP_mlk.jsp").addParameter("tab", "true");
    }
//    @DefaultHandler
    ...
    public void rehydrate() {
        ...
        //For keputusan
         ...
         if (kodNeg.equals("05")) {
            fasaPermohonan = pelupusanService.findMohonFasaByIdMohonIdPengguna(idPermohonan, "15TrmLapSdknDrafMMK"); 
         }
...
//        stageId = "14PerakuMMK";
//        stageId = "sedia_draf_rencana_ptg";
...
//            stageId = "sedia_rencana_syor";
            ...
            if (urusanStatus.equals("LPSP")) {
                ...
                //PTD
                if (stageId.equals("15TrmLapSdknDrafMMK") || stageId.equals("16SmkDrafMMK") || stageId.equals("17SmkDrafMMK") || stageId.equals("18Perakuan") || stageId.equals("sedia_draf_rencana_ptg") || stageId.equals("perakuan_draf_rencana_ptg") || stageId.equals("semak_draf_rencana_ptg1") || stageId.equals("semak_draf_rencana_ptg2")) {
                    if (stageId.equals("sedia_draf_rencana_ptg")) {
                        viewOnlyPTD = false;
                        openPTD = true;
                    }
                    if (stageId.equals("semak_draf_rencana_ptg1")) {
                        viewOnlyPTD = false;
                        openPTD = true;
                    } else if(stageId.equals("15TrmLapSdknDrafMMK") || stageId.equals("17SmkDrafMMK") || stageId.equals("18Perakuan") || stageId.equals("perakuan_draf_rencana_ptg") || stageId.equals("semak_draf_rencana_ptg2")) {
                        openPTD = true;
                        viewOnlyPTD = true;
                        viewOnlyPTDOnly = false ;
                        
                    } else if(stageId.equals("16SmkDrafMMK")){
                        openPTD = true;
                        viewOnlyPTD = true;
                        viewOnlyPTDOnly = true ; 
                    }
                    openPTG = false;
                    viewOnlyPTG = false ;
                }
                ...
                if (stageId.equals("14aTerimaPindaanPTG") || stageId.equals("14bSemakPindaan") || stageId.equals("14cPindaanMMK") || stageId.equals("14dSemakPindaan") || stageId.equals("14ePerakuPindaan")) {
                    ...
                    if (stageId.equals("14bSemakPindaan") || stageId.equals("14cPindaanMMK") || stageId.equals("14dSemakPindaan")) {
                        viewOnlyPTD = false;
                        openPTD = true;
                    } else if(stageId.equals("14ePerakuPindaan")) {
                        openPTD = true;
                        viewOnlyPTD = true;
                        viewOnlyPTDOnly = false ;
                    }
                ...
                //PTG
                if (stageId.equals("19TrmDrafMMK") || stageId.equals("20SmkHuraian") || stageId.equals("21SmkHuraian") || stageId.equals("22SmkHuraian") || stageId.equals("23Perakuan") || stageId.equals("10TerimaDraf") || stageId.equals("10aSemakDraf") || stageId.equals("11SemakDraf") || stageId.equals("13SemakSyorDraf") || stageId.equals("13bPindaanPTG") || stageId.equals("14PerakuMMK")) {
                    if (stageId.equals("19TrmDrafMMK") || stageId.equals("20SmkHuraian") || stageId.equals("21SmkHuraian") || stageId.equals("22SmkHuraian") || stageId.equals("23Perakuan") || stageId.equals("10TerimaDraf") || stageId.equals("13bPindaanPTG") || stageId.equals("14PerakuMMK") || stageId.equals("13SemakSyorDraf")) {
                        viewOnlyPTD = true;
                        viewOnlyPTG = true;
                        openPTG = true;
                        viewOnlyPTGOnly = false ;
                    }
                    if (stageId.equals("10aSemakDraf") || stageId.equals("11SemakDraf")) {
                        viewOnlyPTG = false;
                        openPTG = true;
                        viewOnlyPTD = true;
                    } else {
...
//                    viewOnlyPTD = true;
            ...
            if(kodNeg.equals("04")){
                ...
                senaraiUlasanJabatanTeknikal = pelupusanService.senaraiPermohonanRujLuarByIdPermohonan(idPermohonan); 
            }
...
//                BigDecimal percent = BigDecimal.valueOf(percentDouble);
        ...
        if (permohonan.getKodUrusan().getKod().equals("LPSP")) {
                ...
                if (stageId.equals("19TrmDrafMMK")) {
                    no_laporan = permohonankertas.getNoLaporan();
                }
...
//                + pemohon.getPihak().getNama() + tajuk4 + " " + hakmilikPermohonan.getBandarPekanMukimBaru().getNama() + " DAERAH " + permohonan.getCawangan().getDaerah().getNama() + " UNTUK TUJUAN " + permohonan.getSebab() + noktah;
            ...
            if (keputusan.equals("SL")) {
                tajukMainDraf = tajuk + pemohon.getPihak().getNama() + " UNTUK MENDAPATKAN LESEN PENDUDUKAN SEMENTARA UNTUK TUJUAN " + tujuanLPS + " DAN PERMIT " + totalBatuan
                        + " BAHAN BATUAN IAITU " + jenisBahanBatu + " SEBANYAK " + mohonBahanBatuan.getJumlahIsipadu() + " " + mohonBahanBatuan.getJumlahIsipaduDipohonUom().getNama()
                        + " DI ATAS " + hakmilikPermohonan.getLot().getNama() + " " + hakmilikPermohonan.getNoLot() + "," + hakmilikPermohonan.getBandarPekanMukimBaru().getNama()
                        + ",DAERAH " + permohonan.getCawangan().getDaerah().getNama() + " UNTUK TUJUAN " + permohonan.getSebab() + " DI BAWAH SEKSYEN 69 KANUN TANAH NEGARA";
            } 
            else {
                tajukMainDraf = tajuk + pemohon.getPihak().getNama() + " UNTUK MENDAPATKAN LESEN PENDUDUKAN SEMENTARA UNTUK TUJUAN " + tujuanLPS + " DAN PERMIT " + totalBatuan
                        + " BAHAN BATUAN IAITU " + jenisBahanBatu + " SEBANYAK " + mohonBahanBatuan.getJumlahIsipaduDipohon() + " " + mohonBahanBatuan.getJumlahIsipaduDipohonUom().getNama()
                        + " DI ATAS " + hakmilikPermohonan.getLot().getNama() + " " + hakmilikPermohonan.getNoLot() + "," + hakmilikPermohonan.getBandarPekanMukimBaru().getNama()
                        + ",DAERAH " + permohonan.getCawangan().getDaerah().getNama() + " UNTUK TUJUAN " + permohonan.getSebab() + " DI BAWAH SEKSYEN 69 KANUN TANAH NEGARA";
            }
        ...
        if (!checkingValidation()) {
            ...
            if (permohonan != null) {
                ...
                if (mohonKertas == null) {
                    ...
                    mohonKertas.setNoLaporan(no_laporan);
                ...
                if (urusanStatus.equals("LPSP") ) {
                    if(stageId.equals("19TrmDrafMMK"))
                    {
                        ...
                        {
                            mohonKertas.setNoLaporan(no_laporan);
                            pelupusanService.saveOrUpdatePermohonanKertas(mohonKertas);
                        }
                    }
                }
                /*
...
//            LOG.info("PLK" + pLK.getSubtajuk());
    ...
    public Resolution showsyortolaklulus() {
        ...
        {
            idAliran = "sedia_draf_rencana_ptg" ;
        }
        System.out.println(idAliran);
    ...
    public void setNo_laporan(String no_laporan) {
