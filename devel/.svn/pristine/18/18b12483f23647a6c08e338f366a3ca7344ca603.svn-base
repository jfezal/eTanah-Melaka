...
@UrlBinding("/consent/laporan_ptg")
public class LaporanPtgActionBean extends AbleActionBean {
    ...
    private static final Logger LOGGER = Logger.getLogger(LaporanPtgActionBean.class);

    @DefaultHandler
    public Resolution showForm() {
        return new ForwardResolution("/WEB-INF/jsp/consent/laporan_ptg.jsp");
    }
