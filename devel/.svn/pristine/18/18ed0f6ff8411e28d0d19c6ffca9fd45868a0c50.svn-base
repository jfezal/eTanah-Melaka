...
<script type="text/javascript">
    ...
    function validation() {
        if($("#jumTerimaPampasan").val() == ""){
            alert('Sila masukkan Amaun Bayaran (RM) terlebih dahulu.');
...
<s:form name="form1" beanclass="etanah.view.stripes.pengambilan.AkaunTerimaBayaranActionBean">
        ...
        <fieldset class="aras1"><br/>
            <div align="center">
                ...
                <c:forEach items="${actionBean.senaraiPerbicaraanKehadiran}" var="lm">                   
                    <c:if test="${lm.pihak.jenis.kod == 'PM' || lm.pihak.jenis.kod == 'PA'}">
