       ...
       <s:form beanclass="etanah.view.laporanTanah.laporanTanahV3" name="form">
            ...
            <fieldset class="aras1">
             ...
             <s:hidden id="idLaporTanah" name="idLaporTanah" value="${actionBean.syorLaporanTanah.id}" />
                ...
                <p>
                    <label>&nbsp;</label>
                    <s:submit name="searchSyarat" value="Cari" class="btn" onclick="NoPrompt();"/>
                </p>
            </fieldset>
        </div>
        <br>
        ...
        <div class="subtitle">
            ...
            <fieldset class="aras1">
                <legend></legend>
                <p>
                    <display:table style="width:100%" class="tablecloth" name="${actionBean.disSyaratSekatan.listKodSyaratNyata}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/laporanTanah/laporanTanahV3" id="line">
