<%-- 
    Document   : mmkn_831a_jawatankuasakhas_N9
    Created on : 29/5/2013, 10:03:25
    Author     : nordiyana
--%>
...
<script language="javascript" type="text/javascript">
        ...
        function deleteRow2()
        {
            ...
            if(confirm('Adakah anda pasti?')) {
                ...
                if (document.getElementById('idKandungan2'+(j)) != null) {
                    var url = '${pageContext.request.contextPath}/pengambilan/mmkn831a?deleteSinglePTG&idKandungan='
                        +idKandungan;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
    ...
    <%--element2.value ="senaraiPentadbir"+(count5)+(rowCount7+1);--%>
        ...
        function deleteDynamicRow5(tableID,countID) {
            ...
            if(rowCount7 >1){
                ...
                if (obj != null) {
                    ...
                    var url = '${pageContext.request.contextPath}/pengambilan/mmkn831bKhas?deleteSingle&idKandungan='
                        +idKandungan;
        ...
        function addTable5a(divId){
            var id1 = document.getElementById(divId);
            var count5 = document.getElementById ("count5a").value;
            // Increment table count by 1
            document.getElementById ("count5a").value = parseInt(count5)+1;
            count5 = document.getElementById ("count5a").value;

            // create New table
            var table5 = document.createElement("TABLE");
            table5.id = "table5a"+count5;
            //table.className = "tablecloth";
            table5.width="100%";
            //table.border=2;
            var rowCount5 = table5.rows.length;
    ...
    <%--cell0.style.backgroundColor = ("#328aa4");--%>
            ...
            var cell1 = row5.insertCell(1);
            var element1 = document.createElement("textarea");
            element1.t = "senaraiPentadbira"+(count5)+(rowCount5+1);
            element1.rows = 5;
            element1.cols = 130;
            element1.name ="senaraiPentadbira"+(count5)+(rowCount5+1);
            element1.id ="senaraiPentadbira"+(count5)+(rowCount5+1);
    <%--element1.value ="senaraiPentadbir"+(count5)+(rowCount5+1);--%>
            cell1.colSpan = 2;
            cell1.appendChild(element1);
            ...
            var element2 = document.createElement ("input");
            element2.setAttribute("type", "hidden");
            element2.setAttribute("id", "count5a"+(count5));
            element2.setAttribute("name", "count5a"+(count5));
            element2.setAttribute("value", 1);
            cell2.appendChild(element2);
            ...
            var cell3 = row5.insertCell(3);
            var button = document.createElement('input');
            var buttonName = "tambah5a" +(count5);
            button.setAttribute('type','button');
            button.className = "btn";
            button.setAttribute('name',buttonName);
            button.setAttribute('value','Tambah'+' 3.'+(count5));
            button.onclick=function(){addDynamicRow5a(table5.id,element2.id);};
            cell3.appendChild(button);

            var button1 = document.createElement('input');
            var buttonName1 = "hapus5a" +(count5);
            button1.setAttribute('type','button');
            button1.className = "btn";
            button1.setAttribute('name',buttonName1);
            button1.setAttribute('value','Hapus'+' 3.'+(count5));
            button1.onclick=function(){deleteDynamicRow5a(table5.id,element2.id);};
            cell3.appendChild(button1);
        ...
        function addDynamicRow5a(tableID,countID) {
            ...
            var cell2 = row5.insertCell(2);
            var element2 = document.createElement("textarea");
            element2.t = "senaraiPentadbira"+(count5)+(rowCount7+1);
            element2.rows = 5;
            element2.cols = 130;
            element2.name ="senaraiPentadbira"+(count5)+(rowCount7+1);
            element2.id ="senaraiPentadbira"+(count5)+(rowCount7+1);
    <%--element2.value ="senaraiPentadbir"+(count5)+(rowCount7+1);--%>
            cell2.appendChild(element2);
        ...
        function deleteDynamicRow5a(tableID,countID) {
            ...
            if(rowCount7 >1){
                ...
                if (obj != null) {
                    ...
                    var url = '${pageContext.request.contextPath}/pengambilan/mmkn831a?deleteSingleBKhas&idKandungan='
                        +idKandungan;
...
<s:form beanclass="etanah.view.stripes.pengambilan.MMKN831BKhasActionBean" name="form2">
    <s:messages/>
    <s:errors/>
                ...
                <div class="content" align="center">
                    <table border="0" width="80%">
                        <div class="content" align="left">
                            ...
                            <tr><td> &nbsp;</td></tr>
                            <tr><td align="left"><b><label><font color="red">*</font><font color="black">KERTAS MESYUARAT :</font></label><s:text name="kertasBil" disabled="false" size="10" style="text-align:left" id="kertasBil" class="normal_text"/>/${actionBean.kertasTahun}<s:hidden name="kertasTahun" value="${actionBean.kertasTahun}"/></b></td></tr>
                            <%--<tr>
                            ...
                            --%> <tr><td align="left"><b><label><font color="red">*</font><font color="black">TARIKH :</font></label><s:text name="tarikhmesyuarat"  id="tarikhMesyuarat" class="datepicker" size="15" style="text-align:left" /></b></td></tr><%--
                        ...
                        <c:forEach var="i" begin="1" end="${actionBean.count5a}">
                            <tr><td>
                                    <table  width="90%" id="table5a${i}" >
                                        ...
                                        <c:forEach items="${actionBean.senaraiPentadbira[i]}" var="senaraia">
                                            <c:set var="recordCount5a" value="${recordCount5a+1}"/>
                                            <c:if test="${recordCount5a eq 1}">
                                                <tr> <td><b>3.${i}</b></td>
                                                    <td colspan="2"><s:textarea rows="5" class="normal_text" cols="130" name="senaraiPentadbira${i}${recordCount5a}" id="senaraiPentadbira${i}${recordCount5a}" value="${senaraia.kandungan}" /></td>
                                                    <td><s:hidden name="count5a${i}" id="count5a${i}" value="${(fn:length(actionBean.senaraiPentadbira[i]))}" /> </td>
                                                ...
                                                <tr>  <td></td>
                                                    ...
                                                    <td><s:textarea rows="5" cols="130"   class="normal_text" name="senaraiPentadbira${i}${recordCount5a}" id="senaraiPentadbira${i}${recordCount5a}" value="${senaraia.kandungan}" /></td>
                                                </c:if>
                        ...
                        <c:if test="${actionBean.kodNegeri eq '04'}">
                            <tr><td><b><font>4. HURAIAN PENGARAH TANAH DAN GALIAN, NEGERI MELAKA ${actionBean.hakmilik.daerah.nama}</font></b></td></tr>
                        </c:if>
                        ...
                        <c:if test="${actionBean.kodNegeri eq '04'}">
                            <tr><td><b><font>5. SYOR PENGARAH TANAH DAN GALIAN,NEGERI MELAKA</font></b></td></tr>
                        </c:if>
                        <tr><td>
                                <table id ="dataTable5">
                                    <c:set var="y" value="1" />
                        ...
                        <%--<tr><td> &nbsp;</td></tr>
                        <tr><td><b><font>6. SYOR PENGARAH TANAH DAN GALIAN, NEGERI SEMBILAN</font></b></td></tr>
                    ...
                    <div id="Tables4">
                        ...
                        <tr>
                            <td width="100%"><b>6.1</b> Dikemukakan untuk pertimbangan dan keputusan Jawatankuasa Khas Pengambilan  Negeri Sembilan.
                        ...
                        <c:if test="${actionBean.kodNegeri eq '04'}">
                            <tr>
                                <td width="100%"><b>6.1</b> Dikemukakan untuk pertimbangan dan keputusan Jawatankuasa Khas Pengambilan  Negeri Melaka.
