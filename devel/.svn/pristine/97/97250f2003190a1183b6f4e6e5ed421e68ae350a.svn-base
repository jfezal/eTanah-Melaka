<%--
    Document   : searhSekatanKpntngn_lptn
...
<s:form beanclass="etanah.view.stripes.pelupusan.LaporanTanah4ActionBean">
    <fieldset class="aras1">
        ...
        <fieldset class="aras1">
                    <legend></legend>
                    <p>
                        <display:table style="width:100%" class="tablecloth" name="${actionBean.listKodSekatan}" pagesize="10" cellpadding="0" cellspacing="0" requestURI="/pelupusan/laporan_tanah4" id="line">
