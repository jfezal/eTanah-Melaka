                ...
                <table width="100%" border="0">
                        ...
                        <td colspan="4" align="center" >
                            <p>
                                <c:if test="${actionBean.permohonan.kodUrusan.kod eq 'PCRG'}">
                                    ...
                                    <span style="text-transform: uppercase;color:#000000;font-weight:bold;font-family:Tahoma;font-size: 13px;">MINIT MESYUARAT JAWATANKUASA SUMBER MINERAL NEGERI <br> NEGERI SEMBILAN BIL ${actionBean.noRuj} </span>
                                    </c:if>
                            </p>
                        </td>
                    </tr>
                    ...
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <fmt:formatDate value="${actionBean.permohonanKertasTemp.tarikhSidang}" pattern="hh:mm"/>&nbsp;
                                <fmt:formatDate type="time"
                                                pattern="aaa"
                                                value="${actionBean.permohonanKertasTemp.tarikhSidang}" var="timeformat"/>
                    ...
                    <table>
                        ...
                        <c:forEach items="${actionBean.mohonKertasKandListOne}" var="line" begin="0">
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <%--<td width="5%" valign="top"><b style="color:#000000;font-weight:bold;font-family:Tahoma;font-size: 13px;">1.${i}</b></td>--%>
