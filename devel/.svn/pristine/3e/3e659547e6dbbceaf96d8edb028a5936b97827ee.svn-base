<%--
    Document   :  syorPTGSA(Editable).jsp
    Created on :  March 22, 2012, 04:13:00 PM
    Author     :  Shazwan
--%>
...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        function showptgsatidaksokong(val) {
            $('#ptgsatidaksokong').show();
            $('#ptgsasokong').hide();
            if(val == 'SL'){
                val = 'ST';
                    ...
                    <c:when test="${actionBean.kodNegeri eq '04' or actionBean.kodNegeri eq '05'}">
                        <table class="tablecloth" align="center">
                            <tr>
                                ...
                                <td>
                                    <s:radio name="ksn" id="ksn" value="SL" onclick="showptgsasokong(this.value);" />&nbsp;Sokong
                                    <s:radio name="ksn" id="ksn" value="ST" onclick="showptgsatidaksokong(this.value);" />&nbsp;Tidak Sokong                                             
