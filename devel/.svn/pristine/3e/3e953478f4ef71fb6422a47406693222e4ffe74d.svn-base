...
//            alert(radio) ;
            ...
            var idRujukan = $('#idRujukan').val() ;
               var url = '${pageContext.request.contextPath}/pelupusan/sedia_jabatan?simpanKodSalinan&kod=' + kod + '&radio=' + radio + '&idRujukan=' + idRujukan ;
                    $.get(url,
                    function(data){
                        $('#page_div').html(data);
...
//                    alert($('#kodAsal').val());
                    ...
                    if(confirm("Adakah anda pasti?")) {
                        var url = '${pageContext.request.contextPath}/pelupusan/sedia_jabatan?simpanMohonRujLuarDokumen&item='+data+'&idMohRujLuar='+idMohRujLuar;
                        $.post(url,
                        function(data){
                            $('#page_div').html(data);
                            alert("Rekod telah berjaya di masukkan") ;
    ...
    <s:errors/>
        <s:messages/>
        <div class="subtitle">
            <s:form beanclass="etanah.view.stripes.pelupusan.JabatanTeknikalActionBean" name="salinan">
