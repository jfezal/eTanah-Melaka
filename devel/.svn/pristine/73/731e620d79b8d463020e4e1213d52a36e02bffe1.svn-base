 ...
 * @author wan.fairul
 */
@UrlBinding("/strata/kertas")
public class KertasPertimbanganActionBean extends BasicTabActionBean {
    ...
    String syorTP;
    private static final Logger LOG = Logger.getLogger(KertasPertimbanganActionBean.class);
...
//                }
    ...
    public Resolution simpan() {
        ...
        return new RedirectResolution(KertasPertimbanganActionBean.class, "showForm").addParameter("error", error).addParameter("message", msg);
    }
    ...
    public Resolution simpanSemakKertasptg() {
        ...
        return new RedirectResolution(KertasPertimbanganActionBean.class, "showForm2").addParameter("error", error).addParameter("message", msg);
    }
    ...
    public Resolution deleteSingle() {
        ...
        return new RedirectResolution(KertasPertimbanganActionBean.class, "locate");
    }
    ...
    public Resolution deleteSingleSemakKertasptg() {
        ...
        getContext().getRequest().setAttribute("display", Boolean.TRUE);
        addSimpleMessage("Maklumat telah berjaya dihapus.");
        return new RedirectResolution(KertasPertimbanganActionBean.class, "showForm2");
    }
    ...
    public Resolution simpan1() {
        ...
        return new RedirectResolution(KertasPertimbanganActionBean.class, "showForm3").addParameter("error", error).addParameter("message", msg);
