...
import etanah.view.stripes.pelupusan.disClass.DisPPTRPage;
 ...
 * @author afham
 */
@UrlBinding("/pelupusan/kertas_MMKPPTR")
public class KertasMMKPPTRActionBean extends AbleActionBean {
...
//    private List<PermohonanKertasKandungan> senaraiKandunganTajuk;  //Bil - 0
    ...
    private static final Logger LOG = Logger.getLogger(KertasMMKPPTRActionBean.class);
    ...
    public Resolution editOnlyKertasMMKPT() {
        ...
        if (kodNegeri.equals("04")) {
            return new JSP(DisPPTRPage.getKMMK_MAIN_PAGE_MLK()).addParameter("tab", "true");
        } else {
            return new JSP(DisPPTRPage.getKMMK_MAIN_PAGE_NS()).addParameter("tab", "true");
        }
    }
...
//                    kandunganTajuk += " PLOT ";
    ...
    public void setObjectKertasKandunganKeputusanPTG(PermohonanKertas permohonanKertas) {
        ...
        {
            kand = "Dengan perwakilan kuasa yang diberikan kepada saya oleh Pihak Berkuasa Negeri mengikut subseksyen 13(1) Kanun Tanah Negara 1965 yang telah diwartakan"
                    + " melalui Warta Kerajaan Negeri Sembilan No. 315 (Tambahan No. 1) bertarikh 17.8.2006, saya membuat keputusan seperti berikut:- ";
        ...
        {
            kand = "Dibentangkan untuk pertimbangan dan keputusan Majlis Mesyuarat Kerajaan Negeri ";
                if (kodNegeri.equals("04")) {
                kand += "Melaka.";
            } else {
    ...
    public Resolution searchSyarat() {
        ...
        if (!StringUtils.isEmpty(jenisSyarat)) {
            if (jenisSyarat.equalsIgnoreCase("nyata")) {
                ...
                forwardJSP = DisPPTRPage.getKMMK_SYARATNYATA_PAGE();
                ...
                forwardJSP = DisPPTRPage.getKMMK_SEKATAN_PAGE();
            }
        }
    ...
    public Resolution cariKodSyaratNyata() {
        ...
        return new JSP(DisPPTRPage.getKMMK_SYARATNYATA_PAGE()).addParameter("popup", "true");
    }
    ...
    public Resolution cariKodSekatan() {
        ...
        return new JSP(DisPPTRPage.getKMMK_SEKATAN_PAGE()).addParameter("popup", "true");
    }
...
//                senaraiHakmilikPermohonan = disLaporanTanahService.getPlpservice().getHakmilikPermohonanListByCatatanNIdMohon(new String(), idPermohonan);
            ...
            if (permohonan.getKodUrusan().getKod().equals("PBPTG")) {
                fasaPermohonanptg = new FasaPermohonan();
                fasaPermohonanptg = disLaporanTanahService.getPlpservice().findMohonFasaByIdMohonIdPengguna(idPermohonan, "perakuan_ptg");
            }
...
//        permohonanKertas = new PermohonanKertas();
        ...
        switch (typeNum) {
            case 0:
                ...
                forwardJSP = DisPPTRPage.getKMMK_TAJUK();
                break;
            case 1:
                senaraiKandunganTujuan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 1);
                forwardJSP = DisPPTRPage.getKMMK_TUJUAN();
                break;
            case 2:
                senaraiKandunganPerihalPermohonan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 2);
                forwardJSP = DisPPTRPage.getKMMK_PERIHAL_PERMOHONAN();
                break;
            case 3:
                senaraiKandunganPerihalTanah = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 3);
                forwardJSP = DisPPTRPage.getKMMK_PERIHAL_TANAH();
                break;
            case 4:
                senaraiKandunganHuraianPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 4);
                forwardJSP = DisPPTRPage.getKMMK_HURAIAN_PTD();
                break;
            case 5:
                senaraiKandunganPerakuanPtd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 5);
                fixStageId = getStageByUrusan(permohonan.getKodUrusan().getKod(), kodNegeri);
                ...
                forwardJSP = DisPPTRPage.getKMMK_PERAKUAN_PTD();
                break;
            case 6:
                senaraiKandunganPerakuanPtg = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 6);
                forwardJSP = DisPPTRPage.getKMMK_PERAKUAN_PTG();
                break;
            case 7:
                senaraiKandunganKeputusan = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 7);
                forwardJSP = DisPPTRPage.getKMMK_KEPUTUSAN();
                break;
            case 8:
                senaraiKandunganKeputusanJktd = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 8);
                forwardJSP = DisPPTRPage.getKMMK_KEPUTUSAN_JKTD();
                break;
            case 9:
                senaraiKandunganHuraianPtg = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 9);
                forwardJSP = DisPPTRPage.getKMMK_HURAIAN_PTG();
                break;
            case 10:
                rehydrate();
                disKertasMMKController = (DisKertasMMKController) getContext().getRequest().getSession().getAttribute("disKertasMMKController");
                if (kodNegeri.equals("04")) {
                    forwardJSP = DisPPTRPage.getKMMK_MAIN_PAGE_MLK();
                } else {
                    forwardJSP = DisPPTRPage.getKMMK_MAIN_PAGE_NS();
                }
                break;
            case 11:
                senaraiKandunganPemohon = disLaporanTanahService.getPelupusanService().findByIdLapor(permohonanKertas.getIdKertas(), 10);
                forwardJSP = DisPPTRPage.getKMMK_PERIHAL_PEMOHON();
                break;
        }
        return forwardJSP;
    }
    ...
    public Resolution simpanKodSyaratNyata() {
        ...
        return new JSP(DisPPTRPage.getKMMK_PERAKUAN_PTD()).addParameter("tab", Boolean.TRUE);
    }
...
//        LOG.info("CHECKING:..... index :" + index + " kand :" + kand);
    ...
    public Boolean updateMohonFasaptg() {
...
//                    mohonBahanBatuSave.setTempohSyorUom(disLaporanTanahService.getKodUOMDAO().findById(mohonBahanBatu.getUnitTempohKeluar().getKod()));
    ...
    public FasaPermohonan getFasaPermohonanptg() {
        return fasaPermohonanptg;
    }

    public void setFasaPermohonanptg(FasaPermohonan fasaPermohonanptg) {
        this.fasaPermohonanptg = fasaPermohonanptg;
    }
}
