...
<s:useActionBean beanclass="etanah.view.ListUtil" id="listUtil" />
<s:form beanclass="etanah.view.stripes.pengambilan.depositMahkamahActionBean" name="form">
    <s:errors/>
    <s:messages/>
                ...
                <table class="tablecloth" border="0" width="75%">
                    <tr>
                        ...
                        <td>
                            ...
                            <s:text name="pemohon.pihak.jenisPengenalan.nama" id="nama" value="${actionBean.pemohon.pihak.jenisPengenalan.kod}" size="20" onkeyup="this.value=this.value.toUpperCase();" disabled="true"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <s:text name="pemohon.pihak.alamat1" value="${actionBean.pemohon.pihak.alamat1}" id="alamat1" size="40" onkeyup="this.value=this.value.toUpperCase();" disabled="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            <s:text name="pemohon.pihak.alamat2" value="${actionBean.pemohon.pihak.alamat2}" id="alamat2" size="40" onkeyup="this.value=this.value.toUpperCase();" disabled="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            <s:text name="pemohon.pihak.alamat3" value="${actionBean.pemohon.pihak.alamat3}" id="alamat3" size="40" onkeyup="this.value=this.value.toUpperCase();" disabled="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            <s:text name="pemohon.pihak.alamat4" value="${actionBean.pihak.alamat4}" id="alamat4" size="40" onkeyup="this.value=this.value.toUpperCase();" disabled="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td><%--<font color="red" size="4">*</font>--%>Poskod :</td>
                        <td>
                            <s:text name="pemohon.pihak.poskod" value="${actionBean.pihak.poskod}" size="10" id="poskod" maxlength="5" onkeyup="validateNumber(this,this.value);" disabled="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td><%--<font color="red" size="4">*</font>--%>Negeri :</td>
                        <td>
                            <s:text name="pemohon.pihak.negeri.nama" value="${actionBean.pihak.negeri.kod}" size="40" id="poskod" maxlength="5" onkeyup="validateNumber(this,this.value);" disabled="true"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <s:text name="pemohon.pihak.noTelefon1" id="noTelefon1" value="${actionBean.pihak.noTelefon1}"size="" onkeyup="validateNumber(this,this.value);" disabled="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td><%--<font color="red" size="4">*</font>--%>Emel :</td>
                        <td>
                            <s:text name="pemohon.pihak.email" id="emel" value="${actionBean.pihak.email}"size="40" class="normal_text" disabled="true"/> <%--<em>[alamat_emel@gmail.com]</em>--%>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="content" align="center">
                ...
                <table class="tablecloth" border="0" width="75%">
                    ...
                    <tr>
                        ...
                        <td>
                            RM <s:text name="amaun" onkeyup="validateNumber(this,this.value);" formatPattern="#,##0.00"/>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="tablecloth" border="0">
                    <tr>
                        <td align="right" colspan="2">
                            ...
                            <s:button name="simpanPendeposit" id="save" value="Simpan" class="btn" onclick="doSubmit(this.form, this.name, 'page_div',idPihak)"/>
