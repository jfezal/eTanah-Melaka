<%-- 
    Document   : BayaranKerosakanAduan
    ...
    <%--document.getElementById("selectedIdHM").value=obj.value;--%>
        ...
        function validation() {
            ...
            if ($("input[name='kodCaraBayaran.kod']:checked").val() != 'CT' &&
                ...
                return false;
            }else if($("input[name='kodCaraBayaran.kod']:checked").val() != 'T'){
                $("#nodok").attr("disabled",false);
                $("#tarikhDok").attr("disabled",false);
                $("#kodBank").attr("disabled",false);
...
<div class="subtitle" id="caw">
    <s:form name="form1" id="form1" beanclass="etanah.view.stripes.pengambilan.BayaranKerosakanActionBean">
        <div  id="hakmilik_details">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
                        ...
                        <display:column title="Tuan Tanah" >
                            <c:forEach items="${line.hakmilik.senaraiPihakBerkepentingan}" varStatus="loop" var="senarai">
                                <s:link beanclass="etanah.view.stripes.pengambilan.BayaranKerosakanActionBean"
            ...
            <c:if test="${showDetails}">
                <div  class="subtitle">
                    <fieldset class="aras1">
                        <legend>Maklumat Pembayaran - ${actionBean.nama} </legend><br />
                        <div  align="center">
                            <table width="100%">
                                <%--    <tr>
                                ...
                                <tr>
                                    ...
                                    <%--formatPattern="#,##0.00"--%>
                                    <td><s:text name="a" id="amountsebenar" formatPattern="#,##0.00" value="${(actionBean.kosKerosakanTanah)+(actionBean.kosKerosakanBangunan)+(actionBean.kosKerosakanPokok)+(actionBean.kosKerosakanInfra)+(actionBean.kosKerosakanLain)+(actionBean.kosKecacatanTanah)}"  readonly="true"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><label >&nbsp;&nbsp;</label></td>
                                    <%--onclick="showTunai();"--%>
                                    <td><s:radio name="kodCaraBayaran.kod" id="kodCaraBayaran1" value="CT" onclick="showTunai();"/> Cek Tempatan <br /></td>
                                </tr>
                                <tr>
                                    <td><label >&nbsp;&nbsp;</label></td>
                                    <%--onclick="showTunai();"--%>
                                    <td><s:radio name="kodCaraBayaran.kod" id="kodCaraBayaran2" value="CL" onclick="showTunai();"/> Cek Luar <br /></td>
                                </tr>
                                <tr>
                                    <td><label >&nbsp;&nbsp;</label></td>
                                    <td><s:radio name="kodCaraBayaran.kod" id="kodCaraBayaran3" value="CB" onclick="showTunai();"/> Cek Bank Negara <br /></td>
                                </tr>
                                <tr>
                                    <td><label >&nbsp;&nbsp;</label></td>
                                    <td><s:radio name="kodCaraBayaran.kod" id="kodCaraBayaran4" value="DB" onclick="showTunai();"/> Bank Draf <br /></td>
                                </tr>
                                <tr>
                                    <td><label >&nbsp;&nbsp;</label></td>
                                    <%--onclick="hideTunai();"--%>
                                    <td><s:radio name="kodCaraBayaran.kod" id="kodCaraBayaran5" value="T" onclick="hideTunai();"/> Tunai <br /></td>
                                </tr>
                                <%--<tr>
                                    <td><label >&nbsp;&nbsp;</label></td>
                                    onclick="showTunai();"
                                ...
                                <tr>
                                    ...
                                    <td><s:select name="kodBank2.kod" disabled="${actionBean.tunai}" style="width:300px;" id="kodBank" >
