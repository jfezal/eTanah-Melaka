...
$(document).ready(function() {
    ...
    {   
        ...
        var url = '${pageContext.request.contextPath}/pelupusan/kertas_JKTDPBGSA?tambahRow&index='+index+'&kodksn='+kodksn+'&ksn='+kpsn;
        window.open(url, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
    }
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_JKTDPBGSA?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kPerakuanPtd',q,
            function(data){
                $('#page_div').html(data);
    ...
    function cariPopup(val){
            var idMh = $('#idMh').val();
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pelupusan/kertas_JKTDPBGSA?searchSyarat&jenisSyarat="+val+"&idMh="+idMh, "eTanah",
        ...
        function kiraCukai(f) {
            ...
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_JKTDPBGSA?kiraCukai&kodTanah=' + kodTanah , q,
            function(data) {
                if (data == '-1') {
                } else {
