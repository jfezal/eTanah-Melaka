<%-- 
    Document   : kertas_rencana_ptdV2Tujuan
    Created on : Jul 3, 2013, 11:43:45 AM
    Author     : afham
--%>
...
<script type="text/javascript">
    ...
    {   
        ...
        if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pelupusan/kertas_pindaanPTDV2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=kTujuan',q,
            function(data){
                $('#page_div').html(data);
