 ...
 * modified by Shazwan
 */
@UrlBinding("/pelupusan/surat_kelulusan_prmp")

public class KeputusanPermohonanPRMPActionBean extends AbleActionBean {
...
//       String ditundatangan = getContext().getRequest().getParameter("ditundatangan");
        ...
        if(permohonan.getKodUrusan().getKod().equals("PBPTD")||permohonan.getKodUrusan().getKod().equals("PBPTG")){
         ...
         edit = Boolean.TRUE;
        return new JSP("pelupusan/surat_keputusan_PRMP.jsp").addParameter("tab", "true");
    }
    ...
    public void settingPermohonanTuntutanKos(String idPermohonan,InfoAudit info){
                ...
                */
                ...
                if(mohonTuntutKos==null){
                    ...
                    ia.setDimasukOleh(info.getDimasukOleh());
                    ia.setTarikhMasuk(info.getTarikhMasuk());
                    mohonTuntutKos.setInfoAudit(ia);
                    mohonTuntutKos.setPermohonan(permohonan);
                    mohonTuntutKos.setCawangan(permohonan.getCawangan());
                    mohonTuntutKos.setItem("Bayaran Permit Tanah Pertanian");
                    mohonTuntutKos.setAmaunTuntutan(jumlahBayar);
                    mohonTuntutKos.setKodTuntut(kodTuntutDAO.findById("DISB7"));
                    mohonTuntutKos.setKodTransaksi(kodTuntutDAO.findById("DISB7").getKodKewTrans());
                    pelupusanService.simpanSavePermohonanTuntutanKos(mohonTuntutKos); 
                }else{
                    ia = mohonTuntutKos.getInfoAudit();
                    ia.setDiKemaskiniOleh(info.getDimasukOleh());
                    ia.setTarikhKemaskini(info.getTarikhMasuk());
                    mohonTuntutKos.setInfoAudit(ia);
                    mohonTuntutKos.setPermohonan(permohonan);
                    mohonTuntutKos.setCawangan(permohonan.getCawangan());
                    mohonTuntutKos.setItem("Bayaran Permit Tanah Pertanian");
...
//            }
            ...
            mohonTuntutKos = pelupusanService.findMohonTuntutKosByIdPermohonanAndIdTuntut(idPermohonan,"DISB7");
            if(mohonTuntutKos!=null){
               jumlahBayar = mohonTuntutKos.getAmaunTuntutan();
