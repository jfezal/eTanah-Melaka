 ...
 * @author abu.mansur
 */
@UrlBinding("/hasil/papar_keputusan_RemOther")
public class KeputusanPaparRemOthersActionBean extends AbleActionBean {
    ...
    public Resolution showForm(){
        return new JSP("hasil/papar_keputusan_other.jsp").addParameter("tab", "true");
    }
