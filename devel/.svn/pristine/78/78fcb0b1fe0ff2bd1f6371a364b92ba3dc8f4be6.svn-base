 ...
 * @author Rajesh
 */
@UrlBinding("/pengambilan/borang_mmkn_31c_ns")
public class PengambilanMMKN31cNSActionBean extends AbleActionBean {


    private static Logger logger = Logger.getLogger(PengambilanMMKN31cNSActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/negerisembilan/seksyen831bc/pengambilan_MMKN_31c.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        String temp = "PERMOHONAN PENGAMBILAN TANAH DARIPADA "+ permohonan.getSenaraiPemohon().get(0).getIdPemohon()+" SELUAS LEBIH KURANG "
                ...
                + noLotList + " DAERAH " + hakmilik.getDaerah().getNama() + " DI BAWAH SEKSYEN 831C AKTA PENGAMBILAN TANAH 1960.";
        ...
        tujuan = "Kertas ini disediakan untuk mendapat pertimbangan Majlis Mesyuarat kerajaan Negeri, Negeri Sembilan Darul Khusus mengenai "
                ...
                + " seksyen 3(1)(c) Akta Pengambilan Tanah 1960 di bawah perwakilan kuasa seperti yang "
...
//            }
        ...
        getContext().getRequest().setAttribute("form", Boolean.TRUE);
        return new RedirectResolution(PengambilanMMKN31cNSActionBean.class, "locate");
    }
