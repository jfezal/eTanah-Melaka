...
public class DisAgihanTugas {
    ...
    Logger logger = Logger.getLogger(DisAgihanTugas.class);
    ...
    public List<Pengguna> getPengguna(int numUrusan, String stageID, String negeri, String kodCaw) {
        ...
        switch (numUrusan) {
            ...
            case 44:
                //LSTP
                listPp = getPenggunaByBPELCaseLSTP(stageID, numnegeri, kodCaw);
                break;
            case 45:
                //LPJH
                listPp = getPenggunaByBPELCaseLPJH(stageID, numnegeri, kodCaw);
                break;
                 case 46:
                //PLPT
                listPp = getPenggunaByBPELCasePLPT(stageID, numnegeri, kodCaw);
                break;
        }
        return listPp;
    }

//    public List<Pengguna> getPenggunaPLPS(int numUrusan, String stageID, String negeri, String kodCaw, String kodJabatan, String kodPeranan) {
//
//        List listPp = new ArrayList<Pengguna>();
//        //Pengguna pguna = new Pengguna();
//        int numnegeri = negeri.equalsIgnoreCase("04") ? 1
...
//            case 12:
//                //PLPS
//                listPp = getPenggunaByBPELCasePLPS(stageID, numnegeri, kodCaw, kodJabatan, kodPeranan);
//                break;
//        }
//        return listPp;
//    }
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.equalsIgnoreCase("agihan_tugas")) {
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("agihan_tugas1")) {
...
//    }
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.equalsIgnoreCase("agihan_tugas")) {
                    ...
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("agihan_tugas_ck_T")) {
                    bpelName.add("PPelan");
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.equalsIgnoreCase("agihan_tugas")) {
                    ...
                    bpelName.add("ptgppelan");
                    kodCaw = "00"; //NEEDED TO HARDCODE SINCE URUSAN FROM PTD TO PTG, CANT GET FROM MOHON.KODCAW
                } else if (stageID.equalsIgnoreCase("02agihan_tugas")) {
                    bpelName.add("PPelanptg");
                    kodCaw = "00"; //NEEDED TO HARDCODE SINCE URUSAN FROM PTD TO PTG, CANT GET FROM MOHON.KODCAW
                } else if (stageID.equalsIgnoreCase("A01Terima_kpsn")) {
                    bpelName.add("PPelanptg");
                    kodCaw = "00"; //NEEDED TO HARDCODE SINCE URUSAN FROM PTD TO PTG, CANT GET FROM MOHON.KODCAW
                }
                break;
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.equalsIgnoreCase("agihan_tugas")) {
                    bpelName.add("PPTanahPTG");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("08rekod_keputusan_jkm")) {
                    bpelName.add("PPTanahPTG");
                    kodCaw = "00";
                    ...
                    bpelName.add("PPelanptg");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("16arahan_tugas")) {
                    bpelName.add("ptptgkuasa");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("A01Terima_kpsn")) {
                    bpelName.add("PPelanptg");
                    kodCaw = "00";
            ...
            case 2:
                //NEGERI SEMBILAN
                //TO DO HERE                
                if (stageID.equalsIgnoreCase("04AgihanTugas")) {
                    bpelName.add("PPelanPTG");
                    kodCaw = "00";
                    ...
                    bpelName.add("PPelanPTG");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("33AgihanTugas")) {
                    bpelName.add("PPTanahPTG");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("42AgihanTugas")) {
                    bpelName.add("PPelanPTG");
                    kodCaw = "00";
                } else if (stageID.equalsIgnoreCase("29AgihanTugas")) {
                    bpelName.add("PPelanPTG");
                    kodCaw = "00";
                }
                break;
    ...
    public List<Pengguna> getPenggunaByBPELCaseLSTP(String stageID, int numnegeri, String kodCaw) {
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                if (stageID.equalsIgnoreCase("02ArhnChrtg")) {
                    ...
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("23ArhSedDrfWrt")) {
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("36ArhChrtg")) {
                    bpelName.add("PPelan");
                }
                break;
        }
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.equalsIgnoreCase("agihan_tugas")) {
                    ...
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("semak_rencana")) {                    
                    bpelName.add("PPelan");
                }
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.equalsIgnoreCase("02AghnTgs")) {
                    ...
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("A01SemakAgih")) {
                    bpelName.add("PPTanah");
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                if (stageID.equalsIgnoreCase("agihan_tugas") || stageID.equalsIgnoreCase("agihan_tugas4") || stageID.equalsIgnoreCase("agihan_tugas5")) {
                    ...
                    bpelName.add("ptlupus");
                } else if (stageID.equalsIgnoreCase("02ArhChrtg")) {
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("09agihan_tugas")) {
                    bpelName.add("PPTanah");
                }
                break;
        }
...
//, String kodJabatan, String kodPeranan
        List listPp = new ArrayList<Pengguna>();
        /*
         * NOTE : bpelName refer to BPELGroup of the appointed user..not the
         * current user..
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.equalsIgnoreCase("agihan_tugas")) {
                    bpelName.add("PPelan");
//                            bpelName = pservice.getUser(kodCaw, kodJabatan, kodPeranan);
                } else if (stageID.equalsIgnoreCase("agihan_tugas2")) {
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("agihan_tugas3")) {
                    bpelName.add("PPelan");
...
//        if (bpelName.size() > 0) {
//            listPp = pservice.findPenggunaByBPELPLPS(bpelName, kodCaw, kodJabatan, kodPeranan);
//        }
        return listPp;
    }
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                if (stageID.equalsIgnoreCase("01ArhSedLap")) {
                    bpelName.add("pptkanan");
                } else if (stageID.equalsIgnoreCase("01AArhSedLap")) {
                    bpelName.add("pptkanan");
...
//                }
                if (stageID.equalsIgnoreCase("agih_tugasPP")) {
                    ...
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("terima_ulasan_teknikal")) {
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("semak_agihan_tugas")) {
                    bpelName.add("PPelan");
                    ...
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("arahan_sedia_draf_mmk")) {
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("agih_tugas_tmbhn2")) {
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("arah_precomp_tmbhn2")) {
                    bpelName.add("PPTanah");
                }
            ...
            case 2:
                ...
                if (stageID.equalsIgnoreCase("agih_tugasPP")) {
                    ...
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("agih_tugas_chart_kpsn_L")) {
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("agih_chart_hakmilik")) {
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("arahan_pu")) {
    ...
    public List<Pengguna> getPenggunaByBPELCasePBPTG(String stageID, int numnegeri, String kodCaw) {
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                } else if (stageID.equalsIgnoreCase("02ArahChrtg")) {
                    bpelName.add("PPelan");
        ...
        switch (numnegeri) {
            case 1:
                ...
                if (stageID.equalsIgnoreCase("01Kemasukan")) {
                    bpelName.add("ptlupus");
                } else if (stageID.equalsIgnoreCase("agih_tugasPP")) {
                    bpelName.add("PPelan");
                    ...
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("agih_rekod_index")) {
                    bpelName.add("PPelan");
                }
    ...
    public List<Pengguna> getPenggunaByBPELCasePBGSA(String stageID, int numnegeri, String kodCaw) {
        ...
        switch (numnegeri) {
            case 1:
                ...
                } else if (stageID.equalsIgnoreCase("02agih_tugasPP")) {
                    bpelName.add("PPelan");


                } else if (stageID.equalsIgnoreCase("05MklmArahan")) {
                    bpelName.add("ptlupus");


                } else if (stageID.equalsIgnoreCase("018AghanTgs")) {
                    bpelName.add("PPelan");
                ...
                } else if (stageID.equalsIgnoreCase("029arahan_pu")) {
                    bpelName.add("PPTanah");

                } else if (stageID.equalsIgnoreCase("030arah_precomp")) {
                    bpelName.add("PPTanah");

                } else if (stageID.equalsIgnoreCase("040agih_chart_hakmilik")) {
                    bpelName.add("PPelan");

                } else if (stageID.equalsIgnoreCase("041arahan_rekod_lot_index")) {
                    bpelName.add("PPelan");
    ...
    public List<Pengguna> getPenggunaByBPELCasePRIZ(String stageID, int numnegeri, String kodCaw) {
        ...
        switch (numnegeri) {
            ...
            case 2:
                //NEGERI SEMBILAN                
                if (stageID.equalsIgnoreCase("002")) {
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("008")) {
                    bpelName.add("PPTanah");
                }
                break;
        }
    ...
    public List<Pengguna> getPenggunaByBPELCasePBRZ(String stageID, int numnegeri, String kodCaw) {
        ...
        switch (numnegeri) {
            case 1:
                ...
                } else if (stageID.equalsIgnoreCase("agihanTugas")) {
                    bpelName.add("PPelan");
                ...
                } else if (stageID.equalsIgnoreCase("semak_agihan_tugas2")) {
                    bpelName.add("PPelan");

                } else if (stageID.equalsIgnoreCase("semak_charting_keputusan")) {
                    bpelName.add("PPTanah");
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                if (stageID.equalsIgnoreCase("02ArahanCharting")) {
                    ...
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("31TrmKptsn")) {//33TerimaKpsnArahChart
                    bpelName.add("ptlupus");//PPelan
                }
                break;
        }
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                if (stageID.equalsIgnoreCase("03ArhRjkJbtnTknkl")) {
                    bpelName.add("PPelan");
                } else if (stageID.equalsIgnoreCase("04AgihTugasan")) {
                    bpelName.add("PPelanPTG");
                } else if (stageID.equalsIgnoreCase("semak_charting")) {
                    bpelName.add("PPTanahPTG");
                }
    ...
    public List<Pengguna> getPenggunaByBPELCaseLPJH(String stageID, int numnegeri, String kodCaw) {
    ...
    public List<Pengguna> getPenggunaByBPELCasePJTK(String stageID, int numnegeri, String kodCaw) {
        ...
        switch (numnegeri) {
            ...
            case 2:
                ...
                if (stageID.equalsIgnoreCase("02ArhChrtg")) {
                    ...
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("agihan_tugasan_charting")) {
                    bpelName.add("PPelan");
                }
                break;
        }
     ...
     public List<Pengguna> getPenggunaByBPELCasePLPT(String stageID, int numnegeri, String kodCaw) {
            ...
            case 1:
                //MELAKA
                 if (stageID.equalsIgnoreCase("agih_tugasan")) {
                    ...
                    bpelName.add("ptlupus");
                } else if (stageID.equalsIgnoreCase("09AghnTgs")||stageID.equalsIgnoreCase("semak_agih")) {
                    bpelName.add("PPTanah");
                } else if (stageID.equalsIgnoreCase("36TrmKptsnMMK")) {
                    bpelName.add("PPelan");
                }
