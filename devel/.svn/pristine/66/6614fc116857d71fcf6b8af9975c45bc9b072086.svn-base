...
<div class="subtitle">
    ...
    <s:form name="form1" beanclass="etanah.view.stripes.nota.TambahPihakBerkepentinganActionBean">
        ...
        <s:hidden name="idHakmilikPihakBerkepentingan" id="idHakmilikPihakBerkepentingan" value="${actionBean.hakmilikPihakBETPB.idHakmilikPihakBerkepentingan}"/>
        ...
        <fieldset class="aras1">
            ...
            <c:if test="${moreThanOneHakmilik}">
                <p>
                 ...
                 <p>
                <label for="nama"><font color="red">*</font>Perserahan terlibat :</label>
                        <s:select name="perserahan" style="width:270px" id="jenisPerserahan">
                            <c:if test="${actionBean.hakmilikPihakBETPB.perserahan.idUrusan != null}">
                                <s:option value="${actionBean.hakmilikPihakBETPB.perserahan.idUrusan}">${actionBean.hakmilikPihakBETPB.perserahan.idPerserahan} - ${actionBean.hakmilikPihakBETPB.perserahan.kodUrusan.nama} </s:option>
                            </c:if>
                            <c:if test="${actionBean.hakmilikPihakBETPB.perserahan.idUrusan == null}">
                                <s:option value="">SILA PILIH</s:option>
                            </c:if>                    
                    <s:options-collection collection="${actionBean.hakmilikUrusanBETPB}" label="idPerserahan" value="idUrusan" />${actionBean.hakmilikPihakBETPB.perserahan.kodUrusan.nama}
                </s:select>
            </p>
            <p>
            ...
            <p>
                <label for="nama"><font color="red">*</font>Jenis Pihak Berkepentingan :</label>
                        <s:select name="jenisPihak" style="width:270px" id="jenis_pihak" 
                            ...
                            <c:if test="${actionBean.hakmilikPihakBETPB.jenis.kod != null}">
                                <s:option value="${actionBean.hakmilikPihakBETPB.jenis.kod}">${actionBean.hakmilikPihakBETPB.jenis.nama}</s:option>
                            </c:if>
                            <c:if test="${actionBean.hakmilikPihakBETPB.jenis.kod == null}">
                                <s:option value="">SILA PILIH</s:option>
                            </c:if>                    
            ...
            <p id="syerBersama" style="display:none">
                <label><font color="red">*</font>Syer Bersama :${permohonanPihak.syerBersama}</label>
            ...
            <center>
                <s:button name="kemaskiniPihakBerkepentingan" class="btn" value="Simpan" onclick="save(this.name, this.form);"/>&nbsp;
