<%-- 
    Document   : listKodJtek
    Created on : Jul 10, 2014, 1:49:57 PM
...
<div class= "all">
    <script type="text/javascript">
        ...
        function kemaskini(frm, value,value2) {
            var url = '${pageContext.request.contextPath}/utility_kod/kodJtek?viewKodAgensi&kod='+value+'&table_name='+value2;
            frm.action = url;
            frm.submit();
        }
        function goBack(frm) {
        ...
        function addDokumen(frm, value) {
            var url = '${pageContext.request.contextPath}/utility_kod/kodJtek?viewAddForm&table_name='+value;
            frm.action = url;
            frm.submit();
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KodJtekActionBean" name ="kodAgensi" id ="kodAgensi">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Kod Jabatan Teknikal</legend>
                <%--
                <p>
                ...
                <%--
                <p>
                    <label><font color="red">*</font>Kod Negeri :</label>
                ...
                <%--
                <p>
                    <label><font color="red">*</font>Kod Kategori Agensi :</label>
                ...
                <%--
                <p>
                    <label><font color="red">*</font>Kod Gelaran :</label>
                ...
                --%>
                <p>
                    <label><font color="red">*</font>Kod Daerah :</label>
                        <s:select name="daerah" id="daerah" >
                            <s:option value="0">Pilih</s:option>
                        <s:options-collection collection="${list.senaraiKodDaerah}" label="nama" value="kod" />
                    </s:select>
                </p>
                <p align="center"><s:submit name="KodList2" value="Cari" class="btn"/>&nbsp;<s:button name = "reset" class="btn" value ="Isi Semula" onclick= "clearText('kodAgensi')" />&nbsp;<s:button name = "tambah" class="btn" value ="Tambah" onclick= "addDokumen(document.forms.kodAgensi,'${actionBean.nameTable}')" /></p>
        ...
        <c:if test="${actionBean.flag}">   
            <div class="content" align="center">
                <fieldset class="aras1">
                    <legend>
                        Senarai Kod Jabatan Teknikal
                    </legend>
                    <display:table  name="${actionBean.listKodAgensi}" id="line"  class="tablecloth" pagesize="10" requestURI="${pageContext.request.contextPath}/utility_kod/kodJtek">
