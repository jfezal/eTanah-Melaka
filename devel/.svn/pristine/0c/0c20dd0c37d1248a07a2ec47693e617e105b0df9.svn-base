...
@UrlBinding("/pengambilan/sediaLaporanPemulihanTanah")
public class MaklumSediaLaporanPemulihanTanahActionBean extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(MaklumSediaLaporanPemulihanTanahActionBean.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/maklumLaporanPemulihanTanah.jsp").addParameter("tab", "true");
    }
}
