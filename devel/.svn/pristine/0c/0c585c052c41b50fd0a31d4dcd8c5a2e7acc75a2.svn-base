...
public class ClientService {
    ...
    public StatusForm hantarBorangA(String idPermohonan,PermohonanForm form) {
     ...
     public StatusForm hantarBorangB(String idPermohonan,PermohonanForm form) {
        StatusForm status = new StatusForm();
        MyeTappService service = new MyeTappService();
        WebServices port = service.getUpdateApplication();
       PermohonanService permohonanService = new PermohonanService();
     ...
     public StatusForm hantarMMK(String idPermohonan,PermohonanForm form) {
        StatusForm status = new StatusForm();
        MyeTappService service = new MyeTappService();
        WebServices port = service.getUpdateApplication();
        PermohonanService permohonanService = new PermohonanService();
      ...
      public StatusForm hantarBorangD(String idPermohonan,PermohonanForm form) {
        StatusForm status = new StatusForm();
        MyeTappService service = new MyeTappService();
        WebServices port = service.getUpdateApplication();
        PermohonanService permohonanService = new PermohonanService();
      ...
      public StatusForm hantarSijilUkur(String idPermohonan,PermohonanForm form) {
        StatusForm status = new StatusForm();
        MyeTappService service = new MyeTappService();
        PermohonanService permohonanService = new PermohonanService();
        Permohonan p = permohonanService.setForm(form);
       ...
       public StatusForm hantarHakmilikSambungan(String idPermohonan,PermohonanForm form) {
        StatusForm status = new StatusForm();
        MyeTappService service = new MyeTappService();
        PermohonanService permohonanService = new PermohonanService();
        Permohonan p = permohonanService.setForm(form);
