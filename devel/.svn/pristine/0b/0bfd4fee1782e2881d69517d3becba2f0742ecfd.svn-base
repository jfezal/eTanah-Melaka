...
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/src/main/webapp/pub/js/datetimepicker.js"></script>
    ...
    <script type = "text/javascript">
        ...
        function search(index){
            // alert("search:"+index);
            var url = '${pageContext.request.contextPath}/pelupusan/jabatan_teknikal12?kodAgensiPopup&index='+index;
            window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=910,height=800,scrollbars=yes");
        }

        function search2(index){
            // alert("search:"+index);
            var url = '${pageContext.request.contextPath}/pelupusan/jabatan_teknikal12?kodAgensiPopup2&index='+index;
            window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=910,height=800,scrollbars=yes");
        }

        function addDok(val){
            var url = '${pageContext.request.contextPath}/pelupusan/jabatan_teknikal12?addDokumen&idRujukan='+val;
            window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=910,height=800,scrollbars=yes");
        }
                   ...
                   if(null != chkbox && true == chkbox.checked) {
                       idRujukan = $("#idRujukan"+(i+j-1)).val();
                            ...
                            if(document.getElementById("idRujukan"+(i+j-1)) != null){
                               ...
                               var url = '${pageContext.request.contextPath}/pelupusan/jabatan_teknikal12?deleteRujukan&idRujukan='
                                   +idRujukan;
                                   alert("url"+url)
                               $.get(url,
                               function(data){
...
<s:form beanclass="etanah.view.stripes.pelupusan.JabatanTeknikal2ActionBean" name="teknikal">
