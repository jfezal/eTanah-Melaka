 ...
 */
public class InitiateN8AValidator implements StageListener {
    ...
    private static final Logger LOG = Logger.getLogger(InitiateN8AValidator.class);
...
//        if (permohonan.getKeputusan().getKod().equals("WJ")) {
        ...
        if (!senaraiHakmilik.isEmpty()) {
            ...
            LOG.info("buat urusan tukar ganti 8A");
        ...
        KodUrusan kod = kodUrusanDAO.findById("N8A");
