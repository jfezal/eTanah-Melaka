 ...
 * @author sitinorajar
 */
@UrlBinding("/pelupusan/maklumat_penerimaan_pembayaran_pampasan")
public class MaklumatPenerimaanBayaranPampasanActionBean extends AbleActionBean {
...
//    private KodUOM kodUL;
 ...
 @DefaultHandler
    public Resolution showForm() {
        return new JSP("pelupusan/maklumat_penerimaan_pembayaran_pampasan.jsp").addParameter("tab", "true");
    }  
