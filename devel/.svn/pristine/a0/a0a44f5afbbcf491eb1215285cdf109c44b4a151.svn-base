 ...
 */
@UrlBinding("/pelupusan/maklumat_tanah_rayt")
public class MaklumatTanahRAYTActionBean extends AbleActionBean {

    private static Logger logger = Logger.getLogger(MaklumatTanahRAYTActionBean.class);
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/maklumat_tanah_dipohon_rayt.jsp").addParameter("tab", "true");
    }
    ...
    public void rehydrate() {
        ...
        if (idPermohonan != null) {
            ...
            if (permohonan.getPermohonanSebelum() != null) {
                logger.info("idPermohonanSebelum :" + permohonan.getPermohonanSebelum().getIdPermohonan());
                idPermohonanSblm = permohonan.getPermohonanSebelum().getIdPermohonan();
                hakmilikPermohonan = pelupusanService.findByIdPermohonan(idPermohonanSblm);
                mohonTrizab = pelupusanService.findTanahRizabByIdPermohonan(idPermohonanSblm);
                

            } else {
                logger.info("Tiada Id Permohonan Sebelum");
            ...
            permohonan.getSebab();
            logger.info("permohonan.getSebab() : " + permohonan.getSebab());

            logger.info("hakmilikPermohonan : " + hakmilikPermohonan);
            logger.info("hakmilikPermohonan.getLuasTerlibat : " + hakmilikPermohonan.getLuasTerlibat());
...
//            logger.info("----------------------------permohonan" + permohonan.getSebab());
            ...
            logger.debug("mohonTrizab :" + mohonTrizab);
        }
...
//        logger.info("THIS IS KODDAERAH->"+kod);
    ...
    public static void setLogger(Logger logger) {
        MaklumatTanahRAYTActionBean.logger = logger;
    }
...
//        logger.info("THIS IS KODBPM ->"+kodBpm);
    ...
    public static void setKodDaerahStatic(String kodDaerahStatic) {
        MaklumatTanahRAYTActionBean.kodDaerahStatic = kodDaerahStatic;
    }
