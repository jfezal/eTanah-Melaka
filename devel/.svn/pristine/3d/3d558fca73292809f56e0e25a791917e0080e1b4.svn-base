...
@Entity
@Table(name = "ETAPP_BORANGH")
@SequenceGenerator(name = "seq_ETAPP_BORANGH", sequenceName = "seq_ETAPP_BORANGH")
public class EtappBorangH implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_ETAPP_BORANGH")
    @Column(name = "ID_ET_BH")
    private Long idEtBf;
    @ManyToOne
    @JoinColumn(name = "ID_ET_BE", nullable = false)
    private EtappBorangE etappBorangE;
    @ManyToOne
    ...
    public EtappBorangE getEtappBorangE() {
        return etappBorangE;
    }

    public void setEtappBorangE(EtappBorangE etappBorangE) {
        this.etappBorangE = etappBorangE;
    }
