 ...
 */
public class CetakNotisSiasatanValidatorNew implements StageListener {

    private static final Logger LOG = Logger.getLogger(CetakNotisSiasatanValidatorNew.class);
    @Inject
