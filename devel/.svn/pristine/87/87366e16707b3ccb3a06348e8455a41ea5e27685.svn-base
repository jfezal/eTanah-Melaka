<%-- 
    Document   : kod_dato_Lembaga_popup
    Created on : Sep 15, 2010, 11:18:54 AM
    Author     : Programmer
--%>
...
<script type="text/javascript">
    ...
    <%--alert("v :"+v);--%>
                  var url = "${pageContext.request.contextPath}/hasil/kodDatoLembaga?doCheckKod&kod=" + v;
                  $.get(url,
                  function(data){
    <%--alert("data :"+data);--%>
                          if(data == 'Ada'){
...
<s:form name="kodDato" beanclass="etanah.view.stripes.hasil.KodDatoLembagaActionBean">
    <s:messages/>
    <s:errors />
    <div class="subtitle">
