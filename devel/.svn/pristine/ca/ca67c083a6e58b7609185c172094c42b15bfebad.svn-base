...
public class DisKertasMMKController {
    ...
    private boolean kUlasan = Boolean.TRUE ;
    ...
    public DisKertasMMKController editKertasMMKPTPindaan(){
        DisKertasMMKController disKC = new DisKertasMMKController();
        disKC.setkTajuk(Boolean.TRUE);
        disKC.setkTujuan(Boolean.TRUE);
        disKC.setkLatarBelakang(Boolean.TRUE);
    ...
    public DisKertasMMKController editKertasMMKPTGMLK(){
        DisKertasMMKController disKC = new DisKertasMMKController();
        disKC.setkTajuk(Boolean.TRUE);
        disKC.setkTujuan(Boolean.TRUE);
        disKC.setkLatarBelakang(Boolean.TRUE);
    ...
    public boolean iskUlasan() {
        return kUlasan;
    }

    public void setkUlasan(boolean kUlasan) {
        this.kUlasan = kUlasan;
    }
