<%-- 
    Document   : laporan_tanah_n9
    Created on : May 30, 2011, 11:39:30 AM
    Author     : Rajesh
--%>
...
<script type="text/javascript">
    ...
    function popup(i){
        ...
        var d = $('.x'+i).val();
            window.open("${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?showeditTanahRizab&idTanahRizabPermohonan="+d, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=890,height=600");
}


function refreshRizab(){
var url = '${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?refreshpage';
$.get(url,
function(data){
$('#page_div').html(data);
},'html');
...
function addImageUtara(){
    ...
    var idDokumen = document.getElementById("utaraImej").options[document.getElementById("utaraImej").selectedIndex].value;
        $.post('${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?addLaporanImage&pandanganImej=U&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
                function(data){
                    $('#page_div').html(data);
                }, 'html');
}
...
function addImageSelatan(){
    ...
    var idDokumen = document.getElementById("selatanImej").options[document.getElementById("selatanImej").selectedIndex].value;
        $.post('${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?addLaporanImage&pandanganImej=S&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
                function(data){
                    $('#page_div').html(data);
                }, 'html');
}
...
function addImageTimur(){
    ...
    var idDokumen = document.getElementById("timurImej").options[document.getElementById("timurImej").selectedIndex].value;
        $.post('${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?addLaporanImage&pandanganImej=T&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
                function(data){
                    $('#page_div').html(data);
                }, 'html');
}
...
function addImageBarat(){
    ...
    var idDokumen = document.getElementById("baratImej").options[document.getElementById("baratImej").selectedIndex].value;
        $.post('${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?addLaporanImage&pandanganImej=B&idDokumen='+idDokumen+'&idHakmilik='+idHakmilik,
                function(data){
                    $('#page_div').html(data);
                }, 'html');
}
...
function doViewReport(rowNo) {
    ...
    function tambahBangunan(kategori){
        var idHakmilik = '${actionBean.hakmilik.idHakmilik}';
        window.open("${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?tambahBangunanPopup&idHakmilik="+idHakmilik+'&kategori='+kategori, "eTanah",
    ...
    function editLaporanBangunan(idLaporBangunan){
        ...
        window.open("${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?editBangunanPopup&idHakmilik="+idHakmilik+'&idLaporBangunan='+idLaporBangunan, "eTanah",
        "status=0,toolbar=0,location=0,menubar=0,width=910,height=800");
    }
    ...
    function uploadForm(idHakmilik,pandanganImej) {
        ...
        var url = '${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?uploadDoc&idHakmilik='+idHakmilik+'&pandanganImej='+pandanganImej;
    ...
    function refresh(idHakmilik){
            if(idHakmilik !=''){
                var url = '${pageContext.request.contextPath}/pengambilan/laporanTanahPengambilan_n9?hakmilikDetails&idHakmilik='+idHakmilik;
                $.get(url,
                function(data){
                    $('#page_div').html(data);
                },'html');
...
<s:form beanclass="etanah.view.stripes.pengambilan.LaporanTanahPengambilanN9ActionBean">
    <s:messages/>
            ...
            <fieldset class="aras1">
                ...
                <div class="content" align="center">
                        <display:table class="tablecloth" name="${actionBean.permohonan.senaraiHakmilik}" pagesize="5" cellpadding="0" cellspacing="0"
                                       requestURI="/pengambilan/laporanTanahPengambilan_n9" id="line">
                            <display:column title="No" sortable="true">${line_rowNum}</display:column>
                            <display:column title="ID Hakmilik">
                                <s:link beanclass="etanah.view.stripes.pengambilan.LaporanTanahPengambilanN9ActionBean"
            ...
            <c:if test="${actionBean.hakmilik ne null}">
                ...
                <div class="content" align="center" id="perusahaan" style="display:none" >
                    ...
                    <table >
                        ...
                        <tr>
                            <td><label>Ulasan Penolong Pegawai Tanah dengan mereka berkepentingan (Tidak Berdaftar) :</label></td>
                            <td>
           ...
           <%-- <c:if test="${edit}">--%>
                ...
                <table>
                        ...
                        <tr>
                            ...
                            <br>
                            <br>
                          <%--<p>  <label>--%>&nbsp;&nbsp;&nbsp;&nbsp;Penolong Pegawai Tanah Kanan<%--</label></p>--%>
                          <br>
                          <br>
                        <div class="content" align="center">
                            <table>
    ...
    <c:if test="${actionBean.view eq 'true'}">
        ...
        <fieldset class="aras1">
           ...
           <%-- <c:if test="${edit}">--%>
                ...
                <table>
                        <tr>
                            <td>Ulasan mengenai keluasan tanah-tanah yang <br>hendak dibuat pengambilan samada luasnya <br>mengikutpelan yang dikemukakan pemohon <br>atau berbeza.Jika berbeza, berikan alasan-alasan
                            </td>
                            <td>
                                :
                            </td>
