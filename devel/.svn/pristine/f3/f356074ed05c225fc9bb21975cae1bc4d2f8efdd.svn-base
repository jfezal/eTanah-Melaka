...
<div class= "all">
     ...
     maximizeWindow();
        ...
        function removeNonNumeric( strString )
        {
         ...
         function goTo(frm, value,value2) {
           ...
           var url = '${pageContext.request.contextPath}/utility_kod/kodDokumen?updateData&table_name='+value+'&kod='+value2;
            frm.action = url;
            frm.submit();
            }
        }
    ...
    <s:form beanclass="etanah.view.utility.kod.KodDokumenActionBean" name ="kemaskiniKodDokumen" id ="kemaskiniKodDokumen">
        <s:messages/>
        <s:errors/>
        <div class ="subtitle displaytag">
            <fieldset class ="aras1">
                <legend>Kemaskini Kod Dokumen </legend>
                 ...
                 <p><label><font color="red">*</font>Nama :</label>
                  ...
                  <p><label><font color="red">*</font>Kawal Capaian :</label>
                            <s:text id="kawalCapaian" name="details.kawalCapaian" value ="${actionBean.details.kawalCapaian}"></s:text>
                </p>
                <p><label><font color="red">*</font>Penjana :</label>
                            <s:text id="penjana" name="details.penjana" value ="${actionBean.details.penjana}"></s:text>
                </p>
               ...
               <p><label><font color="red">*</font>Dimasukkan Oleh    :</label>${actionBean.details.infoAudit.dimasukOleh.idPengguna}
                ...
                <p><label><font color="red">*</font>DiKemaskini Oleh    :</label>${actionBean.details.infoAudit.dikemaskiniOleh.idPengguna}
                 ...
                 <br/><br/><br/>
                 <p align="center"><s:submit name="updateData" onclick="goTo(document.forms.kemaskiniKodDokumen,'${actionBean.nameTable}','${actionBean.kod}')" value="Simpan" class="btn"/>&nbsp;<s:button name ="kembali" class="btn" value ="Kembali" onclick="goTo2(document.forms.kemaskiniKodDokumen,'${actionBean.nameTable}')"/></p>
