<%-- 
    Document   : dev_kertasMMK_kodSy
    Created on : May 26, 2014, 12:14:53 PM
...
<script type="text/javascript">
    ...
    function searchKodSyaratNyata(idPlot,forEdit){
        var url = '${pageContext.request.contextPath}/pembangunan/kertas_mmk?showFormCariKodSyaratNyataKertasMMK&idPlot='+idPlot+'&forEdit='+forEdit;
    ...
    function searchKodSekatan(idPlot,forEdit){
        var url = '${pageContext.request.contextPath}/pembangunan/kertas_mmk?showFormCariKodSekatanKertasMMK&idPlot='+idPlot+'&forEdit='+forEdit;
                ...
                <table border="0" width="85%" align="center" cellspacing="5">
                    ...
                    <c:if test = "${actionBean.forEdit eq 'NY'}">                                   
                        <tr>
                            ...
                            <td><b>:  </b></td>
                            <td>
                                <s:textarea name="kodSyaratNyataMpp" id="syaratNyata" readonly="readonly" rows="5" cols="80"/>                                                                             
                            </td>
                        </tr>
                    </c:if>
                    ...
                    <c:if test = "${actionBean.forEdit eq 'SK'}">  
                        <tr>
                            ...
                            <td><b>:  </b></td>
                            <td>
                                <s:textarea name="kodSekatanKepentinganBaruMpp" readonly="readonly" id="sekatan" rows="8" cols="80"/>                                                                                                        
                            </td>
                        </tr>
                    </c:if>
                </table>
