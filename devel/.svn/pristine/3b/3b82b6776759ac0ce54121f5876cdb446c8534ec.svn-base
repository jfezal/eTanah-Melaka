                            ...
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        ...
                                        <c:when test="${!empty actionBean.disLaporanTanahSempadan.statusSempadan}">
                                            <s:checkbox id="noLotChecked" title="No Lot" name="noLotChecked" value="lot" disabled="true"/>&nbsp;No Lot&nbsp;
                                            <s:checkbox id="idHakmilikChecked" name="idHakmilikChecked" value="hakmilik" checked="true" disabled="true"/>&nbsp;ID Hakmilik
                                        </c:when>    
                                        <c:otherwise>
