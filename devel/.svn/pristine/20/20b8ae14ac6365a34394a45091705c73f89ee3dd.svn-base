 ...
 * @edited by Afham
 */
@UrlBinding("/pengambilan/melaka/sedia_jabatan")
public class JabatanTeknikalActionBean extends AbleActionBean {
    ...
    public Resolution showForm() {
        ...
        return new JSP("pengambilan/melaka/pendudukansementara/sedia_jabatan_teknikal.jsp").addParameter("tab", "true");
    }
...
//             */
//            String stringAgensi = new String("6006");
//            permohonanRujukanLuar = pelupusanService.findIDPermohonanRujByIdPermohonanNKodAgensi(idPermohonan,stringAgensi);
//            InfoAudit info = new InfoAudit();
//            if(permohonanRujukanLuar!=null){
//                info = permohonanRujukanLuar.getInfoAudit();
//                info.setDiKemaskiniOleh(pguna);
...
//        prs = pelupusanService.findSalinan(String.valueOf(permohonanRujukanLuar.getIdRujukan()));
        ...
        return new JSP("pengambilan/melaka/pendudukansementara/edit_jabatan_teknikal.jsp").addParameter("popup", "true");
...
//            setJangkaMasa_hari(pprl.getTempohHari
        ...
        return new JSP("pengambilan/melaka/pendudukansementara/edit_jabatan_teknikal.jsp").addParameter("tab", "true");
...
//        senaraiRujukLuar =pelupusanService.
        ...
        return new JSP("pengambilan/melaka/pendudukansementara/pilih_agensi.jsp").addParameter("popup", "true");
    }
...
//       String ditundatangan = getContext().getRequest().getParameter("ditundatangan");
        ...
        if (permohonan != null) {
            if (permohonan.getKodUrusan().getKod().equals("LMCRG") || permohonan.getKodUrusan().getKod().equals("PJLB") || permohonan.getKodUrusan().getKod().equals("MLCRG") || permohonan.getKodUrusan().getKod().equals("MPJLB")) {
...
//        return new ForwardResolution("/WEB-INF/jsp/pelupusan/common/sedia_jabatan_teknikal.jsp").addParameter("tab", "true");
    ...
    public Resolution kodAgensiPopup2() {
        ...
        return new JSP("pengambilan/melaka/pendudukansementara/pilih_salinan_agensi.jsp").addParameter("popup", "true");
    }
    /*
    ...
    public Resolution kodAgensiPopup3() {
        ...
        return new JSP("pengambilan/melaka/pendudukansementara/pilih_dokumen_serta.jsp").addParameter("popup", "true");
    }
...
//code changed by rohan
        if (kod != null) {
            ...
            if (listKodAgensi.size() < 1) {
                ...
                getContext().getRequest().setAttribute("agensi", Boolean.TRUE);
                return new JSP("pengambilan/melaka/pendudukansementara/tambah_agensi.jsp").addParameter("popup", "true");
...
//            kodAgensi.setKodKementerian(1); //TODO: list kod_kementerian
    ...
    public Resolution simpanAgensi() {
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/melaka/pendudukansementara/sedia_jabatan_teknikal.jsp").addParameter("tab", "true");
    }
...
//      edit();
        ...
        return new ForwardResolution("/WEB-INF/jsp/pengambilan/melaka/pendudukansementara/edit_jabatan_teknikal.jsp").addParameter("popup", "true");
