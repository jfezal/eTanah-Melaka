...
<html>
    ...
    <body>
        <s:form beanclass="etanah.view.stripes.pengambilan.SediaSuratPenolakanActionBean">
           <s:messages/>
           <s:errors/>
           <div class="subtitle">
                <fieldset class="aras1">
                    ...
                    <div class="content" align="">
                        <table border="0">
                            ...
                            Sila klik pada butang jana dokumen untuk penyediaan surat penolakan
                            </font>
                        </table>
                    </div>
                </fieldset>
