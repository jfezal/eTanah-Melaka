...
<s:form beanclass="etanah.view.stripes.pembangunan.RayuanAnsuranActionBean">
    <s:messages/>
    <s:errors/>    
    <c:if test = "${actionBean.permohonan.kodUrusan.kod eq 'RBPA'}">
    <p><font color="red">*Sila masukkan tarikh surat rayuan dari pemohon. </font></p>
    <div class="subtitle">
    ...
    <c:if test = "${actionBean.permohonan.kodUrusan.kod eq 'RNS'}">
    <p><font color="red">*Sila masukkan tarikh rujukan surat JPPH. </font></p>
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>Rekod Tarikh Tandatangan</legend>
                <p>
