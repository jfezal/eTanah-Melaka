...
@UrlBinding("/pengambilan/drafWartaDiPPK")
public class pemberitahuanDrafWartaDiPPPK extends AbleActionBean
{
    private static Logger logger = Logger.getLogger(pemberitahuanDrafWartaDiPPPK.class);
    @Inject
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/maklumJanaDrafWartaPB.jsp").addParameter("tab", "true");
    }
}
