 ...
 */
@UrlBinding("/strata/janaGeran")
public class JanaGeranBerperingkatActionBean extends AbleActionBean {

    private static final Logger LOG = Logger.getLogger(JanaGeranBerperingkatActionBean.class);
    ...
    public Resolution showForm() {
        return new JSP("strata/pbbm/janaGeranPeringkat.jsp").addParameter("tab", "true");
    ...
    public void rehydrate() {
        ...
        senaraiHakmilikTerlibat = strService.findHakmilikStrataTByHakmilikInduk(idHakmilik);
    ...
    public Resolution janaGeran() {
        ...
        for (int i = 0; i < splitChar.length; i++) {
            if (!splitChar[i].equalsIgnoreCase("")) {
                ...
                Hakmilik hm = strService.findInfoByIdHakmilik(idHakmilikStrata);
                if (hm.getKodKategoriBangunan().getKod().equals("B") || hm.getKodKategoriBangunan().getKod().equals("L")) {
                    ...
                    //5.==================================================================
                    LOG.info("--Generating PSK--::");

                    values = new String[]{idPermohonan.trim(), idHakmilikStrata};
                    params = new String[]{"p_id_mohon", "p_id_hakmilik"};
                    kodDoc = "UTILITIPSK_MLK.rdf";
                    kd5.setKod("PSK");
                    ...
                    //1.==================================================================
                    LOG.info("--Generating 4AKDH--::");

                    String idPermohonan = permohonan.getIdPermohonan();
                    values = new String[]{idPermohonan.trim(), idHakmilikStrata};
                    params = new String[]{"p_id_mohon", "p_id_hakmilik"};
                    kodDoc = "STRB4AKDHDK5_MLK.rdf";
                    kd5.setKod("4AKDH");
                    ...
                    reportUtil.generateReport(kodDoc, params, values, dokumenPath + path, pengguna);
                    updatePathDokumen(reportUtil.getDMSPath(), b.getIdDokumen());
                    LOG.info("--Generated 4AKDH--::");

                    //2.==================================================================
                    LOG.info("--Generating 4AKKK--::");

                    values = new String[]{idPermohonan.trim(), idHakmilikStrata};
                    params = new String[]{"p_id_mohon", "p_id_hakmilik"};
                    kodDoc = "STRB4AKDHKK5_MLK.rdf";
                    kd5.setKod("4AKKK");
...
//        Hakmilik hakmilik = hakmilikPermohonan.getHakmilik();
//
//        String idHakmilikInduk = null;
//
//        if (hakmilik.getIdHakmilikInduk() != null) {
//            idHakmilikInduk = hakmilik.getIdHakmilikInduk();
//        } else {
//            idHakmilikInduk = hakmilik.getIdHakmilik();
//        }
//        
//        String idPermohonan = permohonan.getIdPermohonan();
//
...
//        values = new String[]{idPermohonan.trim(), idHakmilikInduk};
//        params = new String[]{"p_id_mohon", "p_id_hakmilik"};
//        kodDoc = "STRB2K5_MLK.rdf";
//        kd5.setKod("2K");
//
//        b = saveOrUpdateDokumen(fd, kd5, idHakmilikInduk);
//        path = permohonan.getFolderDokumen().getFolderId() + File.separator + String.valueOf(b.getIdDokumen());
//        LOG.info("::Path To save :: " + path);
//        LOG.info("::Report Name ::" + kodDoc);
//        syslog.info(pengguna.getIdPengguna() + " generate report " + kd5.getKod() + " for :" + idHakmilikInduk + " and saving it to:" + path);
//        reportUtil.generateReport(kodDoc, params, values, dokumenPath + path, pengguna);
//        updatePathDokumen(reportUtil.getDMSPath(), b.getIdDokumen());
...
//        LOG.info("--Generated 3K--::");
        ...
        return new RedirectResolution(JanaGeranBerperingkatActionBean.class, "showForm");
    }
