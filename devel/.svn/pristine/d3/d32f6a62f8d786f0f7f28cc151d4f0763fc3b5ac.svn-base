            ...
            <fieldset class="aras1">
                ...
                <div align="center">
                    ...
                    <table class="tablecloth" width="70%">
                        ...
                        <tr><td>Nama :</td><td class="s">${actionBean.hpBerkepentingan.nama}</td>
                                <td class="s">
                                <s:text name="nama" onkeyup="this.value=this.value.toUpperCase();"/>
                            </td></tr>

                        <tr><td>Jenis Pengenalan :</td><td class="s">${actionBean.hpBerkepentingan.jenisPengenalan.nama}</td>
                                <td class="s">
                        ...
                        <tr><td>No. Pengenalan :</td><td class="s">${actionBean.hpBerkepentingan.noPengenalan}</td>
                                <td class="s">
                                <s:text name="noPengenalan" maxlength="25" onkeyup="this.value=this.value.toUpperCase();"/>
                            </td></tr>
                        <tr><td>No. Pengenalan Lama:</td><td class="s">${actionBean.hpBerkepentingan.noPengenalanLama}</td>
                                <td class="s">
                                <s:text name="noPengenalanLama" maxlength="25" onkeyup="this.value=this.value.toUpperCase();"/>
                            </td></tr>

                        <tr><td>Warganegara :</td><td class="s">${actionBean.hpBerkepentingan.wargaNegara.nama}</td>
                            <td class="s">
                        ...
                        <tr><td>Pembilang / Penyebut :</td><td class="s">${actionBean.hpBerkepentingan.syerPembilang}/${actionBean.hpBerkepentingan.syerPenyebut}</td>
                            <td class="s">
                                ...
                                <s:text name="pembilang" class="pembilang" 
                                        onblur="updateSyer('${actionBean.hpBerkepentingan.idHakmilikPihakBerkepentingan}')" onchange="updateSyer('${actionBean.hpBerkepentingan.idHakmilikPihakBerkepentingan}'" style="width:46% !important;"/> / <s:text name="penyebut" class="penyebut" onblur="updateSyer('${hpBerkepentingan.idHakmilikPihakBerkepentingan}')" onchange="updateSyer('${hpBerkepentingan.idHakmilikPihakBerkepentingan}'" style="width:46% !important;"/>
                            </td></tr>
                        <tr><td>Syarikat Tubuh :</td><td class="s">${actionBean.hpBerkepentingan.penubuhanSyarikat.nama}</td>
                            <td class="s">
                        ...
                        <tr><td>Alamat :</td><td class="s">${actionBean.hpBerkepentingan.alamat1}</td>
                                <td class="s">
                                <s:text name="alamat1" id="alamat1"/>
                            </td></tr>

                        <tr><td>&nbsp;</td><td class="s">${actionBean.hpBerkepentingan.alamat2}</td>
                                <td class="s">
                                <s:text name="alamat2" id="alamat2"/>
                            </td></tr>

                        <tr><td>&nbsp;</td><td class="s">${actionBean.hpBerkepentingan.alamat3}</td>
                                <td class="s">
                                <s:text name="alamat3" id="alamat3"/>
                            </td></tr>

                        <tr><td>&nbsp;</td><td class="s">${actionBean.hpBerkepentingan.alamat4}</td>
                                <td class="s">
                                <s:text name="alamat4" id="alamat4"/>
                            </td></tr>

                        <tr><td>Poskod :</td><td class="s">${actionBean.hpBerkepentingan.poskod}</td>
                                <td class="s">
                        ...
                        <tr><td>Negeri :</td><td class="s">${actionBean.hpBerkepentingan.negeri.nama}</td>
                                <td class="s">
                        ...
                        <tr><td colspan="3">
                                <div align="center">
                                    <s:button name="saveBetulPB" value="Simpan" class="btn" onmouseover="this.style.cursor='pointer';" onclick="save(this.name, this.form, '${actionBean.hpBerkepentingan.idHakmilikPihakBerkepentingan}', '${actionBean.hpBerkepentingan.idHakmilikPihakBerkepentingan}')"/>
