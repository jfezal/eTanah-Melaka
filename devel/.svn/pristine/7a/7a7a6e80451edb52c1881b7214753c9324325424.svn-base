...
//      }
  ...
  function simpanUrusan() {
    ...
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?simpanUrusan' + param;
  ...
  function updateUrusan() {
    ...
    doBlockUI();
//    alert($("#kodSerah").val());
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?updateUrusan';
    frm = document.tambahUrusan;
    frm.action = url;
    frm.submit();
  }
...
//        alert(param);
    ...
    var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?updateUrusan' + param;
    frm = document.tambahUrusan;
    frm.action = url;
    frm.submit();
  }
...
//      alert("id urusan : " + val);
      var url = '${pageContext.request.contextPath}/daftar/utiliti/kutipanData?hapusMohonHbgn&idP=' + val;
      frm = document.tambahUrusan;
      frm.action = url;
      frm.submit();
    }
          ...
          <div align="center">
            ...
            <table class="tablecloth" width="90%" style="margin-left: auto; margin-right: auto;">
              ...
              <c:if test="${actionBean.hakmilikUrusan.kodUrusan.kodPerserahan.kod eq 'SC'}">
                ...
                <c:if test="${actionBean.hakmilikUrusan.kodUrusan.kod eq 'GDL' or actionBean.hakmilikUrusan.kodUrusan.kod eq 'JMGD'}">
                <tr>
                  <td id="tdLabel">No Perserahan Terlibat :&nbsp</td>
                  <td id="tdDisplay">    
                    <s:text name="noPerserahanTarik" id="noPerserahanTarik" size="30" maxlength="16"/>
                  </td>
                </tr>
                </c:if>
                <tr>
              ...
              <c:if test="${actionBean.hakmilikUrusan.kodUrusan.kodPerserahan.kod eq 'B'}">
                  <c:if test="${actionBean.hakmilikUrusan.kodUrusan.kod eq 'KVSTB'
                                or actionBean.hakmilikUrusan.kodUrusan.kod eq 'KVPB'}">
                        <tr>
                            <td id="tdLabel">No Perserahan Terlibat :&nbsp</td>
                            <td id="tdDisplay">
                                <s:text name="noPerserahanTarik" id="noPerserahanTarik" size="30" maxlength="16"/>
