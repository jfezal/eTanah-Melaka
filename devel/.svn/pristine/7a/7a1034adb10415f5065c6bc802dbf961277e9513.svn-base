...
import etanah.sequence.GeneratorNoSiriPermit ;

/**
 *
 * @author sitifariza.hanim
 */
@UrlBinding("/pelupusan/borang4c_batuan")
public class Borang4CBatuanActionBean extends AbleActionBean {
    ...
    @Inject
    GeneratorNoSiriPermit generatorNoSiriPermit;
    @Inject
    ...
    private PermohonanTuntutanBayar permohonanTuntutanBayar3 ;
    ...
    public Resolution showForm() {
        view = Boolean.FALSE ;
        return new JSP("pelupusan/batuan/penyediaan_borang4C.jsp").addParameter("tab", "true");
    }
        ...
        if (idPermohonan != null) {
            ...
            if (senaraiMohonTuntutKos != null) {
                for (PermohonanTuntutanKos ptk : senaraiMohonTuntutKos) {
                    ...
                    if (ptk.getKodTuntut() != null && ptk.getKodTuntut().getKod().equalsIgnoreCase("DISCJ")) {
                        permohonanTuntutanBayar3 = pelupusanService.findMohonTuntutBayar(ptk.getIdKos());
                    }
                }
            }
        }
...
//            }
          ...
          KodJenisPermit kodJenis = kodJenisPermitDAO.findById("C") ;
...
//                  maxSiri = 1;
//              }
            String sequenceNoSiri = generatorNoSiriPermit.generate(conf.getProperty("kodNegeri"), peng.getKodCawangan(), permitSahLakuTemp);
             log.info("-----Generate No Siri ----" + sequenceNoSiri);
           permitSahLakuTemp.setNoSiri(sequenceNoSiri) ;
        }     
...
//         log.info(ppi) ;
        ...
        permohonanBahanBatuan = pelupusanService.findPermohonanBahanBatuanByIdMohon(idPermohonan);
            ...
            PermohonanTuntutan mohonTuntut = pelupusanService.findPermohonanTuntutanByIdMohonAndKodTransTuntut(idPermohonan, "DIS4C");
            if(mohonTuntut == null){
                ...
                mohonTuntut.setKodTransaksiTuntut(kodTransaksiTuntutDAO.findById("DIS4C"));
...
//            }
    ...
    public PermohonanTuntutanBayar getPermohonanTuntutanBayar3() {
        return permohonanTuntutanBayar3;
    }

    public void setPermohonanTuntutanBayar3(PermohonanTuntutanBayar permohonanTuntutanBayar3) {
        this.permohonanTuntutanBayar3 = permohonanTuntutanBayar3;
    }
