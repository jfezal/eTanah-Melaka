 ...
 * @author Srinivas
 */
@UrlBinding("/pelupusan/kertas_makluman_ns")
public class KertasMaklumanN9ActionBean extends AbleActionBean {
    ...
    private static final Logger LOG = Logger.getLogger(KertasMaklumanN9ActionBean.class);
    ...
    public Resolution showForm() {
         return new JSP("pelupusan/kertas_makluman_N9.jsp").addParameter("tab", "true");
    }
     ...
     peng = (Pengguna) getContext().getRequest().getSession().getAttribute(etanahActionBeanContext.KEY_USER);
        if(permohonan != null){
           ...
           //saving Mohon Kertas
            ...
            permohonanKertasTemp = pelupusanService.findPermohonanKertasByIdPermohonanNKodDokumen(idPermohonan, "MKLM");
            ...
            if(permohonanKertasTemp==null){
                ...
                kodDok = kodDokumenDAO.findById("MKLM");
           ...
           edit2 = (mohonKertasKandListThree.size() > 1) ? false : true;
           int bill4 = 4;
           ...
           edit3 = (mohonKertasKandListFour.size() > 0) ? false : true;
            ...
            if (laporanTanah != null) {
                ...
                listLaporTanahSpdnTemp = pelupusanService.findLaporTanahSmpdnByIdLaporNJSmpdn(laporanTanah.getIdLaporan(),"U"); // UTARA
                ...
                listLaporTanahSpdnTemp = pelupusanService.findLaporTanahSmpdnByIdLaporNJSmpdn(laporanTanah.getIdLaporan(),"S"); // SELATAN
                for(LaporanTanahSempadan lts: listLaporTanahSpdnTemp){
                    LotSempadan ls = new LotSempadan();
                    ls.setLaporanTanahSmpdn(lts);
                ...
                listLaporTanahSpdnTemp = new ArrayList<LaporanTanahSempadan>();
                listLaporTanahSpdnTemp = pelupusanService.findLaporTanahSmpdnByIdLaporNJSmpdn(laporanTanah.getIdLaporan(),"T"); // TIMUR
                for(LaporanTanahSempadan lts: listLaporTanahSpdnTemp){
                    LotSempadan ls = new LotSempadan();
                    ls.setLaporanTanahSmpdn(lts);
                ...
                listLaporTanahSpdnTemp = new ArrayList<LaporanTanahSempadan>();
                listLaporTanahSpdnTemp = pelupusanService.findLaporTanahSmpdnByIdLaporNJSmpdn(laporanTanah.getIdLaporan(),"B"); // BARAT
                for(LaporanTanahSempadan lts: listLaporTanahSpdnTemp){
                    LotSempadan ls = new LotSempadan();
                    ls.setLaporanTanahSmpdn(lts);
         ...
         if(index.equals("1")){
             ...
             if(mohonKertasKandListThree.size() > 0){
                 ...
                 if(kandungan_ref != null && !kandungan_ref.equals("")){
                  ...
                  if(kandungan_ref_in != null && !kandungan_ref_in.equals("")){
                      permohonanKertasKandungan = new PermohonanKertasKandungan();
                      permohonanKertasKandungan.setKertas(permohonanKertasTemp);
                      permohonanKertasKandungan.setCawangan(permohonan.getCawangan());
                      permohonanKertasKandungan.setBil(3);
                      permohonanKertasKandungan.setSubtajuk("1");
                      permohonanKertasKandungan.setKandungan(kandungan_ref_in);
                      ia = new InfoAudit();
                      ia.setDimasukOleh(peng1);
                      ia.setTarikhMasuk(new java.util.Date());
                      permohonanKertasKandungan.setInfoAudit(ia);
    ...
    public Resolution deleteRow() throws Exception {
        ...
        return new RedirectResolution(KertasMaklumanN9ActionBean.class, "locate");
    }
