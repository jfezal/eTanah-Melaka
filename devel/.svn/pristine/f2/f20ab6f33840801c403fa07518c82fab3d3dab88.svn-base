 ...
 * @modified am
 */
@UrlBinding("/pelupusan/draf_mmk_mlk")
public class DrafMMKNMlkActionBean extends AbleActionBean {

    Logger LOG = Logger.getLogger(DrafMMKNMlkActionBean.class);
    @Inject
...
//    BPelService service;
    ...
    public Resolution showForm() {
        ...
        return new JSP("pelupusan/gsa/draf_mmk_penamatan_mlk.jsp").addParameter("tab", "true");
    }
...
//        
         ...
         tajuk1 = "PERMOHONAN UNTUK MENGELUARKAN " +tajukLot+" "+noLot+ "  " + " SELUAS LEBIH KURANG " + luas + " " + kodUnitLuas + 
                  " " + "DI " + lokasi + ", " + bpm + ", DAERAH " + daerah+
                  " " + "DARI KAWASAN PENEMPATAN BERKELOMPOK DI BAWAH SEKSYEN 44 AKTA TANAH (KAWASAN-KAWASAN PENEMPATAN BERKELOMPOK) 1960  " + ".";
         if(!lokasi.isEmpty()){
             lokasi = pelupusanUtiliti.convertStringtoInitCap(lokasi);
         }
         tujuan = "\n" + "Tujuan kertas ini ialah untuk mendapatkan pertimbangan Majlis Mesyuarat Kerajaan Negeri Melaka mengenai permohonan untuk mengeluarkan "+tajukLot+" "+noLot
         ...
         * BIL 2
         */
         perihalPemohon21 = "Pentadbir Tanah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" telah menerima permohonan daripada "+convNama+" untuk mengeluarkan tanah "+tajukLot+" "+noLot
                            +" seluas lebih kurang "+ luas +" "+kodUnitLuas+" di "+lokasi+", "+pelupusanUtiliti.convertStringtoInitCap(bpm)+", Daerah "+pelupusanUtiliti.convertStringtoInitCap(daerah)+" dari kawasan penempatan berkelompok di bawah Seksyen 44 Akta Tanah (Kawasan-kawasan Penempatan Berkelompok) 1960."
...
//        }
        ...
        if (currentStageId.equals("06SediaDrafMMK")) {
            simpanNew();
        }
    }
...
//        }
        ...
        rehydrate();
        return new JSP("pelupusan/gsa/draf_mmk_penamatan_mlk.jsp").addParameter("popup", "true");
...
//                pelupusanService.simpanPermohonanKertasKandungan(permohonanKertasKandungan1);
        ...
        // END : LPS
        return new ForwardResolution("/WEB-INF/jsp/pelupusan/gsa/draf_mmk_penamatan_mlk.jsp").addParameter("tab", "true");
    }
