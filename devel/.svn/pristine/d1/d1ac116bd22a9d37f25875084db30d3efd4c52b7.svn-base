...
<script type="text/javascript">
    ...
    <c:choose>
        ...
        function uploadForm(pandanganImej) {
            ...
            var idHakmilik = $('#idHakmilik').val();
            //            alert(idLapor);
            window.open("${pageContext.request.contextPath}/pelupusan/laporan_tanahV2?uploadDoc&pandanganImej="+pandanganImej+"&idLapor="+idLapor+"&idHakmilik="+idHakmilik, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
