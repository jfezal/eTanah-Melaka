...
<script type="text/javascript">
    ...
    <c:choose>
        <c:when test="${actionBean.hakmilikPermohonan.kodHakmilikSementara.kod eq 'GRN'}">
                $('#jikaPajakan').hide(); 
        </c:when>
        <c:when test="${actionBean.hakmilikPermohonan.kodHakmilikSementara.kod eq 'GM'}">
                $('#jikaPajakan').hide(); 
        </c:when>            
        <c:otherwise>
                $('#jikaPajakan').show();
    ...
    <c:if test="${actionBean.hakmilikPermohonan.kategoriTanahBaru ne null}">
        ...
        function listkegunaantanah(){
            ...
            //alert(val);
            var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?carianIndependent&katTanahPilihan='+katTanahPilihan;
        ...
        function addRow(index,f)
        {
            ...
            var url = '${pageContext.request.contextPath}/pembangunan/laporanTanahv2?tambahRow&index='+index+'&kodksn='+kodksn+'&ksn='+kpsn;
        ...
        function deleteRow(idKandungan,f,tName)
        {
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}/pembangunan/laporanTanahv2?deleteRow&idKandungan='+idKandungan+'&tName='+tName+'&typeName=PPT&ksn='+kpsn,q,
                function(data){
                    $('#page_div').html(data);
        ...
        function cariPopup(val){
            NoPrompt();
            window.open("${pageContext.request.contextPath}/pembangunan/laporanTanahv2?searchSyarat&jenisSyarat="+val, "eTanah",
        ...
        function filterKodGunaTanah() {
            ...
            $.post('${pageContext.request.contextPath}/pembangunan/laporanTanahv2?senaraiKodGunaTanahByKatTanah&kodKatTanah=' + katTanah,
            function(data) {
                if (data != '') {
        ...
        function kiraCukai(f) {
            ...
            var q = $(f).formSerialize();
            $.post('${pageContext.request.contextPath}/pembangunan/laporanTanahv2?kiraCukai&kodTanah=' + kodTanah , q,
            function(data) {
                if (data == '-1') {
                } else {
