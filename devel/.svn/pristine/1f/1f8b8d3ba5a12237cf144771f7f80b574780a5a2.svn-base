<%-- 
    Document   : pru_rekod_keputusan_MMK
    Created on : Dec 22, 2009, 9:47:36 AM
...
<s:form beanclass="etanah.view.pelupusan.PelupusanActionBean">
    <p>REKOD KEPUTUSAN MAJLIS MESYUARAT KERAJAAN</p>
    <div class="subtitle">
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                ...
                Pemberimilikan di bawah Sek. 76, Kanun Tanah Negara
            </p>
            <p>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            <legend>
                Keputusan Jawatankuasa Tanah Negeri
            </legend>
            <p>
                <label for="ID Berkaitan"> Bilangan Mesyuarat Yang ke- : </label>
                &nbsp;
            </p>
            <p>
                <label for="ID Berkaitan"> Tarikh Mesyuarat : </label>
                &nbsp;
            </p>
            <p>
                <label for="ID Berkaitan"> Nombor Kertas Mesyuarat : </label>
                &nbsp;
            </p>
            <p>
            ...
            <p>
                <label for="ID Berkaitan"> Minit/Perakuan : </label>
                &nbsp;
            </p>
            <p>&nbsp;</p>
        </fieldset>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                ...
                <s:radio name="option" value="KK"/>Lulus
                <s:radio name="option" value="SS"/>Tolak
                <s:radio name="option" value="TP"/>Tangguh
            </p>
            <p>
    ...
    <div class="subtitle">
        <fieldset class="aras1">
            ...
            <p>
                <label> Jumlah Bayaran Pendudukan (RM) : </label>
                &nbsp;
            </p>
            <p>
