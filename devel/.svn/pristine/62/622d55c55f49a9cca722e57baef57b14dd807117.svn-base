<%--
    Document   : rekodPampasan31a_PenarikanBalik
...
function popupList(idPihak,idHakmilik){
        var url = '${pageContext.request.contextPath}/pengambilan/bayaranPampasan31aPB?showAmbilPampasanList&idPihak='+idPihak+'&idHakmilik='+idHakmilik;
        window.open(url, "eTanah","status=0,toolbar=0,location=0,menubar=0,width=1000,height=700");
    }
</script>
<s:useActionBean beanclass="etanah.view.ListUtil" id="listUtil" />
<s:form beanclass="etanah.view.stripes.pengambilan.RekodPampasan31a_PenarikanBalikActionBean" id="form">
<s:messages/>
<s:errors/>
<c:if test="${form1}">
    ...
    <div align="center">
        <table style="width:99.2%" bgcolor="purple">
            <tr><td width="100%" height="20" ><div style="background-color: purple;" align="center">
                        <font style="font-family: Tahoma; font-size: 16px; font-weight: bold;"><font color="white">PENGAMBILAN: REKOD PENERIMAAN BAYARAN PENARIKAN BALIK  (3(1)(a))</font></font>
            </div></td></tr>
        </table>
    </div><br /><br />
...
<fieldset class="aras1"><br/>
    ...
    <display:table class="tablecloth" name="${actionBean.hakmilikPermohonanList}" pagesize="5" cellpadding="0" cellspacing="0"
        ...
        <display:column title="ID Hakmilik">
            <s:link beanclass="etanah.view.stripes.pengambilan.RekodPampasan31a_PenarikanBalikActionBean"
      ...
      <c:if test="${actionBean.hakmilik ne null}">
          ...
          <fieldset class="aras1">
              ...
              <display:table class="tablecloth" name="${actionBean.hakmilik}" cellpadding="0" cellspacing="0" id="tbl1">
                    ...
                    <display:column title="No Lot/No PT" >${tbl1.lot.nama}&nbsp;${tbl1.noLot}</display:column>
                    ...
                    <display:column title="Orang Berkepentingan" style="vertical-align:baseline">
                        <display:table name="${actionBean.permohonanPihakList}" id="line5" class="tablecloth">
                            <display:column title="Pihak">
                                <s:link beanclass="etanah.view.stripes.pengambilan.RekodPampasan31a_PenarikanBalikActionBean"
                                        event="pihakDetails" onclick="return ajaxLink(this, '#hakmilik_details');" >
                                    <s:param name="idHakmilik" value="${tbl1.idHakmilik}"/>
                            ...
                            <display:column title="Bil Bayaran">
                                ...
                                <a href="javascript:popupList('${line5.pihak.idPihak}','${tbl1.idHakmilik}');">
                                    ...
                                    <img src="${pageContext.request.contextPath}/pub/images/icons/_active__document.png"
                                         onclick="javascript:popupList('${line5.pihak.idPihak}','${tbl1.idHakmilik}');" height="30" width="30" alt="papar"
                    ...
                    <display:column title="Luas Diambil" ><fmt:formatNumber pattern="#,##0.0000" value="${actionBean.hakmilik.luas}"/>&nbsp;${actionBean.hakmilik.kodUnitLuas.nama}</display:column>
      ...
      <c:if test="${showDetails}">
          <table width="100%">
              <tr>
                  ...
                  <td>${actionBean.nama}<br /></td>
              </tr>
              <tr>
                  <td width="30%"><label  >Tajuk Permohonan :</label></td>
                  <td>${actionBean.permohonan.permohonanSebelum.sebab }<br /></td>
              </tr>
              <tr>
                ...
                <fmt:formatNumber value="${actionBean.jumCaraBayar1}" pattern="0.00"/><br /></td>
              </tr>
              <tr>
                  <td><label >Jumlah pampasan yang diterima (RM) :</label></td>
                  <td><s:text name="jumTerimaPampasan" size="50" id="jumTerimaPampasan" formatPattern="###,###,###.00" onkeyup="validateNumber(this,this.value);"/><br /></td>
              </tr>
              <%--can use later when want to keyin cara pembayaran,no label,tarikh bank 18052011--%>
              <%--<tr>
