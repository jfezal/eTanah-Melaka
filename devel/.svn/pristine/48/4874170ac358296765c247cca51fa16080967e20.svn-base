...
//                          var url = "reportName=" + report + "%26report_p_id_hakmilik=" + param.value;
    ...
    <stripes:messages />
    <stripes:errors />
    <stripes:form beanclass="etanah.view.stripes.ispeks.SemakPenyataPemungutActionBean" id="formSPEKS" name="formSPEKS">
        <div class="subtitle">
            <fieldset class="aras1">
                <legend>Fail SPEKS (Penyemak)</legend>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="2"><b>Arahan : Sila 'Semak' Penyata Pemungut dan maklumat yang berkaitan.</b></font>
               ...
               <p>
                ...
                <p>
                    <label>&nbsp;</label>
                    <stripes:submit name="simpan" value="Semak" class="btn"/>
 <stripes:button name="selesai" value="Selesai" class="btn"  onclick="selesaiConfirm();"/>
                    <stripes:submit name="selesai" value="Selesai" class="btn" id="selesai"/>                                        <stripes:button id="mt" name="downloadFile" value="Papar Penyata" class="btn" onclick="papar('${actionBean.noPenyata}')"/>
