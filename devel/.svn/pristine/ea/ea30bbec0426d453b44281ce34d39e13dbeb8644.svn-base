...
@UrlBinding("/pengambilan/bayarantuntutanlebihan")
public class RekodPenerimaanTuntutanLebihanActionBean extends AbleActionBean {
...
//    private HakmilikPermohonanService hakmilikPermohonanService;
    ...
    public Resolution showForm() {
        return new JSP("pengambilan/rekodPenerimaanBayaranPampasan31a.jsp").addParameter("tab", "true");
    }
...
//        permohonanSblm= permohonanDAO.findById(idSblm);
        ...
        return new JSP("pengambilan/rekodPenerimaanTuntutanLebihan.jsp").addParameter("tab", "true");
    }
...
//        permohonanSblm= permohonanDAO.findById(idSblm);
    ...
    public Resolution refreshpage() {
        rehydrate();
        return new RedirectResolution(RekodPenerimaanTuntutanLebihanActionBean.class, "locate");
    }
...
//        String idSblm = permohonan.getPermohonanSebelum().getIdPermohonan();
        ...
        return new JSP("pengambilan/rekodPenerimaanBayaranPampasan31a_pop.jsp").addParameter("popup", "true");
    }
