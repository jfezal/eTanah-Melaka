        ...
        <table>
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <c:if test="${jana}">
                    <br />
                    <center><s:button class="btn" name="janaCukai" value="Jana Cukai" onclick="save(this.name, this.form);"/></center>
                    </c:if>

                <br />
            </fieldset>
            <br />
            <c:if test="${fn:length(actionBean.listPetak) > 0 && actionBean.skimStrata ne null}">
                ...
                <p>
                    ...
                    <display:table style="width:80%" class="tablecloth" name="${actionBean.listPetak}" id="line">
                        <display:column title="Petak" class="listPetak" >
                            ${line.nama}
                        ...
                        <display:column title="Kadar">
                            <c:choose>
                                <c:when test="${fn:startsWith(line.nama,'L') || fn:startsWith(line.nama,'PL')}" >
