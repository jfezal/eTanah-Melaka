                        ...
                        buttons: {
                            ...
                            'Simpan': function() {
                                ...
                                if (bValid) {
                                    ...
                                    var url = '${pageContext.request.contextPath}/consent/pihak_penerima?savePengarahEdit&idPengarah='+idPengarah  + '&idMohonPihak=' + idMohonPihak + '&idPemohon=' + idPemohon + '&namaPengarah=' + nama + '&kpPengarah=' + kp + '&noKpPengarah=' + noKp + '&wargaPengarah=' + warga+ '&idPengguna=' + idPengguna;
                                    frm = document.form1;
                                    frm.action = url;
                                    frm.submit();
                ...
                buttons: {
                    ...
                    'Simpan': function() {
                        ...
                        if (bValid) {
                            ...
                            var url = '${pageContext.request.contextPath}/consent/pihak_penerima?saveCawanganEdit&idCawangan='+idCawangan  + '&idMohonPihak=' + idMohonPihak  + '&idPemohon=' + idPemohon + '&namaCawangan=' + namaCawangan + '&alamat1=' + alamat1 + '&alamat2=' + alamat2 + '&alamat3=' + alamat3 + '&alamat4=' + alamat4 + '&poskod=' + poskod+ '&negeri=' + negeri;
                            frm = document.form1;
                            frm.action = url;
                            frm.submit();
                            $(this).dialog('close');
    ...
    <%--$('#namaPengarahEdit').val($('#nama_pengarah'+value).val());--%>
        ...
        function removePengarah(val, id){
            if(confirm('Adakah anda pasti?')) {
                doBlockUI();
                var url = '${pageContext.request.contextPath}/consent/pihak_penerima?deletePengarah&idPengarah='+val + '&idPihak=' + $('#idPihak').val() + '&idMohonPihak=' + $('#idMohonPihak').val() + '&idPemohon=' + $('#idPemohon').val() + '&jenisAction=editPenerima';
                frm = document.form1;
                frm.action = url;
                frm.submit();
            }
        ...
        function removeAmanah(val, id){
            if(confirm('Adakah anda pasti?')) {
                doBlockUI();
                var url = '${pageContext.request.contextPath}/consent/pihak_penerima?deletePihakHubungan&idHubungan='+val + '&idPihak=' + $('#idPihak').val() + '&idMohonPihak=' + $('#idMohonPihak').val() +'&jenisAction=editPenerima';
                frm = document.form1;
                frm.action = url;
                frm.submit();
            }
        ...
        function removeCawanganPemohon(val, id){
            if(confirm('Adakah anda pasti?')) {
                doBlockUI();
                var url = '${pageContext.request.contextPath}/consent/pihak_penerima?deletePihakCaw&idPihakCaw='+val + '&idPihak=' + $('#idPihak').val() + '&idMohonPihak=' + $('#idMohonPihak').val()  + '&idPemohon=' + $('#idPemohon').val() + '&jenisAction=editPenerima';
                frm = document.form1;
                frm.action = url;
                frm.submit();
            }
                ...
                <c:if test="${actionBean.pihak.jenisPengenalan.kod ne 'B' && actionBean.pihak.jenisPengenalan.kod ne 'L'
                      ...
                      <div class="content" align="center" id="pengarah">
                          ...
                          <display:table class="tablecloth" name="${actionBean.pengarahList}" cellpadding="0" cellspacing="0"
                                         id="pengarahTable" pagesize="10" requestURI="${pageContext.request.contextPath}/consent/pihak_penerima">
                ...
                <div id="pgAmanah" align="center">
                    ...
                    <div align="center">
                        <display:table class="tablecloth" name="${actionBean.senaraiPihakHubungan}" cellpadding="0" cellspacing="0"
                                       id="pgAmanahTable" pagesize="10"                                       requestURI="${pageContext.request.contextPath}/consent/pihak_penerima">
                            <display:column  title="Nama" class="nama"property="nama"></display:column>
                            <display:column title="Jenis Pengenalan" property="jenisPengenalan.nama"></display:column>
                            <display:column title="Nombor Pengenalan" property="noPengenalan"></display:column>
                            <display:column title="Warganegara" property="wargaNegara.nama"></display:column>
