        ...
        <fieldset class="aras1">
            ...
            <div class="content" align="center">
                <table border="0" width="30%">
                    ...
                    <tr>
                        <td>
                            <font color="#001848"><b> Kod Permit/Lesen  </b></font>
                        </td>
                        <td>
                            :
                        </td>
                        <td>
                            <s:select name="kodPermit" id="kodPermit" style="width:400px;" value="${actionBean.kodPermit}">
                                <s:option value="">Pilih</s:option>
                                <s:options-collection collection="${list.senaraiKodPermit}" label="nama" value="kod" />
                            </s:select>                          
                        </td>
                    </tr>   
                    --%>
