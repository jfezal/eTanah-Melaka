...
<script type="text/javascript">
    ...
    function refreshlptn(){
        var url = '${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?refreshpage';
        $.get(url,
        function(data){
            $('#page_div').html(data);
    ...
    <c:choose>
        ...
        function refreshpage2(type,pandanganImej,catatan,idLapor){
            ...
            //        alert(type);
            //        alert(catatan);
            var url = '${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?refreshpage&type='+type+'&pandanganImej='+pandanganImej+'&catatan='+catatan+'&idLapor='+idLapor;
        ...
        function deleteImage(idImej, idDokumen,catatan, type,f) {
            ...
            if(confirm('Adakah anda pasti untuk menghapus data ini?')) {
                var q = $(f).formSerialize();
                $.post('${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?deleteImage&idImej='+idImej+'&idDokumen='+idDokumen+'&catatan='+catatan+'&type='+type+'&imageType='+imageType+'&idLapor='+idLapor,q,
                function(data){
                    $('#page_div').html(data);
        ...
        function editImage(idImej) {
            ...
            var idLapor = $('#idLapor').val();
            //alert(idLapor);
            window.open("${pageContext.request.contextPath}/pengambilan/laporan_tanahV2?showFormPopUpImej&idImej="+idImej+"&idLapor="+idLapor, "eTanah",
            "status=0,toolbar=0,location=0,menubar=0,width=900,height=600");
        }
</script>
...
<body>
    ...
    <s:form beanclass="etanah.view.stripes.pengambilan.LaporanTanahNewDisposalActionBean">
                ...
                <div class="content" align="center">
                    ...
                    <display:table class="tablecloth" name="${actionBean.hakmilikImejLaporanListEdit}" pagesize="5" cellpadding="0" cellspacing="0" id="line"
                        ...
                        <display:column title="Kemaskini">
                            <div align="center">
                                <a onclick="editImage(${line.idImej})" onmouseover="this.style.cursor='pointer';" ><img alt="Kemaskini"  height="20px" width="20px" src='${pageContext.request.contextPath}/pub/images/icons/edit_pelupusan_small.png'/></a>
                            </div>  <%--alert('edit'+${line.idLaporBangunan});--%>
                        </display:column>
                        <display:column title="Hapus">
                            <div align="center">
                                <a onclick="deleteImage('${line.idImej}','${line.dokumen.idDokumen}','${line.catatan}','imgPopup',this.form);" onmouseover="this.style.cursor='pointer';" ><img alt="Hapus" height="20px" width="20px" src='${pageContext.request.contextPath}/pub/images/not_ok.gif'/></a>
                            </div>  <%--alert('edit'+${line.idLaporBangunan});--%>
                        </display:column>
                    </display:table>
                </div>
