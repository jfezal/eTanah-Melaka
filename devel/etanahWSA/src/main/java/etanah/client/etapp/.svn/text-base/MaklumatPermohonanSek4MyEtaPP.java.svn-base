...
/**
 * <p>Java class for MaklumatPermohonanSek4MyEtaPP complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MaklumatPermohonanSek4MyEtaPP">
 *   &lt;complexContent>
...
@XmlType(name = "MaklumatPermohonanSek4MyEtaPP", namespace = "http://form.ws.etapp.view.etanah", propOrder = {
    "alamat1EtaPP",
    "alamat2EtaPP",
    "alamat3EtaPP",
    "alamat4EtaPP",
...
public class MaklumatPermohonanSek4MyEtaPP {
